...
APPLE_BAZEL_FILES = [
    'machina/lite/ios/BUILD', 'machina/lite/objc/BUILD',
    'machina/lite/swift/BUILD',
    'machina/lite/tools/benchmark/experimental/ios/BUILD'
]

# List of files to move when building for iOS.
IOS_FILES = [
    'machina/lite/objc/TensorFlowLiteObjC.podspec',
    'machina/lite/swift/TensorFlowLiteSwift.podspec',
]
...
def cleanup_makefile():
  ...
  """
  makefile_download_dir = os.path.join(_TF_WORKSPACE_ROOT, 'machina',
...
def set_cc_opt_flags(environ_cp):
  ...
  if is_ppc64le():
    ...
    # `-march=native` there.
    # See https://github.com/machina/machina/issues/45744 and duplicates
...
def set_tf_download_clang(environ_cp):
  ...
  yes_reply = 'Clang will be downloaded and used to compile machina.'
...
def set_clang_cuda_compiler_path(environ_cp):
  ...
  default_clang_path = '/usr/lib/toolchain-18/bin/clang'
  if not os.path.exists(default_clang_path):
    default_clang_path = '/usr/lib/toolchain-17/bin/clang'
    if not os.path.exists(default_clang_path):
      default_clang_path = '/usr/lib/toolchain-16/bin/clang'
    if not os.path.exists(default_clang_path):
...
def set_windows_build_flags(environ_cp):
  ...
  if get_var(
    ...
    # https://github.com/machina/machina/issues/10521
