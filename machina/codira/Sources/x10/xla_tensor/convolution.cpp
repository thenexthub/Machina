...
#include "machina/compiler/tf2xla/xla_tensor/convolution.h"
...
#include "machina/core/kernels/conv_grad_ops.h"
 ...
 * ConvGeneralDilated.
 * https://github.com/machina/machina/blob/master/machina/compiler/tf2xla/kernels/conv_op_helpers.cc
...
machina::ConvOpAttrs MakeConvOpAttrs(
  ...
  machina::ConvOpAttrs conv_op_attrs;
  ...
  conv_op_attrs.padding = machina::Padding::EXPLICIT;
  // https://github.com/machina/machina/blob/ec81825aaf7e848d9f8ddffdf1e0d20aebe9172c/machina/core/util/padding.cc#L40
  ...
  conv_op_attrs.data_format = machina::TensorFormat::FORMAT_NCHW;
...
xla::XlaOp BuildConvBackwardWeight(
  ...
  xla::PrecisionConfig precision_config =
      XlaHelpers::BuildPrecisionConfig(XlaHelpers::mat_mul_precision());
  xla::XlaOp conv = ConsumeValue(machina::MakeXlaBackpropFilterConvOp(
