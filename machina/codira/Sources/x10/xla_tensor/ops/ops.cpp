...
#include "machina/compiler/tf2xla/xla_tensor/ops/constant.h"
...
#include "machina/compiler/xla/client/lib/logdet.h"
#include "machina/compiler/xla/client/lib/math.h"
#include "machina/compiler/xla/client/lib/matrix.h"
...
NodePtr ARange(at::Scalar start, at::Scalar end, at::Scalar step,
  ...
  switch (type) {
    case xla::PrimitiveType::BF16:
      values = XlaHelpers::Range<machina::bfloat16>(
          static_cast<machina::bfloat16>(start.toFloat()),
          static_cast<machina::bfloat16>(end.toFloat()),
          static_cast<machina::bfloat16>(step.toFloat()));
      break;
