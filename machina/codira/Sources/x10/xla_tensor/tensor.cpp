...
#include "machina/compiler/tf2xla/xla_tensor/op_by_op_executor.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/cast.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/device_data.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/expand.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/scalar.h"
...
XLATensor XLATensor::Create(at::Scalar scalar, at::ScalarType type,
                            const Device& device) {
  return Create(codira_xla::ToTensor(scalar, type), device);
}
