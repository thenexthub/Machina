...
#include "machina/compiler/xla/xla_client/mesh_service.h"
#include "machina/compiler/xla/xla_client/metrics.h"
#include "machina/compiler/xla/xla_client/triggered_task.h"
#include "machina/compiler/xla/xla_client/util.h"
#include "machina/compiler/xla/xla_client/xrt_session.h"
#include "machina/compiler/xla/xla_client/xrt_session_cache.h"
...
#include "machina/compiler/xla/xla_data.pb.h"
#include "machina/compiler/xrt/cc/ops/xrt_compile_ops.h"
#include "machina/compiler/xrt/cc/ops/xrt_execute_op.h"
#include "machina/compiler/xrt/cc/ops/xrt_state_ops.h"
#include "machina/compiler/xrt/xrt.pb.h"
...
class XrtComputationClient : public ComputationClient,
 ...
 public:
  ...
  codira_xla::Device GetDefaultDeviceStruct() const override;
 ...
 private:
  ...
  struct SessionWork {
    ...
    std::vector<machina::Output> outputs_handles;
  ...
  machina::Tensor GetArgumentsInputs(absl::Span<const DataPtr> arguments,
                                        const std::string& device);

  std::vector<machina::Output> CreateExecuteOps(
      XrtSessionCache::SessionMap* session_map,
      absl::Span<const Computation* const> computations,
  ...
  void ReleaseHandles(std::vector<DeviceHandle>* handles,
                      const std::function<const XrtSession::CachedNode&(
                          XrtSession*, const machina::Scope&,
  ...
  // Converts an XLA data type to a machina data type.
  static machina::DataType XlaTypeToDataType(PrimitiveType dtype);

  static machina::TensorShape MakeEquivalentTensorShape(const Shape& shape);
  ...
  static machina::ConfigProto CreateConfigProto(const Options& options);

  static machina::tpu::TopologyProto InitializeAndFetchTopology(
