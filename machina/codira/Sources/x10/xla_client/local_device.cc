...
#include "machina/compiler/xla/service/platform_util.h"
...
DataPtr LocalDevice::TransferToServer(xla::BorrowingLiteral literal,
  ...
  machina::profiler::TraceMe trace("TransferSingleTensorToServer");
  ...
  ScopedShapedBuffer buffer = [&] {
    machina::profiler::TraceMe trace("Allocate");
...
std::vector<DataPtr> LocalDevice::TransferToServer(
  ...
  auto* device = this;
  machina::profiler::TraceMe trace("TransferToServer");
...
std::vector<ComputationPtr> LocalDevice::Compile(
  ...
  for (CompileInstance& instance : instances) {
    ...
    machina::profiler::TraceMe trace(
...
std::vector<DataPtr> LocalDevice::ExecuteComputation(
  ...
  if (!is_cpu) {
    machina::profiler::TraceMe trace("Acquire Async slot");
