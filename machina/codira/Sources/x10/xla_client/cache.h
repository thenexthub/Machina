...
#ifndef X10_XLA_CLIENT_CACHE_H_
#define X10_XLA_CLIENT_CACHE_H_
...
class Cache {
 ...
 private:
  ...
  using ElementMap =
      absl::flat_hash_map<const K*, typename ElementList::iterator, Hasher,
                          Equaler>;
