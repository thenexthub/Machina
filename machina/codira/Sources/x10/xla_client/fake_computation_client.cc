...
#include "machina/compiler/xla/xla_client/fake_computation_client.h"
...
codira_xla::Device FakeComputationClient::GetDefaultDeviceStruct() const {
  return codira_xla::Device(codira_xla::DeviceType::CPU, 0);
}
