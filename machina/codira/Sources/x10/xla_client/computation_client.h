...
#include "machina/compiler/xla/client/xla_computation.h"
...
class ComputationClient {
 public:
  ...
  virtual codira_xla::Device GetDefaultDeviceStruct() const = 0;
  static codira_xla::Device DefaultDeviceStruct();
...
ComputationClient::Device* GetX10Device(codira_xla::Device device_id);
