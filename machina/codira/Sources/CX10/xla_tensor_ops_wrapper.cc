...
#include "machina/compiler/tf2xla/xla_tensor/elementwise.h"
...
#include "machina/compiler/tf2xla/xla_tensor/matrix.h"
#include "machina/compiler/tf2xla/xla_tensor/nll_loss.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/infer_output_shape.h"
#include "machina/compiler/tf2xla/xla_tensor/ops/tf_create_conv_attrs.h"
#include "machina/compiler/tf2xla/xla_tensor/reduction.h"
#include "machina/compiler/tf2xla/xla_tensor/segment_reduction_ops.h"
#include "machina/compiler/tf2xla/xla_tensor/softmax_builder.h"
#include "machina/compiler/tf2xla/xla_tensor/tensor_util.h"
#include "machina/compiler/tf2xla/xla_tensor/xla_lower_util.h"
#include "machina/compiler/tf2xla/kernels/conv_op_helpers.h"
#include "machina/compiler/tf2xla/lib/random.h"
#include "machina/compiler/xla/client/lib/constants.h"
#include "machina/compiler/xla/client/lib/math.h"
#include "machina/compiler/xla/client/lib/prng.h"
#include "machina/compiler/xla/client/lib/qr.h"
#include "machina/compiler/xla/client/lib/svd.h"
#include "machina/compiler/xla/service/hlo_instruction.h"
#include "xla_tensor_wrapper.h"

namespace at {
xla::hash_t Hash(const c10::optional<at::ScalarType>& dtype) {
  return xla::util::Hash(codira_xla::OptionalOr<int>(dtype, -1));
}
...
namespace machina {
xla::hash_t Hash(machina::MirrorPadMode mode) {
...
xla::BitGeneratorTy GetBestGenerator(LoweringContext* loctx = nullptr) {
  ...
  if (!loctx || loctx->device().hw_type == codira_xla::DeviceType::TPU) {
...
xla::int64 CanonicalizeStack(absl::Span<const Value> inputs, xla::int64 dim) {
  ...
  return codira_xla::XlaHelpers::GetCanonicalDimensionIndex(
...
xla::int64 CanonicalizeCat(absl::Span<const Value> inputs, xla::int64 dim) {
  ...
  dim = codira_xla::XlaHelpers::GetCanonicalDimensionIndex(dim,
                                                          first_shape.rank());
...
xla::XlaOp BuildTfConv(xla::XlaOp input, xla::XlaOp filter, bool depthwise,
  ...
  return ConsumeValue(machina::MakeXlaForwardConvOp(
...
xla::XlaOp BuildTfConvBackpropFilter(
    ...
    absl::Span<const xla::int64> strides, machina::Padding padding,
    absl::Span<const xla::int64> explicit_paddings,
    machina::TensorFormat data_format,
    absl::Span<const xla::int64> dilations) {
  ...
  xla::PrecisionConfig precision_config =
      XlaHelpers::BuildPrecisionConfig(XlaHelpers::mat_mul_precision());
  xla::Shape input_shape = XlaHelpers::ShapeOfXlaOp(input);
  return ConsumeValue(machina::MakeXlaBackpropFilterConvOp(
...
xla::XlaOp BuildTfConvBackpropInput(
  ...
  return ConsumeValue(machina::MakeXlaBackpropInputConvOp(
