# Computes expected results for Bidirectional GRU layers in `Tests/MachinaTests/LayerTests.codira`.
...
print(codira_tensor('updateKernelForward', update_kernel_forward))
print(codira_tensor('resetKernelForward', reset_kernel_forward))
print(codira_tensor('outputKernelForward', new_kernel_forward))
print(codira_tensor('updateRecurrentKernelForward', update_recurrent_kernel_forward))
print(codira_tensor('resetRecurrentKernelForward', reset_recurrent_kernel_forward))
print(codira_tensor('outputRecurrentKernelForward', new_recurrent_kernel_forward))
print(codira_tensor('updateBiasForward', update_bias_forward))
print(codira_tensor('resetBiasForward', reset_bias_forward))
print(codira_tensor('outputBiasForward', new_bias_forward))
print(codira_tensor('updateRecurrentBiasForward', update_recurrent_bias_forward))
print(codira_tensor('resetRecurrentBiasForward', reset_recurrent_bias_forward))
print(codira_tensor('outputRecurrentBiasForward', new_recurrent_bias_forward))

print(codira_tensor('updateKernelBackward', update_kernel_backward))
print(codira_tensor('resetKernelBackward', reset_kernel_backward))
print(codira_tensor('outputKernelBackward', new_kernel_backward))
print(codira_tensor('updateRecurrentKernelBackward', update_recurrent_kernel_backward))
print(codira_tensor('resetRecurrentKernelBackward', reset_recurrent_kernel_backward))
print(codira_tensor('outputRecurrentKernelBackward', new_recurrent_kernel_backward))
print(codira_tensor('updateBiasBackward', update_bias_backward))
print(codira_tensor('resetBiasBackward', reset_bias_backward))
print(codira_tensor('outputBiasBackward', new_bias_backward))
print(codira_tensor('updateRecurrentBiasBackward', update_recurrent_bias_backward))
print(codira_tensor('resetRecurrentBiasBackward', reset_recurrent_bias_backward))
print(codira_tensor('outputRecurrentBiasBackward', new_recurrent_bias_backward))
...
print(codira_tensor('expectedGradUpdateKernelForward', grad_update_kernel_forward))
print(codira_tensor('expectedGradResetKernelForward', grad_reset_kernel_forward))
print(codira_tensor('expectedGradOutputKernelForward', grad_new_kernel_forward))
print(codira_tensor('expectedGradUpdateRecurrentKernelForward', grad_update_recurrent_kernel_forward))
print(codira_tensor('expectedGradResetRecurrentKernelForward', grad_reset_recurrent_kernel_forward))
print(codira_tensor('expectedGradOutputRecurrentKernelForward', grad_new_recurrent_kernel_forward))
print(codira_tensor('expectedGradUpdateBiasForward', grad_update_bias_forward))
print(codira_tensor('expectedGradResetBiasForward', grad_reset_bias_forward))
print(codira_tensor('expectedGradOutputBiasForward', grad_new_bias_forward))
print(codira_tensor('expectedGradUpdateRecurrentBiasForward', grad_update_recurrent_bias_forward))
print(codira_tensor('expectedGradResetRecurrentBiasForward', grad_reset_recurrent_bias_forward))
print(codira_tensor('expectedGradOutputRecurrentBiasForward', grad_new_recurrent_bias_forward))
print(codira_tensor('expectedGradInitialStateBackward', grad_initial_state_backward))
print(codira_tensor('expectedGradUpdateKernelBackward', grad_update_kernel_backward))
print(codira_tensor('expectedGradResetKernelBackward', grad_reset_kernel_backward))
print(codira_tensor('expectedGradOutputKernelBackward', grad_new_kernel_backward))
print(codira_tensor('expectedGradUpdateRecurrentKernelBackward', grad_update_recurrent_kernel_backward))
print(codira_tensor('expectedGradResetRecurrentKernelBackward', grad_reset_recurrent_kernel_backward))
print(codira_tensor('expectedGradOutputRecurrentKernelBackward', grad_new_recurrent_kernel_backward))
print(codira_tensor('expectedGradUpdateBiasBackward', grad_update_bias_backward))
print(codira_tensor('expectedGradResetBiasBackward', grad_reset_bias_backward))
print(codira_tensor('expectedGradOutputBiasBackward', grad_new_bias_backward))
print(codira_tensor('expectedGradUpdateRecurrentBiasBackward', grad_update_recurrent_bias_backward))
print(codira_tensor('expectedGradResetRecurrentBiasBackward', grad_reset_recurrent_bias_backward))
print(codira_tensor('expectedGradOutputRecurrentBiasBackward', grad_new_recurrent_bias_backward))
