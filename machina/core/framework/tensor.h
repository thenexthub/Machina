...
#ifndef MACHINA_CORE_FRAMEWORK_TENSOR_H_
#define MACHINA_CORE_FRAMEWORK_TENSOR_H_
...
typename TTypes<T>::Scalar Tensor::scalar() {
  static_assert(
      ...
      "std::string is no longer a scalar type, use machina::tstring");
...
#endif  // MACHINA_CORE_FRAMEWORK_TENSOR_H_
