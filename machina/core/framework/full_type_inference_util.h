...
#ifndef MACHINA_CORE_FRAMEWORK_FULL_TYPE_INFERENCE_UTIL_H_
#define MACHINA_CORE_FRAMEWORK_FULL_TYPE_INFERENCE_UTIL_H_
...
#endif  // MACHINA_CORE_FRAMEWORK_FULL_TYPE_INFERENCE_UTIL_H_
