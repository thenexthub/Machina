...
#ifndef MACHINA_CORE_FRAMEWORK_REGISTER_TYPES_H_
#define MACHINA_CORE_FRAMEWORK_REGISTER_TYPES_H_
...
#define TF_CALL_int32(m) m(::machina::int32)
#define TF_CALL_uint32(m) m(::machina::uint32)
#define TF_CALL_uint8(m) m(::machina::uint8)
#define TF_CALL_int16(m) m(::machina::int16)

#define TF_CALL_int8(m) m(::machina::int8)
#define TF_CALL_string(m) m(::machina::tstring)
#define TF_CALL_tstring(m) m(::machina::tstring)
#define TF_CALL_resource(m) m(::machina::ResourceHandle)
#define TF_CALL_variant(m) m(::machina::Variant)
#define TF_CALL_complex64(m) m(::machina::complex64)
#define TF_CALL_int64(m) m(::int64_t)
#define TF_CALL_uint64(m) m(::machina::uint64)
#define TF_CALL_bool(m) m(bool)

#define TF_CALL_qint8(m) m(::machina::qint8)
#define TF_CALL_quint8(m) m(::machina::quint8)
#define TF_CALL_qint32(m) m(::machina::qint32)
#define TF_CALL_bfloat16(m) m(::machina::bfloat16)
#define TF_CALL_qint16(m) m(::machina::qint16)

#define TF_CALL_quint16(m) m(::machina::quint16)
#define TF_CALL_uint16(m) m(::machina::uint16)
#define TF_CALL_complex128(m) m(::machina::complex128)
#define TF_CALL_half(m) m(Eigen::half)

#define TF_CALL_float8_e5m2(m) m(::machina::float8_e5m2)
#define TF_CALL_float8_e4m3fn(m) m(::machina::float8_e4m3fn)
#define TF_CALL_float8_e4m3fnuz(m) m(::machina::float8_e4m3fnuz)
#define TF_CALL_float8_e4m3b11fnuz(m) m(::machina::float8_e4m3b11fnuz)
#define TF_CALL_float8_e5m2fnuz(m) m(::machina::float8_e5m2fnuz)

#define TF_CALL_int4(m) m(::machina::int4)
#define TF_CALL_uint4(m) m(::machina::uint4)
#define TF_CALL_int2(m) m(::machina::int2)
#define TF_CALL_uint2(m) m(::machina::uint2)
...
#endif  // MACHINA_CORE_FRAMEWORK_REGISTER_TYPES_H_
