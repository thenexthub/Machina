...
namespace {
using ::machina::metrics::IncrementPhase2XlaCompilerCounter;
using ::machina::metrics::Phase2XlaCompilerMetric;
...
constexpr char kPhase2XlaCompilerStreamzName[] =
    "/machina/compiler/tf2xla/xla_compiler/compilation_status";
...
TEST(Metrics, Phase2ComilationStatusCounterIncremented) {
  ...
  machina::metrics::IncrementTfMlirBridgeSecondPhaseCounter(
      machina::metrics::MlirBridgeSecondPhaseMetric::
