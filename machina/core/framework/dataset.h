 ...
 *
 */
#ifndef MACHINA_CORE_FRAMEWORK_DATASET_H_
#define MACHINA_CORE_FRAMEWORK_DATASET_H_
...
#include "machina/core/framework/dataset_metadata.pb.h"
...
// `machina::data` symbol on the stack.
class Runner {
 public:
  virtual ~Runner() {}
 ...
 public:
  struct Params {
    ...
    explicit Params(OpKernelContext* ctx)
      ...
      accelerator_device_info = device->machina_accelerator_device_info();
      ...
      // that a symbol in the machina::data namespace is always on the stack
...
// work.
//
// NOTE(mrry): We do not use a regular `machina::thread::ThreadPool` for this
...
#endif  // MACHINA_CORE_FRAMEWORK_DATASET_H_
