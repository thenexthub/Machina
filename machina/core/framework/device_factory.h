...
#ifndef MACHINA_CORE_FRAMEWORK_DEVICE_FACTORY_H_
#define MACHINA_CORE_FRAMEWORK_DEVICE_FACTORY_H_
...
#define INTERNAL_REGISTER_LOCAL_DEVICE_FACTORY(device_type, device_factory, \
                                               ctr, ...)                    \
  static ::machina::dfactory::Registrar<device_factory>                  \
...
#endif  // MACHINA_CORE_FRAMEWORK_DEVICE_FACTORY_H_
