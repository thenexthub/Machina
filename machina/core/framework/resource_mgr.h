...
#ifndef MACHINA_CORE_FRAMEWORK_RESOURCE_MGR_H_
#define MACHINA_CORE_FRAMEWORK_RESOURCE_MGR_H_
...
ResourceHandle ScopedStepContainer::MakeResourceHandle(
  ...
  mutex_lock ml(mu_);
  dirty_ = true;
  return machina::MakeResourceHandle(container_, name, device,
                                        TypeIndex::Make<T>(), {});
}
...
#endif  // MACHINA_CORE_FRAMEWORK_RESOURCE_MGR_H_
