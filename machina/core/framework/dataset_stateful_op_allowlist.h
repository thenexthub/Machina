...
#ifndef MACHINA_CORE_FRAMEWORK_DATASET_STATEFUL_OP_ALLOWLIST_H_
#define MACHINA_CORE_FRAMEWORK_DATASET_STATEFUL_OP_ALLOWLIST_H_
...
#define ALLOW_STATEFUL_OP_FOR_DATASET_FUNCTIONS_UNIQ(ctr, name)       \
  static ::machina::Status allowlist_op##ctr TF_ATTRIBUTE_UNUSED = \
      ::machina::data::AllowlistedStatefulOpRegistry::Global()->Add(name)

}  // namespace machina

#endif  // MACHINA_CORE_FRAMEWORK_DATASET_STATEFUL_OP_ALLOWLIST_H_
