...
#ifndef MACHINA_CORE_FRAMEWORK_VARIANT_H_
#define MACHINA_CORE_FRAMEWORK_VARIANT_H_
...
#include "machina/core/framework/type_index.h"
...
// machina::Variant is intended to be used as the value that will be stored
// in a machina::Tensor object when its type is DT_VARIANT.
//
// machina::Variant can store an object of a class that satisfies the
// following constraints:
//
// * The class is CopyConstructible.
// * The class has a default constructor.
// * It's either a protocol buffer, a machina::Tensor, or defines the
// following functions:
//
...
// POD data types, machina::Tensor, and protocol buffer objects. However,
...
// machina::Tensors of primitive types (Eg., a list of machina::Tensors).
...
class Variant {
 public:
  ...
  // machina::Variant object itself. We want the copy constructor to be
  // chosen for the machina::Variant case.
...
#endif  // MACHINA_CORE_FRAMEWORK_VARIANT_H_
