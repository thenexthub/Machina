...
#ifndef MACHINA_CORE_FRAMEWORK_GRAPH_DEF_UTIL_H_
#define MACHINA_CORE_FRAMEWORK_GRAPH_DEF_UTIL_H_
...
// Node objects are actually specified as machina::NodeDef protocol buffers,
...
#endif  // MACHINA_CORE_FRAMEWORK_GRAPH_DEF_UTIL_H_
