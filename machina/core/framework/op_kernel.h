...
#ifndef MACHINA_CORE_FRAMEWORK_OP_KERNEL_H_
#define MACHINA_CORE_FRAMEWORK_OP_KERNEL_H_
...
#include "machina/core/framework/op.h"  // TODO(b/62899350): Remove
...
#include "machina/core/framework/session_state.h"
#include "machina/core/framework/tensor.h"
#include "machina/core/framework/tensor_shape.h"
#include "machina/core/framework/tensor_shape.pb.h"  // TODO(b/62899350): Remove
#include "machina/core/framework/tracking_allocator.h"
#include "machina/core/framework/types.h"
#include "machina/core/framework/types.pb.h"
#include "machina/core/lib/core/errors.h"
#include "machina/core/lib/core/status.h"
#include "machina/core/lib/gtl/array_slice.h"
#include "machina/core/lib/gtl/manual_constructor.h"
...
// machina::gtl::iterator_range to make the below container classes
// unnecessary.
...
class OpKernelContext {
 public:
  ...
  DeviceContext* op_device_context() {
    ...
    if (ret == nullptr) {
      auto* dev_info = device()->machina_accelerator_device_info();
  ...
  // Cancellation.
  //
  // EXPERIMENTAL. See the implementation in machina::FIFOQueue for an
...
#define TF_EXTRACT_KERNEL_NAME_Name(name_str) \
  name_str, ::machina::register_kernel::Name(name_str)
...
#define REGISTER_KERNEL_BUILDER_IMPL_3(ctr, op_name, kernel_builder_expr,   \
                                       is_system_kernel, ...)               \
  static ::machina::InitOnStartupMarker const register_kernel_##ctr      \
      TF_ATTRIBUTE_UNUSED =                                                 \
          TF_INIT_ON_STARTUP_IF(is_system_kernel ||                         \
                                (SHOULD_REGISTER_OP_KERNEL(#__VA_ARGS__) && \
                                 SHOULD_REGISTER_OP(op_name)))              \
          << ([](::machina::KernelDef const* kernel_def) {               \
               ::machina::kernel_factory::OpKernelRegistrar registrar(   \
               ...
               return ::machina::InitOnStartupMarker{};                  \
...
#endif  // MACHINA_CORE_FRAMEWORK_OP_KERNEL_H_
