...
#ifndef MACHINA_CORE_FRAMEWORK_FUNCTION_H_
#define MACHINA_CORE_FRAMEWORK_FUNCTION_H_
...
// converted into ::machina::gradient::Creator, which is
//   std::function<Status(const AttrSlice&, FunctionDef*)>.
//
// A ::machina::gradient::Creator should populate in FunctionDef* with a
...
#define REGISTER_OP_GRADIENT_UNIQ(ctr, name, fn)      \
  static bool unused_grad_##ctr TF_ATTRIBUTE_UNUSED = \
      ...
      ::machina::gradient::RegisterOp(name, fn)
...
#endif  // MACHINA_CORE_FRAMEWORK_FUNCTION_H_
