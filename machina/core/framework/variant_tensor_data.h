...
#ifndef MACHINA_CORE_FRAMEWORK_VARIANT_TENSOR_DATA_H_
#define MACHINA_CORE_FRAMEWORK_VARIANT_TENSOR_DATA_H_
...
#endif  // MACHINA_CORE_FRAMEWORK_VARIANT_TENSOR_DATA_H_
