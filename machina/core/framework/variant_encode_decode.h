...
#ifndef MACHINA_CORE_FRAMEWORK_VARIANT_ENCODE_DECODE_H_
#define MACHINA_CORE_FRAMEWORK_VARIANT_ENCODE_DECODE_H_
...
// * A machina::Tensor (TypeResolver<T, false, true>)
...
template <
    ...
    bool =
        std::is_same<typename std::decay<T>::type, ::machina::Tensor>::value,
...
// Specialization for machina::Tensor
template <typename T>
...
#endif  // MACHINA_CORE_FRAMEWORK_VARIANT_ENCODE_DECODE_H_
