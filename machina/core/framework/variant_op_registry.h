...
#ifndef MACHINA_CORE_FRAMEWORK_VARIANT_OP_REGISTRY_H_
#define MACHINA_CORE_FRAMEWORK_VARIANT_OP_REGISTRY_H_
...
#define REGISTER_UNARY_VARIANT_DECODE_FUNCTION_UNIQ(ctr, T, type_name) \
  static ::machina::variant_op_registry_fn_registration::           \
...
#endif  // MACHINA_CORE_FRAMEWORK_VARIANT_OP_REGISTRY_H_
