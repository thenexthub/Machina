...
#ifndef MACHINA_CORE_FRAMEWORK_DEVICE_BASE_H_
#define MACHINA_CORE_FRAMEWORK_DEVICE_BASE_H_
...
class DeviceBase {
 public:
  ...
  void set_machina_cpu_worker_threads(CpuWorkerThreads* t) {
    cpu_worker_threads_ = t;
  }

  virtual const CpuWorkerThreads* machina_cpu_worker_threads() const {
  ...
  // Does not take ownership.
  void set_machina_accelerator_device_info(
      AcceleratorDeviceInfo* device_info) {
    accelerator_device_info_ = device_info;
  }

  virtual const AcceleratorDeviceInfo* machina_accelerator_device_info()
      const {
  ...
  virtual tsl::thread::ThreadPool* machina_device_thread_pool() {
 ...
 protected:
  // Does not take ownership.
  void set_machina_device_thread_pool(tsl::thread::ThreadPool* thread_pool) {
...
#endif  // MACHINA_CORE_FRAMEWORK_DEVICE_BASE_H_
