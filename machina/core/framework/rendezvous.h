...
#ifndef MACHINA_CORE_FRAMEWORK_RENDEZVOUS_H_
#define MACHINA_CORE_FRAMEWORK_RENDEZVOUS_H_
...
// consumer>, where the producer and the consumer are machina
// devices.
//
...
#endif  // MACHINA_CORE_FRAMEWORK_RENDEZVOUS_H_
