...
#ifndef MACHINA_CORE_FRAMEWORK_KERNEL_DEF_BUILDER_H_
#define MACHINA_CORE_FRAMEWORK_KERNEL_DEF_BUILDER_H_
...
#endif  // MACHINA_CORE_FRAMEWORK_KERNEL_DEF_BUILDER_H_
