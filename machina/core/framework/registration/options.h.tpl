...
#ifndef MACHINA_CORE_FRAMEWORK_REGISTRATION_OPTIONS_TMPL_H_
#define MACHINA_CORE_FRAMEWORK_REGISTRATION_OPTIONS_TMPL_H_
...
#endif  // MACHINA_CORE_FRAMEWORK_REGISTRATION_OPTIONS_TMPL_H_
