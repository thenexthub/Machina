...
#ifndef MACHINA_CORE_FRAMEWORK_OP_H_
#define MACHINA_CORE_FRAMEWORK_OP_H_
...
#include "machina/core/framework/full_type_inference_util.h"  // IWYU pragma: export
#include "machina/core/framework/full_type_util.h"  // IWYU pragma: export
#include "machina/core/framework/op_def_builder.h"
#include "machina/core/framework/op_def_util.h"  // IWYU pragma: export
...
class OpDefBuilderWrapper {
 public:
  ...
  const ::machina::OpDefBuilder& builder() const { return builder_; }

  InitOnStartupMarker operator()();

 private:
  mutable ::machina::OpDefBuilder builder_;
};
...
#define REGISTER_OP_IMPL(ctr, name, is_system_op)                         \
  static ::machina::InitOnStartupMarker const register_op##ctr         \
      TF_ATTRIBUTE_UNUSED =                                               \
          ...
          << ::machina::register_op::OpDefBuilderWrapper(name)
...
#endif  // MACHINA_CORE_FRAMEWORK_OP_H_
