...
#ifndef MACHINA_CORE_FRAMEWORK_RESOURCE_OP_KERNEL_H_
#define MACHINA_CORE_FRAMEWORK_RESOURCE_OP_KERNEL_H_
...
#endif  // MACHINA_CORE_FRAMEWORK_RESOURCE_OP_KERNEL_H_
