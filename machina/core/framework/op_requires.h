...
#ifndef MACHINA_CORE_FRAMEWORK_OP_REQUIRES_H_
#define MACHINA_CORE_FRAMEWORK_OP_REQUIRES_H_
...
#define OP_REQUIRES_OK(CTX, ...)                                        \
  do {                                                                  \
    if (!TF_PREDICT_TRUE(                                               \
            ::machina::op_requires_internal::OkImpl<::absl::Status>( \
...
#define OP_REQUIRES_OK_ASYNC(CTX, STATUS, CALLBACK)                          \
  do {                                                                       \
    if (!TF_PREDICT_TRUE(                                                    \
            ::machina::op_requires_internal::OkAsyncImpl<::absl::Status>( \
...
#endif  // MACHINA_CORE_FRAMEWORK_OP_REQUIRES_H_
