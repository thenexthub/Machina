 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_LAYOUT_H_
#define MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_LAYOUT_H_
...
#endif  // MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_LAYOUT_H_
