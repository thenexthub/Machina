...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaHostCompute"), HostComputeOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSendToHost"), SendToHostOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaRecvFromHost"), RecvFromHostOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("_XlaHostComputeMlir"), MlirXlaOpKernel);
