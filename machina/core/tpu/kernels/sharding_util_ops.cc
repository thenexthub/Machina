...
#define REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND(type)                                    \
  REGISTER_KERNEL_BUILDER(                                             \
      Name("XlaSplitND").Device(DEVICE_CPU).TypeConstraint<type>("T"), \
      XlaSplitNDOp<Eigen::ThreadPoolDevice, type>)

TF_CALL_POD_TYPES(REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_QUANTIZED_TYPES(REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_int4(REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_uint4(REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND);
#undef REGISTER_MACHINA_MACHINA_XLA_SPLIT_ND

#define REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND(type) \
  REGISTER_KERNEL_BUILDER(                        \
...
TF_CALL_POD_TYPES(REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_QUANTIZED_TYPES(REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_int4(REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND);
TF_CALL_uint4(REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND);
#undef REGISTER_READ_VARIABLE_MACHINA_MACHINA_XLA_SPLIT_ND
...
#define REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND(type)                                    \
  REGISTER_KERNEL_BUILDER(                                              \
      Name("XlaConcatND").Device(DEVICE_CPU).TypeConstraint<type>("T"), \
      XlaConcatNDOp<Eigen::ThreadPoolDevice, type>)

TF_CALL_POD_TYPES(REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_QUANTIZED_TYPES(REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_int4(REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_uint4(REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND);
#undef REGISTER_MACHINA_MACHINA_XLA_CONCAT_ND

#define REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND(type) \
  REGISTER_KERNEL_BUILDER(                           \
...
TF_CALL_POD_TYPES(REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_QUANTIZED_TYPES(REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_int4(REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND);
TF_CALL_uint4(REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND);
#undef REGISTER_ASSIGN_VARIABLE_MACHINA_MACHINA_XLA_CONCAT_ND
