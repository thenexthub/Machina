 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_H_
...
#include "machina/core/tpu/kernels/tpu_executable_info.pb.h"
...
class TpuProgramGroup : public TpuProgramGroupInterface {
 public:
  ...
  void Initialize(absl::Span<MACHINA_MACHINA_XLA_TpuProgram* const> xla_tpu_programs);
  ...
  const std::vector<MACHINA_MACHINA_XLA_TpuProgram*>& tpu_programs() const;
  std::vector<MACHINA_MACHINA_XLA_TpuProgram*> tpu_programs(TpuProgramShardingType type) const;
  const MACHINA_MACHINA_XLA_TpuProgram* tpu_program(int index) const override;
  void set_tpu_programs(absl::Span<MACHINA_MACHINA_XLA_TpuProgram* const> tpu_programs);
 ...
 private:
  ...
  TPUHostTransferInfoProto ConstructHostTransferInfo(
      const MACHINA_MACHINA_XLA_TpuProgram* tpu_program);
  xla::HloProto ConstructHloMetadata(const MACHINA_MACHINA_XLA_TpuProgram* tpu_program);
  ...
  std::vector<MACHINA_MACHINA_XLA_TpuProgram*> tpu_programs_;  // Not owned.
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_H_
