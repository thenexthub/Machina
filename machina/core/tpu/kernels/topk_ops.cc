...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("KthOrderStatistic"), KthOrderStatistic);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TopKUnique"), TopKUnique);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MakeUnique"), MakeUnique);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TopKWithUnique"), TopKWithUnique);
}  // namespace
}  // namespace machina
