...
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_FINGERPRINT_LOOKUP_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_FINGERPRINT_LOOKUP_H_
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_FINGERPRINT_LOOKUP_H_
