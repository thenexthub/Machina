 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_COMPILE_OP_COMMON_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_COMPILE_OP_COMMON_H_
...
class TpuCompileOpKernelCommon {
 public:
  TpuCompileOpKernelCommon(const std::string& mlir_module,
    ...
    mlir_module_fingerprint_ = machina::Fingerprint64(mlir_module_);
  }
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_COMPILE_OP_COMMON_H_
