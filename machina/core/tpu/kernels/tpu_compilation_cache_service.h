 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_SERVICE_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_SERVICE_H_
...
#include "machina/core/tpu/kernels/tpu_compilation_cache_grpc.h"
...
class TpuCompilationCacheService {
 public:
  using ServiceType = ::machina::tpu::grpc::TpuCompilationCacheService;
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_SERVICE_H_
