 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_OP_UTIL_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_OP_UTIL_H_
...
uint64 CreateFingerprintWithNameAndShapes(
    uint64 name, const std::vector<machina::TensorShape>& shapes);
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_OP_UTIL_H_
