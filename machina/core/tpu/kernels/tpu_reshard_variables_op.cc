...
#include "machina/core/tpu/kernels/tpu_reshard_variables_op.h"
...
#include "machina/compiler/jit/xla_tensor.h"
...
#include "machina/core/tpu/kernels/tpu_reshard_variables_op_util.h"
...
namespace reshard_util = ::machina::tpu::reshard_variables;
