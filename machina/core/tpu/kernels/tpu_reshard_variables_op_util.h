...
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_RESHARD_VARIABLES_OP_UTIL_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_RESHARD_VARIABLES_OP_UTIL_H_
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_RESHARD_VARIABLES_OP_UTIL_H_
