 ...
 *
 */
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_INTERFACE_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_INTERFACE_H_
...
class TpuProgramGroupInterface {
 public:
  ...
  // Get MACHINA_MACHINA_XLA_TpuProgram Proto
  virtual const MACHINA_MACHINA_XLA_TpuProgram* tpu_program(int index) const = 0;
};

}  // namespace tpu
}  // namespace machina

#endif  // MACHINA_CORE_TPU_KERNELS_TPU_PROGRAM_GROUP_INTERFACE_H_
