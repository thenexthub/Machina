...
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_ORDINAL_SELECTOR_INTERFACE_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_ORDINAL_SELECTOR_INTERFACE_H_
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_ORDINAL_SELECTOR_INTERFACE_H_
