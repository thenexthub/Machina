 ...
 *
 */
#include "machina/core/tpu/kernels/tpu_configuration_ops.h"
...
#include "machina/core/tpu/kernels/tpu_compilation_cache_factory.h"
#include "machina/core/tpu/kernels/tpu_compilation_cache_interface.h"
#include "machina/core/tpu/kernels/tpu_compilation_cache_local_lookup.h"
#include "machina/core/tpu/kernels/tpu_compilation_cache_lookup.h"
#include "machina/core/tpu/kernels/tpu_compilation_cache_rpc_lookup.h"
#include "machina/core/tpu/kernels/tpu_embedding_engine_state_interface.h"
#include "machina/core/tpu/kernels/tpu_execute_op_options.h"
#include "machina/core/tpu/kernels/tpu_fingerprint_lookup.h"
#include "machina/core/tpu/kernels/tpu_mesh_state_interface.h"
#include "machina/core/tpu/kernels/tpu_op_consts.h"
#include "machina/core/tpu/kernels/tpu_pod_state.h"
#include "machina/core/tpu/tpu_configuration.h"
#include "machina/core/tpu/tpu_defs.h"  // IWYU pragma: keep
...
void ConfigureDistributedTpuOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("ConfigureDistributedTpuOp");
...
void WaitForDistributedTpuOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("WaitForDistributedTpuOp");
...
void ShutdownDistributedTpuOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("ShutdownDistributedTpuOp");
...
void InitializeHostForDistributedTpuOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("InitializeHostForDistributedTpuOp");
...
void SetGlobalTPUArrayOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("SetGlobalTPUArrayOp");
...
void DisconnectDistributedTpuChipsOp::Compute(OpKernelContext* ctx) {
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("DisconnectDistributedTpuChipsOp");
