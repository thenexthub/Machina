...
#include "machina/core/tpu/ops/tpu_embedding_ops.h"
...
#include "machina/xla/stream_executor/tpu/status_helper.h"
...
void CompileSendTPUEmbeddingGradients(
  ...
  MACHINA_MACHINA_XLA_Shape gradient_tuple_c_shape;
  ...
  MACHINA_MACHINA_XLA_Shape learning_rate_tuple_c_shape;
  ...
  MACHINA_MACHINA_XLA_Shape deduplication_c_shape;
...
class RecvTPUEmbeddingActivationsOp : public XlaOpKernel {
 ...
 private:
  machina::tpu::TPUEmbeddingConfiguration tpu_embedding_config_;
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaRecvTPUEmbeddingActivations").AllowVariantTypes(),
...
class RecvTPUEmbeddingDeduplicationDataOp : public XlaOpKernel {
 public:
  explicit RecvTPUEmbeddingDeduplicationDataOp(OpKernelConstruction* ctx)
    ...
    OP_REQUIRES(
        ctx,
        machina::tpu::TPUEmbeddingConfiguration().ParseFromString(
            config_string_),
        errors::InvalidArgument("Failed to parse TPUEmbeddingConfiguration "
                                "proto from config attr"));
  }
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSendTPUEmbeddingGradients").AllowVariantTypes(),
...
class SplitDedupDataOp : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    OP_REQUIRES_VALUE(
        ...
        machina::tpu::SpmdShardingAnnotationOnFirstDim(
 ...
 private:
  ...
  machina::TensorProto tuple_mask_tensor_;

  SplitDedupDataOp(const SplitDedupDataOp&) = delete;
  void operator=(const SplitDedupDataOp&) = delete;
};

REGISTER_MACHINA_MACHINA_XLA_OP(Name("SplitDedupData").AllowVariantTypes(), SplitDedupDataOp);
...
class MergeDedupDataOp : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    const machina::TensorShapeProto& tuple_tensor_shape =
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MergeDedupData").AllowVariantTypes(), MergeDedupDataOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ComputeDedupDataSize"), ComputeDedupDataSizeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ComputeDedupDataTupleMask").AllowVariantTypes(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaRecvTPUEmbeddingActivationsV2").AllowVariantTypes(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSendTPUEmbeddingGradientsV2").AllowVariantTypes(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ComputeDedupDataSizeV2"), ComputeDedupDataSizeV2Op);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ComputeDedupDataTupleMaskV2").AllowVariantTypes(),
