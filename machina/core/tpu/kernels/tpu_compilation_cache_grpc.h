...
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_GRPC_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_GRPC_H_
...
#include "machina/core/tpu/kernels/tpu_compilation_cache.pb.h"
#else
#include "machina/core/tpu/kernels/tpu_compilation_cache.pb.h"  // copybara"
#endif
...
class TpuCompilationCacheService final {
 public:
  using RequestType = ::machina::tpu::GetTpuProgramRequest;
#if defined(LIBTPU_ON_GCE)
  using ResponseType = ::machina::tpu::GetTpuProgramResponseExternal;
#else
  using ResponseType = ::machina::tpu::GetTpuProgramResponse;
#endif
...
#if defined(LIBTPU_ON_GCE)
    return "machina.tpu.TpuCompilationCacheServiceExternal";
#else
    return "machina.tpu.TpuCompilationCacheService";
#endif
  }
  class StubInterface {
   public:
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_COMPILATION_CACHE_GRPC_H_
