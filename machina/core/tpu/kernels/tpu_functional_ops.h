...
#ifndef MACHINA_CORE_TPU_KERNELS_TPU_FUNCTIONAL_OPS_H_
#define MACHINA_CORE_TPU_KERNELS_TPU_FUNCTIONAL_OPS_H_
...
using XlaShardingInfoMap = absl::flat_hash_map<
    std::string, std::tuple<machina::DataType, std::string, std::string>>;
...
using TpuReplicatedInputInfoMap =
    absl::flat_hash_map<std::string,
                           std::tuple<machina::DataType, Node*>>;
...
#endif  // MACHINA_CORE_TPU_KERNELS_TPU_FUNCTIONAL_OPS_H_
