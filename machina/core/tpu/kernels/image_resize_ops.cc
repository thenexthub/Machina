...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeNearestNeighbor")
                    .CompileTimeConstantInput("size")
                    .Device(DEVICE_TPU_MACHINA_MACHINA_XLA_JIT),
                TpuResizeNearestNeighborOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeNearestNeighborGrad")
                    .CompileTimeConstantInput("size")
                    .Device(DEVICE_TPU_MACHINA_MACHINA_XLA_JIT),
                TpuResizeNearestNeighborGradOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeBilinear")
                    .CompileTimeConstantInput("size")
                    .Device(DEVICE_TPU_MACHINA_MACHINA_XLA_JIT),
                TpuResizeBilinearOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeBilinearGrad").Device(DEVICE_TPU_MACHINA_MACHINA_XLA_JIT),
