 ...
 *
 */
#include "machina/core/tpu/kernels/tpu_execute_op.h"
...
#include "machina/core/tpu/kernels/tpu_compilation_cache_entry.h"
...
namespace machina {
namespace {
using ::machina::tpu::CompilationCacheEntryRef;
using ::machina::tpu::TpuCompilationCacheLookup;
...
absl::Status TPUExecuteOp::DoWork(OpKernelContext* context) {
  ...
  const tpu::TpuProgramGroup* tpu_program_group =
      machina::down_cast<const tpu::TpuProgramGroup*>(
