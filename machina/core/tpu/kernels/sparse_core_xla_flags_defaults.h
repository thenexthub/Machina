...
#ifndef MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_MACHINA_XLAFLAGS_DEFAULTS_H_
#define MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_MACHINA_XLAFLAGS_DEFAULTS_H_
...
#endif  // MACHINA_CORE_TPU_KERNELS_SPARSE_CORE_MACHINA_XLAFLAGS_DEFAULTS_H_
