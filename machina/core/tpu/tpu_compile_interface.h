 ...
 *
 */
#ifndef MACHINA_CORE_TPU_TPU_COMPILE_INTERFACE_H_
#define MACHINA_CORE_TPU_TPU_COMPILE_INTERFACE_H_
...
class TpuCompileInterface {
 public:
  ...
  // Proto: machina::tpu::CompilationResultProto
  // Location: machina/core/protobuf/tpu/compilation_result.proto
  static inline constexpr char kTpuCompileErrorPayloadKey[] =
      "type.googleapis.com/machina.tpu.CompilationResultProto";
...
#endif  // MACHINA_CORE_TPU_TPU_COMPILE_INTERFACE_H_
