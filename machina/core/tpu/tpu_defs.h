...
#ifndef MACHINA_CORE_TPU_TPU_DEFS_H_
#define MACHINA_CORE_TPU_TPU_DEFS_H_
...
// DEVICE_TPU_SYSTEM is now defined in machina/core/framework/types.h/.cc

// Name of the MACHINA_MACHINA_XLA_TPU_JIT compilation device, which is an internal device to
// compile graphs for TPU. Not registered as a device; no operators can be
// assigned to this device by a user.
extern const char* const DEVICE_TPU_MACHINA_MACHINA_XLA_JIT;  // "MACHINA_MACHINA_XLA_TPU_JIT";
...
#endif  // MACHINA_CORE_TPU_TPU_DEFS_H_
