 ...
 *
 */
#ifndef MACHINA_CORE_TPU_TPU_GLOBAL_INIT_H_
#define MACHINA_CORE_TPU_TPU_GLOBAL_INIT_H_
...
// declarations.
namespace tsl {
using machina::InitializeTPUSystemGlobally;  // NOLINT
}

#endif  // MACHINA_CORE_TPU_TPU_GLOBAL_INIT_H_
