...
#include "machina/core/tpu/tpu_execute.h"
...
#include "machina/xla/stream_executor/tpu/c_api_defn.h"
...
#include "machina/xla/stream_executor/tpu/tpu_op_executable.h"
...
#include "machina/core/common_runtime/next_pluggable_device/c/outside_compilation_params.h"
...
using ::machina::tpu::TpuNodeContext;
          ...
          TF_RETURN_IF_ERROR(stream->DoHostCallbackWithStatus(
              [raw_input_runtime, padded_data, runtime_shape,
               compile_time_shape]() {
                ...
                // again.
                MACHINA_MACHINA_XLA_Shape c_runtime_shape, c_compile_time_shape;
