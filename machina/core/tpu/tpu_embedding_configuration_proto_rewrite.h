...
#ifndef MACHINA_CORE_TPU_TPU_EMBEDDING_CONFIGURATION_PROTO_REWRITE_H_
#define MACHINA_CORE_TPU_TPU_EMBEDDING_CONFIGURATION_PROTO_REWRITE_H_
...
#endif  // MACHINA_CORE_TPU_TPU_EMBEDDING_CONFIGURATION_PROTO_REWRITE_H_
