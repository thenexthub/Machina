...
#include "machina/core/protobuf/tpu/optimization_parameters.pb.h"
#include "machina/core/protobuf/tpu/tpu_embedding_configuration.pb.h"
#include "machina/core/tpu/ops/tpu_embedding_shape_util.h"
#include "machina/core/tpu/tpu_embedding_optimization_parameters_utils.h"
#include "machina/core/tpu/tpu_embedding_output_layout_utils.h"

namespace machina {

using shape_inference::InferenceContext;
using shape_inference::ShapeHandle;
using machina::tpu::TPUEmbeddingConfiguration;
...
REGISTER_OP("XlaRecvTPUEmbeddingDeduplicationData")
    ...
    .Attr("config: string")
    .SetIsStateful()
    .SetShapeFn(machina::shape_inference::ScalarShape);
...
REGISTER_OP("SplitDedupData")
    ...
    .SetShapeFn([](shape_inference::InferenceContext* c) -> absl::Status {
      ...
      machina::TensorProto tuple_mask_tensor;
