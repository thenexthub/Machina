...
#ifndef MACHINA_CORE_TPU_GRAPH_REWRITE_COND_BUILDER_H_
#define MACHINA_CORE_TPU_GRAPH_REWRITE_COND_BUILDER_H_
...
#endif  // MACHINA_CORE_TPU_GRAPH_REWRITE_COND_BUILDER_H_
