...
#ifndef MACHINA_CORE_TPU_GRAPH_REWRITE_VARIABLE_MERGER_PASS_H_
#define MACHINA_CORE_TPU_GRAPH_REWRITE_VARIABLE_MERGER_PASS_H_
...
#endif  // MACHINA_CORE_TPU_GRAPH_REWRITE_VARIABLE_MERGER_PASS_H_
