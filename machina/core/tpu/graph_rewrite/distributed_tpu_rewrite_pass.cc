...
#include "machina/core/tpu/graph_rewrite/distributed_tpu_rewrite_pass.h"
...
#include "machina/compiler/tf2xla/sharding_util.h"
#include "machina/compiler/tf2xla/side_effect_util.h"
...
#include "machina/core/common_runtime/device_propagation.h"
...
#include "machina/core/common_runtime/lower_function_call_op.h"
#include "machina/core/common_runtime/lower_functional_ops.h"
#include "machina/core/common_runtime/lower_if_op.h"
#include "machina/core/common_runtime/lower_while_op.h"
...
#include "machina/core/tpu/graph_rewrite/distributed_tpu_rewrite_helpers.h"
#include "machina/core/tpu/graph_rewrite/distributed_tpu_rewrite_pass_internal.h"
#include "machina/core/tpu/graph_rewrite/host_training_loop_optimization_util.h"
...
int64_t GetPadding(const int split_dim, const int num_splits,
  ...
  int64_t per_split_size = machina::MathUtil::CeilOfRatio<int64_t>(
...
// LINT.ThenChange(//machina/compiler/mlir/machina/utils/tpu_rewrite_device_util.cc)
...
absl::Status ComputeShardedArgShapes(TensorShape* shape,
  ...
  for (int dim_idx = 0; dim_idx < sharded_rank; ++dim_idx) {
    auto sharded_dim = machina::MathUtil::CeilOfRatio<int64_t>(
...
absl::Status DistributedTPURewritePass::Run(
  ...
  tsl::OkOrSetErrorCounterPayload(
      machina::core::platform::ErrorSourceProto::TF_MACHINA_MACHINA_XLA_BRIDGE, status);
  return status;
}
