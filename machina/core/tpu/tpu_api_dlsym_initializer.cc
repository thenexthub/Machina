...
#include "machina/xla/stream_executor/tpu/tpu_api_dlsym_set_fn.h"
#include "machina/xla/stream_executor/tpu/tpu_executor_c_api.h"
#include "machina/xla/stream_executor/tpu/tpu_initialize_util.h"
...
#include "machina/xla/stream_executor/tpu/tpu_library_init_fns.inc"
...
// Gets the path of current module. It is usually machina_framework.so.
...
absl::Status FindAndLoadTpuLibrary() {
  // Reopen machina_framework.so as RTLD_GLOBAL. So that libtpu can link to
  // Tensorflow C API.
