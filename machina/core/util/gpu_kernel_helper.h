...
#ifndef MACHINA_CORE_UTIL_GPU_KERNEL_HELPER_H_
#define MACHINA_CORE_UTIL_GPU_KERNEL_HELPER_H_
...
__host__ __device__ inline machina::bfloat16 GpuLdg(
    const machina::bfloat16* address) {
  return Eigen::numext::bit_cast<machina::bfloat16>(
...
#endif  // MACHINA_CORE_UTIL_GPU_KERNEL_HELPER_H_
