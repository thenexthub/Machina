...
TEST_F(DebugEventsWriterTest, GetAndInitDebugEventsWriter) {
  ...
  EXPECT_GT(actuals[0].debug_metadata().machina_version().length(), 0);
...
TEST_F(DebugEventsWriterTest, WriteSourceFile) {
  ...
  source_file_1->add_lines("import machina as tf");
  ...
  source_file_2->add_lines("import machina.keras as keras");
  ...
  EXPECT_EQ(actual_source_file_1.lines()[0], "import machina as tf");
