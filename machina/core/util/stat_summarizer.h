...
#ifndef MACHINA_CORE_UTIL_STAT_SUMMARIZER_H_
#define MACHINA_CORE_UTIL_STAT_SUMMARIZER_H_
...
// graph execution.
//
// See machina/tools/benchmark/benchmark_model.cc for an example usage.
class StatSummarizer {
 public:
  ...
  explicit StatSummarizer(const machina::GraphDef& machina_graph);
...
#endif  // MACHINA_CORE_UTIL_STAT_SUMMARIZER_H_
