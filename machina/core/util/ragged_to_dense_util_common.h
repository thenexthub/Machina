...
#ifndef MACHINA_CORE_UTIL_RAGGED_TO_DENSE_UTIL_COMMON_H_
#define MACHINA_CORE_UTIL_RAGGED_TO_DENSE_UTIL_COMMON_H_
...
#endif  // MACHINA_CORE_UTIL_RAGGED_TO_DENSE_UTIL_COMMON_H_
