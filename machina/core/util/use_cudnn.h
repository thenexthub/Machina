...
#ifndef MACHINA_CORE_UTIL_USE_CUDNN_H_
#define MACHINA_CORE_UTIL_USE_CUDNN_H_

#include <cstdint>

#include "machina/xla/tsl/util/use_cudnn.h"
...
#endif  // MACHINA_CORE_UTIL_USE_CUDNN_H_
