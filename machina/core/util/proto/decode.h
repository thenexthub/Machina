...
#ifndef MACHINA_CORE_UTIL_PROTO_DECODE_H_
#define MACHINA_CORE_UTIL_PROTO_DECODE_H_
...
inline absl::Status ReadGroupBytes(CodedInputStream* input, int field_number,
  ...
  // machina/python/kernel_tests/proto:decode_proto_op_test target a
...
#endif  // MACHINA_CORE_UTIL_PROTO_DECODE_H_
