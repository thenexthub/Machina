...
#ifndef MACHINA_CORE_UTIL_PROTO_DESCRIPTOR_POOL_REGISTRY_H_
#define MACHINA_CORE_UTIL_PROTO_DESCRIPTOR_POOL_REGISTRY_H_
...
class DescriptorPoolRegistry {
 public:
  typedef std::function<absl::Status(
      machina::protobuf::DescriptorPool const** desc_pool,
      std::unique_ptr<machina::protobuf::DescriptorPool>* owned_desc_pool)>
      DescriptorPoolFn;
...
#endif  // MACHINA_CORE_UTIL_PROTO_DESCRIPTOR_POOL_REGISTRY_H_
