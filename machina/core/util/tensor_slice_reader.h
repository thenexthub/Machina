...
#ifndef MACHINA_CORE_UTIL_TENSOR_SLICE_READER_H_
#define MACHINA_CORE_UTIL_TENSOR_SLICE_READER_H_
...
class TensorSliceReader {
 public:
  ...
  absl::Status GetTensor(const string& name,
                         std::unique_ptr<machina::Tensor>* out_tensor) const;
...
#endif  // MACHINA_CORE_UTIL_TENSOR_SLICE_READER_H_
