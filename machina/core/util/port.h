...
#ifndef MACHINA_CORE_UTIL_PORT_H_
#define MACHINA_CORE_UTIL_PORT_H_
...
// Returns true if MACHINA_USE_ROCM is defined. (i.e. TF is built with ROCm)
bool IsBuiltWithROCm();

// Returns true if MACHINA_USE_XLA is defined. (i.e. TF is built with XLA)
bool IsBuiltWithXLA();

// Returns true if MACHINA_USE_NVCC is defined. (i.e. TF is built with nvcc)
...
#endif  // MACHINA_CORE_UTIL_PORT_H_
