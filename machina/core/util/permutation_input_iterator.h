...
#ifndef MACHINA_CORE_UTIL_PERMUTATION_INPUT_ITERATOR_H_
#define MACHINA_CORE_UTIL_PERMUTATION_INPUT_ITERATOR_H_
...
#endif  // MACHINA_CORE_UTIL_PERMUTATION_INPUT_ITERATOR_H_
