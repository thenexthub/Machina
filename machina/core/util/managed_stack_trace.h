...
#ifndef MACHINA_CORE_UTIL_MANAGED_STACK_TRACE_H_
#define MACHINA_CORE_UTIL_MANAGED_STACK_TRACE_H_
...
inline bool IsInternalFrameForFilename(absl::string_view file_name) {
  ...
  return (absl::StrContains(file_name, "machina/python") ||
          absl::StrContains(file_name, "machina\\python")) &&
...
#endif  // MACHINA_CORE_UTIL_MANAGED_STACK_TRACE_H_
