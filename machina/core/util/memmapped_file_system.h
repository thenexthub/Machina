...
#ifndef MACHINA_CORE_UTIL_MEMMAPPED_FILE_SYSTEM_H_
#define MACHINA_CORE_UTIL_MEMMAPPED_FILE_SYSTEM_H_
...
// machina/contrib/util/convert_graphdef_memmapped_format
...
#endif  // MACHINA_CORE_UTIL_MEMMAPPED_FILE_SYSTEM_H_
