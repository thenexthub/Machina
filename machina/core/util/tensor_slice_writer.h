...
#ifndef MACHINA_CORE_UTIL_TENSOR_SLICE_WRITER_H_
#define MACHINA_CORE_UTIL_TENSOR_SLICE_WRITER_H_
...
// machina::io::Table format.  If successful, return OK
...
#endif  // MACHINA_CORE_UTIL_TENSOR_SLICE_WRITER_H_
