...
#ifndef MACHINA_CORE_UTIL_CUDA_SPARSE_H_
#define MACHINA_CORE_UTIL_CUDA_SPARSE_H_
...
#include "machina/xla/stream_executor/rocm/hipsparse_wrapper.h"
...
class GpuSparse {
 public:
  ...
  Status Coo2csr(const int* cooRowInd, int nnz, int m, int* csrRowPtr) const;
    ...
    (MACHINA_USE_ROCM && TF_ROCM_VERSION < 40200)
...
#if (GOOGLE_CUDA && (CUDA_VERSION < 10020)) || MACHINA_USE_ROCM
  template <typename Scalar>
...
#endif  // MACHINA_CORE_UTIL_CUDA_SPARSE_H_
