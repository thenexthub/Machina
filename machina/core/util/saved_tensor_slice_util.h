...
#ifndef MACHINA_CORE_UTIL_SAVED_TENSOR_SLICE_UTIL_H_
#define MACHINA_CORE_UTIL_SAVED_TENSOR_SLICE_UTIL_H_
...
string EncodeTensorNameSlice(const string& name,
                             const machina::TensorSlice& slice);
...
#endif  // MACHINA_CORE_UTIL_SAVED_TENSOR_SLICE_UTIL_H_
