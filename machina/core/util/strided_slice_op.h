 ...
 *
 */
#ifndef MACHINA_CORE_UTIL_STRIDED_SLICE_OP_H_
#define MACHINA_CORE_UTIL_STRIDED_SLICE_OP_H_
...
// strided slice.  Modelled after machina::BCast, but with a few key
// differences:
...
#endif  // MACHINA_CORE_UTIL_STRIDED_SLICE_OP_H_
