 ...
 *
 */
#ifndef MACHINA_CORE_UTIL_QUANTIZATION_UNIFORM_QUANT_OPS_PARAMS_H_
#define MACHINA_CORE_UTIL_QUANTIZATION_UNIFORM_QUANT_OPS_PARAMS_H_
...
#endif  // MACHINA_CORE_UTIL_QUANTIZATION_UNIFORM_QUANT_OPS_PARAMS_H_
