...
#ifndef MACHINA_CORE_UTIL_EXAMPLE_PROTO_HELPER_H_
#define MACHINA_CORE_UTIL_EXAMPLE_PROTO_HELPER_H_
...
// Given a single machina::Example, with an optional example name
...
// have disjoint key fields from the Feature map in the machina.Example
// proto.
//
...
// A method to convert a batch of machina::Example protos into output
...
// machina::Example protocol buffer feature values.
...
#endif  // MACHINA_CORE_UTIL_EXAMPLE_PROTO_HELPER_H_
