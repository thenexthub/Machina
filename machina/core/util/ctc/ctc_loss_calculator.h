...
#ifndef MACHINA_CORE_UTIL_CTC_CTC_LOSS_CALCULATOR_H_
#define MACHINA_CORE_UTIL_CTC_CTC_LOSS_CALCULATOR_H_
...
#endif  // MACHINA_CORE_UTIL_CTC_CTC_LOSS_CALCULATOR_H_
