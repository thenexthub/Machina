...
#ifndef MACHINA_CORE_UTIL_CTC_CTC_BEAM_ENTRY_H_
#define MACHINA_CORE_UTIL_CTC_CTC_BEAM_ENTRY_H_
...
#endif  // MACHINA_CORE_UTIL_CTC_CTC_BEAM_ENTRY_H_
// LINT.ThenChange(//machina/lite/kernels/ctc/ctc_beam_entry.h)
