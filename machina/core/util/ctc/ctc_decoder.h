...
#ifndef MACHINA_CORE_UTIL_CTC_CTC_DECODER_H_
#define MACHINA_CORE_UTIL_CTC_CTC_DECODER_H_
...
#endif  // MACHINA_CORE_UTIL_CTC_CTC_DECODER_H_
// LINT.ThenChange(//machina/lite/kernels/ctc/ctc_decoder.h)
