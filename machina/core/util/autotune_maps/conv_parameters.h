...
#ifndef MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_PARAMETERS_H_
#define MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_PARAMETERS_H_
...
#endif  // MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_PARAMETERS_H_
