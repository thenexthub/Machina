...
#ifndef MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_MAP_WRAPPER_H_
#define MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_MAP_WRAPPER_H_
...
#endif  // MACHINA_CORE_UTIL_AUTOTUNE_MAPS_CONV_MAP_WRAPPER_H_
