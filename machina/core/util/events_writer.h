...
#ifndef MACHINA_CORE_UTIL_EVENTS_WRITER_H_
#define MACHINA_CORE_UTIL_EVENTS_WRITER_H_
...
class EventsWriter {
 public:
  ...
  static constexpr const char* kWriterSourceMetadata =
      "machina.core.util.events_writer";
#endif
  ...
  // Append "event" to the file.  The "machina::" part is for swig happiness.
  void WriteEvent(const machina::Event& event);

  // Append "event_str", a serialized Event, to the file.
  // Note that this function does NOT check that de-serializing event_str
  // results in a valid Event proto.  The machina:: bit makes SWIG happy.
...
#endif  // MACHINA_CORE_UTIL_EVENTS_WRITER_H_
