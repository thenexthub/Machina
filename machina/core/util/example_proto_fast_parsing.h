...
#ifndef MACHINA_CORE_UTIL_EXAMPLE_PROTO_FAST_PARSING_H_
#define MACHINA_CORE_UTIL_EXAMPLE_PROTO_FAST_PARSING_H_
...
struct FastParseExampleConfig {
  struct Dense {
    ...
    // ParseExample op.
    // Documentation is available in: machina/core/ops/parsing_ops.cc
...
#endif  // MACHINA_CORE_UTIL_EXAMPLE_PROTO_FAST_PARSING_H_
