...
#ifndef MACHINA_CORE_TRANSFORMS_GRAPH_TO_FUNC_PASS_H_
#define MACHINA_CORE_TRANSFORMS_GRAPH_TO_FUNC_PASS_H_
...
#endif  // MACHINA_CORE_TRANSFORMS_GRAPH_TO_FUNC_PASS_H_
