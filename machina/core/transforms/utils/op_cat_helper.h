 ...
 *
 */
#ifndef MACHINA_CORE_TRANSFORMS_UTILS_OP_CAT_HELPER_H_
#define MACHINA_CORE_TRANSFORMS_UTILS_OP_CAT_HELPER_H_
...
#endif  // MACHINA_CORE_TRANSFORMS_UTILS_OP_CAT_HELPER_H_
