...
#ifndef MACHINA_CORE_TRANSFORMS_REGION_TO_FUNCTIONAL_PASS_H_
#define MACHINA_CORE_TRANSFORMS_REGION_TO_FUNCTIONAL_PASS_H_
...
#endif  // MACHINA_CORE_TRANSFORMS_REGION_TO_FUNCTIONAL_PASS_H_
