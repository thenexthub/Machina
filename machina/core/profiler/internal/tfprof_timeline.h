...
#ifndef MACHINA_CORE_PROFILER_INTERNAL_TFPROF_TIMELINE_H_
#define MACHINA_CORE_PROFILER_INTERNAL_TFPROF_TIMELINE_H_
...
#endif  // MACHINA_CORE_PROFILER_INTERNAL_TFPROF_TIMELINE_H_
