...
#ifndef MACHINA_CORE_PROFILER_INTERNAL_TFPROF_GRAPH_H_
#define MACHINA_CORE_PROFILER_INTERNAL_TFPROF_GRAPH_H_
...
#endif  // MACHINA_CORE_PROFILER_INTERNAL_TFPROF_GRAPH_H_
