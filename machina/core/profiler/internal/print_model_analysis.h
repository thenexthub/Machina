...
#ifndef MACHINA_CORE_PROFILER_INTERNAL_PRINT_MODEL_ANALYSIS_H_
#define MACHINA_CORE_PROFILER_INTERNAL_PRINT_MODEL_ANALYSIS_H_
...
#endif  // MACHINA_CORE_PROFILER_INTERNAL_PRINT_MODEL_ANALYSIS_H_
