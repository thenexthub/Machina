...
<b>--op_log_path:</b>
machina.tfprof.OpLogProto (optional). A proto used to provide extra operation
...
```shell
# Build the tool.
bazel build --config opt machina/core/profiler:profiler

# Help information, including detail 'option' instructions.
bazel-bin/machina/core/profiler/profiler help
```
...
bazel-bin/machina/core/profiler/profiler \
...
bazel-bin/machina/core/profiler/profiler scope \
    --graph_path=graph.pbtxt \
    --max_depth=3
```
