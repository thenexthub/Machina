...
#ifndef MACHINA_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
#define MACHINA_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
...
#endif  // MACHINA_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
