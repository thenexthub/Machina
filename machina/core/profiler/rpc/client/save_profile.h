...
#ifndef MACHINA_CORE_PROFILER_RPC_CLIENT_SAVE_PROFILE_H_
#define MACHINA_CORE_PROFILER_RPC_CLIENT_SAVE_PROFILE_H_
...
#endif  // MACHINA_CORE_PROFILER_RPC_CLIENT_SAVE_PROFILE_H_
