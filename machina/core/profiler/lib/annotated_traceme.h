 ...
 *
 */
#ifndef MACHINA_CORE_PROFILER_LIB_ANNOTATED_TRACEME_H_
#define MACHINA_CORE_PROFILER_LIB_ANNOTATED_TRACEME_H_
...
#endif  // MACHINA_CORE_PROFILER_LIB_ANNOTATED_TRACEME_H_
