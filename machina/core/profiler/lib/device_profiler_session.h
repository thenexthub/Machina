 ...
 *
 */
#ifndef MACHINA_CORE_PROFILER_LIB_DEVICE_PROFILER_SESSION_H_
#define MACHINA_CORE_PROFILER_LIB_DEVICE_PROFILER_SESSION_H_
...
#endif  // MACHINA_CORE_PROFILER_LIB_DEVICE_PROFILER_SESSION_H_
