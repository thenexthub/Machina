 ...
 *
 */
#ifndef MACHINA_CORE_PROFILER_LIB_SCOPED_MEMORY_DEBUG_ANNOTATION_H_
#define MACHINA_CORE_PROFILER_LIB_SCOPED_MEMORY_DEBUG_ANNOTATION_H_
...
#endif  // MACHINA_CORE_PROFILER_LIB_SCOPED_MEMORY_DEBUG_ANNOTATION_H_
