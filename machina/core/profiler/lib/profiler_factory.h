...
==============================================================================*/
#ifndef MACHINA_CORE_PROFILER_LIB_PROFILER_FACTORY_H_
#define MACHINA_CORE_PROFILER_LIB_PROFILER_FACTORY_H_
...
#include "machina/core/profiler/lib/profiler_interface.h"  // IWYU pragma: keep
...
CreateProfilers(const machina::ProfileOptions& options) {
...
#endif  // MACHINA_CORE_PROFILER_LIB_PROFILER_FACTORY_H_
