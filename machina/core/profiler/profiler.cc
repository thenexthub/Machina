...
#include "machina/core/profiler/internal/advisor/tfprof_advisor.h"
...
int Run(int argc, char** argv) {
  ...
  std::vector<Flag> flag_list = {
      ...
      Flag("op_log_path", &FLAGS_op_log_path,
           "machina::tfprof::OpLogProto proto binary file name"),
...
int main(int argc, char** argv) { return machina::tfprof::Run(argc, argv); }
