 ...
 *
 */
#ifndef MACHINA_CORE_ACTIVITY_WATCHER_ACTIVITY_UTILS_H_
#define MACHINA_CORE_ACTIVITY_WATCHER_ACTIVITY_UTILS_H_
...
#endif  // MACHINA_CORE_ACTIVITY_WATCHER_ACTIVITY_UTILS_H_
