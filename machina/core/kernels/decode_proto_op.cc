...
#include "machina/core/util/proto/decode.h"
#include "machina/core/util/proto/descriptors.h"
...
using ::machina::protobuf::DescriptorPool;
using ::machina::protobuf::DynamicMessageFactory;
using ::machina::protobuf::FieldDescriptor;
using ::machina::protobuf::Message;
using ::machina::protobuf::TextFormat;
using ::machina::protobuf::internal::WireFormatLite;
using ::machina::protobuf::io::CodedInputStream;
 ...
 public:
  ...
  absl::Status FillWithDefaults() {
    switch (default_value_.dtype) {
      ...
      default:
        // There are many machina dtypes not handled here, but they
