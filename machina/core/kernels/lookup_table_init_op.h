...
#ifndef MACHINA_CORE_KERNELS_LOOKUP_TABLE_INIT_OP_H_
#define MACHINA_CORE_KERNELS_LOOKUP_TABLE_INIT_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_LOOKUP_TABLE_INIT_OP_H_
