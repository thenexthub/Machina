...
#include "machina/core/kernels/fused_batch_norm_op.h"
#include "machina/core/kernels/redux_functor.h"
...
struct FusedBatchNorm<CPUDevice, T, U, /* is_training= */ true> {
  void operator()(OpKernelContext* context, const Tensor& x_input,
    ...
    if (tensor_format == FORMAT_NCHW) {
      ...
      OP_REQUIRES_OK(
          context, ::machina::DoTranspose(context->eigen_device<CPUDevice>(),
    ...
    if (tensor_format == FORMAT_NCHW) {
      ...
      const absl::Status s = ::machina::DoTranspose(
    ...
    if (tensor_format == FORMAT_NCHW) {
      ...
      OP_REQUIRES_OK(
          context, ::machina::DoTranspose(context->eigen_device<CPUDevice>(),
                                             ...
                                             &transformed_y_backprop_input));
      OP_REQUIRES_OK(context, ::machina::DoTranspose(
