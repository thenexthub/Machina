...
#ifndef MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_H_
#define MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_H_
...
#endif  // MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_H_
