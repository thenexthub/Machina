...
#ifndef MACHINA_CORE_KERNELS_SPECTROGRAM_TEST_UTILS_H_
#define MACHINA_CORE_KERNELS_SPECTROGRAM_TEST_UTILS_H_
...
#endif  // MACHINA_CORE_KERNELS_SPECTROGRAM_TEST_UTILS_H_
