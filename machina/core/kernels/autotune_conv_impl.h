...
#ifndef MACHINA_CORE_KERNELS_AUTOTUNE_CONV_IMPL_H_
#define MACHINA_CORE_KERNELS_AUTOTUNE_CONV_IMPL_H_
...
#endif  // MACHINA_CORE_KERNELS_AUTOTUNE_CONV_IMPL_H_
