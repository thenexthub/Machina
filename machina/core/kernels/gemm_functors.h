...
#ifndef MACHINA_CORE_KERNELS_GEMM_FUNCTORS_H_
#define MACHINA_CORE_KERNELS_GEMM_FUNCTORS_H_
...
class ReferenceGemmFunctor {
 public:
  void operator()(machina::OpKernelContext* ctx, size_t m, size_t n,
...
class FastGemmFunctor {
 public:
  void operator()(machina::OpKernelContext* ctx, size_t m, size_t n,
                  size_t k, const T1* a, size_t lda, const T2* b, size_t ldb,
                  T3* c, size_t ldc) {
    typename machina::TTypes<const T1>::Matrix a_matrix(a, m, k);
    typename machina::TTypes<const T2>::Matrix b_matrix(b, k, n);
    typename machina::TTypes<T3>::Matrix c_matrix(c, m, n);
...
class FastGemmFunctor<Eigen::bfloat16, Eigen::bfloat16, Eigen::bfloat16> {
 public:
  void operator()(machina::OpKernelContext* ctx, size_t m, size_t n,
                  ...
                  size_t ldc) {
    using ConstMatrix =
        typename machina::TTypes<const Eigen::bfloat16>::Matrix;
    ConstMatrix a_matrix(a, m, k);
    ConstMatrix b_matrix(b, k, n);
    typename machina::TTypes<Eigen::bfloat16>::Matrix c_matrix(c, m, n);
...
#endif  // MACHINA_CORE_KERNELS_GEMM_FUNCTORS_H_
