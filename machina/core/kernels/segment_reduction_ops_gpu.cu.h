...
#ifndef MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_GPU_CU_H_
#define MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_GPU_CU_H_

#if GOOGLE_CUDA || MACHINA_USE_ROCM

#define EIGEN_USE_GPU

#include "machina/core/common_runtime/gpu/gpu_event_mgr.h"
#include "machina/core/framework/register_types.h"
#include "machina/core/kernels/gpu_prim.h"
#include "machina/core/kernels/gpu_prim_helpers.h"
#include "machina/core/kernels/segment_reduction_ops.h"
#include "machina/core/lib/core/bits.h"
#include "machina/core/util/determinism.h"
#include "machina/core/util/env_var.h"
#include "machina/core/util/gpu_device_functions.h"
#include "machina/core/util/gpu_kernel_helper.h"
#include "machina/core/util/gpu_solvers.h"  // For ScratchSpace
#include "machina/core/util/permutation_input_iterator.h"

#if (defined(MACHINA_USE_ROCM) && MACHINA_USE_ROCM)
...
struct SparseSegmentGradV2Functor<GPUDevice, T, Tindices, Tsegmentids> {
 ...
 private:
  ...
  void Impl(OpKernelContext* context, SparseSegmentReductionOperation operation,
    ...
    context->device()
        ->machina_accelerator_device_info()
...
#endif  // MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_GPU_CU_H_
