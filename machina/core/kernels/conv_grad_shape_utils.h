...
#ifndef MACHINA_CORE_KERNELS_CONV_GRAD_SHAPE_UTILS_H_
#define MACHINA_CORE_KERNELS_CONV_GRAD_SHAPE_UTILS_H_
...
#endif  // MACHINA_CORE_KERNELS_CONV_GRAD_SHAPE_UTILS_H_
