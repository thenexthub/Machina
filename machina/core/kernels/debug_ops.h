...
#ifndef MACHINA_CORE_KERNELS_DEBUG_OPS_H_
#define MACHINA_CORE_KERNELS_DEBUG_OPS_H_
...
#if GOOGLE_CUDA
#include "machina/core/platform/cuda.h"
 ...
 public:
  ...
  void ComputeAsync(OpKernelContext* context, DoneCallback done) override {
    ...
    if (tensor_debug_mode_ == 2) {  // CURT_HEALTH.
      ...
      OP_REQUIRES_OK(context,
                     context->allocate_output(0, shape, &output_tensor));
      OP_REQUIRES_ASYNC(context, !machina::OpDeterminismRequired(),
...
#endif  // MACHINA_CORE_KERNELS_DEBUG_OPS_H_
