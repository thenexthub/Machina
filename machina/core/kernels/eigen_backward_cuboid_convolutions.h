...
#ifndef MACHINA_CORE_KERNELS_EIGEN_BACKWARD_CUBOID_CONVOLUTIONS_H_
#define MACHINA_CORE_KERNELS_EIGEN_BACKWARD_CUBOID_CONVOLUTIONS_H_
...
#endif  // MACHINA_CORE_KERNELS_EIGEN_BACKWARD_CUBOID_CONVOLUTIONS_H_
