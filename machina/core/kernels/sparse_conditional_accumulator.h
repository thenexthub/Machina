...
#ifndef MACHINA_CORE_KERNELS_SPARSE_CONDITIONAL_ACCUMULATOR_H_
#define MACHINA_CORE_KERNELS_SPARSE_CONDITIONAL_ACCUMULATOR_H_

#include "machina/core/kernels/typed_conditional_accumulator_base.h"
...
class SparseConditionalAccumulator
 ...
 protected:
  ...
  void AddToAccumGradFunction(
      OpKernelContext* ctx,
      std::tuple<const Tensor*, const Tensor*, const Tensor*>* grad) override {
    // Modeled after third_party/machina/core/kernels/sparse_add_op
...
#endif  // MACHINA_CORE_KERNELS_SPARSE_CONDITIONAL_ACCUMULATOR_H_
