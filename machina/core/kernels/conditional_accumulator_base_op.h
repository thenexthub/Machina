...
#ifndef MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_BASE_OP_H_
#define MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_BASE_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_CONDITIONAL_ACCUMULATOR_BASE_OP_H_
