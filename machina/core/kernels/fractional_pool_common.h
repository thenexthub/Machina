 ...
 *
 */
#ifndef MACHINA_CORE_KERNELS_FRACTIONAL_POOL_COMMON_H_
#define MACHINA_CORE_KERNELS_FRACTIONAL_POOL_COMMON_H_
...
#endif  // MACHINA_CORE_KERNELS_FRACTIONAL_POOL_COMMON_H_
