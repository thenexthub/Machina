...
#ifndef MACHINA_CORE_KERNELS_SPARSE_SLICE_GRAD_OP_H_
#define MACHINA_CORE_KERNELS_SPARSE_SLICE_GRAD_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_SPARSE_SLICE_GRAD_OP_H_
