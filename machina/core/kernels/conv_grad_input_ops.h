...
#ifndef MACHINA_CORE_KERNELS_CONV_GRAD_INPUT_OPS_H_
#define MACHINA_CORE_KERNELS_CONV_GRAD_INPUT_OPS_H_
...
class Conv2DCustomBackpropInputOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    auto worker_threads = *(context->device()->machina_cpu_worker_threads());
...
#endif  // MACHINA_CORE_KERNELS_CONV_GRAD_INPUT_OPS_H_
