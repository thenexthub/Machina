...
#ifndef MACHINA_CORE_KERNELS_TENSOR_CORD_H_
#define MACHINA_CORE_KERNELS_TENSOR_CORD_H_
...
class TensorCord {
 ...
 public:
  static constexpr const char kTypeName[] = "machina::TensorCord";
...
#endif  // MACHINA_CORE_KERNELS_TENSOR_CORD_H_
