...
#ifndef MACHINA_CORE_KERNELS_GATHER_FUNCTOR_BATCHED_H_
#define MACHINA_CORE_KERNELS_GATHER_FUNCTOR_BATCHED_H_
...
#endif  // MACHINA_CORE_KERNELS_GATHER_FUNCTOR_BATCHED_H_
