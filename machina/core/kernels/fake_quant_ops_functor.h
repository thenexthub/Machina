...
#ifndef MACHINA_CORE_KERNELS_FAKE_QUANT_OPS_FUNCTOR_H_
#define MACHINA_CORE_KERNELS_FAKE_QUANT_OPS_FUNCTOR_H_
...
template <typename T>
using ConstScalar = typename machina::TTypes<T>::ConstScalar;
template <typename T>
using Scalar = typename machina::TTypes<T>::Scalar;
template <typename T>
using ConstVec = typename machina::TTypes<T>::ConstVec;
template <typename T>
using Vec = typename machina::TTypes<T>::Vec;
template <typename T>
using ConstFlat = typename machina::TTypes<T>::ConstFlat;
template <typename T>
using Flat = typename machina::TTypes<T>::Flat;
...
using Index = typename machina::TTypes<float>::ConstTensor::Index;
...
#endif  // MACHINA_CORE_KERNELS_FAKE_QUANT_OPS_FUNCTOR_H_
