...
#ifndef MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OPS_TEST_H_
#define MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OPS_TEST_H_
...
template <typename T>
using is_integer = toolchain::is_one_of<T, int8_t, int16_t, int32_t, int64_t,
...
template <typename T, std::enable_if_t<
                          toolchain::is_one_of<T, Eigen::half, float, double>::value,
                          bool> = true>
...
template <typename T,
          std::enable_if_t<toolchain::is_one_of<T, std::complex<float>,
...
template <typename T,
          std::enable_if_t<toolchain::is_one_of<T, bool>::value, bool> = true>
absl::InlinedVector<T, 10> DefaultInput() {
...
#endif  // MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OPS_TEST_H_
