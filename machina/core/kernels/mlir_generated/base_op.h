...
#ifndef MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OP_H_
#define MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OP_H_
...
using DescriptorBuffer =
    toolchain::SmallVector<unsigned char,
...
class MLIROpKernel : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    toolchain::SmallVector<DescriptorBuffer, 4> buffers(ctx->num_inputs());
    toolchain::SmallVector<UnrankedMemRef, 4> args;
 ...
 protected:
  virtual UnrankedMemRef Invoke(
      OpKernelContext* ctx, toolchain::SmallVectorImpl<UnrankedMemRef>& args) = 0;
};
  ...
  class MLIR_OP(tf_op, platform, casted_input_type, casted_output_type)      \
   ...
   public:                                                                   \
    ...
    UnrankedMemRef Invoke(                                                   \
        OpKernelContext* ctx,                                                \
        toolchain::SmallVectorImpl<UnrankedMemRef>& args) override {              \
...
#endif  // MACHINA_CORE_KERNELS_MLIR_GENERATED_BASE_OP_H_
