 ...
 *
 */
#ifndef MACHINA_CORE_KERNELS_RESOURCE_VARIABLE_OPS_H_
#define MACHINA_CORE_KERNELS_RESOURCE_VARIABLE_OPS_H_
...
#endif  // MACHINA_CORE_KERNELS_RESOURCE_VARIABLE_OPS_H_
