...
#ifndef MACHINA_CORE_KERNELS_CONCAT_LIB_CPU_H_
#define MACHINA_CORE_KERNELS_CONCAT_LIB_CPU_H_
...
void ConcatCPUImpl(
  ...
  auto worker_threads = d->machina_cpu_worker_threads();
...
#endif  // MACHINA_CORE_KERNELS_CONCAT_LIB_CPU_H_
