...
#ifndef MACHINA_CORE_KERNELS_SPECTROGRAM_H_
#define MACHINA_CORE_KERNELS_SPECTROGRAM_H_
...
class Spectrogram {
 public:
  ...
  // in machina/core/kernels/spectrogram_test.cc.
  ...
  // For example in machina/core/kernels/spectrogram_op.cc
  bool Reset();
...
#endif  // MACHINA_CORE_KERNELS_SPECTROGRAM_H_
