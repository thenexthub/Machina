...
class StringNGramsOp : public machina::OpKernel {
 public:
  explicit StringNGramsOp(machina::OpKernelConstruction* context)
  ...
  void Compute(machina::OpKernelContext* context) override {
    ...
    const machina::Tensor* data;
    OP_REQUIRES_OK(context, context->input("data", &data));
    const auto& input_data = data->flat<tstring>().data();

    const machina::Tensor* splits;
