...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_WARMUP_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_WARMUP_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_WARMUP_H_
