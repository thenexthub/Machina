...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_CONCAT_SPLIT_UTIL_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_CONCAT_SPLIT_UTIL_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_CONCAT_SPLIT_UTIL_H_
