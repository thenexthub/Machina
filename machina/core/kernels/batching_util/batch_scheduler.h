...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_SCHEDULER_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_SCHEDULER_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_SCHEDULER_H_
