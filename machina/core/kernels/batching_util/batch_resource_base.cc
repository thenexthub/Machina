...
#include "machina/core/kernels/batching_util/batch_resource_base.h"
...
#include "machina/xla/tsl/platform/criticality.h"
#include "machina/core/common_runtime/cost_constants.h"
...
#include "machina/core/common_runtime/request_cost.h"
...
#include "machina/core/kernels/batching_util/batch_stats.h"
#include "machina/core/kernels/batching_util/concat_split_util.h"
#include "machina/core/kernels/batching_util/input_split_metadata.h"
#include "machina/core/kernels/batching_util/threadsafe_status.h"
#include "machina/core/kernels/batching_util/warmup.h"
...
#include "machina/core/util/incremental_barrier.h"
...
void RecordPaddingSize(int32_t padding_size, const string& model_name,
  ...
  static auto* cell = machina::monitoring::PercentileSampler<3>::New(
      {"/machina/serving/batching/padding_size",
      ...
      /*max_samples=*/1024, machina::monitoring::UnitOfMeasure::kNumber);
...
void RecordPaddingSizeV2(int32_t padding_size, const string& model_name,
  ...
  static auto* cell = machina::monitoring::Sampler<3>::New(
      {"/machina/serving/batching/padding_size_v2",
       "Tracks the padding size distribution on batches by model_name (if "
       "available).",
       "model_name", "execution_batch_size", "op_name"},
...
void RecordInputBatchSize(int32_t batch_size, const string& model_name,
  ...
  static auto* cell = machina::monitoring::PercentileSampler<2>::New(
      {"/machina/serving/batching/input_batch_size",
...
void RecordInputBatchSizeV2(int32_t batch_size, const string& model_name,
                            const string& op_name) {
  static auto* cell = machina::monitoring::Sampler<2>::New(
      {"/machina/serving/batching/input_batch_size_v2",
       "Tracks the batch size distribution on the inputs by model_name (if "
       "available).",
       "model_name", "op_name"},
...
void RecordBatchSize(int32_t batch_size, const string& model_name,
                     const string& op_name) {
  static auto* cell = machina::monitoring::Sampler<2>::New(
      {"/machina/serving/batching/batch_size",
...
void RecordProcessedBatchSize(int32_t batch_size, const string& model_name,
                              const string& op_name) {
  static auto* cell = machina::monitoring::PercentileSampler<2>::New(
      {"/machina/serving/batching/processed_batch_size",
...
void RecordProcessedBatchSizeV2(int32_t batch_size, const string& model_name,
  ...
  static auto* cell = monitoring::Counter<3>::New(
      "/machina/serving/batching/processed_batch_size_v2",
...
void RecordBatchDelayUs(int64_t batch_delay_us, const string& model_name,
  ...
  static auto* cell = monitoring::PercentileSampler<3>::New(
      {"/machina/serving/batching/batch_delay_us",
...
void RecordBatchDelayUsV2(int64_t batch_delay_us, const string& model_name,
                          const string& op_name, int32_t batch_size) {
  static auto* cell = machina::monitoring::Sampler<3>::New(
      {"/machina/serving/batching/batch_delay_us_v2",
       "Tracks the batching delay (in microseconds) for inputs by model_name "
       "(if available).",
       "model_name", "op_name", "processed_batch_size"},
...
void RecordBatchTaskSizeSum(int32_t batch_task_size,
  ...
  static auto* cell = machina::monitoring::Counter<3>::New(
      "/machina/serving/batching/batch_task_size_sum",
...
void RecordBatchParamBatchTimeoutMicros(int64_t batch_timeout_micros,
  ...
  static auto* cell = monitoring::Gauge<int64_t, 2>::New(
      "/machina/serving/batching/batch_timeout_micros",
...
void RecordBatchParamMaxBatchSize(int64_t max_batch_size,
                                  ...
                                  const string& op_name) {
  static auto* cell = monitoring::Gauge<int64_t, 2>::New(
      "/machina/serving/batching/max_batch_size",
...
void RecordBatchParamPaddingPolicy(const string& batch_padding_policy,
  ...
  static auto* cell = monitoring::Gauge<string, 2>::New(
      "/machina/serving/batching/configured_batch_padding_policy",
...
void RecordBatchParamMaxEnqueuedBatches(int64_t max_enqueued_batches,
                                        ...
                                        const string& op_name) {
  static auto* cell = monitoring::Gauge<int64_t, 2>::New(
      "/machina/serving/batching/max_enqueued_batches",
...
void RecordBatchParamAllowedBatchSizes(const string& allowed_batch_sizes,
                                       ...
                                       const string& op_name) {
  static auto* cell = monitoring::Gauge<string, 2>::New(
      "/machina/serving/batching/allowed_batch_sizes",
...
void RecordBatchCosts(const std::string& model_name,
  ...
  static auto* cell = machina::monitoring::Sampler<3>::New(
      {"/machina/serving/batching/costs",
...
using ::machina::concat_split_util::Concat;
using ::machina::concat_split_util::Split;
