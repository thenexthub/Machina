...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_RESOURCE_BASE_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_RESOURCE_BASE_H_
...
#include "machina/core/kernels/batching_util/adaptive_shared_batch_scheduler.h"
...
class BatchResourceBase : public ResourceBase {
 public:
  ...
  // specialized `slice`.
  struct BatchTask : public machina::serving::BatchTask {
  ...
  // machina::serving namespace, because some versions of compiler complain
  ...
  void set_session_metadata(machina::SessionMetadata session_metadata) {
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_RESOURCE_BASE_H_
