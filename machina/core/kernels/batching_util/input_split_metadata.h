...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_INPUT_SPLIT_METADATA_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_INPUT_SPLIT_METADATA_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_INPUT_SPLIT_METADATA_H_
