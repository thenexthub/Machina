...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_INPUT_TASK_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_INPUT_TASK_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_BATCH_INPUT_TASK_H_
