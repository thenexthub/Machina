...
#ifndef MACHINA_CORE_KERNELS_BATCHING_UTIL_PERIODIC_FUNCTION_H_
#define MACHINA_CORE_KERNELS_BATCHING_UTIL_PERIODIC_FUNCTION_H_
...
#endif  // MACHINA_CORE_KERNELS_BATCHING_UTIL_PERIODIC_FUNCTION_H_
