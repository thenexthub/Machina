 ...
 *
 */
#include "machina/core/kernels/data/cache_dataset_ops.h"
...
#include "machina/core/data/global_shuffle_utils.h"
...
#include "machina/core/kernels/data/cache_ops.h"
 ...
 private:
  absl::Status ExtendTempCacheToIndex(int64 index, OpKernelContext* ctx) {
    ...
    while (cache_.size() <= index) {
      ...
      if (end_of_sequence) {
        return machina::errors::OutOfRange("Index out of range [0, ",
                                              cache_.size(), "):", index);
      }
