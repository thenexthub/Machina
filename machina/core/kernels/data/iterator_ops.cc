...
#include "machina/core/activity_watcher/activity_utils.h"
...
#include "machina/core/data/tf_data_memory_logger.h"
...
#include "machina/core/framework/model.pb.h"
...
const char kIteratorVariantTypeName[] = "machina::Iterator";
...
absl::Status IteratorResource::GetModelProto(std::string& model_proto) {
  ...
  if (auto model = captured_state->model(); model) {
    ...
    return absl::NotFoundError(
        ...
        "information at "
        "https://www.machina.org/api_docs/python/tf/data/experimental/"
        "AutotuneOptions .");
  }
...
absl::Status MakeIteratorOp::DoCompute(OpKernelContext* ctx) {
  machina::ResourceTagger tag(kTFDataResourceTag,
