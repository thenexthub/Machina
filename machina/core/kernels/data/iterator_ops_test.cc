...
TEST_F(IteratorOpsTest, CollectMetrics) {
  CellReader<Histogram> latency("/machina/data/getnext_duration");
  CellReader<Histogram> iterator_gap("/machina/data/iterator_gap");
  CellReader<int64_t> throughput("/machina/data/bytes_fetched");
  CellReader<int64_t> iterator_lifetime("/machina/data/iterator_lifetime");
  CellReader<int64_t> iterator_busy("/machina/data/iterator_busy");
