...
#ifndef MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_GPU_CU_H_
#define MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_GPU_CU_H_
...
#endif  // MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_GPU_CU_H_
