 ...
 *
 */
#include "machina/core/kernels/stochastic_cast_op.h"
...
struct StochasticCastVerifier {
  ...
  typedef machina::random::UniformDistribution<Generator, Scalar>
      Distribution;
...
using Eigen::half;
using machina::random::PhiloxRandom;
...
class StochasticCastOpToIntTest : public OpsTestBase {
 ...
 protected:
  ...
  void ExhasutiveTestHelper(DataType in_type, DataType out_type) {
    ...
    machina::test::ExpectEqual(expected, *GetOutput(0));
  }
};
