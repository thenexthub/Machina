...
#include "machina/core/kernels/pooling_ops_common.h"
...
#include "machina/core/kernels/maxpooling_op_gpu.h"
#include "machina/core/kernels/pooling_ops_common_gpu.h"
 ...
 public:
  explicit MaxPoolingGradWithArgmaxOp(OpKernelConstruction* context)
    ...
    if (std::is_same<Device, GPUDevice>::value) {
      OP_REQUIRES(context, !machina::OpDeterminismRequired(),
