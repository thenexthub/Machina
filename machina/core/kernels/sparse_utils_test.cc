...
::machina::random::SimplePhilox& RandomPhilox() {
  // Safe initialization of static random generator.
  static auto* philox =
      new ::machina::random::PhiloxRandom(machina::testing::RandomSeed());
  static auto* rnd = new ::machina::random::SimplePhilox(philox);
  return *rnd;
}
