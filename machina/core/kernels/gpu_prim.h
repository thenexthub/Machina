...
==============================================================================*/
#ifndef MACHINA_CORE_KERNELS_GPU_PRIM_H_
#define MACHINA_CORE_KERNELS_GPU_PRIM_H_
...
struct NumericTraits<Eigen::half>
    : BaseTraits</*_CATEGORY=*/FLOATING_POINT, /*_PRIMITIVE=*/true,
                 ...
                 /*T=*/Eigen::half> {};
template <>
struct NumericTraits<machina::bfloat16>
    : BaseTraits</*_CATEGORY=*/FLOATING_POINT, /*_PRIMITIVE=*/true,
                 /*_NULL_TYPE=*/false, /*_UnsignedBits=*/uint16_t,
                 /*T=*/machina::bfloat16> {};
}  // namespace cub
...
template <>
struct radix_key_codec_base<machina::bfloat16>
    : radix_key_codec_floating<machina::bfloat16, uint16_t> {};
};  // namespace detail
};  // namespace rocprim

#endif  // MACHINA_USE_ROCM

#endif  // MACHINA_CORE_KERNELS_GPU_PRIM_H_
