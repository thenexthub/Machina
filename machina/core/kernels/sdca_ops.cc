...
#include "machina/core/kernels/hinge-loss.h"
#include "machina/core/kernels/logistic-loss.h"
#include "machina/core/kernels/loss.h"
#include "machina/core/kernels/poisson-loss.h"
#include "machina/core/kernels/sdca_internal.h"
#include "machina/core/kernels/smooth-hinge-loss.h"
#include "machina/core/kernels/squared-loss.h"
...
void DoCompute(const ComputeOptions& options, OpKernelContext* const context) {
  ...
  const DeviceBase::CpuWorkerThreads& worker_threads =
      *context->device()->machina_cpu_worker_threads();
