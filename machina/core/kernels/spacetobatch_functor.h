...
#ifndef MACHINA_CORE_KERNELS_SPACETOBATCH_FUNCTOR_H_
#define MACHINA_CORE_KERNELS_SPACETOBATCH_FUNCTOR_H_
...
#endif  // MACHINA_CORE_KERNELS_SPACETOBATCH_FUNCTOR_H_
