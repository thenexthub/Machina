...
#ifndef MACHINA_CORE_KERNELS_QUEUE_BASE_H_
#define MACHINA_CORE_KERNELS_QUEUE_BASE_H_
...
#include "machina/core/framework/queue_interface.h"
...
class QueueBase : public QueueInterface {
 public:
  ...
  // `machina::batch_util::CopySliceToElement()` defined in
  // "./batch_util.h" instead.
  ABSL_DEPRECATED(
      "Use `machina::batch_util::CopySliceToElement()` defined in "
      "\"./batch_util.h\" instead.")
...
#endif  // MACHINA_CORE_KERNELS_QUEUE_BASE_H_
