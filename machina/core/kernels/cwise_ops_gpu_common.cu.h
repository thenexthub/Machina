...
#ifndef MACHINA_CORE_KERNELS_CWISE_OPS_GPU_COMMON_CU_H_
#define MACHINA_CORE_KERNELS_CWISE_OPS_GPU_COMMON_CU_H_
...
#endif  // MACHINA_CORE_KERNELS_CWISE_OPS_GPU_COMMON_CU_H_
