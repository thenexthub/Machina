...
#ifndef MACHINA_CORE_KERNELS_STRING_TO_HASH_BUCKET_FAST_OP_H_
#define MACHINA_CORE_KERNELS_STRING_TO_HASH_BUCKET_FAST_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_STRING_TO_HASH_BUCKET_FAST_OP_H_
