...
#ifndef MACHINA_CORE_KERNELS_INITIALIZABLE_LOOKUP_TABLE_H_
#define MACHINA_CORE_KERNELS_INITIALIZABLE_LOOKUP_TABLE_H_
...
#endif  // MACHINA_CORE_KERNELS_INITIALIZABLE_LOOKUP_TABLE_H_
