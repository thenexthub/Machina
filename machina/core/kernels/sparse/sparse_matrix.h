...
#ifndef MACHINA_CORE_KERNELS_SPARSE_SPARSE_MATRIX_H_
#define MACHINA_CORE_KERNELS_SPARSE_SPARSE_MATRIX_H_
...
class CSRSparseMatrix {
  ...
  //
 public:
  static constexpr const char kTypeName[] = "machina::CSRSparseMatrix";
...
#endif  // MACHINA_CORE_KERNELS_SPARSE_SPARSE_MATRIX_H_
