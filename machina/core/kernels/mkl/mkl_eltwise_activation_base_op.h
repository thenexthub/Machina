...
#ifndef MACHINA_CORE_KERNELS_MKL_MKL_ELTWISE_ACTIVATION_BASE_OP_H_
#define MACHINA_CORE_KERNELS_MKL_MKL_ELTWISE_ACTIVATION_BASE_OP_H_
...
#endif  // INTEL_MKL
#endif  // MACHINA_CORE_KERNELS_MKL_MKL_ELTWISE_ACTIVATION_BASE_OP_H_
