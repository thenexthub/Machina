...
#ifndef MACHINA_CORE_KERNELS_MKL_MKL_KERNEL_UTIL_H_
#define MACHINA_CORE_KERNELS_MKL_MKL_KERNEL_UTIL_H_
...
class MklTestingUtil {
 public:
  ...
  static void RunGraph(const machina::GraphDef graph_def,
...
#endif  // INTEL_MKL
#endif  // MACHINA_CORE_KERNELS_MKL_MKL_KERNEL_UTIL_H_
