...
#include "machina/core/kernels/mkl/mkl_conv_ops.h"
...
#include "machina/core/kernels/mkl/mkl_quantized_conv_ops.h"
#include "machina/core/kernels/no_op.h"
 ...
 public:
  ...
  void Compute(OpKernelContext* context) override {
    try {
      ...
      string error_msg = machina::strings::StrCat(
