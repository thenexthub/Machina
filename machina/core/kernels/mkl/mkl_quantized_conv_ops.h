...
#ifndef MACHINA_CORE_KERNELS_MKL_MKL_QUANTIZED_CONV_OPS_H_
#define MACHINA_CORE_KERNELS_MKL_MKL_QUANTIZED_CONV_OPS_H_
...
#endif  // MACHINA_CORE_KERNELS_MKL_MKL_QUANTIZED_CONV_OPS_H_
