...
#ifndef MACHINA_CORE_KERNELS_MKL_MKL_POOLING_OPS_COMMON_H_
#define MACHINA_CORE_KERNELS_MKL_MKL_POOLING_OPS_COMMON_H_
...
#endif  // INTEL_MKL
#endif  // MACHINA_CORE_KERNELS_MKL_MKL_POOLING_OPS_COMMON_H_
