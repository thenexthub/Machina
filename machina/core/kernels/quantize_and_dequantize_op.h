...
#ifndef MACHINA_CORE_KERNELS_QUANTIZE_AND_DEQUANTIZE_OP_H_
#define MACHINA_CORE_KERNELS_QUANTIZE_AND_DEQUANTIZE_OP_H_
...
struct QuantizeAndDequantizePerChannelImpl {
  static void Compute(const Device& d, typename TTypes<T, 3>::ConstTensor input,
                      ...
                      QuantizerRoundMode round_mode, bool narrow_range,
                      typename TTypes<T, 3>::Tensor output) {
    using Index = typename machina::TTypes<T>::ConstTensor::Index;
...
}  // end of namespace machina

#endif  // MACHINA_CORE_KERNELS_QUANTIZE_AND_DEQUANTIZE_OP_H_
