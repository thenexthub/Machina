...
#include "machina/core/util/ctc/ctc_loss_calculator.h"
...
#if ((GOOGLE_CUDA && CUDNN_VERSION >= 7603) || MACHINA_USE_ROCM)
...
REGISTER_KERNEL_BUILDER(Name("CTCLossV2")
                        ...
                        CTCLossOpGPU);
#endif  // ((GOOGLE_CUDA && CUDNN_VERSION >= 7603)  || MACHINA_USE_ROCM)
