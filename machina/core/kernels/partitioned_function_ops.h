...
#ifndef MACHINA_CORE_KERNELS_PARTITIONED_FUNCTION_OPS_H_
#define MACHINA_CORE_KERNELS_PARTITIONED_FUNCTION_OPS_H_
...
#endif  // MACHINA_CORE_KERNELS_PARTITIONED_FUNCTION_OPS_H_
