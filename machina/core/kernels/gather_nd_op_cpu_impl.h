...
#ifndef MACHINA_CORE_KERNELS_GATHER_ND_OP_CPU_IMPL_H_
#define MACHINA_CORE_KERNELS_GATHER_ND_OP_CPU_IMPL_H_
...
#endif  // MACHINA_CORE_KERNELS_GATHER_ND_OP_CPU_IMPL_H_
