...
#ifndef MACHINA_CORE_KERNELS_COMPOSITE_TENSOR_VARIANT_H_
#define MACHINA_CORE_KERNELS_COMPOSITE_TENSOR_VARIANT_H_
...
#endif  // MACHINA_CORE_KERNELS_COMPOSITE_TENSOR_VARIANT_H_
