...
#ifndef MACHINA_CORE_KERNELS_EIGEN_CUBOID_CONVOLUTION_H_
#define MACHINA_CORE_KERNELS_EIGEN_CUBOID_CONVOLUTION_H_
...
#endif  // MACHINA_CORE_KERNELS_EIGEN_CUBOID_CONVOLUTION_H_
