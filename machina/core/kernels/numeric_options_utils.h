...
#ifndef MACHINA_CORE_KERNELS_NUMERIC_OPTIONS_UTILS_H_
#define MACHINA_CORE_KERNELS_NUMERIC_OPTIONS_UTILS_H_
...
#endif  // MACHINA_CORE_KERNELS_NUMERIC_OPTIONS_UTILS_H_
