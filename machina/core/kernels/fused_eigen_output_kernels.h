...
#ifndef MACHINA_CORE_KERNELS_FUSED_EIGEN_OUTPUT_KERNELS_H_
#define MACHINA_CORE_KERNELS_FUSED_EIGEN_OUTPUT_KERNELS_H_
...
#endif  // MACHINA_CORE_KERNELS_FUSED_EIGEN_OUTPUT_KERNELS_H_
