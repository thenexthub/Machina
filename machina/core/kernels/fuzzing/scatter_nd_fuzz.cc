...
class FuzzScatterNd : public FuzzSession {
  void BuildGraph(const Scope& scope) override {
    auto indices =
        machina::ops::Placeholder(scope.WithOpName("indices"), DT_INT32);
    auto updates =
        machina::ops::Placeholder(scope.WithOpName("updates"), DT_INT32);
    auto shape =
        machina::ops::Placeholder(scope.WithOpName("shape"), DT_INT32);
    (void)machina::ops::ScatterNd(scope.WithOpName("output"), indices,
                                     updates, shape);
  }
  ...
  void FuzzImpl(const uint8_t* data, size_t size) override {
    ...
    Tensor shape_tensor(machina::DT_INT32,
    ...
    Tensor indices_tensor(machina::DT_INT32, TensorShape(indices_dims));
    ...
    Tensor updates_tensor(machina::DT_INT32, TensorShape(updates_dims));
