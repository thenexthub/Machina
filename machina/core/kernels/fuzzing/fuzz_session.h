...
#ifndef MACHINA_CORE_KERNELS_FUZZING_FUZZ_SESSION_H_
#define MACHINA_CORE_KERNELS_FUZZING_FUZZ_SESSION_H_
...
#define SINGLE_INPUT_OP_BUILDER(dtype, opName)                          \
  void BuildGraph(const Scope& scope) override {                        \
    ...
    (void)machina::ops::opName(scope.WithOpName("output"), op_node); \
  }
...
#endif  // MACHINA_CORE_KERNELS_FUZZING_FUZZ_SESSION_H_
