...
#ifndef MACHINA_CORE_KERNELS_EIGEN_BENCHMARK_H_
#define MACHINA_CORE_KERNELS_EIGEN_BENCHMARK_H_

#include "unsupported/Eigen/CXX11/Tensor"  // from @eigen_archive
#include "machina/xla/tsl/framework/convolution/eigen_spatial_convolutions.h"
#include "machina/core/framework/tensor_types.h"
#include "machina/core/kernels/eigen_backward_cuboid_convolutions.h"
#include "machina/core/kernels/eigen_backward_spatial_convolutions.h"
#include "machina/core/kernels/eigen_cuboid_convolution.h"
#include "machina/core/platform/test_benchmark.h"

using ::machina::TTypes;
 ...
 public:
  ...
  void SpatialConvolution(Dimensions input_dims, Dimensions filter_dims) {
    ...
    for (auto s : state_) {
      ...
      machina::testing::DoNotOptimize(output);
    }
  ...
  void SpatialConvolutionBackwardInput(Dimensions input_dims,
    ...
    for (auto s : state_) {
      ...
      machina::testing::DoNotOptimize(input_backward);
    }
  ...
  void SpatialConvolutionBackwardKernel(Dimensions input_dims,
    ...
    for (auto s : state_) {
      ...
      machina::testing::DoNotOptimize(filter_backward);
    }
...
#endif  // MACHINA_CORE_KERNELS_EIGEN_BENCHMARK_H_
