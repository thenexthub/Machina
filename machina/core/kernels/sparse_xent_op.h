...
#ifndef MACHINA_CORE_KERNELS_SPARSE_XENT_OP_H_
#define MACHINA_CORE_KERNELS_SPARSE_XENT_OP_H_
...
class SparseXentLossGenerator {
 public:
  ...
  operator()(const Eigen::array<int, 2>& coords) const {
    ...
    const Index label = machina::internal::SubtleMustCopy(labels_(batch));
...
#endif  // MACHINA_CORE_KERNELS_SPARSE_XENT_OP_H_
