...
#ifndef MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_H_
#define MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_H_
...
#endif  // MACHINA_CORE_KERNELS_SEGMENT_REDUCTION_OPS_H_
