...
#ifndef MACHINA_CORE_KERNELS_LINALG_MATRIX_SOLVE_LS_OP_IMPL_H_
#define MACHINA_CORE_KERNELS_LINALG_MATRIX_SOLVE_LS_OP_IMPL_H_
...
#endif  // MACHINA_CORE_KERNELS_LINALG_MATRIX_SOLVE_LS_OP_IMPL_H_
