...
#ifndef MACHINA_CORE_KERNELS_LINALG_MATRIX_SET_DIAG_OP_H_
#define MACHINA_CORE_KERNELS_LINALG_MATRIX_SET_DIAG_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_LINALG_MATRIX_SET_DIAG_OP_H_
