 ...
 *
 */
#ifndef MACHINA_CORE_KERNELS_LINALG_LINALG_OPS_COMMON_H_
#define MACHINA_CORE_KERNELS_LINALG_LINALG_OPS_COMMON_H_
...
#endif  // MACHINA_CORE_KERNELS_LINALG_LINALG_OPS_COMMON_H_
