...
#ifndef MACHINA_CORE_KERNELS_LINALG_MATRIX_BAND_PART_OP_H_
#define MACHINA_CORE_KERNELS_LINALG_MATRIX_BAND_PART_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_LINALG_MATRIX_BAND_PART_OP_H_
