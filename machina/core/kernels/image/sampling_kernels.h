...
#ifndef MACHINA_CORE_KERNELS_IMAGE_SAMPLING_KERNELS_H_
#define MACHINA_CORE_KERNELS_IMAGE_SAMPLING_KERNELS_H_
...
#endif  // MACHINA_CORE_KERNELS_IMAGE_SAMPLING_KERNELS_H_
