...
#include "machina/core/kernels/image/non_max_suppression_op.h"
...
class GenerateBoundingBoxProposals : public machina::OpKernel {
 public:
...
REGISTER_KERNEL_BUILDER(Name("GenerateBoundingBoxProposals")
                        ...
                        machina::GenerateBoundingBoxProposals);
}  // namespace machina
#endif
