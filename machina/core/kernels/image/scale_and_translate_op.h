...
#ifndef MACHINA_CORE_KERNELS_IMAGE_SCALE_AND_TRANSLATE_OP_H_
#define MACHINA_CORE_KERNELS_IMAGE_SCALE_AND_TRANSLATE_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_IMAGE_SCALE_AND_TRANSLATE_OP_H_
