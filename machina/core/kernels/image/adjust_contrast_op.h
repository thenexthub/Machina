...
#ifndef MACHINA_CORE_KERNELS_IMAGE_ADJUST_CONTRAST_OP_H_
#define MACHINA_CORE_KERNELS_IMAGE_ADJUST_CONTRAST_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_IMAGE_ADJUST_CONTRAST_OP_H_
