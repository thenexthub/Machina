...
#ifndef MACHINA_CORE_KERNELS_STATEFUL_RANDOM_OPS_CPU_GPU_H_
#define MACHINA_CORE_KERNELS_STATEFUL_RANDOM_OPS_CPU_GPU_H_
...
#endif  // MACHINA_CORE_KERNELS_STATEFUL_RANDOM_OPS_CPU_GPU_H_
