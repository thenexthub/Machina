...
#ifndef MACHINA_CORE_KERNELS_STATELESS_RANDOM_GAMMA_OP_H_
#define MACHINA_CORE_KERNELS_STATELESS_RANDOM_GAMMA_OP_H_
...
#endif  // MACHINA_CORE_KERNELS_STATELESS_RANDOM_GAMMA_OP_H_
