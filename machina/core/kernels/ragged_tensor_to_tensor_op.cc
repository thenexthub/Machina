...
#include "machina/core/kernels/broadcast_to_op.h"
...
#include "machina/core/util/ragged_to_dense_util.h"
...
class RaggedTensorToTensorBaseOp : public OpKernel {
 public:
  typedef
      typename ::machina::TTypes<const INDEX_TYPE>::Flat RowPartitionTensor;
...
#define REGISTER_CPU_KERNEL(value_type)                \
  ...
  REGISTER_CPU_KERNEL_INDEX_TYPE(value_type, machina::int32);
