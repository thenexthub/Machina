...
#ifndef MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_H_
#define MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_H_
  ...
  Index ParallelExecute(OpKernelContext* c, const Device& d,
    ...
    auto ParallelScatter = [&](Index start, Index end) {
      for (Index i = start; i < end; ++i) {
        ...
        // between).
        const Index index = ::machina::internal::SubtleMustCopy(indices(i));
    ...
    const DeviceBase::CpuWorkerThreads& worker_threads =
        *(c->device()->machina_cpu_worker_threads());
...
#endif  // MACHINA_CORE_KERNELS_SCATTER_FUNCTOR_H_
