...
class TestGpuRadixSortKernel : public machina::OpKernel {
 public:
  explicit TestGpuRadixSortKernel(machina::OpKernelConstruction* context)
      : OpKernel(context) {
...
template <typename T>
class TestGpuInclusivePrefixSumKernel : public machina::OpKernel {
 public:
...
class TestGpuSegmentedReduceKernel : public machina::OpKernel {
 public:
...
template <typename T>
class TestGpuSelectFlaggedKernel : public machina::OpKernel {
 public:
  explicit TestGpuSelectFlaggedKernel(machina::OpKernelConstruction* context)
      : OpKernel(context) {
