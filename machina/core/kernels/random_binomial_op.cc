...
#include "machina/core/kernels/random_binomial_op.h"
...
#include "machina/core/kernels/stateful_random_ops_cpu_gpu.h"
#include "machina/core/kernels/stateless_random_ops.h"
...
#include "machina/core/util/guarded_philox_random.h"
...
struct RandomBinomialFunctor<CPUDevice, T, U> {
  void operator()(OpKernelContext* ctx, const CPUDevice& d, int64_t num_batches,
    ...
    auto worker_threads = *(ctx->device()->machina_cpu_worker_threads());
...
class RandomBinomialOp : public OpKernel {
 ...
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    machina::BCast bcast(counts_tensor.shape().dim_sizes(),
