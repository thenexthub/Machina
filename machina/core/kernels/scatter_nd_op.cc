...
#include "machina/core/kernels/inplace_ops_functor.h"
#include "machina/core/kernels/scatter_nd_op.h"
 ...
 public:
  ...
  void Compute(OpKernelContext* c) override {
    ...
    if (forwarded_input == nullptr) {
      ...
      OP_REQUIRES_OK(c, machina::functor::DoCopy(c->eigen_device<Device>(),
                                                    input, out));
