...
#ifndef MACHINA_CORE_KERNELS_SMOOTH_HINGE_LOSS_H_
#define MACHINA_CORE_KERNELS_SMOOTH_HINGE_LOSS_H_
...
#endif  // MACHINA_CORE_KERNELS_SMOOTH_HINGE_LOSS_H_
// MACHINA_KERNELS_SMOOTH_HINGE_LOSS_H_
