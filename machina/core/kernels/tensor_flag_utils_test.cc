...
#include "machina/core/kernels/tensor_flag_utils.h"
...
using machina::tensor_flag_utils::FindConfigValueForKey;
using machina::tensor_flag_utils::GetLinearBucket;
using machina::tensor_flag_utils::GetPowerBucket;
using machina::tensor_flag_utils::ValidateScalarQuantityShardingConfig;
using machina::tensor_flag_utils::ValidateSparseMatrixShardingConfig;
