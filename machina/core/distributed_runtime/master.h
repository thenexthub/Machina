...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_MASTER_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_MASTER_H_
...
class Master {
 public:
  ...
  // See machina::Reset() and the comment on ResetRequest.
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_MASTER_H_
