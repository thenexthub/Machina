...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_SERVICE_IMPL_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_SERVICE_IMPL_H_
...
class EagerServiceImpl {
 public:
  ...
  absl::Status CreateMasterContext(const machina::uint64 context_id,
 ...
 protected:
  ...
  class ServerContext : public core::RefCounted {
   public:
    ...
    static ServerContext* CreateMasterContext(machina::EagerContext* ctx,
                                              const WorkerEnv* env) {
      return new ServerContext(ctx, -1, env, /* is_master= */ true);
    }

    explicit ServerContext(machina::EagerContext* ctx,
      ...
      destroy_after_micros_ =
          destroy_after_secs * machina::EnvTime::kSecondsToMicros;
      RecordAccess();
    }
    ...
    machina::EagerContext* Context() const { return ctx_; }
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_SERVICE_IMPL_H_
