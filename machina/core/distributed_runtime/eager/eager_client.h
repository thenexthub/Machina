...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_CLIENT_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_CLIENT_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_EAGER_EAGER_CLIENT_H_
