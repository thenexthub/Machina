...
absl::Status WithErrorSourcePayload(absl::Status error) {
  ...
  error.SetPayload(machina::kErrorSource,
...
void RemoteMgr::AddOperationOutput(machina::TensorHandle* handle,
