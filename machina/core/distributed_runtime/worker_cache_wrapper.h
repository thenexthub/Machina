...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_CACHE_WRAPPER_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_CACHE_WRAPPER_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_CACHE_WRAPPER_H_
