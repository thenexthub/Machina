...
void EnableCoordinationService(machina::ServerDef* server_def) {
...
TEST_P(SingleClientTest, SetGetConfigInOpTest) {
  ...
  machina::ServerDef server_def = GetServerDef(job_name, num_workers);
  ...
  std::unique_ptr<machina::ServerInterface> workers[3];
