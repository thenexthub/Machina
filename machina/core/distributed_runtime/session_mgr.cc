...
#include "machina/xla/tsl/protobuf/distributed_runtime_payloads.pb.h"
...
#include "machina/core/distributed_runtime/error_payloads.h"
...
void SetCoordinatedJobList(const ServerDef& server_def,
  ...
  for (const auto& job : server_def.cluster().job()) {
    machina::CoordinatedJob* coordinated_job =
