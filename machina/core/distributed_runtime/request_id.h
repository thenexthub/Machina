...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_REQUEST_ID_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_REQUEST_ID_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_REQUEST_ID_H_
