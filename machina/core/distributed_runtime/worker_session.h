...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_SESSION_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_SESSION_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_WORKER_SESSION_H_
