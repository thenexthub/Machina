...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_EAGER_GRPC_EAGER_SERVICE_IMPL_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_EAGER_GRPC_EAGER_SERVICE_IMPL_H_
...
#include "machina/core/distributed_runtime/rpc/eager/grpc_eager_service.h"
...
class GrpcEagerServiceImpl : public tsl::AsyncServiceInterface {
 public:
  ...
  absl::Status CreateMasterContext(machina::uint64 context_id,
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_EAGER_GRPC_EAGER_SERVICE_IMPL_H_
