...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
