...
#include "machina/xla/tsl/distributed_runtime/rpc/grpc_call.h"
#include "machina/xla/tsl/protobuf/rpc_options.pb.h"
#include "machina/core/common_runtime/buf_rendezvous.h"
...
#include "machina/core/distributed_runtime/rpc/grpc_tensor_coding.h"
...
#include "machina/core/distributed_runtime/rpc/rpc_response_cache.h"
#include "machina/core/distributed_runtime/worker.h"
...
#include "machina/core/protobuf/transport_options.pb.h"
...
void GrpcWorker::GrpcRecvTensorAsync(CallOptions* opts,
  ...
  env_->rendezvous_mgr->RecvLocalAsync(
      ...
      [opts, rendezvous_done, src_dev, request](
        ...
        if (!src_dev->machina_accelerator_device_info() || on_host) {
          return rendezvous_done(val, is_dead, status);
        }
        ...
        CHECK(send_dev_context)
            ...
            << " gpu_info: " << src_dev->machina_accelerator_device_info();
