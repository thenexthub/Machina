...
#include "machina/core/distributed_runtime/rpc/grpc_master_service_impl.h"
...
static const char* grpcMasterService_method_names[] = {
    "/machina.MasterService/CreateSession",
    "/machina.MasterService/ExtendSession",
    "/machina.MasterService/PartialRunSetup",
    "/machina.MasterService/RunStep",
    "/machina.MasterService/CloseSession",
    "/machina.MasterService/ListDevices",
    "/machina.MasterService/Reset",
    "/machina.MasterService/MakeCallable",
    "/machina.MasterService/RunCallable",
    "/machina.MasterService/ReleaseCallable",
};
