...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_SERVER_LIB_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_SERVER_LIB_H_
...
class GrpcServer : public ServerInterface {
 ...
 public:
  ...
  absl::Status AddMasterEagerContextToEagerService(
      const machina::uint64 context_id,
      machina::EagerContext* context) override;
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_SERVER_LIB_H_
