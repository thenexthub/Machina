...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
