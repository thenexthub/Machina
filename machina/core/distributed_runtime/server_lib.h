...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
...
class ServerInterface {
 public:
  ...
  virtual absl::Status AddMasterEagerContextToEagerService(
      const machina::uint64 context_id, EagerContext* context) = 0;
...
class ServerFactory {
 public:
  struct Options {
    ...
    machina::DeviceMgr* local_device_mgr;
  };
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
