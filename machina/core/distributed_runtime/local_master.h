...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_LOCAL_MASTER_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_LOCAL_MASTER_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_LOCAL_MASTER_H_
