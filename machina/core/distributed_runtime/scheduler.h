...
#ifndef MACHINA_CORE_DISTRIBUTED_RUNTIME_SCHEDULER_H_
#define MACHINA_CORE_DISTRIBUTED_RUNTIME_SCHEDULER_H_
...
#endif  // MACHINA_CORE_DISTRIBUTED_RUNTIME_SCHEDULER_H_
