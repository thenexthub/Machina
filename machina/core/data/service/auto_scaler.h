...
#ifndef MACHINA_CORE_DATA_SERVICE_AUTO_SCALER_H_
#define MACHINA_CORE_DATA_SERVICE_AUTO_SCALER_H_
...
// Exports a metric (/machina/data/service/optimal_number_of_workers) with
...
#endif  // MACHINA_CORE_DATA_SERVICE_AUTO_SCALER_H_
