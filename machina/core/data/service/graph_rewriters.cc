 ...
 *
 */
#include "machina/core/data/service/graph_rewriters.h"
...
#include "machina/core/grappler/optimizers/data/auto_shard.h"
...
#include "machina/core/kernels/data/experimental/auto_shard_dataset_op.h"
...
using ::machina::data::experimental::AutoShardDatasetOp;
...
RemoveCompressionMapRewriter::ApplyRemoveCompressionMapRewrite(
  ...
  machina::RewriterConfig::CustomGraphOptimizer config = GetRewriteConfig();
...
machina::RewriterConfig::CustomGraphOptimizer
RemoveCompressionMapRewriter::GetRewriteConfig() const {
  machina::RewriterConfig::CustomGraphOptimizer config;
