 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_CLIENT_VALIDATE_UTILS_H_
#define MACHINA_CORE_DATA_SERVICE_CLIENT_VALIDATE_UTILS_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_CLIENT_VALIDATE_UTILS_H_
