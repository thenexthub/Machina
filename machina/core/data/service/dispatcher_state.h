 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_DISPATCHER_STATE_H_
#define MACHINA_CORE_DATA_SERVICE_DISPATCHER_STATE_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_DISPATCHER_STATE_H_
