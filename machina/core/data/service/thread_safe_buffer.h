 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_THREAD_SAFE_BUFFER_H_
#define MACHINA_CORE_DATA_SERVICE_THREAD_SAFE_BUFFER_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_THREAD_SAFE_BUFFER_H_
