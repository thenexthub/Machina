 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_STREAM_WRITER_H_
#define MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_STREAM_WRITER_H_
...
#include "machina/core/data/service/snapshot/parallel_tfrecord_writer.h"
#include "machina/core/data/service/snapshot/path_utils.h"
#include "machina/core/data/service/task_runner.h"
...
struct SnapshotWriterParams {
  ...
  std::string StreamDirectory() const {
    return machina::data::StreamDirectory(snapshot_path, stream_index);
  }
  ...
  std::string UncommittedChunksDirectory() const {
    return machina::data::UncommittedChunksDirectory(snapshot_path,
                                                        stream_index);
  }

  std::string CheckpointsDirectory() const {
    return machina::data::CheckpointsDirectory(snapshot_path, stream_index);
  }
...
#endif  // MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_STREAM_WRITER_H_
