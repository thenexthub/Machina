 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_MANAGER_H_
#define MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_MANAGER_H_
...
#include "machina/core/data/service/snapshot/prefetched_split_provider.h"
...
class SnapshotManager {
 ...
 private:
  ...
  // A machina environment interface used to write to and read from `path_`.
  tsl::Env* const env_;
...
#endif  // MACHINA_CORE_DATA_SERVICE_SNAPSHOT_SNAPSHOT_MANAGER_H_
