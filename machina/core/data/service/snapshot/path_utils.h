 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_SNAPSHOT_PATH_UTILS_H_
#define MACHINA_CORE_DATA_SERVICE_SNAPSHOT_PATH_UTILS_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_SNAPSHOT_PATH_UTILS_H_
