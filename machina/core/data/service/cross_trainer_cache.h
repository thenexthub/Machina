 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_CROSS_TRAINER_CACHE_H_
#define MACHINA_CORE_DATA_SERVICE_CROSS_TRAINER_CACHE_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_CROSS_CLIENT_CACHE_H_
