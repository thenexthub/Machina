...
#ifndef MACHINA_CORE_DATA_SERVICE_GRPC_UTIL_H_
#define MACHINA_CORE_DATA_SERVICE_GRPC_UTIL_H_
...
// Wraps a grpc::Status in a machina::Status with the given message.
...
#endif  // MACHINA_CORE_DATA_SERVICE_GRPC_UTIL_H_
