 ...
 *
 */
#ifndef MACHINA_CORE_DATA_SERVICE_DISPATCHER_CLIENT_H_
#define MACHINA_CORE_DATA_SERVICE_DISPATCHER_CLIENT_H_
...
#endif  // MACHINA_CORE_DATA_SERVICE_DISPATCHER_CLIENT_H_
