 ...
 *
 */
#ifndef MACHINA_CORE_DATA_STANDALONE_H_
#define MACHINA_CORE_DATA_STANDALONE_H_
...
#include "machina/core/data/unbounded_thread_pool.h"
...
//   machina::data:standalone::Dataset::Params params;
//   std::unique_ptr<machina::data::standalone::Dataset> dataset;
//   Status s = machina::data::standalone::Dataset::FromGraph(
//      params, graph_def, &dataset);
//   if (!s.ok()) { /* error handling */ }
//
//   std::unique_ptr<machina::data::standalone::Iterator> iterator;
...
#endif  // MACHINA_CORE_DATA_STANDALONE_H_
