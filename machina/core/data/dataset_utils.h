 ...
 *
 */
#ifndef MACHINA_CORE_DATA_DATASET_UTILS_H_
#define MACHINA_CORE_DATA_DATASET_UTILS_H_
...
#define REGISTER_DATASET_OP_NAME_UNIQ(ctr, experiment, job_selector, \
                                      task_selector)                 \
  static ::machina::data::DatasetExperimentRegistrar              \
...
#endif  // MACHINA_CORE_DATA_DATASET_UTILS_H_
