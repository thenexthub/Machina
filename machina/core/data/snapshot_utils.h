...
#ifndef MACHINA_CORE_DATA_SNAPSHOT_UTILS_H_
#define MACHINA_CORE_DATA_SNAPSHOT_UTILS_H_
...
#include "machina/core/lib/io/compression.h"
...
class Writer {
 ...
 protected:
  virtual absl::Status Initialize(machina::Env* env) = 0;
};
...
class TFRecordWriter : public Writer {
 public:
  ...
  absl::Status Initialize(machina::Env* env) override;
...
class TFRecordReaderImpl {
 public:
  ...
  // machina/compiler/xla/tsl/lib/io/compression.h.
...
#endif  // MACHINA_CORE_DATA_SNAPSHOT_UTILS_H_
