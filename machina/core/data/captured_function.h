 ...
 *
 */
#ifndef MACHINA_CORE_DATA_CAPTURED_FUNCTION_H_
#define MACHINA_CORE_DATA_CAPTURED_FUNCTION_H_
...
class FunctionMetadata {
 public:
  ...
  static absl::Status Create(machina::OpKernelConstruction* ctx,
...
#endif  // MACHINA_CORE_DATA_CAPTURED_FUNCTION_H_
