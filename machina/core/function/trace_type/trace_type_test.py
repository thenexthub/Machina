...
from machina.core.function.trace_type import custom_nest_trace_type
from machina.core.function.trace_type import default_types
...
class TraceTypeBuilderTest(test.TestCase, parameterized.TestCase):
  ...
  def testWrappedNamedTuple(self):
    ...
    class MockWrapper(tuple):
      ...
      # //machina/python/trackable/data_structures.py
