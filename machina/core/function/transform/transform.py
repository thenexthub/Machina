...
from machina.core.function.runtime_client import runtime_client
...
from machina.python.ops import custom_gradient as custom_gradient_lib
...
def transform_atomic_function(
  ...
  # pylint: disable=protected-access
  # Ref: third_party/machina/python/ops/control_flow_util_v2.py
