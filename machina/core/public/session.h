...
#ifndef MACHINA_CORE_PUBLIC_SESSION_H_
#define MACHINA_CORE_PUBLIC_SESSION_H_
...
///     std::unique_ptr<machina::Session>
///     session(machina::NewSession(options));
///
...
#endif  // MACHINA_CORE_PUBLIC_SESSION_H_
