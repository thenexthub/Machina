...
#ifndef MACHINA_CORE_OPS_COMPAT_OP_COMPATIBILITY_LIB_H_
#define MACHINA_CORE_OPS_COMPAT_OP_COMPATIBILITY_LIB_H_
...
#endif  // MACHINA_CORE_OPS_COMPAT_OP_COMPATIBILITY_LIB_H_
