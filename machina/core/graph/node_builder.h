...
#ifndef MACHINA_CORE_GRAPH_NODE_BUILDER_H_
#define MACHINA_CORE_GRAPH_NODE_BUILDER_H_
...
class NodeBuilder {
 public:
  ...
  // Sets the device name in the "assigned device" field in machina::Node.
...
#endif  // MACHINA_CORE_GRAPH_NODE_BUILDER_H_
