...
#include "machina/cc/ops/random_ops.h"
...
TEST_F(GraphPartitionTest, CrossDeviceLoopSimple) {
  ...
  auto a2 = ::machina::ops::internal::Enter(in_.WithOpName("A2"), a1, "foo");
  auto a3 = ::machina::ops::Merge(in_.WithOpName("A3"),
...
TEST_F(GraphPartitionTest, CrossDeviceLoopSimple1) {
  auto a1 = BoolInput(in_.WithOpName("A1"));
  auto a2 = ::machina::ops::internal::Enter(in_.WithOpName("B2"), a1, "foo");
  auto a3 = ::machina::ops::Merge(in_.WithOpName("A3"),
...
TEST(TopologicalSortNodesWithTimePriority, WhileLoop) {
  ...
  using namespace ::machina::ops::internal;  // NOLINT(build/namespaces)
