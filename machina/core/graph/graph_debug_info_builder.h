...
#ifndef MACHINA_CORE_GRAPH_GRAPH_DEBUG_INFO_BUILDER_H_
#define MACHINA_CORE_GRAPH_GRAPH_DEBUG_INFO_BUILDER_H_
...
using StackTracesMap =
    absl::flat_hash_map<std::string,
                        std::shared_ptr<machina::AbstractStackTrace>>;
...
#endif  // MACHINA_CORE_GRAPH_GRAPH_DEBUG_INFO_BUILDER_H_
