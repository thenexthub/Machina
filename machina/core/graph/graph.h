...
#ifndef MACHINA_CORE_GRAPH_GRAPH_H_
#define MACHINA_CORE_GRAPH_GRAPH_H_
...
#include "machina/core/lib/core/arena.h"
...
enum class ConstructionContext {
  ...
  kDirectSession,  // From `machina::DirectSession`, TF1 session API.
...
#endif  // MACHINA_CORE_GRAPH_GRAPH_H_
