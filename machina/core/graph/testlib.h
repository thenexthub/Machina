...
// DEPRECATED: Use the C++ API defined in machina/cc instead.

#ifndef MACHINA_CORE_GRAPH_TESTLIB_H_
#define MACHINA_CORE_GRAPH_TESTLIB_H_
...
#endif  // MACHINA_CORE_GRAPH_TESTLIB_H_
