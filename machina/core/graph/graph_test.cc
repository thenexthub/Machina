...
#include "machina/core/graph/benchmark_testlib.h"
...
TEST(AddInput, AddsControlSlot) {
  ...
  machina::Graph::AddInput(&node_def, input_name, Graph::kControlSlot);
...
TEST(AddInput, AddsSourceSlotZero) {
  ...
  machina::Graph::AddInput(&node_def, input_name, 0);
...
TEST(AddInput, AddsOtherSlots) {
  ...
  machina::Graph::AddInput(&node_def, input_name, arbitrary_slot);
