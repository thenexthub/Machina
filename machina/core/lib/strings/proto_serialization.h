 ...
 *
 */
#ifndef MACHINA_CORE_LIB_STRINGS_PROTO_SERIALIZATION_H_
#define MACHINA_CORE_LIB_STRINGS_PROTO_SERIALIZATION_H_
...
#endif  // MACHINA_CORE_LIB_STRINGS_PROTO_SERIALIZATION_H_
