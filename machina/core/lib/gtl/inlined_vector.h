...
#ifndef MACHINA_CORE_LIB_GTL_INLINED_VECTOR_H_
#define MACHINA_CORE_LIB_GTL_INLINED_VECTOR_H_

#include "machina/xla/tsl/lib/gtl/inlined_vector.h"  // IWYU pragma: export
...
#endif  // MACHINA_CORE_LIB_GTL_INLINED_VECTOR_H_
