...
#ifndef MACHINA_CORE_LIB_GTL_MANUAL_CONSTRUCTOR_H_
#define MACHINA_CORE_LIB_GTL_MANUAL_CONSTRUCTOR_H_
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size)                          \
  typename machina::gtl::internal::AlignType<TF_LIB_GTL_ALIGN_OF(T), \
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size) \
  machina::gtl::internal::AlignType<Size * sizeof(T)>::result
...
#endif  // MACHINA_CORE_LIB_GTL_MANUAL_CONSTRUCTOR_H_
