...
auto* gauge_with_labels = Gauge<int64_t, 1>::New(
    "/machina/test/gauge_with_labels", "Gauge with one label.", "MyLabel");
...
auto* gauge_without_labels = Gauge<int64_t, 0>::New(
    "/machina/test/gauge_without_labels", "Gauge without any labels.");
...
auto* string_gauge = Gauge<string, 0>::New("/machina/test/string_gauge",
...
auto* bool_gauge =
    Gauge<bool, 0>::New("/machina/test/bool_gauge", "Gauge of bool value.");
