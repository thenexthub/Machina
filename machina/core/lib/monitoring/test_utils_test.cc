...
TEST(PercentilesTest, Percentiles) {
  machina::monitoring::Percentiles percentiles_value;
...
TEST(PercentilesTest, Subtract) {
  machina::monitoring::Percentiles percentiles_value1;
  ...
  machina::monitoring::Percentiles percentiles_value2;
...
TEST(PercentilesTest, SubtractEmptyPercentile) {
  ...
  Percentiles empty_percentile((machina::monitoring::Percentiles()));
