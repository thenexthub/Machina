...
auto* sampler_with_labels =
    Sampler<1>::New({"/machina/test/sampler_with_labels",
...
auto* init_sampler_without_labels =
    Sampler<0>::New({"/machina/test/init_sampler_without_labels",
...
auto* sampler_without_labels =
    Sampler<0>::New({"/machina/test/sampler_without_labels",
                     "Sampler without labels initialized as empty."},
...
auto* sampler_with_exponential =
    Sampler<1>::New({"/machina/test/sampler_with_exponential",
...
TEST(ExplicitSamplerTest, SameName) {
  auto* same_sampler = Sampler<1>::New({"/machina/test/sampler_with_labels",
                                        "Sampler with one label.", "MyLabel"},
                                       Buckets::Explicit({10.0, 20.0}));
