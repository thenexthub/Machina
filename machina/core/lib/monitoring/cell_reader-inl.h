 ...
 *
 */
#ifndef MACHINA_CORE_LIB_MONITORING_CELL_READER_INL_H_
#define MACHINA_CORE_LIB_MONITORING_CELL_READER_INL_H_
...
#endif  // MACHINA_CORE_LIB_MONITORING_CELL_READER_INL_H_
