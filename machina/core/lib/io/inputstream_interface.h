...
#ifndef MACHINA_CORE_LIB_IO_INPUTSTREAM_INTERFACE_H_
#define MACHINA_CORE_LIB_IO_INPUTSTREAM_INTERFACE_H_
...
#endif  // MACHINA_CORE_LIB_IO_INPUTSTREAM_INTERFACE_H_
