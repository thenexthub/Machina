...
class RuntimeFallbackOpHandler : public tfrt::OpHandler {
 ...
 private:
  ...
  friend toolchain::Expected<tfrt::OpHandler*> CreateRuntimeFallbackOpHandler(
...
static Expected<tfrt::RCReference<tfrt::Device>> GetDeviceFromFallbackTensor(
  ...
  // update c_api_tfrt layer to get it directly from machina::TensorHandle.
...
struct RuntimeFallbackOpHandlerTraits {
  ...
  static void Dispatch(const RuntimeFallbackOpEntry& op_entry,
                       ...
                       toolchain::ArrayRef<Tensor*> inputs, const OpAttrsRef& attrs,
...
toolchain::Error RuntimeFallbackOpHandler::Initialize() {
