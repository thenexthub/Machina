 ...
 *
 */
#ifndef MACHINA_CORE_RUNTIME_FALLBACK_RUNTIME_FALLBACK_BATCH_KERNEL_H_
#define MACHINA_CORE_RUNTIME_FALLBACK_RUNTIME_FALLBACK_BATCH_KERNEL_H_
...
void BatchFunctionFallbackKernel<BatchResourceType>::ComputeAsync(
  ...
  std::function<
      absl::StatusOr<machina::core::RefCountPtr<BatchResourceType>>()>
      creator;
  if (adaptive_batch_scheduler_options_ != std::nullopt) {
    creator = [this, c]()
      ...
      return machina::core::RefCountPtr<BatchResourceType>(
  ...
  auto br = client_graph_resource_context->GetOrCreateResource<
      machina::core::RefCountPtr<BatchResourceType>>(shared_name_, creator);
...
#endif  // MACHINA_CORE_RUNTIME_FALLBACK_RUNTIME_FALLBACK_BATCH_KERNEL_H_
