...
class FallbackBatchResource : public machina::serving::BatchResourceBase {
 public:
...
void FallbackBatchResource::ProcessFuncBatchImpl(
  ...
  // There is a comment in machina/core/kernels/batch_kernels.cc
  ...
  toolchain::SmallVector<const absl::Status*, 3> errors;
