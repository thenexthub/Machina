...
#include "machina/core/common_runtime/lower_case_op.h"
...
const bool IsExemptFromSideEffectsExecutionValidation(const string& op) {
  static const auto* exemption = new absl::flat_hash_set<string>(
      {// LINT.IfChange
       ...
       // Legacy random ops.
       // See details in machina/python/framework/auto_control_deps.py.
  ...
  // LINT.ThenChange(//machina/python/framework/auto_control_deps.py)
