...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_FUNCTION_UTILS_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_FUNCTION_UTILS_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_FUNCTION_UTILS_H_
