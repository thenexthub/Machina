...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_MAP_PARALLELIZATION_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_MAP_PARALLELIZATION_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_MAP_PARALLELIZATION_H_
