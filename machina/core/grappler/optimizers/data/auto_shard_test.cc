...
using ::machina::grappler::graph_tests_utils::MakeBatchV2Node;
using ::machina::grappler::graph_tests_utils::MakeMapAndBatchNode;
using ::machina::grappler::graph_tests_utils::MakeParallelBatchNode;
