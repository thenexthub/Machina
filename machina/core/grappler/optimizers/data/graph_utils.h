...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_GRAPH_UTILS_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_GRAPH_UTILS_H_
...
// in machina happens in other layers (for example, in the Scope class of the
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_DATA_GRAPH_UTILS_H_
