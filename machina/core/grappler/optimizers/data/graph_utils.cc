...
NodeDef* AddScalarConstNodeHelper(
  ...
  std::unique_ptr<machina::TensorProto> tensor =
      std::make_unique<machina::TensorProto>();
  std::unique_ptr<machina::TensorShapeProto> tensor_shape =
      std::make_unique<machina::TensorShapeProto>();
