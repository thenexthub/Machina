...
#include "machina/core/grappler/optimizers/data/seq_interleave_prefetch.h"
...
NodeDef CreateBufferSizeNode(DataType dtype,
  ...
  auto tensor = std::make_unique<machina::TensorProto>();
  auto tensor_shape = std::make_unique<machina::TensorShapeProto>();
