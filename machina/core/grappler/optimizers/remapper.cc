...
#include "machina/core/grappler/utils/graph_view.h"
#include "machina/core/grappler/utils/pattern_utils.h"
#include "machina/core/grappler/utils/symbolic_shapes.h"
...
#ifdef INTEL_MKL
#include "machina/core/util/mkl_heuristics.h"
#endif  // INTEL_MKL
...
bool IsGpuCompatible(const RemapperContext& ctx,
                     ...
                     const Cluster* cluster) {
#if MACHINA_USE_ROCM && !TF_HIPBLASLT
...
inline bool IsXlaCpuGlobalJitOn() {
  ...
  TF_CHECK_OK(ReadStringsFromEnvVar("TF_MACHINA_MACHINA_XLA_FLAGS", "", &tf_xla_flags));
