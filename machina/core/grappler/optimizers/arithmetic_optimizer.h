...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_ARITHMETIC_OPTIMIZER_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_ARITHMETIC_OPTIMIZER_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_ARITHMETIC_OPTIMIZER_H_
