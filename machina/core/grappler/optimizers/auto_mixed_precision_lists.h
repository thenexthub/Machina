...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_AUTO_MIXED_PRECISION_LISTS_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_AUTO_MIXED_PRECISION_LISTS_H_
 ...
 protected:
  ...
  static void AddTensorListOps(gtl::FlatSet<string>* list) {
    ...
    constexpr const char* tensor_list_ops[] = {
        ...
        "TensorListStack"};
    // LINT.ThenChange(//machina/core/grappler/optimizers/auto_mixed_precision.cc)
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_AUTO_MIXED_PRECISION_LISTS_H_
