...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_CONSTANT_FOLDING_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_CONSTANT_FOLDING_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_CONSTANT_FOLDING_H_
