...
#include "machina/core/grappler/optimizers/arithmetic_optimizer_test_utils.h"
#include "machina/core/grappler/optimizers/model_pruner.h"
#include "machina/core/grappler/utils.h"
#include "machina/core/lib/core/status_test_util.h"
#include "machina/core/platform/test.h"
#include "machina/core/util/tensor_bundle/byte_swap_tensor.h"
...
TEST_F(ArithmeticOptimizerTest, ReorderTransposeCastProducerIsCast) {
  machina::Scope s = machina::Scope::NewRootScope().WithDevice("/CPU:0");
  Output nhwc_uint8 =
...
TEST_F(ArithmeticOptimizerTest, AddOpsRewriteAddOpsOfIdenticalShape) {
  machina::Scope s = machina::Scope::NewRootScope();
  machina::Scope sx = s.NewSubScope("x");
  machina::Scope sy = s.NewSubScope("y");
