...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_TFG_PASSES_BUILDER_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_TFG_PASSES_BUILDER_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_TFG_PASSES_BUILDER_H_
