...
#include "machina/core/grappler/optimizers/arithmetic_optimizer.h"
#include "machina/core/grappler/optimizers/auto_mixed_precision.h"
#include "machina/core/grappler/optimizers/auto_parallel.h"
#include "machina/core/grappler/optimizers/common_subgraph_elimination.h"
#include "machina/core/grappler/optimizers/constant_folding.h"
#include "machina/core/grappler/optimizers/custom_graph_optimizer_registry.h"
#include "machina/core/grappler/optimizers/debug_stripper.h"
#include "machina/core/grappler/optimizers/dependency_optimizer.h"
#include "machina/core/grappler/optimizers/function_optimizer.h"
#include "machina/core/grappler/optimizers/generic_layout_optimizer.h"
#include "machina/core/grappler/optimizers/implementation_selector.h"
#include "machina/core/grappler/optimizers/loop_optimizer.h"
#include "machina/core/grappler/optimizers/memory_optimizer.h"
#include "machina/core/grappler/optimizers/model_pruner.h"
#include "machina/core/grappler/optimizers/pin_to_host_optimizer.h"
#include "machina/core/grappler/optimizers/remapper.h"
#include "machina/core/grappler/optimizers/scoped_allocator_optimizer.h"
#include "machina/core/grappler/optimizers/shape_optimizer.h"
#include "machina/core/grappler/utils/canonicalizer.h"
#include "machina/core/grappler/utils/colocation.h"
#include "machina/core/grappler/utils/functions.h"
...
#include "machina/core/util/xla_config_registry.h"
...
absl::Status OptimizeGraph(
    ...
    std::unique_ptr<machina::Graph>* g) {
  if (!machina::grappler::MetaOptimizerEnabled(config_proto)) {
    return absl::OkStatus();
  }
  ...
  if (cpu_device && std::is_same<decltype(cpu_device), LocalDevice>::value &&
      cpu_device->machina_cpu_worker_threads() != nullptr) {
    ...
    item.optimization_options().intra_op_parallelism_threads =
        cpu_device->machina_cpu_worker_threads()->num_threads;
  }
  ...
  machina::GraphDef out_graph;
  machina::grappler::VirtualCluster cluster(&device_set);
  ...
  std::unique_ptr<machina::Graph> optimized_graph(
      new machina::Graph(OpRegistry::Global()));
