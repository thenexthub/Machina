...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_DEBUG_STRIPPER_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_DEBUG_STRIPPER_H_
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_DEBUG_STRIPPER_H_
