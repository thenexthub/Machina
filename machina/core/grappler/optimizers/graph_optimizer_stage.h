...
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_GRAPH_OPTIMIZER_STAGE_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_GRAPH_OPTIMIZER_STAGE_H_
...
class GraphOptimizerStage {
 public:
  ...
  absl::Status GetInputNode(const string& input, NodeDef** node) const {
    return ::machina::grappler::GetInputNode(ctx_, input, node);
  }
  ...
  absl::Status GetTensorProperties(
    ...
    return ::machina::grappler::GetTensorProperties(ctx_, tensor,
                                                       properties);
  }

  NodeDef* AddCopyNode(const string& name, const NodeDef* node_to_copy) {
    return ::machina::grappler::AddCopyNode(ctx_, name, node_to_copy);
  }
  NodeDef* AddEmptyNode(const string& name) {
    return ::machina::grappler::AddEmptyNode(ctx_, name);
  }
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_GRAPH_OPTIMIZER_STAGE_H_
