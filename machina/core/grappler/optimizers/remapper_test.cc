...
class XlaCpuJitDisableFusionTest : public RemapperTest {
 protected:
  void SetUp() override {
    setenv("TF_MACHINA_MACHINA_XLA_FLAGS", "--tf_xla_cpu_global_jit", /*overwrite=*/1);
  }
...
#if !(DNNL_AARCH64_USE_ACL || GOOGLE_CUDA || MACHINA_USE_ROCM)
TEST_F(XlaCpuJitDisableFusionTest, MatMulWithBias) { RunTest<DT_FLOAT>(); }
#endif  // !(DNNL_AARCH64_USE_ACL || GOOGLE_CUDA || MACHINA_USE_ROCM)
