 ...
 *
 */
#ifndef MACHINA_CORE_GRAPPLER_OPTIMIZERS_CUSTOM_GRAPH_OPTIMIZER_REGISTRY_H_
#define MACHINA_CORE_GRAPPLER_OPTIMIZERS_CUSTOM_GRAPH_OPTIMIZER_REGISTRY_H_
...
// See machina/core/protobuf/rewriter_config.proto for optimizer description.
struct ConfigList {
  ConfigList() {}
...
#define REGISTER_GRAPH_OPTIMIZER_AS(MyCustomGraphOptimizerClass, name) \
  namespace {                                                          \
  static ::machina::grappler::CustomGraphOptimizerRegistrar         \
...
#endif  // MACHINA_CORE_GRAPPLER_OPTIMIZERS_CUSTOM_GRAPH_OPTIMIZER_REGISTRY_H_
