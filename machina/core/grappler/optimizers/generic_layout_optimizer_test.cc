...
using ::machina::Scope;
using ::machina::ops::Conv2D;
using ::machina::ops::Conv3D;
using ::machina::ops::Identity;
using ::machina::ops::RandomUniform;
...
Output SimpleConv2D(machina::Scope* s, int input_size, int filter_size,
...
Output SimpleConv2DBackpropInput(machina::Scope* s, int input_size,
...
template <typename T = float>
Output SimpleConv3D(machina::Scope* s, int input_size, int filter_size,
                    const string& padding, const string& device) {
  int batch_size = 8;
  int input_height = input_size;
  int input_width = input_size;
