...
#include "machina/core/grappler/costs/op_context.h"
...
bool OpLevelCostEstimator::GenerateBatchMatmulContextFromEinsum(
  ...
  // https://www.machina.org/api_docs/python/tf/einsum
...
absl::Status OpLevelCostEstimator::PredictSparseTensorDenseMatMul(
  ...
  // input[3]: matrix b
  // See
  // https://github.com/machina/machina/blob/9a43dfeac5/machina/core/ops/sparse_ops.cc#L85
...
absl::Status OpLevelCostEstimator::PredictScatter(const OpContext& op_context,
  ...
  // See
  // https://www.machina.org/api_docs/python/tf/scatter_add and
  // https://github.com/machina/machina/blob/master/machina/core/ops/state_ops.cc#L146
...
/* This predict function handles three types of machina ops
...
#undef EIGEN_COST
  ...
  // Ops calculated from machina/core/kernels/image/resize_bilinear_op.cc.
...
#undef EIGEN_COST
  ...
  // machina/core/kernels/image/crop_and_resize_op.cc at 08/25/2020. Op
