...
#ifndef MACHINA_CORE_GRAPPLER_COSTS_COST_ESTIMATOR_H_
#define MACHINA_CORE_GRAPPLER_COSTS_COST_ESTIMATOR_H_
...
#endif  // MACHINA_CORE_GRAPPLER_COSTS_COST_ESTIMATOR_H_
