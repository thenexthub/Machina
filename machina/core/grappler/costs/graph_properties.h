...
#ifndef MACHINA_CORE_GRAPPLER_COSTS_GRAPH_PROPERTIES_H_
#define MACHINA_CORE_GRAPPLER_COSTS_GRAPH_PROPERTIES_H_
...
#endif  // MACHINA_CORE_GRAPPLER_COSTS_GRAPH_PROPERTIES_H_
