...
#ifndef MACHINA_CORE_GRAPPLER_GRAPH_TOPOLOGY_VIEW_H_
#define MACHINA_CORE_GRAPPLER_GRAPH_TOPOLOGY_VIEW_H_
...
#endif  // MACHINA_CORE_GRAPPLER_GRAPH_TOPOLOGY_VIEW_H_
