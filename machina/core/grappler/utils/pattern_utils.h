...
#ifndef MACHINA_CORE_GRAPPLER_UTILS_PATTERN_UTILS_H_
#define MACHINA_CORE_GRAPPLER_UTILS_PATTERN_UTILS_H_
...
#endif  // MACHINA_CORE_GRAPPLER_UTILS_PATTERN_UTILS_H_
