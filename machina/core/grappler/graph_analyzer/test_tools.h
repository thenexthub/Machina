...
#ifndef MACHINA_CORE_GRAPPLER_GRAPH_ANALYZER_TEST_TOOLS_H_
#define MACHINA_CORE_GRAPPLER_GRAPH_ANALYZER_TEST_TOOLS_H_
...
#endif  // MACHINA_CORE_GRAPPLER_GRAPH_ANALYZER_TEST_TOOLS_H_
