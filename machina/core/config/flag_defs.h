...
#ifndef MACHINA_CORE_CONFIG_FLAG_DEFS_H_
#define MACHINA_CORE_CONFIG_FLAG_DEFS_H_
...
class Flags {
 public:
  ...
  // LINT.ThenChange(//machina/core/config/flags_api_wrapper.cc)
};
...
#endif  // MACHINA_CORE_CONFIG_FLAG_DEFS_H_
