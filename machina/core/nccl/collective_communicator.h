 ...
 *
 */
#ifndef MACHINA_CORE_NCCL_COLLECTIVE_COMMUNICATOR_H_
#define MACHINA_CORE_NCCL_COLLECTIVE_COMMUNICATOR_H_
...
#endif  // MACHINA_CORE_NCCL_COLLECTIVE_COMMUNICATOR_H_
