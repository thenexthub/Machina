...
struct NcclManager::NcclStream : public core::RefCounted {
 public:
  ...
  // This is a different stream than the machina compute stream.
#if MACHINA_USE_ROCM
...
void NcclManager::RunCollective(Collective* collective) {
  ...
  machina::profiler::TraceMeProducer traceme("Schedule Collective");
...
void NcclManager::LoopKernelLaunches(NcclStream* nccl_stream) {
  ...
  while (true) {
    ...
    machina::profiler::TraceMeConsumer traceme("Run Collective",
