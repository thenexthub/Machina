...
#if MACHINA_USE_NCCL && (GOOGLE_CUDA || MACHINA_USE_ROCM)
...
void NcclCommunicator::Enqueue(std::shared_ptr<CollectiveContext> col_ctx,
  ...
  auto* gpu_info =
      col_ctx->op_ctx->device()->machina_accelerator_device_info();
...
#endif  // MACHINA_USE_NCCL && (GOOGLE_CUDA || MACHINA_USE_ROCM)
