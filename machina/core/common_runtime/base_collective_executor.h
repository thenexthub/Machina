 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_BASE_COLLECTIVE_EXECUTOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_BASE_COLLECTIVE_EXECUTOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_BASE_COLLECTIVE_EXECUTOR_H_
