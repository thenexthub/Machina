...
#ifndef MACHINA_CORE_COMMON_RUNTIME_ARG_RET_PLACEMENT_H_
#define MACHINA_CORE_COMMON_RUNTIME_ARG_RET_PLACEMENT_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_ARG_RET_PLACEMENT_H_
