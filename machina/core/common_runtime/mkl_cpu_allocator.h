...
#ifndef MACHINA_CORE_COMMON_RUNTIME_MKL_CPU_ALLOCATOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_MKL_CPU_ALLOCATOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_MKL_CPU_ALLOCATOR_H_
