...
#ifndef MACHINA_CORE_COMMON_RUNTIME_GRAPH_EXECUTION_STATE_H_
#define MACHINA_CORE_COMMON_RUNTIME_GRAPH_EXECUTION_STATE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_GRAPH_EXECUTION_STATE_H_
