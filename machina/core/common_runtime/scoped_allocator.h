 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_H_
