...
#ifndef MACHINA_CORE_COMMON_RUNTIME_STATS_PUBLISHER_INTERFACE_H_
#define MACHINA_CORE_COMMON_RUNTIME_STATS_PUBLISHER_INTERFACE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_STATS_PUBLISHER_INTERFACE_H_
