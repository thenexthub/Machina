 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_BUF_RENDEZVOUS_H_
#define MACHINA_CORE_COMMON_RUNTIME_BUF_RENDEZVOUS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_BUF_RENDEZVOUS_H_
