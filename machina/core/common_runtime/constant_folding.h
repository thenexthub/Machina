...
#ifndef MACHINA_CORE_COMMON_RUNTIME_CONSTANT_FOLDING_H_
#define MACHINA_CORE_COMMON_RUNTIME_CONSTANT_FOLDING_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_CONSTANT_FOLDING_H_
