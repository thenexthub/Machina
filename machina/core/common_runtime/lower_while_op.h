...
#ifndef MACHINA_CORE_COMMON_RUNTIME_LOWER_WHILE_OP_H_
#define MACHINA_CORE_COMMON_RUNTIME_LOWER_WHILE_OP_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_LOWER_WHILE_OP_H_
