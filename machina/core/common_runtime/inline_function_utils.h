...
#ifndef MACHINA_CORE_COMMON_RUNTIME_INLINE_FUNCTION_UTILS_H_
#define MACHINA_CORE_COMMON_RUNTIME_INLINE_FUNCTION_UTILS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_INLINE_FUNCTION_UTILS_H_
