 ...
 *
 */
#include "machina/core/common_runtime/ring_reducer.h"
...
#include "machina/core/common_runtime/collective_test_util.h"
...
#define DEF_TEST(B, T, W, D, S, L, A)                                         \
  TEST_F(RingReducerTest,                                                     \
    ...
    switch (dtype) {                                                          \
      ...
      case DT_BFLOAT16: {                                                     \
        RunTest<machina::bfloat16>(dtype, DEVICE_##T, W, D, S, L, A);      \
      } break;                                                                \
      case DT_INT32: {                                                        \
