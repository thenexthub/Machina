...
#ifndef MACHINA_CORE_COMMON_RUNTIME_LOCAL_EXECUTOR_PARAMS_H_
#define MACHINA_CORE_COMMON_RUNTIME_LOCAL_EXECUTOR_PARAMS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_LOCAL_EXECUTOR_PARAMS_H_
