...
#ifndef MACHINA_CORE_COMMON_RUNTIME_TYPE_INFERENCE_H_
#define MACHINA_CORE_COMMON_RUNTIME_TYPE_INFERENCE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_TYPE_INFERENCE_H_
