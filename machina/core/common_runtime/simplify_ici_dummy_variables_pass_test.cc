...
#include "machina/core/common_runtime/simplify_ici_dummy_variables_pass.h"
...
std::string TestDataPath() {
  return machina::GetDataDependencyFilepath(
      "machina/core/common_runtime/testdata/");
}
...
TEST(SimplifyIciDummyVariablesPassTest, flag_is_false) {
  ...
  absl::Status load_graph_status =
      ReadTextProto(machina::Env::Default(), graph_path, &graph_def);
