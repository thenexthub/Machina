...
#include "machina/core/common_runtime/inspecting_placer.h"
...
#include "machina/core/framework/full_type_util.h"
...
bool IsXlaDevice(absl::string_view device_type) {
  if (device_type == "MACHINA_MACHINA_XLA_CPU_JIT" || device_type == "MACHINA_MACHINA_XLA_GPU_JIT" ||
      device_type == "MACHINA_MACHINA_XLA_TPU_JIT") {
    // Symbolic XLA device.
    return true;
  }

  return (device_type == "MACHINA_MACHINA_XLA_CPU" || device_type == "MACHINA_MACHINA_XLA_GPU" ||
          device_type == "TPU");
}
