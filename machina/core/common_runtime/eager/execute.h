 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_H_
