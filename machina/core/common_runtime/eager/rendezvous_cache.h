...
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_RENDEZVOUS_CACHE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_RENDEZVOUS_CACHE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_RENDEZVOUS_CACHE_H_
