 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_EAGER_OP_REWRITE_REGISTRY_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_EAGER_OP_REWRITE_REGISTRY_H_
...
class EagerOpRewrite {
 public:
  ...
  virtual absl::Status Run(
      ...
      std::unique_ptr<machina::EagerOperation>* out_op) = 0;
...
#define REGISTER_REWRITE_UNIQ(ctr, file, line, phase, ordinal, rewrite)       \
  static ::machina::eager_rewrite_registration::EagerRewriteRegistration   \
      register_rewrite_##ctr(phase, ordinal,                                  \
                             ::std::unique_ptr<::machina::EagerOpRewrite>( \
                                 new rewrite(#rewrite, file, #line)))

}  // namespace machina
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_EAGER_OP_REWRITE_REGISTRY_H_
