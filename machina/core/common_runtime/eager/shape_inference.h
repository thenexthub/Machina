...
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_SHAPE_INFERENCE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_SHAPE_INFERENCE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_SHAPE_INFERENCE_H_
