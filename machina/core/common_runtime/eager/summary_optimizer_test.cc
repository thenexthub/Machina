...
using ::machina::summary_optimizer::GetDisableSummariesInputArg;
using ::machina::summary_optimizer::StrippedFunctionName;
using ::machina::summary_optimizer::StripSummaries;
using ::machina::summary_optimizer::internal::NormalizeEdgeName;
