 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_CUSTOM_DEVICE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_CUSTOM_DEVICE_H_
...
class CustomDeviceTensorHandle : public ImmediateExecutionTensorHandle {
 public:
  CustomDeviceTensorHandle(ImmediateExecutionContext* context,
                           CustomDevice* device, machina::DataType dtype)
  ...
  machina::DataType DataType() const override { return dtype_; }
 ...
 protected:
  ...
  const machina::DataType dtype_;
  machina::FullTypeDef full_type_;
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_CUSTOM_DEVICE_H_
