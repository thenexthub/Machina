...
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_KERNEL_AND_DEVICE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_KERNEL_AND_DEVICE_H_
...
//
// Also see:
// https://www.machina.org/code/machina/core/common_runtime/kernel_benchmark_testlib.h
// and
// https://www.machina.org/code/machina/core/kernels/ops_testutil.h
...
class KernelAndDeviceOp final : public KernelAndDevice {
 public:
  KernelAndDeviceOp(
      machina::Rendezvous* rendezvous, bool log_memory,
      FunctionLibraryRuntime* flr,
      std::function<void(std::function<void()>)>* runner,
      std::unique_ptr<CollectiveExecutor::Handle> collective_executor,
      Device* host_cpu_device)
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_KERNEL_AND_DEVICE_H_
