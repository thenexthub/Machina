 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_NODE_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_NODE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_EXECUTE_NODE_H_
