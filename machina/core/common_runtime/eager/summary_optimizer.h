...
#ifndef MACHINA_CORE_COMMON_RUNTIME_EAGER_SUMMARY_OPTIMIZER_H_
#define MACHINA_CORE_COMMON_RUNTIME_EAGER_SUMMARY_OPTIMIZER_H_
...
namespace machina::summary_optimizer {
namespace internal {
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EAGER_SUMMARY_OPTIMIZER_H_
