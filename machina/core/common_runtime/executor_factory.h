...
#ifndef MACHINA_CORE_COMMON_RUNTIME_EXECUTOR_FACTORY_H_
#define MACHINA_CORE_COMMON_RUNTIME_EXECUTOR_FACTORY_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EXECUTOR_FACTORY_H_
