...
#include "machina/core/common_runtime/direct_session.h"
...
#include "machina/core/common_runtime/graph_optimizer.h"
#include "machina/core/common_runtime/local_session_selection.h"
#include "machina/core/common_runtime/memory_types.h"
...
#include "machina/core/common_runtime/scoped_allocator_mgr.h"
...
#include "machina/core/lib/core/threadpool_options.h"
...
#include "machina/core/profiler/lib/device_profiler_session.h"
...
auto* direct_session_runs = monitoring::Counter<0>::New(
    "/machina/core/direct_session_runs",
  ...
  auto set_threadpool_args_for_item =
      [&default_runner, &handler](const PerPartitionExecutorsAndLib& item,
        ...
        thread::ThreadPool* device_thread_pool =
            item.device->machina_device_thread_pool();
...
absl::Status DirectSession::ResourceHandleToInputTensor(
  ...
  if (resource_handle.container() ==
    ...
    return errors::InvalidArgument(strings::StrCat(
        ...
        "https://github.com/machina/machina/issues/new, ideally with a "
