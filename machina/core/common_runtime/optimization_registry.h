...
#ifndef MACHINA_CORE_COMMON_RUNTIME_OPTIMIZATION_REGISTRY_H_
#define MACHINA_CORE_COMMON_RUNTIME_OPTIMIZATION_REGISTRY_H_
...
#include "machina/core/graph/costmodel.h"
...
#define REGISTER_OPTIMIZATION_UNIQ(ctr, grouping, phase, optimization)         \
  static ::machina::optimization_registration::OptimizationPassRegistration \
      register_optimization_##ctr(                                             \
          grouping, phase,                                                     \
          ::std::unique_ptr<::machina::GraphOptimizationPass>(              \
              new optimization()),                                             \
          #optimization)

}  // namespace machina

#endif  // MACHINA_CORE_COMMON_RUNTIME_OPTIMIZATION_REGISTRY_H_
