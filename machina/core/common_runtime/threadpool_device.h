...
#ifndef MACHINA_CORE_COMMON_RUNTIME_THREADPOOL_DEVICE_H_
#define MACHINA_CORE_COMMON_RUNTIME_THREADPOOL_DEVICE_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_THREADPOOL_DEVICE_H_
