...
#ifndef MACHINA_CORE_COMMON_RUNTIME_SINGLE_THREADED_EXECUTOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_SINGLE_THREADED_EXECUTOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_SINGLE_THREADED_EXECUTOR_H_
