...
#ifndef MACHINA_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
#define MACHINA_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_SESSION_FACTORY_H_
