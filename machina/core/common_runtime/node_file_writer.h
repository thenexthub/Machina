 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_NODE_FILE_WRITER_H_
#define MACHINA_CORE_COMMON_RUNTIME_NODE_FILE_WRITER_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_NODE_FILE_WRITER_H_
