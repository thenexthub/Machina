...
#ifndef MACHINA_CORE_COMMON_RUNTIME_COST_CONSTANTS_H_
#define MACHINA_CORE_COMMON_RUNTIME_COST_CONSTANTS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_COST_CONSTANTS_H_
