 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_EVAL_CONST_TENSOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_EVAL_CONST_TENSOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_EVAL_CONST_TENSOR_H_
