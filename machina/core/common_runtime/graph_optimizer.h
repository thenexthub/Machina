...
#ifndef MACHINA_CORE_COMMON_RUNTIME_GRAPH_OPTIMIZER_H_
#define MACHINA_CORE_COMMON_RUNTIME_GRAPH_OPTIMIZER_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_GRAPH_OPTIMIZER_H_
