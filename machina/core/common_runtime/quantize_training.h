...
#ifndef MACHINA_CORE_COMMON_RUNTIME_QUANTIZE_TRAINING_H_
#define MACHINA_CORE_COMMON_RUNTIME_QUANTIZE_TRAINING_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_QUANTIZE_TRAINING_H_
