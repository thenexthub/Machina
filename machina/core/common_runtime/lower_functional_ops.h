...
#ifndef MACHINA_CORE_COMMON_RUNTIME_LOWER_FUNCTIONAL_OPS_H_
#define MACHINA_CORE_COMMON_RUNTIME_LOWER_FUNCTIONAL_OPS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_LOWER_FUNCTIONAL_OPS_H_
