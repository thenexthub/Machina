...
#include "machina/core/common_runtime/function_testlib.h"
...
TEST(OptimizationTest, RemoveDeadNodes) {
  ...
  TF_EXPECT_GRAPH_EQ(expected, Optimize(::machina::RemoveDeadNodes, func));
}
...
TEST(OptimizationTest, RemoveIdentityNodes_Ref) {
  ...
  TF_EXPECT_GRAPH_EQ(expected,
                     Optimize(::machina::RemoveIdentityNodes, func));
}
