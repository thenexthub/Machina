#ifndef MACHINA_CORE_COMMON_RUNTIME_PENDING_COUNTS_H_
#define MACHINA_CORE_COMMON_RUNTIME_PENDING_COUNTS_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_PENDING_COUNTS_H_
