...
#include "machina/xla/tsl/lib/gtl/inlined_vector.h"
...
using machina::BinSummary;
using machina::DeviceMemAllocator;
using machina::GPUBFCAllocator;
using machina::GPUOptions;
using machina::TypedAllocator;
