 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_SHAPE_REFINER_H_
#define MACHINA_CORE_COMMON_RUNTIME_SHAPE_REFINER_H_
...
class ShapeRefiner {
 public:
  ...
  void set_function_library_for_shape_inference(
      const machina::FunctionLibraryDefinition* lib) {
 ...
 private:
  ...
  friend class ::machina::grappler::GraphProperties;
  ...
  // shape inference.
  const machina::FunctionLibraryDefinition* function_library_ = nullptr;
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_SHAPE_REFINER_H_
