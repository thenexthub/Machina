...
#ifndef MACHINA_CORE_COMMON_RUNTIME_PROFILE_HANDLER_H_
#define MACHINA_CORE_COMMON_RUNTIME_PROFILE_HANDLER_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_PROFILE_HANDLER_H_
