...
#ifndef MACHINA_CORE_COMMON_RUNTIME_NULL_REQUEST_COST_ACCESSOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_NULL_REQUEST_COST_ACCESSOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_NULL_REQUEST_COST_ACCESSOR_H_
