...
#ifndef MACHINA_CORE_COMMON_RUNTIME_DEVICE_PROPAGATION_H_
#define MACHINA_CORE_COMMON_RUNTIME_DEVICE_PROPAGATION_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_DEVICE_PROPAGATION_H_
