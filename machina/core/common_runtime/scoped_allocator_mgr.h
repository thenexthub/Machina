 ...
 *
 */
#ifndef MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_MGR_H_
#define MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_MGR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_SCOPED_ALLOCATOR_MGR_H_
