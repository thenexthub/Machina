...
#include "machina/core/common_runtime/next_pluggable_device/c/tf_rendezvous_c_api_helper.h"
...
#include "machina/core/common_runtime/next_pluggable_device/c/tf_device_context_c_api_helper.h"
...
class TfCThunkRendezvous final : public ::machina::RendezvousInterface {
 public:
...
void TfCThunkRendezvous::RecvAsync(const ParsedKey& key, const Args& args,
  ...
  params->on_done =
      ToC([done = std::move(done), params](
              ...
              const machina::RendezvousInterface::Args& send_args,
              const machina::RendezvousInterface::Args& recv_args,
              const machina::Tensor& tensor, bool is_dead) {
...
std::unique_ptr<machina::RendezvousInterface> FromC(
