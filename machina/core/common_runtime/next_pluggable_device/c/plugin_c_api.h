...
#ifndef MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_C_PLUGIN_C_API_H_
#define MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_C_PLUGIN_C_API_H_
...
// ------------------------------  TF2XLA  -------------------------------------
// TODO(b/254484247): either separate MACHINA_MACHINA_XLA_Shape to its own file, or use PJRT
...
typedef void TFNPD_XlaShapeToDeviceShapeRepresentation(
    ...
    MACHINA_MACHINA_XLA_LayoutPreference layout_preference, MACHINA_MACHINA_XLA_Shape* serialized_device_shape,
    TF_Status* tf_status);
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_C_PLUGIN_C_API_H_
