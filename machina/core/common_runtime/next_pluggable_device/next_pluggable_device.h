...
#ifndef MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_NEXT_PLUGGABLE_DEVICE_H_
#define MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_NEXT_PLUGGABLE_DEVICE_H_
...
#include "machina/core/common_runtime/next_pluggable_device/next_pluggable_device_context.h"
...
class NextPluggableDevice : public PjRtBaseDevice {
 public:
  struct Options {
    ...
    // The name of the compilation device (e.g., "MACHINA_MACHINA_XLA_TPU_JIT");
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_NEXT_PLUGGABLE_DEVICE_NEXT_PLUGGABLE_DEVICE_H_
