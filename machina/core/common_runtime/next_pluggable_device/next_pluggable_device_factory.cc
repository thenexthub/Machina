...
#include "machina/core/common_runtime/next_pluggable_device/next_pluggable_device.h"
...
absl::StatusOr<xla::Shape> DeviceShapeRepresentation(
  ...
  ApiConverter::StackHelper<MACHINA_MACHINA_XLA_Shape> c_xla_shape(xla_shape);
  ApiConverter::StackHelper<MACHINA_MACHINA_XLA_Shape> c_device_shape;
