...
#ifndef MACHINA_CORE_COMMON_RUNTIME_LAYOUT_PASS_UTIL_H_
#define MACHINA_CORE_COMMON_RUNTIME_LAYOUT_PASS_UTIL_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_LAYOUT_PASS_UTIL_H_
