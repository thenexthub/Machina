...
#ifndef MACHINA_CORE_COMMON_RUNTIME_GRAPH_CONSTRUCTOR_H_
#define MACHINA_CORE_COMMON_RUNTIME_GRAPH_CONSTRUCTOR_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_GRAPH_CONSTRUCTOR_H_
