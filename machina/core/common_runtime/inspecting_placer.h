...
#ifndef MACHINA_CORE_COMMON_RUNTIME_INSPECTING_PLACER_H_
#define MACHINA_CORE_COMMON_RUNTIME_INSPECTING_PLACER_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_INSPECTING_PLACER_H_
