...
#ifndef MACHINA_CORE_COMMON_RUNTIME_DIRECT_SESSION_H_
#define MACHINA_CORE_COMMON_RUNTIME_DIRECT_SESSION_H_
...
class DirectSession : public Session {
 public:
  ...
  absl::Status Run(const ::machina::RunOptions& run_options,
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_DIRECT_SESSION_H_
