...
#ifndef MACHINA_CORE_COMMON_RUNTIME_GPU_DEVICE_CONTEXT_H_
#define MACHINA_CORE_COMMON_RUNTIME_GPU_DEVICE_CONTEXT_H_
...
#endif  // MACHINA_CORE_COMMON_RUNTIME_GPU_DEVICE_CONTEXT_H_
