...
#ifndef MACHINA_CORE_IR_TYPES_DIALECT_H_
#define MACHINA_CORE_IR_TYPES_DIALECT_H_
...
#include "machina/core/ir/types/dialect.h.inc"

// Include the Type classes declaration generated from types.td
#define GET_TYPEDEF_CLASSES
#include "machina/core/ir/types/types.h.inc"
...
class TypeWithSubtypeStorage : public TypeStorage {
 public:
  ...
  static toolchain::hash_code hashKey(const KeyTy& key) {
    return toolchain::hash_combine_range(key.begin(), key.end());
  }
...
class OperandShapeIterator final
    : public toolchain::mapped_iterator<Operation::operand_iterator,
...
class ResultShapeIterator final
    : public toolchain::mapped_iterator<Operation::result_iterator,
                                   std::optional<ArrayRef<int64_t>> (*)(
                                       Value)> {
 public:
  using reference = std::optional<ArrayRef<int64_t>>;
...
auto filter_resources(RangeT&& range) {
  return toolchain::make_filter_range(std::forward<RangeT>(range), [](Value val) {
...
#include "machina/core/ir/types/attributes.h.inc"
#include "machina/core/ir/types/attributes_enum.h.inc"

#endif  // MACHINA_CORE_IR_TYPES_DIALECT_H_
