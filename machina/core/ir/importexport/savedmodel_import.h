...
#ifndef MACHINA_CORE_IR_IMPORTEXPORT_SAVEDMODEL_IMPORT_H_
#define MACHINA_CORE_IR_IMPORTEXPORT_SAVEDMODEL_IMPORT_H_
...
absl::StatusOr<OwningOpRef<mlir::ModuleOp>> ImportSavedModelToMlir(
    mlir::MLIRContext* context, const machina::GraphDebugInfo& debug_info,
    const machina::SavedModel& saved_model);

}  // namespace tfg
}  // namespace mlir

#endif  // MACHINA_CORE_IR_IMPORTEXPORT_SAVEDMODEL_IMPORT_H_
