...
#ifndef MACHINA_CORE_IR_IMPORTEXPORT_PARSE_TEXT_PROTO_H_
#define MACHINA_CORE_IR_IMPORTEXPORT_PARSE_TEXT_PROTO_H_
...
absl::Status ParseTextProto(absl::string_view text_proto,
                            ...
                            machina::protobuf::Message* parsed_proto);
inline absl::Status ParseTextProto(
    absl::string_view /* text_proto */, absl::string_view /* prefix_to_strip */,
    machina::protobuf::MessageLite* /* parsed_proto */) {
  return machina::errors::Unavailable("Cannot parse text protos on mobile.");
}

}  // namespace tfg
}  // namespace mlir

#endif  // MACHINA_CORE_IR_IMPORTEXPORT_PARSE_TEXT_PROTO_H_
