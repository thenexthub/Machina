...
#ifndef MACHINA_CORE_IR_IMPORTEXPORT_FUNCTIONDEF_EXPORT_H_
#define MACHINA_CORE_IR_IMPORTEXPORT_FUNCTIONDEF_EXPORT_H_
...
absl::StatusOr<machina::FunctionDef> ConvertGenericFunctionToFunctionDef(
    GraphFuncOp func);

}  // namespace tfg
}  // namespace mlir

#endif  // MACHINA_CORE_IR_IMPORTEXPORT_FUNCTIONDEF_EXPORT_H_
