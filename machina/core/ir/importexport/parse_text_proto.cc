...
class NoOpErrorCollector : public machina::protobuf::io::ErrorCollector {
 public:
  void RecordError(int line, machina::protobuf::io::ColumnNumber column,
...
Status ParseTextProto(absl::string_view text_proto,
  ...
  machina::protobuf::TextFormat::Parser parser;
  ...
  machina::protobuf::io::ArrayInputStream input_stream(
