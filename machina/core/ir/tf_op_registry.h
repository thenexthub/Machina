...
#ifndef MACHINA_CORE_IR_TF_OP_REGISTRY_H_
#define MACHINA_CORE_IR_TF_OP_REGISTRY_H_
...
class TensorFlowOpRegistryInterface : public TensorFlowRegistryInterfaceBase {
 public:
  ...
  TensorFlowOpRegistryInterface(Dialect *dialect,
                                const machina::OpRegistry *registry)
  ...
  const machina::OpRegistry *GetRegistry() const { return registry_; }
...
#endif  // MACHINA_CORE_IR_TF_OP_REGISTRY_H_
