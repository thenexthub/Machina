...
#ifndef MACHINA_CORE_IR_TF_OP_WRAPPER_H_
#define MACHINA_CORE_IR_TF_OP_WRAPPER_H_
...
class ControlRetIterator final
    : public toolchain::mapped_iterator_base<ControlRetIterator<ValueIteratorT>,
                                        ValueIteratorT, Value> {
 public:
  using toolchain::mapped_iterator_base<ControlRetIterator<ValueIteratorT>,
...
class TFOp {
 public:
  ...
  // marked as implicit to support `toolchain::dyn_cast`.
...
class ControlRetRange final
    : public toolchain::iterator_range<
          ::mlir::detail::ControlRetIterator<typename ValueRangeT::iterator>> {
 public:
  using Base = toolchain::iterator_range<
      ::mlir::detail::ControlRetIterator<typename ValueRangeT::iterator>>;
  ...
  size_t size() const { return toolchain::size(*this); }
  ...
  bool operator==(const OtherT &other) const {
    return toolchain::size(*this) == toolchain::size(other) &&
...
#endif  // MACHINA_CORE_IR_TF_OP_WRAPPER_H_
