 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_GRAPH_EXECUTOR_GRAPH_EXECUTOR_H_
#define MACHINA_CORE_TFRT_GRAPH_EXECUTOR_GRAPH_EXECUTOR_H_
...
struct RequestInfo {
  ...
  // The task runner used by machina::OpKernel.
...
// Runs a MLRT function for executing machina graphs.
...
class GraphExecutor {
 public:
  ...
  class LoadedClientGraph {
   ...
   private:
    ...
    mutable machina::mutex executable_context_mu_;
  ...
  machina::tfrt_stub::TfrtGraphExecutionState& graph_execution_state()
      const {
    return *graph_execution_state_;
  }

  // Returns the underlying runtime.
  const machina::tfrt_stub::Runtime& runtime() const {
 ...
 private:
  ...
  machina::mutex loaded_client_graphs_mu_;
 ...
 protected:
  ...
  machina::mutex num_recompilations_mu_;
...
#endif  // MACHINA_CORE_TFRT_GRAPH_EXECUTOR_GRAPH_EXECUTOR_H_
