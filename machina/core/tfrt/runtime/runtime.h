 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_RUNTIME_RUNTIME_H_
#define MACHINA_CORE_TFRT_RUNTIME_RUNTIME_H_
...
class ModelRuntimeContext {
 public:
  ...
  machina::DeviceMgr* device_mgr() const { return device_mgr_; }
  void set_device_mgr(machina::DeviceMgr* device_mgr) {
 ...
 private:
  ...
  machina::DeviceMgr* device_mgr_ = nullptr;
...
// This defines the runtime abstraction in machina for TFRT. It is supposed
// to provide machina specific functionalities that are implemented using
...
// machina::experimental::cc::Runtime when it lands.
class Runtime {
 public:
...
#endif  // MACHINA_CORE_TFRT_RUNTIME_RUNTIME_H_
