...
under the License.
==============================================================================*/
#ifndef MACHINA_CORE_TFRT_RUNTIME_STREAM_H_
#define MACHINA_CORE_TFRT_RUNTIME_STREAM_H_
...
struct StreamedResult {
  absl::flat_hash_map<std::string, machina::Tensor> tensors;
...
class StreamWorkerInterface {
 public:
  ...
  virtual absl::Status InvokeStreamCallback(
      ...
      const std::vector<std::pair<int64_t, std::vector<machina::Tensor>>>&
          responses) = 0;
...
class StreamCallbackRegistry {
 public:
  ...
  absl::StatusOr<ScopedStreamCallback> Register(
      ...
      StepId step_id,
      absl::AnyInvocable<
          void(absl::flat_hash_map<std::string, machina::Tensor>)>
          callback);
   ...
   public:
    CallbackState(StreamCallbackRegistry* registry,
                  ...
                  absl::AnyInvocable<void(
                      absl::flat_hash_map<std::string, machina::Tensor>)>
                      callback)
        : registry_(registry),
...
#endif  // MACHINA_CORE_TFRT_RUNTIME_STREAM_H_
