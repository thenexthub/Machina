 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_MLRT_INTERPRETER_VALUE_H_
#define MACHINA_CORE_TFRT_MLRT_INTERPRETER_VALUE_H_
...
struct InPlaceStorageT {
  // Many tensor implementations like machina::Tensor requires multiple
...
#endif  // MACHINA_CORE_TFRT_MLRT_INTERPRETER_VALUE_H_
