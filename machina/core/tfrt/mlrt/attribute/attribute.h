 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_MLRT_ATTRIBUTE_ATTRIBUTE_H_
#define MACHINA_CORE_TFRT_MLRT_ATTRIBUTE_ATTRIBUTE_H_
...
class TensorAttr {
 public:
  struct StorageType {
    using Self = StorageType;
    DEFINE_BYTECODE_FIELD(machina::DataType, dtype);
  ...
  machina::DataType dtype() const { return StorageType::read_dtype(p_); }
...
#endif  // MACHINA_CORE_TFRT_MLRT_ATTRIBUTE_ATTRIBUTE_H_
