...
#include "machina/core/tfrt/mlrt/interpreter/execute.h"
...
TEST(KernelTest, CreateExecuteOp) {
  ...
  int32_t input = 100;
  machina::Tensor input_tensor(input);
  ...
  int32_t output = 200;
  machina::Tensor expected(output);

  machina::test::ExpectEqual(
...
class TestDeviceKernel : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ctx->set_output(0, machina::Tensor(ctx->device()->name()));
  }
};
...
class TestAsyncIdentityKernel : public AsyncOpKernel {
 public:
  ...
  void ComputeAsync(OpKernelContext* ctx, DoneCallback done) override {
    DCHECK(ctx->device()->machina_cpu_worker_threads()->workers);
    ctx->device()->machina_cpu_worker_threads()->workers->Schedule(
...
TEST(KernelTest, Predicate) {
  ...
  std::vector<machina::Tensor> inputs = {
      machina::Tensor(true),
      machina::Tensor(static_cast<int8_t>(100)),
      machina::Tensor(static_cast<uint8_t>(100)),
      machina::Tensor(static_cast<int16_t>(100)),
      machina::Tensor(static_cast<int32_t>(100)),
      machina::Tensor(static_cast<int64_t>(100)),
      machina::Tensor(100.0f),
      machina::Tensor(100.0),
      machina::Tensor("100"),
      machina::Tensor(machina::DT_INT32, {4}),
  };
  ...
  machina::Tensor error_input(machina::DT_VARIANT, {});
...
TEST(KernelTest, CancelInAsyncCanEarlyReturn) {
  ...
  auto promise =
      mlrt::Promise::Allocate<machina::tfrt_stub::FallbackTensor>();
...
TEST(KernelTest, TensorToInt32) {
  ...
  mlrt::ExecutionContext execution_context(&loaded_executable);
  {
    machina::Tensor input = machina::Tensor(static_cast<int32_t>(100));
...
void TestMapFnBody(mlrt::KernelFrame frame) {
  ...
  int32_t loop_index = frame.arguments()[2]
                           .Get<machina::tfrt_stub::FallbackTensor>()
                           .tensor()
                           .scalar<int32_t>()();
  ...
  auto in_tensor = future.Get<machina::tfrt_stub::FallbackTensor>().tensor();
  machina::Tensor out_tensor(DT_INT32, {kMapFnOpMaxIteration});
  ...
  std::move(promise).Set<machina::tfrt_stub::FallbackTensor>(out_tensor);
}
...
void TestMapFnBodyErrorWithPromiseSet(mlrt::KernelFrame frame) {
  ...
  auto loop_index =
      frame.arguments()[2].Get<machina::tfrt_stub::FallbackTensor>();
  std::move(promise).Set<machina::tfrt_stub::FallbackTensor>(
      std::move(loop_index));
...
TEST(KernelTest, MapFnOp) {
  ...
  machina::Tensor loop_max_iteration_tensor;
  TF_CHECK_OK(machina::Tensor::BuildTensor(DT_INT32, {},
  ...
  machina::Tensor tensor_list;
  TF_CHECK_OK(machina::Tensor::BuildTensor(DT_INT32, {kMapFnOpMaxIteration},
                                              &tensor_list));
  args.at(1).Set(tfrt_stub::FallbackTensor(std::move(tensor_list)));

  machina::Tensor bias_tensor;
  TF_CHECK_OK(machina::Tensor::BuildTensor(DT_INT32, {}, &bias_tensor));
  ...
  machina::Tensor expected(machina::DT_INT32, {kMapFnOpMaxIteration});
  expected.flat<int32_t>()(0) = 100;
  expected.flat<int32_t>()(1) = 101;

  auto& to_be = result.Get<machina::tfrt_stub::FallbackTensor>();
  machina::test::ExpectEqual(to_be.tensor(), expected);
}
...
TEST(KernelTest, MapFnOpZeroIteration) {
  ...
  machina::Tensor loop_max_iteration_tensor(DT_INT32, {});
  loop_max_iteration_tensor.scalar<int32_t>()() = 0;
  args.at(0).Set(
      tfrt_stub::FallbackTensor(std::move(loop_max_iteration_tensor)));

  machina::Tensor tensor_list(DT_INT32, {});
  tensor_list.scalar<int32_t>()() = 1000;
  args.at(1).Set(tfrt_stub::FallbackTensor(std::move(tensor_list)));

  machina::Tensor bias_tensor(DT_INT32, {});
  bias_tensor.scalar<int32_t>()() = kMapFnBias;
  args.at(2).Set(tfrt_stub::FallbackTensor(bias_tensor));
  ...
  machina::Tensor expected(machina::DT_INT32, {});
...
TEST(KernelTest, PromiseReturn) {
  ...
  auto promise =
      mlrt::Promise::Allocate<machina::tfrt_stub::FallbackTensor>();
  machina::Tensor expected(static_cast<int32_t>(100));
...

  {
    ...
    inputs[1].Set(machina::tfrt_stub::FallbackTensor(expected));
...
void TestAsyncWhileFnBody(mlrt::KernelFrame frame) {
  ...
  int32_t prev_loop_count =
      prev_loop_count_future.Get<machina::tfrt_stub::FallbackTensor>()
          .tensor()
          .scalar<int32_t>()();
  machina::Tensor next_loop_count(DT_INT32, {});
  next_loop_count.scalar<int32_t>()() = prev_loop_count + 1;

  machina::Tensor predicate(DT_BOOL, {});
  predicate.scalar<bool>()() = prev_loop_count + 1 < max_iteration;
  std::move(predicate_promise)
      .Set<machina::tfrt_stub::FallbackTensor>(std::move(predicate));

  std::move(next_loop_count_promise)
      .Set<machina::tfrt_stub::FallbackTensor>(std::move(next_loop_count));
}
