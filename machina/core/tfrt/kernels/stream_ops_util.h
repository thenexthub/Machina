 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_KERNELS_STREAM_OPS_UTIL_H_
#define MACHINA_CORE_TFRT_KERNELS_STREAM_OPS_UTIL_H_
...
#endif  // MACHINA_CORE_TFRT_KERNELS_STREAM_OPS_UTIL_H_
