...
#ifndef MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_UTIL_H_
#define MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_UTIL_H_
...
// TODO(tfrt-dev): Replace tfrt::TensorSpec with machina::TensorSpec once the
// latter is checked in.
struct TensorSpec {
  machina::DataType dtype;
  machina::PartialTensorShape shape;

  explicit TensorSpec(machina::DataType dtype) : dtype(dtype) {}
  TensorSpec(machina::DataType dtype, machina::PartialTensorShape shape)
...
#endif  // MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_UTIL_H_
