 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_H_
#define MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_H_
...
// a machina saved model directory.
class SavedModel {
 public:
  struct Options {
  ...
  virtual const machina::MetaGraphDef& GetMetaGraphDef() const = 0;
  ...
  virtual absl::Status Run(const RunOptions& run_options,
                           ...
                           std::vector<machina::Tensor>* outputs) = 0;
  ...
  virtual absl::Status RunMultipleSignatures(
      ...
      std::vector<std::vector<machina::Tensor>>* multi_outputs) = 0;
...
class SavedModelImpl final : public SavedModel {
 public:
  ...
  // machina saved model from `saved_model_dir`. Refer to
  ...
  const machina::MetaGraphDef& GetMetaGraphDef() const override;
  ...
  absl::Status RunMultipleSignatures(
      const RunOptions& run_options, absl::Span<const std::string> names,
      absl::Span<const std::vector<machina::Tensor>> multi_inputs,
      std::vector<std::vector<machina::Tensor>>* multi_outputs) override;
 ...
 private:
  ...
  machina::MetaGraphDef meta_graph_def_;
  tfrt::BefBuffer bef_;
  ...
  machina::mutex loading_result_cache_mu_;
...
using SavedModel = ::machina::tfrt_stub::SavedModel;
using SavedModelImpl = ::machina::tfrt_stub::SavedModelImpl;
using SavedModelMiraImpl = ::machina::tfrt_stub::SavedModelMiraImpl;
using TensorSpec = ::machina::tfrt_stub::TensorSpec;
using FunctionMetadata = ::machina::tfrt_stub::FunctionMetadata;

namespace internal {
using Signature = ::machina::tfrt_stub::internal::Signature;
}

}  // namespace tfrt

#endif  // MACHINA_CORE_TFRT_SAVED_MODEL_SAVED_MODEL_H_
