 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_FALLBACK_FALLBACK_STATE_H_
#define MACHINA_CORE_TFRT_FALLBACK_FALLBACK_STATE_H_
...
// current machina. It also provides methods used in current machina.
class FallbackState {
 public:
...
#endif  // MACHINA_CORE_TFRT_FALLBACK_FALLBACK_STATE_H_
