 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_RUN_HANDLER_THREAD_POOL_RUN_HANDLER_CONCURRENT_WORK_QUEUE_H_
#define MACHINA_CORE_TFRT_RUN_HANDLER_THREAD_POOL_RUN_HANDLER_CONCURRENT_WORK_QUEUE_H_
...
class RunHandlerThreadWorkQueue
    : public machina::tfrt_stub::WorkQueueInterface {
 public:
  struct Options {
  ...
  absl::StatusOr<std::unique_ptr<machina::tfrt_stub::WorkQueueInterface>>
...
#endif  // MACHINA_CORE_TFRT_RUN_HANDLER_THREAD_POOL_RUN_HANDLER_CONCURRENT_WORK_QUEUE_H_
