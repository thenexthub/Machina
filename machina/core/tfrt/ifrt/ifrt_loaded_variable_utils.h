...
#ifndef MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_UTILS_H_
#define MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_UTILS_H_
...
#endif  // MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_UTILS_H_
