...
#ifndef MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_REGISTRY_H_
#define MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_REGISTRY_H_
...
#endif  // MACHINA_CORE_TFRT_IFRT_IFRT_LOADED_VARIABLE_REGISTRY_H_
