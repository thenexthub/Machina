...
#ifndef MACHINA_CORE_TFRT_IFRT_IFRT_EXECUTABLE_REGISTRY_H_
#define MACHINA_CORE_TFRT_IFRT_IFRT_EXECUTABLE_REGISTRY_H_
...
#endif  // MACHINA_CORE_TFRT_IFRT_IFRT_EXECUTABLE_REGISTRY_H_
