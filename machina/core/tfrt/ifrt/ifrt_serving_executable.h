...
#ifndef MACHINA_CORE_TFRT_IFRT_IFRT_SERVING_EXECUTABLE_H_
#define MACHINA_CORE_TFRT_IFRT_IFRT_SERVING_EXECUTABLE_H_
...
class IfrtServingExecutable {
 public:
  ...
  absl::StatusOr<std::vector<machina::Tensor>> Execute(
 ...
 private:
  ...
  // released.
  machina::tpu::TPUCompileMetadataProto original_compile_metadata_;
  ...
  machina::DeviceMgr* device_mgr_;  // Not owned. For host callback.
  machina::XlaHelpers::ShapeRepresentationFn shape_representation_fn_;
...
#endif  // MACHINA_CORE_TFRT_IFRT_IFRT_SERVING_EXECUTABLE_H_
