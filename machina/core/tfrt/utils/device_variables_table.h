 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_UTILS_DEVICE_VARIABLES_TABLE_H_
#define MACHINA_CORE_TFRT_UTILS_DEVICE_VARIABLES_TABLE_H_
...
class DeviceVariablesTable {
 public:
  ...
  AsyncValueRef<DeviceTensorType> GetOrAddDeviceVariable(
      const HostTensorType& host_tensor, int copy_index,
      toolchain::unique_function<void(AsyncValueRef<DeviceTensorType>)> creator) {
...
#endif  // MACHINA_CORE_TFRT_UTILS_DEVICE_VARIABLES_TABLE_H_
