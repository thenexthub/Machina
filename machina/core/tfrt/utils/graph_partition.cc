...
absl::StatusOr<Node*> BuildPartitionedCallOp(
  ...
  call_builder.Attr(machina::kNoInlineAttr, true);
  ...
  (*new_fdef.mutable_attr())[machina::kNoInlineAttr].set_b(true);
...
absl::StatusOr<Node*> BuildStatefulPartitionedCallOp(
  ...
  (*id_fdef.mutable_attr())[machina::kNoInlineAttr].set_b(true);
