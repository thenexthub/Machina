 ...
 *
 */
#ifndef MACHINA_CORE_TFRT_UTILS_ERROR_UTIL_H_
#define MACHINA_CORE_TFRT_UTILS_ERROR_UTIL_H_
...
inline toolchain::Error MakeStatusError(absl::Status status) {
  return MakeStringError(MakeStatusString(status));
}

}  // namespace tfrt

#endif  // MACHINA_CORE_TFRT_UTILS_ERROR_UTIL_H_
