...
#ifndef MACHINA_CORE_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
#define MACHINA_CORE_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
...
#endif  // MACHINA_CORE_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
