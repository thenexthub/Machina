...
#ifndef MACHINA_CORE_PLATFORM_CLOUD_GCS_DNS_CACHE_H_
#define MACHINA_CORE_PLATFORM_CLOUD_GCS_DNS_CACHE_H_
...
#endif  // MACHINA_CORE_PLATFORM_CLOUD_GCS_DNS_CACHE_H_
