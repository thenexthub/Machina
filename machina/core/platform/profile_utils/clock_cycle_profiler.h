...
#ifndef MACHINA_CORE_PLATFORM_PROFILE_UTILS_CLOCK_CYCLE_PROFILER_H_
#define MACHINA_CORE_PLATFORM_PROFILE_UTILS_CLOCK_CYCLE_PROFILER_H_
...
#endif  // MACHINA_CORE_PLATFORM_PROFILE_UTILS_CLOCK_CYCLE_PROFILER_H_
