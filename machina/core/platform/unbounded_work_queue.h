...
#ifndef MACHINA_CORE_PLATFORM_UNBOUNDED_WORK_QUEUE_H_
#define MACHINA_CORE_PLATFORM_UNBOUNDED_WORK_QUEUE_H_
...
#endif  // MACHINA_CORE_PLATFORM_UNBOUNDED_WORK_QUEUE_H_
