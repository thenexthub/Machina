...
def tf_tpu_dependencies():
    return if_libtpu([Label("//machina/core/tpu/kernels")])

def tf_dtensor_tpu_dependencies():
    return if_libtpu([Label("//machina/dtensor/cc:dtensor_tpu_kernels")])
...
def tf_additional_binary_deps():
    return [
        ...
        # core.
        Label("//machina/core/kernels:lookup_util"),
        Label("//machina/core/util/tensor_bundle"),
    ] + if_cuda([
...
def tf_protos_all():
    return if_static(
        extra_deps = [
            Label("//machina/core/protobuf:conv_autotuning_proto_cc_impl"),
            Label("//machina/core:protos_all_cc_impl"),
        ...
        otherwise = [Label("//machina/core:protos_all_cc")],
    )
