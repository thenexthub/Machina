...
load("//machina:py.default.bzl", "py_test")
load("//machina:machina.default.bzl", "cuda_py_test")
load("//machina/python/tpu:tpu.bzl", _tpu_py_test = "tpu_py_test")
...
def distribute_py_test(
    ...
    Args:
        ...
        disable_tpu_use_tfrt: None/bool. Whether generate a unit test on TFRT TPU
            ...
            tests for targets managed by machina team.
