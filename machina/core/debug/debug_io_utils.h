...
#ifndef MACHINA_CORE_DEBUG_DEBUG_IO_UTILS_H_
#define MACHINA_CORE_DEBUG_DEBUG_IO_UTILS_H_
...
template <>
struct hash<::machina::DebugNodeKey> {
  size_t operator()(const ::machina::DebugNodeKey& k) const {
    return ::machina::Hash64(
        ::machina::strings::StrCat(k.device_name, ":", k.node_name, ":",
...
#endif  // MACHINA_CORE_DEBUG_DEBUG_IO_UTILS_H_
