...
class CpuOpHandler : public OpHandler {
 ...
 private:
  ...
  toolchain::SmallSetVector<TensorConversionFnRegistry::ConversionKey, 4>
      allowed_conversions;

  friend toolchain::Expected<CpuOpHandler*> CreateCpuOpHandler(
...
toolchain::Expected<CpuOpHandler*> CreateCpuOpHandler(CoreRuntime* runtime,
