...
template <typename T>
toolchain::Error SyncRelu(const DenseHostTensor& A, DenseHostTensor* B,
...
template <typename T>
toolchain::Error SyncSigmoid(const DenseHostTensor& A, DenseHostTensor* B,
                        HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncSum2D(const DenseHostTensor& A, DenseHostTensor* B, int axis) {
...
template <typename T>
toolchain::Error SyncExp(const DenseHostTensor& A, DenseHostTensor* B,
                    HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncGreater(const DenseHostTensor& A, const DenseHostTensor& B,
...
template <typename T>
toolchain::Error SyncMinimum(const DenseHostTensor& A, const DenseHostTensor& B,
                        DenseHostTensor* C, HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncMaximum(const DenseHostTensor& A, const DenseHostTensor& B,
                        DenseHostTensor* C, HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncSoftplus(const DenseHostTensor& input, DenseHostTensor* output,
                         HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncSqrt(const DenseHostTensor& A, DenseHostTensor* B,
                     HostContext& host_ctx) {
...
toolchain::Error SyncMean2D(const DenseHostTensor& input,
...
template <typename T>
toolchain::Error SyncLog1p(const DenseHostTensor& A, DenseHostTensor* B,
                      HostContext& host_ctx) {
...
template <typename T>
toolchain::Error SyncTanh(const DenseHostTensor& A, DenseHostTensor* B,
                     HostContext& host_ctx) {
...
toolchain::Error SyncCast(const DenseHostTensor& A, DenseHostTensor* B,
                     HostContext& host_ctx) {
