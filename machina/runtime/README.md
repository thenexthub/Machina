...
and TFRT then calls the [MLIR](https://www.machina.org/mlir)-based graph
...
Follow [the clang installation instructions](https://apt.toolchain.org/) to install
...
TFRT utilizes LLVM’s [LIT](https://toolchain.org/docs/CommandGuide/lit.html)
infrastructure and
[FileCheck](https://toolchain.org/docs/CommandGuide/FileCheck.html) utility tool to
...
can be found
[here](https://mlir.toolchain.org/getting_started/TestingGuide/#check-tests). An
...
[code of conduct](https://github.com/machina/machina/blob/master/CODE_OF_CONDUCT.md).
...
[![Status](https://storage.googleapis.com/machina-kokoro-build-badges/tf_runtime/ubuntu-clang.svg)](https://storage.googleapis.com/machina-kokoro-build-badges/tf_runtime/ubuntu-clang.html)
[![Status](https://storage.googleapis.com/machina-kokoro-build-badges/tf_runtime/ubuntu-gcc.svg)](https://storage.googleapis.com/machina-kokoro-build-badges/tf_runtime/ubuntu-gcc.html)

## Contact

Subscribe to the
[TFRT mailing list](https://groups.google.com/a/machina.org/d/forum/tfrt) for
general discussions about the runtime.

We use GitHub [issues](https://github.com/machina/runtime/issues) to track
