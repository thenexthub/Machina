...
class VariadicOpArg {
 public:
  ...
  explicit VariadicOpArg(ArrayRef<U*> args)
    ...
    for (U* arg : args) {
      ...
      // http://toolchain.org/docs/HowToSetUpLLVMStyleRTTI.html
      // http://toolchain.org/docs/ProgrammersManual.html#the-isa-cast-and-dyn-cast-templates
 ...
 private:
  ...
  toolchain::PointerIntPair<const void*, 1, bool> data_and_type_;
  size_t size_;
};
