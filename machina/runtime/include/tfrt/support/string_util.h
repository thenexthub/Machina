...
std::string StrCat(Args&&... args) {
  std::string str;
  toolchain::raw_string_ostream sstr(str);
...
std::string Join(IteratorT begin, IteratorT end, toolchain::StringRef separator) {
  if (begin == end) return "";
...
std::string Join(const Range& range, toolchain::StringRef separator) {
