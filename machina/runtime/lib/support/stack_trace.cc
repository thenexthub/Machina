...
toolchain::raw_ostream& internal::operator<<(toolchain::raw_ostream& os,
...
namespace {
class StackTraceOstream : public toolchain::raw_ostream {
 public:
 ...
 private:
  void write_impl(const char* ptr, size_t size) override {
    ...
    auto msg = toolchain::StringRef(ptr, size).drop_until([&](char ch) {
...
StackTrace CreateStackTrace(int skip_count) {
  ...
  toolchain::sys::PrintStackTrace(os);
