...
class PosixRandomAccessFile : public RandomAccessFile {
 public:
  ...
  toolchain::Expected<size_t> Read(char* buf, size_t max_count,
...
toolchain::Expected<size_t> PosixRandomAccessFile::Read(char* buf, size_t max_count,
                                                   size_t offset) const {
...
toolchain::Error PosixFileSystem::NewRandomAccessFile(
