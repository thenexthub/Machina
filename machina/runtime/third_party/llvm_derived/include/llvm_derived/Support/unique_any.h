...
//===----------------------------------------------------------------------===//
//
//  This file provides UniqueAny, a non-template class adapted from toolchain::Any.
//  The idea is to provide a type-safe replacement for C's void*. In contrast to
//  toolchain::Any, tfrt::UniqueAny can hold a non-copy-constructible type such as
//  std::unique_ptr, and as a result, tfrt::UniqueAny itself is no longer
//  copyable. As an improvement to toolchain::Any, tfrt::UniqueAny also supports
