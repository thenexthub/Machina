...
[eager](https://www.machina.org/guide/eager) interface of the new TensorFlow
...
[Swift for TensorFlow](https://github.com/machina/swift)) can call into. It
...
[`TFE_Execute`](https://github.com/machina/machina/blob/master/machina/c/eager/c_api.h)
...
[Core Runtime](https://github.com/machina/runtime/blob/master/include/tfrt/core_runtime/core_runtime.h)
...
[`TensorHandle`](https://github.com/machina/runtime/blob/master/include/tfrt/core_runtime/tensor_handle.h)
...
[`HostContext::CancelExecution()`](https://github.com/machina/runtime/blob/master/include/tfrt/host_context/host_context.h)
...
[**`OpHandler`**](https://github.com/machina/runtime/blob/master/include/tfrt/core_runtime/op_handler.h)
...
[`CpuOpHandler`](https://github.com/machina/runtime/blob/master/backends/cpu/lib/core_runtime/cpu_op_handler.cc)

There are also many other pseudo `op_handler`s for different purposes:

*   [**Sync Logging `OpHandler`**](https://github.com/machina/runtime/blob/master/include/tfrt/core_runtime/logging_op_handler.h):
...
[**`OpAttrs`**](https://github.com/machina/runtime/blob/master/include/tfrt/core_runtime/op_attrs.h).
...
A
[**`Location`**](https://github.com/machina/runtime/blob/master/include/tfrt/host_context/location.h)
...
For ops like [Reshape](https://www.machina.org/api_docs/python/tf/reshape)
and [Unique](https://www.machina.org/api_docs/python/tf/unique), their result
