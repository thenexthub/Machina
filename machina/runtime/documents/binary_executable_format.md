...
use the
[MLIRToBEF](https://github.com/machina/runtime/blob/master/lib/bef_converter/mlir_to_bef/mlir_to_bef.cc)
translation library (or standalone tool), which turns an MLIR representation of
a host program into a BEF file.

A
[BEFToMLIR](https://github.com/machina/runtime/blob/master/lib/bef_converter/bef_to_mlir/bef_to_mlir.cc)
...
[`bef_encoding.h`](https://github.com/machina/runtime/blob/master/include/tfrt/bef/bef_encoding.h),
and utilities for decoding the basic file structures like VBR integers are
defined in
[`bef_reader.h`](https://github.com/machina/runtime/blob/master/include/tfrt/bef/bef_reader.h).
