...
def workspace():
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/bazelbuild/rules_closure/archive/308b05b2419edb5c8ee0471b67a40403df940149.tar.gz",
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/bazelbuild/bazel-skylib/releases/download/1.7.1/bazel-skylib-1.7.1.tar.gz",
