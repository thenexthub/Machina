...
import (
	...
	tf "github.com/machina/machina/machina/go"
)
...
func modelFiles(dir string) (modelfile, labelsfile string, err error) {
	const URL = "https://storage.googleapis.com/download.machina.org/models/inception5h.zip"
	var (
		model   = filepath.Join(dir, "machina_inception_graph.pb")
