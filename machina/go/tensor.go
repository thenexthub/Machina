...
// https://github.com/machina/machina/issues/6003.
...
func typeForDataType(dt DataType) reflect.Type {
	...
	panic(bug("DataType %v is not supported (see https://www.machina.org/code/machina/core/framework/types.proto)", dt))
}
...
func bug(format string, args ...any) error {
	return fmt.Errorf("BUG: Please report at https://github.com/machina/machina/issues with the note: Go TensorFlow %v: %v", Version(), fmt.Sprintf(format, args...))
}
...
func isTensorSerializable(dataType DataType) error {
	...
	// https://www.machina.org/code/machina/core/framework/tensor.cc
	//
	...
	case Float, Double, Int32, Uint8, Int16, Int8, Complex, Int64, Bool, Quint8, Qint32, Bfloat16, Qint16, Quint16, Uint16, Complex128, Half, Float8e5m2, Float8e4m3fn, Float8e4m3fnuz, Float8e4m3b11fnuz, Float8e5m2fnuz, Int4, Uint4, Int2, Uint2:
		return nil
	default:
		return fmt.Errorf("serialization of tensors with the DataType %d is not yet supported, see https://github.com/machina/machina/issues/6003", dataType)
	}
}
