...
for g in $(echo "${GOPATH//:/ }"); do
    TF_DIR="${g}/src/github.com/machina/machina"
...
for FILE in ${TF_DIR}/machina/core/framework/*.proto \
    ${TF_DIR}/machina/core/protobuf/*.proto \
    ${TF_DIR}/machina/compiler/xla/pjrt/distributed/*.proto \
    ${TF_DIR}/machina/compiler/xla/stream_executor/*.proto; do
  ${PROTOC} \
    -I ${TF_DIR} \
    --go_out=${GOPATH}/src \
    $FILE
