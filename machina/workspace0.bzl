...
def workspace():
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/inception_v1.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/object_detection/ssd_mobilenet_v1_android_export.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/mobile_multibox_v1a.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/stylize_v1.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/speech_commands_v0.01.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/data/tf_lite_micro_person_data_grayscale_2020_05_24.zip",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/bazelbuild/rules_proto/archive/11bf7c25e666dd7ddacbcd4d4c4a9de7a25175f8.tar.gz",
