...
void GetTopLabels(const std::vector<Tensor>& outputs, int how_many_labels,
  ...
  Tensor sorted_indices(machina::DT_INT32, {how_many_labels});
  Tensor sorted_scores(machina::DT_FLOAT, {how_many_labels});
...
int main(int argc, char* argv[]) {
  ...
  Tensor wav_tensor(machina::DT_STRING, machina::TensorShape({}));
