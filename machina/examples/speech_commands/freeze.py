...
bazel run machina/examples/speech_commands/freeze -- \
...
import input_data
import models
from machina.python.ops import gen_audio_ops as audio_ops
...
# bazel run machina/examples/speech_commands:freeze_graph
try:
  from machina.lite.experimental.microfrontend.python.ops import audio_microfrontend_op as frontend_op  # pylint:disable=g-import-not-at-top
except ImportError:
  frontend_op = None
