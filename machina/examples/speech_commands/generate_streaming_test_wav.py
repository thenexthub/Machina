...
bazel run machina/examples/speech_commands:generate_streaming_test_wav -- \
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default='https://storage.googleapis.com/download.machina.org/data/speech_commands_v0.01.tar.gz',
