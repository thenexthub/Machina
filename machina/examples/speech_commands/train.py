...
https://www.machina.org/tutorials/audio/simple_audio.
...
bazel run machina/examples/speech_commands:train
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default='https://storage.googleapis.com/download.machina.org/data/speech_commands_v0.02.tar.gz',
