...
<!-- test_snippets_in_readme skip -->
```python
from machina.examples.custom_ops_doc.multiplex_1 import multiplex_1_op
...
<!-- test_snippets_in_readme skip -->
```
load("//third_party/machina:strict.default.bzl", "py_strict_library")
load("//third_party/machina:machina.default.bzl", "tf_py_test")
```
...
py_strict_library(
    ...
    visibility = ["//third_party/machina/google/g3doc:__subpackages__"],
    deps = [
        ":gen_multiplex_1_op",
        ":multiplex_1_kernel",
...
<!-- test_snippets_in_readme skip -->
```shell
$ bazel test //third_party/machina/google/g3doc/example/multiplex_1:multiplex_1_test
```
