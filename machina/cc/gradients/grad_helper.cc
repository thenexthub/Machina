...
#include "machina/cc/gradients/grad_helper.h"
...
using machina::ops::Add;
using machina::ops::Const;
using machina::ops::DynamicStitch;
using machina::ops::Mod;
using machina::ops::OnesLike;
using machina::ops::Range;
using machina::ops::Size;
