...
#ifndef MACHINA_CC_EXPERIMENTAL_BASE_PUBLIC_RUNTIME_H_
#define MACHINA_CC_EXPERIMENTAL_BASE_PUBLIC_RUNTIME_H_
...
// object through machina::cc::RuntimeBuilder::Build, after setting any
// relevant configuration options. Many Tensorflow functions take a reference to
// the runtime as an argument (eg: machina::cc::SavedModelAPI::Load), and
// may have different implementations depending on the runtime. For many of
// these Runtime-attached objects (such as machina::cc::TensorHandle), the
...
#endif  // MACHINA_CC_EXPERIMENTAL_BASE_PUBLIC_RUNTIME_H_
