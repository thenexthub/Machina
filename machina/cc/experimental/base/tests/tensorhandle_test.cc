...
#include "machina/cc/experimental/base/public/tensorhandle.h"
...
#include "machina/cc/experimental/base/tests/tensor_types_test_util.h"
...
using machina::experimental::cc::Tensor;
using machina::experimental::cc::TensorHandle;

using SimpleTypes = ::testing::Types<
    machina::FloatType, machina::DoubleType, machina::Int32Type,
    machina::UINT8Type, machina::INT8Type, machina::INT64Type,
    machina::UINT16Type, machina::UINT32Type, machina::UINT64Type>;
