...
using ::machina::protobuf::io::ArrayInputStream;
// NOLINTNEXTLINE: clang-tidy missing-includes false positive
...
absl::StatusOr<RepeatedPtrField<::machina::proto_splitter::FieldIndex>>
...
TEST(FingerprintingTest, TestHashSignatureDef) {
  ...
  ::machina::protobuf::Map<std::string, SignatureDef> signature_def_map;
