...
#ifndef MACHINA_CC_SAVED_MODEL_METRICS_H_
#define MACHINA_CC_SAVED_MODEL_METRICS_H_
...
// Returns "/machina/core/saved_model/write/count" cell. This metric
// has 1 field "write_version", which is equal to the
// `machina::libexport::GetWriteVersion` of the protobuf and should be
...
// Returns "/machina/core/saved_model/read/count" cell. This metric
// has 1 field "write_version", which is equal to the
// `machina::libexport::GetWriteVersion` of the protobuf, and should be
...
// Returns "/machina/core/saved_model/write/api" cell. This metric has 1
...
// Returns "/machina/core/saved_model/read/api" cell. This metric has 1
...
// Returns "/machina/core/saved_model/write/fingerprint" cell, which contains
...
// Returns "/machina/core/saved_model/write/path" cell, which contains
// the saved_model_path of the SM when it is exported.
monitoring::GaugeCell<std::string>& SavedModelWritePath();

// Returns "/machina/core/saved_model/write/path_and_fingerprint" cell, which
...
// Returns "/machina/core/saved_model/read/fingerprint" cell, wich contains
...
// Returns "/machina/core/saved_model/read/path" cell, wich contains
// the saved_model_path of the SM when it is imported.
monitoring::GaugeCell<std::string>& SavedModelReadPath();

// Returns "/machina/core/saved_model/read/path_and_fingerprint" cell, which
...
// Returns "/machina/core/checkpoint/sharding/callback_description" cell
...
#endif  // MACHINA_CC_SAVED_MODEL_METRICS_H_
