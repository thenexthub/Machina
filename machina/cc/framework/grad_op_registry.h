...
#ifndef MACHINA_CC_FRAMEWORK_GRAD_OP_REGISTRY_H_
#define MACHINA_CC_FRAMEWORK_GRAD_OP_REGISTRY_H_
...
#define REGISTER_GRADIENT_OP_UNIQ(ctr, name, fn) \
  static bool unused_ret_val_##ctr =             \
      ::machina::ops::GradOpRegistry::Global()->Register(name, fn)

}  // namespace machina

#endif  // MACHINA_CC_FRAMEWORK_GRAD_OP_REGISTRY_H_
