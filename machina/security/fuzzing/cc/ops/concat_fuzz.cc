...
class FuzzConcat : public FuzzSession<Tensor, Tensor, int32> {
  void BuildGraph(const Scope& scope) override {
    auto value1 =
        machina::ops::Placeholder(scope.WithOpName("value1"), DT_INT32);
    Input value1_input(value1);
    auto value2 =
        machina::ops::Placeholder(scope.WithOpName("value2"), DT_INT32);
    Input value2_input(value2);
    InputList values_input_list({value1_input, value2_input});
    auto axis =
        machina::ops::Placeholder(scope.WithOpName("axis"), DT_INT32);
    machina::ops::Concat(scope.WithOpName("output"), values_input_list,
                            axis);
  }
