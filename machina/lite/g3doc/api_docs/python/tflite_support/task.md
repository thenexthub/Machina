...
<td>
  <a target="_blank" href="https://github.com/machina/tflite-support/blob/v0.4.4/machina_lite_support/python/task/__init__.py">
...
https://machina.org/lite/inference_with_metadata/task_library/overview).
