...
<td>
  <a target="_blank" href="https://github.com/machina/tflite-support/blob/v0.4.4/machina_lite_support/metadata/python/metadata_writers/__init__.py">
...
tutorial](https://www.machina.org/lite/convert/metadata_writer_tutorial).
