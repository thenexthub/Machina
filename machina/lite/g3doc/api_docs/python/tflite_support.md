...
the [metadata section](https://www.machina.org/lite/convert/metadata) of the
TensorFlow Lite guide.

To learn more about Task Library, check out the
[documentation](https://www.machina.org/lite/inference_with_metadata/task_library/overview)
