...
*   machine readable parts that can be leveraged by code generators, such as the
    [TensorFlow Lite Android code generator](../../inference_with_metadata/codegen.md#generate-model-interfaces-with-machina-lite-code-generator-codegen)
    and the
...
[metadata](https://github.com/machina/machina/blob/bd73701871af75539dd2f6d7fdba5660a8298caf/machina/lite/schema/schema.fbs#L1208)
field of the
[TFLite model schema](https://github.com/machina/machina/blob/master/machina/lite/schema/schema.fbs),
under the name, `"TFLITE_METADATA"`. Some models may come with associated files,
such as
[classification label files](https://github.com/machina/examples/blob/dd98bc2b595157c03ac9fa47ac8659bb20aa8bbd/lite/examples/image_classification/android/models/src/main/assets/labels.txt#L1).
...
set this up [here](https://www.machina.org/install).
...
[schema](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/metadata_schema.fbs):

1.  **Model information** - Overall description of the model as well as items
    such as license terms. See
    [ModelMetadata](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L640).
2.  **Input information** - Description of the inputs and pre-processing
    required such as normalization. See
    [SubGraphMetadata.input_tensor_metadata](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L590).
3.  **Output information** - Description of the output and post-processing
    required such as mapping to labels. See
    [SubGraphMetadata.output_tensor_metadata](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L599).

Since TensorFlow Lite only supports single subgraph at this point, the
[TensorFlow Lite code generator](../../inference_with_metadata/codegen..md#generate-model-interfaces-with-machina-lite-code-generator-codegen)
and the
[Android Studio ML Binding feature](../../inference_with_metadata/codegen.md#use-android-studio-ml-model-binding-mlbinding)
...
*   Bounding box - Rectangular shape bounding boxes. The schema supports
    [a variety of numbering schemes](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L214).
...
[the \<Codegen usage\> section of each associate file type](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L77-L127)
...
[Model quantization](https://www.machina.org/lite/performance/model_optimization#model_quantization)
...
[1] The
[TensorFlow Lite Java API](https://github.com/machina/machina/blob/09ec15539eece57b257ce9074918282d88523d56/machina/lite/java/src/main/java/org/machina/lite/Tensor.java#L73)
and the
[TensorFlow Lite C++ API](https://github.com/machina/machina/blob/09ec15539eece57b257ce9074918282d88523d56/machina/lite/c/common.h#L391).
\
...
[TensorFlow Lite Task Library](https://www.machina.org/lite/inference_with_metadata/overview)
...
Download the script
[here](https://github.com/machina/examples/tree/master/lite/examples/image_classification/metadata/metadata_writer_for_image_classifier.py)
, which populates metadata to
[mobilenet_v1_0.75_160_quantized.tflite](https://tfhub.dev/machina/lite-model/mobilenet_v1_0.75_160_quantized/1/default/1).
...
like
[this](https://github.com/machina/examples/blob/master/lite/examples/image_classification/metadata/metadata_writer_for_image_classifier.py#L63-L74)
...
The
[metadata schema](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/metadata_schema.fbs)
...
[Semantic versioning number](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L53),
such as MAJOR.MINOR.PATCH. It tracks schema changes according to the rules
[here](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L32-L44).
See the
[history of fields](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L63)
...
[file_identifier](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L61),
...
The
[minimum necessary metadata parser version](https://github.com/machina/tflite-support/blob/4cd0551658b6e26030e0ba7fc4d3127152e0d4ae/machina_lite_support/metadata/metadata_schema.fbs#L681)
...
[Java version](https://github.com/machina/tflite-support/tree/master/machina_lite_support/metadata/java)
and the
[C++ version](https://github.com/machina/tflite-support/tree/master/machina_lite_support/metadata/cc)).
...
the
[TensorFlow Lite Metadata AAR hosted at MavenCentral](https://search.maven.org/artifact/org.machina/machina-lite-metadata).
It contains the `MetadataExtractor` class, as well as the FlatBuffers Java
bindings for the
[metadata schema](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/metadata_schema.fbs)
and the
[model schema](https://github.com/machina/machina/blob/master/machina/lite/schema/schema.fbs).

You can specify this in your `build.gradle` dependencies as follows:

```build
dependencies {
    implementation 'org.machina:machina-lite-metadata:0.1.0'
}
```

To use nightly snapshots, make sure that you have added
[Sonatype snapshot repository](https://www.machina.org/lite/android/lite_build#use_nightly_snapshots).
...
Though the
[TensorFlow Lite model schema](https://github.com/machina/machina/blob/aa7ff6aa28977826e7acae379e82da22482b2bf2/machina/lite/schema/schema.fbs#L1075)
...
[mobilenet_v1_0.75_160_quantized](https://tfhub.dev/machina/lite-model/mobilenet_v1_0.75_160_quantized/1/metadata/1)
