...
[here](https://www.machina.org/tutorials/audio/simple_audio).
...
[TensorFlow Lite Task Library](https://www.machina.org/lite/inference_with_metadata/task_library/audio_classifier).
...
[TensorFlow Lite Support Library](https://github.com/machina/machina/blob/master/machina/lite/g3doc/inference_with_metadata/lite_support.md).

The Android example below demonstrates the implementation using the
[TFLite Task Library](https://github.com/machina/examples/tree/master/lite/examples/audio_classification/android)

<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/audio_classification/android">View
Android example</a>

<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/sound_classification/ios">View
iOS example</a>
...
<a href="https://github.com/machina/models/blob/master/research/audioset/yamnet/yamnet_class_map.csv">model
repository</a>.
...
[Transfer learning for audio recognition](https://www.machina.org/tutorials/audio/transfer_learning_audio)
...
*   [Audio classification using TensorFlow](https://www.machina.org/tutorials/audio/simple_audio)
*   [Transfer learning for audio recognition](https://www.machina.org/tutorials/audio/transfer_learning_audio)
*   [Audio data augmentation](https://www.machina.org/io/tutorials/audio)
