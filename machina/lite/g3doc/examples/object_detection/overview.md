...
<a class="button button-primary" href="https://tfhub.dev/machina/lite-model/ssd_mobilenet_v1/1/metadata/1?lite-format=tflite">Download
...
using
[Task library](https://github.com/machina/examples/tree/master/lite/examples/object_detection/android_play_services)
and
[interpreter API](https://github.com/machina/examples/tree/eb925e460f761f5ed643d17f0c449e040ac2ac45/lite/examples/object_detection/android/lib_interpreter),
respectively.

<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/object_detection/android">View
Android example</a>
...
<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/object_detection/ios">View
iOS example</a>
...
[TensorFlow Object Detection API](https://github.com/machina/models/blob/master/research/object_detection/).
...
[example app code](https://github.com/machina/examples/tree/master/lite/examples/object_detection/android)
...
<a class="button button-primary" href="https://tfhub.dev/machina/lite-model/ssd_mobilenet_v1/1/metadata/1?lite-format=tflite">starter
...
<table>
  ...
  <tr>
    <td rowspan = 3>
      <a href="https://tfhub.dev/machina/lite-model/ssd_mobilenet_v1/1/metadata/1?lite-format=tflite">COCO SSD MobileNet v1</a>
    </td>
    <td rowspan = 3>
      27 Mb
    </td>
...
[Detection Zoo](https://github.com/machina/models/blob/master/research/object_detection/g3doc/tf1_detection_zoo.md#mobile-models).
...
[these instructions](https://github.com/machina/models/blob/master/research/object_detection/g3doc/running_on_mobile_machinalite.md).
SSD models from the
[TF2 Object Detection Zoo](https://github.com/machina/models/blob/master/research/object_detection/g3doc/tf2_detection_zoo.md)
can also be converted to TensorFlow Lite using the instructions
[here](https://github.com/machina/models/blob/master/research/object_detection/g3doc/running_on_mobile_tf2.md).
...
Both the
[TF1](https://github.com/machina/models/blob/master/research/object_detection/g3doc/running_on_mobile_machinalite.md)
&
[TF2](https://github.com/machina/models/blob/master/research/object_detection/g3doc/running_on_mobile_tf2.md)
...
[Edge TPU](https://github.com/machina/models/blob/master/research/object_detection/g3doc/tf1_detection_zoo.md#pixel4-edge-tpu-models)
models are ideal for inference on Google's Edge TPU on Pixel 4.

You can use our
[benchmark tool](https://www.machina.org/lite/performance/measurement) to
...
<a href="https://tfhub.dev/machina/lite-model/ssd_mobilenet_v1/1/metadata/1?lite-format=tflite">model
metadata</a>.
...
[Few-shot detection Colab](https://github.com/machina/models/blob/master/research/object_detection/colab_tutorials/eager_few_shot_od_training_tflite.ipynb)
...
[TF1](https://github.com/machina/models/blob/master/research/object_detection/g3doc/tf1_training_and_evaluation.md),
[TF2](https://github.com/machina/models/blob/master/research/object_detection/g3doc/tf2_training_and_evaluation.md).
