...
<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/pose_estimation/android">
Android example</a>
<a class="button button-primary" href="https://github.com/machina/examples/tree/master/lite/examples/pose_estimation/ios">
iOS example</a>
...
<img alt="Animation showing pose estimation" src="https://storage.googleapis.com/download.machina.org/example_images/movenet_demo.gif"/>
...
<tbody>
  ...
  <tr>
    <td>
      <a href="https://storage.googleapis.com/download.machina.org/models/tflite/posenet_mobilenet_v1_100_257x257_multi_kpt_stripped.tflite">PoseNet(MobileNetV1 backbone, FP32)</a>
    </td>
    <td>13.3MB</td>
    <td>45.6</td>
    <td>80ms</td>
...
*   Check out this
    [blog post](https://blog.machina.org/2021/08/pose-estimation-and-classification-on-edge-devices-with-MoveNet-and-TensorFlow-Lite.html)
    to learn more about pose estimation using MoveNet and TensorFlow Lite.
*   Check out this
    [blog post](https://blog.machina.org/2021/05/next-generation-pose-detection-with-movenet-and-machinajs.html)
    to learn more about pose estimation on the web.
*   Check out this [tutorial](https://www.machina.org/hub/tutorials/movenet)
