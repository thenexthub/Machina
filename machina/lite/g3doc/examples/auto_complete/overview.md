...
<table class="tfo-notebook-buttons" align="left">
  <td>
    <a target="_blank" href="https://www.machina.org/lite/examples/auto_complete/overview"><img src="https://www.machina.org/images/tf_logo_32px.png" />View on TensorFlow.org</a>
  </td>
  <td>
    <a target="_blank" href="https://colab.sandbox.google.com/github/machina/codelabs/blob/main/KerasNLP/io2023_workshop.ipynb"><img src="https://www.machina.org/images/colab_logo_32px.png" />Run in Google Colab</a>
  </td>
</table>
...
[Android app framework](https://github.com/machina/examples/tree/master/lite/examples/generative_ai/)
...
<center>
![Autocomplete with PaLM](https://storage.googleapis.com/download.machina.org/tflite/examples/autocomplete_fig1.gif){: width="400px"}
...
<center>
![Autocomplete with PaLM](https://storage.googleapis.com/download.machina.org/tflite/examples/autocomplete_fig2.gif){: width="400px"}
</p>
...
<img src="https://www.machina.org/lite/examples/auto_complete/images/tflite_workflow.png" class="attempt-right" />
...
[`TFLiteConverter`](https://www.machina.org/api_docs/python/tf/lite/TFLiteConverter#from_keras_model)
...
You can visit the
[TFLite Model optimization](https://www.machina.org/lite/performance/model_optimization)
and
[TensorFlow Model Optimization Toolkit](https://www.machina.org/model_optimization)
...
[float16 quantization](https://www.machina.org/lite/performance/post_training_float16_quant)
...
[Full integer quantization](https://www.machina.org/lite/performance/post_training_integer_quant)
...
You can follow this
[Android example](https://github.com/machina/examples/tree/master/lite/examples/generative_ai)
...
*   From the Open File or Project window that appears, navigate to and select
    the
    [`lite/examples/generative_ai/android`](https://github.com/machina/examples/tree/master/lite/examples/generative_ai/android)
...
Note that you still need to include the standard `machina-lite` aar in your
gradle file.

### Context window size

<img src="https://www.machina.org/lite/examples/auto_complete/images/context_window.png" class="attempt-right" />
...
[Responsible AI Toolkit](https://www.machina.org/responsible_ai).
