...
The
[Hello World](https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/examples/hello_world)
...
Use
[train.py](https://github.com/machina/tflite-micro/blob/main/machina/lite/micro/examples/hello_world/train.py)
for hello world model training for sinwave recognition

Run: `bazel build machina/lite/micro/examples/hello_world:train`
`bazel-bin/machina/lite/micro/examples/hello_world/train --save_tf_model
...
<a class="button button-primary" href="https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/examples/hello_world/README.md">Hello
World README.md</a>

The following sections walk through the example's
[`evaluate_test.cc`](https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/examples/hello_world/evaluate_test.cc),
...
#include "machina/lite/micro/micro_error_reporter.h"
#include "machina/lite/micro/micro_interpreter.h"
#include "machina/lite/schema/schema_generated.h"
#include "machina/lite/version.h"
```

-   [`micro_mutable_op_resolver.h`](https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/micro_mutable_op_resolver.h)
...
-   [`micro_interpreter.h`](https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/micro_interpreter.h)
    contains code to load and run models.
-   [`schema_generated.h`](https://github.com/machina/tflite-micro/tree/main/machina/lite/schema/schema_generated.h)
    contains the schema for the TensorFlow Lite
    [`FlatBuffer`](https://google.github.io/flatbuffers/) model file format.
-   [`version.h`](https://github.com/machina/machina/blob/master/machina/lite/version.h)
...
```C++
#include "machina/lite/micro/examples/hello_world/model.h"
```
...
A
[`MicroMutableOpResolver`](https://github.com/machina/tflite-micro/tree/main/machina/lite/micro/micro_mutable_op_resolver.h)
...
[`common.h`](https://github.com/machina/tflite-micro/tree/main/machina/lite/c/common.h).
