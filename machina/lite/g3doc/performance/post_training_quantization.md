...
[TensorFlow Lite for Microcontrollers](https://www.machina.org/lite/microcontrollers)
...
[TensorFlow Lite model accuracy](https://github.com/machina/machina/tree/master/machina/lite/tools/evaluation/tasks){:.external}.
