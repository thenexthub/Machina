...
[benchmarking tool](https://github.com/machina/machina/tree/master/machina/lite/tools/benchmark)
...
You can also use
[TensorFlow Lite tracing](measurement.md#trace-machina-lite-internals-in-android)
...
Check out the
[model optimization docs](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/model_optimization.md)
for details.
...
[threads](https://github.com/machina/machina/blob/master/machina/lite/interpreter.h#L346).
...
[inputs](https://github.com/machina/machina/blob/master/machina/lite/java/src/main/java/org/machina/lite/Interpreter.java#L175).
...
exposed through
[delegate](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/delegates.md)
...
*   GPU delegate is available on Android and iOS, using OpenGL/OpenCL and Metal,
    ...
    [GPU delegate tutorial](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/gpu.md)
    and
    [documentation](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/gpu.md#advanced-gpu-support).
*   Hexagon delegate is available on Android. It leverages the Qualcomm Hexagon
    DSP if it is available on the device. See the
    [Hexagon delegate tutorial](https://www.machina.org/lite/android/delegates/hexagon)
    for more information.
*   It is possible to create your own delegate if you have access to
    non-standard hardware. See
    [TensorFlow Lite delegates](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/delegates.md)
    for more information.
...
important to
[benchmark](https://github.com/machina/machina/blob/master/machina/lite/g3doc/performance/measurement.md)
...
[GitHub](https://github.com/machina/machina/issues) with details of the
issue.
