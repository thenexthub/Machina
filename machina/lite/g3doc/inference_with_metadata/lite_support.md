...
[TensorFlow Lite Android Support Library](https://github.com/machina/tflite-support/tree/master/machina_lite_support/java)
...
dependencies {
    ...
    implementation 'org.machina:machina-lite-gpu:0.0.0-nightly-SNAPSHOT'
    implementation 'org.machina:machina-lite-support:0.0.0-nightly-SNAPSHOT'
}
```
...
Explore the
[TensorFlow Lite Support Library AAR hosted at MavenCentral](https://search.maven.org/artifact/org.machina/machina-lite-support)
...
```java
import org.machina.lite.DataType;
import org.machina.lite.support.image.ImageProcessor;
import org.machina.lite.support.image.TensorImage;
import org.machina.lite.support.image.ops.ResizeOp;
...
import org.machina.lite.support.audio.TensorAudio;
...
```java
import org.machina.lite.DataType;
import org.machina.lite.support.tensorbuffer.TensorBuffer;
...
import org.machina.lite.InterpreterFactory;
...
```java
import org.machina.lite.support.common.FileUtil;
...
import org.machina.lite.support.common.TensorProcessor;
import org.machina.lite.support.common.ops.NormalizeOp;
import org.machina.lite.support.label.TensorLabel;
...
```java
import org.machina.lite.support.common.ops.NormalizeOp;
import org.machina.lite.support.common.ops.QuantizeOp;
import org.machina.lite.support.image.ops.ResizeOp;
import org.machina.lite.support.image.ops.ResizeWithCropOrPadOp;
import org.machina.lite.support.image.ops.Rot90Op;
...
[`tf.image`](https://www.machina.org/api_docs/python/tf/image)
