...
See the
[Audio Classification reference app](https://github.com/machina/examples/tree/master/lite/examples/audio_classification/android)
...
dependencies {
    ...
    implementation 'org.machina:machina-lite-task-audio:0.4.4'
...
See the
[source code and javadoc](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/audio/classifier/AudioClassifier.java)
...
// https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/audio/core/audio_tensor/sources/TFLAudioTensor.h
let audioTensor = classifier.createInputAudioTensor()

// Create Audio Record to record the incoming audio samples from the on-device microphone.
// Created Audio Record has audio format matching the requirements of the audio classifier.
// For more details, please see:
https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/audio/core/audio_record/sources/TFLAudioRecord.h
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/audio/sources/TFLAudioClassifier.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/audio/audio_classifier.py)
for more options to configure `AudioClassifier`.
...
// See more information here: machina_lite_support/cc/task/audio/core/audio_buffer.h
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/audio/audio_classifier.h)
for more options to configure `AudioClassifier`.
