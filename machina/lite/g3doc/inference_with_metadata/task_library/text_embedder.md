...
As opposed to
[text search](https://www.machina.org/lite/inference_with_metadata/task_library/text_searcher),
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/text_embedder.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/text/text_embedder.py)
for more options to configure `TextEmbedder`.
...
Try out the simple
[CLI demo tool for TextEmbedder](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/text/desktop#textembedder)
...
*   BERT-based models (see
    [source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/utils/bert_utils.h)
    for more details):
...
*   Universal Sentence Encoder-based models (see
    [source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/utils/universal_sentence_encoder_utils.h)
    for more details):
