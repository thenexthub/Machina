...
[BaseTaskApi](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/core/base_task_api.h)
...
[`BertQuestionAnswerer`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/bert_question_answerer.h)
for
[MobileBert](https://tfhub.dev/machina/lite-model/mobilebert/1/default/1).
...
*   **Determine the API I/O** - Your API should expose similar input/output
    ...
    [template parameter](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/core/base_task_api.h?q="template <class OutputType, class... InputTypes>").
    With the template parameters specified, the
    [`BaseTaskApi::Infer`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/core/base_task_api.h?q="Infer\(InputTypes... args\)")
...
*   **Provide conversion logic between API I/O and input/output tensor of the
    ...
    [`BaseTaskApi::Preprocess`](https://github.com/machina/tflite-support/blob/5cea306040c40b06d6e0ed4e5baf6c307db7bd00/machina_lite_support/cc/task/core/base_task_api.h#L74)
    and
    [`BaseTaskApi::Postprocess`](https://github.com/machina/tflite-support/blob/5cea306040c40b06d6e0ed4e5baf6c307db7bd00/machina_lite_support/cc/task/core/base_task_api.h#L80).
    The two functions provide
    [inputs](https://github.com/machina/machina/blob/1b84e5af78f85b8d3c4687b7dee65b78113f81cc/machina/lite/schema/schema.fbs#L1007)
    and
    [outputs](https://github.com/machina/machina/blob/1b84e5af78f85b8d3c4687b7dee65b78113f81cc/machina/lite/schema/schema.fbs#L1008)
    ...
    example in
    [`BertQuestionAnswerer`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/bert_question_answerer.cc).
...
*   **Create factory functions of the API** - A model file and a
    [`OpResolver`](https://github.com/machina/machina/blob/master/machina/lite/core/api/op_resolver.h)
    are needed to initialize the
    [`tflite::Interpreter`](https://github.com/machina/machina/blob/master/machina/lite/interpreter.h).
    [`TaskAPIFactory`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/core/task_api_factory.h)
    provides utility functions to create BaseTaskApi instances.

    Note: By default
    [`TaskAPIFactory`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/core/task_api_factory.h)
    provides a
    [`BuiltInOpResolver`](https://github.com/machina/machina/blob/master/machina/lite/kernels/register.h).
    If your model needs customized ops or a subset of built-in ops, you can
    register them by creating a
    [`MutableOpResolver`](https://github.com/machina/machina/blob/master/machina/lite/mutable_op_resolver.h).
...
[`BertQuestionAnswerer`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/text/qa/BertQuestionAnswerer.java)
for
[MobileBert](https://tfhub.dev/machina/lite-model/mobilebert/1/default/1).
...
[`BaseTaskApi`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/core/BaseTaskApi.java),
...
*   __Create factory functions of the API__ - This also mirrors native factory
    ...
    [`TaskJniUtils`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/core/TaskJniUtils.java)
...
*   __Implement the JNI module for native functions__ - All Java native methods
    ...
    [bert_question_answerer_jni](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/native/task/text/qa/bert_question_answerer_jni.cc)
    is implemented.

    ```cpp
      // Implements BertQuestionAnswerer::initJniWithBertByteBuffers
      extern "C" JNIEXPORT jlong JNICALL
      Java_org_machina_lite_task_text_qa_BertQuestionAnswerer_initJniWithBertByteBuffers(
      ...
      Java_org_machina_lite_task_text_qa_BertQuestionAnswerer_answerNative(
      ...
      jclass qa_answer_class =
        env->FindClass("org/machina/lite/task/text/qa/QaAnswer");
...
[`TFLBertQuestionAnswerer`](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/text/qa/Sources/TFLBertQuestionAnswerer.h)
for [MobileBert](https://tfhub.dev/machina/lite-model/mobilebert/1/default/1)
in Swift.
