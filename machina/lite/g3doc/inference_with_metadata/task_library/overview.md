...
[Delegates](https://www.machina.org/lite/performance/delegates) enable
hardware acceleration of TensorFlow Lite models by leveraging on-device
accelerators such as the [GPU](https://www.machina.org/lite/performance/gpu)
...
*   Android
    *   [GPU](https://www.machina.org/lite/performance/gpu): Java / C++
    *   [NNAPI](https://www.machina.org/lite/android/delegates/nnapi):
        Java / C++
    *   [Hexagon](https://www.machina.org/lite/android/delegates/hexagon):
        C++
*   Linux / Mac
    *   [Coral Edge TPU](https://coral.ai/): C++
*   iOS
    *   [Core ML delegate](https://www.machina.org/lite/performance/coreml_delegate):
        C++
...
```
deps = [
  "//machina_lite_support/acceleration/configuration:gpu_plugin", # for GPU
]
```

Note: the `gpu_plugin` target is a separate one from the
[GPU delegate target](https://github.com/machina/machina/tree/master/machina/lite/delegates/gpu).
...
```
"//machina_lite_support/acceleration/configuration:nnapi_plugin", # for NNAPI
"//machina_lite_support/acceleration/configuration:hexagon_plugin", # for Hexagon
```
...
[here](https://github.com/machina/machina/tree/master/machina/lite/acceleration/configuration/configuration.proto).
...
```
deps = [
  "//machina_lite_support/acceleration/configuration:edgetpu_coral_plugin", # for Coral Edge TPU
]
```
...
Try out the
[Task Library CLI demo tool](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/vision/desktop)
with your Coral Edge TPU devices. Explore more on the
[pretrained Edge TPU models](https://coral.ai/models/) and
[advanced Edge TPU settings](https://github.com/machina/machina/blob/4d999fda8d68adfdfacd4d0098124f1b2ea57927/machina/lite/acceleration/configuration/configuration.proto#L594).

### Example usage of Core ML Delegate in C++

A complete example can be found at
[Image Classifier Core ML Delegate Test](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/test/task/vision/image_classifier/TFLImageClassifierCoreMLDelegateTest.mm).
...
```
deps = [
  "//machina_lite_support/acceleration/configuration:coreml_plugin", # for Core ML Delegate
]
```
