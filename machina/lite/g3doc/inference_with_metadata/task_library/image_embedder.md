...
As opposed to
[image search](https://www.machina.org/lite/inference_with_metadata/task_library/image_searcher),
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/vision/image_embedder.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/vision/image_embedder.py)
for more options to configure `ImageEmbedder`.
...
Try out the simple
[CLI demo tool for ImageEmbedder](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/vision/desktop#imageembedder)
