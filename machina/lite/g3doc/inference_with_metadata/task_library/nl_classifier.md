...
*   Models with `average_word_vec` spec created by
    [TensorFlow Lite Model Maker for text Classification](https://www.machina.org/lite/models/modify/model_maker/text_classification).
...
See the
[Text Classification reference app](https://github.com/machina/examples/blob/master/lite/examples/text_classification/android/lib_task_api/src/main/java/org/machina/lite/examples/textclassification/client/TextClassificationClient.java)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/text/nlclassifier/NLClassifier.java)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/text/nlclassifier/Sources/TFLNLClassifier.h)
for more details.
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/text/nlclassifier/nl_classifier.h)
for more details.
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/text/nl_classifier.py)
for more options to configure `NLClassifier`.

## Example results

Here is an example of the classification results of the
[movie review model](https://www.machina.org/lite/examples/text_classification/overview).
...
Try out the simple
[CLI demo tool for NLClassifier](https://github.com/machina/tflite-support/blob/master/machina_lite_support/examples/task/text/desktop/README.md#nlclassifier)
...
*   Input tensor: (kTfLiteString/kTfLiteInt32)
    ...
    -   If input type is kTfLiteInt32, a `RegexTokenizer` needs to be set up in
        the input tensor's
        [Metadata](https://www.machina.org/lite/models/convert/metadata_writer_tutorial#natural_language_classifiers).
...
*   Output score tensor:
    ...
    -   Can have an optional associated file in the output tensor's
        ...
        [example label file](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/python/tests/testdata/nl_classifier/labels.txt).
