...
As opposed to
[image classification](https://www.machina.org/lite/inference_with_metadata/task_library/image_classifier),
...
See the
[source code and javadoc](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/vision/searcher/ImageSearcher.java)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/vision/image_searcher.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/vision/image_searcher.py)
for more options to configure `ImageSearcher`.
...
Try out the simple
[CLI demo tool for ImageSearcher](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/vision/desktop#imagesearcher)
