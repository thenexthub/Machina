...
the
[image classification overview](https://www.machina.org/lite/examples/image_classification/overview)
...
*   Models created by
    [TensorFlow Lite Model Maker for Image Classification](https://www.machina.org/lite/models/modify/model_maker/image_classification).

*   The
    [pretrained image classification models on TensorFlow Hub](https://tfhub.dev/machina/collections/lite/task-library/image-classifier/1).
...
See the
[Image Classification reference app](https://github.com/machina/examples/blob/master/lite/examples/image_classification/android/README.md)
...
See the
[source code and javadoc](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/vision/classifier/ImageClassifier.java)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/vision/sources/TFLImageClassifier.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/vision/image_classifier.py)
for more options to configure `ImageClassifier`.
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/vision/image_classifier.h)
for more options to configure `ImageClassifier`.
...
Try out the simple
[CLI demo tool for ImageClassifier](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/vision/desktop#image-classifier)
...
*   Output score tensor (kTfLiteUInt8/kTfLiteFloat32)
    ...
    -   optional (but recommended) label map(s) as AssociatedFile-s with type
        ...
        [example label file](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/python/tests/testdata/image_classifier/labels.txt).
