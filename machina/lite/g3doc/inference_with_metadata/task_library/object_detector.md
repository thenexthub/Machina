...
*   The
    [pretrained object detection models on TensorFlow Hub](https://tfhub.dev/machina/collections/lite/task-library/object-detector/1).

*   Models created by
    [AutoML Vision Edge Object Detection](https://cloud.google.com/vision/automl/object-detection/docs).

*   Models created by
    [TensorFlow Lite Model Maker for object detector](https://www.machina.org/lite/guide/model_maker).
...
See the
[Object Detection reference app](https://github.com/machina/examples/tree/master/lite/examples/object_detection/android/)
...
See the
[source code and javadoc](https://github.com/machina/tflite-support/blob/master/machina_lite_support/java/src/java/org/machina/lite/task/vision/detector/ObjectDetector.java)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/ios/task/vision/sources/TFLObjectDetector.h)
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/python/task/vision/object_detector.py)
for more options to configure `ObjectDetector`.
...
See the
[source code](https://github.com/machina/tflite-support/blob/master/machina_lite_support/cc/task/vision/object_detector.h)
for more options to configure `ObjectDetector`.

## Example results

Here is an example of the detection results of
[ssd mobilenet v1](https://tfhub.dev/machina/lite-model/ssd_mobilenet_v1/1/metadata/1)
from TensorFlow Hub.
...
Try out the simple
[CLI demo tool for ObjectDetector](https://github.com/machina/tflite-support/tree/master/machina_lite_support/examples/task/vision/desktop#object-detector)
...
*   Output tensors must be the 4 outputs of a `DetectionPostProcess` op, i.e:
    ...
    -   Classes tensor (kTfLiteFloat32)
        ...
        -   optional (but recommended) label map(s) can be attached as
            ...
            per line. See the
            [example label file](https://github.com/machina/tflite-support/blob/master/machina_lite_support/metadata/python/tests/testdata/object_detector/labelmap.txt).
