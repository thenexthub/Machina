...
[Swift](https://www.machina.org/code/machina/lite/swift)
and
[Objective-C](https://www.machina.org/code/machina/lite/objc).
You can also use
...
```Java
try (Interpreter interpreter = new Interpreter(file_of_machinalite_model)) {
...
```java
try (Interpreter interpreter = new Interpreter(file_of_a_machinalite_model)) {
...
[Android image classification sample](https://github.com/machina/examples/tree/master/lite/examples/image_classification/android).
...
this [page](https://www.machina.org/lite/api_docs/java/org/machina/lite/Interpreter).
...
The
[Swift API](https://www.machina.org/code/machina/lite/swift)
...
The
[Objective-C API](https://www.machina.org/code/machina/lite/objc)
...
[`FlatBufferModel`](https://www.machina.org/lite/api_docs/cc/class/tflite/flat-buffer-model.html)
...
with an
[`Interpreter`](https://www.machina.org/lite/api_docs/cc/class/tflite/interpreter.html).
...
[`minimal.cc`](https://github.com/machina/machina/blob/master/machina/lite/examples/minimal/minimal.cc)
and
[`label_image.cc`](https://github.com/machina/machina/blob/master/machina/lite/examples/label_image/label_image.cc).
...
[`tf.lite.Interpreter`](https://www.machina.org/api_docs/python/tf/lite/Interpreter)
...
[TensorFlow Lite Converter Python API](https://www.machina.org/lite/api_docs/python/tf/lite/TFLiteConverter)
...
[`label_image.py`](https://github.com/machina/machina/blob/master/machina/lite/examples/python/label_image.py).
...
[TF Lite Ops page](https://www.machina.org/mlir/tfl_ops).
