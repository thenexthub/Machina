...
[GitHub issue](https://github.com/machina/machina/issues).
...
[allowlist](https://github.com/machina/machina/blob/master/machina/lite/g3doc/guide/op_select_allowlist.md))
...
search our
[GitHub issues](https://github.com/machina/machina/issues?q=label%3Acomp%3Alite+)
or file a [new one](https://github.com/machina/machina/issues).
...
[summarize_graph](https://github.com/machina/machina/blob/master/machina/tools/graph_transforms/README.md#inspecting-graphs)
tool.

If the summarize_graph tool yields an error, you can visualize the GraphDef with
[TensorBoard](https://www.machina.org/guide/summaries_and_tensorboard) and
look for the inputs and outputs in the graph. To visualize a `.pb` file, use the
[`import_pb_to_tensorboard.py`](https://github.com/machina/machina/blob/master/machina/python/tools/import_pb_to_tensorboard.py)
script like below:
...
```shell
python -m machina.lite.tools.visualize model.tflite visualized_model.html
```

Otherwise, you can run this script with Bazel

*   [Clone the TensorFlow repository](https://www.machina.org/install/source)
*   Run the `visualize.py` script with bazel:

```shell
bazel run //machina/lite/tools:visualize model.tflite visualized_model.html
```
...
*   *Tweak the number of threads.* Many TensorFlow Lite operators support
    ...
    [C++ API](https://github.com/machina/machina/blob/master/machina/lite/core/interpreter_builder.h#L110)
