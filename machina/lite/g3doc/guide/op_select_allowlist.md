...
The following
[TensorFlow Text](https://www.machina.org/tutorials/machina_text/intro)
...
import machina_text as tf_text
...
If you
[created your own TensorFlow operators](https://www.machina.org/guide/create_op),
...
allowed
[list](https://www.machina.org/lite/guide/op_select_allowlist#machina_core_operators),
you can report the feature request at
[here](https://github.com/machina/machina/issues) with the names of the
...
[commit](https://github.com/machina/machina/commit/02e691329517eb5e76522ed8d8bef79ceb082ff8).
...
`machina/core/kernels` directory, you can search the source code location,
...
If there are any header files under the `machina/core/kernels` directory,
...
`machina/compiler/mlir/lite/delegates/flex/allowlisted_flex_ops.cc`. The
...
`machina/lite/g3doc/guide/op_select_allowlist.md`.
