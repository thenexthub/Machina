...
[example application](https://github.com/machina/examples/tree/master/lite/examples/bert_qa/android)
...
([`mobilebert`](https://tfhub.dev/machina/lite-model/mobilebert/1/metadata/1))
...
[GitHub](https://github.com/machina/examples/tree/master/lite/examples/bert_qa/android)
...
*   [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt) -
    Initializes the question answerer and handles the model and delegate
    selection.
*   [QaFragment.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/fragments/QaFragment.kt) -
    Handles and formats the results.
*   [MainActivity.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/MainActivity.kt) -
...
1.  In the module that uses TensorFlow Lite, update the module's `build.gradle`
    ...
    [app/build.gradle](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/build.gradle):

    ```
    dependencies {
      ...
      // Import machina library
      implementation 'org.machina:machina-lite-task-text:0.3.0'
...
[`download_model.gradle`](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/download_models.gradle)
file to download the
[mobilebert_qa](https://www.machina.org/lite/inference_with_metadata/task_library/bert_question_answerer)
model and
[passage text](https://storage.googleapis.com/download.machina.org/models/tflite/bert_qa/contents_from_squad.json)
...
1.  Create a companion object to define the settings for the model. In the
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L100-L106):
...
1.  Create the settings for the model by building a `BertQaHelper` object, and
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L41-L76):
...
1.  Create a variable to define the delegate that the application will use. In
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L31):
...
1.  Create a delegate selector. In the example application, the delegate
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L48-L62):
...
1.  Use the `LoadDataSetClient` object to load the passage text data to the app.
    ...
    [LoadDataSetClient.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/dataset/LoadDataSetClient.kt#L25-L45)
...
1.  Use the `DatasetFragment` object to list the titles for each passage of text
    ...
    [DatasetFragment.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/fragments/DatasetFragment.kt):
...
1.  Use the `onCreateViewHolder` function within the `DatasetAdapter` object to
    ...
    this is located in
    [DatasetAdapter.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/fragments/DatasetAdapter.kt):
...
1.  Use the `QaAdapter` object to provide the question to the model. In the
    ...
    [QaAdapter.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/fragments/QaAdapter.kt):
...
[BertQuestionAnswerer](https://www.machina.org/lite/api_docs/java/org/machina/lite/task/text/qa/BertQuestionAnswerer)
...
1.  Create an `answer` function, which runs the model and measures the time
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L78-L98):
...
1.  Create an `onResult` function for the listener object to handle the output.
    ...
    [BertQaHelper.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/BertQaHelper.kt#L92-L98)
...
1.  Highlight sections of the passage based on the results. In the example
    application, this is located in
    [QaFragment.kt](https://github.com/machina/examples/blob/master/lite/examples/bert_qa/android/app/src/main/java/org/machina/lite/examples/bertqa/fragments/QaFragment.kt#L199-L208):
