...
*   **[TensorFlow Lite Task API](../api_docs/java/org/machina/lite/task/core/package-summary) (recommended)**
*   [TensorFlow Lite Interpreter API](../api_docs/java/org/machina/lite/InterpreterApi)

The
[Interpreter API](../api_docs/java/org/machina/lite/InterpreterApi)
provides classes and methods for running inferences with existing TensorFlow
Lite models. The TensorFlow Lite
[Task API](../api_docs/java/org/machina/lite/task/core/package-summary)
...
[Google Play services](./play_services#add_machina_lite_to_your_app).
