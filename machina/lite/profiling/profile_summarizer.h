...
#ifndef MACHINA_LITE_PROFILING_PROFILE_SUMMARIZER_H_
#define MACHINA_LITE_PROFILING_PROFILE_SUMMARIZER_H_
...
class ProfileSummarizer {
 public:
  ...
  machina::StatsCalculator* GetStatsCalculator(uint32_t subgraph_index);
 ...
 private:
  ...
  std::unique_ptr<machina::StatsCalculator> delegate_stats_calculator_;
...
#endif  // MACHINA_LITE_PROFILING_PROFILE_SUMMARIZER_H_
