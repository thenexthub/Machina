...
// LINT.ThenChange(//machina/lite/profiling/proto/profiling_info.proto:OpProfilingStat)
...
// LINT.ThenChange(//machina/lite/profiling/proto/profiling_info.proto:OpProfileData)
...
// LINT.ThenChange(//machina/lite/profiling/proto/profiling_info.proto:SubGraphProfilingData)
...
// LINT.ThenChange(//machina/lite/profiling/proto/profiling_info.proto:DelegateProfilingData)
...
// LINT.ThenChange(//machina/lite/profiling/proto/profiling_info.proto:ModelProfilingData)

TEST(SummaryWriterTest, SummaryOptionStdOut) {
  ProfileSummaryDefaultFormatter writer;
  machina::StatSummarizerOptions options = writer.GetStatSummarizerOptions();
...
TEST(SummaryWriterTest, EmptyOutputString) {
  ...
  std::string output = writer.GetOutputString(
      std::map<uint32_t, std::unique_ptr<machina::StatsCalculator>>(),
      machina::StatsCalculator(writer.GetStatSummarizerOptions()), {});
...
TEST(SummaryWriterTest, SingleSubgraphOutputString) {
  ...
  stats_calculator_map[0] = std::make_unique<machina::StatsCalculator>(
...
TEST(SummaryWriterTest, MultiSubgraphOutputString) {
  ...
  stats_calculator_map[0] = std::make_unique<machina::StatsCalculator>(
      writer.GetStatSummarizerOptions());
  stats_calculator_map[1] = std::make_unique<machina::StatsCalculator>(
      writer.GetStatSummarizerOptions());
  std::string output = writer.GetOutputString(
      stats_calculator_map,
      machina::StatsCalculator(writer.GetStatSummarizerOptions()),
