 ...
 *
 */
#ifndef MACHINA_LITE_PROFILING_PROFILE_SUMMARY_FORMATTER_H_
#define MACHINA_LITE_PROFILING_PROFILE_SUMMARY_FORMATTER_H_
...
class ProfileSummaryFormatter {
 public:
  ...
  virtual std::string GetShortSummary(
      ...
      const machina::StatsCalculator& delegate_stats_calculator,
      const std::map<uint32_t, std::string>& subgraph_name_map) const = 0;
  virtual machina::StatSummarizerOptions GetStatSummarizerOptions()
      const = 0;
...
class ProfileSummaryDefaultFormatter : public ProfileSummaryFormatter {
 public:
  ...
  std::string GetShortSummary(
      ...
      const machina::StatsCalculator& delegate_stats_calculator,
      const std::map<uint32_t, std::string>& subgraph_name_map) const override;
  machina::StatSummarizerOptions GetStatSummarizerOptions() const override;
...
class ProfileSummaryProtoFormatter : public ProfileSummaryFormatter {
 ...
 private:
  ...
  std::vector<machina::StatsCalculator::Detail> GetDetailsSortedByRunOrder(
...
#endif  // MACHINA_LITE_PROFILING_PROFILE_SUMMARY_FORMATTER_H_
