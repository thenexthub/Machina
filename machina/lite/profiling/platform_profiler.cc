...
#include "machina/lite/profiling/atrace_profiler.h"
#elif defined(__APPLE__)
#include "TargetConditionals.h"
#if TARGET_OS_IOS
#define SIGNPOST_PLATFORM_PROFILER
#include "machina/lite/profiling/signpost_profiler.h"
#endif
#elif defined(ENABLE_TFLITE_PERFETTO_PROFILER)
#include "machina/lite/experimental/perfetto_profiling/perfetto_profiler.h"
#endif
