...
#ifndef MACHINA_LITE_PROFILING_TELEMETRY_PROFILER_H_
#define MACHINA_LITE_PROFILING_TELEMETRY_PROFILER_H_
...
#endif  // MACHINA_LITE_PROFILING_TELEMETRY_PROFILER_H_
