...
#ifndef MACHINA_LITE_PROFILING_MEMORY_USAGE_MONITOR_H_
#define MACHINA_LITE_PROFILING_MEMORY_USAGE_MONITOR_H_
...
#endif  // MACHINA_LITE_PROFILING_MEMORY_USAGE_MONITOR_H_
