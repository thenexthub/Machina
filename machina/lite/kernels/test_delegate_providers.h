 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_TEST_DELEGATE_PROVIDERS_H_
#define MACHINA_LITE_KERNELS_TEST_DELEGATE_PROVIDERS_H_
...
#endif  // MACHINA_LITE_KERNELS_TEST_DELEGATE_PROVIDERS_H_
