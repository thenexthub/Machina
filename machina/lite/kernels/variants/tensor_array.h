 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_VARIANTS_TENSOR_ARRAY_H_
#define MACHINA_LITE_KERNELS_VARIANTS_TENSOR_ARRAY_H_
...
#endif  // MACHINA_LITE_KERNELS_VARIANTS_TENSOR_ARRAY_H_
