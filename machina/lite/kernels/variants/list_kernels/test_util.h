 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_VARIANTS_LIST_KERNELS_TEST_UTIL_H_
#define MACHINA_LITE_KERNELS_VARIANTS_LIST_KERNELS_TEST_UTIL_H_
...
#endif  // MACHINA_LITE_KERNELS_VARIANTS_LIST_KERNELS_TEST_UTIL_H_
