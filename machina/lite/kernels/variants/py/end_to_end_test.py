...
from machina.lite.kernels.variants.py import register_list_ops_py
from machina.lite.python import interpreter as _interpreter
...
class ListOpsTest(parameterized.TestCase):
  ...
  * Check machina and machina lite output the same data.
  """
