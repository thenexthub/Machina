...
#ifndef MACHINA_LITE_KERNELS_UNIDIRECTIONAL_SEQUENCE_LSTM_TEST_UTIL_H_
#define MACHINA_LITE_KERNELS_UNIDIRECTIONAL_SEQUENCE_LSTM_TEST_UTIL_H_
...
#endif  // THIRD_PARTY_MACHINA_LITE_KERNELS_UNIDIRECTIONAL_SEQUENCE_LSTM_TEST_UTIL_H_
