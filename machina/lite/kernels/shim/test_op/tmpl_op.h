 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_SHIM_TEST_OP_TMPL_OP_H_
#define MACHINA_LITE_KERNELS_SHIM_TEST_OP_TMPL_OP_H_
...
#endif  // MACHINA_LITE_KERNELS_SHIM_TEST_OP_TMPL_OP_H_
