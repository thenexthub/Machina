 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_SHIM_TENSOR_VIEW_H_
#define MACHINA_LITE_KERNELS_SHIM_TENSOR_VIEW_H_
...
// That is it maps
//   ::machina::Tensor -> tflite::shim::TfTensorView
//   ::TfLiteTensor -> tflite::shim::TfLiteTensorView
template <typename W>
struct TensorViewSubType {};

// Common denominator for ::tflite::TfLiteTensor and ::machina::Tensor.
 ...
 protected:
  ...
  using DataVariantType =
      std::variant<absl::Span<bool>, absl::Span<int8_t>, absl::Span<uint8_t>,
                   ...
                   absl::Span<double>, absl::Span<::machina::tstring>>;
  ...
  //   // A matrix view
  //   TensorView t_str;
  //   auto t_str_mat = t_str.As<machina::tstring, /*RANK=*/ 2>();
  //   t_str_mat(0, 0) = "abc";
  //   t_str_mat(2, 3) = "def";
...
#endif  // MACHINA_LITE_KERNELS_SHIM_TENSOR_VIEW_H_
