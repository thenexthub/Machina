 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_SHIM_TFLITE_TENSOR_VIEW_H_
#define MACHINA_LITE_KERNELS_SHIM_TFLITE_TENSOR_VIEW_H_
...
class TfLiteTensorView : public TensorView {
 ...
 protected:
  ...
  struct StringBuffer {
    ...
    // TensorViews
    std::vector<::machina::tstring> buffer;
...
#endif  // MACHINA_LITE_KERNELS_SHIM_TFLITE_TENSOR_VIEW_H_
