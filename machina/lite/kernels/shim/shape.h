 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_SHIM_SHAPE_H_
#define MACHINA_LITE_KERNELS_SHIM_SHAPE_H_
...
class Shape {
 public:
  ...
  // ensure this matches the one defined in ::machina namespace
...
#endif  // MACHINA_LITE_KERNELS_SHIM_SHAPE_H_
