...
TEST(TfLiteTensorW, Str) {
...

  {
    ...
    ASSERT_TRUE(t_or.ok()) << t_or.status();
    auto& t = t_or.value();
    auto t_mat = t.As<::machina::tstring, 2>();
    t.Data<::machina::tstring>()[0] = "a";
    t.Data<::machina::tstring>()[1] = "bc";
    t_mat(1, 0) = "def";
    t.Data<::machina::tstring>()[3] = "g";
    t.Data<::machina::tstring>()[4] = "";
    t_mat(2, 1) = "hi";
  }

  {
    ...
    ASSERT_TRUE(t_or.ok()) << t_or.status();
    auto& t = t_or.value();
    EXPECT_THAT(t.Data<::machina::tstring>(),
