...
#define CASE_FOR_DTYPE(TF_DTYPE)           \
  CASE_FOR_DTYPE_GIVEN_CPP_DTYPE(TF_DTYPE, \
                                 ::machina::EnumToDataType<TF_DTYPE>::Type)
...
TfTensorViewTemplatizedNew(TfTensorType *wrapped_tensor) {
  switch (wrapped_tensor->dtype()) {
    CASE_FOR_DTYPE(::machina::DT_BOOL);
    CASE_FOR_DTYPE(::machina::DT_UINT8);
    CASE_FOR_DTYPE(::machina::DT_UINT64);
    CASE_FOR_DTYPE(::machina::DT_INT8);
    CASE_FOR_DTYPE(::machina::DT_INT16);
    CASE_FOR_DTYPE(::machina::DT_INT32);
    // Map DT_INT64 to int64_t instead of int64 to have a single int64 datatype.
    CASE_FOR_DTYPE_GIVEN_CPP_DTYPE(::machina::DT_INT64, std::int64_t);
    CASE_FOR_DTYPE(::machina::DT_FLOAT);
    CASE_FOR_DTYPE(::machina::DT_DOUBLE);
    CASE_FOR_DTYPE(::machina::DT_STRING);
    default: {
