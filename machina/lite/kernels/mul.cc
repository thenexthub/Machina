 ...
 *
 */
#include "machina/lite/kernels/internal/optimized/integer_ops/mul.h"
...
#include "machina/lite/kernels/internal/reference/integer_ops/mul.h"
...
#define TF_LITE_MUL(type, opname, dtype)                             \
  type::opname(op_params, GetTensorShape(input1),                    \
    ...
    if (input1->type == kTfLiteInt8) {
      ...
      // see MulElementwise -
      // machina/lite/kernels/internal/reference/integer_ops/mul.h in case of
