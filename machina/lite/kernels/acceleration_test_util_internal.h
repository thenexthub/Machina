 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_ACCELERATION_TEST_UTIL_INTERNAL_H_
#define MACHINA_LITE_KERNELS_ACCELERATION_TEST_UTIL_INTERNAL_H_
...
#endif  // MACHINA_LITE_KERNELS_ACCELERATION_TEST_UTIL_INTERNAL_H_
