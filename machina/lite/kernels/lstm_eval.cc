 ...
 *
 */
#include "machina/lite/kernels/lstm_eval.h"
...
#include "machina/lite/kernels/internal/kernel_utils.h"
...
// LINT.ThenChange(//machina/lite/tools/optimize/calibration/builtin_logging_ops/lstm.cc)
