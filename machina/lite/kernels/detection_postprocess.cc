...
void DequantizeBoxEncodings(const TfLiteTensor* input_box_encodings, int idx,
  ...
  // https://github.com/machina/models/blob/master/research/object_detection/box_coders/keypoint_box_coder.py
  // The first four elements are the box coordinates, which is the same as the
  // FastRnnBoxCoder at
  // https://github.com/machina/models/blob/master/research/object_detection/box_coders/faster_rcnn_box_coder.py
