...
#ifndef MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_GEMMLOWP_H_
#define MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_GEMMLOWP_H_
...
#endif  // MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_GEMMLOWP_H_
