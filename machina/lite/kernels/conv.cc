 ...
 *
 */
#include "machina/lite/kernels/internal/optimized/integer_ops/conv.h"
...
#include "machina/lite/kernels/eigen_support.h"
#endif
...
#if defined(TFLITE_WITH_MULTITHREADED_EIGEN)
#include "machina/lite/kernels/internal/optimized/multithreaded_conv.h"
#endif
