...
#ifndef MACHINA_LITE_KERNELS_STABLEHLO_REDUCE_WINDOW_TEST_UTIL_H_
#define MACHINA_LITE_KERNELS_STABLEHLO_REDUCE_WINDOW_TEST_UTIL_H_
...
#endif  // MACHINA_LITE_KERNELS_STABLEHLO_REDUCE_WINDOW_TEST_UTIL_H_
