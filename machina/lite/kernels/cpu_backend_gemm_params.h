...
#ifndef MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_PARAMS_H_
#define MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_PARAMS_H_
...
#endif  // MACHINA_LITE_KERNELS_CPU_BACKEND_GEMM_PARAMS_H_
