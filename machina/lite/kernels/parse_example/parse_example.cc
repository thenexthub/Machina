...
#include "machina/core/util/example_proto_fast_parsing.h"
#include "machina/core/util/presized_cuckoo_map.h"
#include "machina/lite/core/c/common.h"
#include "machina/lite/kernels/internal/tensor_ctypes.h"
#include "machina/lite/kernels/kernel_util.h"
#include "machina/lite/kernels/parse_example/example_proto_fast_parsing.h"
...
bool ParseExample(StringRef serialized, Example* example) {
  ...
  machina::example::EnableAliasing(&stream);
...
absl::Status FastParseSerializedExample(
  ...
  machina::example::parsed::Example parsed_example;
  ...
  for (size_t i = 0; i < parsed_example_size; ++i) {
    ...
    machina::example::parsed::FeatureMapEntry& name_and_feature =
        parsed_example[parsed_example_size - i - 1];
    const absl::string_view feature_name = name_and_feature.first;
    machina::example::parsed::Feature& feature = name_and_feature.second;
