 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_COMPATIBILITY_H_
#define MACHINA_LITE_KERNELS_INTERNAL_COMPATIBILITY_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_COMPATIBILITY_H_
