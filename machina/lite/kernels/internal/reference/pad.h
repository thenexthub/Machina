...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_PAD_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_PAD_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_PAD_H_
