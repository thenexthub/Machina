 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
