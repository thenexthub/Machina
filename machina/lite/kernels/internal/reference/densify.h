 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DENSIFY_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DENSIFY_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DENSIFY_H_
