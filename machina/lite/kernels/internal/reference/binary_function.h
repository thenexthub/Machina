 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BINARY_FUNCTION_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BINARY_FUNCTION_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BINARY_FUNCTION_H_
