 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_ARG_MIN_MAX_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_ARG_MIN_MAX_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_ARG_MIN_MAX_H_
