 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SOFTMAX_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SOFTMAX_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SOFTMAX_H_
