 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_HARD_SWISH_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_HARD_SWISH_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_HARD_SWISH_H_
