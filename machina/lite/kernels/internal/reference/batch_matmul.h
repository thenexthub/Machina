 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_MATMUL_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_MATMUL_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_MATMUL_H_
