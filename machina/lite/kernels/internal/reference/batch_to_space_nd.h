 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_TO_SPACE_ND_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_TO_SPACE_ND_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_BATCH_TO_SPACE_ND_H_
