 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_TENSOR_CTYPES_H_
#define MACHINA_LITE_KERNELS_INTERNAL_TENSOR_CTYPES_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_TENSOR_CTYPES_H_
