...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_FULLY_CONNECTED_4BIT_H_
#define MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_FULLY_CONNECTED_4BIT_H_
#include <stdint.h>
...
#include "machina/lite/kernels/internal/optimized/4bit/sse_fully_connected.h"
#elif defined(FC_4BIT_NEON) && (defined(__ARM_NEON__) || defined(__ARM_NEON))
#include "machina/lite/kernels/internal/optimized/4bit/neon_fully_connected.h"
#else
#include "machina/lite/kernels/internal/optimized/4bit/fully_connected_reference.h"
#endif
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_FULLY_CONNECTED_4BIT_H_
