 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_IM2COL_UTILS_H_
#define MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_IM2COL_UTILS_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_IM2COL_UTILS_H_
