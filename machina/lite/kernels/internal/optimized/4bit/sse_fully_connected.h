...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_4BIT_SSE_FULLY_CONNECTED_H_
#define MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_4BIT_SSE_FULLY_CONNECTED_H_
#if defined(FC_4BIT_SSE) && defined(__SSSE3__)

#include <stdint.h>

#include "machina/lite/kernels/internal/optimized/4bit/sse_fully_connected_impl.h"
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_4BIT_SSE_FULLY_CONNECTED_H_
