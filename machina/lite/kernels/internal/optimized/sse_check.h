 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_SSE_CHECK_H_
#define MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_SSE_CHECK_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_SSE_CHECK_H_
