 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_INTEGER_OPS_SUB_H_
#define MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_INTEGER_OPS_SUB_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_OPTIMIZED_INTEGER_OPS_SUB_H_
