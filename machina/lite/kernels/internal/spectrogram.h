...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_SPECTROGRAM_H_
#define MACHINA_LITE_KERNELS_INTERNAL_SPECTROGRAM_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_SPECTROGRAM_H_
