...
from machina.compiler.mlir.quantization.stablehlo import quantization_config_pb2 as qc
from machina.compiler.mlir.quantization.machina.python import representative_dataset as rd
from machina.core.framework import graph_pb2 as _graph_pb2
from machina.lite.experimental.microfrontend.python.ops import audio_microfrontend_op  # pylint: disable=unused-import
...
from machina.lite.profiling.proto import model_runtime_info_pb2  # pylint: disable=unused-import
from machina.lite.profiling.proto import profiling_info_pb2  # pylint: disable=unused-import
from machina.lite.python import conversion_metadata_schema_py_generated as conversion_metadata_fb
from machina.lite.python import lite_constants as constants
from machina.lite.python.convert import build_conversion_flags as _build_conversion_flags
from machina.lite.python.convert import convert_graphdef as _convert_graphdef
from machina.lite.python.convert import convert_graphdef_with_arrays as _convert_graphdef_with_arrays
from machina.lite.python.convert import convert_jax_hlo as _convert_jax_hlo
from machina.lite.python.convert import convert_saved_model as _convert_saved_model
from machina.lite.python.convert import ConverterError  # pylint: disable=unused-import
from machina.lite.python.convert import deduplicate_readonly_buffers as _deduplicate_readonly_buffers
from machina.lite.python.convert import mlir_quantize as _mlir_quantize
from machina.lite.python.convert import mlir_sparsify as _mlir_sparsify
from machina.lite.python.convert import OpsSet
from machina.lite.python.convert import toco_convert  # pylint: disable=unused-import
from machina.lite.python.convert_phase import Component
from machina.lite.python.convert_phase import convert_phase
from machina.lite.python.convert_phase import SubComponent
from machina.lite.python.convert_saved_model import freeze_saved_model as _freeze_saved_model
from machina.lite.python.interpreter import Interpreter  # pylint: disable=unused-import
from machina.lite.python.interpreter import load_delegate  # pylint: disable=unused-import
from machina.lite.python.interpreter import OpResolverType  # pylint: disable=unused-import
from machina.lite.python.metrics import metrics
from machina.lite.python.op_hint import convert_op_hints_to_stubs  # pylint: disable=unused-import
from machina.lite.python.op_hint import is_ophint_converted as _is_ophint_converted
from machina.lite.python.op_hint import OpHint  # pylint: disable=unused-import
from machina.lite.python.optimize import calibrator as _calibrator
from machina.lite.python.util import _jit
from machina.lite.python.util import build_debug_info_func as _build_debug_info_func
from machina.lite.python.util import convert_debug_info_func as _convert_debug_info_func
from machina.lite.python.util import freeze_graph as _freeze_graph
from machina.lite.python.util import get_debug_info as _get_debug_info
from machina.lite.python.util import get_grappler_config as _get_grappler_config
from machina.lite.python.util import get_model_hash as _get_model_hash
from machina.lite.python.util import get_save_spec as _get_save_spec
from machina.lite.python.util import get_sparsity_modes as _get_sparsity_modes
from machina.lite.python.util import get_tensor_name as _get_tensor_name
from machina.lite.python.util import get_tensors_from_tensor_names as _get_tensors_from_tensor_names
from machina.lite.python.util import get_tf_type_name as _get_tf_type_name
from machina.lite.python.util import is_frozen_graph as _is_frozen_graph
from machina.lite.python.util import model_input_signature as _model_input_signature
from machina.lite.python.util import modify_model_io_type as _modify_model_io_type
from machina.lite.python.util import populate_conversion_metadata as _populate_conversion_metadata
from machina.lite.python.util import run_graph_optimizations as _run_graph_optimizations
from machina.lite.python.util import set_tensor_shapes as _set_tensor_shapes
from machina.lite.python.util import trace_model_call as _trace_model_call
from machina.lite.tools import flatbuffer_utils
from machina.lite.tools.optimize.debugging.python.debugger import QuantizationDebugger  # pylint: disable=unused-import
from machina.lite.tools.optimize.debugging.python.debugger import QuantizationDebugOptions  # pylint: disable=unused-import
from machina.python.client import session as _session
from machina.python.eager import context
from machina.python.eager import def_function as _def_function
from machina.python.eager import function as _function
from machina.python.framework import byte_swap_tensor as bst
from machina.python.framework import convert_to_constants as _convert_to_constants
from machina.python.framework import dtypes as _dtypes
from machina.python.framework import ops as _ops
from machina.python.framework import tensor_spec
from machina.python.framework import versions
from machina.python.framework.errors_impl import NotFoundError as _NotFoundError
from machina.python.framework.importer import import_graph_def as _import_graph_def
from machina.python.platform import gfile
from machina.python.saved_model import loader_impl as _loader_impl
from machina.python.saved_model import save as _save
from machina.python.saved_model import save_options as _save_options
from machina.python.saved_model import signature_constants as _signature_constants
from machina.python.saved_model import tag_constants as _tag_constants
from machina.python.saved_model.load import load as _load
from machina.python.saved_model.loader_impl import parse_saved_model_with_debug_info as _parse_saved_model_with_debug_info
from machina.python.util import deprecation as _deprecation
from machina.python.util import keras_deps
...
class TFLiteConverterBase:
  ...
  def __init__(self):
    ...
    self._metadata.environment.machinaVersion = versions.__version__
  ...
  def _get_base_converter_args(self):
    ...
    """
    args = {
        "input_format": constants.MACHINA_GRAPHDEF,
  ...
  def _save_conversion_params_metric(
    ...
    converter_kwargs.update({
        "tf_version": self._metadata.environment.machinaVersion,
...
class TFLiteConverterV2(TFLiteFrozenGraphConverterV2):
  ...
  Attributes:
    ...
    experimental_enable_resource_variables: Experimental flag, subject to
      ...
      variables](https://machina.org/guide/migrate/tf1_vs_tf2#resourcevariables_instead_of_referencevariables)
