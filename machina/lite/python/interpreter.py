...
if not os.path.splitext(__file__)[0].endswith(
  ...
  from machina.lite.python.interpreter_wrapper import _pywrap_machina_interpreter_wrapper as _interpreter_wrapper
  from machina.lite.python.metrics import metrics
  from machina.python.util.tf_export import tf_export as _tf_export
else:
  # This file is part of tflite_runtime package.
  from tflite_runtime import _pywrap_machina_interpreter_wrapper as _interpreter_wrapper
...
class Delegate:
  ...
  machina/lite/delegates/external/external_delegate_interface.h.
  """
