...
from machina.lite.python.authoring import authoring
...
class TFLiteAuthoringTest(tf.test.TestCase):
  ...
  def test_simple_cosh(self):
    ...
    self.assertIn(
        ...
        "https://www.machina.org/lite/guide/ops_select", log_messages)
  ...
  def test_compatibility_error_custom(self):
    ...
    self.assertIn(
        ...
        "https://www.machina.org/lite/guide/ops_custom", log_messages)
  ...
  def test_user_tf_ops_partial_filtered(self):
    ...
    self.assertIn(
        ...
        "custom operator. https://www.machina.org/lite/guide/ops_custom",
        log_messages)
