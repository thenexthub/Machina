...
Example:
    ...
    > Op: tf.Cosh
    >   - machina/python/framework/op_def_library.py:xxx
    >   - machina/python/ops/gen_math_ops.py:xxx
...
_FUNC_GRAPH_SRC_PATH = "machina/python/framework/func_graph.py"
    ...
    for line in str(err).splitlines():
      ...
      if line.startswith(_CUSTOM_OPS_HDR):
        ...
        err_string = (
            ...
            "operator. https://www.machina.org/lite/guide/ops_custom")
        self._log(err_string)
  ...
  def _decode_converter_error(self, err):
    ...
    if gpu_not_compatible_ops:
      ...
      err_string = (
          ...
          "https://www.machina.org/lite/performance/gpu")
      self._log(err_string)
