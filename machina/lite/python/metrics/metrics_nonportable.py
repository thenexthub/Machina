...
from machina.lite.python.metrics import metrics_interface
...
_gauge_conversion_latency = monitoring.IntGauge(
    '/machina/lite/convert/latency', 'Conversion latency in ms.')
