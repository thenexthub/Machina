...
from machina.lite.python.convert import register_custom_opdefs
...
class ConverterErrorMetricTest(test_util.TensorFlowTestCase,
  ...
  def test_unsupported_control_flow_v1(self):
    ...
    self.assertEqual(
        ...
        'using Control Flow V2 ops instead. See https://www.machina.org/'
  ...
  def test_location_from_concrete_functions(self):
    ...
    self.convert_and_check_location_info(
        ...
        expected_sources=[
            'machina/lite/python/metrics/metrics_nonportable_test.py',
        ])
