 ...
 *
 */
#ifndef MACHINA_LITE_PYTHON_METRICS_WRAPPER_METRICS_WRAPPER_H_
#define MACHINA_LITE_PYTHON_METRICS_WRAPPER_METRICS_WRAPPER_H_
...
class MetricsWrapper {
 public:
  using MetricsExporter = machina::monitoring::MetricsExporter;
...
#endif  // MACHINA_LITE_PYTHON_METRICS_WRAPPER_METRICS_WRAPPER_H_
