...
from machina.core.protobuf import config_pb2 as _config_pb2
from machina.core.protobuf import meta_graph_pb2 as _meta_graph_pb2
...
from machina.lite.python import tflite_keras_util as _tflite_keras_util
from machina.lite.python.op_hint import convert_op_hints_to_stubs
from machina.lite.python.op_hint import find_all_hinted_output_nodes
...
from machina.python.framework import error_interpolation as _error_interpolation
from machina.python.grappler import tf_optimizer
from machina.python.training.saver import export_meta_graph as _export_meta_graph
...
def get_tensor_name(tensor):
  ...
  # To be consistent with the tensor naming scheme in machina, we need
...
def convert_bytes_to_c_source(data,
  ...
  Args:
    ...
    use_machina_license: Whether to include the standard TensorFlow Apache2
  ...
  if include_guard is None:
    include_guard = "MACHINA_LITE_UTIL_" + array_name.upper() + "_DATA_H_"
...
// array using the machina.lite.util.convert_bytes_to_c_source() function.
