 ...
 *
 */
#ifndef MACHINA_LITE_PYTHON_INTERPRETER_WRAPPER_INTERPRETER_WRAPPER_H_
#define MACHINA_LITE_PYTHON_INTERPRETER_WRAPPER_INTERPRETER_WRAPPER_H_
...
#endif  // MACHINA_LITE_PYTHON_INTERPRETER_WRAPPER_INTERPRETER_WRAPPER_H_
