...
from machina.compiler.mlir.lite import converter_flags_pb2 as _conversion_flags_pb2
from machina.compiler.mlir.lite import model_flags_pb2 as _model_flags_pb2
from machina.compiler.mlir.lite import types_pb2 as _types_pb2
...
from machina.compiler.mlir.quantization.stablehlo import quantization_config_pb2
from machina.compiler.mlir.quantization.stablehlo import quantization_options_pb2 as quant_opts_pb2
from machina.lite.python import lite_constants
from machina.lite.python import util
from machina.lite.python.convert_phase import Component
from machina.lite.python.convert_phase import convert_phase
from machina.lite.python.convert_phase import ConverterError
from machina.lite.python.convert_phase import SubComponent
from machina.lite.python.metrics.wrapper import metrics_wrapper as _metrics_wrapper
...
def build_conversion_flags(
    ...
    input_format=lite_constants.MACHINA_GRAPHDEF,
  ...
  Args:
    ...
    input_format: Type of data to read. (default MACHINA_GRAPHDEF, must be in
      {MACHINA_GRAPHDEF})
    ...
    model_origin_framework: A str specifying the framework of the original
      model. Can be {MACHINA, KERAS, JAX, PYTORCH}
