 ...
 *
 */
#ifndef MACHINA_LITE_CORE_ASYNC_INTEROP_C_ATTRIBUTE_MAP_H_
#define MACHINA_LITE_CORE_ASYNC_INTEROP_C_ATTRIBUTE_MAP_H_
...
#endif  // MACHINA_LITE_CORE_ASYNC_INTEROP_C_ATTRIBUTE_MAP_H_
