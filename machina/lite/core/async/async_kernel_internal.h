 ...
 *
 */
#ifndef MACHINA_LITE_CORE_ASYNC_ASYNC_KERNEL_INTERNAL_H_
#define MACHINA_LITE_CORE_ASYNC_ASYNC_KERNEL_INTERNAL_H_
...
#endif  // MACHINA_LITE_CORE_ASYNC_ASYNC_KERNEL_INTERNAL_H_
