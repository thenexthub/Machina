 ...
 *
 */
#include "machina/lite/core/async/c/async_signature_runner.h"
...
#include "machina/lite/core/async/backend_async_kernel_interface.h"
#include "machina/lite/core/async/c/internal.h"
...
#include "machina/lite/interpreter_test_util.h"
...
TEST(AsyncSignatureRunnerTest, TestNoSignatures) {
  TfLiteModel* model = TfLiteModelCreateFromFile(
      "third_party/machina/lite/testdata/no_signatures.bin");
