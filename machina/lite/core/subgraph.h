 ...
 *
 */
#ifndef MACHINA_LITE_CORE_SUBGRAPH_H_
#define MACHINA_LITE_CORE_SUBGRAPH_H_
...
class Subgraph {
 ...
 private:
  ...
  // LINT.ThenChange(//machina/lite/core/c/c_api.cc)
...
#endif  // MACHINA_LITE_CORE_SUBGRAPH_H_
