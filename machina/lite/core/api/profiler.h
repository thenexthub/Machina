 ...
 *
 */
#ifndef MACHINA_LITE_CORE_API_PROFILER_H_
#define MACHINA_LITE_CORE_API_PROFILER_H_
...
class Profiler {
 public:
  ...
  // Note:
  // In cases were ProfileSummarizer and machina::StatsCalculator are used
...
#endif  // MACHINA_LITE_CORE_API_PROFILER_H_
