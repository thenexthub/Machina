...
#include "machina/lite/core/api/tensor_utils.h"
...
#include "machina/lite/graph_info.h"
#include "machina/lite/logger.h"
#include "machina/lite/memory_planner.h"
...
#include "machina/lite/simple_planner.h"
#else
#include "machina/lite/arena_planner.h"
#endif
#ifdef TF_LITE_MACHINA_PROFILER
#include "machina/lite/machina_profiler_logger.h"
#endif  // TF_LITE_MACHINA_PROFILER
    ...
    if (IsUnresolvedCustomOp(op_reg)) {
      if (IsFlexOp(op_reg.custom_name)) {
        ReportError(
            ...
            "adding \"org.machina:machina-lite-select-tf-ops\" "
...
TfLiteStatus Subgraph::InvokeImpl() {
...
#ifdef TF_LITE_MACHINA_PROFILER
  machina::profiler::TraceMe* trace_subgraph =
  ...
  for (int execution_plan_index = 0;
    ...
    machina::profiler::TraceMe* trace_op =
    ...
    for (int i = 0; i < node.inputs->size; ++i) {
      ...
      if (tensor->data.raw == nullptr && tensor->bytes > 0 &&
        ...
        if (registration.builtin_code == kTfLiteBuiltinReshape && i == 1 &&
          ...
          // `machina/lite/kernels/reshape.cc`
          continue;
        } else {
