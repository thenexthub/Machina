 ...
 *
 */
#ifndef MACHINA_LITE_EXPERIMENTAL_RESOURCE_LOOKUP_UTIL_H_
#define MACHINA_LITE_EXPERIMENTAL_RESOURCE_LOOKUP_UTIL_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_RESOURCE_LOOKUP_UTIL_H_
