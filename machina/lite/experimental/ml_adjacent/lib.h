 ...
 *
 */
#ifndef MACHINA_LITE_EXPERIMENTAL_ML_ADJACENT_LIB_H_
#define MACHINA_LITE_EXPERIMENTAL_ML_ADJACENT_LIB_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_ML_ADJACENT_LIB_H_
