 ...
 *
 */
#ifndef MACHINA_LITE_EXPERIMENTAL_MICROFRONTEND_LIB_LOG_SCALE_H_
#define MACHINA_LITE_EXPERIMENTAL_MICROFRONTEND_LIB_LOG_SCALE_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_MICROFRONTEND_LIB_LOG_SCALE_H_
