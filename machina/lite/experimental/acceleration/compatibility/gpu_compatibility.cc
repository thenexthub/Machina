...
#include "machina/lite/experimental/acceleration/compatibility/devicedb.h"
#include "machina/lite/experimental/acceleration/compatibility/gpu_compatibility_binary.h"
