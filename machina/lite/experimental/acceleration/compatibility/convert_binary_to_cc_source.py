...
# This is a version of //machina/lite/python/convert_file_to_c_source.py
...
# Cribbed from //machina/lite/python/util.py
# Changed:
...
// //machina/lite/experimental/acceleration/compatibility/convert_binary_to_cc_source.py
