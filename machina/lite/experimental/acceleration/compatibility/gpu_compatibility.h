 ...
 *
 */
#ifndef MACHINA_LITE_EXPERIMENTAL_ACCELERATION_COMPATIBILITY_GPU_COMPATIBILITY_H_
#define MACHINA_LITE_EXPERIMENTAL_ACCELERATION_COMPATIBILITY_GPU_COMPATIBILITY_H_
...
#include "machina/lite/experimental/acceleration/compatibility/database_generated.h"
...
class GPUCompatibilityList {
 public:
  ...
  // machina/lite/experimental/acceleration/compatibility/variables.h
  gpu::CompatibilityStatus GetStatus(
...
#endif  // MACHINA_LITE_EXPERIMENTAL_ACCELERATION_COMPATIBILITY_GPU_COMPATIBILITY_H_
