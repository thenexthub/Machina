 ...
 *
 */
#include "machina/lite/experimental/acceleration/mini_benchmark/validator_runner_entrypoint.h"
...
#include "machina/lite/experimental/acceleration/mini_benchmark/constants.h"
#include "machina/lite/experimental/acceleration/mini_benchmark/fb_storage.h"
#include "machina/lite/experimental/acceleration/mini_benchmark/file_lock.h"
...
#include "machina/lite/experimental/acceleration/mini_benchmark/validator.h"
...
int Java_org_machina_lite_acceleration_validation_entrypoint(int argc,
                                                                char** argv) {
  if (argc < 6) return 1;
