...
extern const unsigned char MACHINA_ACCELERATION_MODEL_DATA_VARIABLE[];
extern const int MACHINA_ACCELERATION_MODEL_LENGTH_VARIABLE;
 ...
 protected:
  static void SetUpTestSuite() {
    ...
    std::string contents(reinterpret_cast<const char*>(
                             MACHINA_ACCELERATION_MODEL_DATA_VARIABLE),
                         MACHINA_ACCELERATION_MODEL_LENGTH_VARIABLE);
