 ...
 *
 */
#ifndef MACHINA_LITE_EXPERIMENTAL_ACCELERATION_MINI_BENCHMARK_LIBJPEG_DECODER_H_
#define MACHINA_LITE_EXPERIMENTAL_ACCELERATION_MINI_BENCHMARK_LIBJPEG_DECODER_H_
...
#include "machina/lite/experimental/acceleration/mini_benchmark/libc_handle.h"
#include "machina/lite/experimental/acceleration/mini_benchmark/libjpeg.h"
#include "machina/lite/experimental/acceleration/mini_benchmark/libjpeg_handle.h"
  ...
  class Impl {
   ...
   private:
    ...
    TfLiteStatus Run(Fn f, Args... args) {
      ...
      // LLVM bug: https://bugs.toolchain.org/show_bug.cgi?id=21183
...
#endif  // MACHINA_LITE_EXPERIMENTAL_ACCELERATION_MINI_BENCHMARK_LIBJPEG_DECODER_H_
