...
https://tfhub.dev/machina/coral-model/mobilenet_v1_1.0_224_quantized/1/default/1
...
from machina.lite.experimental.acceleration.mini_benchmark.metrics import kl_divergence
