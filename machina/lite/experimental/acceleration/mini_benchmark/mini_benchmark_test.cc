 ...
 *
 */
#include "machina/lite/experimental/acceleration/mini_benchmark/mini_benchmark.h"
...
#include "machina/lite/acceleration/configuration/proto_to_flatbuffer.h"
#include "machina/lite/experimental/acceleration/mini_benchmark/embedded_mobilenet_float_validation_model.h"
...
class MiniBenchmarkTest : public ::testing::Test {
 protected:
  ...
  const std::string ns_ = "org.machina.lite.mini_benchmark.test";
