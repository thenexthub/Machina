...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_NEGATE_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_NEGATE_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_NEGATE_H_
