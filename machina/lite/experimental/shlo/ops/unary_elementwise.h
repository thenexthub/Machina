...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_UNARY_ELEMENTWISE_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_UNARY_ELEMENTWISE_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_UNARY_ELEMENTWISE_H_
