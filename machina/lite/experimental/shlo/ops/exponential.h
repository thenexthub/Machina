...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_EXPONENTIAL_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_EXPONENTIAL_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_EXPONENTIAL_H_
