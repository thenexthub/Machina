...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_MULTIPLY_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_MULTIPLY_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_MULTIPLY_H_
