...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_COSINE_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_COSINE_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_COSINE_H_
