...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_LOG_PLUS_ONE_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_LOG_PLUS_ONE_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_OPS_LOG_PLUS_ONE_H_
