...
#ifndef MACHINA_LITE_EXPERIMENTAL_SHLO_LEGACY_SRC_UTIL_H_
#define MACHINA_LITE_EXPERIMENTAL_SHLO_LEGACY_SRC_UTIL_H_
...
#endif  // MACHINA_LITE_EXPERIMENTAL_SHLO_LEGACY_SRC_UTIL_H_
