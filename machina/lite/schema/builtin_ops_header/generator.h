...
#ifndef MACHINA_LITE_SCHEMA_BUILTIN_OPS_HEADER_GENERATOR_H_
#define MACHINA_LITE_SCHEMA_BUILTIN_OPS_HEADER_GENERATOR_H_
...
#endif  // MACHINA_LITE_SCHEMA_BUILTIN_OPS_HEADER_GENERATOR_H_
