...
bazel run machina/lite/schema/upgrade_schema -- in.json out.json
bazel run machina/lite/schema/upgrade_schema -- in.bin out.bin
bazel run machina/lite/schema/upgrade_schema -- in.bin out.json
bazel run machina/lite/schema/upgrade_schema -- in.json out.bin
bazel run machina/lite/schema/upgrade_schema -- in.tflite out.tflite
"""
import argparse
import contextlib
import json
