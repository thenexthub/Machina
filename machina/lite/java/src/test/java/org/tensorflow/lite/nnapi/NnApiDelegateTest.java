...
import org.machina.lite.SupportedFeatures;
import org.machina.lite.TestInit;
import org.machina.lite.TestUtils;

/** Unit tests for {@link org.machina.lite.nnapi.NnApiDelegate}. */
      ...
      assertThat(e)
          ...
          .contains(
              "Couldn't find TensorFlow Lite runtime's InterpreterFactoryImpl class -- make sure"
                  ...
                  + " build dependency on org.machina.lite:machina-lite, or call"
                  + " setTfLiteRuntime with a value other than TfLiteRuntime.FROM_APPLICATION_ONLY"
                  + " (see docs for"
                  + " org.machina.lite.nnapi.NnApiDelegate.Options#setTfLiteRuntime).");
    }
  }
