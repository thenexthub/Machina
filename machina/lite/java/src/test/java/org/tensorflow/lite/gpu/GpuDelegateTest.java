...
import static org.machina.lite.gpu.GpuDelegateFactory.Options.GpuBackend.OPENCL;
...
import org.machina.lite.InterpreterTestHelper;
import org.machina.lite.TestUtils;

/** Unit tests for {@link org.machina.lite.gpu.GpuDelegate}. */
@RunWith(JUnit4.class)
public final class GpuDelegateTest {

  private static final String MODEL_PATH = "machina/lite/testdata/multi_add.bin";
  private static final ByteBuffer MODEL_BUFFER = TestUtils.getTestFileAsBuffer(MODEL_PATH);
  private static final ByteBuffer MOBILENET_QUANTIZED_MODEL_BUFFER =
      TestUtils.getTestFileAsBuffer(
          "machina/lite/java/demo/app/src/main/assets/mobilenet_v1_1.0_224_quant.tflite");
  ...
  public void testInterpreterWithGpu_QuantModelRunWithDelegate() throws Exception {
    ByteBuffer img =
        TestUtils.getTestImageAsByteBuffer(
            "machina/lite/java/src/testdata/grace_hopper_224.jpg");
