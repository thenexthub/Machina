...
/** Unit tests for {@link org.machina.lite.Interpreter} with selective registration. */
@RunWith(JUnit4.class)
public final class InterpreterCustomizedAndroidBuildTest {
  // Supported model.
  private static final String SUPPORTED_MODEL_PATH = "machina/lite/testdata/add.bin";
