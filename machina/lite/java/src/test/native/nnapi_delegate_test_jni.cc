...
Java_org_machina_lite_nnapi_NnApiDelegateTest_getMockSlHandle(JNIEnv* env,
                                                                 jclass clazz) {
...
Java_org_machina_lite_nnapi_NnApiDelegateTest_hasNnApiSlBeenCalled(
    JNIEnv* env, jclass clazz) {
  return g_sl_has_been_called;
}

JNIEXPORT void JNICALL
Java_org_machina_lite_nnapi_NnApiDelegateTest_closeMockSl(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle) {
...
JNIEXPORT jboolean JNICALL
Java_org_machina_lite_NnApiDelegateNativeTest_getAllowFp16Option(
...
JNIEXPORT jboolean JNICALL
Java_org_machina_lite_NnApiDelegateNativeTest_getDisallowNnapiCpuOption(
    JNIEnv* env, jclass clazz, jlong delegate_handle) {
  auto* delegate =
      reinterpret_cast<tflite::StatefulNnApiDelegate*>(delegate_handle);
  tflite::StatefulNnApiDelegate::Options options =
...
Java_org_machina_lite_NnApiDelegateNativeTest_getModelTokenOption(
    JNIEnv* env, jclass clazz, jlong delegate_handle) {
  auto* delegate =
      reinterpret_cast<tflite::StatefulNnApiDelegate*>(delegate_handle);
  tflite::StatefulNnApiDelegate::Options options =
