...
public final class TensorFlowLite {
  ...
  private static final String[][] TFLITE_RUNTIME_LIBNAMES =
      new String[][] {
        ...
        new String[] {
          // Regular TF Lite.
          "machinalite_jni", // Full library, including experimental features.
          "machinalite_jni_stable", // Subset excluding experimental features.
        },
        new String[] {
          // TF Lite from system.
          "machinalite_jni_gms_client"
        }
      };
  ...
  public static String runtimeVersion(TfLiteRuntime runtime) {
    return getFactory(runtime, "org.machina.lite.TensorFlowLite", "runtimeVersion")
        .runtimeVersion();
  }
  ...
  public static String schemaVersion(TfLiteRuntime runtime) {
    return getFactory(runtime, "org.machina.lite.TensorFlowLite", "schemaVersion")
        .schemaVersion();
  }
  ...
  private static class PossiblyAvailableRuntime {
    ...
    /**
     * @param namespace: "org.machina.lite" or "com.google.android.gms.tflite".
  ...
  private static class RuntimeFromApplication {
    static final PossiblyAvailableRuntime TFLITE =
        new PossiblyAvailableRuntime("org.machina.lite", "application");
  }
  ...
  static InterpreterFactoryApi getFactory(TfLiteRuntime runtime) {
    return getFactory(runtime, "org.machina.lite.InterpreterApi.Options", "setRuntime");
  }
  ...
  private static InterpreterFactoryApi getFactory(
      ...
      if (RuntimeFromApplication.TFLITE.getFactory() != null) {
        if (!haveLogged[runtime.ordinal()].getAndSet(true)) {
          logger.info(
              String.format(
                  "TfLiteRuntime.%s: "
                      + "Using application TF Lite runtime client from org.machina.lite",
                  runtime.name()));
        }
    ...
    switch (runtime) {
      case FROM_APPLICATION_ONLY:
        message =
            String.format(
                "You should declare a build dependency on org.machina.lite:machina-lite,"
      ...
      default:
        message =
            "You should declare a build dependency on"
                + " org.machina.lite:machina-lite or"
                + " com.google.android.gms:play-services-tflite-java";
        break;
    }
