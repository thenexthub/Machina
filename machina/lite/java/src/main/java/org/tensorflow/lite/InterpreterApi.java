...
import org.machina.lite.acceleration.ValidatedAccelerationConfig;
 ...
 *     new InterpreterApi.create(file_of_a_machinalite_model)) {
...
public interface InterpreterApi extends AutoCloseable {
  ...
  class Options {
     ...
     * href="https://www.machina.org/lite/api_docs/java/org/machina/lite/Interpreter#setCancelled(boolean)">setCancelled(boolean)</a>.
     ...
     * See
     * https://github.com/machina/machina/blob/master/machina/lite/delegates/xnnpack/README.md
     * for more details.
     */
    Boolean useXNNPACK;
   ...
   *     href="https://www.machina.org/lite/api_docs/java/org/machina/lite/Interpreter.Options#setAllowBufferHandleOutput(boolean)">Interpreter.Options#setAllowBufferHandleOutput(boolean)</a>),
