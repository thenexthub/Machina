...
#ifndef MACHINA_LITE_JAVA_SRC_MAIN_NATIVE_JNI_UTILS_H_
#define MACHINA_LITE_JAVA_SRC_MAIN_NATIVE_JNI_UTILS_H_
...
#endif  // MACHINA_LITE_JAVA_SRC_MAIN_NATIVE_JNI_UTILS_H_
