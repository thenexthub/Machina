...
JNIEXPORT jlong JNICALL Java_org_machina_lite_TensorImpl_create(
...
Java_org_machina_lite_TensorImpl_createSignatureInputTensor(
...
JNIEXPORT jlong JNICALL
Java_org_machina_lite_TensorImpl_createSignatureOutputTensor(
    JNIEnv* env, jclass clazz, jlong signature_runner_handle,
    jstring output_name) {
  tflite::SignatureRunner* runner =
      reinterpret_cast<tflite::SignatureRunner*>(signature_runner_handle);
...
JNIEXPORT void JNICALL Java_org_machina_lite_TensorImpl_delete(
    JNIEnv* env, jclass clazz, jlong handle) {
  delete reinterpret_cast<TensorHandle*>(handle);
}

JNIEXPORT jobject JNICALL Java_org_machina_lite_TensorImpl_buffer(
    JNIEnv* env, jclass clazz, jlong handle) {
...
JNIEXPORT void JNICALL Java_org_machina_lite_TensorImpl_writeDirectBuffer(
...
Java_org_machina_lite_TensorImpl_readMultiDimensionalArray(JNIEnv* env,
                                                              jclass clazz,
                                                              jlong handle,
                                                              jobject value) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT void JNICALL
Java_org_machina_lite_TensorImpl_writeMultiDimensionalArray(JNIEnv* env,
                                                               jclass clazz,
                                                               jlong handle,
                                                               jobject src) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT void JNICALL Java_org_machina_lite_TensorImpl_writeScalar(
    JNIEnv* env, jclass clazz, jlong handle, jobject src) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) return;
  if ((tensor->type != kTfLiteString) && (tensor->data.raw == nullptr)) {
...
JNIEXPORT jint JNICALL Java_org_machina_lite_TensorImpl_dtype(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT jstring JNICALL Java_org_machina_lite_TensorImpl_name(
    JNIEnv* env, jclass clazz, jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) {
    ThrowException(env, tflite::jni::kIllegalArgumentException,
...
JNIEXPORT jintArray JNICALL Java_org_machina_lite_TensorImpl_shape(
    JNIEnv* env, jclass clazz, jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) return nullptr;
  int num_dims = tensor->dims->size;
...
JNIEXPORT jintArray JNICALL Java_org_machina_lite_TensorImpl_shapeSignature(
    JNIEnv* env, jclass clazz, jlong handle) {
  TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
  if (tensor == nullptr) return nullptr;
...
JNIEXPORT jint JNICALL Java_org_machina_lite_TensorImpl_numBytes(
    JNIEnv* env, jclass clazz, jlong handle) {
...
Java_org_machina_lite_TensorImpl_hasDelegateBufferHandle(JNIEnv* env,
                                                            jclass clazz,
                                                            jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
JNIEXPORT jint JNICALL Java_org_machina_lite_TensorImpl_index(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  return GetTensorIndexFromHandle(env, handle);
}

JNIEXPORT jfloat JNICALL Java_org_machina_lite_TensorImpl_quantizationScale(
    JNIEnv* env, jclass clazz, jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
...
Java_org_machina_lite_TensorImpl_quantizationZeroPoint(JNIEnv* env,
                                                          jclass clazz,
                                                          jlong handle) {
  const TfLiteTensor* tensor = GetTensorFromHandle(env, handle);
