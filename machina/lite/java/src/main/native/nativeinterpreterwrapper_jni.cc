...
#include "machina/lite/create_op_resolver.h"
#include "machina/lite/interpreter.h"
#include "machina/lite/interpreter_builder.h"
#include "machina/lite/model_builder.h"
#include "machina/lite/tools/verifier_internal.h"
#if TFLITE_DISABLE_SELECT_JAVA_APIS
#include "machina/lite/acceleration/configuration/c/delegate_plugin.h"
...
#include "machina/lite/java/src/main/native/op_resolver_lazy_delegate_proxy.h"
...
Java_org_machina_lite_NativeInterpreterWrapper_getInputNames(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
...
Java_org_machina_lite_NativeInterpreterWrapper_allocateTensors(
...
Java_org_machina_lite_NativeInterpreterWrapper_hasUnresolvedFlexOp(
...
JNIEXPORT jobjectArray JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getSignatureKeys(
    JNIEnv* env, jclass clazz, jlong handle) {
  Interpreter* interpreter = convertLongToInterpreter(env, handle);
  if (interpreter == nullptr) return nullptr;
  static jclass string_class =
...
Java_org_machina_lite_NativeInterpreterWrapper_getInputTensorIndex(
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getOutputTensorIndex(
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getExecutionPlanLength(
    JNIEnv* env, jclass clazz, jlong handle) {
#if TFLITE_DISABLE_SELECT_JAVA_APIS
  ThrowException(env, tflite::jni::kUnsupportedOperationException,
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getInputCount(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
  if (!tflite::jni::CheckJniInitializedOrThrow(env)) return 0;
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getOutputCount(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  if (!tflite::jni::CheckJniInitializedOrThrow(env)) return 0;
...
JNIEXPORT jobjectArray JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_getOutputNames(JNIEnv* env,
                                                                 jclass clazz,
                                                                 jlong handle) {
  if (!tflite::jni::CheckJniInitializedOrThrow(env)) return nullptr;
...
JNIEXPORT void JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_allowFp16PrecisionForFp32(
...
JNIEXPORT void JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_allowBufferHandleOutput(
    JNIEnv* env, jclass clazz, jlong handle, jboolean allow) {
#if TFLITE_DISABLE_SELECT_JAVA_APIS
  if (allow) {
    ThrowException(env, tflite::jni::kUnsupportedOperationException,
...
Java_org_machina_lite_NativeInterpreterWrapper_createErrorReporter(
...
JNIEXPORT jlong JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_createModel(
...
JNIEXPORT jlong JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_createModelWithBuffer(
...
JNIEXPORT jlong JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_createInterpreter(
...
JNIEXPORT void JNICALL Java_org_machina_lite_NativeInterpreterWrapper_run(
...
JNIEXPORT jboolean JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_resizeInput(
    JNIEnv* env, jclass clazz, jlong interpreter_handle, jlong error_handle,
...
JNIEXPORT jlong JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_createCancellationFlag(
...
JNIEXPORT void JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_deleteCancellationFlag(
...
JNIEXPORT void JNICALL
Java_org_machina_lite_NativeInterpreterWrapper_setCancelled(
...
JNIEXPORT void JNICALL Java_org_machina_lite_NativeInterpreterWrapper_delete(
