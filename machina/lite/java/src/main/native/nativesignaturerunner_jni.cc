...
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeGetSignatureRunner(
...
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeGetSubgraphIndex(
...
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeInputNames(
    JNIEnv* env, jclass clazz, jlong handle) {
  SignatureRunner* runner = CastLongToPointer<SignatureRunner>(env, handle);
...
JNIEXPORT jobjectArray JNICALL
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeOutputNames(
    JNIEnv* env, jclass clazz, jlong handle) {
  SignatureRunner* runner = CastLongToPointer<SignatureRunner>(env, handle);
  if (runner == nullptr) return nullptr;
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeGetInputIndex(
...
JNIEXPORT jint JNICALL
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeGetOutputIndex(
...
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeResizeInput(
...
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeAllocateTensors(
    JNIEnv* env, jclass clazz, jlong handle, jlong error_handle) {
  SignatureRunner* runner = CastLongToPointer<SignatureRunner>(env, handle);
  BufferErrorReporter* error_reporter =
      CastLongToPointer<BufferErrorReporter>(env, error_handle);
...
JNIEXPORT void JNICALL
Java_org_machina_lite_NativeSignatureRunnerWrapper_nativeInvoke(
    JNIEnv* env, jclass clazz, jlong handle, jlong error_handle) {
  SignatureRunner* runner = CastLongToPointer<SignatureRunner>(env, handle);
  BufferErrorReporter* error_reporter =
      CastLongToPointer<BufferErrorReporter>(env, error_handle);
