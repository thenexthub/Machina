 ...
 *
 */
#ifndef MACHINA_LITE_EXTERNAL_CPU_BACKEND_CONTEXT_H_
#define MACHINA_LITE_EXTERNAL_CPU_BACKEND_CONTEXT_H_
...
#endif  // MACHINA_LITE_EXTERNAL_CPU_BACKEND_CONTEXT_H_
