 ...
 *
 */
#ifndef MACHINA_LITE_TOOLS_SERIALIZATION_ENUM_MAPPING_H_
#define MACHINA_LITE_TOOLS_SERIALIZATION_ENUM_MAPPING_H_
...
#endif  // MACHINA_LITE_TOOLS_SERIALIZATION_ENUM_MAPPING_H_
