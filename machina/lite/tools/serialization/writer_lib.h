...
#ifndef MACHINA_LITE_TOOLS_SERIALIZATION_WRITER_LIB_H_
#define MACHINA_LITE_TOOLS_SERIALIZATION_WRITER_LIB_H_
#include <cstddef>
#include <cstdint>
#include <iostream>
#include <memory>
...
// That's because "machina/lite/schema/mutable/schema_generated.h"
// and "machina/lite/schema/schema_generated.h" both use the same
...
#endif  // MACHINA_LITE_TOOLS_SERIALIZATION_WRITER_LIB_H_
