...
#ifndef MACHINA_LITE_TOOLS_STRIP_BUFFERS_STRIPPING_LIB_H_
#define MACHINA_LITE_TOOLS_STRIP_BUFFERS_STRIPPING_LIB_H_
...
#endif  // MACHINA_LITE_TOOLS_STRIP_BUFFERS_STRIPPING_LIB_H_
