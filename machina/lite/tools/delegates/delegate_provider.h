...
#ifndef MACHINA_LITE_TOOLS_DELEGATES_DELEGATE_PROVIDER_H_
#define MACHINA_LITE_TOOLS_DELEGATES_DELEGATE_PROVIDER_H_
...
#endif  // MACHINA_LITE_TOOLS_DELEGATES_DELEGATE_PROVIDER_H_
