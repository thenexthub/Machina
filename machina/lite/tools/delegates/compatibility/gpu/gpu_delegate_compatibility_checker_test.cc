...
#include "machina/lite/tools/delegates/compatibility/gpu/gpu_delegate_compatibility_checker.h"
...
TEST(GpuDelegateCompatibilityCheckerTest, CheckOnlineMode) {
  const std::string& full_path =
      machina::GetDataDependencyFilepath("machina/lite/testdata/add.bin");
...
TEST(GpuDelegateCompatibilityCheckerTest, IncompatibleModelOfflineMode) {
  const std::string& full_path = machina::GetDataDependencyFilepath(
      "machina/lite/testdata/conv3d_huge_im2col.bin");
