...
Modify the
[TFLite full integer (int8) quantization steps](https://www.machina.org/lite/performance/post_training_quantization#full_integer_quantization)
...
```python
from machina.lite.tools.optimize.debugging.python import debugger
