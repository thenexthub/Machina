 ...
 *
 */
#ifndef MACHINA_LITE_TOOLS_OPTIMIZE_QUANTIZATION_UTILS_H_
#define MACHINA_LITE_TOOLS_OPTIMIZE_QUANTIZATION_UTILS_H_
...
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:num_elements)
...
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:fill_per_channel_min_max)
...
TfLiteStatus SymmetricPerChannelQuantization(TensorT* tensor,
                                             ...
                                             ErrorReporter* error_reporter);
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:symmetric_per_channel_quantization)
...
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:symmetric_per_channel_quantize_values)
...
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:symmetric_quantize_tensor)
...
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:quantize_tensor_float16)
...
TfLiteStatus AddQuantizationParams(const std::vector<float>& scales,
                                   ...
                                   ErrorReporter* error_reporter);
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:add_quantization_params)
...
TfLiteStatus SymmetricQuantizeTensorPerChannel(ModelT* model, TensorT* tensor,
                                               int32_t channel_dim_index,
                                               ErrorReporter* error_reporter);
// LINT.ThenChange(//machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h:symmetric_quantize_tensor_per_channel)
...
#endif  // MACHINA_LITE_TOOLS_OPTIMIZE_QUANTIZATION_UTILS_H_
