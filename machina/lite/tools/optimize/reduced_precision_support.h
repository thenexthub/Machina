 ...
 *
 */
#ifndef MACHINA_LITE_TOOLS_OPTIMIZE_REDUCED_PRECISION_SUPPORT_H_
#define MACHINA_LITE_TOOLS_OPTIMIZE_REDUCED_PRECISION_SUPPORT_H_
...
#endif  // MACHINA_LITE_TOOLS_OPTIMIZE_REDUCED_PRECISION_SUPPORT_H_
