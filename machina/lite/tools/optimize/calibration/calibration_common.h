 ...
 *
 */
#ifndef MACHINA_LITE_TOOLS_OPTIMIZE_CALIBRATION_CALIBRATION_COMMON_H_
#define MACHINA_LITE_TOOLS_OPTIMIZE_CALIBRATION_CALIBRATION_COMMON_H_
...
#endif  // MACHINA_LITE_TOOLS_OPTIMIZE_CALIBRATION_CALIBRATION_COMMON_H_
