...
class SimpleSignatureDefUtilTest : public testing::Test {
 protected:
  ...
  SignatureDef GetTestSignatureDef() {
    ...
    machina::TensorInfo input_tensor;
    machina::TensorInfo output_tensor;
