...
Note: This utility is not compatiable with machina.org/lite/guide/signatures.
"""

from machina.core.protobuf import meta_graph_pb2
from machina.lite.tools.signature import _pywrap_signature_def_util_wrapper as signature_def_util
