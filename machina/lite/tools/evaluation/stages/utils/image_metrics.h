 ...
 *
 */
#ifndef MACHINA_LITE_TOOLS_EVALUATION_STAGES_UTILS_IMAGE_METRICS_H_
#define MACHINA_LITE_TOOLS_EVALUATION_STAGES_UTILS_IMAGE_METRICS_H_
...
#endif  // MACHINA_LITE_TOOLS_EVALUATION_STAGES_UTILS_IMAGE_METRICS_H_
