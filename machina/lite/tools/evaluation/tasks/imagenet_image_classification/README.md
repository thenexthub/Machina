...
python machina/lite/tools/evaluation/tasks/imagenet_image_classification/generate_validation_labels.py \
...
bazel build -c opt \
  ...
  --cxxopt='--std=c++17' \
  //machina/lite/tools/evaluation/tasks/imagenet_image_classification:run_eval
```
...
```
adb push bazel-bin/machina/lite/tools/evaluation/tasks/imagenet_image_classification/run_eval /data/local/tmp
```
