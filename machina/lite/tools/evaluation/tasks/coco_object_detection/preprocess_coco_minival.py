...
found here:
https://github.com/machina/models/blob/master/research/object_detection/data/mscoco_minival_ids.txt.
...
from machina.lite.tools.evaluation.proto import evaluation_stages_pb2
