...
#ifndef MACHINA_LITE_TOOLS_EVALUATION_EVALUATION_DELEGATE_PROVIDER_H_
#define MACHINA_LITE_TOOLS_EVALUATION_EVALUATION_DELEGATE_PROVIDER_H_
...
#endif  // MACHINA_LITE_TOOLS_EVALUATION_EVALUATION_DELEGATE_PROVIDER_H_
