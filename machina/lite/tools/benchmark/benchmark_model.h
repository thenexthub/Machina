...
#ifndef MACHINA_LITE_TOOLS_BENCHMARK_BENCHMARK_MODEL_H_
#define MACHINA_LITE_TOOLS_BENCHMARK_BENCHMARK_MODEL_H_
...
#include "machina/lite/profiling/memory_info.h"
...
class BenchmarkResults {
 public:
  ...
  BenchmarkResults(double model_size_mb, int64_t startup_latency_us,
                   ...
                   machina::StatWithPercentiles<int64_t> warmup_time_us,
                   machina::StatWithPercentiles<int64_t> inference_time_us,
  ...
  machina::StatWithPercentiles<int64_t> inference_time_us() const {
    return inference_time_us_;
  }
  machina::StatWithPercentiles<int64_t> warmup_time_us() const {
 ...
 private:
  ...
  machina::StatWithPercentiles<int64_t> warmup_time_us_;
  machina::StatWithPercentiles<int64_t> inference_time_us_;
...
class BenchmarkModel {
 ...
 protected:
  ...
  virtual machina::StatWithPercentiles<int64_t> Run(
...
#endif  // MACHINA_LITE_TOOLS_BENCHMARK_BENCHMARK_MODEL_H_
