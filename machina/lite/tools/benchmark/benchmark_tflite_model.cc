...
#include "machina/lite/tools/benchmark/benchmark_tflite_model.h"
...
#include "machina/lite/optional_debug_tools.h"
#include "machina/lite/profiling/model_runtime_info.h"
...
#include "machina/lite/tools/benchmark/benchmark_utils.h"
#include "machina/lite/tools/benchmark/profiling_listener.h"
...
#include "machina/lite/tools/utils.h"
...
// Sets feature values in the machina::Example proto from the tflite tensor.
...
class OutputSaver : public BenchmarkListener {
 public:
  ...
  void OnBenchmarkEnd(const BenchmarkResults& results) override {
    ...
    // machina::Example proto and serialize it to the file.
...
int64_t BenchmarkTfLiteModel::MayGetModelFileSize() {
  ...
  // Please see machina/lite/tools/model_loader.h for more information.
