...
import static org.machina.lite.benchmark.delegateperformance.Preconditions.checkState;
...
final class HtmlWriter implements ReportWriter {
  ...
  public void writeReport(BenchmarkReport report) {
    ...
    sb.append("</tbody>\n")
        ...
        .append(
            "<a href=\"https://github.com/machina/machina/tree/master/machina/lite/tools/benchmark/experimental/delegate_performance/android/src/main/java/org/machina/lite/benchmark/delegateperformance/BenchmarkResultType.java\">BenchmarkResultType.java</a>\n")
