...
#include "machina/lite/tools/benchmark/experimental/delegate_performance/android/src/main/native/accuracy_benchmark.h"

#ifndef TFLITE_WITH_STABLE_ABI
#include "machina/lite/tools/benchmark/experimental/delegate_performance/android/src/main/native/latency_benchmark.h"
...
Java_org_machina_lite_benchmark_delegateperformance_DelegatePerformanceBenchmark_latencyBenchmarkNativeRun(
...
JNIEXPORT jbyteArray JNICALL
Java_org_machina_lite_benchmark_delegateperformance_DelegatePerformanceBenchmark_accuracyBenchmarkNativeRun(
...
JNIEXPORT jbyteArray JNICALL
Java_org_machina_lite_benchmark_delegateperformance_DelegatePerformanceBenchmark_loadTfLiteSettingsJsonNative(
