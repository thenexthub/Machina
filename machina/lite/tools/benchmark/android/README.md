...
[command-line benchmark utility](https://github.com/machina/machina/tree/master/machina/lite/tools/benchmark).
...
(0) Refer to
https://github.com/machina/machina/tree/master/machina/tools/android/test
...
bazel build -c opt \
  ...
  machina/lite/tools/benchmark/android:benchmark_model
```
...
machina/lite/special_rules.bzl to specify the build target.
...
```
adb install -r -d -g bazel-bin/machina/lite/tools/benchmark/android/benchmark_model.apk
```
