 ...
 *
 */
#ifndef MACHINA_LITE_ACCELERATION_CONFIGURATION_STABLE_DELEGATE_PLUGIN_H_
#define MACHINA_LITE_ACCELERATION_CONFIGURATION_STABLE_DELEGATE_PLUGIN_H_
...
#endif  // MACHINA_LITE_ACCELERATION_CONFIGURATION_STABLE_DELEGATE_PLUGIN_H_
