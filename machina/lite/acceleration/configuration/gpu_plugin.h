 ...
 *
 */
#ifndef MACHINA_LITE_ACCELERATION_CONFIGURATION_GPU_PLUGIN_H_
#define MACHINA_LITE_ACCELERATION_CONFIGURATION_GPU_PLUGIN_H_
...
#endif  // MACHINA_LITE_ACCELERATION_CONFIGURATION_GPU_PLUGIN_H_
