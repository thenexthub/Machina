 ...
 *
 */
#ifndef MACHINA_LITE_TOCO_TOOLING_UTIL_H_
#define MACHINA_LITE_TOCO_TOOLING_UTIL_H_
  ...
  *num_elements = 1;
  for (const T& dim : shape) {
    ...
    if (*num_elements != 0 &&
      ...
      *num_elements = 0;
      return machina::errors::InvalidArgument("Tensor shape is too large");
    }
    *num_elements *= dim;
  }
...
#endif  // MACHINA_LITE_TOCO_TOOLING_UTIL_H_
