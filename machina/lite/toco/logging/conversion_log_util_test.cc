...
TEST(ConversionLogUtilTest, TestCountOperatorsByType) {
  ...
  elu_grad->machina_op = "EluGrad";
  node_def.set_op("EluGrad");
  node_def.SerializeToString(&elu_grad->machina_node_def);
