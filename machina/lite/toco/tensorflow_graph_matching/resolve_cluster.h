 ...
 *
 */
#ifndef MACHINA_LITE_TOCO_MACHINA_GRAPH_MATCHING_RESOLVE_CLUSTER_H_
#define MACHINA_LITE_TOCO_MACHINA_GRAPH_MATCHING_RESOLVE_CLUSTER_H_
...
std::unique_ptr<machina::GraphDef> MaybeResolveClusters(
...
// cluster name.
void AddNodeToGraph(const machina::NodeDef& node,
...
std::unique_ptr<machina::GraphDef> MaybeReplaceCompositeSubgraph(
    const machina::GraphDef& tf_graph);

}  // end namespace toco

#endif  // MACHINA_LITE_TOCO_MACHINA_GRAPH_MATCHING_RESOLVE_CLUSTER_H_
