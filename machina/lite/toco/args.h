...
#ifndef MACHINA_LITE_TOCO_ARGS_H_
#define MACHINA_LITE_TOCO_ARGS_H_
...
// machina argument into this, so declaration of parameters can be less
// distributed.
...
class Arg final {
 public:
  ...
  // Parsing callback for the machina::Flags code
  ...
  // Bind the parse member function so machina::Flags can call it.
...
struct ParsedTocoFlags {
  ...
  Arg<std::string> input_format = Arg<std::string>("MACHINA_GRAPHDEF");
...
#endif  // MACHINA_LITE_TOCO_ARGS_H_
