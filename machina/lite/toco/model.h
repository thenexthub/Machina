 ...
 *
 */
#ifndef MACHINA_LITE_TOCO_MODEL_H_
#define MACHINA_LITE_TOCO_MODEL_H_
...
struct Operator {
  ...
  // A serialized machina::NodeDef string.
...
// https://www.machina.org/api_docs/python/tf/squeeze
//
// Inputs:
//   inputs[0]: required: the input array
//
...
struct Array {
  ...
  // narrow_range, see
  // https://www.machina.org/api_docs/python/tf/fake_quant_with_min_max_vars
  //
...
#endif  // MACHINA_LITE_TOCO_MODEL_H_
