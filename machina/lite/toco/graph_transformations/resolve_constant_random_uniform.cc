...
bool ComputeRandomUniformArray(Model* model, RandomUniformOperator* op) {
  typedef machina::random::UniformDistribution<
      machina::random::PhiloxRandom, DataType<Type>>
      Distribution;
  ...
  // machina::functor::FillPhiloxRandomTask<Distribution, false> in
  // //machina/core/kernels/random_op.cc for the implementation.
  machina::random::PhiloxRandom generator(op->seed, op->seed2);
  Distribution dist;
