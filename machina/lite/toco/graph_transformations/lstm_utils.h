 ...
 *
 */
#ifndef MACHINA_LITE_TOCO_GRAPH_TRANSFORMATIONS_LSTM_UTILS_H_
#define MACHINA_LITE_TOCO_GRAPH_TRANSFORMATIONS_LSTM_UTILS_H_
...
#endif  // MACHINA_LITE_TOCO_GRAPH_TRANSFORMATIONS_LSTM_UTILS_H_
