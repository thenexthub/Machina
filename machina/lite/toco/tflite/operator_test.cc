...
TEST_F(OperatorTest, TensorFlowUnsupported) {
  ...
  op.machina_op = "MyCustomUnsupportedOp";
  ...
  auto output_toco_op = SerializeAndDeserialize(
      GetOperator("MACHINA_UNSUPPORTED", OperatorType::kUnsupported), op);

  ::machina::NodeDef output_node_def;
  output_node_def.ParseFromString(output_toco_op->machina_node_def);
