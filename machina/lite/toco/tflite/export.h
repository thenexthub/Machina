 ...
 *
 */
#ifndef MACHINA_LITE_TOCO_TFLITE_EXPORT_H_
#define MACHINA_LITE_TOCO_TFLITE_EXPORT_H_
...
class OperatorKey {
 public:
  ...
  const std::string& flex_machina_op() const { return flex_machina_op_; }
...
#endif  // MACHINA_LITE_TOCO_TFLITE_EXPORT_H_
