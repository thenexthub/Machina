...
TEST_F(ExportTest, UnsupportedFunctionality) {
  ...
  EXPECT_EQ(status.code(), ::machina::error::UNIMPLEMENTED);
...
TEST_F(ExportTest, UnsupportedControlFlowAndCustomOpsErrors) {
  ...
  EXPECT_EQ(
      ...
      "https://github.com/machina/machina/issues/28485. Some of the "
