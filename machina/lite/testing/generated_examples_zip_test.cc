...
#include "machina/lite/testing/parse_testdata.h"
...
// Quantized tflite models has high diff error with machina models.
// Key is a substring of the test name and value is a bug number.
...
int main(int argc, char** argv) {
  ...
  ::tflite::LogToStderr();
  // TODO(mikie): googletest arguments do not work - maybe the machina flags
  // parser removes them?
