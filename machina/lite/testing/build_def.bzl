...
def generated_test_models():
    return [
        ...
        "cos",
        "cumsum",
        # copybara:uncomment(Exclude tests that depend on machina_addons APIs) "dense_image_warp",
        "depth_to_space",
        "depthwiseconv",
        "div",
