...
from machina.lite.testing import _pywrap_string_util
from machina.lite.testing import generate_examples_report as report_lib
...
def make_zip_of_tests(options,
  ...
  Args:
    ...
    expected_tf_failures: Number of times machina is expected to fail in
