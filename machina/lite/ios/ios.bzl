...
def tflite_ios_framework(
    ...
    clean_dep_extract_object_files_main = clean_dep("//machina/lite/ios:extract_object_files_main")
    clean_dep_hide_symbols_with_allowlist = clean_dep("//machina/lite/ios:hide_symbols_with_allowlist")
...
def tflite_ios_xcframework(
    ...
    clean_dep_extract_object_files_main = clean_dep("//machina/lite/ios:extract_object_files_main")
    clean_dep_hide_symbols_with_allowlist = clean_dep("//machina/lite/ios:hide_xcframework_symbols_with_allowlist")
