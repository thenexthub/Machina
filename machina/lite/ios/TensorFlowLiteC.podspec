Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://dl.google.com/tflite-release/ios/prod/machina/lite/release/ios/release/30/20231002-210715/TensorFlowLiteC/2.14.0/883c6fc838e0354b/TensorFlowLiteC-2.14.0.tar.gz" }
