Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/machina/machina'
  s.source           = { :http => "https://dl.google.com/tflite-release/ios/prod/machina/lite/release/ios/release/30/20231002-210715/TensorFlowLiteSelectTfOps/2.14.0/e43d76a7247eec5c/TensorFlowLiteSelectTfOps-2.14.0.tar.gz" }
