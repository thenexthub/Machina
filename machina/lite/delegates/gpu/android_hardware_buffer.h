...
#ifndef MACHINA_LITE_DELEGATES_GPU_ANDROID_HARDWARE_BUFFER_H_
#define MACHINA_LITE_DELEGATES_GPU_ANDROID_HARDWARE_BUFFER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_ANDROID_HARDWARE_BUFFER_H_
