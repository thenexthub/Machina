...
#ifndef MACHINA_LITE_DELEGATES_GPU_METAL_GPU_OBJECT_H_
#define MACHINA_LITE_DELEGATES_GPU_METAL_GPU_OBJECT_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_METAL_GPU_OBJECT_H_
