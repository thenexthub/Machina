...
#ifndef MACHINA_LITE_DELEGATES_GPU_METAL_BUFFER_CONVERT_H_
#define MACHINA_LITE_DELEGATES_GPU_METAL_BUFFER_CONVERT_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_METAL_BUFFER_CONVERT_H_
