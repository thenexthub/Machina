 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_GPU_METAL_METAL_ARGUMENTS_H_
#define MACHINA_LITE_DELEGATES_GPU_METAL_METAL_ARGUMENTS_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_METAL_METAL_ARGUMENTS_H_
