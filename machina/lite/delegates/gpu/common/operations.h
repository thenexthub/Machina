...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_OPERATIONS_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_OPERATIONS_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_OPERATIONS_H_
