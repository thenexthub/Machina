...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_INFO_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_INFO_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_INFO_H_
