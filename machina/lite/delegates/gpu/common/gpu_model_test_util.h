...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_TEST_UTIL_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_TEST_UTIL_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_TEST_UTIL_H_
