 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_CUSTOM_PARSERS_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_CUSTOM_PARSERS_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_CUSTOM_PARSERS_H_
