...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_PRECISION_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_PRECISION_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_PRECISION_H_
