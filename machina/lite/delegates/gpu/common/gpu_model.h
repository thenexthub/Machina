...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_GPU_MODEL_H_
