...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_TENSOR_DESC_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_TENSOR_DESC_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_TENSOR_DESC_H_
