...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_TENSOR_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_TENSOR_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_TENSOR_H_
