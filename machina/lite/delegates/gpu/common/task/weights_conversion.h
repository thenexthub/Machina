...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_CONVERSION_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_CONVERSION_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_CONVERSION_H_
