...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_LAYOUT_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_LAYOUT_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_WEIGHTS_LAYOUT_H_
