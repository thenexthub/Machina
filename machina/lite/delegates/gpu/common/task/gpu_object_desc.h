...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_OBJECT_DESC_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_OBJECT_DESC_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_GPU_OBJECT_DESC_H_
