...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_ARGUMENTS_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_ARGUMENTS_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASK_ARGUMENTS_H_
