...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_SELECTORS_SUBGRAPH_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_SELECTORS_SUBGRAPH_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_SELECTORS_SUBGRAPH_H_
