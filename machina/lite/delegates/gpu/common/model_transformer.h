...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_TRANSFORMER_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_TRANSFORMER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_TRANSFORMER_H_
