...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_OBJECT_READER_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_OBJECT_READER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_OBJECT_READER_H_
