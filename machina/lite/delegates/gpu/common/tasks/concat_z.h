...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONCAT_Z_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONCAT_Z_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONCAT_Z_H_
