...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_GATHER_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_GATHER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_GATHER_H_
