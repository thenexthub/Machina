...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SPACE_TO_DEPTH_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SPACE_TO_DEPTH_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SPACE_TO_DEPTH_H_
