...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_QUANTIZE_AND_DEQUANTIZE_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_QUANTIZE_AND_DEQUANTIZE_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_QUANTIZE_AND_DEQUANTIZE_H_
