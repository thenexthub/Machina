...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_RESIZE_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_RESIZE_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_RESIZE_H_
