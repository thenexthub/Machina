...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SOFTMAX_TEST_UTIL_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SOFTMAX_TEST_UTIL_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_SOFTMAX_TEST_UTIL_H_
