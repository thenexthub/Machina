...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_MAX_UNPOOLING_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_MAX_UNPOOLING_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_MAX_UNPOOLING_H_
