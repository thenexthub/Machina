...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONV_METAL_SIMD_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONV_METAL_SIMD_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_TASKS_CONV_METAL_SIMD_H_
