...
#ifndef MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_HINTS_H_
#define MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_HINTS_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_COMMON_MODEL_HINTS_H_
