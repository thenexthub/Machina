...
#ifndef MACHINA_LITE_DELEGATES_GPU_METAL_DELEGATE_H_
#define MACHINA_LITE_DELEGATES_GPU_METAL_DELEGATE_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_METAL_DELEGATE_H_
