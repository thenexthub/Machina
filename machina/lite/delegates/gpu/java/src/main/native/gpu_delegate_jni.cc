...
JNIEXPORT jlong JNICALL Java_org_machina_lite_gpu_GpuDelegate_createDelegate(
...
JNIEXPORT void JNICALL Java_org_machina_lite_gpu_GpuDelegate_deleteDelegate(
