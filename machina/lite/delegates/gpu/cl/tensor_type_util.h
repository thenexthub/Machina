...
#ifndef MACHINA_LITE_DELEGATES_GPU_CL_TENSOR_TYPE_UTIL_H_
#define MACHINA_LITE_DELEGATES_GPU_CL_TENSOR_TYPE_UTIL_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_CL_TENSOR_TYPE_UTIL_H_
