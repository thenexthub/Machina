...
#ifndef MACHINA_LITE_DELEGATES_GPU_CL_GPU_API_DELEGATE_H_
#define MACHINA_LITE_DELEGATES_GPU_CL_GPU_API_DELEGATE_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_CL_GPU_API_DELEGATE_H_
