...
#ifndef MACHINA_LITE_DELEGATES_GPU_CL_QCOM_THIN_FILTER_H_
#define MACHINA_LITE_DELEGATES_GPU_CL_QCOM_THIN_FILTER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_CL_QCOM_THIN_FILTER_H_
