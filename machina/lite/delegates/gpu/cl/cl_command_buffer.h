...
#ifndef MACHINA_LITE_DELEGATES_GPU_CL_CL_COMMAND_BUFFER_H_
#define MACHINA_LITE_DELEGATES_GPU_CL_CL_COMMAND_BUFFER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_CL_CL_COMMAND_BUFFER_H_
