...
#ifndef MACHINA_LITE_DELEGATES_GPU_CL_KERNELS_CONVERTER_H_
#define MACHINA_LITE_DELEGATES_GPU_CL_KERNELS_CONVERTER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_CL_KERNELS_CONVERTER_H_
