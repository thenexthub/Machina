...
#ifndef MACHINA_LITE_DELEGATES_GPU_GL_KERNELS_CONCAT_H_
#define MACHINA_LITE_DELEGATES_GPU_GL_KERNELS_CONCAT_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_GL_KERNELS_CONCAT_H_
