...
#ifndef MACHINA_LITE_DELEGATES_GPU_GL_RUNTIME_SHARED_BUFFER_H_
#define MACHINA_LITE_DELEGATES_GPU_GL_RUNTIME_SHARED_BUFFER_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_GL_RUNTIME_SHARED_BUFFER_H_
