...
#ifndef MACHINA_LITE_DELEGATES_GPU_GL_EGL_CONTEXT_H_
#define MACHINA_LITE_DELEGATES_GPU_GL_EGL_CONTEXT_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_GL_EGL_CONTEXT_H_
