...
#ifndef MACHINA_LITE_DELEGATES_GPU_GL_COMPILER_PREPROCESSOR_H_
#define MACHINA_LITE_DELEGATES_GPU_GL_COMPILER_PREPROCESSOR_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_GL_COMPILER_PREPROCESSOR_H_
