 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_GPU_GL_ANDROID_SYNC_H_
#define MACHINA_LITE_DELEGATES_GPU_GL_ANDROID_SYNC_H_
...
#endif  // MACHINA_LITE_DELEGATES_GPU_GL_ANDROID_SYNC_H_
