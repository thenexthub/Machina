...
#include "machina/compiler/mlir/lite/kernels/internal/compatibility_macros.h"
...
#include "machina/lite/delegates/xnnpack/file_util.h"
#include "machina/lite/delegates/xnnpack/flexbuffers_util.h"
#include "machina/lite/delegates/xnnpack/quantization_util.h"
#include "machina/lite/delegates/xnnpack/weight_cache.h"
...
#include "machina/lite/tools/optimize/reduced_precision_support.h"
...
// the machina/lite/kernels/var_handle.cc implementation because there's a
  ...
  static TfLiteStatus CalculatePadding(TfLiteContext* context,
    ...
    switch (padding) {
      case kTfLitePaddingSame: {
        *flags = XNN_FLAG_MACHINA_SAME_PADDING;
        return kTfLiteOk;
      }
  ...
  static TfLiteStatus VisitResizeBilinearNode(
    ...
    if (subgraph != nullptr) {
      ...
      if (resize_params->align_corners) {
        ...
        flags |= XNN_FLAG_MACHINA_LEGACY_MODE;
      }
