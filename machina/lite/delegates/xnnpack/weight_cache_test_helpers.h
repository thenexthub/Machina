 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_XNNPACK_WEIGHT_CACHE_TEST_HELPERS_H_
#define MACHINA_LITE_DELEGATES_XNNPACK_WEIGHT_CACHE_TEST_HELPERS_H_
...
#endif  // MACHINA_LITE_DELEGATES_XNNPACK_WEIGHT_CACHE_TEST_HELPERS_H_
