 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_XNNPACK_MMAP_HANDLE_H_
#define MACHINA_LITE_DELEGATES_XNNPACK_MMAP_HANDLE_H_
...
#endif  // MACHINA_LITE_DELEGATES_XNNPACK_MMAP_HANDLE_H_
