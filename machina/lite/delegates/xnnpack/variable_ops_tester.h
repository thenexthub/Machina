...
#ifndef MACHINA_LITE_DELEGATES_XNNPACK_VARIABLE_OPS_TESTER_H_
#define MACHINA_LITE_DELEGATES_XNNPACK_VARIABLE_OPS_TESTER_H_
...
#endif  // MACHINA_LITE_DELEGATES_XNNPACK_VARIABLE_OPS_TESTER_H_
