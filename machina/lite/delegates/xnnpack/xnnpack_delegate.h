...
#ifndef MACHINA_LITE_DELEGATES_XNNPACK_XNNPACK_DELEGATE_H_
#define MACHINA_LITE_DELEGATES_XNNPACK_XNNPACK_DELEGATE_H_
...
#endif  // MACHINA_LITE_DELEGATES_XNNPACK_XNNPACK_DELEGATE_H_
