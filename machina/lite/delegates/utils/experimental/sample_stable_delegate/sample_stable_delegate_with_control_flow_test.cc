 ...
 *
 */
#include "machina/lite/delegates/utils/experimental/sample_stable_delegate/sample_stable_delegate_with_control_flow.h"
...
TEST(SampleStableDelegate, StaticallyLinkedDelegateAndModelWithSub) {
  ...
  //
  TfLiteModel* model =
      TfLiteModelCreateFromFile("machina/lite/testdata/sub.bin");
  ASSERT_NE(model, nullptr);
  TfLiteInterpreterOptions* options = TfLiteInterpreterOptionsCreate();
  ASSERT_NE(options, nullptr);
  TfLiteInterpreterOptionsAddDelegate(options, opaque_delegate.get());
...
TEST(SampleStableDelegate, StaticallyLinkedDelegateAndModelWithNestedWhile) {
  ...
  TfLiteModel* model = TfLiteModelCreateFromFile(
      "machina/lite/testdata/nested_while.bin");
  ASSERT_NE(model, nullptr);
  TfLiteInterpreterOptions* options = TfLiteInterpreterOptionsCreate();
  ASSERT_NE(options, nullptr);
  TfLiteInterpreterOptionsAddDelegate(options, opaque_delegate.get());
