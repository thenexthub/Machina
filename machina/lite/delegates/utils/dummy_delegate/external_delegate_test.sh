...
readonly benchmark_tool=machina/lite/tools/benchmark/benchmark_model
readonly external_delegate=machina/lite/delegates/utils/dummy_delegate/dummy_external_delegate.so
