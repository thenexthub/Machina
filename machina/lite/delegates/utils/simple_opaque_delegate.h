...
#ifndef MACHINA_LITE_DELEGATES_UTILS_SIMPLE_OPAQUE_DELEGATE_H_
#define MACHINA_LITE_DELEGATES_UTILS_SIMPLE_OPAQUE_DELEGATE_H_
...
#endif  // MACHINA_LITE_DELEGATES_UTILS_SIMPLE_OPAQUE_DELEGATE_H_
