 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_FLEX_DELEGATE_DATA_H_
#define MACHINA_LITE_DELEGATES_FLEX_DELEGATE_DATA_H_
...
#include "machina/lite/delegates/flex/subgraph_resource.h"
...
class DelegateData {
 public:
  ...
  // non-null.
  absl::Status Prepare(const machina::SessionOptions& session_options,
  ...
  machina::EagerContext* GetEagerContext() { return eager_context_; }

  machina::CancellationManager* GetCancellationManager() {
 ...
 private:
  ...
  machina::EagerContext* eager_context_ = nullptr;
  // Not owned by DelegateData.
  machina::CancellationManager* cancellation_manager_ = nullptr;
...
#endif  // MACHINA_LITE_DELEGATES_FLEX_DELEGATE_DATA_H_
