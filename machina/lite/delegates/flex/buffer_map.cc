...
machina::Tensor BufferMap::GetTensor(int tensor_index) const {
  return id_to_tensor_.at(tensor_index);
}

const machina::Tensor* BufferMap::GetTensorPtr(int tensor_index) const {
...
void BufferMap::SetFromTensorFlow(int tensor_index, machina::Tensor tensor) {
