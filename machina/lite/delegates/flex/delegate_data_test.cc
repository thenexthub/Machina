...
#include "machina/lite/kernels/subgraph_test_util.h"
...
TEST(DelegateDataTest, CheckFunctionDef) {
  machina::StaticDeviceMgr device_mgr(machina::DeviceFactory::NewDevice(
      "CPU", {}, "/job:localhost/replica:0/task:0/device:CPU:0"));
  machina::EagerContext* eager_context = new machina::EagerContext(
      machina::SessionOptions(),
  ...
  machina::FunctionDef add_fdef, mul_fdef;
