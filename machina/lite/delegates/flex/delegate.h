 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_FLEX_DELEGATE_H_
#define MACHINA_LITE_DELEGATES_FLEX_DELEGATE_H_
...
class FlexDelegate : public SimpleDelegateInterface {
 ...
 private:
  ...
  std::unique_ptr<machina::CancellationManager> cancellation_manager_;
};

}  // namespace tflite

#endif  // MACHINA_LITE_DELEGATES_FLEX_DELEGATE_H_
