...
#include "machina/lite/acceleration/configuration/c/nnapi_plugin.h"
...
Java_org_machina_lite_nnapi_NnApiDelegateImpl_createDelegate(
...
Java_org_machina_lite_nnapi_NnApiDelegateImpl_getNnapiErrno(JNIEnv* env,
                                                               jclass clazz,
                                                               jlong delegate) {
#if TFLITE_DISABLE_SELECT_JAVA_APIS
  TfLiteOpaqueDelegate* nnapi_delegate =
...
Java_org_machina_lite_nnapi_NnApiDelegateImpl_deleteDelegate(
