 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_C_API_H_
#define MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_C_API_H_
...
#endif  // MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_C_API_H_
