...
#ifndef MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_KERNEL_H_
#define MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_KERNEL_H_
...
#include "machina/lite/delegates/nnapi/nnapi_delegate_plugin.h"
...
enum class NNAPIValidationFailureType : int {
  ...
  // machina/compiler/mlir/lite/tools/versioning/op_version.cc.
...
#endif  // MACHINA_LITE_DELEGATES_NNAPI_NNAPI_DELEGATE_KERNEL_H_
