 ...
 *
 */
#ifndef MACHINA_LITE_DELEGATES_HEXAGON_BUILDERS_TRANSPOSE_BUILDER_H_
#define MACHINA_LITE_DELEGATES_HEXAGON_BUILDERS_TRANSPOSE_BUILDER_H_
...
#endif  // MACHINA_LITE_DELEGATES_HEXAGON_BUILDERS_TRANSPOSE_BUILDER_H_
