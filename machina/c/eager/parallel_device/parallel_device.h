...
#ifndef MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_H_
#define MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_H_
...
#endif  // MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_H_
