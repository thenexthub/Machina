...
#ifndef MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_TESTLIB_H_
#define MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_TESTLIB_H_
...
#endif  // MACHINA_C_EAGER_PARALLEL_DEVICE_PARALLEL_DEVICE_TESTLIB_H_
