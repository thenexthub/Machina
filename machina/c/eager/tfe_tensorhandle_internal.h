 ...
 *
 */
#ifndef MACHINA_C_EAGER_TFE_TENSORHANDLE_INTERNAL_H_
#define MACHINA_C_EAGER_TFE_TENSORHANDLE_INTERNAL_H_
...
DEFINE_CONVERSION_FUNCTIONS(machina::ImmediateExecutionTensorHandle,
                            TFE_TensorHandle);
DEFINE_CONVERSION_FUNCTIONS(machina::ImmediateExecutionTensorHandle*,
                            TFE_TensorHandle*);
...
#endif  // MACHINA_C_EAGER_TFE_TENSORHANDLE_INTERNAL_H_
