 ...
 *
 */
#ifndef MACHINA_C_EAGER_IMMEDIATE_EXECUTION_TENSOR_HANDLE_H_
#define MACHINA_C_EAGER_IMMEDIATE_EXECUTION_TENSOR_HANDLE_H_
...
#endif  // MACHINA_C_EAGER_IMMEDIATE_EXECUTION_TENSOR_HANDLE_H_
