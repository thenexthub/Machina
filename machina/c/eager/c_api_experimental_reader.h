...
#ifndef MACHINA_C_EAGER_C_API_EXPERIMENTAL_READER_H_
#define MACHINA_C_EAGER_C_API_EXPERIMENTAL_READER_H_
...
// auto* streamz = machina::monitoring::Counter<1>::New("name",
// "description", "label");
...
#endif  // MACHINA_C_EAGER_C_API_EXPERIMENTAL_READER_H_
