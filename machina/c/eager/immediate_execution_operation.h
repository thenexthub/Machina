 ...
 *
 */
#ifndef MACHINA_C_EAGER_IMMEDIATE_EXECUTION_OPERATION_H_
#define MACHINA_C_EAGER_IMMEDIATE_EXECUTION_OPERATION_H_
...
class ImmediateExecutionOperation : public AbstractOperation {
 public:
  ...
  virtual const machina::OpDef* OpDef() const = 0;
  ...
  virtual const machina::AbstractOpAttrs* GetOpAttrs() const = 0;
...
#endif  // MACHINA_C_EAGER_IMMEDIATE_EXECUTION_OPERATION_H_
