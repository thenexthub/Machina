 ...
 *
 */
#ifndef MACHINA_C_EAGER_C_API_EXPERIMENTAL_H_
#define MACHINA_C_EAGER_C_API_EXPERIMENTAL_H_
...
// Serialize `attrs` as a machina::NameAttrList protocol buffer (into `buf`),
...
#endif  // MACHINA_C_EAGER_C_API_EXPERIMENTAL_H_
