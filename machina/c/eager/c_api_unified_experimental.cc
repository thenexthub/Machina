...
using machina::wrap;
using machina::tracing::CreateTracingExecutionContext;
using machina::tracing::SetDefaultTracingEngine;
...
TF_AbstractFunction* TF_FinalizeFunction(TF_ExecutionContext* ctx,
  ...
  if (!tracing_ctx) {
    tsl::Set_TF_Status_from_Status(
        s, machina::errors::InvalidArgument(
...
TF_AbstractTensor* TF_AddFunctionParameter(TF_ExecutionContext* func,
  ...
  if (shape.num_dims != -1) {
    ...
    Status status = machina::PartialTensorShape::MakePartialShape(
