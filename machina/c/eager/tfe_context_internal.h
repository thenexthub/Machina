 ...
 *
 */
#ifndef MACHINA_C_EAGER_TFE_CONTEXT_INTERNAL_H_
#define MACHINA_C_EAGER_TFE_CONTEXT_INTERNAL_H_
...
DEFINE_CONVERSION_FUNCTIONS(machina::ImmediateExecutionContext, TFE_Context);

}  // namespace machina

#endif  // MACHINA_C_EAGER_TFE_CONTEXT_INTERNAL_H_
