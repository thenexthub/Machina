 ...
 *
 */
#ifndef MACHINA_C_EAGER_C_API_TEST_UTIL_H_
#define MACHINA_C_EAGER_C_API_TEST_UTIL_H_
...
bool GetDeviceName(TFE_Context* ctx, machina::string* device_name,
                   const char* device_type);

// Create a ServerDef with the given `job_name` and add `num_tasks` tasks in it.
machina::ServerDef GetServerDef(const machina::string& job_name,
                                   int num_tasks);
...
#endif  // MACHINA_C_EAGER_C_API_TEST_UTIL_H_
