...
#include "machina/c/eager/tfe_tensor_debug_info_internal.h"
...
std::vector<int64_t> TensorShapeAsVector(const machina::TensorHandle& handle,
                                         absl::Status* status) {
...
TF_CAPI_EXPORT extern TFE_TensorDebugInfo* TFE_TensorHandleTensorDebugInfo(
  ...
  machina::TensorHandle* handle =
      TensorHandleFromInterface(machina::unwrap(h));
