...
#ifndef MACHINA_C_EAGER_GRADIENTS_H_
#define MACHINA_C_EAGER_GRADIENTS_H_
...
// a map (`machina::eager::TensorTape`) from the wrapped tensor to the id of
...
// op executed under the tape. A separate map (`machina::eager::OpTape`)
...
class TapeTensor {
 public:
  ...
  int64_t GetID() const;
  machina::DataType GetDType() const;
...
#endif  // MACHINA_C_EAGER_GRADIENTS_H_
