...
#ifndef MACHINA_C_C_API_MACROS_INTERNAL_H_
#define MACHINA_C_C_API_MACROS_INTERNAL_H_
...
#define TF_VALIDATE_STRUCT_SIZE(STRUCT_NAME, STRUCT_OBJ, SIZE_VALUE_NAME) \
  do {                                                                    \
    if (STRUCT_OBJ.struct_size == 0) {                                    \
      return machina::Status(absl::StatusCode::kFailedPrecondition,    \
...
#endif  // __cplusplus
#endif  // MACHINA_C_C_API_MACROS_INTERNAL_H_
