 ...
 *
 */
#ifndef MACHINA_C_EXPERIMENTAL_GRADIENTS_TAPE_TAPE_CONTEXT_H_
#define MACHINA_C_EXPERIMENTAL_GRADIENTS_TAPE_TAPE_CONTEXT_H_
...
#endif  // MACHINA_C_EXPERIMENTAL_GRADIENTS_TAPE_TAPE_CONTEXT_H_
