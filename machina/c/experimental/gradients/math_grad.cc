 ...
 *
 */
#include "machina/c/experimental/gradients/math_grad.h"

#include "machina/c/eager/abstract_tensor_handle.h"
#include "machina/c/eager/gradients.h"
#include "machina/c/experimental/ops/array_ops.h"
#include "machina/c/experimental/ops/math_ops.h"
#include "machina/c/experimental/ops/nn_ops.h"

using std::vector;
using machina::ops::AddV2;
using machina::ops::Div;
using machina::ops::DivNoNan;
using machina::ops::MatMul;
using machina::ops::Mul;
using machina::ops::Neg;
using machina::ops::OnesLike;
using machina::ops::SqrtGrad;
