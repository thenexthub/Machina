 ...
 *
 */
#ifndef MACHINA_C_EXPERIMENTAL_GRADIENTS_MATH_GRAD_H_
#define MACHINA_C_EXPERIMENTAL_GRADIENTS_MATH_GRAD_H_
...
#endif  // MACHINA_C_EXPERIMENTAL_GRADIENTS_MATH_GRAD_H_
