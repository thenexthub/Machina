...
#ifndef MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_SAVED_MODEL_UTILS_H_
#define MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_SAVED_MODEL_UTILS_H_
...
// Load a TensorProto into a machina::Constant. This is similar to the
// constant loading logic in python:
// https://github.com/machina/machina/blob/516608035f85cec8b126712b0ff8407220206b22/machina/python/saved_model/load.py#L437
absl::Status TensorProtoToConstant(ImmediateExecutionContext* ctx,
                                   const TensorProto& proto,
                                   std::unique_ptr<Constant>* output);

// Creates a machina::Variable from a SavedVariable. This is similar to the
// logic in:
...
#endif  // MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_SAVED_MODEL_UTILS_H_
