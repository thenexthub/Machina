...
#ifndef MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_REVIVED_TYPES_RESTORED_RESOURCE_H_
#define MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_REVIVED_TYPES_RESTORED_RESOURCE_H_
...
// https://github.com/machina/machina/blob/fda326e542ca67534e8411edb180e8760a4828b7/machina/python/saved_model/load.py#L481
// TF2 resource objects typically extend TrackableResource:
// https://github.com/machina/machina/blob/fda326e542ca67534e8411edb180e8760a4828b7/machina/python/training/tracking/tracking.py#L285
// and are expected to implement "_create_resource", "_initialize", and
// "_destroy_resource" functions:
// https://github.com/machina/machina/blob/139ba9c5284799beafdd1d7f895127cf00e7c48f/machina/python/training/tracking/tracking.py#L262-L281
class RestoredResource : TensorHandleConvertible {
 public:
  ...
  //           https://github.com/machina/machina/blob/master/machina/core/protobuf/saved_object_graph.proto#L182
  //           Conceptually, this is the same device used in CapturableResource:
  //           https://github.com/machina/machina/blob/568e2bef00f24af1159a0846abf67c099ca78a21/machina/python/training/tracking/tracking.py#L222-L225
  //           Implementation-wise, it is device used when invoking the
  //           create_resource function to produce the resource_handle
  //           associated with the object:
  //           https://github.com/machina/machina/blob/568e2bef00f24af1159a0846abf67c099ca78a21/machina/python/training/tracking/tracking.py#L246-L247
...
#endif  // MACHINA_C_EXPERIMENTAL_SAVED_MODEL_CORE_REVIVED_TYPES_RESTORED_RESOURCE_H_
