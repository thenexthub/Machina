...
#include "machina/c/experimental/saved_model/core/revived_types/partially_revived_objects.h"
#include "machina/c/experimental/saved_model/core/revived_types/revived_objects.h"
...
// https://github.com/machina/machina/blob/ddc1bbad3dfd4a089eb96014f26cc16664b1b2f8/machina/python/training/tracking/base.py#L953-L983
...
// https://github.com/machina/machina/blob/ddc1bbad3dfd4a089eb96014f26cc16664b1b2f8/machina/python/training/saving/saveable_object.py#L58.
// The string key becomes the "name" attribute of the SerializedTensor proto
// in the TrackableObjectGraph,
// https://github.com/machina/machina/blob/ddc1bbad3dfd4a089eb96014f26cc16664b1b2f8/machina/core/protobuf/trackable_object_graph.proto#L26
// And the checkpoint_key is a globally unique string derived from this name:
// https://github.com/machina/machina/blob/842df9e6b516e42578a8d23b35d41176b9a6cf1d/machina/python/training/tracking/graph_view.py#L236-L241
// SaveableObjects model the information needed to pass to the SaveV2/RestoreV2
// ops via their SaveSpec members
// https://github.com/machina/machina/blob/ddc1bbad3dfd4a089eb96014f26cc16664b1b2f8/machina/python/training/saving/saveable_object.py#L21,
...
// https://github.com/machina/machina/blob/ddc1bbad3dfd4a089eb96014f26cc16664b1b2f8/machina/python/training/saving/saveable_object.py#L85
  ...
  TF_RETURN_IF_ERROR(bundle->VisitObjectsToRestore(
      [&revived_objects, &directory, context, bundle](
        ...
        if (bundle->saved_object_graph().nodes(node).kind_case() !=
          ...
          // functions from
          // https://github.com/machina/machina/commit/df6b21c13c82b5d0981642cfe18f10e60f78ea5c
...
absl::Status TFSavedModelAPI::Load(
  ...
  // https://github.com/machina/machina/blob/285b5fa15405c5e2c084080f52a1818be8648079/machina/python/saved_model/function_deserialization.py#L438-L454
