 ...
 *
 */
#include "machina/c/experimental/filesystem/plugins/gcs/gcs_filesystem.h"
...
static std::string InitializeTmpDir() {
  ...
  if (test_dir != nullptr) {
    ...
    return machina::io::JoinPath(std::string(test_dir), rng_val);
  } else {
    return "";
  }
}
...
// `//machina/core/platform/cloud:gcs_file_system_test`.
