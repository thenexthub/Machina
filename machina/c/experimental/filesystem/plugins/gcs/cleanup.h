...
#ifndef MACHINA_C_EXPERIMENTAL_FILESYSTEM_PLUGINS_GCS_CLEANUP_H_
#define MACHINA_C_EXPERIMENTAL_FILESYSTEM_PLUGINS_GCS_CLEANUP_H_
...
#endif  // MACHINA_C_EXPERIMENTAL_FILESYSTEM_PLUGINS_GCS_CLEANUP_H_
