...
#include "machina/c/c_api_macros_internal.h"
...
#include "machina/xla/stream_executor/executor_cache.h"
...
#include "machina/xla/stream_executor/stream_executor_common.h"
#include "machina/xla/tsl/platform/errors.h"
#include "machina/xla/tsl/platform/status.h"
#include "machina/core/common_runtime/device/device_utils.h"
#include "machina/core/platform/env.h"
#include "machina/core/platform/stringpiece.h"

using machina::StatusFromTF_Status;

namespace stream_executor {
using machina::StringPiece;

// TODO(penporn): Remove OwnedTFStatus.
using OwnedTFStatus = machina::TF_StatusPtr;
...
absl::Status ValidateSPPlatform(const SP_Platform& platform) {
  ...
  TF_RETURN_IF_ERROR(
      machina::device_utils::ValidateDeviceType(platform.name));
  TF_RETURN_IF_ERROR(
      machina::device_utils::ValidateDeviceType(platform.type));
...
absl::Status InitStreamExecutorPlugin(SEInitPluginFn init_fn,
  ...
  TF_RETURN_IF_ERROR(machina::StatusFromTF_Status(c_status.get()));
