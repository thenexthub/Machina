...
#ifndef MACHINA_C_EXPERIMENTAL_NEXT_PLUGGABLE_DEVICE_C_API_H_
#define MACHINA_C_EXPERIMENTAL_NEXT_PLUGGABLE_DEVICE_C_API_H_
...
// --------------------------  Resource  ---------------------------------------
// Create a `machina::PluginResource` to the ResourceMgr provided by the
// `ctx`. The `machina::PluginResource` wraps a resource by plugin (as a
...
// machina/compiler/xla/pjrt/c/pjrt_c_api_helpers.h to generate the options.
...
#endif  // MACHINA_C_EXPERIMENTAL_NEXT_PLUGGABLE_DEVICE_C_API_H_
