...
class CApiFunctionTest : public ::testing::Test {
 protected:
  ...
  void VerifyFDefNodes(const machina::FunctionDef& fdef,
  ...
  void VerifyFDefInputs(const machina::FunctionDef& fdef,
  ...
  void VerifyFDefOutputs(const machina::FunctionDef& fdef,
  ...
  void VerifyFDefEdges(
      const machina::FunctionDef& fdef,
...
void AssertEqual(TF_Function* f1, TF_Function* f2) {
  string s1, s2;
  machina::FunctionDef fdef1, fdef2;
