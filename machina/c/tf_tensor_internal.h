...
#ifndef MACHINA_C_TF_TENSOR_INTERNAL_H_
#define MACHINA_C_TF_TENSOR_INTERNAL_H_
...
#include "machina/c/tf_tensor_helper.h"  // IWYU pragma: export
...
typedef struct TF_Tensor {
  machina::AbstractTensorInterface* tensor;
} TF_Tensor;

class TF_ManagedBuffer : public machina::TensorBuffer {
 public:
...
class TensorInterface : public AbstractTensorInterface {
 public:
  TensorInterface() {}
  explicit TensorInterface(machina::Tensor t) : tensor_(std::move(t)) {}
...
#endif  // MACHINA_C_TF_TENSOR_INTERNAL_H_
