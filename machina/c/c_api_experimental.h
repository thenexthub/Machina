...
#ifndef MACHINA_C_C_API_EXPERIMENTAL_H_
#define MACHINA_C_C_API_EXPERIMENTAL_H_
...
// machina.ConfigProto.OptimizerOptions.global_jit_level to ON_1, and also
...
// clients that cannot read/write the machina.ConfigProto proto.
...
// as if passed in MACHINA_MACHINA_XLA_FLAGS. This has global effect.
...
// Create a serialized machina.ConfigProto proto, where:
//
...
// Create a serialized machina.RunOptions proto, where RunOptions.trace_level
...
TF_CAPI_EXPORT extern void TF_EnqueueNamedTensor(TF_Session* session,
                                                 ...
                                                 TF_Tensor* tensor,
                                                 TF_Status* status);
// Create a serialized machina.ServerDef proto.
...
// Checks the machina::NodeDef built via the methods above to see if it can
// run on device_type.
...
#endif  // MACHINA_C_C_API_EXPERIMENTAL_H_
