...
#ifndef MACHINA_MACHINA_XLA_FFI_EXECUTION_CONTEXT_H_
#define MACHINA_MACHINA_XLA_FFI_EXECUTION_CONTEXT_H_
...
#endif  // MACHINA_MACHINA_XLA_FFI_EXECUTION_CONTEXT_H_
