...
TEST(CallFrameTest, UpdateCallFrame) {
  ...
  {  // Construct MACHINA_MACHINA_XLA_FFI_CallFrame from the original call frame.
    MACHINA_MACHINA_XLA_FFI_CallFrame ffi_call_frame = call_frame->Build(
        /*api=*/nullptr, /*ctx=*/nullptr, MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE);

    EXPECT_EQ(ffi_call_frame.args.size, 1);
    EXPECT_EQ(ffi_call_frame.args.types[0], MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER);
    EXPECT_EQ(static_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(ffi_call_frame.args.args[0])->data,
              mem0.opaque());

    EXPECT_EQ(ffi_call_frame.rets.size, 1);
    EXPECT_EQ(ffi_call_frame.rets.types[0], MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER);
    EXPECT_EQ(static_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(ffi_call_frame.rets.rets[0])->data,
              mem1.opaque());
  ...
  {  // Construct MACHINA_MACHINA_XLA_FFI_CallFrame from the updated call frame.
    MACHINA_MACHINA_XLA_FFI_CallFrame ffi_call_frame = updated_call_frame.Build(
        /*api=*/nullptr, /*ctx=*/nullptr, MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE);
  ...
  {  // Construct MACHINA_MACHINA_XLA_FFI_CallFrame from the call frame updated in place.
    MACHINA_MACHINA_XLA_FFI_CallFrame ffi_call_frame = updated_call_frame.Build(
        /*api=*/nullptr, /*ctx=*/nullptr, MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE);
