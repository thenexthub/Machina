...
#ifndef MACHINA_MACHINA_XLA_FFI_CALL_FRAME_H_
#define MACHINA_MACHINA_XLA_FFI_CALL_FRAME_H_
...
class CallFrame {
 public:
  ...
  // Builds an MACHINA_MACHINA_XLA_FFI_CallFrame from owned arguments and attributes.
  MACHINA_MACHINA_XLA_FFI_CallFrame Build(
      const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
      MACHINA_MACHINA_XLA_FFI_ExecutionStage stage = MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE);
...
#endif  // MACHINA_MACHINA_XLA_FFI_CALL_FRAME_H_
