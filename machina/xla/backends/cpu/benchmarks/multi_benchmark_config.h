...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_BENCHMARKS_MULTI_BENCHMARK_CONFIG_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_BENCHMARKS_MULTI_BENCHMARK_CONFIG_H_
...
#include "machina/xla/backends/cpu/benchmarks/aot_benchmark_helper.h"
...
#define MACHINA_MACHINA_XLA_CPU_BENCHMARK(n) MACHINA_MACHINA_XLA_CPU_BENCHMARK_HELPER(__COUNTER__, n)
...
#define MACHINA_MACHINA_XLA_CPU_BENCHMARK_HELPER(ctr, n) MACHINA_MACHINA_XLA_CPU_BENCHMARK_HELPER2(ctr, n)

// Helper for macros above.  Don't use directly.
#define MACHINA_MACHINA_XLA_CPU_BENCHMARK_HELPER2(ctr, n)                    \
  static MultiBenchmarkConfig* xla_cpu_benchmark_ptr_##ctr = \
      RegisterJitAndAotBenchmarks(#n, n)

}  // namespace xla::cpu

#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_BENCHMARKS_MULTI_BENCHMARK_CONFIG_H_
