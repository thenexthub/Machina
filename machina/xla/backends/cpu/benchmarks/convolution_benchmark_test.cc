...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv2D<F32>)
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_GroupedConv2D)
    ->MeasureProcessCPUTime()
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv1DStrided)
    ->MeasureProcessCPUTime()
    ->Args({1, 129})
    ->Args({3, 129});
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv1DTransposedStrided)
    ->MeasureProcessCPUTime()
    ->MeasureProcessCPUTime()
    ->Args({129, 1})
    ->Args({129, 3});
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv1DTransposedStridedNonDefaultLayout)
    ->MeasureProcessCPUTime()
    ->Args({129, 1})
    ->Args({129, 3});

MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv2DStrided)->MeasureProcessCPUTime();
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_Conv2DTransposedStrided)->MeasureProcessCPUTime();

// -------------------------------------------------------------------------- //
// Grouped strided convolutions
// -------------------------------------------------------------------------- //

MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_GroupedConv2DStrided)
    ->MeasureProcessCPUTime()
    ->Args({128, 128, 128})
    ->Args({128, 128, 16});
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_GroupedConv2DTransposedStrided)
    ->MeasureProcessCPUTime()
    ->Args({128, 128, 128})
    ->Args({128, 128, 16});
