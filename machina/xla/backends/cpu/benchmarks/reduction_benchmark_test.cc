...
#define BENCHMARK_SIZES(NAME)   \
  MACHINA_MACHINA_XLA_CPU_BENCHMARK(NAME)       \
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ReduceAddF32OverDimension)
    ->ArgName("reduce_dim")
    ->Arg(0)
    ->Arg(1);

MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ReduceWindowAddF32OuterAndInnerDim)
    ->MeasureProcessCPUTime()
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ReduceWindowAddF32SkippingData)->MeasureProcessCPUTime();

MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ReduceWindowAddF32OverlappingWindows)
    ->MeasureProcessCPUTime();
