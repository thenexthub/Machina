...
// (2^18) == (2^9)^2 == (2^6)^3
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ScatterS32_R1)
    ->MeasureProcessCPUTime()
    ->Args({1 << 18, 1 << 18});
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ScatterS32_R2)
    ->MeasureProcessCPUTime()
    ->Args({1 << 9, 1 << 9});
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ScatterS32_R3)
    ->MeasureProcessCPUTime()
    ->Args({1 << 6, 1 << 6});

MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_SimpleScatterReduceF32_R3)
    ->MeasureProcessCPUTime()
