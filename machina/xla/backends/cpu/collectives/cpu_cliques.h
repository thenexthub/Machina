...
#ifndef MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUES_H_
#define MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUES_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUES_H_
