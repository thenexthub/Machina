...
#ifndef MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUE_KEY_H_
#define MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUE_KEY_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_COLLECTIVES_CPU_CLIQUE_KEY_H_
