...
#ifndef MACHINA_XLABACKENDS_CPU_COLLECTIVES_GLOO_KV_STORE_H_
#define MACHINA_XLABACKENDS_CPU_COLLECTIVES_GLOO_KV_STORE_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_COLLECTIVES_GLOO_KV_STORE_H_
