...
#ifndef MACHINA_XLABACKENDS_CPU_CONSTANT_ALLOCATION_H_
#define MACHINA_XLABACKENDS_CPU_CONSTANT_ALLOCATION_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_CONSTANT_ALLOCATION_H_
