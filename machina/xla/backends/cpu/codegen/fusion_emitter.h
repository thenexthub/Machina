...
#ifndef MACHINA_XLABACKENDS_CPU_CODEGEN_FUSION_EMITTER_H_
#define MACHINA_XLABACKENDS_CPU_CODEGEN_FUSION_EMITTER_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_CODEGEN_FUSION_EMITTER_H_
