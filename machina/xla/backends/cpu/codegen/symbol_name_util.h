...
#ifndef MACHINA_XLABACKENDS_CPU_CODEGEN_SYMBOL_NAME_UTIL_H_
#define MACHINA_XLABACKENDS_CPU_CODEGEN_SYMBOL_NAME_UTIL_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_CODEGEN_SYMBOL_NAME_UTIL_H_
