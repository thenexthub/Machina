...
#ifndef MACHINA_XLABACKENDS_CPU_CODEGEN_DOT_DOT_KERNEL_EMITTER_H_
#define MACHINA_XLABACKENDS_CPU_CODEGEN_DOT_DOT_KERNEL_EMITTER_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_CODEGEN_DOT_DOT_KERNEL_EMITTER_H_
