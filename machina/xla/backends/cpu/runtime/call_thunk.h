...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_CALL_THUNK_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_CALL_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_CALL_THUNK_H_
