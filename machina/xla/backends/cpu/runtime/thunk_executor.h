...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_EXECUTOR_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_EXECUTOR_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_EXECUTOR_H_
