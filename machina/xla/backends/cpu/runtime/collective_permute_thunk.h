...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_COLLECTIVE_PERMUTE_THUNK_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_COLLECTIVE_PERMUTE_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_COLLECTIVE_PERMUTE_THUNK_H_
