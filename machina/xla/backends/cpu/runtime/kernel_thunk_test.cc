...
class AddF32HostKernel : public FunctionLibrary {
 public:
  absl::StatusOr<void*> ResolveFunction(TypeId type_id,
    ...
    auto kernel = +[](const MACHINA_MACHINA_XLA_CPU_KernelCallFrame* call_frame) {
      const MACHINA_MACHINA_XLA_CPU_KernelArg& in = call_frame->args[0];
      const MACHINA_MACHINA_XLA_CPU_KernelArg& out = call_frame->args[1];
