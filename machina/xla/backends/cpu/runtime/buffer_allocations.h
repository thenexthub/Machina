...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_BUFFER_ALLOCATIONS_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_BUFFER_ALLOCATIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_BUFFER_ALLOCATIONS_H_
