...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_SERDES_BASE_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_SERDES_BASE_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_SERDES_BASE_H_
