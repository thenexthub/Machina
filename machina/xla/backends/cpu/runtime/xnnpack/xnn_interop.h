...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XNNPACK_XNN_INTEROP_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XNNPACK_XNN_INTEROP_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XNNPACK_XNN_INTEROP_H_
