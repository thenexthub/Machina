...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_XNNPACK_XNN_SCHEDULER_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_XNNPACK_XNN_SCHEDULER_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_XNNPACK_XNN_SCHEDULER_H_
