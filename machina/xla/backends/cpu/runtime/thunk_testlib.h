...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_TESTLIB_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_TESTLIB_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_TESTLIB_H_
