...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_DOT_LIB_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_DOT_LIB_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_DOT_LIB_H_
