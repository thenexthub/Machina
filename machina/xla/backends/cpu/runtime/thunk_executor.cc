...
// If XLA:CPU compiled with `-DMACHINA_MACHINA_XLA_CPU_USE_BLOCKING_THUNK_EXECUTOR` we'll run
...
#if defined(MACHINA_MACHINA_XLA_CPU_USE_BLOCKING_THUNK_EXECUTOR)
  return true;
#else
  return false;
#endif  // MACHINA_MACHINA_XLA_CPU_USE_BLOCKING_THUNK_EXECUTOR
}
