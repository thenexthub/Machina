...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
...
class FunctionLibrary {
 public:
  ...
  using Kernel = MACHINA_MACHINA_XLA_CPU_Kernel;
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
