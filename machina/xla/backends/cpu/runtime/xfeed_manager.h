...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XFEED_MANAGER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XFEED_MANAGER_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_XFEED_MANAGER_H_
