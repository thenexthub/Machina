...
#ifndef MACHINA_XLABACKENDS_CPU_TESTLIB_KERNEL_RUNNER_H_
#define MACHINA_XLABACKENDS_CPU_TESTLIB_KERNEL_RUNNER_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_TESTLIB_KERNEL_RUNNER_H_
