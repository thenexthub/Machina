...
TEST(KernelRunnerTest, Add) {
  static constexpr absl::string_view kLlvmAddI32 = R"(
        %struct.MACHINA_MACHINA_XLA_CPU_KernelCallFrame = type { ptr, ptr, i64, ptr }
        %struct.MACHINA_MACHINA_XLA_CPU_KernelArg = type { ptr, i64 }
        ; c = a + b (per thread)
        define ptr @LlvmAddI32(ptr noundef %call_frame_ptr) {
          %args_gep = getelementptr inbounds %struct.MACHINA_MACHINA_XLA_CPU_KernelCallFrame,
                          ptr %call_frame_ptr, i32 0, i32 3
          %args_ptr = load ptr, ptr %args_gep, align 8
          %arg1_gep = getelementptr inbounds %struct.MACHINA_MACHINA_XLA_CPU_KernelArg, ptr %args_ptr, i64 1
          %arg2_gep = getelementptr inbounds %struct.MACHINA_MACHINA_XLA_CPU_KernelArg, ptr %args_ptr, i64 2
          %arg0_ptr = load ptr, ptr %args_ptr, align 8
          %arg1_ptr = load ptr, ptr %arg1_gep, align 8
          %arg2_ptr = load ptr, ptr %arg2_gep, align 8
          %thread_gep = getelementptr inbounds %struct.MACHINA_MACHINA_XLA_CPU_KernelCallFrame, ptr %call_frame_ptr, i32 0, i32 1
