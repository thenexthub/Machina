...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_ERROR_MANAGER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_ERROR_MANAGER_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_ERROR_MANAGER_H_
