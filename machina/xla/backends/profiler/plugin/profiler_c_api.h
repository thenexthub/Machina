...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_PROFILER_PLUGIN_PROFILER_C_API_H_
#define MACHINA_MACHINA_XLA_BACKENDS_PROFILER_PLUGIN_PROFILER_C_API_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_PROFILER_PLUGIN_PROFILER_C_API_H_
