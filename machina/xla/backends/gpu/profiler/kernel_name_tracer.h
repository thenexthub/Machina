...
#ifndef MACHINA_XLABACKENDS_GPU_PROFILER_KERNEL_NAME_TRACER_H_
#define MACHINA_XLABACKENDS_GPU_PROFILER_KERNEL_NAME_TRACER_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_PROFILER_KERNEL_NAME_TRACER_H_
