...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_MAKE_BATCH_POINTERS_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_MAKE_BATCH_POINTERS_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_MAKE_BATCH_POINTERS_H_
