...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_CUSTOM_CALL_TARGET_H_
