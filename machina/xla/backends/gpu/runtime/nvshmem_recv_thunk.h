...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_NVSHMEM_RECV_THUNK_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_NVSHMEM_RECV_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_NVSHMEM_RECV_THUNK_H_
