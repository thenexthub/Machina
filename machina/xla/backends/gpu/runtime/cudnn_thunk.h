...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_CUDNN_THUNK_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_CUDNN_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_CUDNN_THUNK_H_
