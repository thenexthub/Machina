...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_ANNOTATION_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_ANNOTATION_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_ANNOTATION_H_
