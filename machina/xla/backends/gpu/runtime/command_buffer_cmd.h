...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
...
#include "machina/xla/runtime/object_pool.h"
...
class CustomCallCmd : public CommandBufferCmd {
 public:
  ...
  CustomCallCmd(std::string target_name, MACHINA_MACHINA_XLA_FFI_Handler* handler,
                std::vector<std::optional<Slice>> operands,
                std::vector<std::optional<Slice>> results,
 ...
 private:
  ...
  MACHINA_MACHINA_XLA_FFI_Handler* handler_ = nullptr;
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
