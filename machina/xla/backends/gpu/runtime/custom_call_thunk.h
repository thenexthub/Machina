...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_THUNK_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_THUNK_H_
...
class CustomCallThunk : public Thunk {
 public:
  ...
  std::optional<MACHINA_MACHINA_XLA_FFI_Handler_Bundle> bundle() const { return bundle_; }
 ...
 private:
  ...
  absl::Status ExecuteFfiHandler(RunId run_id, MACHINA_MACHINA_XLA_FFI_Handler* handler,
  ...
  std::optional<MACHINA_MACHINA_XLA_FFI_Handler_Bundle> bundle_;
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_CUSTOM_CALL_THUNK_H_
