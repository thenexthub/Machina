...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_SEQUENTIAL_THUNK_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_SEQUENTIAL_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_SEQUENTIAL_THUNK_H_
