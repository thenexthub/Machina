...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_SUPPORT_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_SUPPORT_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_SUPPORT_H_
