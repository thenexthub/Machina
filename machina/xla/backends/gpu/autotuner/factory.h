...
#ifndef MACHINA_XLABACKENDS_GPU_AUTOTUNER_FACTORY_H_
#define MACHINA_XLABACKENDS_GPU_AUTOTUNER_FACTORY_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_AUTOTUNER_FACTORY_H_
