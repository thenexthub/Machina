...
#ifndef MACHINA_XLABACKENDS_GPU_AUTOTUNER_CUSTOM_KERNEL_H_
#define MACHINA_XLABACKENDS_GPU_AUTOTUNER_CUSTOM_KERNEL_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_AUTOTUNER_CUSTOM_KERNEL_H_
