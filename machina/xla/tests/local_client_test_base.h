...
#ifndef MACHINA_MACHINA_XLA_TESTS_LOCAL_CLIENT_TEST_BASE_H_
#define MACHINA_MACHINA_XLA_TESTS_LOCAL_CLIENT_TEST_BASE_H_
...
#endif  // MACHINA_MACHINA_XLA_TESTS_LOCAL_CLIENT_TEST_BASE_H_
