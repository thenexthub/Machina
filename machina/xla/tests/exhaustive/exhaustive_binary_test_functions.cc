...
#include "machina/xla/hlo/builder/xla_builder.h"  // IWYU pragma: keep, exhaustive_binary_test_ops.inc
#include "machina/xla/tests/exhaustive/error_spec.h"
#include "machina/xla/tests/exhaustive/exhaustive_binary_test_definitions.h"
#include "machina/xla/tests/exhaustive/exhaustive_op_test_utils.h"
#include "machina/xla/tests/exhaustive/test_op.h"  // IWYU pragma: keep, exhaustive_binary_test_ops.inc
...
#include "machina/xla/tests/exhaustive/exhaustive_binary_test_ops.inc"
