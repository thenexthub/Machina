...
#ifndef MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_BINARY_TEST_DEFINITIONS_H_
#define MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_BINARY_TEST_DEFINITIONS_H_
...
#include "machina/xla/literal.h"  // IWYU pragma: keep, exhaustive_binary_test_definitions.inc
#include "machina/xla/tests/exhaustive/exhaustive_op_test.h"  // IWYU pragma: keep, exhaustive_binary_test_definitions.inc
#include "machina/xla/types.h"  // IWYU pragma: keep, exhaustive_binary_test_definitions.inc
#include "tsl/platform/test.h"  // IWYU pragma: keep, exhaustive_binary_test_definitions.inc

namespace xla {
namespace exhaustive_op_test {

#include "machina/xla/tests/exhaustive/exhaustive_binary_test_definitions.inc"

}  // namespace exhaustive_op_test
}  // namespace xla

#endif  // MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_BINARY_TEST_DEFINITIONS_H_
