...
#ifndef MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_OP_TEST_H_
#define MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_OP_TEST_H_

#include <cstddef>

#include "machina/xla/tests/exhaustive/exhaustive_op_test_base.h"
...
#endif  // MACHINA_XLATESTS_EXHAUSTIVE_EXHAUSTIVE_OP_TEST_H_
