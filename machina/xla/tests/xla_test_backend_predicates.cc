...
absl::string_view GetXlaTestDevice() { return GetEnvOrDie("MACHINA_MACHINA_XLA_TEST_DEVICE"); }
absl::string_view GetXlaTestDeviceType() {
  return GetEnvOrDie("MACHINA_MACHINA_XLA_TEST_DEVICE_TYPE");
}

std::vector<absl::string_view> GetXlaTestModifiers() {
  return absl::StrSplit(GetEnvOrDie("MACHINA_MACHINA_XLA_TEST_MODIFIERS"), ',');
}
}  // namespace
