...
#ifndef MACHINA_XLATESTS_HLO_PJRT_TEST_BASE_H_
#define MACHINA_XLATESTS_HLO_PJRT_TEST_BASE_H_
...
#define MACHINA_XLATEST_MIGRATED_TO_HLO_RUNNER_PJRT
#ifdef MACHINA_XLATEST_NOT_MIGRATED_TO_HLO_RUNNER_PJRT
static_assert(false,
              "HloPjRtTestBase cannot be used in the same target as a test "
              "that uses HloTestBase.");
#endif  // MACHINA_XLATEST_NOT_MIGRATED_TO_HLO_RUNNER_PJRT
...
#endif  // MACHINA_XLATESTS_HLO_PJRT_TEST_BASE_H_
