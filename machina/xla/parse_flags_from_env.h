...
#ifndef MACHINA_MACHINA_XLA_PARSE_FLAGS_FROM_ENV_H_
#define MACHINA_MACHINA_XLA_PARSE_FLAGS_FROM_ENV_H_
...
// Examples:
//
//  - TF_MACHINA_MACHINA_XLA_FLAGS="--foo=bar  --wombat='value with a space'"
//  - TF_MACHINA_MACHINA_XLA_FLAGS=/tmp/flagfile
//
...
#endif  // MACHINA_MACHINA_XLA_PARSE_FLAGS_FROM_ENV_H_
