...
#ifndef MACHINA_XLACODEGEN_TRACE_PASS_INSTRUMENTATION_H_
#define MACHINA_XLACODEGEN_TRACE_PASS_INSTRUMENTATION_H_
...
#endif  // MACHINA_XLACODEGEN_TRACE_PASS_INSTRUMENTATION_H_
