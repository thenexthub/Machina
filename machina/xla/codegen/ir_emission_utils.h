...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_IR_EMISSION_UTILS_H_
#define MACHINA_MACHINA_XLA_CODEGEN_IR_EMISSION_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_IR_EMISSION_UTILS_H_
