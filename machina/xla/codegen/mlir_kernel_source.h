...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_MLIR_KERNEL_SOURCE_H_
#define MACHINA_MACHINA_XLA_CODEGEN_MLIR_KERNEL_SOURCE_H_
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_MLIR_KERNEL_SOURCE_H_
