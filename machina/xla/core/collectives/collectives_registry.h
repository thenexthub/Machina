...
#ifndef MACHINA_MACHINA_XLA_CORE_COLLECTIVES_COLLECTIVES_REGISTRY_H_
#define MACHINA_MACHINA_XLA_CORE_COLLECTIVES_COLLECTIVES_REGISTRY_H_
...
#define MACHINA_MACHINA_XLA_COLLECTIVES_REGISTER(PLATFORM, NAME, PRIORITY, IMPL) \
  MACHINA_MACHINA_XLA_COLLECTIVES_REGISTER_(PLATFORM, NAME, PRIORITY, IMPL, __COUNTER__)
#define MACHINA_MACHINA_XLA_COLLECTIVES_REGISTER_(PLATFORM, NAME, PRIORITY, IMPL, N) \
  MACHINA_MACHINA_XLA_COLLECTIVES_REGISTER__(PLATFORM, NAME, PRIORITY, IMPL, N)
#define MACHINA_MACHINA_XLA_COLLECTIVES_REGISTER__(PLATFORM, NAME, PRIORITY, IMPL, N)         \
...
#endif  // MACHINA_MACHINA_XLA_CORE_COLLECTIVES_COLLECTIVES_REGISTRY_H_
