...
#ifndef MACHINA_XLACORE_HOST_OFFLOADING_HOST_OFFLOADING_TRANSFORMS_H_
#define MACHINA_XLACORE_HOST_OFFLOADING_HOST_OFFLOADING_TRANSFORMS_H_
...
#endif  // MACHINA_XLACORE_HOST_OFFLOADING_HOST_OFFLOADING_TRANSFORMS_H_
