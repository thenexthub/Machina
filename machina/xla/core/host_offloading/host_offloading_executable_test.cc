...
#include "machina/xla/core/host_offloading/host_offloading_pjrt_executable.h"
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kCustomCallUsingThreadPool, CustomCallUsingThreadPool,
                       xla::ffi::Ffi::Bind()
                           .Ret<ffi::BufferR0<PrimitiveType::S32>>()
                           .Ctx<xla::ffi::IntraOpThreadPool>());

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(xla::ffi::GetXlaFfiApi(), "CustomCallUsingThreadPool",
