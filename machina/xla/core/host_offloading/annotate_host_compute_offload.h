...
#ifndef MACHINA_XLACORE_HOST_OFFLOADING_ANNOTATE_HOST_COMPUTE_OFFLOAD_H_
#define MACHINA_XLACORE_HOST_OFFLOADING_ANNOTATE_HOST_COMPUTE_OFFLOAD_H_
...
#endif  // MACHINA_XLACORE_HOST_OFFLOADING_ANNOTATE_HOST_COMPUTE_OFFLOAD_H_
