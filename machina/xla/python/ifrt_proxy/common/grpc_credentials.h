...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_GRPC_CREDENTIALS_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_GRPC_CREDENTIALS_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_GRPC_CREDENTIALS_H_
