...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_PROTO_UTIL_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_PROTO_UTIL_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_PROTO_UTIL_H_
