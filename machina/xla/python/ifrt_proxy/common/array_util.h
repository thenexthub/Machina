...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_COMMON_ARRAY_UTIL_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_COMMON_ARRAY_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_COMMON_ARRAY_UTIL_H_
