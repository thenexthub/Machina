...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_REGISTRY_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_REGISTRY_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_REGISTRY_H_
