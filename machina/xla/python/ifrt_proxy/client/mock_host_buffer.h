...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MOCK_HOST_BUFFER_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MOCK_HOST_BUFFER_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MOCK_HOST_BUFFER_H_
