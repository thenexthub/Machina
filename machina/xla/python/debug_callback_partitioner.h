...
#ifndef MACHINA_XLAPYTHON_DEBUG_CALLBACK_PARTITIONER_H_
#define MACHINA_XLAPYTHON_DEBUG_CALLBACK_PARTITIONER_H_
...
#endif  // MACHINA_XLAPYTHON_DEBUG_CALLBACK_PARTITIONER_H_
