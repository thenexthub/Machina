...
#ifndef MACHINA_XLAPYTHON_CUSTOM_CALL_BATCH_PARTITIONER_H_
#define MACHINA_XLAPYTHON_CUSTOM_CALL_BATCH_PARTITIONER_H_
...
#endif  // MACHINA_XLAPYTHON_CUSTOM_CALL_BATCH_PARTITIONER_H_
