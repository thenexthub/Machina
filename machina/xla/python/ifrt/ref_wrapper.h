...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_REF_WRAPPER_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_REF_WRAPPER_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_REF_WRAPPER_H_
