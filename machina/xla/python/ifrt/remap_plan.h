...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_REMAP_PLAN_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_REMAP_PLAN_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_REMAP_PLAN_H_
