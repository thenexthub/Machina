...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_VERSION_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_VERSION_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_VERSION_H_
