...
#ifndef MACHINA_XLAPYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
#define MACHINA_XLAPYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
