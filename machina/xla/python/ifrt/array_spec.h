...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_SPEC_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_SPEC_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_SPEC_H_
