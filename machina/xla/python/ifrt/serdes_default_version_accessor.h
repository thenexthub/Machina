...
#ifndef MACHINA_XLAPYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
#define MACHINA_XLAPYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
