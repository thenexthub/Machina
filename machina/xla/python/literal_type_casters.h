...
#ifndef MACHINA_MACHINA_XLA_PYTHON_LITERAL_TYPE_CASTERS_H_
#define MACHINA_MACHINA_XLA_PYTHON_LITERAL_TYPE_CASTERS_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_LITERAL_TYPE_CASTERS_H_
