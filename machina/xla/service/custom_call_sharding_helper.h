...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_SHARDING_HELPER_H_
#define MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_SHARDING_HELPER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_SHARDING_HELPER_H__
