...
#ifndef MACHINA_MACHINA_XLA_SERVICE_ALL_GATHER_DECOMPOSER_H_
#define MACHINA_MACHINA_XLA_SERVICE_ALL_GATHER_DECOMPOSER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_ALL_GATHER_DECOMPOSER_H_
