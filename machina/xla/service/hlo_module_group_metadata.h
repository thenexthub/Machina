...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_GROUP_METADATA_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_GROUP_METADATA_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_GROUP_METADATA_H_
