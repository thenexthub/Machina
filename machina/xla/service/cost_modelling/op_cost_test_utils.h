...
#ifndef MACHINA_XLASERVICE_COST_MODELLING_OP_COST_TEST_UTILS_H_
#define MACHINA_XLASERVICE_COST_MODELLING_OP_COST_TEST_UTILS_H_
...
#endif  // MACHINA_XLASERVICE_COST_MODELLING_OP_COST_TEST_UTILS_H_
