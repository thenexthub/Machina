...
#include "machina/xla/service/while_loop_unroller.h"
...
#include "machina/xla/overflow_util.h"
...
#include "machina/xla/service/constant_value.h"
#include "machina/xla/service/hlo_creation_utils.h"
#include "machina/xla/service/hlo_cse.h"
#include "machina/xla/service/pattern_matcher.h"
#include "machina/xla/service/scheduling_annotations_util.h"
#include "machina/xla/service/value_range.h"
#include "machina/xla/service/while_loop_constant_sinking.h"
#include "machina/xla/service/while_util.h"
...
absl::StatusOr<bool> WhileLoopUnroller::Run(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3, "WhileLoopUnroller::Run(), before:\n" + module->ToString());
  bool changed = false;
  // Make sure all the necessary passes are executed before unrolling in order
  // to unroll every possible loop.
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3, "WhileLoopUnroller::Run(), after:\n" + module->ToString());
  return changed;
}
