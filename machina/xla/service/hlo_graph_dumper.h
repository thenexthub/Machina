...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
