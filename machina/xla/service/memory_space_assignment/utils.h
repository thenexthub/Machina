...
#ifndef MACHINA_MACHINA_XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_UTILS_H_
#define MACHINA_MACHINA_XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_UTILS_H_
