...
#include "machina/xla/hlo/analysis/hlo_operand_index.h"
...
#include "machina/xla/service/memory_space_assignment/memory_bound_loop_optimizer.h"
...
#include "machina/xla/service/memory_space_assignment/tuning_utils.h"
#include "machina/xla/service/memory_space_assignment/utils.h"
#include "machina/xla/service/time_utils.h"
...
absl::StatusOr<HeapSimulator::Result<HloValue>> MsaAlgorithm::Finish() {
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3, buffer_info_str_);
  VLOG(3) << "Debug allocation info: ";
  MACHINA_MACHINA_XLA_VLOG_LINES(3, allocation_info_str_);
