...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_ACL_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_ACL_H_
...
inline extern void __xla_cpu_runtime_ACLMatMulF32(
  ...
  std::cerr
      << "Attempt to call ACL MatMul runtime library without defining "
         "MACHINA_MACHINA_XLA_CPU_USE_ACL. Add --define=build_with_acl=true to build with ACL.";
  exit(1);
}
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_ACL_H_
