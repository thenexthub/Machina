...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_OPTIONS_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_OPTIONS_H_
