...
#ifndef MACHINA_XLASERVICE_CPU_CPU_LAYOUT_ASSIGNMENT_H_
#define MACHINA_XLASERVICE_CPU_CPU_LAYOUT_ASSIGNMENT_H_
...
#endif  // MACHINA_XLASERVICE_CPU_CPU_LAYOUT_ASSIGNMENT_H_
