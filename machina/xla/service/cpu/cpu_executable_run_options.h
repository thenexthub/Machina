...
#ifndef MACHINA_XLASERVICE_CPU_CPU_EXECUTABLE_RUN_OPTIONS_H_
#define MACHINA_XLASERVICE_CPU_CPU_EXECUTABLE_RUN_OPTIONS_H_
...
#endif  // MACHINA_XLASERVICE_CPU_CPU_EXECUTABLE_RUN_OPTIONS_H_
