...
#ifndef MACHINA_XLASERVICE_CPU_CPU_TRANSFER_MANAGER_H_
#define MACHINA_XLASERVICE_CPU_CPU_TRANSFER_MANAGER_H_
...
#endif  // MACHINA_XLASERVICE_CPU_CPU_TRANSFER_MANAGER_H_
