...
#ifndef MACHINA_XLASERVICE_CPU_RUNTIME_CUSTOM_CALL_STATUS_H_
#define MACHINA_XLASERVICE_CPU_RUNTIME_CUSTOM_CALL_STATUS_H_
...
#endif  // MACHINA_XLASERVICE_CPU_RUNTIME_CUSTOM_CALL_STATUS_H_
