...
#ifndef MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_PIPELINE_UNROLLER_H_
#define MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_PIPELINE_UNROLLER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_PIPELINE_UNROLLER_H_
