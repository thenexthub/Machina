...
#ifndef MACHINA_XLASERVICE_TPU_COMPUTATION_PLACER_H_
#define MACHINA_XLASERVICE_TPU_COMPUTATION_PLACER_H_
...
class TpuComputationPlacer : public xla::ComputationPlacer {
 ...
 private:
  MACHINA_XLAComputationPlacer* placer_;
};

}  // namespace tpu
}  // namespace tensorflow

#endif  // MACHINA_XLASERVICE_TPU_COMPUTATION_PLACER_H_
