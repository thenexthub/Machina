...
#include "machina/xla/service/memory_annotations.h"
...
TEST_F(CollectivePipelinerTest, TransformRecvSendBackwards) {
  ...
  EXPECT_TRUE(
      RunOptimizer(module.get(), /*last_run=*/true, 0,
                   ...
                   should_pipeline)
          .value());
  MACHINA_MACHINA_XLA_VLOG_LINES(10, module->ToString());
  auto recv1 =
...
ENTRY entry {
  ...
  EXPECT_TRUE(
      RunOptimizer(module.get(), /*last_run=*/true, 0,
                   ...
                   IsAllGather)
          .value());
  MACHINA_MACHINA_XLA_VLOG_LINES(1, "After backward pipelining:");
  MACHINA_MACHINA_XLA_VLOG_LINES(1, module->ToString());
  EXPECT_TRUE(RunOptimizer(
                  module.get(), /*last_run=*/true, 0, false, true,
                  collective_pipeliner_utils::PipeliningDirection::kForward,
                  ...
                  [](const HloInstruction* i) { return false; })
                  .value());
  MACHINA_MACHINA_XLA_VLOG_LINES(1, "After forward pipelining:");
  MACHINA_MACHINA_XLA_VLOG_LINES(1, module->ToString());
