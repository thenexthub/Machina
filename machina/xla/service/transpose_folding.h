...
#ifndef MACHINA_MACHINA_XLA_SERVICE_TRANSPOSE_FOLDING_H_
#define MACHINA_MACHINA_XLA_SERVICE_TRANSPOSE_FOLDING_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_TRANSPOSE_FOLDING_H_
