...
#ifndef MACHINA_MACHINA_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
#define MACHINA_MACHINA_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
