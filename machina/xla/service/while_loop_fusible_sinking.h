...
#ifndef MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_FUSIBLE_SINKING_H_
#define MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_FUSIBLE_SINKING_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_FUSIBLE_SINKING_H_
