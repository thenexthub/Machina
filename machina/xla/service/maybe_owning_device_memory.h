...
#ifndef MACHINA_MACHINA_XLA_SERVICE_MAYBE_OWNING_DEVICE_MEMORY_H_
#define MACHINA_MACHINA_XLA_SERVICE_MAYBE_OWNING_DEVICE_MEMORY_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_MAYBE_OWNING_DEVICE_MEMORY_H_
