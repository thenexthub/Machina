...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SPMD_PARTITION_ASSIGNMENT_H_
#define MACHINA_MACHINA_XLA_SERVICE_SPMD_PARTITION_ASSIGNMENT_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SPMD_PARTITION_ASSIGNMENT_H_
