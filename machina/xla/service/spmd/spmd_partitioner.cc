...
#include "machina/xla/service/spmd/spmd_partitioner.h"
...
#include "machina/xla/service/spmd/custom_call_handler.h"
#include "machina/xla/service/spmd/shardy/constants.h"
#include "machina/xla/service/spmd/spmd_partitioner_util.h"
...
absl::StatusOr<bool> SpmdPartitioner::Run(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(1, SpmdLogger::ReportBeforePartition(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(1, SpmdLogger::ReportAfterPartition(
                        *module, options_.report_instruction_count));
  MACHINA_MACHINA_XLA_VLOG_LINES(1, logger.MakeReport());
