...
#ifndef MACHINA_XLASERVICE_GPU_CONV_LAYOUT_NORMALIZATION_H_
#define MACHINA_XLASERVICE_GPU_CONV_LAYOUT_NORMALIZATION_H_
...
#endif  // MACHINA_XLASERVICE_GPU_CONV_LAYOUT_NORMALIZATION_H_
