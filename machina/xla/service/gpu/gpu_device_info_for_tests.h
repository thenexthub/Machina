...
#ifndef MACHINA_XLASERVICE_GPU_GPU_DEVICE_INFO_FOR_TESTS_H_
#define MACHINA_XLASERVICE_GPU_GPU_DEVICE_INFO_FOR_TESTS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_GPU_DEVICE_INFO_FOR_TESTS_H_
