...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_CUBLAS_CUDNN_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_CUBLAS_CUDNN_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_CUBLAS_CUDNN_H_
