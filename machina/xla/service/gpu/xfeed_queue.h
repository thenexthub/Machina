...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_XFEED_QUEUE_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_XFEED_QUEUE_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_XFEED_QUEUE_H_
