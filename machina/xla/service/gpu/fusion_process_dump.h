...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_FUSION_PROCESS_DUMP_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_FUSION_PROCESS_DUMP_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_FUSION_PROCESS_DUMP_H_
