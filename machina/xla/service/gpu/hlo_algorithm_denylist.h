...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_ALGORITHM_DENYLIST_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_ALGORITHM_DENYLIST_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_ALGORITHM_DENYLIST_H_
