...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_DIMENSION_SORTER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_DIMENSION_SORTER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_DIMENSION_SORTER_H_
