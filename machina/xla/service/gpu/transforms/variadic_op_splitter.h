...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_VARIADIC_OP_SPLITTER_H_
