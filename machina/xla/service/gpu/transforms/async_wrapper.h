...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_ASYNC_WRAPPER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_ASYNC_WRAPPER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_ASYNC_WRAPPER_H_
