...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
