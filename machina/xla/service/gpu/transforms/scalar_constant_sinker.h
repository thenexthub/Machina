...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
