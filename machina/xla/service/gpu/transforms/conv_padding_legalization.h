...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_CONV_PADDING_LEGALIZATION_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_CONV_PADDING_LEGALIZATION_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_CONV_PADDING_LEGALIZATION_H_
