...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_COPY_FUSION_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_COPY_FUSION_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_COPY_FUSION_H_
