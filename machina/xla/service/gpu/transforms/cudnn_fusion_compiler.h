...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_FUSION_COMPILER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_FUSION_COMPILER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_FUSION_COMPILER_H_
