...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_TRIANGULAR_SOLVE_REWRITER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_TRIANGULAR_SOLVE_REWRITER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_TRIANGULAR_SOLVE_REWRITER_H_
