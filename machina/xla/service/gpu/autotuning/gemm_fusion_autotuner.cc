...
#include "machina/xla/hlo/utils/hlo_query.h"
...
#include "machina/xla/service/gpu/autotuning/autotuner_compile_util.h"
#include "machina/xla/service/gpu/autotuning/autotuner_status_key.h"
#include "machina/xla/service/gpu/autotuning/autotuner_util.h"
#include "machina/xla/service/gpu/autotuning/dot_search_space.h"
#include "machina/xla/service/gpu/autotuning/redzone_buffers.h"
...
#include "machina/xla/service/gpu/kernels/custom_kernel_fusion.h"
#include "machina/xla/service/gpu/kernels/custom_kernel_fusion_pattern.h"
#include "machina/xla/service/gpu/matmul_utils.h"
#include "machina/xla/service/gpu/split_k_gemm_rewriter.h"
...
#include "machina/xla/service/gpu/transforms/priority_fusion.h"
#include "machina/xla/service/hlo_cost_analysis.h"
#include "machina/xla/service/hlo_graph_dumper.h"
#include "machina/xla/service/hlo_module_config.h"
#include "machina/xla/service/matmul_indexing_utils.h"
...
#include "machina/xla/stream_executor/cuda/ptx_compiler_helpers.h"
...
#include "machina/xla/stream_executor/gpu/redzone_allocator.h"
...
absl::StatusOr<bool> GemmFusionAutotuner::Run(
    HloModule* module,
    const absl::flat_hash_set<absl::string_view>& execution_threads) {
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("GEMM fusion autotuner");
