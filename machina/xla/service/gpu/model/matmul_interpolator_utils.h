...
#ifndef MACHINA_XLASERVICE_GPU_MODEL_MATMUL_INTERPOLATOR_UTILS_H_
#define MACHINA_XLASERVICE_GPU_MODEL_MATMUL_INTERPOLATOR_UTILS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_MODEL_MATMUL_INTERPOLATOR_UTILS_H_
