...
#ifndef MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_GPU_BACKEND_LIB_H_
#define MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_GPU_BACKEND_LIB_H_
...
#endif  // MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_GPU_BACKEND_LIB_H_
