...
#ifndef MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_PTX_VERSION_UTIL_H_
#define MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_PTX_VERSION_UTIL_H_
...
#endif  // MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_PTX_VERSION_UTIL_H_
