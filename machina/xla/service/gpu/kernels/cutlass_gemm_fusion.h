...
#ifndef MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_FUSION_H_
#define MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_FUSION_H_
...
#endif  // MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_FUSION_H_
