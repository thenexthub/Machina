...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_PATTERN_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_PATTERN_H_
...
#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN(PATTERN) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN_(PATTERN, __COUNTER__)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN_(PATTERN, N) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN__(PATTERN, N)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN__(PATTERN, N)         \
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_PATTERN_H_
