...
#ifndef MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_CUSTOM_KERNEL_H_
#define MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_CUSTOM_KERNEL_H_
...
#endif  // MACHINA_XLASERVICE_GPU_KERNELS_CUTLASS_GEMM_CUSTOM_KERNEL_H_
