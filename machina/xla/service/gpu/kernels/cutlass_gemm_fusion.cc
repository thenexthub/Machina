...
#include "machina/xla/service/gpu/kernels/cutlass_gemm_fusion.h"
...
#include "machina/xla/service/gpu/kernels/cutlass_gemm.h"
#include "machina/xla/service/gpu/kernels/cutlass_gemm_custom_kernel.h"
...
MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN(::xla::gpu::CutlassGemmWithUpcastPattern);
MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_PATTERN(
    ::xla::gpu::CutlassGemmWithDynamicUpdateSlicePattern);

MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION("cutlass_gemm", ::xla::gpu::CutlassGemmFusion);
MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION("cutlass_gemm_with_upcast",
                           ::xla::gpu::CutlassGemmWithUpcastFusion);
MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION("cutlass_gemm_with_dynamic_update_slice",
