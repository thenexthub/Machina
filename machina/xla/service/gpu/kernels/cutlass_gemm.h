...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUTLASS_GEMM_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUTLASS_GEMM_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUTLASS_GEMM_H_
