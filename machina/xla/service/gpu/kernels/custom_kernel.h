...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_H_
