...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_H_
...
#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION(NAME, FUSION) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_(NAME, FUSION, __COUNTER__)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION_(NAME, FUSION, N) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION__(NAME, FUSION, N)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_FUSION__(NAME, FUSION, N)                      \
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_KERNELS_CUSTOM_KERNEL_FUSION_H_
