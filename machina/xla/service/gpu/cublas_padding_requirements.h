...
#ifndef MACHINA_XLASERVICE_GPU_CUBLAS_PADDING_REQUIREMENTS_H_
#define MACHINA_XLASERVICE_GPU_CUBLAS_PADDING_REQUIREMENTS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_CUBLAS_PADDING_REQUIREMENTS_H_
