...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_CONV_RUNNER_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_CONV_RUNNER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_CONV_RUNNER_H_
