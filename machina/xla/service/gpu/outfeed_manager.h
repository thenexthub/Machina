...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_OUTFEED_MANAGER_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_OUTFEED_MANAGER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_OUTFEED_MANAGER_H_
