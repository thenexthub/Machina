...
#ifndef MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_INVARIANT_CODE_MOTION_H_
#define MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_INVARIANT_CODE_MOTION_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_WHILE_LOOP_INVARIANT_CODE_MOTION_H_
