...
#ifndef MACHINA_XLASERVICE_CUSTOM_CALL_STATUS_INTERNAL_H_
#define MACHINA_XLASERVICE_CUSTOM_CALL_STATUS_INTERNAL_H_
...
#endif  // MACHINA_XLASERVICE_CUSTOM_CALL_INTERNAL_STATUS_H_
