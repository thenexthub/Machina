...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SHAPED_BUFFER_H_
#define MACHINA_MACHINA_XLA_SERVICE_SHAPED_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SHAPED_BUFFER_H_
