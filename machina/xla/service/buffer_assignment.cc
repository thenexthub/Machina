...
#include "machina/xla/hlo/ir/hlo_op_metadata.h"
...
#include "machina/xla/service/buffer_assignment.pb.h"
...
absl::Status BufferAssigner::AssignBuffersFromHeapSimulator(
  ...
  for (const HeapSimulator::HeapResult<HloValue>& heap_result :
    ...
    MACHINA_MACHINA_XLA_VLOG_LINES(2, allocation->ToString());
...
BufferAssigner::CreateAssignment(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3, alias_analysis->ToString());
  MACHINA_MACHINA_XLA_VLOG_LINES(3, alias_analysis->dataflow_analysis().ToString());
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3,
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(2, assignment->ToString());
  assignment->ComputeSummaryStats();
  MACHINA_MACHINA_XLA_VLOG_LINES(1, assignment->StatsString(alias_info_));
