...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
#define MACHINA_MACHINA_XLA_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
