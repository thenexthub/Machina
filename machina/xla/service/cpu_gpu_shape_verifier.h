...
#ifndef MACHINA_XLASERVICE_CPU_GPU_SHAPE_VERIFIER_H_
#define MACHINA_XLASERVICE_CPU_GPU_SHAPE_VERIFIER_H_
...
#endif  // MACHINA_XLASERVICE_CPU_GPU_SHAPE_VERIFIER_H_
