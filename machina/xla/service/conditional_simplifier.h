...
#ifndef MACHINA_XLASERVICE_CONDITIONAL_SIMPLIFIER_H_
#define MACHINA_XLASERVICE_CONDITIONAL_SIMPLIFIER_H_
...
#endif  // MACHINA_XLASERVICE_CONDITIONAL_SIMPLIFIER_H_
