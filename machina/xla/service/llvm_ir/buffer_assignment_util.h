...
#ifndef MACHINA_XLASERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
#define MACHINA_XLASERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
...
#endif  // MACHINA_XLASERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
