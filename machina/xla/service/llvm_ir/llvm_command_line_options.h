...
#ifndef MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
#define MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
