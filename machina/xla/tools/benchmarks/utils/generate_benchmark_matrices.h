...
#ifndef MACHINA_XLATOOLS_BENCHMARKS_UTILS_GENERATE_BENCHMARK_MATRICES_H_
#define MACHINA_XLATOOLS_BENCHMARKS_UTILS_GENERATE_BENCHMARK_MATRICES_H_
...
#endif  // MACHINA_XLATOOLS_BENCHMARKS_UTILS_GENERATE_BENCHMARK_MATRICES_H_
