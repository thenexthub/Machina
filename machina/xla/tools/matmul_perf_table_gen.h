...
#ifndef MACHINA_MACHINA_XLA_TOOLS_MATMUL_PERF_TABLE_GEN_H_
#define MACHINA_MACHINA_XLA_TOOLS_MATMUL_PERF_TABLE_GEN_H_
...
#endif  // MACHINA_MACHINA_XLA_TOOLS_MATMUL_PERF_TABLE_GEN_H_
