...
#ifndef MACHINA_MACHINA_XLA_CLIENT_LOCAL_CLIENT_H_
#define MACHINA_MACHINA_XLA_CLIENT_LOCAL_CLIENT_H_
...
#include "machina/xla/service/local_service.h"
...
class LocalExecutable {
 ...
 private:
  ...
  // of the computation.
  //
  // The given ExecutableRunOptions override any values from TF_MACHINA_MACHINA_XLA_FLAGS
...
class LocalClient : public Client {
 public:
  ...
  //
  // The given ExecutableBuildOptions overrides any values from MACHINA_MACHINA_XLA_FLAGS
  // environment variable.
...
#endif  // MACHINA_MACHINA_XLA_CLIENT_LOCAL_CLIENT_H_
