...
#ifndef MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_CUSTOM_CALL_IMPORTER_H_
#define MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_CUSTOM_CALL_IMPORTER_H_
...
#endif  // MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_CUSTOM_CALL_IMPORTER_H_
