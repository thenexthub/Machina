...
#ifndef MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
#define MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
...
#endif  // MACHINA_XLAHLO_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
