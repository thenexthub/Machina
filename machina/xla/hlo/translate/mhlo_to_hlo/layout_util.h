...
#ifndef MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_LAYOUT_UTIL_H_
#define MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_LAYOUT_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_LAYOUT_UTIL_H_
