...
#include "machina/xla/hlo/experimental/auto_sharding/auto_sharding.pb.h"
...
#include "machina/xla/hlo/experimental/auto_sharding/iopddl.h"
...
absl::StatusOr<AutoShardingSolverOutput> SolveAndExtractSolution(
  ...
  if (VLOG_IS_ON(10)) {
    ...
    VLOG(10) << "MODEL:";
    MACHINA_MACHINA_XLA_VLOG_LINES(10, model_proto.DebugString());
    VLOG(10) << "RESPONSE:";
    MACHINA_MACHINA_XLA_VLOG_LINES(10, response.DebugString());
  }
