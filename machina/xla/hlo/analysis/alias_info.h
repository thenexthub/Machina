...
#ifndef MACHINA_MACHINA_XLA_HLO_ANALYSIS_ALIAS_INFO_H_
#define MACHINA_MACHINA_XLA_HLO_ANALYSIS_ALIAS_INFO_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_ANALYSIS_ALIAS_INFO_H_
