...
#ifndef MACHINA_XLAHLO_ANALYSIS_HLO_OPERAND_INDEX_H_
#define MACHINA_XLAHLO_ANALYSIS_HLO_OPERAND_INDEX_H_
...
#endif  // MACHINA_XLAHLO_ANALYSIS_HLO_OPERAND_INDEX_H_
