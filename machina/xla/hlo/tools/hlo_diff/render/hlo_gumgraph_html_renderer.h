...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_HLO_GUMGRAPH_HTML_RENDERER_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_HLO_GUMGRAPH_HTML_RENDERER_H_

#include <sstream>

#include "machina/xla/hlo/tools/hlo_diff/hlo_diff_result.h"
#include "machina/xla/hlo/tools/hlo_diff/hlo_diff_summary.h"
#include "machina/xla/hlo/tools/hlo_diff/render/graph_url_generator.h"
#include "machina/xla/hlo/tools/hlo_diff/render/op_metric_getter.h"
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_HLO_GUMGRAPH_HTML_RENDERER_H_
