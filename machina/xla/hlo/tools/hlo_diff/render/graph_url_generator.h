...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_GRAPH_URL_GENERATOR_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_GRAPH_URL_GENERATOR_H_
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_GRAPH_URL_GENERATOR_H_
