...
#ifndef MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_OPT_OPT_LIB_H_
#define MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_OPT_OPT_LIB_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_OPT_OPT_LIB_H_
