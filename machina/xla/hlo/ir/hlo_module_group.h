...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_HLO_MODULE_GROUP_H_
#define MACHINA_MACHINA_XLA_HLO_IR_HLO_MODULE_GROUP_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_HLO_MODULE_GROUP_H_
