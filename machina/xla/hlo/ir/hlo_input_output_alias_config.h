...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
#define MACHINA_MACHINA_XLA_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
