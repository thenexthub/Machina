...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_HLO_CASTING_UTILS_H_
#define MACHINA_MACHINA_XLA_HLO_IR_HLO_CASTING_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_HLO_CASTING_UTILS_H_
