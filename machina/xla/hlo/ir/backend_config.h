...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_BACKEND_CONFIG_H_
#define MACHINA_MACHINA_XLA_HLO_IR_BACKEND_CONFIG_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_BACKEND_CONFIG_H_
