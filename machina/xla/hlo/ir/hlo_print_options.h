...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_HLO_PRINT_OPTIONS_H_
#define MACHINA_MACHINA_XLA_HLO_IR_HLO_PRINT_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_HLO_PRINT_OPTIONS_H_
