...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_DFS_HLO_VISITOR_H_
#define MACHINA_MACHINA_XLA_HLO_IR_DFS_HLO_VISITOR_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_DFS_HLO_VISITOR_H_
