...
#ifndef MACHINA_XLAHLO_TRANSFORMS_MEMORY_SPACE_PROPAGATION_H_
#define MACHINA_XLAHLO_TRANSFORMS_MEMORY_SPACE_PROPAGATION_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_MEMORY_SPACE_PROPAGATION_H_
