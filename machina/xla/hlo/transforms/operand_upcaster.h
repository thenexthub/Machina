...
#ifndef MACHINA_XLAHLO_TRANSFORMS_OPERAND_UPCASTER_H_
#define MACHINA_XLAHLO_TRANSFORMS_OPERAND_UPCASTER_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_OPERAND_UPCASTER_H_
