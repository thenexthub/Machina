...
#ifndef MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
#define MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_RESHAPE_DECOMPOSER_H_
