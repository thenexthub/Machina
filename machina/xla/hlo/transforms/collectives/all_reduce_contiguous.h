...
#ifndef MACHINA_XLAHLO_TRANSFORMS_COLLECTIVES_ALL_REDUCE_CONTIGUOUS_H_
#define MACHINA_XLAHLO_TRANSFORMS_COLLECTIVES_ALL_REDUCE_CONTIGUOUS_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_COLLECTIVES_ALL_REDUCE_CONTIGUOUS_H_
