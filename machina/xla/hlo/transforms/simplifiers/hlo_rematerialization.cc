...
#include "machina/xla/hlo/analysis/tuple_points_to_analysis.h"
...
#include "machina/xla/hlo/transforms/simplifiers/hlo_rematerialization_data_structures.h"
...
MemoryUsageTracker::MemoryUsageTracker(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(10, ToString());
  DCHECK(Check());
}
...
absl::StatusOr<bool> HloRematerialization::Run(
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(3, "Before HloRematerialization:\n" + module->ToString());
  ...
  MACHINA_MACHINA_XLA_VLOG_LINES(5, "After HloRematerialization:\n" + module->ToString());
