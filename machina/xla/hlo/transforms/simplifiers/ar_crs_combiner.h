...
#ifndef MACHINA_MACHINA_XLA_HLO_TRANSFORMS_SIMPLIFIERS_AR_CRS_COMBINER_H_
#define MACHINA_MACHINA_XLA_HLO_TRANSFORMS_SIMPLIFIERS_AR_CRS_COMBINER_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TRANSFORMS_SIMPLIFIERS_AR_CRS_COMBINER_H_
