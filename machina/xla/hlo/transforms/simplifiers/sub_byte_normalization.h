...
#ifndef MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SUB_BYTE_NORMALIZATION_H_
#define MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SUB_BYTE_NORMALIZATION_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SUB_BYTE_NORMALIZATION_H_
