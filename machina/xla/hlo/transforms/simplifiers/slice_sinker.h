...
#ifndef MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SLICE_SINKER_H_
#define MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SLICE_SINKER_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_SLICE_SINKER_H_
