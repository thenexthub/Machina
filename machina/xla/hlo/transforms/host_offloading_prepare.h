...
#ifndef MACHINA_MACHINA_XLA_HLO_TRANSFORMS_HOST_OFFLOADING_PREPARE_H_
#define MACHINA_MACHINA_XLA_HLO_TRANSFORMS_HOST_OFFLOADING_PREPARE_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TRANSFORMS_HOST_OFFLOADING_PREPARE_H_
