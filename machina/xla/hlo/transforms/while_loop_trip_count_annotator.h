...
#ifndef MACHINA_XLAHLO_TRANSFORMS_WHILE_LOOP_TRIP_COUNT_ANNOTATOR_H_
#define MACHINA_XLAHLO_TRANSFORMS_WHILE_LOOP_TRIP_COUNT_ANNOTATOR_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_WHILE_LOOP_TRIP_COUNT_ANNOTATOR_H_
