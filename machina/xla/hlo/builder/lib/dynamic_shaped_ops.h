...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_DYNAMIC_SHAPED_OPS_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_DYNAMIC_SHAPED_OPS_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_DYNAMIC_SHAPED_OPS_H_
