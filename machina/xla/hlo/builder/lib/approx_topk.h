...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_APPROX_TOPK_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_APPROX_TOPK_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_APPROX_TOPK_H_
