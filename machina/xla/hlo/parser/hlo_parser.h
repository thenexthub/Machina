...
#ifndef MACHINA_MACHINA_XLA_HLO_PARSER_HLO_PARSER_H_
#define MACHINA_MACHINA_XLA_HLO_PARSER_HLO_PARSER_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_PARSER_HLO_PARSER_H_
