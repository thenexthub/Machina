...
#ifndef MACHINA_XLAHLO_UTILS_CONCURRENCY_TYPE_ADAPTERS_H_
#define MACHINA_XLAHLO_UTILS_CONCURRENCY_TYPE_ADAPTERS_H_
...
#endif  // MACHINA_XLAHLO_UTILS_CONCURRENCY_TYPE_ADAPTERS_H_
