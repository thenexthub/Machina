...
#ifndef MACHINA_MACHINA_XLA_PJRT_CPU_ABSTRACT_CPU_BUFFER_H_
#define MACHINA_MACHINA_XLA_PJRT_CPU_ABSTRACT_CPU_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_CPU_ABSTRACT_CPU_BUFFER_H_
