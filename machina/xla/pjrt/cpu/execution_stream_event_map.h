...
#ifndef MACHINA_XLAPJRT_CPU_EXECUTION_STREAM_EVENT_MAP_H_
#define MACHINA_XLAPJRT_CPU_EXECUTION_STREAM_EVENT_MAP_H_
...
#endif  // MACHINA_XLAPJRT_CPU_EXECUTION_STREAM_EVENT_MAP_H_
