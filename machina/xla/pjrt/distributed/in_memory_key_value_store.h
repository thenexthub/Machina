...
#ifndef MACHINA_XLAPJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
#define MACHINA_XLAPJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
...
#endif  // MACHINA_XLAPJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
