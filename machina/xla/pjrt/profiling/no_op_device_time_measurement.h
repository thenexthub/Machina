...
#ifndef MACHINA_XLAPJRT_PROFILING_NO_OP_DEVICE_TIME_MEASUREMENT_H_
#define MACHINA_XLAPJRT_PROFILING_NO_OP_DEVICE_TIME_MEASUREMENT_H_
...
#endif  // MACHINA_XLAPJRT_PROFILING_NO_OP_DEVICE_TIME_MEASUREMENT_H_
