...
#ifndef MACHINA_MACHINA_XLA_PJRT_HOST_MEMORY_SPACES_H_
#define MACHINA_MACHINA_XLA_PJRT_HOST_MEMORY_SPACES_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_HOST_MEMORY_SPACES_H_
