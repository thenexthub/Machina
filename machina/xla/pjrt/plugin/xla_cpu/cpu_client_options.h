...
#ifndef MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_CLIENT_OPTIONS_H_
#define MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_CLIENT_OPTIONS_H_
...
#endif  // MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_CLIENT_OPTIONS_H_
