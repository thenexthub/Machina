...
#ifndef MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_EXECUTE_OPTIONS_H_
#define MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_EXECUTE_OPTIONS_H_
...
#endif  // MACHINA_XLAPJRT_PLUGIN_MACHINA_XLACPU_CPU_EXECUTE_OPTIONS_H_
