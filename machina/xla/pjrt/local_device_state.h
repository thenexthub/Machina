...
#ifndef MACHINA_MACHINA_XLA_PJRT_LOCAL_DEVICE_STATE_H_
#define MACHINA_MACHINA_XLA_PJRT_LOCAL_DEVICE_STATE_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_LOCAL_DEVICE_STATE_H_
