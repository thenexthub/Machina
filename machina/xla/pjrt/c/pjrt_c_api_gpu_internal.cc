...
#include "machina/xla/backends/profiler/plugin/plugin_tracer_impl.h"
#include "machina/xla/backends/profiler/plugin/profiler_c_api.h"
#include "machina/xla/backends/profiler/plugin/profiler_error.h"
...
#include "machina/xla/pjrt/c/pjrt_c_api_custom_partitioner_extension.h"
#include "machina/xla/pjrt/c/pjrt_c_api_ffi_extension.h"
#include "machina/xla/pjrt/c/pjrt_c_api_ffi_internal.h"
#include "machina/xla/pjrt/c/pjrt_c_api_gpu_extension.h"
...
#include "machina/xla/pjrt/c/pjrt_c_api_triton_extension.h"
#include "machina/xla/pjrt/c/pjrt_c_api_triton_internal.h"
...
#include "machina/xla/python/custom_call_batch_partitioner.h"
#include "machina/xla/python/custom_partition_callback.h"
    ...
    case 1:
      xla::ffi::Ffi::RegisterStaticHandler(
          ...
          MACHINA_MACHINA_XLA_FFI_Handler_Bundle{
              reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Handler*>(args->handler_instantiate),
              reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Handler*>(args->handler_prepare),
              reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Handler*>(args->handler_initialize),
              reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Handler*>(args->handler_execute)});
      return nullptr;
    default:
