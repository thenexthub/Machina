...
#ifndef MACHINA_MACHINA_XLA_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
#define MACHINA_MACHINA_XLA_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
...
struct PJRT_FFI_Register_Handler_Args {
  ...
  void* handler;  // MACHINA_MACHINA_XLA_FFI_Handler* for typed FFI calls
...
// Only supports typed FFI handlers (MACHINA_MACHINA_XLA_FFI_Handler*).
...
#endif  // MACHINA_MACHINA_XLA_PJRT_C_PJRT_C_API_FFI_EXTENSION_H_
