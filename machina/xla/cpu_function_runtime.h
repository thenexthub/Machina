...
#ifndef MACHINA_MACHINA_XLA_CPU_FUNCTION_RUNTIME_H_
#define MACHINA_MACHINA_XLA_CPU_FUNCTION_RUNTIME_H_
...
//
// Example usage:
//   MACHINA_MACHINA_XLA_ALIGN std::array<float, 4> arg_x;
//   MACHINA_MACHINA_XLA_ALIGN float arg_y;
//   xla_instance.set_arg_data(0, arg_x.date());
//   xla_instance.set_arg_data(0, &arg_y);
#define MACHINA_MACHINA_XLA_ALIGN alignas(xla::cpu_function_runtime::Align())
...
#endif  // MACHINA_MACHINA_XLA_CPU_FUNCTION_RUNTIME_H_
