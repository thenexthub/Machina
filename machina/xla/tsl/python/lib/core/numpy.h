...
#ifndef MACHINA_XLATSL_PYTHON_LIB_CORE_NUMPY_H_
#define MACHINA_XLATSL_PYTHON_LIB_CORE_NUMPY_H_
...
#ifndef MACHINA_XLAIMPORT_NUMPY
...
#endif  // MACHINA_XLATSL_PYTHON_LIB_CORE_NUMPY_H_
