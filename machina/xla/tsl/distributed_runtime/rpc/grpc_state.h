...
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_STATE_H_
