...
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
