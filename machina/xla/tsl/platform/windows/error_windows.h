...
#ifndef MACHINA_XLATSL_PLATFORM_WINDOWS_ERROR_WINDOWS_H_
#define MACHINA_XLATSL_PLATFORM_WINDOWS_ERROR_WINDOWS_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_WINDOWS_ERROR_WINDOWS_H_
