...
#ifndef MACHINA_XLATSL_PLATFORM_DYNAMIC_ANNOTATIONS_H_
#define MACHINA_XLATSL_PLATFORM_DYNAMIC_ANNOTATIONS_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_DYNAMIC_ANNOTATIONS_H_
