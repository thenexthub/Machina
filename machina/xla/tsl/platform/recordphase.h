...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_RECORDPHASE_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_RECORDPHASE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_RECORDPHASE_H_
