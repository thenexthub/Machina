...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_GCS_THROTTLE_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_GCS_THROTTLE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_GCS_THROTTLE_H_
