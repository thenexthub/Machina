...
#ifndef MACHINA_XLA_TSL_PLATFORM_CLOUD_EXPIRING_LRU_CACHE_H_
#define MACHINA_XLA_TSL_PLATFORM_CLOUD_EXPIRING_LRU_CACHE_H_
...
#endif  // MACHINA_XLA_TSL_PLATFORM_CLOUD_EXPIRING_LRU_CACHE_H_
