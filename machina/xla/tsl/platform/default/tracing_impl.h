...
#ifndef MACHINA_XLATSL_PLATFORM_DEFAULT_TRACING_IMPL_H_
#define MACHINA_XLATSL_PLATFORM_DEFAULT_TRACING_IMPL_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_DEFAULT_TRACING_IMPL_H_
