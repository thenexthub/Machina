...
#ifndef MACHINA_XLATSL_PLATFORM_DEFAULT_CRASH_ANALYSIS_H_
#define MACHINA_XLATSL_PLATFORM_DEFAULT_CRASH_ANALYSIS_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_DEFAULT_CRASH_ANALYSIS_H_
