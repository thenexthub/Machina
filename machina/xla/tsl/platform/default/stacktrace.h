...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_STACKTRACE_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_STACKTRACE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_STACKTRACE_H_
