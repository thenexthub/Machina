...
#ifndef MACHINA_XLATSL_FRAMEWORK_DEVICE_ID_MANAGER_H_
#define MACHINA_XLATSL_FRAMEWORK_DEVICE_ID_MANAGER_H_
...
#endif  // MACHINA_XLATSL_FRAMEWORK_DEVICE_ID_MANAGER_H_
