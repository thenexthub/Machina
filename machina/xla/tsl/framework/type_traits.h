...
#ifndef MACHINA_MACHINA_XLA_TSL_FRAMEWORK_TYPE_TRAITS_H_
#define MACHINA_MACHINA_XLA_TSL_FRAMEWORK_TYPE_TRAITS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_FRAMEWORK_TYPE_TRAITS_H_
