...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_CONVERT_MACHINA_MACHINA_XLA_OP_UTILS_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_CONVERT_MACHINA_MACHINA_XLA_OP_UTILS_H_
...
inline bool IsXlaArgsOrRetvals(absl::string_view op_name) {
  return op_name == "MACHINA_MACHINA_XLA_Args" || op_name == "MACHINA_MACHINA_XLA_Retvals";
}
...
#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_CONVERT_MACHINA_MACHINA_XLA_OP_UTILS_H_
