...
#ifndef MACHINA_XLATSL_PROFILER_UTILS_BUFFER_POOL_H_
#define MACHINA_XLATSL_PROFILER_UTILS_BUFFER_POOL_H_
...
#endif  // MACHINA_XLATSL_PROFILER_UTILS_BUFFER_POOL_H_
