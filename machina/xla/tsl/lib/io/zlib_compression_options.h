...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_COMPRESSION_OPTIONS_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_COMPRESSION_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_COMPRESSION_OPTIONS_H_
