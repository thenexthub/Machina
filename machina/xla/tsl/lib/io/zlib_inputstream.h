...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_INPUTSTREAM_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_INPUTSTREAM_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_IO_ZLIB_INPUTSTREAM_H_
