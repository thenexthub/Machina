...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_IO_SNAPPY_SNAPPY_INPUTBUFFER_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_IO_SNAPPY_SNAPPY_INPUTBUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_IO_SNAPPY_SNAPPY_INPUTBUFFER_H_
