...
#ifndef MACHINA_XLATSL_LIB_IO_SNAPPY_SNAPPY_COMPRESSION_OPTIONS_H_
#define MACHINA_XLATSL_LIB_IO_SNAPPY_SNAPPY_COMPRESSION_OPTIONS_H_
...
#endif  // MACHINA_XLATSL_LIB_IO_SNAPPY_SNAPPY_COMPRESSION_OPTIONS_H_
