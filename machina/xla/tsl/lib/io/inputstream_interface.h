...
#ifndef MACHINA_XLATSL_LIB_IO_INPUTSTREAM_INTERFACE_H_
#define MACHINA_XLATSL_LIB_IO_INPUTSTREAM_INTERFACE_H_
...
#endif  // MACHINA_XLATSL_LIB_IO_INPUTSTREAM_INTERFACE_H_
