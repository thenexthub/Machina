...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MATH_MATH_UTIL_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MATH_MATH_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MATH_MATH_UTIL_H_
