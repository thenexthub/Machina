...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_DEVICE_NAME_UTILS_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_DEVICE_NAME_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_DEVICE_NAME_UTILS_H_
