...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
