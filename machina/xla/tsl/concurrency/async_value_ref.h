...
#ifndef MACHINA_MACHINA_XLA_TSL_CONCURRENCY_ASYNC_VALUE_REF_H_
#define MACHINA_MACHINA_XLA_TSL_CONCURRENCY_ASYNC_VALUE_REF_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_CONCURRENCY_ASYNC_VALUE_REF_H_
