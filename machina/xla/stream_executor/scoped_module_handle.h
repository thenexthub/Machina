...
#ifndef MACHINA_XLASTREAM_EXECUTOR_SCOPED_MODULE_HANDLE_H_
#define MACHINA_XLASTREAM_EXECUTOR_SCOPED_MODULE_HANDLE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_SCOPED_MODULE_HANDLE_H_
