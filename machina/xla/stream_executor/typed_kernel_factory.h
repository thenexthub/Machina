...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TYPED_KERNEL_FACTORY_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TYPED_KERNEL_FACTORY_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TYPED_KERNEL_FACTORY_H_
