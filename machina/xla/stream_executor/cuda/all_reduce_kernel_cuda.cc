...
#define REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, NV_TYPE,             \
...
#define REGISTER_ALL_REDUCE_KERNEL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, NV_TYPE, REDUCTION_KIND) \
  REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, NV_TYPE, REDUCTION_KIND,  \
                                  kOneShot)                                   \
  REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, NV_TYPE, REDUCTION_KIND,  \
                                  kTwoShot)
