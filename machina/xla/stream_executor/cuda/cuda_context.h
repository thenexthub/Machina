...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_CONTEXT_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_CONTEXT_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_CONTEXT_H_
