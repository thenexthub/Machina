...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
