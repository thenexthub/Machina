...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_EVENT_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_EVENT_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_EVENT_H_
