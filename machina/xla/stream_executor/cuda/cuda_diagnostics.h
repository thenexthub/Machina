...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_DIAGNOSTICS_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_DIAGNOSTICS_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_DIAGNOSTICS_H_
