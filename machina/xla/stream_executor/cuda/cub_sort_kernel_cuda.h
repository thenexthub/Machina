...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_CUB_SORT_KERNEL_CUDA_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_CUB_SORT_KERNEL_CUDA_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_CUB_SORT_KERNEL_CUDA_H_
