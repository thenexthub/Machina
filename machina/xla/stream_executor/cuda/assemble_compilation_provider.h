...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_ASSEMBLE_COMPILATION_PROVIDER_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_ASSEMBLE_COMPILATION_PROVIDER_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_ASSEMBLE_COMPILATION_PROVIDER_H_
