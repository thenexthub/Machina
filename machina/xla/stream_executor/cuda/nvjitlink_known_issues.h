...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_NVJITLINK_KNOWN_ISSUES_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_NVJITLINK_KNOWN_ISSUES_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_NVJITLINK_KNOWN_ISSUES_H_
