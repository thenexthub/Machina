...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
