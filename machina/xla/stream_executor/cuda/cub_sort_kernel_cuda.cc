...
#include "machina/xla/stream_executor/cuda/cub_sort_kernel_cuda.h"
...
#include "machina/xla/ffi/ffi_api.h"  // IWYU pragma: keep
#include "machina/xla/stream_executor/cuda/cuda_status.h"
...
#define MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(suffix, type)                                \
  MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kCubSortKeysExecute_##suffix,                        \
  ...
  MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(                                                     \
      ...
      xla::ffi::Ffi::Bind<xla::ffi::ExecutionStage::kInitialize>()            \
          ...
          .Attr<size_t>("num_items")                                          \
          .Attr<size_t>("batch_size"));                                       \
  MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(                                                   \
...
#define MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(suffix, type1, type2)                        \
  MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kCubSortPairsExecute_##suffix,                        \
...
#ifdef CUB_TYPE_BF16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(bf16, __nv_bfloat16)
#endif
#ifdef CUB_TYPE_F16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(f16, __half)
#endif
#ifdef CUB_TYPE_F32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(f32, float)
#endif
#ifdef CUB_TYPE_F64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(f64, double)
#endif

// Signed integer types.
#ifdef CUB_TYPE_S8
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(s8, int8_t)
#endif
#ifdef CUB_TYPE_S16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(s16, int16_t)
#endif
#ifdef CUB_TYPE_S32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(s32, int32_t)
#endif
#ifdef CUB_TYPE_S64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(s64, int64_t)
#endif

// Unsigned integer types.
#ifdef CUB_TYPE_U8
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(u8, uint8_t)
#endif
#ifdef CUB_TYPE_U16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(u16, uint16_t)
#endif
#ifdef CUB_TYPE_U32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(u32, uint32_t)
#endif
#ifdef CUB_TYPE_U64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_KEYS(u64, uint64_t)
#endif

// Pairs with 8-bit key.
#ifdef CUB_TYPE_U8_B16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u8_b16, uint8_t, uint16_t)
#endif
#ifdef CUB_TYPE_U8_B32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u8_b32, uint8_t, uint32_t)
#endif
#ifdef CUB_TYPE_U8_B64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u8_b64, uint8_t, uint64_t)
#endif

// Pairs with 16-bit key.
#ifdef CUB_TYPE_U16_B16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u16_b16, uint16_t, uint16_t)
#endif
#ifdef CUB_TYPE_U16_B32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u16_b32, uint16_t, uint32_t)
#endif
#ifdef CUB_TYPE_U16_B64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u16_b64, uint16_t, uint64_t)
#endif

// Pairs with 32-bit key.
#ifdef CUB_TYPE_U32_B16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u32_b16, uint32_t, uint16_t)
#endif
#ifdef CUB_TYPE_U32_B32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u32_b32, uint32_t, uint32_t)
#endif
#ifdef CUB_TYPE_U32_B64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u32_b64, uint32_t, uint64_t)
#endif
#ifdef CUB_TYPE_F32_B16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(f32_b16, float, uint16_t)
#endif
#ifdef CUB_TYPE_F32_B32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(f32_b32, float, uint32_t)
#endif
#ifdef CUB_TYPE_F32_B64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(f32_b64, float, uint64_t)
#endif

// Pairs with 64-bit key.
#ifdef CUB_TYPE_U64_B16
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u64_b16, uint64_t, uint16_t)
#endif
#ifdef CUB_TYPE_U64_B32
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u64_b32, uint64_t, uint32_t)
#endif
#ifdef CUB_TYPE_U64_B64
MACHINA_MACHINA_XLA_CUB_DEFINE_SORT_PAIRS(u64_b64, uint64_t, uint64_t)
#endif
