...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_ASM_COMPILER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_ASM_COMPILER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_ASM_COMPILER_H_
