...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
