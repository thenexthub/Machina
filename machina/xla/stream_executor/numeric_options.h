...
#ifndef MACHINA_XLASTREAM_EXECUTOR_NUMERIC_OPTIONS_H_
#define MACHINA_XLASTREAM_EXECUTOR_NUMERIC_OPTIONS_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_NUMERIC_OPTIONS_H_
