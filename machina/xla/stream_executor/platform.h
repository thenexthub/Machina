...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLATFORM_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLATFORM_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLATFORM_H_
