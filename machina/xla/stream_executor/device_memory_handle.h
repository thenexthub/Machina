...
#ifndef MACHINA_XLASTREAM_EXECUTOR_DEVICE_MEMORY_HANDLE_H_
#define MACHINA_XLASTREAM_EXECUTOR_DEVICE_MEMORY_HANDLE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_DEVICE_MEMORY_HANDLE_H_
