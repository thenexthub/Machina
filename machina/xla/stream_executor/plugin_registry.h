...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLUGIN_REGISTRY_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLUGIN_REGISTRY_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_PLUGIN_REGISTRY_H_
