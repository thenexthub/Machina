...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_LAZY_OP_RUNNER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_LAZY_OP_RUNNER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_LAZY_OP_RUNNER_H_
