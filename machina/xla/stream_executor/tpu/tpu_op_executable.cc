...
#include "machina/xla/stream_executor/tpu/c_api_conversions.h"  // IWYU pragma: keep
...
#include "machina/xla/stream_executor/tpu/tpu_executable_interface.h"
...
TpuOpExecutable::TpuOpExecutable(
    const MACHINA_MACHINA_XLA_TpuProgram* core_program,
...
absl::Status TpuOpExecutable::LoadProgramAndEnqueueToStream(
  ...
  MACHINA_MACHINA_XLA_DeviceAssignment c_dev_assign{/*bytes=*/nullptr, /*size=*/0};
