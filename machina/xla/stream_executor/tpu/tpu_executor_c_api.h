...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_C_API_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_C_API_H_
...
MACHINA_MACHINA_XLA_TransferManager* TpuTransferManager_New();
void TpuTransferManager_Free(MACHINA_MACHINA_XLA_TransferManager* manager);
SE_PlatformId TpuTransferManager_PlatformId(MACHINA_MACHINA_XLA_TransferManager* manager);
void TpuTransferManager_HostShapeToDeviceShape(MACHINA_MACHINA_XLA_TransferManager* manager,
                                               MACHINA_MACHINA_XLA_Shape* host_shape,
                                               MACHINA_MACHINA_XLA_Shape* device_shape);
void TpuTransferManager_TransferLiteralToDeviceAsync(
    MACHINA_MACHINA_XLA_TransferManager* manager, SE_Stream* stream, MACHINA_MACHINA_XLA_Literal* literal,
    MACHINA_MACHINA_XLA_ShapedBuffer* device_buffer, TF_Status* status);
void TpuTransferManager_TransferLiteralFromDevice(
    MACHINA_MACHINA_XLA_TransferManager* manager, SE_Stream* stream,
    MACHINA_MACHINA_XLA_ShapedBuffer* device_buffer, MACHINA_MACHINA_XLA_Literal* literal,
    MACHINA_MACHINA_XLA_StatusCallbackFn callback, void* ctx);
int64_t TpuTransferManager_GetByteSizeRequirement(MACHINA_MACHINA_XLA_TransferManager* manager,
                                                  MACHINA_MACHINA_XLA_Shape* shape);
void TpuTransferManager_ChooseCompactLayoutForShape(
    MACHINA_MACHINA_XLA_TransferManager* manager, MACHINA_MACHINA_XLA_Shape* host_shape, MACHINA_MACHINA_XLA_Shape* output,
    TF_Status* status);
bool TpuTransferManager_CanShapedBufferBeAccessedNow(
    MACHINA_MACHINA_XLA_TransferManager* manager, SE_StreamExecutor* executor,
    MACHINA_MACHINA_XLA_ShapedBuffer* device_buffer);
...
void TpuTransferManager_WriteSingleTupleIndexTable(
    MACHINA_MACHINA_XLA_TransferManager* manager, SE_Stream* stream,
    SE_DeviceMemoryBase* elements, size_t elements_len, MACHINA_MACHINA_XLA_Shape* shape,
    SE_DeviceMemoryBase* region, TF_Status* status);
void TpuTransferManager_GetInfeedLayout(MACHINA_MACHINA_XLA_Shape* shape,
                                        MACHINA_MACHINA_XLA_Shape* infeed_shape);
void TpuTransferManager_LinearizeToBuffers(
    MACHINA_MACHINA_XLA_TransferManager* manager, MACHINA_MACHINA_XLA_Literal* c_literal,
    MACHINA_MACHINA_XLA_Shape* c_device_shape, char*** buffers_array, int64_t** buffers_size,
...
void TpuTransferManager_TransferLiteralToInfeed(MACHINA_MACHINA_XLA_TransferManager* manager,
                                                SE_StreamExecutor* executor,
                                                MACHINA_MACHINA_XLA_Literal* c_literal,
                                                TF_Status* status);
void TpuTransferManager_TransferBuffersToInfeed(MACHINA_MACHINA_XLA_TransferManager* manager,
                                                SE_StreamExecutor* executor,
...
void TpuTransferManager_TransferLiteralFromOutfeed(
    MACHINA_MACHINA_XLA_TransferManager* manager, SE_StreamExecutor* executor,
    MACHINA_MACHINA_XLA_Shape* shape /*deprecated*/, MACHINA_MACHINA_XLA_Literal* c_literal, TF_Status* status);
void TpuTransferManager_ResetDevices(MACHINA_MACHINA_XLA_TransferManager* manager,
...
void TpuTransferManager_ReadDynamicShapes(SE_Stream* stream,
                                          MACHINA_MACHINA_XLA_ShapedBuffer* buffer,
                                          const MACHINA_MACHINA_XLA_Shape& original_shape,
                                          MACHINA_MACHINA_XLA_Shape* updated_shape,
                                          TF_Status* status);

MACHINA_MACHINA_XLA_ComputationPlacer* TpuComputationPlacer_New();
void TpuComputationPlacer_Free(MACHINA_MACHINA_XLA_ComputationPlacer* placer);
...
void TpuComputationPlacer_AssignDevices(MACHINA_MACHINA_XLA_ComputationPlacer* placer,
                                        int replica_count,
...
TFTPU_CAPI_EXPORT void TpuCompiler_RunHloPasses(
    Tpu_Compiler* compiler, MACHINA_MACHINA_XLA_HloModule* se_hlo_module,
    SE_StreamExecutor* stream_executor, SE_DeviceMemoryAllocator* allocator,
    MACHINA_MACHINA_XLA_HloModule* result, TF_Status* status);
...
TFTPU_CAPI_EXPORT void TpuCompiler_Compile(
    Tpu_Compiler* compiler, MACHINA_MACHINA_XLA_HloModuleGroup* se_hlo_module_group,
...
TFTPU_CAPI_EXPORT int64_t TpuCompiler_ShapeSize(Tpu_Compiler* compiler,
                                                MACHINA_MACHINA_XLA_Shape* c_shape);

TFTPU_CAPI_EXPORT void TpuCompiler_DefaultDeviceShapeRepresentation(
    Tpu_Compiler* compiler, MACHINA_MACHINA_XLA_Shape* host_shape, MACHINA_MACHINA_XLA_Shape* device_shape);
...
// This frees the MACHINA_MACHINA_XLA_ShapeIndex* array allocated when se_output is returned by
// TpuExecutable_ExecuteAsyncOnStream.
TFTPU_CAPI_EXPORT void TpuExecutable_FreeXlaShapeIndexArray(
    MACHINA_MACHINA_XLA_ShapeIndex* array);
...
// config's proto.
TFTPU_CAPI_EXPORT MACHINA_MACHINA_XLA_HloModule
...
TFTPU_CAPI_EXPORT void XlaShapeToTpuShapeRepresentation(
    MACHINA_MACHINA_XLA_Shape* serialized_xla_shape, int data_type, bool use_fast_memory,
    MACHINA_MACHINA_XLA_Shape* serialized_tpu_shape, TF_Status* status);

TFTPU_CAPI_EXPORT void XlaShapeToTpuPaddedShape(MACHINA_MACHINA_XLA_Shape* serialized_xla_shape,
                                                MACHINA_MACHINA_XLA_Shape* padded_shape,
                                                TF_Status* status);
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_C_API_H_
