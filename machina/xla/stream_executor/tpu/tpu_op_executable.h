...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_OP_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_OP_EXECUTABLE_H_
...
class TpuOpExecutable : public xla::TpuExecutableInterface {
 public:
  ...
  // MACHINA_MACHINA_XLA_TpuProgram.
  ...
  const MACHINA_MACHINA_XLA_TpuProgram* core_program() const { return core_program_; }
 ...
 private:
  ...
  const MACHINA_MACHINA_XLA_TpuProgram* const core_program_;
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_OP_EXECUTABLE_H_
