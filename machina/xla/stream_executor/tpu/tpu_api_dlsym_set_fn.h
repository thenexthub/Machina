...
#ifndef MACHINA_XLASTREAM_EXECUTOR_TPU_TPU_API_DLSYM_SET_FN_H_
#define MACHINA_XLASTREAM_EXECUTOR_TPU_TPU_API_DLSYM_SET_FN_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_TPU_TPU_API_DLSYM_SET_FN_H_
