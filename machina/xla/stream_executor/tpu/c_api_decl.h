...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_DECL_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_DECL_H_
...
typedef struct MACHINA_MACHINA_XLA_Tile {
  Int64List dimensions;
} MACHINA_MACHINA_XLA_Tile;

typedef struct TileList {
  union {
    MACHINA_MACHINA_XLA_Tile* heap;  // owned
    MACHINA_MACHINA_XLA_Tile inlined[TPU_C_API_MAX_INLINED];
  };
  int64_t size;
} TileList;

typedef struct MACHINA_MACHINA_XLA_Layout {
...
} MACHINA_MACHINA_XLA_Layout;

// Represents an XLA shape tree.
typedef struct MACHINA_MACHINA_XLA_Shape {
  int element_type;
  Int64List dimensions;
  BoolList dynamic_dimensions;
  struct MACHINA_MACHINA_XLA_Shape* tuple_shapes;  // owned
  int ntuple_shapes;
  bool has_layout;
  MACHINA_MACHINA_XLA_Layout layout;
} MACHINA_MACHINA_XLA_Shape;

// Represents a leaf node for a XLA shaped buffer.
typedef struct MACHINA_MACHINA_XLA_ShapedBuffer {
  MACHINA_MACHINA_XLA_Shape on_device_shape;
  int device_ordinal;

  SE_DeviceMemoryBase* bases;
  size_t count;
} MACHINA_MACHINA_XLA_ShapedBuffer;

// Represents a leaf XLA literal.
typedef struct MACHINA_MACHINA_XLA_Literal {
  char** buffers;
  size_t* sizes;
  size_t count;
  MACHINA_MACHINA_XLA_Shape shape;
} MACHINA_MACHINA_XLA_Literal;

typedef struct MACHINA_MACHINA_XLA_MaybeOwningDeviceMemoryShapeTree {
  MACHINA_MACHINA_XLA_Shape shape;
  SE_MaybeOwningDeviceMemory* buffers;
} MACHINA_MACHINA_XLA_MaybeOwningDeviceMemoryShapeTree;

typedef struct MACHINA_MACHINA_XLA_ShapeIndex {
  int64_t indices[8];
  int64_t count;
} MACHINA_MACHINA_XLA_ShapeIndex;

typedef struct SE_ExecutionInput {
  MACHINA_MACHINA_XLA_MaybeOwningDeviceMemoryShapeTree shape_tree;
  MACHINA_MACHINA_XLA_ShapeIndex* unowned_indices;
  int unowned_indices_size;
  MACHINA_MACHINA_XLA_Shape dynamic_shape;
} SE_ExecutionInput;

typedef struct SE_ExecutionOutput {
  MACHINA_MACHINA_XLA_ShapedBuffer result;
  SE_MaybeOwningDeviceMemory* to_be_released;
  int to_be_released_size;
  MACHINA_MACHINA_XLA_ShapeIndex* aliased_indices;
  int aliased_indices_size;
} SE_ExecutionOutput;

typedef struct MACHINA_MACHINA_XLA_ComputationLayout {
  int parameter_count;
  MACHINA_MACHINA_XLA_Shape* parameter_layouts;
  MACHINA_MACHINA_XLA_Shape result_layout;
} MACHINA_MACHINA_XLA_ComputationLayout;

typedef struct MACHINA_MACHINA_XLA_HloModuleConfig {
  uint64_t seed;
  int32_t launch_id;
...
typedef struct MACHINA_MACHINA_XLA_HloModuleGroup {
  TpuSerializedProto proto;
  MACHINA_MACHINA_XLA_HloModuleConfig* module_config;
} MACHINA_MACHINA_XLA_HloModuleGroup;

typedef struct MACHINA_MACHINA_XLA_HloModule {
  TpuSerializedProto proto;
  MACHINA_MACHINA_XLA_HloModuleConfig module_config;
} MACHINA_MACHINA_XLA_HloModule;

typedef struct MACHINA_MACHINA_XLA_TransferManager MACHINA_MACHINA_XLA_TransferManager;
typedef struct MACHINA_MACHINA_XLA_TpuMeshState MACHINA_MACHINA_XLA_TpuMeshState;

typedef struct MACHINA_MACHINA_XLA_ComputationPlacer MACHINA_MACHINA_XLA_ComputationPlacer;

typedef void (*MACHINA_MACHINA_XLA_CallbackFn)(void*);
typedef void (*MACHINA_MACHINA_XLA_StatusCallbackFn)(void*, TF_Status*);
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_DECL_H_
