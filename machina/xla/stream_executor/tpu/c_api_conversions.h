...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_CONVERSIONS_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_CONVERSIONS_H_
...
void ToC(const xla::Tile& xla_tile, MACHINA_MACHINA_XLA_Tile* c_tile);
void Destroy(MACHINA_MACHINA_XLA_Tile* c_tile);

// xla::Layout
xla::Layout FromC(const MACHINA_MACHINA_XLA_Layout* c_layout);
void ToC(const xla::Layout& xla_layout, MACHINA_MACHINA_XLA_Layout* c_layout);
...
void Destroy(MACHINA_MACHINA_XLA_ShapeIndex*);
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_C_API_CONVERSIONS_H_
