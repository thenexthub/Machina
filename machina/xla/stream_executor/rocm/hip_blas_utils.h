...
#ifndef MACHINA_XLASTREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
#define MACHINA_XLASTREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_ROCM_HIP_BLAS_UTILS_H_
