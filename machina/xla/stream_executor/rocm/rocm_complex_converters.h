...
#ifndef MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_COMPLEX_CONVERTERS_H_
#define MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_COMPLEX_CONVERTERS_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_COMPLEX_CONVERTERS_H_
