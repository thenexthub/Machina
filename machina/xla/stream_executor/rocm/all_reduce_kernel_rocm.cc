...
#include "machina/xla/stream_executor/gpu/all_reduce_kernel.h"
#include "machina/xla/stream_executor/gpu/all_reduce_kernel_lib.cu.h"
#include "machina/xla/stream_executor/gpu/gpu_kernel_registry.h"
...
#define REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, HIP_TYPE,          \
                                        REDUCTION_KIND, STRATEGY)            \
  GPU_KERNEL_REGISTRY_REGISTER_KERNEL_STATICALLY(                            \
      AllReduceKernelRocm##SUFFIX##STRATEGY,                                 \
      SINGLE_ARG(stream_executor::gpu::AllReduceKernel<                      \
                 MACHINA_MACHINA_XLA_TYPE, xla::ReductionKind::REDUCTION_KIND,               \
...
#define REGISTER_ALL_REDUCE_KERNEL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, HIP_TYPE, REDUCTION_KIND) \
  REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, HIP_TYPE, REDUCTION_KIND,  \
                                  kOneShot)                                    \
  REGISTER_ALL_REDUCE_KERNEL_IMPL(SUFFIX, MACHINA_MACHINA_XLA_TYPE, HIP_TYPE, REDUCTION_KIND,  \
                                  kTwoShot)
