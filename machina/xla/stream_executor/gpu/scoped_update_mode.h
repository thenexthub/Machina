...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_UPDATE_MODE_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_UPDATE_MODE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_UPDATE_MODE_H_
