...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_ASM_COMPILER_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_ASM_COMPILER_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_ASM_COMPILER_H_
