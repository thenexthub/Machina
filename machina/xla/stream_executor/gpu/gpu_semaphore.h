...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_SEMAPHORE_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_SEMAPHORE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_SEMAPHORE_H_
