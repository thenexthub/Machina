...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_STREAM_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_STREAM_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_STREAM_H_
