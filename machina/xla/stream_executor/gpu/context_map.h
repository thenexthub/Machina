...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_CONTEXT_MAP_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_CONTEXT_MAP_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_CONTEXT_MAP_H_
