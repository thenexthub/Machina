...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
