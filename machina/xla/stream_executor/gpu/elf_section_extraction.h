...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_ELF_SECTION_EXTRACTION_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_ELF_SECTION_EXTRACTION_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_ELF_SECTION_EXTRACTION_H_
