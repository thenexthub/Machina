...
#ifndef MACHINA_MACHINA_XLA_MLIR_UTILS_ERROR_UTIL_H_
#define MACHINA_MACHINA_XLA_MLIR_UTILS_ERROR_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_MLIR_UTILS_ERROR_UTIL_H_
