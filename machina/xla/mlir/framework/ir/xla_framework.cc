...
#include "machina/xla/mlir/framework/ir/xla_framework_dialect.cc.inc"
#define GET_TYPEDEF_CLASSES
#include "machina/xla/mlir/framework/ir/xla_framework_types.cc.inc"
...
void XLAFrameworkDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "machina/xla/mlir/framework/ir/xla_framework.cc.inc"
#undef GET_OP_LIST
      >();
