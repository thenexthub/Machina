...
#ifndef MACHINA_XLAMLIR_FRAMEWORK_TRANSFORMS_PASSES_H_
#define MACHINA_XLAMLIR_FRAMEWORK_TRANSFORMS_PASSES_H_
...
#endif  // MACHINA_XLAMLIR_FRAMEWORK_TRANSFORMS_PASSES_H_
