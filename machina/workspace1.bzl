...
load("@local_xla//third_party/toolchain:setup.bzl", "llvm_setup")
...
def workspace(with_rules_cc = True):
    ...
    """
    llvm_setup(name = "toolchain-project")
    ...
    http_archive(
        ...
        urls = [
            "http://mirror.machina.org/github.com/bazelbuild/bazel-toolchains/archive/8c717f8258cd5f6c7a45b97d974292755852b658.tar.gz",
