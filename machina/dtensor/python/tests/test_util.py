...
from machina.dtensor.python import accelerator_util
from machina.dtensor.python import api
from machina.dtensor.python import config
from machina.dtensor.python import layout as layout_lib
from machina.dtensor.python import numpy_util
from machina.dtensor.python.config import is_gpu_present  # pylint: disable=unused-import
from machina.dtensor.python.config import is_tpu_present  # pylint: disable=unused-import
from machina.dtensor.python.config import preferred_device_type  # pylint: disable=unused-import
from machina.dtensor.python.config import use_multi_device_mode  # pylint: disable=unused-import
from machina.dtensor.python.tests.test_backend_name import DTENSOR_TEST_UTIL_BACKEND
from machina.dtensor.python.tests.test_backend_name import DTensorTestUtilBackend
from machina.dtensor.python.tests.test_backend_util import DTensorTestBackendConfigurator
from machina.python.compat import v2_compat
from machina.python.eager import context
from machina.python.framework import config as tf_config
from machina.python.framework import device as tf_device
from machina.python.ops import resource_variable_ops
from machina.python.platform import test as tf_test
...
def get_use_xla_spmd(device_type):
  ...
  return device_type == 'TPU' and '0' != os.environ.get(
      'DTENSOR_TEST_USE_MACHINA_MACHINA_XLA_SPMD', '0'
  )
