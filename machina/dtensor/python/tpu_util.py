...
from machina.dtensor.python import dtensor_device
...
def _build_all_reduce_ring(core_locations: List[_CoreLocation],
  ...
  This is ported from the C++ machina::BuildAllReduceRing function,
...
def create_tpu_mesh(
    ...
    use_xla_spmd: bool = layout_lib.USE_MACHINA_MACHINA_XLA_SPMD) -> layout_lib.Mesh:
