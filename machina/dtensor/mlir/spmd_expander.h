...
#ifndef MACHINA_DTENSOR_MLIR_SPMD_EXPANDER_H_
#define MACHINA_DTENSOR_MLIR_SPMD_EXPANDER_H_
...
class SPMDExpanderBase {
 public:
  ...
  virtual StatusOr<toolchain::DenseMap<int, Layout>> ComputeLayoutForward(
  ...
  virtual StatusOr<toolchain::DenseMap<int, Layout>> ComputeLayoutBackward(
...
#define REGISTER_SPMD_BY_OP_NAME(expander_name, op_name, prop, ...)     \
  static ::machina::InitOnStartupMarker const spmd_##expander_name = \
      InitOnStartupMarker{}                                             \
      << dtensor::SPMDExpanderRegistry::Global()->RegisterPropagateFn(  \
...
#endif  // MACHINA_DTENSOR_MLIR_SPMD_EXPANDER_H_
