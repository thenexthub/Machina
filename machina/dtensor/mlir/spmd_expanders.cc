...
#include "machina/dtensor/mlir/expansions/argmax_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/concat_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/dataparallel_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/einsum_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/elementwise_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/expanddims_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/fft_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/fill_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/gather_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/matmul_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/optional_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/qr_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/random_op_spmd_expander.h"
...
#include "machina/dtensor/mlir/expansions/resource_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/save_restore_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/scatter_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/segmentation_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/slice_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/softmax_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/sparse_to_dense_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/split_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/squeeze_spmd_expander.h"
#include "machina/dtensor/mlir/expansions/strided_slice_spmd_expander.h"
...
REGISTER_SPMD(StatelessTruncatedNormal, TF::StatelessTruncatedNormalOp,
              RandomOpSPMDExpander);
// LINT.ThenChange(//machina/dtensor/cc/small_constant_optimization.cc)
// Random V2 ops
...
REGISTER_SPMD(DepthwiseConv2dNative, TF::DepthwiseConv2dNativeOp,
              DataparallelSPMDExpander, toolchain::DenseMap<int, int>{{0, 3}},
              toolchain::DenseMap<int, int>{{0, 3}});
...
REGISTER_SPMD(MaxPoolGradGrad, TF::MaxPoolGradGradOp, DataparallelSPMDExpander,
              toolchain::DenseMap<int, int>{{0, 3}, {1, 3}, {2, 3}},
              toolchain::DenseMap<int, int>{{0, 3}});
REGISTER_SPMD(ResizeBilinearGrad, TF::ResizeBilinearGradOp,
              DataparallelSPMDExpander,
              toolchain::DenseMap<int, int>{{0, 3}, {1, 3}},
              toolchain::DenseMap<int, int>{{0, 3}});
