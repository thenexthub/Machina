...
#include "machina/dtensor/mlir/expansions/conv_spmd_expander.h"
...
absl::Status VerifyConvLayout(const Layout& input_layout,
  ...
  const int num_non_default_dilations =
      toolchain::count_if(conv_op.getDilations(), [](mlir::Attribute dilation) {
  ...
  const int num_non_default_strides =
      toolchain::count_if(conv_op.getStrides(), [](mlir::Attribute stride) {
  ...
  toolchain::ArrayRef<int64_t> filter_shape = filter_type.getShape();
...
mlir::Value PadInputOnUnshardedDim(mlir::OpBuilder& builder,
  ...
  toolchain::SmallVector<int64_t, 4> paddings_flat_vec(paddings_flat_length, 0);
  ...
  toolchain::SmallVector<int64_t, 4> paddings_shape(input_tensor_shape.begin(),
...
StatusOr<mlir::Operation*> HandleConv(ConvOp conv_op) {
  ...
  toolchain::StringRef format = conv_op.getDataFormat();
  toolchain::StringRef padding = conv_op.getPadding();
  ...
  for (int curr_input_dim = begin_input_dim; curr_input_dim <= end_input_dim;
    ...
    if (padding == "SAME") {
      ...
      toolchain::SmallVector<int32_t, 4> halo_sizes(input_layout.rank(), 0);
      halo_sizes[curr_input_dim] = halo_size;
      mlir::Value halo_sizes_const = IntConst(builder, location, halo_sizes);

      toolchain::SmallVector<int32_t, 4> halo_increments(input_layout.rank(), 0);
      ...
      toolchain::SmallVector<int64_t, 4> slice_size(input_shape.begin(),
                                               input_shape.end());
...
StatusOr<mlir::Operation*> HandleConvBackpropInput(
  ...
  toolchain::SmallVector<int64_t, 4> global_shape;
  ...
  mlir::Value new_const = IntConst(
      ...
      toolchain::SmallVector<int32_t, 4>(local_shape.begin(), local_shape.end()));
...
StatusOr<mlir::Operation*> HandleConvBackpropInputTensor(
  ...
  TF_ASSIGN_OR_RETURN(toolchain::SmallVector<int64_t> local_shape,
  ...
  mlir::Value global_input_shape = IntConst(
      builder, conv_op->getLoc(),
      toolchain::SmallVector<int32_t, 4>(global_shape.begin(), global_shape.end()));
...
StatusOr<mlir::Operation*> HandleConvBackpropFilterTensor(
  ...
  TF_ASSIGN_OR_RETURN(toolchain::SmallVector<int64_t> global_filter_shape,
                      GetTFShapeFromType(conv_op.getFilter().getType()));

  mlir::OpBuilder builder(conv_op);
  mlir::Value global_filter_shape_const =
      IntConst(builder, conv_op->getLoc(),
               toolchain::SmallVector<int32_t, 4>(global_filter_shape.begin(),
...
StatusOr<mlir::Operation*> ConvSPMDExpander::ExpandOp(mlir::Operation* op) {
  ...
  // Forward prop ops.
  if (toolchain::isa<mlir::TF::Conv2DOp>(op))
    return HandleConv<>(toolchain::cast<mlir::TF::Conv2DOp>(op));
  if (toolchain::isa<mlir::TF::Conv3DOp>(op))
    return HandleConv<>(toolchain::cast<mlir::TF::Conv3DOp>(op));

  // Backward prop input ops.
  if (toolchain::isa<mlir::TF::Conv2DBackpropInputOp>(op))
    return HandleConvBackpropInput<>(
        *output_layout, toolchain::cast<mlir::TF::Conv2DBackpropInputOp>(op));
  if (auto conv_op = toolchain::dyn_cast<mlir::TF::Conv2DBackpropInputV2Op>(op))
    return HandleConvBackpropInputTensor<mlir::TF::Conv2DBackpropInputOp>(
        *output_layout, conv_op);
  if (auto conv_op = toolchain::dyn_cast<mlir::TF::Conv3DBackpropInputOp>(op))
    return HandleConvBackpropInputTensor<mlir::TF::Conv3DBackpropInputV2Op>(
        *output_layout, conv_op);
  if (toolchain::isa<mlir::TF::Conv3DBackpropInputV2Op>(op))
    return HandleConvBackpropInput<>(
        *output_layout, toolchain::cast<mlir::TF::Conv3DBackpropInputV2Op>(op));

  // Backward prop filter ops.
  if (toolchain::isa<mlir::TF::Conv2DBackpropFilterOp>(op))
    return HandleConvBackpropFilter<>(
        *output_layout, toolchain::cast<mlir::TF::Conv2DBackpropFilterOp>(op));
  if (auto conv_op = toolchain::dyn_cast<mlir::TF::Conv2DBackpropFilterV2Op>(op))
    return HandleConvBackpropFilterTensor<mlir::TF::Conv2DBackpropFilterOp>(
        *output_layout, conv_op);
  if (auto conv_op = toolchain::dyn_cast<mlir::TF::Conv3DBackpropFilterOp>(op))
    return HandleConvBackpropFilterTensor<mlir::TF::Conv3DBackpropFilterV2Op>(
        *output_layout, conv_op);
  if (toolchain::isa<mlir::TF::Conv3DBackpropFilterV2Op>(op))
    return HandleConvBackpropFilter<>(
        *output_layout, toolchain::cast<mlir::TF::Conv3DBackpropFilterV2Op>(op));
...
StatusOr<toolchain::DenseMap<int, Layout>> ConvSPMDExpander::ComputeLayoutForward(
  ...
  if (toolchain::isa<mlir::TF::Conv2DOp, mlir::TF::Conv3DOp, mlir::TF::MaxPoolOp,
    ...
    if (input_layouts.find(0) != input_layouts.end()) {
      ...
      // whatever is present.
      if (toolchain::isa<mlir::TF::MaxPoolGradOp>(op)) {
  ...
  } else if (toolchain::isa<mlir::TF::Conv2DBackpropInputOp,
                       mlir::TF::Conv2DBackpropInputV2Op,
                       mlir::TF::Conv3DBackpropInputOp,
                       mlir::TF::Conv3DBackpropInputV2Op>(op)) {
    if (toolchain::isa<mlir::TF::Conv2DBackpropInputOp,
                  mlir::TF::Conv3DBackpropInputV2Op>(op)) {
  ...
  } else if (toolchain::isa<mlir::TF::Conv2DBackpropFilterOp,
                       mlir::TF::Conv2DBackpropFilterV2Op,
                       mlir::TF::Conv3DBackpropFilterOp,
                       mlir::TF::Conv3DBackpropFilterV2Op>(op)) {
    if (toolchain::isa<mlir::TF::Conv2DBackpropFilterOp,
                  mlir::TF::Conv3DBackpropFilterV2Op>(op)) {
...
StatusOr<toolchain::DenseMap<int, Layout>> ConvSPMDExpander::ComputeLayoutBackward(
  ...
  if (toolchain::isa<mlir::TF::Conv2DOp, mlir::TF::Conv3DOp, mlir::TF::MaxPoolOp,
    ...
    if (output_layouts.find(0) != output_layouts.end()) {
      ...
      if (toolchain::isa<mlir::TF::Conv2DOp, mlir::TF::Conv3DOp>(op)) {
        input_layouts[1] =
    ...
    if (output_layouts.find(0) != output_layouts.end()) {
      ...
      if (toolchain::isa<mlir::TF::Conv2DBackpropInputV2Op,
