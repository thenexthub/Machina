...
StatusOr<mlir::Operation*> ExpandDimsExpander::ExpandOp(mlir::Operation* op) {
  ...
  TF_ASSIGN_OR_RETURN(
      toolchain::ArrayRef<int64_t> global_output_shape,
...
StatusOr<toolchain::DenseMap<int, Layout>> ExpandDimsExpander::ComputeLayoutForward(
...
StatusOr<toolchain::DenseMap<int, Layout>> ExpandDimsExpander::ComputeLayoutBackward(
