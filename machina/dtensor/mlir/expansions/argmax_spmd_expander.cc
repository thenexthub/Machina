...
StatusOr<Layout> ComputeResultLayout(mlir::Operation* op,
  ...
  auto argmax_op = toolchain::cast<mlir::TF::ArgMaxOp>(op);
...
StatusOr<toolchain::DenseMap<int, Layout>> ArgMaxSPMDExpander::ComputeLayoutForward(
...
StatusOr<toolchain::DenseMap<int, Layout>> ArgMaxSPMDExpander::ComputeLayoutBackward(
