...
#ifndef MACHINA_DTENSOR_CC_SLICE_UTIL_H_
#define MACHINA_DTENSOR_CC_SLICE_UTIL_H_
...
class ForwardLayoutInference : public TokenProcessor {
 public:
  ForwardLayoutInference(const Layout& input_layout,
                         const toolchain::ArrayRef<int64_t> input_shape)
 ...
 private:
  ...
  const toolchain::ArrayRef<int64_t> input_shape_;
...
#endif  // MACHINA_DTENSOR_CC_SLICE_UTIL_H_
