...
#ifndef MACHINA_DTENSOR_CC_TENSOR_WITH_LAYOUT_H_
#define MACHINA_DTENSOR_CC_TENSOR_WITH_LAYOUT_H_
...
class TensorWithLayout
    : public toolchain::RTTIExtends<TensorWithLayout, toolchain::RTTIRoot> {
 public:
  ...
  virtual void EncodeAttributes(machina::NodeDefBuilder& builder) const = 0;

  // Generates a key which can be used for SPMD lowering.
  virtual machina::Fprint128 CacheKey() const = 0;
...
#endif  // MACHINA_DTENSOR_CC_TENSOR_WITH_LAYOUT_H_
