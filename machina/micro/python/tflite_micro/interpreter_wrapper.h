 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_TOOLS_PYTHON_INTERPRETER_WRAPPER_H_
#define MACHINA_LITE_MICRO_TOOLS_PYTHON_INTERPRETER_WRAPPER_H_
...
#endif  // MACHINA_LITE_MICRO_TOOLS_PYTHON_INTERPRETER_WRAPPER_H_
