...
#ifndef MACHINA_LITE_MICRO_PYTHON_COMPRESSION_UTILS_H_
#define MACHINA_LITE_MICRO_PYTHON_COMPRESSION_UTILS_H_
...
#endif  // MACHINA_LITE_MICRO_PYTHON_COMPRESSION_UTILS_H_