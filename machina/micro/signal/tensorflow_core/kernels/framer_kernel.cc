...
class FramerOp : public machina::OpKernel {
 public:
  explicit FramerOp(machina::OpKernelConstruction* context)
...
REGISTER_KERNEL_BUILDER(Name("SignalFramer").Device(machina::DEVICE_CPU),
                        FramerOp);
