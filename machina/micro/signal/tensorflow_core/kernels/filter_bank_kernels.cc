...
class FilterBankOp : public machina::OpKernel {
 public:
  explicit FilterBankOp(machina::OpKernelConstruction* context)
...
class FilterBankSquareRootOp : public machina::OpKernel {
 public:
  explicit FilterBankSquareRootOp(machina::OpKernelConstruction* context)
      : machina::OpKernel(context) {}
...
class FilterBankSpectralSubtractionOp : public machina::OpKernel {
 public:
...
class FilterBankLogOp : public machina::OpKernel {
 public:
  explicit FilterBankLogOp(machina::OpKernelConstruction* context)
      : machina::OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("SignalFilterBank").Device(machina::DEVICE_CPU),
                        FilterBankOp);
REGISTER_KERNEL_BUILDER(
    Name("SignalFilterBankSquareRoot").Device(machina::DEVICE_CPU),
    FilterBankSquareRootOp);
REGISTER_KERNEL_BUILDER(
    Name("SignalFilterBankSpectralSubtraction").Device(machina::DEVICE_CPU),
    FilterBankSpectralSubtractionOp);
REGISTER_KERNEL_BUILDER(
    Name("SignalFilterBankLog").Device(machina::DEVICE_CPU),
    FilterBankLogOp);
