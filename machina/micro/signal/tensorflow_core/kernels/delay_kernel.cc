...
class DelayOp : public machina::OpKernel {
 public:
  explicit DelayOp(machina::OpKernelConstruction* context)
...
REGISTER_KERNEL_BUILDER(Name("SignalDelay").Device(machina::DEVICE_CPU),
                        DelayOp);
