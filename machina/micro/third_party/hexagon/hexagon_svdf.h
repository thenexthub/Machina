 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_KERNELS_HEXAGON_HEXAGON_SVDF_H_
#define MACHINA_LITE_MICRO_KERNELS_HEXAGON_HEXAGON_SVDF_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_HEXAGON_HEXAGON_SVDF_H_
