...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/bazelbuild/bazel-skylib/releases/download/0.9.0/bazel_skylib-0.9.0.tar.gz",
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/google/gemmlowp/archive/fda83bdc38b118cc6b56753bd540caa49e570745.zip",
