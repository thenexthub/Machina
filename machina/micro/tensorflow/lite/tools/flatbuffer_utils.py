...
Refer to the machina lite flatbuffer schema here:
machina/lite/schema/schema.fbs
"""
...
from tflite_micro.machina.lite.python import schema_util
...
def strip_strings(model):
  ...
  (find strings by searching ":string" in the machina lite flatbuffer schema)
  1. Model description
  2. SubGraph name
  3. Tensor names
