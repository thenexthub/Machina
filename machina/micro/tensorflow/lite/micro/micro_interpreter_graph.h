...
#ifndef MACHINA_LITE_MICRO_MICRO_INTERPRETER_GRAPH_H_
#define MACHINA_LITE_MICRO_MICRO_INTERPRETER_GRAPH_H_
...
#endif  // MACHINA_LITE_MICRO_MICRO_INTERPRETER_GRAPH_H_
