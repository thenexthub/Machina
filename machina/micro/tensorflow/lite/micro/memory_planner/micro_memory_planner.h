...
#ifndef MACHINA_LITE_MICRO_MICRO_MEMORY_PLANNER_MEMORY_PLANNER_H_
#define MACHINA_LITE_MICRO_MICRO_MEMORY_PLANNER_MEMORY_PLANNER_H_
...
#endif  // MACHINA_LITE_MICRO_MICRO_MEMORY_PLANNER_MEMORY_PLANNER_H_
