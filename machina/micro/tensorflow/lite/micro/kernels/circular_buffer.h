...
#ifndef MACHINA_LITE_MICRO_KERNELS_CIRCULAR_BUFFER_H_
#define MACHINA_LITE_MICRO_KERNELS_CIRCULAR_BUFFER_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_CIRCULAR_BUFFER_H_
