...
#ifndef MACHINA_LITE_MICRO_KERNELS_DEPTHWISE_CONV_H_
#define MACHINA_LITE_MICRO_KERNELS_DEPTHWISE_CONV_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_DEPTHWISE_CONV_H_
