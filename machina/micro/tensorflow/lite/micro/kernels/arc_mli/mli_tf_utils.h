...
#ifndef MACHINA_LITE_MICRO_KERNELS_ARC_MLI_TF_UTILS_H_
#define MACHINA_LITE_MICRO_KERNELS_ARC_MLI_TF_UTILS_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_ARC_MLI_TF_UTILS_H_
