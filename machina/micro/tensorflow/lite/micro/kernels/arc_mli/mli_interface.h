...
#ifndef MACHINA_LITE_MICRO_KERNELS_ARC_MLI_INTERFACE_H_
#define MACHINA_LITE_MICRO_KERNELS_ARC_MLI_INTERFACE_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_ARC_MLI_SLICERS_H_
