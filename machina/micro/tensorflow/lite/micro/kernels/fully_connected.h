 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_KERNELS_FULLY_CONNECTED_H_
#define MACHINA_LITE_MICRO_KERNELS_FULLY_CONNECTED_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_FULLY_CONNECTED_H_
