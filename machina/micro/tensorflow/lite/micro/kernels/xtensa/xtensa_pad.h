 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_PAD_H_
#define MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_PAD_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_PAD_H_
