...
#ifndef MACHINA_LITE_MICRO_KERNELS_LSTM_EVAL_GENERAL_H_
#define MACHINA_LITE_MICRO_KERNELS_LSTM_EVAL_GENERAL_H_
#include <algorithm>
#include <cstdint>
...
#endif  // MACHINA_LITE_MICRO_KERNELS_LSTM_EVAL_16ACT_H_
