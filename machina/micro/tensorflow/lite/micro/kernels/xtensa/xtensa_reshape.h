 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_RESHAPE_H_
#define MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_RESHAPE_H_
...
#endif  // MACHINA_LITE_MICRO_KERNELS_XTENSA_XTENSA_RESHAPE_H_
