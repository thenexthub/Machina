...
#ifndef MACHINA_LITE_MICRO_KERNELS_CEVA_CEVA_TFLM_LIB_H_
#define MACHINA_LITE_MICRO_KERNELS_CEVA_CEVA_TFLM_LIB_H_

#include "machina/lite/micro/kernels/ceva/types.h"
...
#endif  // MACHINA_LITE_MICRO_KERNELS_CEVA_CEVA_TFLM_LIB_H_
