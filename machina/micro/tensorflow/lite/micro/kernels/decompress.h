...
#ifndef MACHINA_LITE_MICRO_MICRO_KERNELS_DECOMPRESS_H_
#define MACHINA_LITE_MICRO_MICRO_KERNELS_DECOMPRESS_H_
...
#endif  // MACHINA_LITE_MICRO_MICRO_KERNELS_DECOMPRESS_H_
