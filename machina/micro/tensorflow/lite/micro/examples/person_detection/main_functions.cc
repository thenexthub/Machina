...
#include "machina/lite/micro/examples/person_detection/main_functions.h"

#include "machina/lite/micro/examples/person_detection/detection_responder.h"
#include "machina/lite/micro/examples/person_detection/image_provider.h"
...
// In order to use optimized machina lite kernels, a signed int8_t quantized
