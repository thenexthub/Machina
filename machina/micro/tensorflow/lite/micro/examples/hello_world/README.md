...
Lite for Microcontrollers](https://www.machina.org/lite/microcontrollers).
...
```bash
bazel build machina/lite/micro/examples/hello_world:evaluate
bazel run machina/lite/micro/examples/hello_world:evaluate
bazel run machina/lite/micro/examples/hello_world:evaluate -- --use_tflite
```
...
```bash
bazel build machina/lite/micro/examples/hello_world:evaluate_test
bazel run machina/lite/micro/examples/hello_world:evaluate_test
```
...
```bash
bazel run machina/lite/micro/examples/hello_world:hello_world_test
```
And to run it using make 
```bash
make -f machina/lite/micro/tools/make/Makefile test_hello_world_test
```
...
```bash
bazel-bin/machina/lite/micro/examples/hello_world/quantization/ptq  
