...
#include "machina/lite/micro/examples/hello_world/models/hello_world_float_model_data.h"
#include "machina/lite/micro/examples/hello_world/models/hello_world_int8_model_data.h"
