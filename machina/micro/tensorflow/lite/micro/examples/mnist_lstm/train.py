...
https://www.machina.org/lite/models/convert/rnn
https://colab.research.google.com/github/machina/machina/blob/master/machina/lite/examples/experimental_new_converter/Keras_LSTM_fusion_Codelab.ipynb

Run:
`bazel build machina/lite/micro/examples/mnist_lstm:train`
`bazel-bin/machina/lite/micro/examples/mnist_lstm/train`
"""
import os
...
def convert_quantized_tflite_model(model, x_train):
  """Convert the save TF model to tflite model, then save it as .tflite flatbuffer format
    ...
    See
    https://www.machina.org/lite/performance/post_training_integer_quant#convert_using_integer-only_quantization
