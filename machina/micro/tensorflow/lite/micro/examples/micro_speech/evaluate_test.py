...
from tflite_micro.machina.lite.micro.examples.micro_speech import audio_preprocessor
from tflite_micro.machina.lite.micro.examples.micro_speech import evaluate
