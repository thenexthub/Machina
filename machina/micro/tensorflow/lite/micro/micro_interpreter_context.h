...
#ifndef MACHINA_LITE_MICRO_MICRO_INTERPRETER_CONTEXT_H_
#define MACHINA_LITE_MICRO_MICRO_INTERPRETER_CONTEXT_H_
...
#endif  // MACHINA_LITE_MICRO_MICRO_INTERPRETER_CONTEXT_H_
