...
1.  Pick a benchmark that you would like to measure the performance for.
    ...
    *   If none of the existing benchmarks capture your use-case, then please
        create a github issue or start a thread on micro@machina.org to
...
1.  Create one pull request for each optimized kernel with the PR description
    ...
    *   This context is important even if the toolchain is proprietary and there
        ...
        *   See [this PR](https://github.com/machina/machina/pull/47098)
            as an example.
        *   At minimum the latency with and without the particular optimized
            kernel should be documented.
            [Additional context](https://github.com/machina/machina/pull/46746)
...
[PR #42477](https://github.com/machina/machina/pull/42477) and
[PR #45227](https://github.com/machina/machina/pull/45227)
...
* [PR 1](https://github.com/machina/machina/pull/45464): refactor for
reference fallbacks and a baseline latency. 
* [PR 2](https://github.com/machina/machina/pull/46242): refactor to share
code between reference and optimized kernels. 
* [PR 3](https://github.com/machina/machina/pull/46411): add the code needed
...
1.  Export static library + headers into target-specific development environment
    ...
    *   Build a static libmachina-microlite.a using the TFLM makefile with:
        `make -f machina/lite/micro/tools/make/Makefile TARGET=<target>
