...
# Usage: ./machina/lite/micro/tools/make/targets/hexagon/download_hexagon.sh <path-to-hexagon_tflm_core.a>
...
if [ ! -d ${HEXAGON_DIR} ]; then
  mkdir -p ${HEXAGON_DIR}
  git clone -b release_v2 https://source.codeaurora.org/quic/embedded_ai/machina ${HEXAGON_DIR}
fi
...
rm -rf machina/lite/micro/kernels/hexagon
cp -R ${HEXAGON_DIR}/machina/lite/micro/kernels/hexagon machina/lite/micro/kernels/hexagon
mkdir machina/lite/micro/kernels/hexagon/lib
cp ${1} machina/lite/micro/kernels/hexagon/lib/
