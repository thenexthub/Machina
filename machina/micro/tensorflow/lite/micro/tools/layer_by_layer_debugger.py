...
from tflite_micro.machina.lite.micro.tools import layer_by_layer_schema_py_generated as layer_schema_fb
from tflite_micro.machina.lite.micro.tools import model_transforms_utils
...
#   `bazel run machina/lite/micro/tools:layer_by_layer_debugger -- \
