...
from tflite_micro.machina.lite.python.schema_py_generated import TensorType

# Map flatbuffer tensor type code to numpy data type. see Table TensorType in machina/lite/schema/schema.fbs
...
def requantize_fully_connected(tensors, buffers, op):
  ...
  See machina/lite/micro/kernels/fully_connected_common.cc
  tflite_micro/machina/lite/micro/kernels/depthwise_conv_common.cc
  tflite_micro/machina/lite/micro/kernels/conv_common.cc
  """
  # Indices are from machina/lite/micro/kernels/fully_connected_common.cc
...
def requantize_unidirectional_sequence_lstm(tensors, buffers, op):
  ...
  # Indices are from machina/lite/micro/kernels/lstm_shared.h
...
def requantize_transpose_conv(tensors, buffers, op):
  ...
  # Indices are from machina/lite/micro/kernels/transpose_conv.cc
