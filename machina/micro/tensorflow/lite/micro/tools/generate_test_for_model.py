...
class TestDataGenerator:
  ...
  def generate_makefile(self,
    ...
    """ Generates a makefile which takes the the given input model(s) as input and also the
        ...
        For example usage see: machina/lite/micro/integration_tests/generate_per_layer_tests.py. """
    ...
    makefile.write('$(MACHINA_ROOT)' +
                   ...
                   '/' + test_file + '  \\\n')
    makefile.write(
        "$(MACHINA_ROOT)python/tflite_micro/python_ops_resolver.cc \\\n")
    makefile.write('\n\n')
    makefile.write(src_prefix + '_HDR := \\\n')
    makefile.write(
        "$(MACHINA_ROOT)python/tflite_micro/python_ops_resolver.h \\\n")
    makefile.write('\n\n')
