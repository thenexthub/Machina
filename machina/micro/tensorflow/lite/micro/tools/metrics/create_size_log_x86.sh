...
readable_run make -f machina/lite/micro/tools/make/Makefile clean clean_downloads
...
python3 machina/lite/micro/tools/metrics/create_size_log.py --build_type=${BUILD_TYPE} --target=${TARGET} --target_arch=${TARGET_ARCH} --binary_list=${BINARY_LIST}
...
python3 machina/lite/micro/tools/metrics/detect_size_increase_and_plot_history.py --input_dir=${LOG_DIR} --output_dir=${LOG_DIR} --binary_list=${BINARY_LIST}
SIZE_ALERT_STATUS=$?
