 ...
 *
 */
#ifndef MACHINA_LITE_MICRO_ARENA_ALLOCATOR_IBUFFER_ALLOCATOR_H_
#define MACHINA_LITE_MICRO_ARENA_ALLOCATOR_IBUFFER_ALLOCATOR_H_
...
#endif  // MACHINA_LITE_MICRO_ARENA_ALLOCATOR_IBUFFER_ALLOCATOR_H_
