...
#ifndef MACHINA_LITE_MICRO_TEST_HELPER_CUSTOM_OPS_H_
#define MACHINA_LITE_MICRO_TEST_HELPER_CUSTOM_OPS_H_
...
#endif  // MACHINA_LITE_MICRO_TEST_HELPER_CUSTOM_OPS_H_
