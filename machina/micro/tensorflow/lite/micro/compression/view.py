...
#
# Example usage:
#   bazel run //machina/lite/micro/compression:view -- $(realpath model.tflite)
#
# Theory of operation:
...
from machina.lite.micro.compression import metadata_py_generated as compression_schema
from machina.lite.python import schema_py_generated as tflite_schema
...
if is_bazel:
  USAGE = textwrap.dedent("""\
    Usage: bazel run //machina/lite/micro/compression:view -- <MODEL_PATH>
    ...
    Example: bazel run //machina/lite/micro/compression:view -- $(realpath model.tflite)"""
                          )
else:
