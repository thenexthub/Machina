...
#ifndef TFLITE_MICRO_MACHINA_LITE_MICRO_MICRO_RESOURCE_H_
#define TFLITE_MICRO_MACHINA_LITE_MICRO_MICRO_RESOURCE_H_
...
#endif  // TFLITE_MICRO_MACHINA_LITE_MICRO_MICRO_RESOURCE_H_
