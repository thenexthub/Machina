 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_H_
#define MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_H_
