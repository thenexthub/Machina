 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_FULLY_CONNECTED_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_FULLY_CONNECTED_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_FULLY_CONNECTED_H_
