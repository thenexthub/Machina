 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
