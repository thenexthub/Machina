 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_L2NORMALIZATION_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_L2NORMALIZATION_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_L2NORMALIZATION_H_
