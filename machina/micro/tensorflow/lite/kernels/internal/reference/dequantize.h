 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
