 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SPACE_TO_BATCH_ND_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SPACE_TO_BATCH_ND_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_SPACE_TO_BATCH_ND_H_
