...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_CONCATENATION_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_CONCATENATION_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_CONCATENATION_H_
