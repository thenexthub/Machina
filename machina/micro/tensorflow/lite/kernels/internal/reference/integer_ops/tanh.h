 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_TANH_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_TANH_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_TANH_H_
