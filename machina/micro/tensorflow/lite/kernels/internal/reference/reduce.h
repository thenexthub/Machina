 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REDUCE_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REDUCE_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REDUCE_H_
