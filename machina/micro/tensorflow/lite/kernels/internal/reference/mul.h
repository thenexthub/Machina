 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_MUL_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_MUL_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_MUL_H_
