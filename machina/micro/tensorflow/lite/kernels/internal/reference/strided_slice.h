 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_STRIDED_SLICE_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_STRIDED_SLICE_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_STRIDED_SLICE_H_
