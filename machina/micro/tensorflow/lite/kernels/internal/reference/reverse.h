 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REVERSE_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REVERSE_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_REVERSE_H_
