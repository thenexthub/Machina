 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
#define MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
