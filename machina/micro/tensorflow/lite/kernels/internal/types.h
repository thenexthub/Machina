 ...
 *
 */
#ifndef MACHINA_LITE_KERNELS_INTERNAL_TYPES_H_
#define MACHINA_LITE_KERNELS_INTERNAL_TYPES_H_
...
enum class FullyConnectedWeightsFormat : uint8_t {
  ...
  //
  //   machina/lite/toco/graph_transformations/ensure_uint8_weights_safe_for_fast_int8_kernels.cc
  //
  kShuffled4x16Int8,
};
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_TYPES_H_
