...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_UTILS_H_
#define MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_UTILS_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_PORTABLE_TENSOR_UTILS_H_
