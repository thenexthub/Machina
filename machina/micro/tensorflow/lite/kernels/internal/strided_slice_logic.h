...
#ifndef MACHINA_LITE_KERNELS_INTERNAL_STRIDED_SLICE_LOGIC_H_
#define MACHINA_LITE_KERNELS_INTERNAL_STRIDED_SLICE_LOGIC_H_
...
#endif  // MACHINA_LITE_KERNELS_INTERNAL_STRIDED_SLICE_LOGIC_H_
