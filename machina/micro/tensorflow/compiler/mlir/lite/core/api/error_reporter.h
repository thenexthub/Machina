 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_LITE_CORE_API_ERROR_REPORTER_H_
#define MACHINA_COMPILER_MLIR_LITE_CORE_API_ERROR_REPORTER_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_CORE_API_ERROR_REPORTER_H_
