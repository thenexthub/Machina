...
#ifndef MACHINA_COMPILER_AOT_EMBEDDED_CONSTANT_BUFFERS_H_
#define MACHINA_COMPILER_AOT_EMBEDDED_CONSTANT_BUFFERS_H_
...
#endif  // MACHINA_COMPILER_AOT_EMBEDDED_CONSTANT_BUFFERS_H_
