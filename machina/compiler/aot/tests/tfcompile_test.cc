...
// both of them.
#if defined(ENABLE_MACHINA_MACHINA_XLA_THUNK_TEST)
#include "machina/compiler/aot/tests/test_graph_tfadd_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt_saver_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfassert_eq_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfcond_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tffunction_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfgather_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul_with_constant_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmulandadd_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfrandom_uniform_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfscatter_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfsplits_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tftop_k_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_readonly_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_sequential_updates_thunks.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_thunks.h"

#elif defined(ENABLE_MACHINA_MACHINA_XLA_NANORT_TEST)

#include "machina/compiler/aot/tests/test_graph_tfadd_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt_saver_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfassert_eq_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfcond_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tffunction_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfgather_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul_with_constant_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmulandadd_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfrandom_uniform_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfscatter_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfsplits_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tftop_k_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_readonly_nanort.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_sequential_updates_nanort.h"

#else

#include "machina/compiler/aot/tests/test_graph_tfadd.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt.h"
#include "machina/compiler/aot/tests/test_graph_tfadd_with_ckpt_saver.h"
#include "machina/compiler/aot/tests/test_graph_tfassert_eq.h"
#include "machina/compiler/aot/tests/test_graph_tfcond.h"
#include "machina/compiler/aot/tests/test_graph_tffunction.h"
#include "machina/compiler/aot/tests/test_graph_tfgather.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmul_with_constant.h"
#include "machina/compiler/aot/tests/test_graph_tfmatmulandadd.h"
#include "machina/compiler/aot/tests/test_graph_tfrandom_uniform.h"
#include "machina/compiler/aot/tests/test_graph_tfscatter.h"
#include "machina/compiler/aot/tests/test_graph_tfsplits.h"
#include "machina/compiler/aot/tests/test_graph_tftop_k.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_readonly.h"
#include "machina/compiler/aot/tests/test_graph_tfvariable_sequential_updates.h"

#endif

#include "machina/compiler/tf2xla/xla_compiled_cpu_function.h"
#include "machina/xla/hlo/testlib/test.h"
...
TEST(TFCompileTest, Scatter) {
  ...
  // NOTE(basioli): Shape is hardcoded to 8 in machina config.
