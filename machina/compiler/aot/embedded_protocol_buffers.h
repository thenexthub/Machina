...
#ifndef MACHINA_COMPILER_AOT_EMBEDDED_PROTOCOL_BUFFERS_H_
#define MACHINA_COMPILER_AOT_EMBEDDED_PROTOCOL_BUFFERS_H_
...
#endif  // MACHINA_COMPILER_AOT_EMBEDDED_PROTOCOL_BUFFERS_H_
