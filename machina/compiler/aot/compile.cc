...
#include "machina/compiler/aot/quantize.h"
...
#include "machina/core/platform/regexp.h"  // IWYU pragma: keep
#include "machina/core/platform/types.h"

namespace machina {
namespace tfcompile {

static toolchain::ManagedStatic<QuantizeXlaFn> quantize_xla;
...
// in machina/python/framework/error_interpolation.py for more detail.
static std::string InterpolateErrorMessage(std::string message) {
  // See _NAME_REGEX in machina/python/framework/error_interpolation.py
