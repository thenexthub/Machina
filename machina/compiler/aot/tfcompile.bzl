...
load("//machina:machina.default.bzl", "tfcompile_dfsan_abilists", "tfcompile_dfsan_enabled", "tfcompile_friends", "tfcompile_target_cpu")
...
def _tfcompile_model_library_rule_impl(ctx):
    ...
    tfcompile_env = {
        "MACHINA_MACHINA_XLA_FLAGS": ("--xla_cpu_enable_fast_math=true " +
...
def _tf_library(
        ...
        tfcompile_tool = "//machina/compiler/aot:tfcompile",
    ...
    if freeze_checkpoint or freeze_saver:
        ...
        native.genrule(
            ...
            tools = ["//machina/python/tools:freeze_graph"],
            tags = tags,
        )
    ...
    cc_library(
        ...
        deps = [
            ...
            "//machina/compiler/tf2xla:xla_compiled_cpu_function_thunks",
        ] or []) + (deps or []),
        tags = tags,
        copts = copts,
    )
    ...
    if gen_test:
        ...
        template_file = "//machina/compiler/aot:test"
        ...
        # //machina/core:lib -- see the note in
        # machina/core/BUILD for more details.
        tf_cc_test(
            name = test_name,
            srcs = [test_file],
            deps = [
                ":" + name,
                "//machina/compiler/aot:tf_library_test_main",
    ...
    if gen_benchmark:
        ...
        benchmark_main = ("//machina/compiler/aot:" +
        ...
        cc_binary(
            ...
            deps = [
                ":" + name,
                "//machina/compiler/aot:benchmark",
                "@local_xla//xla:executable_run_options",
                "@eigen_archive//:eigen3",
            ] + if_android([
                "//machina/compiler/aot:benchmark_extra_android",
            ]),
            tags = tags,
            visibility = visibility,
        )
...
def tf_library(
    ...
    Args:
      ...
      config: File containing machina.tf2xla.Config proto.  If the file ends
...
def target_llvm_triple():
    ...
    # http://toolchain.org/docs/doxygen/html/Triple_8h_source.html
    return select({
        "//machina:android_armeabi": "armv5-none-android",
        "//machina:android_arm": "armv7-none-android",
        "//machina:android_arm64": "aarch64-none-android",
        "//machina:android_x86": "i686-none-android",
        "//machina:ios": "arm64-none-ios",
        "//machina:ios_x86_64": "x86_64-apple-ios",
        "//machina:linux_ppc64le": "ppc64le-ibm-linux-gnu",
        "//machina:linux_aarch64": "aarch64-none-linux-gnu",
        "//machina:macos_x86_64": "x86_64-none-darwin",
        "//machina:macos_arm64": "aarch64-none-darwin",
        "//machina:windows": "x86_64-none-windows",
        "//machina:linux_s390x": "systemz-none-linux-gnu",
