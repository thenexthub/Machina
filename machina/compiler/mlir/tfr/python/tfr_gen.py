...
from machina.compiler.mlir.tfr import tfr_wrapper as tfr
...
from machina.python.autograph.pyct.static_analysis import type_inference
...
class TFRTypeResolver(type_inference.Resolver):
  ...
  def res_value(self, ns, value):
    ...
    if getattr(value, '__name__', None) == 'machina.raw_ops':
  ...
  def visit_Attribute(self, node):
    ...
    if isinstance(node.value, ast.Name):
      ...
      if node_type == TFRTypes.TF_RAW_OP:
        # This branch is used when it is inside machina
