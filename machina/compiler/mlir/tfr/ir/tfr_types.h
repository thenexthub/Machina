...
#ifndef MACHINA_COMPILER_MLIR_TFR_IR_TFR_TYPES_H_
#define MACHINA_COMPILER_MLIR_TFR_IR_TFR_TYPES_H_
...
struct TFRTypeStorage final
    : public TypeStorage,
      public toolchain::TrailingObjects<TFRTypeStorage, StringAttr> {
...
#endif  // MACHINA_COMPILER_MLIR_TFR_IR_TFR_TYPES_H_
