...
load("//machina:machina.bzl", "tf_custom_op_library", "tf_gen_op_wrapper_py")
load("//machina:machina.default.bzl", "tf_custom_op_py_library")
...
def gen_op_libraries(
    ...
    py_deps = []
    if use_pywrap_rules():
        py_deps = ["//machina/python:_pywrap_machina"]

    py_deps += [
        "//machina/compiler/mlir/tfr:op_reg_gen",
        "//machina/compiler/mlir/tfr:tfr_gen",
        "//machina/compiler/mlir/tfr:composite",
    ] + deps
