...
if platform.system() == 'Windows':
  ...
  real_test_srcdir = srcdir[:srcdir.find('machina/compiler/mlir')]
...
mlir_tf_tools_dirs = [
    'machina/compiler/aot',
    'machina/compiler/mlir',
    'machina/compiler/mlir/lite',
    'machina/compiler/mlir/lite/experimental/tac',
    'machina/compiler/mlir/lite/stablehlo',
    'machina/compiler/mlir/lite/stablehlo/odml_converter',
    'machina/compiler/mlir/quantization/machina',
    'machina/compiler/mlir/machina',
    'machina/compiler/mlir/tfrt',
    'machina/compiler/mlir/tools/kernel_gen',
    os.path.join(external_srcdir, 'local_xla/xla/mlir_hlo'),
    'machina/core/ir/importexport/',
    'machina/core/ir/tests/',
    'machina/core/transforms/',
    'machina/dtensor/mlir/tests',
]
...
lit_config.load_config(
    ...
    os.path.join(
        os.path.join(real_test_srcdir, os.environ['TEST_WORKSPACE'],
                     'machina/compiler/mlir/runlit.cfg.py')))
