...
#ifndef MACHINA_COMPILER_MLIR_STABLEHLO_TRANSFORMS_UTILS_H_
#define MACHINA_COMPILER_MLIR_STABLEHLO_TRANSFORMS_UTILS_H_
...
#endif  // MACHINA_COMPILER_MLIR_STABLEHLO_TRANSFORMS_UTILS_H_
