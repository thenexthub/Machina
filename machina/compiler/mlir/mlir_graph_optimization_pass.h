...
#ifndef MACHINA_COMPILER_MLIR_MLIR_GRAPH_OPTIMIZATION_PASS_H_
#define MACHINA_COMPILER_MLIR_MLIR_GRAPH_OPTIMIZATION_PASS_H_
...
class MlirOptimizationPass {
 public:
  ...
  virtual toolchain::StringRef name() const = 0;
...
#endif  // MACHINA_COMPILER_MLIR_MLIR_GRAPH_OPTIMIZATION_PASS_H_
