...
#include "machina/compiler/mlir/tools/safe_cast.h"
...
void SymmetricPerChannelQuantizeValues(const float* const input,
  ...
  machina::TensorShape unextended_shape;
  TF_CHECK_OK(machina::TensorShapeUtils::MakeShape(absl::MakeSpan(dimension),
                                                      &unextended_shape));
