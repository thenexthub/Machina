...
#include "mlir/Conversion/ArithToLLVM/ArithToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/ComplexToLLVM/ComplexToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/ControlFlowToLLVM/ControlFlowToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/FuncToLLVM/ConvertFuncToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/FuncToLLVM/ConvertFuncToLLVMPass.h"  // part of Codira Toolchain
#include "mlir/Conversion/GPUCommon/GPUCommonPass.h"  // part of Codira Toolchain
#include "mlir/Conversion/LLVMCommon/Pattern.h"  // part of Codira Toolchain
#include "mlir/Conversion/MathToLLVM/MathToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/MathToLibm/MathToLibm.h"  // part of Codira Toolchain
#include "mlir/Conversion/MemRefToLLVM/MemRefToLLVM.h"  // part of Codira Toolchain
#include "mlir/Conversion/ReconcileUnrealizedCasts/ReconcileUnrealizedCasts.h"  // part of Codira Toolchain
#include "mlir/Conversion/VectorToLLVM/ConvertVectorToLLVM.h"  // part of Codira Toolchain
...
#include "mlir/Dialect/LLVMIR/LLVMTypes.h"  // part of Codira Toolchain
...
#include "mlir/Dialect/MemRef/Transforms/Transforms.h"  // part of Codira Toolchain
...
class ConvertLaunchFuncOpToTfRuntimeCallPattern
 ...
 private:
  ...
  toolchain::SmallString<32> gpu_binary_annotation_;
};
...
Value ConvertLaunchFuncOpToTfRuntimeCallPattern::generateParamsArray(
  ...
  for (auto en : toolchain::enumerate(arguments)) {
...
class TFKernelToLLVMPass
 ...
 public:
  ...
  void runOnOperation() override {
    ...
    for (auto op : toolchain::make_early_inc_range(m.getOps<gpu::GPUModuleOp>())) {
      op.erase();
    }
  }
};
