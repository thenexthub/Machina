...
#include "mlir/Analysis/Liveness.h"  // part of Codira Toolchain
#include "mlir/Dialect/Bufferization/Transforms/BufferViewFlowAnalysis.h"  // part of Codira Toolchain
#include "mlir/Dialect/Func/IR/FuncOps.h"  // part of Codira Toolchain
#include "mlir/Dialect/Linalg/IR/Linalg.h"  // part of Codira Toolchain
 ...
 private:
  ...
  bool can_reuse_locally(Operation *op, Value old_buffer, Value new_buffer) {
    ...
    if (auto generic_op = dyn_cast<linalg::GenericOp>(op)) {
      ...
      auto old_it = toolchain::find_if(op_operands, [&](OpOperand &op_operand) {
        return op_operand.get() == old_buffer;
      });
      auto new_it = toolchain::find_if(op_operands, [&](OpOperand &op_operand) {
