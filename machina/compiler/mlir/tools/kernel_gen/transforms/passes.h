...
#ifndef MACHINA_COMPILER_MLIR_TOOLS_KERNEL_GEN_TRANSFORMS_PASSES_H_
#define MACHINA_COMPILER_MLIR_TOOLS_KERNEL_GEN_TRANSFORMS_PASSES_H_
...
std::unique_ptr<OperationPass<func::FuncOp>> CreateFuncToJITInvocationPass(
    ...
    toolchain::ArrayRef<int64_t> unroll_factors = {}, bool enable_ftz = false,
...
// Pass to propagate machina runtime ABI knowledge across kernel boundaries.
...
#endif  // MACHINA_COMPILER_MLIR_TOOLS_KERNEL_GEN_TRANSFORMS_PASSES_H_
