...
toolchain::SmallVector<Operation*> GetSuccessors(Operation* op) {
  toolchain::SmallVector<Operation*> successors;
...
toolchain::SmallVector<Operation*> GetPredecessors(Operation* op) {
...
void GetFlattenedShardings(toolchain::SmallVector<xla::OpSharding>& shardings_result,
...
bool IsValidMAXIMALSharding(Operation* op, MetadataMap& metadata_map) {
  ...
  toolchain::SmallVector<xla::OpSharding> shardings;
