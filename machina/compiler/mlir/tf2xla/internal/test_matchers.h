...
#ifndef MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_INTERNAL_TEST_MATCHERS_H_
#define MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_INTERNAL_TEST_MATCHERS_H_
...
bool WasGraphAnalysisFailure(const absl::StatusOr<T>& status) {
  return (status.status() ==
          machina::CompileToHloGraphAnalysisFailedError());
}
...
#endif  // MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_INTERNAL_TEST_MATCHERS_H_
