...
const toolchain::DenseSet<mlir::TypeID>& MlirAlwaysOps() {
  // The static variable is a pointer in order to avoid destruction upon thread
  // termination.
  static const toolchain::DenseSet<mlir::TypeID>* ops = new toolchain::DenseSet<
      mlir::TypeID>{
...
bool IsOpTypeAllowedTf2XlaFallback(const TypeID& type_id) {
  ...
  static auto* ops = [] {
    toolchain::SmallDenseSet<mlir::TypeID, 512>* ops_set = new toolchain::SmallDenseSet<
        mlir::TypeID, 512>{
...
bool IsOpTypeAllowedTf2XlaPreferred(const TypeID& type_id) {
  ...
  // clang-format off
  static auto* ops =
      new toolchain::SmallDenseSet<mlir::TypeID, 512>{
    TypeID::get<TF::AllOp>(),
...
const toolchain::DenseSet<mlir::TypeID>& DynamicTensorflowOps() {
  // The static variable is a pointer in order to avoid destruction upon thread
  // termination.
  static const toolchain::DenseSet<mlir::TypeID>* ops =
      new toolchain::DenseSet<mlir::TypeID>{
