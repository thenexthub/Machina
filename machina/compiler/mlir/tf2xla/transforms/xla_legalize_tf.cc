...
#include "machina/xla/mlir_hlo/mhlo/IR/hlo_ops.h"  // IWYU pragma: keep, dependent dialect
...
auto *mlir_legalization_count = machina::monitoring::Counter<1>::New(
    "/machina/core/tf2xla/v1/mlir_failed_xla_legalize_tf_count",
    "Counts the attempts of legalization of ops", "op_name");

auto *mlir_failed_legalization_count = machina::monitoring::Counter<2>::New(
