...
static constexpr char kFailedLegalizationStreamz[] =
    "/machina/core/tf2xla/mlir_second_phase_failed_legalization_op_count";
static constexpr char kNonStaticOpStreamz[] =
    "/machina/core/tf2xla/mlir_second_phase_non_static_op_count";
static constexpr char kNonStaticOpSkipStreamz[] =
    "/machina/core/tf2xla/mlir_second_phase_non_static_op_skip_count";
