...
#ifndef MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_TRANSFORMS_UTILS_H_
#define MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_TRANSFORMS_UTILS_H_
...
DenseIntElementsAttr GetI64ElementsAttr(toolchain::ArrayRef<int64_t> values,
                                        Builder* builder);

}  // namespace mhlo
}  // namespace mlir

#endif  // MACHINA_COMPILER_MLIR_TF2MACHINA_MACHINA_XLA_TRANSFORMS_UTILS_H_
