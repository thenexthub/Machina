...
static constexpr char kCompilationStatusStreamzName[] =
    "/machina/core/tf2xla/api/v1/phase2_compilation_status";
...
absl::StatusOr<XlaCompilationResult> CompileWithComputation(
  ...
  if (computation.index() == 0) {
    TF_RETURN_IF_ERROR(machina::tf2xla::internal::ConfigureMetadata(
  ...
  absl::Status compilation_status =
      machina::tf2xla::v1::CompileTensorflowGraphToHlo(
          computation, metadata_proto, use_tuple_args, shape_determination_fns,
          arg_shapes, tsl::DeviceType("MACHINA_MACHINA_XLA_TPU_JIT"), &arg_core_mapping,
