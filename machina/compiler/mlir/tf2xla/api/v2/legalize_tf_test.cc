...
#include "machina/xla/tsl/lib/monitoring/test_utils.h"
...
using machina::tf2xla::v2::testing::CompileMlirModule;
using ::testing::Not;
...
static constexpr char kCompilationTimeStreamzName[] =
    "/machina/core/tf2xla/api/v2/phase2_compilation_time";
static constexpr char kFullBridge[] = "full_bridge";
static constexpr char kCompilationStatusStreamzName[] =
    "/machina/core/tf2xla/api/v2/phase2_compilation_status";
...
TEST(LegalizeTFTest, RecordsStreamzForNoMlirFallback) {
  FunctionDef my_func =
      machina::FunctionDefHelper::Create("empty", {}, {}, {}, {}, {});

  machina::FunctionDefLibrary fdef;
  *(fdef.add_function()) = my_func;
  machina::FunctionLibraryDefinition flib_def(
      machina::OpRegistry::Global(), fdef);
  ...
  absl::StatusOr<XlaCompiler::CompilationResult> compile_result =
      LegalizeMlirToHlo(function_to_hlo_args, metadata_proto, use_tuple_args,
                        /*device_type=*/"MACHINA_MACHINA_XLA_CPU_JIT",
