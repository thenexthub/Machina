...
auto *tf_dialect_to_executor_dialect_status = tsl::monitoring::Counter<1>::New(
    "/machina/core/tf2xla/api/v2/tf_dialect_to_executor_dialect_status",
...
absl::Status RecordStatusIfError(absl::Status status) {
  ...
  constexpr char bridge_subcomponent[] =
      "TFMACHINA_MACHINA_XLA_TF_FUNCTIONAL_TO_EXECUTOR_EXPORT_v2";
...
absl::Status ExportFromTensorflowDialectToExecutor(
    ModuleOp module, toolchain::StringRef module_name) {
  PassManager tf_to_executor(module.getContext());
  ::machina::applyTensorflowAndCLOptions(tf_to_executor);
  ...
  if (VLOG_IS_ON(1) ||
    ...
    ::machina::DumpMlirOpToFile(
        ...
        module, toolchain::StringRef(), &tf_to_executor);
