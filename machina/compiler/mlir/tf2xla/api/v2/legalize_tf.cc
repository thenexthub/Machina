...
#include "machina/compiler/mlir/tf2xla/internal/reproducer.pb.h"
...
void DumpComputationInput(
  ...
  machina::mlir::tf2xla::internal::LegalizeMlirToHloReproducer reproducer;
  *reproducer.mutable_compile_metadata() = metadata;
  ...
  machina::protobuf::TextFormat::PrintToString(reproducer,
                                                  &string_reproducer);
...
absl::Status DumpHloCompilationResult(
  ...
  machina::DumpRawStringToFile(name, all_computations);
...
absl::StatusOr<machina::XlaCompilationResult> LegalizeMlirToHlo(
  ...
  auto record_time = toolchain::make_scope_exit([&timer] {
