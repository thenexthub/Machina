...
class NoOpPass
 ...
 public:
  ...
  toolchain::StringRef getArgument() const final { return "no-op-pass"; }
...
class ParentPass
 ...
 public:
  ...
  toolchain::StringRef getArgument() const final { return "parent-pass"; }
...
using namespace machina::quantization::mlir_dump_test;
...
module{
  ...
  TF_EXPECT_OK(tsl::Env::Default()->FileExists(
      tsl::io::JoinPath(test_dir_,
                        "dump_0001_machina::quantization::mlir_dump_test"
...
TEST_F(EnableIrPrintingTest, NestedPassSuccessfullyRuns) {
  ...
  TF_EXPECT_OK(tsl::Env::Default()->FileExists(
      tsl::io::JoinPath(test_dir_,
                        "dump2_0001_machina::quantization::mlir_dump_test"
                        "::NoOpPass_before.mlir")));
}
}  // namespace
}  // namespace quantization
