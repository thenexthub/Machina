...
#ifndef MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_QUANTIZED_FUNCTION_LIBRARY_H_
#define MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_QUANTIZED_FUNCTION_LIBRARY_H_
""")
    ...
    f.write(
        '#endif  // MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_QUANTIZED_FUNCTION_LIBRARY_H_'
    )
