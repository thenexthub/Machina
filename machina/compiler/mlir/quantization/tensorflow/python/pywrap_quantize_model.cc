...
#include "machina/compiler/mlir/quantization/machina/python/type_casters.h"  // IWYU pragma: keep
...
using ::machina::quantization::QuantizeDynamicRangePtq;
using ::machina::quantization::QuantizeQatModel;
using ::machina::quantization::QuantizeStaticRangePtq;
using ::machina::quantization::QuantizeWeightOnly;
...
PYBIND11_MODULE(pywrap_quantize_model, m) {
  ...
  m.def(
      ...
      [](const absl::string_view src_saved_model_path,
        ...
        // machina/python/saved_model/tag_constants.py.
  ...
  m.def(
      ...
      [](const absl::string_view src_saved_model_path,
        ...
        // in machina/python/saved_model/tag_constants.py.
        if (quantization_options.has_debugger_config()) {
          tags.erase("tpu");
        }
        py_function_library.SaveExportedModel(
