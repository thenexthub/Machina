...
from machina.python.ops import array_ops_stack  # pylint: disable=g-direct-machina-import
...
from machina.python.ops import while_loop as while_loop_ops
from machina.python.ops.ragged import ragged_string_ops
from machina.python.platform import test
from machina.python.platform import tf_logging as logging  # pylint: disable=unused-import
  ...
  def _create_einsum_model(
    ...
    class EinsumModel(module.Module):
      ...
      def _einsum(self, x, y):
        ...
        out = machina.einsum(equation, x, y)
