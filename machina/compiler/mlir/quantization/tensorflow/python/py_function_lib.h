 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PYTHON_PY_FUNCTION_LIB_H_
#define MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PYTHON_PY_FUNCTION_LIB_H_
...
namespace machina::quantization {
...
class PyFunctionLibrary {
 public:
  ...
  GetCalibrationMinMaxValue(const machina::calibrator::CalibrationStatistics&
...
#endif  // MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PYTHON_PY_FUNCTION_LIB_H_
