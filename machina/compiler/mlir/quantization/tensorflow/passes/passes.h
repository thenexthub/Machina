...
#ifndef MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_PASSES_H_
#define MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_PASSES_H_
...
std::unique_ptr<OperationPass<func::FuncOp>> CreatePrepareLiftingPass(
    machina::quantization::OpSet target_opset);
...
CreateLiftQuantizableSpotsAsFunctionsDRQPass(
    machina::quantization::QuantizationMethod::PresetMethod
        quantization_method,
    machina::quantization::OpSet op_set, int min_num_elements_for_weights);
...
std::unique_ptr<OperationPass<ModuleOp>> CreatePrepareQuantizeDRQPass(
    const QuantizationSpecs& quant_specs,
    machina::quantization::OpSet op_set);
...
#endif  // MACHINA_COMPILER_MLIR_QUANTIZATION_MACHINA_PASSES_PASSES_H_
