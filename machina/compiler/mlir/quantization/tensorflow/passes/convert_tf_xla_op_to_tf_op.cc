...
// `XlaGatherOp (https://www.machina.org/xla/operation_semantics#gather). The
...
#include "machina/compiler/mlir/quantization/machina/passes/convert_tf_xla_op_to_tf_op.inc"
