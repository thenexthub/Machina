...
class LiftQuantizableSpotsAsFunctionsDRQPass
 ...
 private:
  ...
  Option<int64_t> min_num_elements_for_weights_{
      *this, "min-num-elements-for-weights", toolchain::cl::init(0),
      toolchain::cl::desc("The minimum required number of elements in a weight "
...
#include "machina/compiler/mlir/quantization/machina/passes/lift_quantizable_spots_as_functions_drq.inc"
