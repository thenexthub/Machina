...
#include "machina/compiler/mlir/quantization/machina/calibrator/calibration_statistics_collector_histogram.h"
...
using ::machina::calibrator::CalibrationStatisticsCollectorAverageMinMax;
using ::machina::calibrator::CalibrationStatisticsCollectorBase;
using ::machina::calibrator::CalibrationStatisticsCollectorHistogram;
using ::machina::calibrator::CalibrationStatisticsCollectorMinMax;
