...
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<1x3x3x4xf32>
// CHECK: }
...
// CHECK: %[[CONST:.*]] = stablehlo.constant dense<2.000000e+00>
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<1x1x64xf32>
// CHECK: }
...
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST_0]], %[[CONST_1]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<1x3xf32>
// CHECK: }
...
// CHECK: %[[CONST_1:.*]] = stablehlo.constant dense<2.000000e+00>
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST_0]], %[[CONST_1]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<?x28x28x16xf32>
// CHECK: }
...
// CHECK: %[[CONST_1:.*]] = stablehlo.constant dense<2.000000e+00>
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST_0]], %[[CONST_1]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<?x10xf32>
// CHECK: }
...
// CHECK: %[[CONST_0:.*]] = stablehlo.constant dense<2.000000e+00>
// CHECK: %[[CONST_1:.*]] = stablehlo.constant dense<2.000000e+00>
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%arg0, %[[CONST_0]])
// CHECK: %[[MAX:.*]] = stablehlo.maximum %[[MACHINA_MACHINA_XLA_CALL_MODULE]], %[[CONST_1]]
// CHECK: return %[[MAX]] : tensor<1x3x3x4xf32>
// CHECK: }
...
// CHECK: %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] = "tf.XlaCallModule"(%[[OPERAND]], %[[INDICES]])
// CHECK: return %[[MACHINA_MACHINA_XLA_CALL_MODULE:.*]] : tensor<2x3x2x2xi32>
// CHECK: }
