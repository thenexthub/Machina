 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TYPES_H_
#define MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TYPES_H_
...
#endif  // MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TYPES_H_
