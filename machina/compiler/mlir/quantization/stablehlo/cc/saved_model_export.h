...
#ifndef MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_SAVED_MODEL_EXPORT_H_
#define MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_SAVED_MODEL_EXPORT_H_
...
absl::StatusOr<machina::quantization::ExportedModel> CreateExportedModel(
...
[[nodiscard]] machina::quantization::ExportedModel
CreateExportedModelFromGraphDef(
    machina::GraphDef&& graph_def, absl::string_view init_node_name,
    absl::string_view checkpoint_dir,
    std::optional<machina::SaverDef> saver_def,
    const absl::flat_hash_map<std::string, std::string>& function_aliases,
    const std::vector<machina::AssetFileDef>& asset_file_defs);
...
absl::StatusOr<std::optional<machina::SaverDef>> CreateSaverDef(
...
absl::StatusOr<machina::quantization::ExportedModel>
...
// upon model loading.
// TODO: b/329206105 - Add unit tests after decomposing post processing passes.
absl::StatusOr<SmallVector<::machina::AssetFileDef>> RunExportPasses(
    const ExportOptions& export_opts, MLIRContext& ctx, ModuleOp module_op);

}  // namespace mlir::quant::stablehlo

#endif  // MACHINA_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_SAVED_MODEL_EXPORT_H_
