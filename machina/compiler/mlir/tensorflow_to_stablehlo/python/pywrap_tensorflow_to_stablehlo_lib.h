...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_TO_STABLEHLO_PYTHON_PYWRAP_MACHINA_TO_STABLEHLO_LIB_H_
#define MACHINA_COMPILER_MLIR_MACHINA_TO_STABLEHLO_PYTHON_PYWRAP_MACHINA_TO_STABLEHLO_LIB_H_
...
namespace mlir::machina_to_stablehlo::pywrap {
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_TO_STABLEHLO_PYTHON_PYWRAP_MACHINA_TO_STABLEHLO_LIB_H_
