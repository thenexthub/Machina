...
#include "machina/compiler/mlir/machina_to_stablehlo/python/pywrap_machina_to_stablehlo_lib.h"

namespace py = pybind11;

namespace {

using mlir::machina_to_stablehlo::pywrap::PywrapSavedModelToStablehlo;
using mlir::machina_to_stablehlo::pywrap::PywrapTfModuleToStablehlo;

}  // namespace

PYBIND11_MODULE(pywrap_machina_to_stablehlo, m) {
  ...
  // LINT.ThenChange(pywrap_machina_to_stablehlo.pyi:savedmodel_to_stablehlo)
  //
  // LINT.IfChange(machina_module_to_stablehlo)
  m.def(
  ...
  // LINT.ThenChange(pywrap_machina_to_stablehlo.pyi:machina_module_to_stablehlo)
}
