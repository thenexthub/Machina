...
from machina.compiler.mlir.machina_to_stablehlo.python import pywrap_machina_to_stablehlo as machina_to_stablehlo
...
class TensorflowToStableHLOTest(test.TestCase):
  ...
  def test_saved_model_to_stablehlo(self):
    with tempfile.TemporaryDirectory() as tempdir:
      ...
      module_bytecode = machina_to_stablehlo.savedmodel_to_stablehlo(
  ...
  def test_tf_mlir_to_stablehlo(self):
    ...
    """
    module_bytecode = machina_to_stablehlo.machina_module_to_stablehlo(
        module=assembly,
