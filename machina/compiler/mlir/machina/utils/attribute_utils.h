...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_ATTRIBUTE_UTILS_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_ATTRIBUTE_UTILS_H_
...
inline constexpr toolchain::StringRef kTpuReplicateAttr = "_tpu_replicate";
// Device types.
inline constexpr toolchain::StringRef kTpuDevice = "TPU";
// _xla_outside_compilation
inline constexpr toolchain::StringRef kXlaOutsideCompilationAttr =
    "_xla_outside_compilation";
// device attr
inline constexpr toolchain::StringRef kDeviceAttr = "device";
...
inline constexpr toolchain::StringRef kSkipIslandOutlining =
    "_skip_island_outlining";
// Function attribute to signal which argument contains bounded dynamic
// dimension.
inline constexpr toolchain::StringRef kDynamicArgIndexAttr = "_dynamic_arg_index";
...
//          which represents the second branch of replicate group 0 and
//          the second branch of parallel group 0.
inline constexpr toolchain::StringRef kParallelExecAnnotation =
...
using ParallelExecutionIdPairs =
    toolchain::SmallVector<std::pair<std::string, std::string>, 8>;
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_ATTRIBUTE_UTILS_H_
