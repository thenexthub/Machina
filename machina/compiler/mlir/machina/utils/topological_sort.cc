...
std::vector<Operation*> SortBlockTopologically(
  ...
  toolchain::DenseMap<Operation*, int> remaining_incoming_data_edges;
  toolchain::DenseMap<Operation*, int> remaining_incoming_ctrl_edges;
  toolchain::DenseMap<Operation*, int> position;
  toolchain::DenseMap<Operation*, Operation*> ancestor;
  SmallVector<Operation*> ready;

  toolchain::SmallVector<mlir::Operation*, 4> empty_op_set;
  auto ctrlPredecessors =
      [&](Operation* op) -> toolchain::SmallVector<mlir::Operation*, 4> const& {
