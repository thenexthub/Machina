...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_SHAPE_INFERENCE_UTILS_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_SHAPE_INFERENCE_UTILS_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_SHAPE_INFERENCE_UTILS_H_
