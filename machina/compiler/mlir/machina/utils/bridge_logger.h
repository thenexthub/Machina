...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_BRIDGE_LOGGER_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_BRIDGE_LOGGER_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_BRIDGE_LOGGER_H_
