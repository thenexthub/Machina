...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_ERROR_UTIL_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_ERROR_UTIL_H_
...
// support cases where machina::Status is still being used (base class uses
// absl::Status)
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_ERROR_UTIL_H_
