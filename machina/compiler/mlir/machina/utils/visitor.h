...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_VISITOR_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_VISITOR_H_
...
mlir::WalkResult WalkReachableFunctions(
    ...
    toolchain::function_ref<mlir::WalkResult(mlir::func::FuncOp)> callback,
...
mlir::FailureOr<mlir::OwningOpRef<mlir::ModuleOp>> CreatePrunedModule(
    mlir::ModuleOp module, toolchain::ArrayRef<toolchain::StringRef> function_names);

}  // namespace TF
}  // namespace mlir

#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_VISITOR_H_
