...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_UTILS_MACHINA_MACHINA_XLA_SHARDING_UTIL_H_
#define MACHINA_COMPILER_MLIR_MACHINA_UTILS_MACHINA_MACHINA_XLA_SHARDING_UTIL_H_
...
inline constexpr toolchain::StringRef kInputShardingAttr =
    "input_sharding_configuration";
inline constexpr toolchain::StringRef kOutputShardingAttr =
    "output_sharding_configuration";

inline constexpr toolchain::StringRef kICIWeightDistributionMlirBridgeMarker =
...
mlir::LogicalResult GetOutputTypesForLogicalDeviceComputation(
    int core_id, toolchain::ArrayRef<xla::OpSharding> output_sharding_config,
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_UTILS_MACHINA_MACHINA_XLA_SHARDING_UTIL_H_
