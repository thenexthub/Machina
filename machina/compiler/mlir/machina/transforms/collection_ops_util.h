...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_COLLECTION_OPS_UTIL_H_
#define MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_COLLECTION_OPS_UTIL_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_COLLECTION_OPS_UTIL_H_
