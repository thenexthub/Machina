...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_REWRITE_UTIL_H_
#define MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_REWRITE_UTIL_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_REWRITE_UTIL_H_
