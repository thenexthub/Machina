...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_SPARSECORE_SPARSECORE_PASSES_H_
#define MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_SPARSECORE_SPARSECORE_PASSES_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_SPARSECORE_SPARSECORE_PASSES_H_
