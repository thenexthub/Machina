...
TF::StatefulPartitionedCallOp MakeFuncCaller(
    ...
    const toolchain::SetVector<Value>& operands) {
...
TF::StatefulPartitionedCallOp EncapsulateOpsInFunc(
    OpBuilder& builder, const toolchain::SetVector<Operation*>& ops,
...
LogicalResult ExtractOpsAsFunc(
    OpBuilder& builder, ModuleOp module, toolchain::SetVector<Operation*>& ops,
