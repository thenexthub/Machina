...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_CLUSTER_OPS_BY_POLICY_H_
#define MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_CLUSTER_OPS_BY_POLICY_H_
...
class ValuesConstraintSet {
  using ConstraintsMap = toolchain::SmallDenseMap<Value, ValueConstraint>;
 ...
 public:
  ...
  void Walk(toolchain::function_ref<void(Value, ValueConstraint)> walk) const;
 ...
 private:
  toolchain::SmallDenseMap<Value, ValueConstraint> constraints_;
};
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_TRANSFORMS_CLUSTER_OPS_BY_POLICY_H_
