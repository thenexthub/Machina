...
There is a fair amount of setup needed to initialize machina and get it
...
from machina.python import pywrap_mlir  # pylint: disable=g-direct-machina-import
...
# after absl and machina have run various initialization steps.
