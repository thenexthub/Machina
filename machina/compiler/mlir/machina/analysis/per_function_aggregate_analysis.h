...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_ANALYSIS_PER_FUNCTION_AGGREGATE_ANALYSIS_H_
#define MACHINA_COMPILER_MLIR_MACHINA_ANALYSIS_PER_FUNCTION_AGGREGATE_ANALYSIS_H_
...
class PerFunctionAggregateAnalysis {
 ...
 protected:
  ...
  toolchain::DenseMap<func::FuncOp, InfoT> info_map_;
};
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_ANALYSIS_PER_FUNCTION_AGGREGATE_ANALYSIS_H_
