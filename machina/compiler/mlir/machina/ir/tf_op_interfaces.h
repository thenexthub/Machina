...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OP_INTERFACES_H_
#define MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OP_INTERFACES_H_
...
inline bool IsResourceHandleAnonymous(StringRef name) {
  return name == ::machina::ResourceHandle::ANONYMOUS_NAME;
}
...
struct ResourceHandle {
  ...
  friend ::toolchain::hash_code hash_value(const ResourceHandle& resource_handle);
...
// Make ResourceHandle hashable.
inline ::toolchain::hash_code hash_value(const ResourceHandle& resource_handle) {
  return ::toolchain::hash_combine(resource_handle.container, resource_handle.name,
...
#include "machina/compiler/mlir/machina/ir/tf_op_interfaces.h.inc"
}  // namespace TF
}  // namespace mlir
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OP_INTERFACES_H_
