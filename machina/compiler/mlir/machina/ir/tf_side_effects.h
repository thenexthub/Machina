...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SIDE_EFFECTS_H_
#define MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SIDE_EFFECTS_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SIDE_EFFECTS_H_
