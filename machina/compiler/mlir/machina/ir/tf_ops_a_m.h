...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_A_M_H_
#define MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_A_M_H_
...
// purpose is to catch bug on `machina::mutex_lock`. We don't use
// `machina::mutex_lock` here but we have ops (`tf.MutexLock` and
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_A_M_H_
