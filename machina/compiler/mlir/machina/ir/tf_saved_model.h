...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SAVED_MODEL_H_
#define MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SAVED_MODEL_H_
...
#include "machina/compiler/mlir/machina/ir/tf_saved_model.h.inc"
...
T LookupBoundInputOfType(func::FuncOp func, int arg_index,
                         const SymbolTable &symbol_table) {
  return toolchain::dyn_cast_or_null<T>(
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_IR_TF_SAVED_MODEL_H_
