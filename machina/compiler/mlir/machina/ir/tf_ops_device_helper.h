...
#ifndef MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_DEVICE_HELPER_H_
#define MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_DEVICE_HELPER_H_
...
#endif  // MACHINA_COMPILER_MLIR_MACHINA_IR_TF_OPS_DEVICE_HELPER_H_
