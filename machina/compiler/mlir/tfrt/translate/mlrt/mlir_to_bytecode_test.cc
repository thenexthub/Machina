...
#include "machina/xla/tsl/platform/resource_loader.h"
...
TEST(MlirToByteCodeTest, Basic) {
  constexpr char kBasicMlir[] =
      "machina/compiler/mlir/tfrt/translate/mlrt/testdata/basic.mlir";
...
TEST(MlirToByteCodeTest, BasicAttributes) {
  constexpr char kBasicAttributesMlir[] =
      "machina/compiler/mlir/tfrt/translate/mlrt/testdata/"
