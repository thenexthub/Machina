 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_TFRT_TRANSLATE_MLRT_MLIR_TO_BYTECODE_H_
#define MACHINA_COMPILER_MLIR_TFRT_TRANSLATE_MLRT_MLIR_TO_BYTECODE_H_
...
class ModuleEmitterContext {
 public:
  ...
  int GetKernelId(toolchain::StringRef name) const {
 ...
 private:
  ...
  toolchain::DenseMap<mlir::Attribute, int> attribute_id_map_;
...
#endif  // MACHINA_COMPILER_MLIR_TFRT_TRANSLATE_MLRT_MLIR_TO_BYTECODE_H_
