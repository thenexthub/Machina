...
class TPUCompileMlirAndExecuteOpPreParallelizationConversion
 ...
 public:
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<int> constant_operand_indices;
    toolchain::SmallVector<int> non_constant_operand_indices;
    ...
    toolchain::SmallVector<mlir::Value> operands = adaptor.getArgs();
    ...
    toolchain::SmallVector<int32_t> operands_with_static_shapes;
    ...
    if (use_tpu_host_allocator_for_inputs_) {
      toolchain::DenseMap<mlir::Operation*, mlir::Operation*> replaced_ops;
