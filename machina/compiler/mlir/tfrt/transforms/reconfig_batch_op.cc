...
class ReconfigBatchOpPass
 ...
 private:
  toolchain::StringRef getArgument() const final { return "tfrt-reconfig-batch-op"; }
 ...
 protected:
  ...
  mlir::Pass::Option<int64_t> max_enqueued_batches_{
      *this, "tfrt-max-enqueued-batches", toolchain::cl::init(0),
  ...
  mlir::Pass::Option<int64_t> batch_queue_global_prioritization_num_threads_{
      *this, "tfrt-batch-queue-global-prioritization-num-threads",
      toolchain::cl::init(0),
      toolchain::cl::desc("If non-zero, all models on this server are switched to "
