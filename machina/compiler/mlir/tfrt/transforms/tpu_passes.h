...
#ifndef MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_TPU_PASSES_H_
#define MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_TPU_PASSES_H_
...
struct TfrtTpuCompileOptions
  ...
  Option<bool> move_resource_gather_to_host{
      *this, "move-resource-gather-to-host",
      toolchain::cl::desc("Move resource gather ops to host"),
...
#endif  // MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_TPU_PASSES_H_
