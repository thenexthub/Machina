...
#ifndef MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_CORERT_CONVERTER_H_
#define MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_CORERT_CONVERTER_H_
...
class CoreRTConverter : public mlir::TypeConverter {
 public:
  ...
  std::optional<ParseDeviceNameResult> ParseDeviceName(
      toolchain::StringRef device_name) const;
  std::optional<ParseDeviceNameResult> ParseDeviceName(
  ...
  // device value.
  mlir::Value ConvertOpHandler(mlir::Operation *op, toolchain::StringRef device_name,
 ...
 private:
  ...
  bool IsUnusedAttribute(toolchain::StringRef name) const {
  ...
  toolchain::DenseMap<mlir::Operation *, mlir::Value> local_side_effect_chains_;
  toolchain::DenseMap<mlir::Operation *, mlir::Value> distributed_context_by_func_;
  toolchain::DenseMap<mlir::Operation *, mlir::Value> remote_chain_mgr_by_func_;
  toolchain::DenseMap<mlir::Operation *, toolchain::StringMap<mlir::Value>>
      task_handles_by_func_;
  toolchain::StringMap<mlir::Value> op_handler_by_name_;
};

}  // namespace machina

#endif  // MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_CORERT_CONVERTER_H_
