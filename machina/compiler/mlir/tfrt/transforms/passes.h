...
#ifndef MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_PASSES_H_
#define MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_PASSES_H_
...
struct ReconfigBatchOpPassOptions {
  ...
  toolchain::ArrayRef<int64_t> allowed_batch_sizes = {};
...
#endif  // MACHINA_COMPILER_MLIR_TFRT_TRANSFORMS_PASSES_H_
