...
struct OpWithSameArgsInfo : toolchain::DenseMapInfo<mlir::Operation *> {
  static unsigned getHashValue(const mlir::Operation *const_op) {
    ...
    return toolchain::hash_combine(
        toolchain::hash_combine_range(op->operand_begin(), op->operand_end()));
  }
...
class MergeTfIfOpsPass
  ...
  toolchain::StringRef getArgument() const final { return "tfrt-merge-tf-if-ops"; }
  ...
  bool ProcessFunction(mlir::func::FuncOp op, int iteration) {
    ...
    toolchain::SmallDenseMap<mlir::Operation *, toolchain::SmallVector<mlir::TF::IfOp, 2>,
    ...
    toolchain::SmallVector<mlir::TF::IfOp, 4> if_ops_to_remove;
  ...
  void MergeIfOpsWithSameArgs(mlir::OpBuilder &builder, mlir::Location loc,
                              ...
                              toolchain::MutableArrayRef<mlir::TF::IfOp> if_ops) {
  ...
  toolchain::StringRef CreateBranchFunction(
      ...
      toolchain::ArrayRef<mlir::TF::IfOp> if_ops,
      toolchain::function_ref<mlir::FlatSymbolRefAttr(mlir::TF::IfOp)> get_branch) {
