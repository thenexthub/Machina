...
#include "machina/compiler/mlir/tfrt/transforms/corert_converter.h"
...
toolchain::SmallVector<mlir::Value, 4> AddGpuVariableAndInputTensorTransferOps(
    mlir::Operation *op, toolchain::SmallVector<mlir::Value, 4> operands,
    mlir::ConversionPatternRewriter &rewriter) {
  toolchain::SmallVector<mlir::Value, 4> new_operands;
...
toolchain::SmallVector<mlir::Value, 4> AddGpuTransferFromDeviceOps(
    mlir::Operation *op, toolchain::SmallVector<mlir::Value, 4> results,
    mlir::ConversionPatternRewriter &rewriter) {
  assert(results.size() == op->getNumResults());
  toolchain::SmallVector<mlir::Value, 4> new_results;
...
mlir::ArrayAttr ToArrayAttr(const toolchain::SmallVector<int, 4> &int_collection,
  ...
  return builder.getArrayAttr(toolchain::ArrayRef(array_attr));
}
 ...
 public:
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    const auto &xla_compile_device_type =
        op->getAttrOfType<mlir::StringAttr>(machina::kCompileDeviceTypeAttr);
    ...
    if (xla_compile_device_type.getValue().str() != machina::kGpuDevice) {
      return failure();
    }

    toolchain::SmallVector<int, 4> resource_indices;
    for (int idx : toolchain::seq<int>(0, adaptor.getArgs().size())) {
    ...
    toolchain::SmallVector<int, 4> used_output_indices;
    ...
    toolchain::SmallVector<Type, 4> result_types(
...
class FallbackExecuteOpConversion : public mlir::ConversionPattern {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<mlir::StringAttr, 4> func_attr_keys;
    ...
    bool is_tpu_op = op->hasAttr("_tpu_replicate") ||
                     toolchain::isa<mlir::TF::TPUReplicatedInputOp,
 ...
 private:
  ...
  bool UseFallback(mlir::Operation *op) const {
    ...
    return !toolchain::isa<mlir::TF::_TfrtSetResourceOp,
  ...
  bool IsTpuCompileAndExecuteOps(mlir::Operation *op) const {
    return toolchain::isa<mlir::TF::_TPUCompileMlirOp,
  ...
  mlir::LogicalResult ConvertToCoreRTExecuteOp(
      mlir::Operation *op, ValueRange operands, toolchain::StringRef op_handler_name,
      mlir::ArrayAttr op_attrs, mlir::ArrayAttr op_func_attrs,
      mlir::StringAttr op_name,
      mlir::ConversionPatternRewriter &rewriter) const;
...
class FallbackGetResourceOp
 ...
 public:
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<mlir::Type, 4> result_types(
        op.getNumResults(), rewriter.getType<tfrt::fallback::TFTensorType>());
...
class TFDeviceRemoteRunOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<mlir::Value, 4> arguments;
...
class FallbackBatchFunctionOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<NamedAttribute, 12> attr_array;
...
class TFRTFuncOpSignatureConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<mlir::DictionaryAttr, 4> arg_attrs;
    ...
    toolchain::SmallVector<mlir::DictionaryAttr, 4> result_attrs;
...
class TFRTReturnOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter &rewriter) const override {
    toolchain::SmallVector<mlir::Value, 2> new_operands;
...
class TFRTCaseOpConversion : public mlir::OpConversionPattern<TF::CaseOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<mlir::Value, 4> branch_operands;
...
class TFRTWhileOpConversion
 ...
 public:
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    toolchain::SmallVector<Type, 4> while_arg_result_types;
    ...
    toolchain::SmallVector<mlir::Value, 4> pred_args;
    pred_args.push_back(
...
mlir::func::FuncOp TFRTWhileOpConversion::GetPredicateFunction(
  ...
  toolchain::SmallVector<mlir::Value, 2> results = {chain, bool_cond};
...
mlir::func::FuncOp TFRTWhileOpConversion::GetWhileBodyFunction(
  ...
  toolchain::SmallVector<mlir::Type, 4> body_result_types(arg_types.begin(),
                                                     arg_types.end());
  ...
  toolchain::SmallVector<mlir::Value, 4> body_results;
  ...
  for (auto res : toolchain::drop_begin(call_original_body_fn.getResults())) {
...
class TfToTfrtConversionPass
  ...
  toolchain::StringRef getArgument() const final { return "tf-to-tfrt"; }
 ...
 public:
  ...
  void runOnOperation() override {
    ...
    toolchain::SmallVector<mlir::func::FuncOp, 4> func_ops(func_op_range.begin(),
                                                      func_op_range.end());
 ...
 private:
  ...
  void ChainDanglingValuesinFunction(mlir::func::FuncOp func_op) {
    ...
    toolchain::SmallVector<mlir::Value, 2> dangling_values;
    ...
    auto return_op =
        toolchain::cast<tfrt::compiler::ReturnOp>(block.getTerminator());
  ...
  int64_t GetNumArgs(mlir::Operation *fallback_op) {
    if (auto execute_op =
            toolchain::dyn_cast<tfrt::fallback_async::ExecuteOp>(fallback_op)) {
      return execute_op.getArgs().size();
    } else if (auto execute_op_seq =
                   toolchain::dyn_cast<tfrt::fallback_async::ExecuteOpSeq>(
                       fallback_op)) {
      return execute_op_seq.getArgs().size();
    } else if (auto execute_op_allocator =
                   toolchain::dyn_cast<tfrt::fallback_async::ExecuteOpWithAllocator>(
                       fallback_op)) {
      return execute_op_allocator.getArgs().size();
    } else if (auto execute_op_seq_allocator = toolchain::dyn_cast<
  ...
  Option<bool> tpu_lower_to_fallback_{
      *this, "tpu-lower-to-fallback",
      toolchain::cl::desc("If true, lower a TF op that's placed on TPU device "
