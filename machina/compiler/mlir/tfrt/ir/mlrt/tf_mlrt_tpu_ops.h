 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_TFRT_IR_MLRT_TF_MLRT_TPU_OPS_H_
#define MACHINA_COMPILER_MLIR_TFRT_IR_MLRT_TF_MLRT_TPU_OPS_H_
...
class TensorflowMlrtTpuDialect : public mlir::Dialect {
 public:
  ...
  static toolchain::StringRef getDialectNamespace() { return "tf_mlrt_tpu"; }
};
...
#include "machina/compiler/mlir/tfrt/ir/mlrt/tf_mlrt_tpu_ops.h.inc"

#endif  // MACHINA_COMPILER_MLIR_TFRT_IR_MLRT_TF_MLRT_TPU_OPS_H_
