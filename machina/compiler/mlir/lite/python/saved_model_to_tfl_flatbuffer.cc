...
#include "machina/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.h"
...
absl::Status HandleInputOutputArraysWithModule(
  ...
  toolchain::SmallVector<toolchain::StringRef, 4> function_input_names;
  ...
  toolchain::StringSet<> function_input_names_set;
  ...
  toolchain::SmallVector<toolchain::StringRef, 4> function_output_names;
  ...
  toolchain::StringSet<> function_output_names_set;
...
absl::Status ConvertSavedModelToTFLiteFlatBuffer(
  ...
  if (converter_flags.strict_qdq_mode()) {
    ...
    pass_config.quant_specs.inference_type = machina::DT_QINT8;
