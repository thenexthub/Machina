 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_LITE_METRICS_ERROR_COLLECTOR_INST_H_
#define MACHINA_COMPILER_MLIR_LITE_METRICS_ERROR_COLLECTOR_INST_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_METRICS_ERROR_COLLECTOR_INST_H_
