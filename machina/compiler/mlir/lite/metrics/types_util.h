...
#ifndef MACHINA_COMPILER_MLIR_LITE_METRICS_TYPES_UTIL_H_
#define MACHINA_COMPILER_MLIR_LITE_METRICS_TYPES_UTIL_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_METRICS_TYPES_UTIL_H_
