...
#ifndef MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_COMPOSITE_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_COMPOSITE_UTILS_H_
...
std::optional<bool> GetBoolFromCompositeAttr(
    const DictionaryAttr& composite_attrs, toolchain::StringRef attr_name);
...
#endif  // MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_COMPOSITE_UTILS_H_
