...
LogicalResult MatchReduceToArgMinMaxType2(mhlo::ReduceOp reduce_op,
  ...
  mhlo::SelectOp value_select = toolchain::dyn_cast_or_null<mhlo::SelectOp>(
  ...
  mhlo::CompareOp value_gt = toolchain::dyn_cast_or_null<mhlo::CompareOp>(
  ...
  mhlo::SelectOp index_select = toolchain::dyn_cast_or_null<mhlo::SelectOp>(
      return_op.getOperand(1).getDefiningOp());
  if (!index_select) return failure();

  mhlo::MinOp index_select_min = toolchain::dyn_cast_or_null<mhlo::MinOp>(
  ...
  mhlo::SelectOp index_select_select = toolchain::dyn_cast_or_null<mhlo::SelectOp>(
  ...
  mhlo::CompareOp value_eq = toolchain::dyn_cast_or_null<mhlo::CompareOp>(
...
LogicalResult MatchReduceToArgMinMaxType1(mhlo::ReduceOp reduce_op,
  ...
  if (is_float) {
    mhlo::OrOp value_or = toolchain::dyn_cast_or_null<mhlo::OrOp>(
        value_select.getOperand(0).getDefiningOp());
    ...
    mhlo::CompareOp value_ne = toolchain::dyn_cast_or_null<mhlo::CompareOp>(
  ...
  mhlo::OrOp index_or = toolchain::dyn_cast_or_null<mhlo::OrOp>(
  ...
  mhlo::AndOp index_and =
      toolchain::dyn_cast_or_null<mhlo::AndOp>(index_or.getRhs().getDefiningOp());
  ...
  mhlo::CompareOp index_lt = toolchain::dyn_cast_or_null<mhlo::CompareOp>(
