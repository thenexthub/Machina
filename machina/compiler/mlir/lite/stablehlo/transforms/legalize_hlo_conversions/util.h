...
#ifndef MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_LEGALIZE_HLO_CONVERSIONS_UTIL_H_
#define MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_LEGALIZE_HLO_CONVERSIONS_UTIL_H_
...
Value BuildIntArrayConstOp(ImplicitLocOpBuilder& builder,
  ...
  if (type == rewriter.getI64Type()) {
    ...
    toolchain::SmallVector<int32_t> const_i32_vec;
...
#endif  // MACHINA_COMPILER_MLIR_LITE_STABLEHLO_TRANSFORMS_LEGALIZE_HLO_CONVERSIONS_UTIL_H_
