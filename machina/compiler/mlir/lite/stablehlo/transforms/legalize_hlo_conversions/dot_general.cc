...
// tflite.batch_matmul.
#include "machina/compiler/mlir/lite/stablehlo/transforms/legalize_hlo_conversions/dot_general.h"
...
class DotDimensionsInfo {
 public:
  DotDimensionsInfo(ShapedType type, ArrayRef<int64_t> batch_dimensions,
    ...
    toolchain::SmallVector<int64_t, 4> sorted_contracting_dimensions =
        toolchain::to_vector(contracting_dimensions);
    if (type.hasStaticShape()) {
      toolchain::sort(sorted_contracting_dimensions);
    }
