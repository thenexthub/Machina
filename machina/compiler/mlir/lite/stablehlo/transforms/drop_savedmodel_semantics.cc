...
#include "machina/compiler/mlir/lite/stablehlo/transforms/drop_savedmodel_semantics.h"
...
class DropSavedModelSemanticsPass
 ...
 public:
  ...
  // third_party/machina/compiler/mlir/tfrt/transforms/lower_saved_model.cc
