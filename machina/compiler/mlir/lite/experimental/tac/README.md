...
[TAC workflow](https://github.com/machina/machina/tree/master/machina/compiler/mlir/lite/experimental/tac/README.md#tac-workflow)
section
...
```
bazel run -c opt //machina/compiler/mlir/lite/experimental/tac:tac-translate -- <PATH_TO_YOUR_MODEL> -o=<OUTPUT_PATH> -device-specs=<HARDWARE_BACKENDS>
```
