 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_TAC_PASS_H_
#define MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_TAC_PASS_H_
...
class TacFunctionPass : public TacPass<func::FuncOp> {
 ...
 protected:
  ...
  StringRef getName() const override { return toolchain::getTypeName<T>(); }
...
#endif  // MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_TAC_PASS_H_
