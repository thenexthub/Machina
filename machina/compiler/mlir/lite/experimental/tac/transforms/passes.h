...
#ifndef MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_PASSES_H_
#define MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_PASSES_H_
...
std::unique_ptr<OperationPass<ModuleOp>> CreateTacFilterPass(
    ::third_party::machina::compiler::mlir::lite::experimental::tac::
...
#endif  // MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_TRANSFORMS_PASSES_H_
