...
#ifndef MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_COMMON_TARGETS_H_
#define MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_COMMON_TARGETS_H_
...
inline InferenceType GetInferenceTypeEnum(toolchain::StringRef inference_type_str) {
...
inline std::optional<InferenceType> GetInferenceTypeAnnotation(Operation* op) {
  ...
  toolchain::StringRef device_name_str = inference_type.getValue();
...
#endif  // MACHINA_COMPILER_MLIR_LITE_EXPERIMENTAL_TAC_COMMON_TARGETS_H_
