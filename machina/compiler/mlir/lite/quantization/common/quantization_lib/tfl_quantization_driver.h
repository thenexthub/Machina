...
#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_TFL_QUANTIZATION_DRIVER_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_TFL_QUANTIZATION_DRIVER_H_
...
class QuantizationDriver {
 public:
  ...
  toolchain::DenseMap<std::pair<mlir::Operation*, int>, int> GetResultStates() {
 ...
 private:
  ...
  // different ops.
  bool IsWeight(Operation* cst) { return toolchain::is_contained(weights_, cst); }
...
#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_TFL_QUANTIZATION_DRIVER_H_
