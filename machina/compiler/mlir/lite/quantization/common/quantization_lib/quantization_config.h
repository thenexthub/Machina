...
#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_QUANTIZATION_CONFIG_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_QUANTIZATION_CONFIG_H_
...
struct QuantizationSpecs {
  ...
  machina::DataType inference_type = machina::DT_FLOAT;
  ...
  // in the result model.
  machina::DataType inference_input_type = machina::DT_FLOAT;
  ...
  bool RunPropagationAndRewriteQuantizationPasses() const {
    return inference_type != machina::DT_FLOAT && !weight_quantization;
  }
  ...
  bool RunAndRewriteDynamicRangeQuantizationPasses() const {
    bool dynamic_range_quantize =
        (inference_type != machina::DT_FLOAT) && weight_quantization &&
...
#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_QUANTIZATION_LIB_QUANTIZATION_CONFIG_H_
