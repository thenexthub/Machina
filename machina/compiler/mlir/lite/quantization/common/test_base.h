...
#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_TEST_BASE_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_TEST_BASE_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_COMMON_TEST_BASE_H_
