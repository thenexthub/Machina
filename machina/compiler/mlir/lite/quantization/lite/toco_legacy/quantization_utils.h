...
// third_party/machina/lite/tools/optimize/quantization_utils.h as part of
// the effort to decouple TFLite from MLIR.

#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_QUANTIZATION_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_QUANTIZATION_UTILS_H_
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:num_elements)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:fill_per_channel_min_max)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:symmetric_per_channel_quantization)
...
void SymmetricPerChannelQuantizeValues(const float* input,
                                       ...
                                       int32_t channel_dim_index,
                                       std::vector<int8_t>* output_value);
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:symmetric_per_channel_quantize_values)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:symmetric_quantize_tensor)
...
absl::Status SymmetricQuantizeTensorPerChannel(ModelT* model, TensorT* tensor,
                                               int32_t channel_dim_index);
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:symmetric_quantize_tensor_per_channel)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:quantize_tensor_float16)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.h:add_quantization_params)

}  // namespace toco_legacy
}  // namespace lite
}  // namespace mlir

#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_QUANTIZATION_UTILS_H_
