...
// third_party/machina/lite/tools/optimize/quantization_utils.cc as part of
// the effort to decouple TFLite from MLIR.

#include "machina/compiler/mlir/lite/quantization/lite/toco_legacy/quantization_utils.h"
...
#include "machina/compiler/mlir/lite/kernels/internal/runtime_shape.h"
#include "machina/compiler/mlir/lite/quantization/lite/toco_legacy/model_utils.h"
#include "machina/compiler/mlir/lite/quantization/lite/toco_legacy/portable_tensor_utils.h"
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:QuantizationUtilsConstants)
}  // namespace
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:NumElements)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:FillPerChannelMinMax)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:SymmetricPerChannelQuantization)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:SymmetricPerChannelQuantizeValues)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:SymmetricQuantizeTensor)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:QuantizeTensorFloat16)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:AddQuantizationParams)
...
// LINT.ThenChange(//machina/lite/tools/optimize/quantization_utils.cc:SymmetricQuantizeTensorPerChannel)
