...
// third_party/machina/lite/tools/optimize/model_utils.h as part of the
// effort to decouple TFLite from MLIR.

#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_MODEL_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_MODEL_UTILS_H_
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.h:MakeDequantizeOperator)
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.h:MakeTensor)

// LINT.IfChange(HasMinMax)
bool HasMinMax(const TensorT* tensor);
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.h:HasMinMax)

}  // namespace toco_legacy
}  // namespace lite
}  // namespace mlir

#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_LITE_TOCO_LEGACY_MODEL_UTILS_H_
