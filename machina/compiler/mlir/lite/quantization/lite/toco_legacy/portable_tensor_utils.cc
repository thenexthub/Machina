...
// third_party/machina/lite/kernels/internal/reference/portable_tensor_utils.cc
...
// LINT.ThenChange(//machina/lite/kernels/internal/reference/portable_tensor_utils.cc:portable_symmetric_quantize_floats)
