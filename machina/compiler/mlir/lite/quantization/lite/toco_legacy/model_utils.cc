...
// third_party/machina/lite/tools/optimize/model_utils.cc as part of the
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.cc:GetOrInsertOpCodeIndex)
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.cc:MakeDequantizeOperator)
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.cc:MakeTensor)
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils.cc:HasMinMax)
