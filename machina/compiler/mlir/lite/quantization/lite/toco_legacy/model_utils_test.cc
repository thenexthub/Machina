...
// third_party/machina/lite/tools/optimize/model_utils_test.cc as part of the
...
// LINT.ThenChange(//machina/lite/tools/optimize/model_utils_test.cc:HasMinMaxTest)
