...
#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_MACHINA_PASSES_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_MACHINA_PASSES_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_MACHINA_PASSES_H_
