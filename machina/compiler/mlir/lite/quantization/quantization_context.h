...
#ifndef MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_QUANTIZATION_CONTEXT_H_
#define MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_QUANTIZATION_CONTEXT_H_
...
class QuantizeContext {
 public:
  ...
  LogicalResult Handle(quantfork::QuantizeRegionOp op,
                       toolchain::SmallVectorImpl<Operation *> *new_items,
                       bool *changed);
 ...
 private:
  class StatesManager {
   ...
   private:
    ...
    toolchain::DenseMap<OpValue, int> operand_states_;
    toolchain::DenseMap<OpValue, int> result_states_;
  };
...
#endif  // MACHINA_COMPILER_MLIR_LITE_QUANTIZATION_QUANTIZATION_CONTEXT_H_
