...
#ifndef MACHINA_COMPILER_MLIR_LITE_CORE_MACROS_H_
#define MACHINA_COMPILER_MLIR_LITE_CORE_MACROS_H_
...
// LINT.ThenChange(//machina/lite/core/macros.h)

#endif  // MACHINA_COMPILER_MLIR_LITE_CORE_MACROS_H_
