...
#ifndef MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_TRANSLATE_FLAGS_H_
#define MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_TRANSLATE_FLAGS_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_TRANSLATE_FLAGS_H_
