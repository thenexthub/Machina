 ...
 *
 */
#ifndef MACHINA_COMPILER_MLIR_LITE_KERNELS_INTERNAL_UTILS_SPARSITY_FORMAT_CONVERTER_H_
#define MACHINA_COMPILER_MLIR_LITE_KERNELS_INTERNAL_UTILS_SPARSITY_FORMAT_CONVERTER_H_

#include <vector>

#include "Eigen/Core"  // from @eigen_archive
#include "machina/compiler/mlir/lite/core/c/tflite_types.h"
...
// LINT.ThenChange(//machina/lite/kernels/internal/utils/sparsity_format_converter.h)

}  // namespace sparsity
}  // namespace internal
}  // namespace tflite_migration

#endif  // MACHINA_COMPILER_MLIR_LITE_KERNELS_INTERNAL_UTILS_SPARSITY_FORMAT_CONVERTER_H_
