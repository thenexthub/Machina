...
#ifndef MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_EXPORT_H_
#define MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_EXPORT_H_
...
struct FlatbufferExportOptions {
  ...
  machina::OpOrArgNameMapper* op_or_arg_name_mapper = nullptr;
...
#endif  // MACHINA_COMPILER_MLIR_LITE_FLATBUFFER_EXPORT_H_
