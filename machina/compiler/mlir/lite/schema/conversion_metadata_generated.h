...
struct Environment FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_MACHINA_VERSION = 4,
    VT_API_VERSION = 6,
    VT_MODEL_TYPE = 8
  };
  const ::flatbuffers::String *machina_version() const {
    return GetPointer<const ::flatbuffers::String *>(VT_MACHINA_VERSION);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_MACHINA_VERSION) &&
           verifier.VerifyString(machina_version()) &&
...
struct EnvironmentBuilder {
  ...
  void add_machina_version(::flatbuffers::Offset<::flatbuffers::String> machina_version) {
    fbb_.AddOffset(Environment::VT_MACHINA_VERSION, machina_version);
  }
...
inline ::flatbuffers::Offset<Environment> CreateEnvironment(
    ...
    ::flatbuffers::Offset<::flatbuffers::String> machina_version = 0,
    uint32_t api_version = 0,
    tflite::ModelType model_type = tflite::ModelType_NONE) {
  EnvironmentBuilder builder_(_fbb);
  builder_.add_model_type(model_type);
  builder_.add_api_version(api_version);
  builder_.add_machina_version(machina_version);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<Environment> CreateEnvironmentDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const char *machina_version = nullptr,
    uint32_t api_version = 0,
    tflite::ModelType model_type = tflite::ModelType_NONE) {
  auto machina_version__ = machina_version ? _fbb.CreateString(machina_version) : 0;
...
inline void Environment::UnPackTo(EnvironmentT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = machina_version(); if (_e) _o->machina_version = _e->str(); }
...
inline ::flatbuffers::Offset<Environment> CreateEnvironment(::flatbuffers::FlatBufferBuilder &_fbb, const EnvironmentT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _machina_version = _o->machina_version.empty() ? 0 : _fbb.CreateString(_o->machina_version);
