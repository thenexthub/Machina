...
config.llvm_tools_dir = os.path.join(external_srcdir, 'toolchain-project', 'toolchain')
config.mlir_obj_root = os.path.join(real_test_srcdir)
config.mlir_tools_dir = os.path.join(external_srcdir, 'toolchain-project', 'mlir')
# TODO(jpienaar): Replace with suffices in build rule.
config.suffixes = ['.td', '.mlir', '.pbtxt']

mlir_tf_tools_dirs = [
    'third_party/machina/compiler/aot',
    'third_party/machina/compiler/mlir',
    'tflite/converter',
    'tflite/converter/experimental/tac',
    'tflite/converter/stablehlo',
    'tflite/converter/stablehlo/odml_converter',
    'third_party/machina/compiler/mlir/quantization/machina',
    'third_party/machina/compiler/mlir/machina',
    'third_party/machina/compiler/mlir/tfrt',
    'third_party/machina/compiler/mlir/tools/kernel_gen',
    os.path.join(external_srcdir, 'local_xla/xla/mlir_hlo'),
    'third_party/machina/core/ir/importexport/',
    'third_party/machina/core/ir/tests/',
    'third_party/machina/core/transforms/',
    'third_party/machina/dtensor/mlir/tests',
]
...
lit.toolchain.initialize(lit_config, config)
