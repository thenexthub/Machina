...
#ifndef MACHINA_COMPILER_MLIR_LITE_UTILS_LSTM_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_UTILS_LSTM_UTILS_H_
...
class ConvertLSTMCellSimpleToFusedLSTM {
 public:
  ...
  virtual toolchain::StringRef GetCompositeOpName() { return kLstmCellSimple; }
...
class ConvertLayerNormalizedLSTMCellSimpleToFusedLSTM
 ...
 public:
  ...
  toolchain::StringRef GetCompositeOpName() override {
...
#endif  // MACHINA_COMPILER_MLIR_LITE_UTILS_LSTM_UTILS_H_
