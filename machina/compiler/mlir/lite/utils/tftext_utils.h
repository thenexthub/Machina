...
#ifndef MACHINA_COMPILER_MLIR_LITE_UTILS_TFTEXT_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_UTILS_TFTEXT_UTILS_H_
...
LogicalResult ConvertTFTextAPI(mlir::func::FuncOp func, toolchain::StringRef api,
