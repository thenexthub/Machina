...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_DENSE_TO_SPARSE_PASS_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_DENSE_TO_SPARSE_PASS_H_
...
class DenseToSparsePass
 ...
 public:
  ...
  static toolchain::StringRef GetArgument() { return "tfl-dense-to-sparse"; }
  ...
  static toolchain::StringRef GetName() { return "DenseToSparsePass"; }
...
#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_DENSE_TO_SPARSE_PASS_H_
