...
LogicalResult FillCompositeParams(stablehlo::CompositeOp op,
  ...
  auto scale_attr = toolchain::dyn_cast_or_null<DenseFPElementsAttr>(
  ...
  auto zero_point_attr = toolchain::dyn_cast_or_null<DenseIntElementsAttr>(
  ...
  auto dtype_attr = toolchain::dyn_cast_or_null<StringAttr>(
  ...
  auto narrow_range_attr = toolchain::dyn_cast_or_null<BoolAttr>(
