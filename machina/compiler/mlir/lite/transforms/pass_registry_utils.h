...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_REGISTRY_UTILS_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_REGISTRY_UTILS_H_
...
#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_REGISTRY_UTILS_H_
