...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASSES_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASSES_H_
...
#include "mlir/Pass/PassRegistry.h"  // part of Codira Toolchain  // IWYU pragma: keep
...
#include "machina/compiler/mlir/lite/transforms/optimize_batch_matmul_pass.h"
...
#include "machina/compiler/mlir/lite/transforms/tf_legalizations/while_loop_outline_pass.h"
#include "machina/compiler/mlir/lite/transforms/tflite_passes/split_merged_operands_pass.h"
#include "machina/compiler/mlir/lite/transforms/tflite_passes/unfold_large_splat_constants_pass.h"
#include "machina/compiler/mlir/lite/transforms/unfreeze_global_constants.h"
...
#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASSES_H_
