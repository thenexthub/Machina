...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_OPTIMIZE_BROADCAST_LIKE_PASS_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_OPTIMIZE_BROADCAST_LIKE_PASS_H_
...
class OptimizeBroadcastLikePass
 ...
 public:
  ...
  static toolchain::StringRef GetName() { return "OptimizeBroadcastLikePass"; }
  static toolchain::StringRef GetArgument() { return "tfl-optimize-broadcast-like"; }
...
#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_OPTIMIZE_BROADCAST_LIKE_PASS_H_
