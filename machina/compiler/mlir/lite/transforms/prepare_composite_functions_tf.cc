...
#include "machina/compiler/mlir/lite/utils/nms_utils.h"
#include "machina/compiler/mlir/lite/utils/perception_ops_utils.h"
...
LogicalResult CheckOutputConsumer(
    ...
    toolchain::DenseSet<int> expected_consumer_indices) {
...
void PrepareCompositeFunctionsPass::ConvertTFImplementsWithAttributes(
  ...
  bool enable_fuse_tftext =
      tfl_fuse_tftext_ || IsTFTextRegistered(machina::OpRegistry::Global());
