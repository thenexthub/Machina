...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_TF_LEGALIZATIONS_WHILE_LOOP_OUTLINE_PASS_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_TF_LEGALIZATIONS_WHILE_LOOP_OUTLINE_PASS_H_
...
class WhileOutlinePass : public TFL::Pass<WhileOutlinePass> {
 public:
  ...
  static toolchain::StringRef GetName() { return "WhileOutlinePass"; }
  static toolchain::StringRef GetArgument() { return "tfl-while-loop-outline"; }
 ...
 private:
  ...
  machina::OpOrArgLocNameMapper mapper_;
};
}  // namespace TFL
}  // namespace mlir

#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_TF_LEGALIZATIONS_WHILE_LOOP_OUTLINE_PASS_H_
