...
#ifndef MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_H_
#define MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_H_
...
class Pass : public PassWrapper<Pass<DerivedPass, DerivedPassOptions, OpType>,
 ...
 public:
  ...
  toolchain::StringRef getName() const override { return DerivedPass::GetName(); }
...
#endif  // MACHINA_COMPILER_MLIR_LITE_TRANSFORMS_PASS_H_
