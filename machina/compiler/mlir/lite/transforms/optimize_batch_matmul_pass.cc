...
#include "machina/compiler/mlir/lite/transforms/tflite_passes/optimize_batch_matmul_utils.h"
...
struct ConvertBatchMatMulOpToReduceSum
  ...
  LogicalResult matchAndRewrite(TFL::BatchMatMulOp bmm_op,
    ...
    toolchain::ArrayRef<int64_t> lhs_shape =
    ...
    toolchain::ArrayRef<int64_t> rhs_shape =
...
struct FuseRhsTransposeIntoBatchMatMulOp
  ...
  LogicalResult matchAndRewrite(TFL::BatchMatMulOp bmm_op,
    ...
    toolchain::SmallVector<int32_t> new_reshape_input_shape;
...
#include "machina/compiler/mlir/lite/transforms/generated_optimize_batch_matmul.inc"
}  // namespace
