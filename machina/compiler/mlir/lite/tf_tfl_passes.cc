...
#include "machina/compiler/mlir/lite/quantization/machina/passes.h"
#include "machina/compiler/mlir/lite/stablehlo/transforms/legalize_tf_xla_call_module_to_stablehlo_pass.h"
...
#include "machina/compiler/mlir/lite/transforms/pass_registry_utils.h"
#include "machina/compiler/mlir/lite/transforms/passes.h"
#include "machina/compiler/mlir/lite/transforms/variable_freezing_pipeline.h"
...
void AddPreVariableFreezingTFToTFLConversionPasses(
  ...
  raise_custom_ops_pass_options.target_ops_ = toolchain::to_vector(target_ops);
  pass_manager->addNestedPass<mlir::func::FuncOp>(
...
void AddPostVariableFreezingTFToTFLConversionPasses(
  ...
  // The machina list is not supported right now by that pass.
...
void AddTFToTFLConversionPasses(toolchain::StringRef saved_model_dir,
                                const tflite::ConverterFlags& converter_flags,
                                const mlir::TFL::PassConfig& pass_config,
                                mlir::OpPassManager* pass_manager) {
