...
#ifndef MACHINA_COMPILER_MLIR_LITE_COMMON_TFL_PASS_CONFIG_H_
#define MACHINA_COMPILER_MLIR_LITE_COMMON_TFL_PASS_CONFIG_H_
...
struct PassConfig {
  ...
  toolchain::ArrayRef<std::string> trim_functions_allowlist;
...
#endif  // MACHINA_COMPILER_MLIR_LITE_COMMON_TFL_PASS_CONFIG_H_
