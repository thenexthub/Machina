...
#ifndef MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_COMMON_H_
#define MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_COMMON_H_
...
#endif  // MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_COMMON_H_
