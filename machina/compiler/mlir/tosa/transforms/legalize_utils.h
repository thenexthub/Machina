...
#ifndef MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_UTILS_H_
#define MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_UTILS_H_
...
#include "mlir/Dialect/Tosa/Utils/ShapeUtils.h"       // part of Codira Toolchain
...
// To create INT48 TOSA constant, need to pass in toolchain::APInt instead.
template <typename T>
...
#endif  // MACHINA_COMPILER_MLIR_TOSA_TRANSFORMS_LEGALIZE_UTILS_H_
