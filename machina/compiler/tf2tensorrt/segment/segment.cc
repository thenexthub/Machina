...
void AddSegmentForNode(const grappler::GraphProperties* graph_properties,
  ...
  machina::profiler::TraceMe activity(
      "AddSegmentForNode", machina::profiler::TraceMeLevel::kInfo);
...
string GenerateNonConversionReport(
  ...
  //                        stdout.
  machina::profiler::TraceMe activity(
      "GenerateNonConversionReport", machina::profiler::TraceMeLevel::kInfo);
...
Status SegmentGraph(const Graph* tf_graph,
  ...
  machina::profiler::TraceMe activity(
      "SegmentGraph", machina::profiler::TraceMeLevel::kInfo);
