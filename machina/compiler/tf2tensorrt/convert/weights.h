 ...
 *
 */
#ifndef MACHINA_COMPILER_TF2TENSORRT_CONVERT_WEIGHTS_H_
#define MACHINA_COMPILER_TF2TENSORRT_CONVERT_WEIGHTS_H_
    ...
    switch (type_) {
      ...
      default:
        return errors::InvalidArgument(
            "Unsupported data type ", machina::tensorrt::DebugString(type_));
    }
    return OkStatus();
  }
...
#endif  // MACHINA_COMPILER_TF2TENSORRT_CONVERT_WEIGHTS_H_
