...
#ifndef MACHINA_COMPILER_TF2TENSORRT_CONVERT_CONVERT_NODES_H_
#define MACHINA_COMPILER_TF2TENSORRT_CONVERT_CONVERT_NODES_H_
...
#include "machina/compiler/tf2tensorrt/convert/weights.h"
#include "machina/compiler/tf2tensorrt/utils/trt_allocator.h"
#include "machina/compiler/tf2tensorrt/utils/trt_int8_calibrator.h"
...
#include "machina/compiler/tf2tensorrt/utils/trt_tensor_proxy.h"
...
Status ConvertGraphDefToEngine(
    ...
    bool use_explicit_precision,
    machina::grappler::Cluster* cluster = nullptr,
    const string& device = "");
...
#endif  // MACHINA_COMPILER_TF2TENSORRT_CONVERT_CONVERT_NODES_H_
