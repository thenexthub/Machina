 ...
 *
 */
#ifndef MACHINA_COMPILER_TF2TENSORRT_CONVERT_OP_CONVERTER_REGISTRY_H_
#define MACHINA_COMPILER_TF2TENSORRT_CONVERT_OP_CONVERTER_REGISTRY_H_
...
#define REGISTER_TRT_OP_CONVERTER_IMPL(ctr, func, priority, ...)    \
  static ::machina::InitOnStartupMarker const                    \
...
#endif  // MACHINA_COMPILER_TF2TENSORRT_CONVERT_OP_CONVERTER_REGISTRY_H_
