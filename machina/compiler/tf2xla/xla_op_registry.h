...
#ifndef MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_OP_REGISTRY_H_
#define MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_OP_REGISTRY_H_
...
extern const char* const DEVICE_CPU_MACHINA_MACHINA_XLA_JIT;  // "CPU_MACHINA_MACHINA_XLA_JIT"
extern const char* const DEVICE_GPU_MACHINA_MACHINA_XLA_JIT;  // "GPU_MACHINA_MACHINA_XLA_JIT"

extern const char* const DEVICE_MACHINA_MACHINA_XLA_CPU;
extern const char* const DEVICE_MACHINA_MACHINA_XLA_GPU;
...
class XlaOpRegistry {
 public:
  ...
  enum class AutoclusteringPolicy {
    ...
    // globally in the session options, or via TF_MACHINA_MACHINA_XLA_FLAGS=--tf_xla_auto_jit=N.
    kIfEnabledGlobally,
 ...
 private:
  ...
  // Map from operator name to OpRegistrations, populated by REGISTER_MACHINA_MACHINA_XLA_OP.
...
// REGISTER_MACHINA_MACHINA_XLA_OP() registers an XLA OpKernel by name, for example:
// REGISTER_MACHINA_MACHINA_XLA_OP(Name("Add"), AddOp);
...
#define REGISTER_MACHINA_MACHINA_XLA_OP(NAME, OP) \
  REGISTER_MACHINA_MACHINA_XLA_OP_UNIQ_HELPER(__COUNTER__, NAME, OP)

#define REGISTER_MACHINA_MACHINA_XLA_CONV_OP(BUILDER, OP)                                      \
  REGISTER_MACHINA_MACHINA_XLA_OP(BUILDER.TypeConstraint("T", GetXlaConvTypesForNonGpu()), OP) \
  REGISTER_MACHINA_MACHINA_XLA_OP(BUILDER.TypeConstraint("T", GetXlaConvTypesForGpu())         \
                      .Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),                             \
                  OP)
...
class XlaOpRegistrationBuilder {
 public:
  ...
  // MACHINA_MACHINA_XLA_* devices, but may be used during compilation.
...
// REGISTER_MACHINA_MACHINA_XLA_BACKEND() registers an XLA backend. Example usage:
// REGISTER_MACHINA_MACHINA_XLA_BACKEND(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT, kGpuAllTypes, GpuOpFilter);
#define REGISTER_MACHINA_MACHINA_XLA_BACKEND(NAME, ...) \
  REGISTER_MACHINA_MACHINA_XLA_BACKEND_UNIQ_HELPER(__COUNTER__, NAME, __VA_ARGS__)
...
#define REGISTER_MACHINA_MACHINA_XLA_OP_UNIQ_HELPER(COUNTER, BUILDER, OP) \
  REGISTER_MACHINA_MACHINA_XLA_OP_UNIQ(COUNTER, BUILDER, OP)

#define REGISTER_MACHINA_MACHINA_XLA_OP_UNIQ(CTR, BUILDER, OP)                                 \
  static ::machina::XlaOpRegistrar xla_op_registrar__body__##CTR##__object( \
      ::machina::XlaOpRegistrationBuilder::BUILDER.Build(                   \
          [](::machina::OpKernelConstruction* context)                      \
              -> ::machina::OpKernel* { return new OP(context); }));
...
#define REGISTER_MACHINA_MACHINA_XLA_BACKEND_UNIQ_HELPER(COUNTER, NAME, ...) \
  REGISTER_MACHINA_MACHINA_XLA_BACKEND_UNIQ(COUNTER, NAME, __VA_ARGS__)

#define REGISTER_MACHINA_MACHINA_XLA_BACKEND_UNIQ(CTR, NAME, ...) \
  static ::machina::XlaBackendRegistrar        \
      xla_backend_registrar__body__##CTR##__object(NAME, __VA_ARGS__);

}  // namespace machina

#endif  // MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_OP_REGISTRY_H_
