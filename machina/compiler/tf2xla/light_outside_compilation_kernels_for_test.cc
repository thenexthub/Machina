...
#include "machina/compiler/tf2xla/kernels/light_outside_compilation.h"
...
REGISTER_KERNEL_BUILDER(Name("TestStaticTf").Device(DEVICE_GPU),
                        TestStaticTfOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TestStaticTf").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
...
class TestStaticMultipleOutputTfOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    se::Stream* stream =
        ctx->device()->machina_accelerator_device_info()->stream;
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TestStaticMultipleOutputTf").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
                LightOutsideCompilationOp)
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TestDynamicTf").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
                TestDynamicTfXlaOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DynamicMultidim")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DynamicUnranked").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
                LightOutsideCompilationOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TestTfMustBeConstant")
                    .Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT)
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TestDynamicTfWithBound").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
