...
#include "machina/cc/ops/data_flow_ops.h"
...
class XlaCompilerTest : public ::testing::Test {
 protected:
  ...
  XlaCompiler::Options DefaultOptions() {
    ...
    options.device_type = DeviceType(DEVICE_CPU_MACHINA_MACHINA_XLA_JIT);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DummyReadResource"), DummyReadResourceOp);

// DummyDuplicateOp is present purely to test multiple REGISTER_MACHINA_MACHINA_XLA_OP calls
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DummyDuplicateOp").Device(DEVICE_CPU_MACHINA_MACHINA_XLA_JIT),
                DummyDuplicateOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DummyDuplicateOp").Device(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT),
                DummyDuplicateOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DummySideEffectingOp"), DummySideEffectingOp);
