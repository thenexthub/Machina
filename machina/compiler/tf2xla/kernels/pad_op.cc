...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Pad").CompileTimeConstantInput("paddings"), PadOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("PadV2").CompileTimeConstantInput("paddings"), PadOp);
