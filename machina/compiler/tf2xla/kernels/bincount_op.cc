...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("DenseBincount").CompileTimeConstantInput("size"),
                DenseBincountOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Bincount").CompileTimeConstantInput("size"),
                DenseBincountOp);
