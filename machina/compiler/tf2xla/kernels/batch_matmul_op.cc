...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("BatchMatMul"), BatchMatMulOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("BatchMatMulV2"), BatchMatMulOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("BatchMatMulV3"), BatchMatMulOp);
