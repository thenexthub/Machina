...
#include "machina/xla/hlo/builder/lib/pooling.h"
...
// library.
xla::TensorFormat XlaTensorFormat(machina::TensorFormat data_format,
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPool"), MaxPool2DOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPoolV2")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPool3D"), MaxPool3DOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AvgPool"), AvgPool2DOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("AvgPool3D"), MlirXlaOpKernel);
...
class MaxPoolGradOp : public XlaOpKernel {
 public:
  MaxPoolGradOp(OpKernelConstruction* ctx, int num_spatial_dims)
    ...
    OP_REQUIRES(
        ctx, !machina::OpDeterminismRequired(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPoolGrad"), MaxPool2DGradOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPoolGradV2")
                    .CompileTimeConstantInput("ksize")
                    .CompileTimeConstantInput("strides"),
                MaxPool2DGradOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPool3DGrad"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPoolGradGrad").TypeConstraint("T", DT_FLOAT),
                MaxPool2DGradGradOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPoolGradGradV2")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("MaxPool3DGradGrad").TypeConstraint("T", DT_FLOAT),
                MaxPool3DGradGradOp);
