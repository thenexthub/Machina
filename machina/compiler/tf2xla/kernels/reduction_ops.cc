...
#include "machina/compiler/tf2xla/kernels/reduction_ops.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Sum").CompileTimeConstantInput("reduction_indices"),
                SumOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Prod").CompileTimeConstantInput("reduction_indices"),
                ProdOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Min").CompileTimeConstantInput("reduction_indices"),
                MinOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Max").CompileTimeConstantInput("reduction_indices"),
                MaxOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Mean").CompileTimeConstantInput("reduction_indices"),
                MeanOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("All").CompileTimeConstantInput("reduction_indices"),
                AllOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Any").CompileTimeConstantInput("reduction_indices"),
                AnyOp);
