...
#include "machina/core/kernels/stateless_random_ops_v2.h"
...
#include "machina/compiler/tf2xla/kernels/random_ops_util.h"
...
#include "machina/xla/hlo/builder/lib/dynamic_shaped_ops.h"
#include "machina/xla/hlo/builder/lib/prng.h"
...
std::tuple<xla::XlaOp, xla::XlaOp> GetKeyCounter(
  ...
  if (device_type_string == DEVICE_GPU_MACHINA_MACHINA_XLA_JIT ||
      device_type_string == DEVICE_CPU_MACHINA_MACHINA_XLA_JIT) {
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniformV2")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniformIntV2")
                    .CompileTimeConstantInput("shape")
                    .CompileTimeConstantInput("alg")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniformFullIntV2")
                    .CompileTimeConstantInput("shape")
                    .CompileTimeConstantInput("alg")
                    .TypeConstraint("dtype",
                                    {DT_INT32, DT_INT64, DT_UINT32, DT_UINT64}),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomNormalV2")
                    .CompileTimeConstantInput("shape")
                    .CompileTimeConstantInput("alg")
                    .TypeConstraint("dtype", {DT_DOUBLE, DT_FLOAT, DT_HALF,
                                              DT_BFLOAT16}),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessTruncatedNormalV2")
                    .CompileTimeConstantInput("shape")
                    .CompileTimeConstantInput("alg")
                    .TypeConstraint("dtype", {DT_DOUBLE, DT_FLOAT, DT_HALF,
                                              DT_BFLOAT16}),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomGetKeyCounter"), GetKeyCounterOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomGetAlg"), GetAlgOp);
...
// TODO(hinsu): Dis-allow unsupported int64 seed types.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomGetKeyCounterAlg"), GetKeyCounterAlgOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaRngBitGenerator")
