...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniform")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniformInt")
                    .CompileTimeConstantInput("shape")
...
// TODO(phawkins): generalize to non-int32 seed types.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomUniformFullInt")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype", {DT_INT32, DT_INT64})
                    .TypeConstraint("Tseed", DT_INT32),
...
// TODO(phawkins): generalize to non-float, non-int32 seed types.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessRandomNormal")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype",
                                    {DT_DOUBLE, DT_FLOAT, DT_HALF, DT_BFLOAT16})
                    .TypeConstraint("Tseed", DT_INT32),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessTruncatedNormal")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype",
                                    {DT_DOUBLE, DT_FLOAT, DT_HALF, DT_BFLOAT16})
                    .TypeConstraint("Tseed", DT_INT32),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessParameterizedTruncatedNormal")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype",
                                    {DT_DOUBLE, DT_FLOAT, DT_HALF, DT_BFLOAT16})
                    .TypeConstraint("Tseed", DT_INT32),
