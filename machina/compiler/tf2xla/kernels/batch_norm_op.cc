...
class FusedBatchNormOp : public XlaOpKernel {
 public:
  ...
  FusedBatchNormOp(OpKernelConstruction* ctx, bool is_batch_norm_ex)
    ...
    is_on_gpu_ = ctx->device_type().type_string() == DEVICE_GPU_MACHINA_MACHINA_XLA_JIT;
  }
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNorm"), FusedBatchNormOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNormV2"), FusedBatchNormOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNormV3"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("_FusedBatchNormEx"), FusedBatchNormOpEx);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNormGrad"), FusedBatchNormGradOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNormGradV2"), FusedBatchNormGradOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FusedBatchNormGradV3"), MlirXlaOpKernel);
