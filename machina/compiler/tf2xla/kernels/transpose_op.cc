...
// version in third_party/machina because XLA's reshape neatly
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Transpose").CompileTimeConstantInput("perm"),
                TransposeOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("ConjugateTranspose").CompileTimeConstantInput("perm"),
