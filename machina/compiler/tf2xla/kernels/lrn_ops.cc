...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("LRN"), LRNOp);
...
class LRNGradOp : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    // This code is ported from machina/core/kernels/lrn_op.cc. In Python
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("LRNGrad"), LRNGradOp);
