...
#include "machina/compiler/tf2xla/kernels/case_op.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Case").AllowResourceTypes().AllowVariantTypes(),
                XlaCaseOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessCase").AllowResourceTypes().AllowVariantTypes(),
                XlaCaseOp);
