...
class SelfAdjointEigV2Op : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    int max_iter = 2 * machina::Log2Ceiling(n);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSelfAdjointEig"), XlaSelfAdjointEigOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SelfAdjointEigV2"), SelfAdjointEigV2Op);
