...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Gather"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("GatherV2").CompileTimeConstantInput("axis"), GatherOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("GatherNd"), GatherNdOp);
