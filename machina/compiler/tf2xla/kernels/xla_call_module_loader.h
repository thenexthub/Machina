...
#ifndef MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_KERNELS_MACHINA_MACHINA_XLA_CALL_MODULE_LOADER_H_
#define MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_KERNELS_MACHINA_MACHINA_XLA_CALL_MODULE_LOADER_H_
...
class XlaCallModuleLoader {
 public:
  ...
  //
  // This method accepts a list of `toolchain::ArrayRef` instead of `mlir::Type`.
  ...
  // arguments.
  absl::Status RefineDynamicShapes(toolchain::ArrayRef<xla::Shape> input_shapes);
 ...
 private:
  ...
  // disabled_checks attribute and the TF_MACHINA_MACHINA_XLA_FLAGS environment variable.
...
#endif  // MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_KERNELS_MACHINA_MACHINA_XLA_CALL_MODULE_LOADER_H_
