...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Abs"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Atan"), MlirXlaOpKernel);
XLAJIT_MAKE_UNARY(Atanh, xla::Atanh(x));
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Ceil"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Cos"), MlirXlaOpKernel);
XLAJIT_MAKE_UNARY(Cosh, xla::Cosh(x));
XLAJIT_MAKE_UNARY(Sin, xla::Sin(x));
XLAJIT_MAKE_UNARY(Tan, xla::Tan(x));
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Exp"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Expm1"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Floor"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IsFinite"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IsInf"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IsNan"), MlirXlaOpKernel);
// Return 1/x
XLAJIT_MAKE_UNARY(Inv, xla::ScalarLike(x, 1.0) / x);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Reciprocal"), MlirXlaOpKernel);
XLAJIT_MAKE_UNARY(Log, xla::Log(x));
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Log1p"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Rsqrt"), MlirXlaOpKernel);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("Sigmoid"), MlirXlaOpKernel);

// Returns NaN if x is NaN, 0 if x is 0, -1 if x < 0 and 1 if x > 0.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Sign"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Sqrt"), MlirXlaOpKernel);
XLAJIT_MAKE_UNARY(Square, x* x);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Tanh"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Real"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Imag"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Lgamma"), MlirXlaOpKernel);
