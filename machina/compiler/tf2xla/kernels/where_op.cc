...
bool ShouldUsePrefixSumImpl(const DeviceType& dt) {
  ...
  return t == DEVICE_CPU_MACHINA_MACHINA_XLA_JIT || t == DEVICE_GPU_MACHINA_MACHINA_XLA_JIT ||
         t == DEVICE_MACHINA_MACHINA_XLA_CPU || t == DEVICE_MACHINA_MACHINA_XLA_GPU;
}
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Where"), WhereOp);
