...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxArgs"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxArgsGradient"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxVars"), FakeQuantWithMinMaxVarsOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxVarsGradient"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxVarsPerChannel"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FakeQuantWithMinMaxVarsPerChannelGradient"),
