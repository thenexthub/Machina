...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FFT").TypeConstraint("Tcomplex",
                                           {DT_COMPLEX64, DT_COMPLEX128}),
                FFTOp<1>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FFT2D").TypeConstraint("Tcomplex",
                                             {DT_COMPLEX64, DT_COMPLEX128}),
                FFTOp<2>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("FFT3D").TypeConstraint("Tcomplex",
                                             {DT_COMPLEX64, DT_COMPLEX128}),
                FFTOp<3>);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IFFT").TypeConstraint("Tcomplex",
                                            {DT_COMPLEX64, DT_COMPLEX128}),
                MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IFFT2D").TypeConstraint("Tcomplex",
                                              {DT_COMPLEX64, DT_COMPLEX128}),
                IFFTOp<2>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IFFT3D").TypeConstraint("Tcomplex",
                                              {DT_COMPLEX64, DT_COMPLEX128}),
                IFFTOp<3>);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RFFT")
                ...
                RFFTOp<1>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RFFT2D")
                    .TypeConstraint("Treal", {DT_FLOAT, DT_DOUBLE})
                    .TypeConstraint("Tcomplex", {DT_COMPLEX64, DT_COMPLEX128})
                    .CompileTimeConstantInput("fft_length"),
                RFFTOp<2>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RFFT3D")
                    .TypeConstraint("Treal", {DT_FLOAT, DT_DOUBLE})
                    .TypeConstraint("Tcomplex", {DT_COMPLEX64, DT_COMPLEX128})
                    .CompileTimeConstantInput("fft_length"),
                RFFTOp<3>);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IRFFT")
                    .TypeConstraint("Treal", {DT_FLOAT, DT_DOUBLE})
                    .TypeConstraint("Tcomplex", {DT_COMPLEX64, DT_COMPLEX128})
                    .CompileTimeConstantInput("fft_length"),
                IRFFTOp<1>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IRFFT2D")
                    .TypeConstraint("Treal", {DT_FLOAT, DT_DOUBLE})
                    .TypeConstraint("Tcomplex", {DT_COMPLEX64, DT_COMPLEX128})
                    .CompileTimeConstantInput("fft_length"),
                IRFFTOp<2>);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("IRFFT3D")
                    .TypeConstraint("Treal", {DT_FLOAT, DT_DOUBLE})
                    .TypeConstraint("Tcomplex", {DT_COMPLEX64, DT_COMPLEX128})
                    .CompileTimeConstantInput("fft_length"),
                IRFFTOp<3>);
