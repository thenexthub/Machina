...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Reverse").CompileTimeConstantInput("dims"), ReverseOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ReverseV2").CompileTimeConstantInput("axis"),
                ReverseV2Op);
