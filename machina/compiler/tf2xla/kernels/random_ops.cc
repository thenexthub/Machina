...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RandomUniform").CompileTimeConstantInput("shape"),
                RandomUniformOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("RandomShuffle"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RandomUniformInt").CompileTimeConstantInput("shape"),
                RandomUniformIntOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RandomStandardNormal").CompileTimeConstantInput("shape"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TruncatedNormal")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ParameterizedTruncatedNormal")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype", {DT_FLOAT, DT_DOUBLE}),
