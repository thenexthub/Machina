...
class QuantizeAndDequantizeOp : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    // machina/core/kernels/quantize_and_dequantize_op.h closely.
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("QuantizeAndDequantizeV2"), QuantizeAndDequantizeV2Op);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("QuantizeAndDequantizeV3"), QuantizeAndDequantizeOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("QuantizeAndDequantizeV4"), QuantizeAndDequantizeV2Op);
