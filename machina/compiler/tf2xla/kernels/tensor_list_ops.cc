...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListLength").IsMetadataOp(), TensorListLengthOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListReserve")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("EmptyTensorList")
                    .CompileTimeConstantInput("element_shape")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListElementShape").IsMetadataOp(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListGetItem"), TensorListGetItemOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListGather"), TensorListGatherOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListStack"), TensorListStackOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListConcatV2"), TensorListConcatOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListSplit")
                    .CompileTimeConstantInput("element_shape")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListSetItem"), TensorListSetItemOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListPushBack").AllowVariantTypes(),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorListPopBack").AllowVariantTypes(),
                TensorListPopBackOp);
