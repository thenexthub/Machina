...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Softmax"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("LogSoftmax"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SoftmaxCrossEntropyWithLogits"), SoftmaxXentWithLogitsOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SparseSoftmaxCrossEntropyWithLogits"),
