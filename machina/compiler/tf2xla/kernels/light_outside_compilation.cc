...
#include "machina/compiler/tf2xla/kernels/callback.pb.h"
...
#include "machina/xla/stream_executor/stream_finder.h"
...
MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(kTfCallbackCustomCall,
