...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("Conv"), ConvNDOp);
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("Conv2D"), Conv2DOp);
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("Conv3D"), Conv3DOp);
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("DepthwiseConv2dNative"), DepthwiseConv2DOp);
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("DepthwiseConv2dNativeBackpropInput")
...
REGISTER_MACHINA_MACHINA_XLA_CONV_OP(Name("DepthwiseConv2dNativeBackpropFilter")
