 ...
 *
 */
#include "machina/compiler/tf2xla/kernels/image_resize_ops.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeNearestNeighbor").CompileTimeConstantInput("size"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeBilinear").CompileTimeConstantInput("size"),
                ResizeBilinearOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResizeBilinearGrad"), ResizeBilinearGradOp);
