...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Shape").CompilationOnly().IsMetadataOp(), ShapeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSetBound").CompileTimeConstantInput("bound"),
                XlaSetBoundOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ShapeN").CompilationOnly().IsMetadataOp(), ShapeNOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Rank").CompilationOnly().IsMetadataOp(), RankOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Size").CompilationOnly().IsMetadataOp(), SizeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ExpandDims").CompileTimeConstantInput("dim"),
                ExpandDimsOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Squeeze"), SqueezeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ZerosLike").AllowVariantTypes(), ZerosLikeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("OnesLike"), OnesLikeOp);
