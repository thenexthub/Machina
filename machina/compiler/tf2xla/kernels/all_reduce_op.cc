...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("CollectiveReduceV2")
                    .CompileTimeConstantInput("group_key")
                    .CompileTimeConstantInput("group_size"),
                CollectiveReduceV2Op);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("CollectiveAssignGroupV2")
                    .CompileTimeConstantInput("group_assignment"),
                MlirXlaOpKernel);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaReduceScatter")
                    .CompileTimeConstantInput("group_assignment")
