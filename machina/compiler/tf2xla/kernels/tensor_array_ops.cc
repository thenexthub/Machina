...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayV3").CompileTimeConstantInput("size"),
                TensorArrayOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayWriteV3"), TensorArrayWriteOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayReadV3"), TensorArrayReadOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayGatherV3"), TensorArrayGatherOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayScatterV3"), TensorArrayScatterOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayConcatV3"), TensorArrayConcatOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArraySplitV3").CompileTimeConstantInput("lengths"),
                TensorArraySplitOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArraySizeV3"), TensorArraySizeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayGradV3"), TensorArrayGradOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorArrayCloseV3"), TensorArrayCloseOp);
