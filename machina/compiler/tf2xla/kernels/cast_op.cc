      ...
      if (use_truncation_) {
        ...
        input = xla::BitcastConvertType(
            xla::And(
                ...
                ::machina::IntegerLiteral(builder, same_width_int, mask)),
            src_type_);
      }
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Cast"), CastOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Bitcast"), BitcastOp);
