...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyGradientDescent")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyProximalGradientDescent")
                    .TypeConstraint("T", kFloatAndComplexTypes),
...
class ResourceApplyMomentum : public XlaOpKernel {
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    if (use_nesterov_) {
      // See https://github.com/machina/machina/pull/2798 for an
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyMomentum").TypeConstraint("T", kFloatTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyKerasMomentum")
                    .TypeConstraint("T", kFloatAndComplexTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyProximalAdagrad")
                    .TypeConstraint("T", kFloatAndComplexTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyAdagradDA").TypeConstraint("T", kFloatTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyAdaMax").TypeConstraint("T", kFloatTypes),
                ResourceApplyAdaMax);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyCenteredRMSProp")
                    .TypeConstraint("T", kFloatAndComplexTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyFtrl").TypeConstraint("T", kFloatTypes),
                ResourceApplyFtrl);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyFtrlV2").TypeConstraint("T", kFloatTypes),
                ResourceApplyFtrlV2);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyAddSign").TypeConstraint("T", kFloatTypes),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceApplyPowerSign").TypeConstraint("T", kFloatTypes),
