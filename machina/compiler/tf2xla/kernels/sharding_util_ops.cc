...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaSplitND"), XlaSplitNDOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ReadVariableXlaSplitND"), ReadVariableXlaSplitNDOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaConcatND"), XlaConcatNDOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AssignVariableXlaConcatND"), AssignVariableXlaConcatNDOp);
