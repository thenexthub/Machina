...
#include "machina/compiler/tf2xla/kernels/while_op.h"
...
#include "machina/compiler/tf2xla/kernels/if_while_utils.h"
...
#include "machina/xla/hlo/builder/lib/tuple.h"
...
void GetLoopInvariants(XlaOpKernelContext* ctx,
  ...
  const machina::FunctionLibraryDefinition* fld =
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("While").AllowResourceTypes().AllowVariantTypes(),
                XlaWhileOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessWhile").AllowResourceTypes().AllowVariantTypes(),
                XlaWhileOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaWhile").AllowResourceTypes().AllowVariantTypes(),
                XlaWhileOp);
