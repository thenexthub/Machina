...
#include "machina/xla/hlo/builder/lib/loops.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RGBToHSV"), RGBToHSVOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("HSVToRGB"), HSVToRGBOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AdjustContrastv2"), AdjustContrastOpV2);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AdjustSaturation"), AdjustSaturationOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AdjustHue"), AdjustHueOp);
