...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SegmentSumV2").CompileTimeConstantInput("num_segments"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SegmentProdV2").CompileTimeConstantInput("num_segments"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SegmentMinV2").CompileTimeConstantInput("num_segments"),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("SegmentMaxV2").CompileTimeConstantInput("num_segments"),
