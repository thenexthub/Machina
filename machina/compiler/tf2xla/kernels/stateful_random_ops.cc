...
#include "machina/core/kernels/stateful_random_ops.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatefulUniform")
...
// TODO(wangpeng): Support plain float16 to get rid of the `TypeConstraint`.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatefulStandardNormalV2")
                    .CompileTimeConstantInput("algorithm")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype", {DT_DOUBLE, DT_FLOAT, DT_HALF,
                                              DT_BFLOAT16}),
...
// TODO(wangpeng): Support plain float16 to get rid of the `TypeConstraint`.
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatefulTruncatedNormal")
                    .CompileTimeConstantInput("algorithm")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype", {DT_DOUBLE, DT_FLOAT, DT_HALF,
                                              DT_BFLOAT16}),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatefulUniformInt")
                    .CompileTimeConstantInput("algorithm")
                    .CompileTimeConstantInput("shape")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatefulUniformFullInt")
                    .CompileTimeConstantInput("algorithm")
                    .CompileTimeConstantInput("shape")
                    .TypeConstraint("dtype",
                                    {DT_INT32, DT_UINT32, DT_INT64, DT_UINT64}),
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("RngSkip").CompileTimeConstantInput("algorithm"),
                RngSkipOp<>);

using RngReadAndSkipOp = RngSkipOp<int32, true>;

REGISTER_MACHINA_MACHINA_XLA_OP(Name("RngReadAndSkip").CompileTimeConstantInput("alg"),
                RngReadAndSkipOp);
