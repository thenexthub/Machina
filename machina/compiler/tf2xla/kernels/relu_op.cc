...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Relu"), MlirXlaOpKernel);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Relu6"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("LeakyRelu"), LeakyReluOp);

REGISTER_MACHINA_MACHINA_XLA_OP(Name("ReluGrad"), MlirXlaOpKernel);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Relu6Grad"), Relu6GradOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("LeakyReluGrad"), LeakyReluGradOp);
