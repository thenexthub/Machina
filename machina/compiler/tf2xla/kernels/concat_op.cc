...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("Concat").CompileTimeConstantInput("concat_dim"),
                ConcatOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ConcatV2")
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ConcatOffset")
