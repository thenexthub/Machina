...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StackPushV2").CompilationOnly(), StackPushOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StackPopV2").CompilationOnly(), StackPopOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StackCloseV2").CompilationOnly(), StackCloseOp);
