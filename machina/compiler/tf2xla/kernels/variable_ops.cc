...
#include "machina/compiler/tf2xla/kernels/gather_op_helpers.h"
#include "machina/compiler/tf2xla/kernels/shape_util.h"
#include "machina/compiler/tf2xla/lib/scatter.h"
#include "machina/compiler/tf2xla/xla_op_kernel.h"
#include "machina/compiler/tf2xla/xla_op_registry.h"
#include "machina/compiler/tf2xla/xla_resource.h"
...
#include "machina/core/kernels/resource_variable_util.h"
#include "machina/core/kernels/scatter_nd_util.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("VarIsInitializedOp"), VarIsInitializedOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("VariableShape").CompilationOnly().IsMetadataOp(),
                VariableShapeOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ReadVariableOp").CompilationOnly(), ReadVariableOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("AssignVariableOp").CompilationOnly(), AssignVariableOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceGather"), ResourceGatherOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterAdd"), ResourceScatterAddOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterSub"), ResourceScatterSubOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterMul"), ResourceScatterMulOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterDiv"), ResourceScatterDivOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterMin"), ResourceScatterMinOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterMax"), ResourceScatterMaxOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterUpdate"), ResourceScatterUpdateOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterNdUpdate"), ResourceScatterNdUpdateOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterNdAdd"), ResourceScatterNdAddOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ResourceScatterNdSub"), ResourceScatterNdSubOp);
