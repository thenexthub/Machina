...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("ScatterNd").CompileTimeConstantInput("shape"),
                ScatterNdOp);
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorScatterAdd"), TensorScatterAddOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorScatterMax"), TensorScatterMaxOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorScatterMin"), TensorScatterMinOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorScatterSub"), TensorScatterSubOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("TensorScatterUpdate"), TensorScatterUpdateOp);
