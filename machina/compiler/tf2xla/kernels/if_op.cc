...
#include "machina/compiler/tf2xla/kernels/if_op.h"
...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("If").AllowResourceTypes().AllowVariantTypes(), XlaIfOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("StatelessIf").AllowResourceTypes().AllowVariantTypes(),
                XlaIfOp);
REGISTER_MACHINA_MACHINA_XLA_OP(Name("XlaIf").AllowResourceTypes().AllowVariantTypes(),
                XlaIfOp);
