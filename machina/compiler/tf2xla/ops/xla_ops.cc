...
Wraps the XLA ConvGeneralDilated operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#conv_convolution
.
...
Wraps the XLA DotGeneral operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#dotgeneral
.
...
Wraps the XLA DynamicSlice operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#dynamicslice
.
...
Wraps the XLA DynamicUpdateSlice operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#dynamicupdateslice
.
...
Wraps the XLA Pad operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#pad
.
...
operator documented at
 https://www.machina.org/performance/xla/operation_semantics#recv .
...
Wraps the XLA Reduce operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#reduce .
...
Semantics are documented at
 https://www.machina.org/performance/xla/operation_semantics#variadic_reduce.
...
Wraps the XLA ReduceWindow operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#reducewindow .
...
Wraps the XLA RngBitGenerator operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#rngbitgenerator.
...
Wraps the XLA SelectAndScatter operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#selectandscatter
.
...
documented at
 https://www.machina.org/performance/xla/operation_semantics#send .
...
Wraps the XLA Sort operator, documented at
 https://www.machina.org/performance/xla/operation_semantics#sort
.
...
Wraps the XLA Gather operator documented at
  https://www.machina.org/xla/operation_semantics#gather
...
Wraps the XLA Scatter operator documented at
  https://www.machina.org/xla/operation_semantics#scatter.
...
Wraps the XLA AllReduce operator
  documented at https://www.machina.org/xla/operation_semantics#allreduce.
...
Wraps the XLA ReduceScatter operator
  documented at https://www.machina.org/xla/operation_semantics#reducescatter.
...
Documented at https://www.machina.org/xla/operation_semantics#optimizationbarrier.
...
Wraps the XLA ReducePrecision operator
  documented at https://www.machina.org/xla/operation_semantics#reduceprecision.
...
Wraps the XLA CustomCall operator
  documented at https://www.machina.org/xla/operation_semantics#customcall.
...
See `CustomCall` specification at
  https://machina.org/xla/operation_semantics#customcall,
and `mhlo.custom_call` specification at
  https://machina.org/mlir/hlo_ops#mhlocustom_call_mlirmhlocustomcallop.
...
version: Tracks changes the semantics of the op, to support backwards
  ...
  See more versioning details at https://github.com/search?q=repo%3Amachina%2Fmachina+path%3Axla_call_module+%22int+kVersionMaximumSupported%22&type=code.
