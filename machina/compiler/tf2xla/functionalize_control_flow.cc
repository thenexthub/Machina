...
#include "machina/compiler/tf2xla/functionalize_cond.h"
#include "machina/compiler/tf2xla/functionalize_control_flow_util.h"
#include "machina/compiler/tf2xla/functionalize_while.h"
...
absl::Status FunctionalizeControlFlowForFunction(
    ...
    const protobuf::Map<string, machina::AttrValue>& attrs,
...
absl::Status FunctionalizeControlFlow(Graph* graph,
  ...
  if (include_functions) {
    ...
    auto pflr = std::make_unique<ProcessFunctionLibraryRuntime>(
        /*device_mgr=*/nullptr, machina::Env::Default(),
        /*config=*/nullptr, TF_GRAPH_DEF_VERSION, library,
        machina::OptimizerOptions());
