...
#ifndef MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_HELPERS_H_
#define MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_HELPERS_H_
...
struct XlaCompilationResult {
  ...
  // The XLA computation built from the machina subgraph.
...
#endif  // MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_HELPERS_H_
