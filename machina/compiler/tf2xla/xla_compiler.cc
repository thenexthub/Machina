...
#include "machina/compiler/mlir/utils/array_container_utils.h"
#include "machina/compiler/tf2xla/graph_compiler.h"
#include "machina/compiler/tf2xla/layout_util.h"
#include "machina/compiler/tf2xla/rearrange_function_argument.h"
...
// enable logging.
constexpr char kSingleOpComponent[] = "TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_COMPILER_COMPILE_SINGLE_OP";
constexpr char kCompileFunctionComponent[] =
    "TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_COMPILER_COMPILE_FUNCTION";
...
// LINT.ThenChange(//machina/compiler/tf2xla/graph_compiler_test.cc)
...
absl::Status BuildComputation(
  ...
  retval_metadata.set_op_name("MACHINA_MACHINA_XLA_Retvals");
...
absl::Status XlaCompiler::CompileSingleOp(
  ...
  *result = {};
  ...
  if (status.ok()) {
    machina::metrics::IncrementPhase2XlaCompilerCounter(
        machina::metrics::Phase2XlaCompilerMetric::
...
absl::Status XlaCompiler::BuildArguments(
  ...
  arg_metadata.set_op_name("MACHINA_MACHINA_XLA_Args");
