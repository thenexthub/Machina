...
#ifndef MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_COMPILER_H_
#define MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_COMPILER_H_
...
class XlaCompiler {
 public:
  ...
  using Argument = ::machina::XlaArgument;
  ...
  using OutputDescription = ::machina::XlaOutputDescription;

  using ResourceUpdate = ::machina::XlaResourceUpdate;

  using CompilationResult = ::machina::XlaCompilationResult;
  ...
  // Compiles a machina::Graph into an xla::XlaComputation.
...
#endif  // MACHINA_COMPILER_TF2MACHINA_MACHINA_XLA_MACHINA_MACHINA_XLA_COMPILER_H_
