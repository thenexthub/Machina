...
from machina.python.ops import bitwise_ops
...
from machina.python.ops import random_ops_util
...
def call_module(
  ...
  https://github.com/search?q=repo%3Amachina%2Fmachina+path%3Axla_ops.cc+xlacallmodule&type=code
  """
...
def call_module_maximum_supported_version():
  ...
  https://github.com/search?q=repo%3Amachina%2Fmachina+path%3Axla_call_module+%22int+kVersionMaximumSupported%22&type=code
  """
  return 10
