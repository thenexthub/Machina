**Supported operators for device: MACHINA_MACHINA_XLA_CPU_JIT**
...
```shell
bazel run -c opt -- machina/compiler/tf2xla:tf2xla_supported_ops --device=MACHINA_MACHINA_XLA_CPU_JIT
```
