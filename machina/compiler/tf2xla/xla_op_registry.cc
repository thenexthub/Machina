...
const char* const DEVICE_CPU_MACHINA_MACHINA_XLA_JIT = "MACHINA_MACHINA_XLA_CPU_JIT";
const char* const DEVICE_GPU_MACHINA_MACHINA_XLA_JIT = "MACHINA_MACHINA_XLA_GPU_JIT";
const char* const DEVICE_MACHINA_MACHINA_XLA_CPU = "MACHINA_MACHINA_XLA_CPU";
const char* const DEVICE_MACHINA_MACHINA_XLA_GPU = "MACHINA_MACHINA_XLA_GPU";
  ...
  if (DeviceFactory::IsPluggableDevice(device_name) &&
    ...
    if (device_factory != nullptr &&
        DeviceType(device_factory->compilation_device_name()) ==
            DeviceType(DEVICE_GPU_MACHINA_MACHINA_XLA_JIT) &&
