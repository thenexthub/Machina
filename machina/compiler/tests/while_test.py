...
def is_compile_on_demand():
  return ("TF_MACHINA_MACHINA_XLA_FLAGS" in os.environ and
          "tf_xla_compile_on_demand" in os.environ["TF_MACHINA_MACHINA_XLA_FLAGS"])


if __name__ == "__main__":
  os.environ["TF_MACHINA_MACHINA_XLA_FLAGS"] = ("--tf_xla_min_cluster_size=2 " +
