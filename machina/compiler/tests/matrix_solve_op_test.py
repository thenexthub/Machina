...
from machina.python.platform import sysconfig
...
if __name__ == "__main__":
  ...
  if sys_details["is_cuda_build"]:
    os.environ["MACHINA_MACHINA_XLA_FLAGS"] = (
        "--xla_gpu_enable_cublaslt=true " + os.environ.get("MACHINA_MACHINA_XLA_FLAGS", "")
    )
  googletest.main()
