...
class DenseLayerTest(test.TestCase):
  ...
  def testDenseLayerAutoJit(self):
    ...
    os.environ["TF_MACHINA_MACHINA_XLA_FLAGS"] = (
        "--tf_xla_cpu_global_jit " + os.environ.get("TF_MACHINA_MACHINA_XLA_FLAGS", ""))
...
if __name__ == "__main__":
  os.environ["TF_MACHINA_MACHINA_XLA_FLAGS"] = ("--tf_xla_enable_lazy_compilation=true " +
