...
REGISTER_MACHINA_MACHINA_XLA_OP(Name("CompilableOp").Device(DEVICE_CPU_MACHINA_MACHINA_XLA_JIT),
                DummyCompilableOp);
...
class CompilabilityCheckUtilTest : public ::testing::Test {
 protected:
  ...
  DeviceType device_type_ = DeviceType(DEVICE_CPU_MACHINA_MACHINA_XLA_JIT);
