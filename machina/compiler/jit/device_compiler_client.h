...
#ifndef MACHINA_COMPILER_JIT_DEVICE_COMPILER_CLIENT_H_
#define MACHINA_COMPILER_JIT_DEVICE_COMPILER_CLIENT_H_
...
#endif  // MACHINA_COMPILER_JIT_DEVICE_COMPILER_CLIENT_H_
