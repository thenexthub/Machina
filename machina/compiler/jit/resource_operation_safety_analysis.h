...
#ifndef MACHINA_COMPILER_JIT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_
#define MACHINA_COMPILER_JIT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_
...
#endif  // MACHINA_COMPILER_JIT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_
