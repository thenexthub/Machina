...
#include "machina/compiler/jit/build_xla_ops_pass.h"
...
#include "machina/compiler/jit/encapsulate_subgraphs_pass.h"
...
class BuildXlaOpsTest : public ::testing::Test {
 protected:
  void SetUp() override {
    // This is needed to register the MACHINA_MACHINA_XLA_* devices.
...
using ::machina::testing::matchers::Attr;
using ::machina::testing::matchers::CtrlDeps;
using ::machina::testing::matchers::Inputs;
using ::machina::testing::matchers::NodeWith;
using ::machina::testing::matchers::Op;
using ::machina::testing::matchers::Out;
using ::testing::_;
...
TEST_F(BuildXlaOpsTest, ControlDepsPreserved) {
  const char* kXlaDeviceName = "/job:worker/replica:0/task:0/device:MACHINA_MACHINA_XLA_CPU:0";
