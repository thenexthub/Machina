...
#ifndef MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_CONTEXT_H_
#define MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_CONTEXT_H_
...
#endif  // MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_CONTEXT_H_
