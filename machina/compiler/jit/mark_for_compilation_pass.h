...
#ifndef MACHINA_COMPILER_JIT_MARK_FOR_COMPILATION_PASS_H_
#define MACHINA_COMPILER_JIT_MARK_FOR_COMPILATION_PASS_H_
...
#endif  // MACHINA_COMPILER_JIT_MARK_FOR_COMPILATION_PASS_H_
