...
#include "machina/compiler/jit/extract_outside_compilation_pass.h"
...
bool EqualProtoMap(const ::machina::protobuf::Map<Tkey, Tvalue>& a,
                   const ::machina::protobuf::Map<Tkey, Tvalue>& b,
...
REGISTER_OP("UnaryTest")
    ...
    .Output("o: float")
    .SetShapeFn([](::machina::shape_inference::InferenceContext* c) {
      ::machina::shape_inference::ShapeHandle o;
