...
#ifndef MACHINA_COMPILER_JIT_ENCAPSULATE_SUBGRAPHS_PASS_H_
#define MACHINA_COMPILER_JIT_ENCAPSULATE_SUBGRAPHS_PASS_H_
...
#endif  // MACHINA_COMPILER_JIT_ENCAPSULATE_SUBGRAPHS_PASS_H_
