...
#ifndef MACHINA_COMPILER_JIT_DEVICE_COMPILATION_PROFILER_H_
#define MACHINA_COMPILER_JIT_DEVICE_COMPILATION_PROFILER_H_
...
#endif  // MACHINA_COMPILER_JIT_DEVICE_COMPILATION_PROFILER_H_
