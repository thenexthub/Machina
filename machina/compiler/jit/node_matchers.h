...
// Provides a set of matchers for machina nodes.
//
// Example usage:
//
//  machina::Node* node = ...;
...
//
//  - ConstantValue(machina::Input::Initializer init): matches a Const node
...
#ifndef MACHINA_COMPILER_JIT_NODE_MATCHERS_H_
#define MACHINA_COMPILER_JIT_NODE_MATCHERS_H_
...
impl::NodeMatcherProperties ConstantValue(
    const ::machina::Input::Initializer& val);
...
#endif  // MACHINA_COMPILER_JIT_NODE_MATCHERS_H_
