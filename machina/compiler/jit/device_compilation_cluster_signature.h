...
#ifndef MACHINA_COMPILER_JIT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
#define MACHINA_COMPILER_JIT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
...
#endif  // MACHINA_COMPILER_JIT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
