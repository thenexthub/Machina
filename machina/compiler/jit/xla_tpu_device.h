...
#ifndef MACHINA_COMPILER_JIT_MACHINA_XLATPU_DEVICE_H_
#define MACHINA_COMPILER_JIT_MACHINA_XLATPU_DEVICE_H_
...
#endif  // MACHINA_COMPILER_JIT_MACHINA_XLATPU_DEVICE_H_
