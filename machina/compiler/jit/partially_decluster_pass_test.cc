...
#include "machina/compiler/jit/partially_decluster_pass.h"
...
#include "machina/compiler/tf2xla/cc/ops/xla_ops.h"
...
TEST(PartiallyDeclusterPassTest, DontDeclusterXlaDeviceOps) {
  ...
  // This is needed to register the MACHINA_MACHINA_XLA_GPU device.
  ...
  n->set_assigned_device_name(
      "/job:localhost/replica:0/task:0/device:MACHINA_MACHINA_XLA_GPU:0");
...
TEST(PartiallyDeclusterPassTest, MetadataOpsDontStartClusters) {
  ...
  machina::Scope in_cluster_and = root.WithXlaCluster("cluster_0");
