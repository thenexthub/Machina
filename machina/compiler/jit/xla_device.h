...
// under different names (e.g., MACHINA_MACHINA_XLA_CPU or MACHINA_MACHINA_XLA_GPU).

#ifndef MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_H_
#define MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_H_
#include <set>
...
class XlaDevice : public LocalDevice {
 public:
  ...
  struct Options {
    ...
    // The name of the XLA device (e.g., "MACHINA_MACHINA_XLA_CPU")
    string device_name;

    // The number of the device.
    int device_ordinal = -1;

    // The name of the compilation device (e.g., "MACHINA_MACHINA_XLA_CPU_JIT");
 ...
 private:
  ...
  const int device_ordinal_;
  // The name/type of this XlaDevice. eg. "MACHINA_MACHINA_XLA_GPU".
...
#endif  // MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_DEVICE_H_
