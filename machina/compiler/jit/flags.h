...
#ifndef MACHINA_COMPILER_JIT_FLAGS_H_
#define MACHINA_COMPILER_JIT_FLAGS_H_
...
// parses TF_MACHINA_MACHINA_XLA_FLAGS for all of them.  Those functions which return a pointer
...
//
// Has the side-effect of parsing TF_MACHINA_MACHINA_XLA_FLAGS if that hasn't happened yet.
...
#endif  // MACHINA_COMPILER_JIT_FLAGS_H_
