...
#ifndef MACHINA_COMPILER_JIT_PJRT_BASE_DEVICE_H_
#define MACHINA_COMPILER_JIT_PJRT_BASE_DEVICE_H_
...
// machina::PjRtBaseDevice replaces the deprecated machina::XlaDevice.
...
class PjRtBaseDevice : public LocalDevice {
 public:
  ...
  struct Options {
    ...
    // (e.g., "MACHINA_MACHINA_XLA_CPU_JIT");
...
#endif  // MACHINA_COMPILER_JIT_PJRT_BASE_DEVICE_H_
