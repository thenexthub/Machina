...
#ifndef MACHINA_COMPILER_JIT_DEVICE_COMPILER_H_
#define MACHINA_COMPILER_JIT_DEVICE_COMPILER_H_
...
#include "machina/compiler/jit/device_compilation_cache.h"
...
DeviceCompiler<ExecutableType, ClientType>::DeviceCompiler(
  ...
  async_compiler_threads_ = std::make_unique<machina::thread::ThreadPool>(
      machina::Env::Default(), "async_compiler_threads",
...
absl::Status DeviceCompiler<ExecutableType, ClientType>::CompileImpl(
  ...
  *out_executable = nullptr;
  ...
  if (state == DeviceCompileState::kUncompiled) {
    MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("Compilation of XLA executable");
...
#endif  // MACHINA_COMPILER_JIT_DEVICE_COMPILER_H_
