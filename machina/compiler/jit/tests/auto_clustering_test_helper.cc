...
#include "machina/tools/optimization/optimization_pass_runner.h"
...
absl::Status ReadTextProtoFromString(Env* env, const string& data,
                                     ::machina::protobuf::Message* proto) {
  if (!::machina::protobuf::TextFormat::ParseFromString(data, proto)) {
...
absl::Status AutoClusteringTest::RunAutoClusteringTestImpl(
  ...
  TF_RETURN_IF_ERROR(runner.SetJitLevel(machina::OptimizerOptions::ON_2));
  ...
  //   machina/compiler/jit/tests:auto_clustering_test
