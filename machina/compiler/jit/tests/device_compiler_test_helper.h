 ...
 *
 */
#ifndef MACHINA_COMPILER_JIT_TESTS_DEVICE_COMPILER_TEST_HELPER_H_
#define MACHINA_COMPILER_JIT_TESTS_DEVICE_COMPILER_TEST_HELPER_H_
...
#endif  // MACHINA_COMPILER_JIT_TESTS_DEVICE_COMPILER_TEST_HELPER_H_
