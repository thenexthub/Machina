...
#ifndef MACHINA_COMPILER_JIT_DEADNESS_ANALYSIS_INTERNAL_H_
#define MACHINA_COMPILER_JIT_DEADNESS_ANALYSIS_INTERNAL_H_
...
#endif  // MACHINA_COMPILER_JIT_DEADNESS_ANALYSIS_INTERNAL_H_
