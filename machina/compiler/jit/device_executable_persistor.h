...
#ifndef MACHINA_COMPILER_JIT_DEVICE_EXECUTABLE_PERSISTOR_H_
#define MACHINA_COMPILER_JIT_DEVICE_EXECUTABLE_PERSISTOR_H_
...
DeviceExecutablePersistor<ExecutableType, ClientType>::VerifyLoadedCacheEntry(
    const XlaSerializedCacheKey& key, const xla::HloModuleProto& hlo_module,
    const XlaSerializedCacheEntry& entry) const {
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER(absl::StrCat("Verifying loaded cache entry: ",
...
#endif  // MACHINA_COMPILER_JIT_DEVICE_EXECUTABLE_PERSISTOR_H_
