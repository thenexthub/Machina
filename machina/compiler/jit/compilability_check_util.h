...
#ifndef MACHINA_COMPILER_JIT_COMPILABILITY_CHECK_UTIL_H_
#define MACHINA_COMPILER_JIT_COMPILABILITY_CHECK_UTIL_H_
...
#endif  // MACHINA_COMPILER_JIT_COMPILABILITY_CHECK_UTIL_H_
