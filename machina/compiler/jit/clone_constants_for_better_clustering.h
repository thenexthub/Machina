...
#ifndef MACHINA_COMPILER_JIT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_
#define MACHINA_COMPILER_JIT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_
...
#endif  // MACHINA_COMPILER_JIT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_
