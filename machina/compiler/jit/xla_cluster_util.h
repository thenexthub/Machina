...
#ifndef MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_CLUSTER_UTIL_H_
#define MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_CLUSTER_UTIL_H_
...
#endif  // MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_CLUSTER_UTIL_H_
