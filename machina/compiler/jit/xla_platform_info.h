...
#ifndef MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_PLATFORM_INFO_H_
#define MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_PLATFORM_INFO_H_
...
class XlaPlatformInfo {
 ...
 private:
  ...
  // xla_device_metadata_ lives in the machina::DeviceBase in which the
  ...
  // pjrt_device_metadata_ lives in machina::PjRtBaseDevice in which the
...
#endif  // MACHINA_COMPILER_JIT_MACHINA_MACHINA_XLA_PLATFORM_INFO_H_
