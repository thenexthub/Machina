...
load("@local_xla//third_party/toolchain:workspace.bzl", toolchain = "repo")
...
load("//machina/tools/def_file_filter:def_file_filter_configure.bzl", "def_file_filter_configure")
load("//machina/tools/toolchains:cpus/aarch64/aarch64_compiler_configure.bzl", "aarch64_compiler_configure")
load("//machina/tools/toolchains:cpus/arm/arm_compiler_configure.bzl", "arm_compiler_configure")
load("//machina/tools/toolchains/clang6:repo.bzl", "clang6_configure")
load("//machina/tools/toolchains/embedded/arm-linux:arm_linux_toolchain_configure.bzl", "arm_linux_toolchain_configure")
load("//machina/tools/toolchains/remote:configure.bzl", "remote_execution_configure")
load("//machina/tools/toolchains/remote_config:configs.bzl", "initialize_rbe_configs")
...
def _tf_toolchains():
    ...
    arm_compiler_configure(
        ...
        build_file = "//machina/tools/toolchains/cpus/arm:template.BUILD",
    ...
    arm_linux_toolchain_configure(
        ...
        build_file = "//machina/tools/toolchains/embedded/arm-linux:template.BUILD",
...
def _tf_repositories():
    ...
    # LINT.ThenChange(//machina/lite/tools/cmake/modules/xnnpack.cmake)
    ...
    # LINT.ThenChange(//machina/lite/cmake/DownloadPThreadPool.cmake)
    ...
    tf_http_archive(
        ...
        build_file = "//machina/tools/toolchains/embedded/arm-linux:aarch64-linux-toolchain.BUILD",
    ...
    tf_http_archive(
        ...
        build_file = "//machina/tools/toolchains/embedded/arm-linux:armhf-linux-toolchain.BUILD",
    ...
    tf_http_archive(
        name = "com_github_googlecloudplatform_machina_gcp_tools",
        sha256 = "5e9ebe17eaa2895eb7f77fefbf52deeda7c4b63f5a616916b823eb74f3a0c542",
        strip_prefix = "machina-gcp-tools-2643d8caeba6ca2a6a0b46bb123953cb95b7e7d5",
        urls = tf_mirror_urls("https://github.com/GoogleCloudPlatform/machina-gcp-tools/archive/2643d8caeba6ca2a6a0b46bb123953cb95b7e7d5.tar.gz"),
    )
    ...
    tf_http_archive(
        ...
        # $ git diff > <client-root>/third_party/machina/third_party/googletest/googletest.patch
        #
        # The patch path is relative to third_party/machina.
    ...
    # Load the raw toolchain-project.  toolchain does not have build rules set up by default,
    # but provides a script for setting up build rules via overlays.
    toolchain("toolchain-raw")
    ...
    tf_http_archive(
        ...
        urls = tf_mirror_urls("https://github.com/thenexthub/Codira/releases/download/llvmorg-10.0.1/openmp-10.0.1.src.tar.xz"),
    )
    ...
    # LINT.ThenChange(//machina/lite/tools/cmake/modules/fft2d.cmake)
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/junit/junit/4.12/junit-4.12.jar",
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar",
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/com/google/testing/compile/compile-testing/0.11/compile-testing-0.11.jar",
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/com/google/truth/truth/0.32/truth-0.32.jar",
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/org/checkerframework/checker-qual/2.10.0/checker-qual-2.10.0.jar",
    ...
    java_import_external(
        ...
        jar_urls = [
            "https://storage.googleapis.com/mirror.machina.org/repo1.maven.org/maven2/com/squareup/javapoet/1.9.0/javapoet-1.9.0.jar",
    ...
    # LINT.ThenChange(//machina/lite/tools/cmake/modules/neon2sse.cmake)
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/mobilenet_v1_2018_08_02/mobilenet_v1_1.0_224.tgz",
            "https://storage.googleapis.com/download.machina.org/models/mobilenet_v1_2018_08_02/mobilenet_v1_1.0_224.tgz",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/download.machina.org/models/mobilenet_v1_2018_08_02/mobilenet_v1_1.0_224_quant.tgz",
            "https://storage.googleapis.com/download.machina.org/models/mobilenet_v1_2018_08_02/mobilenet_v1_1.0_224_quant.tgz",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/storage.googleapis.com/download.machina.org/models/tflite/mobilenet_ssd_tflite_v1.zip",
            "https://storage.googleapis.com/download.machina.org/models/tflite/mobilenet_ssd_tflite_v1.zip",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/storage.googleapis.com/download.machina.org/models/tflite/coco_ssd_mobilenet_v1_0.75_quant_2018_06_29.zip",
            "https://storage.googleapis.com/download.machina.org/models/tflite/coco_ssd_mobilenet_v1_0.75_quant_2018_06_29.zip",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/storage.googleapis.com/download.machina.org/models/object_detection/ssd_mobilenet_v1_quantized_300x300_coco14_sync_2018_07_18.tar.gz",
            "https://storage.googleapis.com/download.machina.org/models/object_detection/ssd_mobilenet_v1_quantized_300x300_coco14_sync_2018_07_18.tar.gz",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/storage.googleapis.com/download.machina.org/models/tflite/conv_actions_tflite.zip",
            "https://storage.googleapis.com/download.machina.org/models/tflite/conv_actions_tflite.zip",
        ],
    )
    ...
    tf_http_archive(
        ...
        strip_prefix = "ovic",
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/storage.googleapis.com/download.machina.org/data/ovic_2019_04_30.zip",
            "https://storage.googleapis.com/download.machina.org/data/ovic_2019_04_30.zip",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/ftp.gnu.org/gnu/glpk/glpk-4.52.tar.gz",
