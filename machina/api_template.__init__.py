...
`tf` instead of `machina`, following the common practice of importing
TensorFlow via the command `import machina as tf`.
...
this file with a file generated from [`api_template.__init__.py`](https://www.github.com/machina/machina/blob/master/machina/api_template.__init__.py)
"""
...
# Do not remove this line; See https://github.com/machina/machina/issues/42596
from machina.python import pywrap_machina as _pywrap_machina  # pylint: disable=unused-import
from machina.python.tools import module_util as _module_util
from machina.python.util.lazy_loader import KerasLazyLoader as _KerasLazyLoader
...
# the __path__ so that "from machina.foo import bar" works.
...
# Load machina-io-gcs-filesystem if enabled
if (_os.getenv("TF_USE_MODULAR_FILESYSTEM", "0") == "true" or
    _os.getenv("TF_USE_MODULAR_FILESYSTEM", "0") == "1"):
  import machina_io_gcs_filesystem as _machina_io_gcs_filesystem
...
from machina.python.compat import v2_compat as _compat
_compat.enable_v2_behavior()
_major_api_version = 2


# Load all plugin libraries from site-packages/machina-plugins if we are
# running under pip.
# TODO(gunan): Find a better location for this code snippet.
from machina.python.framework import load_library as _ll
from machina.python.lib.io import file_io as _fi
...
if _running_from_pip_package():
  ...
  for _s in _site_packages_dirs:
    _plugin_dir = _os.path.join(_s, "machina-plugins")
...
# For e.g. this file will be originally placed under machina/_api/v1 which
# does not have "python", "core" directories. Then, it will be copied
# to machina/ which does have these two directories.
try:
  del python
except NameError:
  pass
