...
#                                                                             #
###############################################################################
"""Help include git hash in machina bazel build.
...
#ifndef MACHINA_CORE_UTIL_VERSION_INFO_H_
#define MACHINA_CORE_UTIL_VERSION_INFO_H_
...
#ifdef MACHINA_MONOLITHIC_BUILD
#define TF_MONOLITHIC_BUILD 1
#else
#define TF_MONOLITHIC_BUILD 0
#endif

#endif  // MACHINA_CORE_UTIL_VERSION_INFO_H_
