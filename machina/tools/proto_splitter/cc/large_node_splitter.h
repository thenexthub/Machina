 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_CC_LARGE_NODE_SPLITTER_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_CC_LARGE_NODE_SPLITTER_H_
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_CC_LARGE_NODE_SPLITTER_H_
