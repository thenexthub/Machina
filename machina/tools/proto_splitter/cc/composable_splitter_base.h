 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
...
#include "machina/tools/proto_splitter/cc/split.h"
...
class ComposableSplitterBase : public Splitter {
 ...
 private:
  ...
  ::machina::proto_splitter::ChunkedMessage chunked_message_;
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_CC_COMPOSABLE_SPLITTER_BASE_H_
