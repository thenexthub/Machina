...
using ::machina::proto_splitter_testdata::ManyFields;
...
absl::StatusOr<
    tsl::protobuf::RepeatedPtrField<::machina::proto_splitter::FieldIndex>>
MakeFieldTags() {
...
TEST(UtilTest, TestReadChunk) {
  std::string cpb_file =
      io::JoinPath(machina::testing::TensorFlowSrcRoot(),
  ...
  ::machina::proto_splitter::ChunkMetadata metadata = read_metadata.value();
