 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_CC_SIZE_SPLITTER_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_CC_SIZE_SPLITTER_H_
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_CC_SIZE_SPLITTER_H_
