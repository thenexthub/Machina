 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_CC_TEST_UTIL_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_CC_TEST_UTIL_H_
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_CC_TEST_UTIL_H_
