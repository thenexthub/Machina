...
using ::machina::proto_splitter_testdata::RepeatedRepeatedString;
using ::machina::proto_splitter_testdata::RepeatedString;
...
TEST(RepeatedStringSplitterTest, TestWrite) {
  ...
  std::string output_prefix = machina::io::GetTempFilename("");
