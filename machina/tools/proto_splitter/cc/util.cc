...
absl::StatusOr<const std::vector<Field>> GetFieldTypes(
    const tsl::protobuf::RepeatedPtrField<
        ::machina::proto_splitter::FieldIndex>& field_tags) {
  ...
  for (int fti = 0; fti < field_tags.size();) {
    switch (field_tags[fti].kind_case()) {
      ...
      case ::machina::proto_splitter::FieldIndex::KindCase::kMapKey:
        ...
        break;
      case ::machina::proto_splitter::FieldIndex::KindCase::KIND_NOT_SET:
      default:
        return absl::FailedPreconditionError(absl::StrCat(
...
absl::StatusOr<::machina::proto_splitter::ChunkMetadata> GetChunkMetadata(
...
absl::StatusOr<std::string> ReadChunk(
    riegeli::RecordReaderBase& reader,
    const ::machina::proto_splitter::ChunkInfo& chunk_info) {
