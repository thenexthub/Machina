 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_CC_UTIL_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_CC_UTIL_H_
...
struct ChunkedProto {
  ...
  ::machina::proto_splitter::ChunkedMessage* chunked_message = nullptr;
};
...
absl::Status AddFieldTag(
    ...
    ::machina::proto_splitter::ChunkedField& chunked_field);
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_CC_UTIL_H_
