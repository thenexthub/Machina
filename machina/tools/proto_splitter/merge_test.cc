...
#include "machina/tools/proto_splitter/cc/test_util.h"
#include "machina/tools/proto_splitter/cc/util.h"
#include "machina/tools/proto_splitter/chunk.pb.h"
#include "machina/tools/proto_splitter/testdata/test_message.pb.h"
#include "tsl/platform/env.h"
#include "tsl/platform/protobuf.h"
#include "tsl/platform/statusor.h"

namespace machina::tools::proto_splitter {
...
TEST(MergeTest, TestMergeTreeChunksDepthFirst) {
  ...
  for (const auto& chunk : kDFSplitTreeChunks) {
    ::machina::proto_splitter_testdata::StringNode string_node;
    ::tsl::protobuf::TextFormat::ParseFromString(chunk, &string_node);
    std::unique_ptr<::tsl::protobuf::Message> node =
        std::make_unique<::machina::proto_splitter_testdata::StringNode>(
            string_node);
  ...
  ::machina::proto_splitter::ChunkedMessage chunked_message;
...
TEST(MergeTest, TestReadManyField) {
  ...
  ::machina::proto_splitter_testdata::ManyFields merged_many_field;
  TF_ASSERT_OK(Merger::Read(path, &merged_many_field));

  ::machina::proto_splitter_testdata::ManyFields test_many_field;
  TF_ASSERT_OK(tsl::ReadTextProto(
...
TEST(MergeTest, TestReadPartial) {
  ...
  ::machina::proto_splitter::ChunkMetadata chunk_metadata =
      read_metadata.value();
  ::machina::proto_splitter::ChunkMetadata partial_chunk_metadata;
...
TEST(MergeTest, TestProcessFieldReturnsErrorOnInvalidFieldNumber) {
  ...
  std::vector<std::unique_ptr<tsl::protobuf::Message>> chunks;
  chunks.push_back(
      std::make_unique<::machina::proto_splitter_testdata::ManyFields>());

  ::machina::proto_splitter_testdata::ManyFields merged;
