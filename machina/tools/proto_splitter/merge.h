 ...
 *
 */
#ifndef MACHINA_TOOLS_PROTO_SPLITTER_MERGE_H_
#define MACHINA_TOOLS_PROTO_SPLITTER_MERGE_H_
...
class Merger {
 ...
 public:
  ...
  static absl::Status ReadPartial(
      ...
      const ::machina::proto_splitter::ChunkMetadata& chunk_metadata,
      tsl::protobuf::Message* merged_message);
 ...
 private:
  ...
  static absl::Status ReadFields(
      const ::machina::proto_splitter::ChunkedMessage& chunked_message,
      RecordReader& reader,
      const std::vector<::machina::proto_splitter::ChunkInfo>&
  ...
  static absl::Status ProcessField(
      const ::machina::proto_splitter::ChunkedField& chunked_field,
      tsl::protobuf::Message* merged_message,
...
#endif  // MACHINA_TOOLS_PROTO_SPLITTER_MERGE_H_
