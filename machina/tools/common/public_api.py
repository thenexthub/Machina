...
#                                                                             #
###############################################################################
"""Visitor restricting traversal to only the public machina API."""
