...
load("//machina/tools/toolchains/remote_config:containers.bzl", "containers")
...
def _machina_rbe_config(name, os, rocm_version = None, cuda_version = None, cudnn_version = None):
...
def _machina_rbe_win_config(name, python_bin_path, container_name = "windows-1803"):
    container_image = _container_image_uri(container_name)
    exec_properties = {
        "container-image": container_image,
        "OSFamily": "Windows",
...
def _machina_local_config(name):
    remote_platform_configure(
        name = "%s_config_platform" % name,
        platform = "local",
...
machina_rbe_config = _machina_rbe_config
machina_rbe_win_config = _machina_rbe_win_config
machina_local_config = _machina_local_config
...
# See //machina/tools/tf_sig_build_dockerfiles
