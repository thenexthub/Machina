...
toolchain {
  ...
  tool_path { name: "ar" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-ar" }
  tool_path { name: "as" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-as" }
  tool_path { name: "compat-ld" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/ld.lld" }
  tool_path { name: "cpp" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-cpp" }
  tool_path { name: "dwp" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-dwp" }
  tool_path { name: "gcc" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/clang" }
  tool_path { name: "gcov" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-cov" }
  tool_path { name: "ld" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/ld.lld" }
  tool_path { name: "toolchain-profdata" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-profdata" }
  tool_path { name: "nm" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-nm" }
  tool_path { name: "objcopy" path: "%package(@local_config_clang6//clang6)%/toolchain/bin/toolchain-objcopy" }
  ...
  cxx_builtin_include_directory: "%package(@local_config_clang6//clang6)%/toolchain/lib/clang/6.0.0/include"
  ...
  unfiltered_cxx_flag: "%package(@local_config_clang6//clang6)%/toolchain/lib/clang/6.0.0/include"
  unfiltered_cxx_flag: "-isystem"
