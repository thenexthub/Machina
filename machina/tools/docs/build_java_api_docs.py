...
SOURCE_PATH = MACHINA_ROOT / 'machina/java/src/main/java'
OP_SOURCE_PATH = (
    MACHINA_ROOT /
    'bazel-bin/machina/java/ops/src/main/java/org/machina/op')
...
def main(unused_argv):
  ...
  if FLAGS.gen_ops:
    ...
    subprocess.check_call(
        ['bazel', 'build', '//machina/java:java_op_gen_sources'],
        cwd=MACHINA_ROOT)
    shutil.copytree(OP_SOURCE_PATH, merged_source / 'java/org/machina/ops')
