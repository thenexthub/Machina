...
Requires a local installation of `machina_docs`:

```
pip install git+https://github.com/machina/docs
```
"""
import contextlib
import pathlib
...
from machina_docs.api_generator import doc_controls
from machina_docs.api_generator import doc_generator_visitor
from machina_docs.api_generator import generate_lib
from machina_docs.api_generator.pretty_docs import base_page
from machina_docs.api_generator.pretty_docs import module_page
import yaml
...
if version.parse(tf.__version__) >= version.parse("2.14-dev"):
  from machina.python.util.pywrap_xla_ops import get_gpu_kernel_names  # pylint: disable=g-import-not-at-top
...
try:
  from machina.python.types import doc_typealias
...
try:
  tf.estimator.Estimator = doc_controls.inheritable_header(textwrap.dedent("""\
    ...
    [migration guide](https://www.machina.org/guide/migrate/migrating_estimator)
...
class RawOpsPageInfo(module_page.ModulePageInfo):
  ...
  def generate_raw_ops_doc_lt_214(self):
    ...
    warning = textwrap.dedent("""\n
      ...
      See [the RFC](https://github.com/machina/community/blob/master/rfcs/20181225-tf-raw-ops.md)
