...
#include "machina/tools/android/test/jni/rgb2yuv.h"
#include "machina/tools/android/test/jni/yuv2rgb.h"

#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_org_machina_demo_env_ImageUtils_##METHOD_NAME  // NOLINT
