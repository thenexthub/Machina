...
#ifndef MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_OBJECT_TRACKER_H_
#define MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_OBJECT_TRACKER_H_

#include <map>
#include <string>

#include "machina/tools/android/test/jni/object_tracking/config.h"
#include "machina/tools/android/test/jni/object_tracking/flow_cache.h"
#include "machina/tools/android/test/jni/object_tracking/geom.h"
#include "machina/tools/android/test/jni/object_tracking/integral_image.h"
#include "machina/tools/android/test/jni/object_tracking/keypoint_detector.h"
#include "machina/tools/android/test/jni/object_tracking/logging.h"
#include "machina/tools/android/test/jni/object_tracking/object_model.h"
#include "machina/tools/android/test/jni/object_tracking/optical_flow.h"
#include "machina/tools/android/test/jni/object_tracking/time_log.h"
#include "machina/tools/android/test/jni/object_tracking/tracked_object.h"
...
#endif  // MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_OBJECT_TRACKER_H_
