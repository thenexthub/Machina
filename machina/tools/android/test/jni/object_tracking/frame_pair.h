...
#ifndef MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_FRAME_PAIR_H_
#define MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_FRAME_PAIR_H_
...
#endif  // MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_FRAME_PAIR_H_
