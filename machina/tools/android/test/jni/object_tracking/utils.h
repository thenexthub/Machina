...
#ifndef MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_UTILS_H_
#define MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_UTILS_H_
...
#endif  // MACHINA_TOOLS_ANDROID_TEST_JNI_OBJECT_TRACKING_UTILS_H_
