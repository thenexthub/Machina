...
#include "machina/tools/android/inference_interface/jni/run_stats_jni.h"
...
#define RUN_STATS_METHOD(name) \
  JNICALL Java_org_machina_contrib_android_RunStats_##name
