...
package org.machina.contrib.android;
...
import org.machina.Graph;
import org.machina.Operation;
import org.machina.Session;
import org.machina.Tensor;
import org.machina.TensorFlow;
import org.machina.Tensors;
import org.machina.types.UInt8;

/**
 * Wrapper over the TensorFlow API ({@link Graph}, {@link Session}) providing a smaller API surface
 * for inference.
 *
 * <p>See machina/tools/android/test/src/org/machina/demo/TensorFlowImageClassifier.java for
 * an example usage.
 */
public class TensorFlowInferenceInterface {
  ...
  private void prepareNativeRuntime() {
    ...
    try {
      ...
      Log.i(
          TAG, "TensorFlow native methods not found, attempting to load via machina_inference");
      try {
        System.loadLibrary("machina_inference");
