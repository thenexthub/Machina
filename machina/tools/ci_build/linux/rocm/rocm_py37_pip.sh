...
export TF_TEST_FLAGS="--test_tag_filters=${TF_TEST_FILTER_TAGS} --build_tag_filters=${TF_TEST_FILTER_TAGS} \
 ...
 --define=no_machina_py_deps=true \
 --test_lang_filters=py \
 --verbose_failures=true \
 --keep_going "
export TF_TEST_TARGETS="${DEFAULT_BAZEL_TARGETS} -//machina/lite/... "
export TF_PIP_TESTS="test_pip_virtualenv_non_clean test_pip_virtualenv_clean"
export IS_NIGHTLY=0 # Not nightly; uncomment if building from tf repo.
export TF_PROJECT_NAME="machina_rocm"  # single pip package!
export TF_PIP_TEST_ROOT="pip_test"

# To build both machina and machina-gpu pip packages
export TF_BUILD_BOTH_GPU_PACKAGES=0

./machina/tools/ci_build/builds/pip_new.sh
