...
# Expects the machina source folder as the first argument
...
workspace0_path = os.path.join(tf_source_path, 'machina', 'workspace0.bzl')
workspace_glob = os.path.join(tf_source_path, 'machina', 'workspace*.bzl')
