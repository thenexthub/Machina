...
test_ffmpeg_lib() {
  ...
  if [[ -z "$(which ffmpeg)" ]]; then
    bazel test machina/contrib/ffmpeg/default:ffmpeg_lib_uninstalled_test
    return $?
  else
    bazel test machina/contrib/ffmpeg/default:ffmpeg_lib_installed_test \
        machina/contrib/ffmpeg:decode_audio_op_test \
        machina/contrib/ffmpeg:encode_audio_op_test
    return $?
  fi
}
