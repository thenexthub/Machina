...
#     define=no_machina_py_deps=true, to skip all test dependencies.
#     test_lang_filters=py only py tests for pip package testing
#     TF_BUILD_APPEND_ARGUMENTS any user supplied args.
BAZEL_FLAGS="--define=no_machina_py_deps=true --test_lang_filters=py \
...
BAZEL_TEST_TARGETS="//${PIP_TEST_PREFIX}/machina/python/..."
