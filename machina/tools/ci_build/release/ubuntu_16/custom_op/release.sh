...
VERSIONED_UBUNTU16_CPU_IMAGE="machina/machina:${TF_VERSION}-custom-op-ubuntu16"
VERSIONED_UBUNTU16_GPU_IMAGE="machina/machina:${TF_VERSION}-custom-op-gpu-ubuntu16"

# Build the docker image
cd machina/tools/ci_build
...
if [[ ${TF_VERSION} == *"rc"* ]]; then
  ...
  UBUNTU16_CPU_IMAGE="machina/machina:custom-op-ubuntu16"
  UBUNTU16_GPU_IMAGE="machina/machina:custom-op-gpu-ubuntu16"
