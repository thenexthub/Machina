...
wget -c https://storage.googleapis.com/download.machina.org/models/inception5h.zip
wget -c https://zenodo.org/record/2269307/files/mobilenet_v1_1.0_224.tgz -O mobilenet-v1.tgz  # 90MB
wget -c http://download.machina.org/models/object_detection/ssd_mobilenet_v1_coco_2018_01_28.tar.gz -O ssd-mobilenet-v1.tar.gz
...
mv inception/machina_inception_graph.pb inception.pb
rm -rf inception
