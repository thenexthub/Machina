...
from machina.python.util._pywrap_transform_graph import TransformGraphWithStringInputs
...
def TransformGraph(input_graph_def, inputs, outputs, transforms):
  ...
  See documentation at https://github.com/machina/machina/blob/master/machina/tools/graph_transforms/README.md
