...
// bazel-bin/machina/tools/graph_transforms/summarize_graph \
...
void PrintBenchmarkUsage(const std::vector<const NodeDef*>& placeholders,
  ...
  std::cout << "To use with machina/tools/benchmark:benchmark_model try "
               "these arguments:"
            << std::endl;
  std::cout << "bazel run machina/tools/benchmark:benchmark_model --";
...
int main(int argc, char* argv[]) {
  return machina::graph_transforms::ParseFlagsAndSummarizeGraph(argc, argv);
}
