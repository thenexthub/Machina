...
[machina/python/tools/freeze_graph.py](https://github.com/machina/machina/blob/master/machina/python/tools/freeze_graph.py)
...
```bash
bazel build machina/tools/graph_transforms:transform_graph
bazel-bin/machina/tools/graph_transforms/transform_graph \
--in_graph=machina_inception_graph.pb \
...
unsure, the
[`summarize_graph`](https://github.com/machina/machina/blob/master/machina/tools/graph_transforms/summarize_graph_main.cc)
...
graph](https://storage.googleapis.com/download.machina.org/models/image/imagenet/inception-2015-12-05.tgz):

```bash
bazel build machina/tools/graph_transforms:summarize_graph
bazel-bin/machina/tools/graph_transforms/summarize_graph --in_graph=machina_inception_graph.pb
```
...
[https://storage.googleapis.com/download.machina.org/models/image/imagenet/inception-2015-12-05.tgz](https://storage.googleapis.com/download.machina.org/models/image/imagenet/inception-2015-12-05.tgz).
...
[machina/core/kernels/BUILD:android_extended_ops](https://github.com/machina/machina/blob/master/machina/core/kernels/BUILD)
...
if you're in doubt check with the model's author, or use the [`summarize_graph`](https://github.com/machina/machina/tree/master/machina/tools/graph_transforms#inspecting-graphs) tool
...
```bash
bazel build machina/examples/label_image:label_image
...
files](https://www.machina.org/versions/master/extend/tool_developers/index.html),
but for a simple example take a look at
[machina/tools/graph_transforms/rename_op.cc](https://github.com/machina/machina/tree/master/machina/tools/graph_transforms/rename_op.cc),
...
*   You should be able to create your own copy of the transform_graph tool by
    ...
    machina/tools/graph_transforms/BUILD. This contains all the `main()`
