...
#ifndef MACHINA_TOOLS_GRAPH_TRANSFORMS_TRANSFORM_UTILS_H_
#define MACHINA_TOOLS_GRAPH_TRANSFORMS_TRANSFORM_UTILS_H_
...
#define REGISTER_GRAPH_TRANSFORM_UNIQ(ctr, name, func)    \
  static machina::graph_transforms::TransformRegistrar \
      registrar__body__##ctr##__object(name, func);

}  // namespace graph_transforms
}  // namespace machina

#endif  // MACHINA_TOOLS_GRAPH_TRANSFORMS_TRANSFORM_UTILS_H_
