...
#ifndef MACHINA_TOOLS_GRAPH_TRANSFORMS_FOLD_CONSTANTS_LIB_H_
#define MACHINA_TOOLS_GRAPH_TRANSFORMS_FOLD_CONSTANTS_LIB_H_
...
#endif  // MACHINA_TOOLS_GRAPH_TRANSFORMS_FOLD_CONSTANTS_LIB_H_
