...
//
// bazel build machina/tools/graph_transforms:compare_graphs
// bazel-bin/machina/tools/graph_transforms/compare_graphs a.pb b.pb
//
...
int main(int argc, char* argv[]) {
  return machina::graph_transforms::ParseFlagsAndCompareGraphs(argc, argv);
}
