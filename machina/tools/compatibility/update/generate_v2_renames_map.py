...
"""Script for updating machina/tools/compatibility/renames_v2.py.

To update renames_v2.py, run:
  bazel run machina/tools/compatibility/update:generate_v2_renames_map
...
from machina import python as tf_python  # pylint: disable=unused-import
from machina.python import modules_with_exports  # pylint: disable=unused-import
...
_OUTPUT_FILE_PATH = 'third_party/machina/tools/compatibility/renames_v2.py'
_FILE_HEADER = """###############################################################################
#                                                                             #
#   Copyright (c) 2025, NeXTHub Corporation. All Rights Reserved.             #
#   DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.             #
