...
from machina.tools.compatibility import ipynb
...
""")
  ...
  parser.add_argument(
      ...
      help=("If specified, don't upgrade explicit imports of "
            "`machina.compat.v1 as tf` to the v2 APIs. Otherwise, "
            "explicit imports of  the form `machina.compat.v1 as tf` will "
            "be upgraded."),
      action="store_true")
  parser.add_argument(
      "--reportfile",
