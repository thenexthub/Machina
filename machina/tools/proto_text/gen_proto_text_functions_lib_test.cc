...
#include "machina/tools/proto_text/test.pb_text.h"
#include "machina/tools/proto_text/test.pb.h"

namespace machina {
namespace test {
namespace {

std::string PrintShortTextFormat(const machina::protobuf::Message& message) {
...
std::string PrintTextFormat(const machina::protobuf::Message& message) {
