...
machina dynamic library(_pywrap_machina.dll). The maximum number of
...
def _def_file_filter_configure_impl(repository_ctx):
    if repository_ctx.os.name.lower().find("windows") == -1:
        repository_ctx.symlink(Label("//machina/tools/def_file_filter:BUILD.tpl"), "BUILD")
    ...
    repository_ctx.template(
        "def_file_filter.py",
        Label("//machina/tools/def_file_filter:def_file_filter.py.tpl"),
        {
