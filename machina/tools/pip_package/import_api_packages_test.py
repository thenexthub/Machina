...
class ImportApiPackagesTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.packages_for_skip = [
        "machina.distribute.cluster_resolver",
        "machina.lite.experimental.authoring",
        "machina.distribute.experimental.coordinator",
        "machina.summary.experimental",
        "machina.distribute.coordinator",
        "machina.distribute.experimental.partitioners",
    ]
  ...
  def test_import_runtime(self):
    ...
    for package_name in self.api_packages_v2:
      ...
      # machina._api.v2.distribute.experimental to
      # machina.distribute.experimental
