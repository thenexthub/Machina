...
Should be set via --repo_env=WHEEL_NAME=machina_cpu.
2) `--collab` - whether this is a collaborator build.
3) `--version` - machina version.
...
tf_wheel = rule(
    attrs = {
        ...
        "wheel_binary": attr.label(
            default = Label("//machina/tools/pip_package:build_pip_package_py"),
            executable = True,
            cfg = "exec",
        ),
