...
PATH_TO_DIR = "machina/tools/machina_builder/compat_checker"
...
class ConfigCompatChecker:
    ...
    for section in parser.sections():
      ...
      for config in all_configs:
        ...
        if section == "Dependency":
          ...
          #
          # For example:
          # [`python`, _Reqs(), `machina`, _Reqs()] for
          # `python 3.7 requires machina 1.13`
  ...
  def filter_dependency(self, line):
    ...
    e.g.
      `python 3.7 requires machina 1.13`
      `machina range(1.0.0, 1.13.1) requires gcc range(4.8, )`
