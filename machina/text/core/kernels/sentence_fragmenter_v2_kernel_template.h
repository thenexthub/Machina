...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_SENTENCE_FRAGMENTER_V2_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_SENTENCE_FRAGMENTER_V2_KERNEL_TEMPLATE_H_
...
absl::Status SentenceFragmenterV2Op<Rt>::Invoke(InvokeContext* context) {
  ...
  const auto document = input_values->template As<machina::tstring, 1>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_SENTENCE_FRAGMENTER_V2_KERNEL_TEMPLATE_H_
