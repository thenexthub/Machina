...
#include "machina_text/core/kernels/regex_split.h"

namespace machina {
namespace text {

class RegexSplitOp : public machina::OpKernel {
 public:
  explicit RegexSplitOp(machina::OpKernelConstruction* ctx)
...
REGISTER_KERNEL_BUILDER(
    Name("RegexSplitWithOffsets").Device(machina::DEVICE_CPU), RegexSplitOp);
