...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
...
#include "machina_text/core/kernels/boise_offset_converter.h"
...
class OffsetsToBoiseTagsOp
 ...
 public:
  ...
  // Inputs declaration (syntax: https://www.machina.org/guide/create_op)
  static std::vector<std::string> Inputs();

  // Outputs declaration (syntax: https://www.machina.org/guide/create_op)
...
absl::Status OffsetsToBoiseTagsOp<Rt>::Invoke(InvokeContext* context) {
  ...
  const auto& input_span_type_vec =
      input_span_type->template As<machina::tstring, 1>();
...
absl::Status BoiseTagsToOffsetsOp<Rt>::Invoke(InvokeContext* context) {
  ...
  const auto& input_boise_tags_vec =
      input_boise_tags->template As<machina::tstring, 1>();
  ...
  SH_RETURN_IF_ERROR(FillOutputTensor<std::string, machina::tstring>(
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
