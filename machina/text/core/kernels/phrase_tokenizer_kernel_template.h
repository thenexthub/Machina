...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_PHRASE_TOKENIZER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_PHRASE_TOKENIZER_KERNEL_TEMPLATE_H_

#include "absl/status/status.h"
#include "absl/strings/str_cat.h"
#include "machina/lite/kernels/shim/op_kernel.h"
#include "machina/lite/kernels/shim/status_macros.h"
#include "machina_text/core/kernels/phrase_tokenizer.h"
...
absl::Status PhraseTokenizeOp<Rt>::Invoke(InvokeContext* context) {
  ...
  auto phrase_tokenizer = ::machina::text::PhraseTokenizer::Create(
  ...
  auto output_subwords_vec =
      output_subwords->template As<machina::tstring, 1>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_phrase_TOKENIZER_KERNEL_TEMPLATE_H_
