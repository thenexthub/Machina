...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_H_
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_H_
