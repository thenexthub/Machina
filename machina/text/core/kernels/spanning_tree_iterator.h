...
#ifndef MACHINA_TEXT_CORE_KERNELS_SPANNING_TREE_ITERATOR_H_
#define MACHINA_TEXT_CORE_KERNELS_SPANNING_TREE_ITERATOR_H_
...
#endif  // MACHINA_TEXT_CORE_KERNELS_SPANNING_TREE_ITERATOR_H_
