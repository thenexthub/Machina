...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
...
#include "machina_text/core/kernels/utf8_binarize.h"
...
absl::Status Utf8BinarizeOp<Rt>::Invoke(InvokeContext* context) {
  ...
  const auto tokens = (*tokens_statusor)->template As<machina::tstring, 1>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
