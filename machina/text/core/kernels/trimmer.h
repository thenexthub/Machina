...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_TRIMMER_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_TRIMMER_H_
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_TRIMMER_H_
