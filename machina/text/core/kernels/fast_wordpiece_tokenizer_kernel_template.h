...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_WORDPIECE_TOKENIZER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_WORDPIECE_TOKENIZER_KERNEL_TEMPLATE_H_

#include "absl/status/status.h"
#include "absl/strings/str_cat.h"
#include "machina/lite/kernels/shim/op_kernel.h"
#include "machina/lite/kernels/shim/status_macros.h"
#include "machina_text/core/kernels/fast_wordpiece_tokenizer.h"
...
// TFLite. See
// https://github.com/machina/machina/tree/master/machina/lite/kernels/shim
...
class FastWordpieceTokenizeWithOffsetsOp
 ...
 public:
  ...
  // https://www.machina.org/guide/create_op)
...
absl::Status FastWordpieceTokenizeWithOffsetsOp<Rt>::Invoke(
  ...
  auto fast_wordpiece_tokenizer =
      ::machina::text::FastWordpieceTokenizer::Create(
...
absl::Status FastWordpieceDetokenizeOp<Rt>::Invoke(InvokeContext* context) {
  ...
  auto output_words_vec = output_words->template As<machina::tstring, 1>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_WORDPIECE_TOKENIZER_KERNEL_TEMPLATE_H_
