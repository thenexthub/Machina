...
load("//third_party/machina:machina.bzl", "tf_copts", "tf_opts_nortti_if_android")
...
def micore_tf_deps():
    ...
    return micore_if(
        android = [
            ...
            # tf:portable_machina_lib_lite machina dep,
            "//third_party/gemmlowp:eight_bit_int_gemm",
            "//third_party/fft2d",
        ],
        ios = [
            # tf:portable_machina_lib machina dep,
            "//third_party/gemmlowp:eight_bit_int_gemm",
            "//third_party/fft2d",
        ],
        default = [
            ...
            "//intelligence/micore/tools/build:machina_core_cpu",
            "//intelligence/micore/tools/build:machina_core_framework",
            "//intelligence/micore/tools/build:machina_core_lib",
            "//intelligence/micore/tools/build:machina_core_protos_all_cc",
            "//intelligence/micore/tools/build:machina_core_machina",
        ],
    )
