...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_BERT_NORMALIZER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_BERT_NORMALIZER_KERNEL_TEMPLATE_H_
...
absl::Status FastBertNormalizeOp<Rt>::InvokeRealWork(InvokeContext* context) {
  ...
  auto output_values_vec = output_values->template As<machina::tstring, 1>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_FAST_BERT_NORMALIZER_KERNEL_TEMPLATE_H_
