...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_H_
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BOISE_OFFSET_CONVERTER_H_
