...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
...
#include "machina_text/core/kernels/whitespace_tokenizer.h"
...
template <tflite::shim::Runtime Rt>
  ...
  const auto values = (*values_statusor)->template As<machina::tstring, 1>();
  ...
  const absl::string_view config =
      (*cfg_statusor)->template AsScalar<machina::tstring>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
