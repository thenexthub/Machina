...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_TEMPLATE_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_TEMPLATE_H_
...
#include "machina_text/core/kernels/round_robin_trimmer.h"
...
absl::Status RoundRobinTrimOp<Rt, T, Tsplits>::Invoke(InvokeContext* context) {
  ...
  const int max_sequence_length = msl->template AsScalar<machina::int32>();
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_ROUND_ROBIN_TRIMMER_KERNEL_TEMPLATE_H_
