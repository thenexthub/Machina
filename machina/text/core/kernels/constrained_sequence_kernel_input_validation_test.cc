...
#include "machina_text/core/kernels/text_kernels_test_util.h"
...
using machina::text_kernels_test_util::MatrixEq;
using machina::text_kernels_test_util::VectorEq;

class ConstrainedSequenceInputValidationTest : public machina::OpsTestBase {
 public:
  void SetUpOpWithDefaults(bool use_start_end,
                           machina::DataType input_datatype) {
    // Prepare graph.
