...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BYTE_TOKENIZER_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BYTE_TOKENIZER_H_
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_BYTE_TOKENIZER_H_
