...
#include "machina_text/core/kernels/fast_wordpiece_tokenizer_model_builder.h"
...
#include "machina_text/core/kernels/darts_clone_trie_builder.h"
...
#include "machina_text/core/kernels/sentence_fragmenter_v2.h"
#include "machina_text/core/kernels/string_vocab.h"
...
absl::StatusOr<std::string> FastWordpieceBuilder::ExportToFlatBuffer() const {
  ...
  std::vector<machina::text::FailureStruct> failure_struct_fbs_vector;
