...
#ifndef THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_DARTS_CLONE_TRIE_BUILDER_H_
#define THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_DARTS_CLONE_TRIE_BUILDER_H_
...
#endif  // THIRD_PARTY_MACHINA_TEXT_CORE_KERNELS_DARTS_CLONE_TRIE_BUILDER_H_
