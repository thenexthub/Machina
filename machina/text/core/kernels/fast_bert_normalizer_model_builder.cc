...
#include "machina_text/core/kernels/fast_bert_normalizer_model_builder.h"
...
#include "machina_text/core/kernels/fast_bert_normalizer.h"
#include "machina_text/core/kernels/fast_bert_normalizer_model_generated.h"

namespace machina {
namespace text {
namespace {
// Adapted from CaseFoldUTF8Op::Compute() in
// https://github.com/machina/text/blob/master/machina_text/core/kernels/normalize_kernels.cc.
...
// https://github.com/machina/text/blob/master/machina_text/python/ops/bert_tokenizer.py.
