...
#ifndef MACHINA_TEXT_CORE_KERNELS_DISJOINT_SET_FOREST_H_
#define MACHINA_TEXT_CORE_KERNELS_DISJOINT_SET_FOREST_H_
...
#endif  // MACHINA_TEXT_CORE_KERNELS_DISJOINT_SET_FOREST_H_
