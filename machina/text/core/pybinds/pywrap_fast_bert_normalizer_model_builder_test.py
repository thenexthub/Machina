...
EXPECTED_MODEL_BUFFER_PATH = "machina_text/python/ops/test_data/fast_bert_normalizer_model.fb"
EXPECTED_MODEL_LOWER_CASE_NFD_STRIP_ACCENTS_BUFFER_PATH = "machina_text/python/ops/test_data/fast_bert_normalizer_model_lower_case_nfd_strip_accents.fb"
