...
from machina_text.python import ops as text_ops
from machina_text.python.benchmarks import benchmark_utils
from machina_text.python.ops.bert_tokenizer import BasicTokenizer
...
# absl FLAGS
_BERT_VOCAB_PATH = "machina_text/python/benchmarks/test_data/uncased_L-12_H-768_A-12/vocab.txt"
_HUB_MODULE_HANDLE = "machina_text/python/ops/test_data/segmenter_hub_module"
_SENTENCEPIECE_MODEL_FILE = "machina_text/python/ops/test_data/test_oss_model.model"
_FAST_SENTENCEPIECE_MODEL_FILE = "machina_text/python/ops/test_data/fast_sentencepiece.model"
