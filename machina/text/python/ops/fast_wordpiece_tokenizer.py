...
from machina_text.core.pybinds import pywrap_fast_wordpiece_tokenizer_model_builder
...
class FastWordpieceTokenizer(TokenizerWithOffsets, Detokenizer):
  ...
  [WordpieceTokenizer](https://www.machina.org/text/api_docs/python/text/WordpieceTokenizer)
