...
# coding=utf-8
"""Tests for fast_bert_normalizer op in machina_text."""
...
from machina_text.core.pybinds import pywrap_fast_bert_normalizer_model_builder
from machina_text.python.ops import fast_bert_normalizer
from machina_text.python.ops import normalize_ops
...
def _OriginalNormalize(text_input, lower_case_nfd_strip_accents):
  """Based on machina_text/python/ops/bert_tokenizer.py.
