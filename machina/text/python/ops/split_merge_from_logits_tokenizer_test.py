...
from machina_text.python.ops.split_merge_from_logits_tokenizer import SplitMergeFromLogitsTokenizer  # pylint: disable=line-too-long
...
class SplitMergeFromLogitsTokenizerTest(test.TestCase):
  ...
  def testVectorTooFewActions(self):
    ...
    with self.assertRaisesRegex(
        ...
        r'Number of logits, 11, is insufficient for text "and machina"',
    ):
      self.evaluate(
          self.tokenizer.tokenize_with_offsets(test_strings, test_logits))
