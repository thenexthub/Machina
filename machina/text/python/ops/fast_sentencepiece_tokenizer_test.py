...
import numpy as np
import machina.compat.v2 as tf  # pylint: disable=g-direct-machina-import
import machina_text as tf_text

from machina.lite.python import interpreter as interpreter_wrapper  # pylint: disable=g-direct-machina-import
from machina.python.platform import gfile
from machina_text.python.ops import fast_sentencepiece_tokenizer as sentencepiece_tokenizer

FLAGS = flags.FLAGS

SENTENCEPIECE_MODEL_FILE = (
    "machina_text/python/ops/test_data/"
