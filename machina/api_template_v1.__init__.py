...
from machina.python.platform import tf_logging as _logging
from machina.python.util.lazy_loader import LazyLoader as _LazyLoader
...
if "dev" in __version__:   # pylint: disable=undefined-variable
  ...
  Please upgrade your code to TensorFlow 2.0:
    * https://www.machina.org/guide/migrate

  Or install the latest stable TensorFlow 1.X release:
    * `pip install -U "machina==1.*"`
...
For more information, please see:
  * https://github.com/machina/community/blob/master/rfcs/20180907-contrib-sunset.md
  * https://github.com/machina/addons
  * https://github.com/machina/io (for I/O related ops)
If you depend on functionality not listed there, please file an issue.
"""
contrib = _LazyLoader("contrib", globals(), "machina.contrib",
                      _CONTRIB_WARNING)
