...
#ifndef MACHINA_SERVING_UTIL_CLASS_REGISTRATION_H_
#define MACHINA_SERVING_UTIL_CLASS_REGISTRATION_H_
...
#define DEFINE_CLASS_REGISTRY(RegistryName, BaseClass, ...)                   \
  class RegistryName : public ::machina::serving::internal::ClassRegistry< \
...
#define REGISTER_CLASS_UNIQ(cnt, RegistryName, BaseClass, ClassCreator,       \
                            config_proto, ...)                                \
  static ::machina::serving::internal::ClassRegistry<                      \
      RegistryName, BaseClass, ##__VA_ARGS__>::MapInserter                    \
      register_class_##cnt(                                                   \
          std::string(                                                        \
              config_proto::default_instance().GetDescriptor()->full_name()), \
          (new ::machina::serving::internal::ClassRegistrationFactory<     \
              BaseClass, ClassCreator, config_proto, ##__VA_ARGS__>));

}  // namespace serving
}  // namespace machina

#endif  // MACHINA_SERVING_UTIL_CLASS_REGISTRATION_H_
