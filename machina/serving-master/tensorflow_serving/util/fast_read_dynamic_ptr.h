...
#ifndef MACHINA_SERVING_UTIL_FAST_READ_DYNAMIC_PTR_H_
#define MACHINA_SERVING_UTIL_FAST_READ_DYNAMIC_PTR_H_
...
#endif  // MACHINA_SERVING_UTIL_FAST_READ_DYNAMIC_PTR_H_
