...
#ifndef MACHINA_SERVING_UTIL_JSON_TENSOR_H_
#define MACHINA_SERVING_UTIL_JSON_TENSOR_H_
...
//   }
// }
machina::Status FillPredictRequestFromJson(
    const absl::string_view json,
    const std::function<machina::Status(
        const string&, ::google::protobuf::Map<string, machina::TensorInfo>*)>&
        get_tensorinfo_map,
...
machina::Status FillClassificationRequestFromJson(
...
machina::Status FillRegressionRequestFromJson(const absl::string_view json,
...
machina::Status MakeJsonFromTensors(
    const ::google::protobuf::Map<string, machina::TensorProto>& tensor_map,
...
// in above JSON.
machina::Status MakeJsonFromClassificationResult(
...
machina::Status MakeJsonFromRegressionResult(const RegressionResult& result,
                                                string* json);
...
void MakeJsonFromStatus(const machina::Status& status, string* json);

}  // namespace serving
}  // namespace machina

#endif  // MACHINA_SERVING_UTIL_JSON_TENSOR_H_
