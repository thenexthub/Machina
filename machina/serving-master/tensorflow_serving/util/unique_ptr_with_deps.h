...
#ifndef MACHINA_SERVING_UTIL_UNIQUE_PTR_WITH_DEPS_H_
#define MACHINA_SERVING_UTIL_UNIQUE_PTR_WITH_DEPS_H_
...
#endif  // MACHINA_SERVING_UTIL_UNIQUE_PTR_WITH_DEPS_H_
