...
#ifndef MACHINA_SERVING_UTIL_NET_HTTP_PUBLIC_HEADER_NAMES_H_
#define MACHINA_SERVING_UTIL_NET_HTTP_PUBLIC_HEADER_NAMES_H_
...
#endif  // MACHINA_SERVING_UTIL_NET_HTTP_PUBLIC_HEADER_NAMES_H_
