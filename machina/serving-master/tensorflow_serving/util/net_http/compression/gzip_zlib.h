...
#ifndef MACHINA_SERVING_UTIL_NET_HTTP_COMPRESSION_GZIP_ZLIB_H_
#define MACHINA_SERVING_UTIL_NET_HTTP_COMPRESSION_GZIP_ZLIB_H_
...
#endif  // MACHINA_SERVING_UTIL_NET_HTTP_COMPRESSION_GZIP_ZLIB_H_
