...
A
[SignatureDef](https://github.com/machina/machina/blob/master/machina/core/protobuf/meta_graph.proto)
...
[SavedModel](https://github.com/machina/machina/blob/master/machina/python/saved_model/builder.py).

## Background

[TF-Exporter](https://github.com/machina/machina/blob/master/machina/contrib/session_bundle/README.md)
and
[SessionBundle](https://github.com/machina/machina/blob/master/machina/contrib/session_bundle/session_bundle.h)
used
[Signatures](https://github.com/machina/machina/blob/master/machina/contrib/session_bundle/manifest.proto)
...
Note that
[TensorInfo](https://github.com/machina/machina/blob/master/machina/core/protobuf/meta_graph.proto#L194)
...
[util](https://github.com/machina/machina/blob/master/machina/python/saved_model/signature_def_utils.py)
...
signature_def: {
  ...
  value: {
    ...
    method_name: "machina/serving/classify"
  }
}
```
...
signature_def: {
  ...
  value: {
    ...
    method_name: "machina/serving/predict"
  }
}
```
...
signature_def: {
  ...
  value: {
    ...
    method_name: "machina/serving/regress"
  }
}
```
