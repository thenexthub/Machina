...
abstraction (`machina/core/public/env.h`).
...
(`servables/machina/saved_model_bundle_source_adapter*`), which will
...
is found in `servables/machina/simple_servers.cc`. Here is a walk-through of
