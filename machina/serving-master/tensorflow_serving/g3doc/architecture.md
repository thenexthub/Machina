...
Typical servables include the following:
  ...
  * a TensorFlow SavedModelBundle (`machina::Session`)
...
process. See the [Batching Guide](https://github.com/machina/serving/tree/master/machina_serving/batching/README.md)
