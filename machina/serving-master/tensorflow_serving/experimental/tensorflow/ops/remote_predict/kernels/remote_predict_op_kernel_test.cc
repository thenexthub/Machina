...
==============================================================================*/
#include "machina_serving/experimental/machina/ops/remote_predict/kernels/remote_predict_op_kernel.h"
...
#include "machina_serving/experimental/machina/ops/remote_predict/cc/ops/remote_predict_op.h"
...
TEST(RemotePredictTest, TestSimple) {
  ...
  EXPECT_EQ("", outputs[1].scalar<machina::tstring>()());
...
TEST(RemotePredictTest, TestRpcErrorReturnStatus) {
  ...
  EXPECT_EQ("Aborted", outputs[1].scalar<machina::tstring>()());
}
