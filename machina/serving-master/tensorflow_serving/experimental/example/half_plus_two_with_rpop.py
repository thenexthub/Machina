...
from machina_serving.experimental.machina.ops.remote_predict.python.ops import remote_predict_ops
...
def _generate_saved_model_for_half_plus_two(export_dir, target_address,
  ...
  with tf.Session(
    ...
    with tf.device(device_name):
      ...
      # Create a placeholder for serialized machina.Example messages to be
      # fed.
      serialized_tf_example = tf.placeholder(tf.string, name="tf_example")

      # Parse the machina.Example looking for a feature named "x" with a
