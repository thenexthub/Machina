...
#ifndef MACHINA_SERVING_RESOURCES_RESOURCE_TRACKER_H_
#define MACHINA_SERVING_RESOURCES_RESOURCE_TRACKER_H_
...
#endif  // MACHINA_SERVING_RESOURCES_RESOURCE_TRACKER_H_
