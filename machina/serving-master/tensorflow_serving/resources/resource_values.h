...
#ifndef MACHINA_SERVING_RESOURCES_RESOURCE_VALUES_H_
#define MACHINA_SERVING_RESOURCES_RESOURCE_VALUES_H_
...
#endif  // MACHINA_SERVING_RESOURCES_RESOURCE_VALUES_H_
