...
#ifndef THIRD_PARTY_MACHINA_SERVING_MODEL_SERVERS_SERVER_INIT_H_
#define THIRD_PARTY_MACHINA_SERVING_MODEL_SERVERS_SERVER_INIT_H_
...
#include "machina_serving/model_servers/http_rest_api_handler_base.h"
#include "machina_serving/model_servers/prediction_service_util.h"
...
// Register the machina serving functions.
class TensorflowServingFunctionRegistration {
 public:
  ...
  // The machina serving function registration. For TFRT, the TFRT
 ...
 private:
  TensorflowServingFunctionRegistration() {
    Register("machina", init::SetupPlatformConfigMapForTensorFlowImpl,
             init::UpdatePlatformConfigMapForTensorFlowImpl,
             init::CreateHttpRestApiHandlerImpl,
             init::CreatePredictionServiceImpl);
  }

  // The registration type, indicating the platform, e.g. machina, tfrt.
...
#endif  // THIRD_PARTY_MACHINA_SERVING_MODEL_SERVERS_SERVER_INIT_H_
