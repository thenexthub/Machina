...
#include "machina_serving/model_servers/get_model_status_impl.h"
...
#include "machina_serving/servables/machina/get_model_metadata_impl.h"
#include "machina_serving/servables/machina/predict_impl.h"
#include "machina_serving/servables/machina/regression_service.h"
#include "machina_serving/util/json_tensor.h"

namespace machina {
namespace serving {

using machina::serving::ServerCore;
using machina::serving::TensorflowPredictor;
...
Status HttpRestApiHandler::GetInfoMap(
    ...
    ::google::protobuf::Map<string, machina::TensorInfo>* infomap) {
