...
#include "machina_serving/model_servers/http_rest_api_handler.h"
#include "machina_serving/model_servers/http_rest_api_util.h"
...
#include "machina_serving/util/net_http/public/response_code_enum.h"
#include "machina_serving/util/net_http/server/public/httpserver.h"
#include "machina_serving/util/net_http/server/public/server_request_interface.h"
#include "machina_serving/util/prometheus_exporter.h"
...
class RestApiRequestDispatcher {
 public:
  RestApiRequestDispatcher(int timeout_in_ms, ServerCore* core)
    ...
    auto* tf_serving_registry = machina::serving::init::
