...
#include "machina_serving/core/servable_state.h"
#include "machina_serving/core/test_util/availability_test_util.h"
#include "machina_serving/core/test_util/fake_loader_source_adapter.pb.h"
#include "machina_serving/core/test_util/fake_log_collector.h"
#include "machina_serving/core/test_util/mock_prediction_stream_logger.h"
#include "machina_serving/core/test_util/mock_request_logger.h"
#include "machina_serving/model_servers/model_platform_types.h"
#include "machina_serving/model_servers/test_util/server_core_test_util.h"
...
class RelativePathsServerCoreTest : public ServerCoreTest {
 protected:
  ...
  ModelServerConfig GetTestModelServerConfigWithRelativePath(
    ...
    using ::machina::io::Basename;
    using ::machina::io::Dirname;
...
TEST_P(ServerCoreTest, StoragePathPrefixOption) {
  ...
  const string path_prefix = machina::io::JoinPath(
      getenv("TEST_SRCDIR"), "tf_serving/external/org_machina/machina/");
