...
#include "machina_serving/model_servers/tfrt_http_rest_api_handler.h"
...
#include "machina_serving/servables/machina/tfrt_get_model_metadata_impl.h"
...
absl::Status TFRTHttpRestApiHandler::GetInfoMap(
    ...
    ::google::protobuf::Map<std::string, machina::TensorInfo>* infomap) {
  ServableHandle<Servable> servable;
