...
#ifndef MACHINA_SERVING_MODEL_SERVERS_TEST_UTIL_SERVER_CORE_TEST_UTIL_H_
#define MACHINA_SERVING_MODEL_SERVERS_TEST_UTIL_SERVER_CORE_TEST_UTIL_H_
...
class ServerCoreTest : public ::testing::TestWithParam<std::tuple<int, bool>> {
 ...
 protected:
  ...
  // Returns ModelServerConfig that contains test model for the machina
  // platform.
  ...
  // machina platform, using the supplied options.
  Status CreateServerCore(const ModelServerConfig& config,
                          ServerCore::Options options,
                          std::unique_ptr<ServerCore>* server_core);

  // Creates a ServerCore object configured with both a fake platform and the
  // machina platform, using GetDefaultOptions().
  Status CreateServerCore(const ModelServerConfig& config,
                          std::unique_ptr<ServerCore>* server_core) {
...
#endif  // MACHINA_SERVING_MODEL_SERVERS_TEST_UTIL_SERVER_CORE_TEST_UTIL_H_
