...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_REGRESSOR_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_REGRESSOR_H_
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_REGRESSOR_H_
