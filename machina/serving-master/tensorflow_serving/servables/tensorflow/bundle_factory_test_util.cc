...
const char kTestMLMDSavedModelPath[] =
    "servables/machina/testdata/half_plus_two_mlmd/00000123";
...
std::vector<string> GetTestSessionBundleExportFiles() {
  ...
  return {machina::io::JoinPath(dir, "export.meta"),
          machina::io::JoinPath(dir, "export-00000-of-00001")};
}

std::vector<string> GetTestSavedModelBundleExportFiles() {
  const string dir = GetTestSavedModelPath();
  return {
      machina::io::JoinPath(dir, "saved_model.pb"),
      machina::io::JoinPath(dir, "assets/foo.txt"),
      machina::io::JoinPath(dir, "variables/variables.index"),
      machina::io::JoinPath(dir, "variables/variables.data-00000-of-00001")};
}
