...
#include "machina_serving/servables/machina/tfrt_saved_model_factory.h"
...
#include "machina/core/kernels/batching_util/shared_batch_scheduler.h"
...
#include "machina_serving/batching/tfrt_saved_model_with_batching.h"
...
#include "machina_serving/servables/machina/bundle_factory_util.h"
#include "machina_serving/servables/machina/machine_learning_metadata.h"
#include "machina_serving/servables/machina/saved_model_config.h"
#include "machina_serving/servables/machina/saved_model_config_util.h"
#include "machina_serving/servables/machina/servable.h"
#include "machina_serving/servables/machina/tfrt_saved_model_source_adapter.pb.h"
#include "machina_serving/servables/machina/tfrt_saved_model_warmup.h"
#include "machina_serving/servables/machina/tfrt_servable.h"
...
#include "machina_serving/session_bundle/graph_rewriter.h"
...
absl::Status WrapSavedModelForBatching(
  ...
  auto queue_options =
      GetQueueOptions<machina::serving::SavedModelBatchingTask>(
          batching_config,
          [](std::unique_ptr<machina::serving::SavedModelBatchingTask>*
                 input_task,
...
absl::Status TfrtSavedModelFactory::CreateTfrtSavedModelWithMetadata(
  ...
  auto* runtime = machina::tfrt_stub::GetGlobalRuntime();
  ...
  if (auto& graph_rewriter = machina::serving::GraphRewriter::GetGlobal();
