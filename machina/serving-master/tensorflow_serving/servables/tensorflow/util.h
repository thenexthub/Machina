...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_UTIL_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_UTIL_H_
...
// set to machina::kDefaultServingSignatureDefKey.
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_UTIL_H_
