...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_SERVABLE_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_SERVABLE_H_
...
#include "machina_serving/servables/machina/run_options.h"
...
class Servable {
 public:
  ...
  using RunOptions = machina::serving::servables::RunOptions;
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_SERVABLE_H_
