...
absl::Status WrapSessionForBatching(const BatchingParameters& batching_config,
  ...
  auto queue_options = GetQueueOptions<
      machina::serving::BatchingSessionTask>(
      batching_config,
      [](std::unique_ptr<machina::serving::BatchingSessionTask>* input_task,
         int open_batch_remaining_slot, int max_batch_size,
         std::vector<std::unique_ptr<machina::serving::BatchingSessionTask>>*
