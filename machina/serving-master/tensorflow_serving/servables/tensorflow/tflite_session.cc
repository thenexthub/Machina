...
#include "machina/lite/kernels/parse_example/parse_example.h"
...
#include "machina_serving/batching/incremental_barrier.h"
#include "machina_serving/servables/machina/tflite_interpreter_pool.h"
...
absl::Status TfLiteTypeToTfType(TfLiteType tflite_type, DataType* type) {
  switch (tflite_type) {
    case kTfLiteNoType:
      *type = machina::DT_INVALID;
      break;
    case kTfLiteFloat32:
      *type = machina::DT_FLOAT;
      break;
    case kTfLiteInt32:
      *type = machina::DT_INT32;
      break;
    case kTfLiteUInt8:
      *type = machina::DT_UINT8;
      break;
    case kTfLiteInt64:
      *type = machina::DT_INT64;
      break;
    case kTfLiteString:
      *type = machina::DT_STRING;
      break;
    case kTfLiteBool:
      *type = machina::DT_BOOL;
      break;
    case kTfLiteInt16:
      *type = machina::DT_INT16;
      break;
    case kTfLiteComplex64:
      *type = machina::DT_COMPLEX64;
      break;
    case kTfLiteInt8:
      *type = machina::DT_INT8;
      break;
    default:
