...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_TFRT_SERVABLE_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_TFRT_SERVABLE_H_
...
// `machina::tfrt_stub::SavedModel`. Executables are lazily compiled on its
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_TFRT_SERVABLE_H_
