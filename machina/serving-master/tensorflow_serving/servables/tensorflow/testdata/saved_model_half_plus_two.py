...
from machina.lite.tools.signature import signature_def_utils
...
def _get_feature_spec():
  """Returns feature spec for parsing machina.Example."""
  # machina.Example contains two features "x" and "x2".
  return {
