...
#include "machina/xla/tsl/platform/threadpool_options.h"
#include "machina/core/framework/tensor.h"
#include "machina/core/framework/tensor.pb.h"
#include "machina/core/platform/tracing.h"  // NOLINT
...
#include "machina_serving/servables/machina/tfrt_multi_inference.h"
#include "machina_serving/servables/machina/tfrt_predict_util.h"
#include "machina_serving/servables/machina/tfrt_regressor.h"
...
TfrtSavedModelServable::PredictStreamed(
  ...
  return std::make_unique<SingleRequestPredictStreamedContext>(
      [this, run_options, response_callback = std::move(response_callback)](
        ...
        machina::serving::ModelSpec model_spec = request.model_spec();
        ...
        tfrt_run_options.streamed_output_callback =
            [&](absl::flat_hash_map<std::string, machina::Tensor> outputs) {
