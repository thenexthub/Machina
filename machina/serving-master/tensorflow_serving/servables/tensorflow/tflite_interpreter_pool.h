...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_TFLITE_INTERPRETER_POOL_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_TFLITE_INTERPRETER_POOL_H_
...
class TfLiteInterpreterWrapper {
 ...
 public:
  ...
  static Status CreateTfLiteInterpreterWrapper(
      ...
      const machina::SessionOptions& options,
  ...
  machina::Status SetStringData(const std::vector<const Tensor*>& tensors,
...
class TfLiteInterpreterPool {
 public:
  ...
  static machina::Status CreateTfLiteInterpreterPool(
      const tflite::FlatBufferModel* model,
      const machina::SessionOptions& options, int pool_size,
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_TFLITE_INTERPRETER_POOL_H_
