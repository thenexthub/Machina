...
#include "machina_serving/apis/internal/serialized_input.pb.h"
...
auto* example_counts = monitoring::Sampler<1>::New(
    {"/machina/serving/request_example_counts",
     "The number of machina.Examples per request.", "model"},
...
auto* example_count_total = monitoring::Counter<1>::New(
    "/machina/serving/request_example_count_total",
    "The total number of machina.Examples.", "model");

// Metrics by model
auto* model_request_status_count_total = monitoring::Counter<2>::New(
    "/machina/serving/request_count", "The total number of requests.",
    "model_name", "status");

auto* runtime_latency = monitoring::Sampler<3>::New(
    {
        "/machina/serving/runtime_latency",
...
auto* request_latency = monitoring::Sampler<3>::New(
    {
        "/machina/serving/request_latency",
