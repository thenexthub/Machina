...
#include "machina/lite/tools/signature/signature_def_util.h"
...
constexpr char kTestModel[] =
    "/servables/machina/testdata/saved_model_half_plus_two_tflite/00000123/"
    "model.tflite";
...
constexpr char kMobileNetModel[] =
    "/servables/machina/testdata/mobilenet_v1_quant_tflite/00000123/"
    "model.tflite";

constexpr char kParseExampleModel[] =
    "/servables/machina/testdata/parse_example_tflite/00000123/"
    "model.tflite";

TEST(TfLiteSession, BasicTest) {
  string model_bytes;
  TF_ASSERT_OK(ReadFileToString(machina::Env::Default(),
...
machina::DataType ToTfTensorType(tflite::TensorType tflite_type) {
  switch (tflite_type) {
