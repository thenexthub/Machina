...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_UTIL_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_UTIL_H_
...
#include "machina_serving/batching/batching_session.h"
#include "machina_serving/resources/resources.pb.h"
#include "machina_serving/servables/machina/resource_estimator.h"
...
// Estimates the resources a session bundle or saved model bundle will use once
// loaded, from its export or saved model path. machina::Env::Default() will
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_UTIL_H_
