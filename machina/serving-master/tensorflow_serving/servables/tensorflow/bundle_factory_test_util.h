...
#ifndef MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_TEST_UTIL_H_
#define MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_TEST_UTIL_H_
...
#endif  // MACHINA_SERVING_SERVABLES_MACHINA_BUNDLE_FACTORY_TEST_UTIL_H_
