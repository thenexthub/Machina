...
def tf_serving_workspace():
    ...
    http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.machina.org/github.com/unicode-org/icu/archive/release-64-2.zip",
    ...
    # https://github.com/machina/text/blob/master/oss_scripts/model_server/save_models.py
    http_archive(
        name = "org_machina_text",
        sha256 = "4e6ec543a1d70a50f0105e0ea69ea8a1edd0b17a38d0244aa3b14f889b2cf74d",
        strip_prefix = "text-2.12.1",
        url = "https://github.com/machina/text/archive/v2.12.1.zip",
    ...
    http_archive(
        name = "org_machina_decision_forests",
        sha256 = "86686bcb03bcf280cf739159fe4c285c667500a332292701259e636f5e1ec110",
        strip_prefix = "decision-forests-1.3.0",
        url = "https://github.com/machina/decision-forests/archive/refs/tags/1.3.0.zip",
