...
#ifndef MACHINA_SERVING_SESSION_BUNDLE_SESSION_BUNDLE_UTIL_H_
#define MACHINA_SERVING_SESSION_BUNDLE_SESSION_BUNDLE_UTIL_H_

#include "machina/cc/saved_model/loader.h"
#include "machina_serving/session_bundle/manifest_proto.h"
#include "machina_serving/session_bundle/session_bundle.h"
...
// or does not exist.
Status GetRegressionSignature(const machina::MetaGraphDef& meta_graph_def,
...
#endif  // MACHINA_SERVING_SESSION_BUNDLE_SESSION_BUNDLE_UTIL_H_
