...
#ifndef MACHINA_SERVING_BATCHING_BATCH_SCHEDULER_RETRIER_H_
#define MACHINA_SERVING_BATCHING_BATCH_SCHEDULER_RETRIER_H_
...
#endif  // MACHINA_SERVING_BATCHING_BATCH_SCHEDULER_RETRIER_H_
