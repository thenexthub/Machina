...
#include "machina_serving/batching/batching_util.h"
...
auto *queuing_latency = monitoring::Sampler<0>::New(
    {"/machina/serving/saved_model_with_batching/queuing_latency",
...
// removes toolchain dependency, refactors this function accordingly (return type may
// change).
