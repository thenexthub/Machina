...
#ifndef MACHINA_SERVING_BATCHING_BATCHING_UTIL_H_
#define MACHINA_SERVING_BATCHING_BATCHING_UTIL_H_
...
void RecordPaddingSize(int32 padding_size, int32 execution_batch_size) {
  ...
  static auto* cell = machina::monitoring::Sampler<1>::New(
      {absl::StrCat("/machina/serving/", batching_task_name,
                    "/padding_size"),
...
void RecordInputBatchSize(int32 batch_size) {
  static const std::string batching_task_name = BatchingTask::Name();
  static auto* cell = machina::monitoring::Sampler<0>::New(
      {absl::StrCat("/machina/serving/", batching_task_name,
                    "/input_batch_size"),
...
#endif  // MACHINA_SERVING_BATCHING_BATCHING_UTIL_H_
