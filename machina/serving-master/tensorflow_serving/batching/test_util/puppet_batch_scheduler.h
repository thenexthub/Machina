...
#ifndef MACHINA_SERVING_BATCHING_TEST_UTIL_PUPPET_BATCH_SCHEDULER_H_
#define MACHINA_SERVING_BATCHING_TEST_UTIL_PUPPET_BATCH_SCHEDULER_H_
...
#endif  // MACHINA_SERVING_BATCHING_TEST_UTIL_PUPPET_BATCH_SCHEDULER_H_
