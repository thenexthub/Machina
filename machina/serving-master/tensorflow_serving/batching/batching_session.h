...
// A library for wrapping a machina session such that Run() calls get
// scheduled in batches, using a batch scheduler of your choice.

#ifndef MACHINA_SERVING_BATCHING_BATCHING_SESSION_H_
#define MACHINA_SERVING_BATCHING_BATCHING_SESSION_H_
...
#include "machina_serving/batching/batching_options.h"
...
// Options for batching machina Sessions; see the Create*() functions below.
...
#endif  // MACHINA_SERVING_BATCHING_BATCHING_SESSION_H_
