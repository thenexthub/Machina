...
#
# Ex: $ bazel test :unittest_dockerfile_mkl --test_arg=machina/serving:latest-mkl \
#         --test_output=streamed --verbose_failures

declare -r PROJDIR=$(pwd)/machina_serving
...
declare -r MODELDIR="${PROJDIR}/servables/machina/testdata"
