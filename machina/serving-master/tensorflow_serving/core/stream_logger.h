...
#ifndef THIRD_PARTY_MACHINA_SERVING_CORE_STREAM_LOGGER_H_
#define THIRD_PARTY_MACHINA_SERVING_CORE_STREAM_LOGGER_H_
...
#endif  // THIRD_PARTY_MACHINA_SERVING_CORE_STREAM_LOGGER_H_
