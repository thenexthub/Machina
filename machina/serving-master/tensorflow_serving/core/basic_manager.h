...
#ifndef MACHINA_SERVING_CORE_BASIC_MANAGER_H_
#define MACHINA_SERVING_CORE_BASIC_MANAGER_H_
...
#include "machina_serving/util/fast_read_dynamic_ptr.h"
...
#endif  // MACHINA_SERVING_CORE_BASIC_MANAGER_H_
