...
#ifndef MACHINA_SERVING_CORE_ASPIRED_VERSION_POLICY_H_
#define MACHINA_SERVING_CORE_ASPIRED_VERSION_POLICY_H_
...
#endif  // MACHINA_SERVING_CORE_ASPIRED_VERSION_POLICY_H_
