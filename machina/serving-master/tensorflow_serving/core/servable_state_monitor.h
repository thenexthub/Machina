...
#ifndef MACHINA_SERVING_CORE_SERVABLE_STATE_MONITOR_H_
#define MACHINA_SERVING_CORE_SERVABLE_STATE_MONITOR_H_
...
#endif  // MACHINA_SERVING_CORE_SERVABLE_STATE_MONITOR_H_
