...
#ifndef MACHINA_SERVING_CORE_PREFIX_STORAGE_PATH_SOURCE_ADAPTER_H_
#define MACHINA_SERVING_CORE_PREFIX_STORAGE_PATH_SOURCE_ADAPTER_H_
...
#endif  // MACHINA_SERVING_CORE_PREFIX_STORAGE_PATH_SOURCE_ADAPTER_H_
