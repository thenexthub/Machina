...
#ifndef MACHINA_SERVING_CORE_SERVER_REQUEST_LOGGER_H_
#define MACHINA_SERVING_CORE_SERVER_REQUEST_LOGGER_H_
...
#endif  // MACHINA_SERVING_CORE_SERVER_REQUEST_LOGGER_H_
