...
#ifndef MACHINA_SERVING_CORE_SERVABLE_DATA_H_
#define MACHINA_SERVING_CORE_SERVABLE_DATA_H_
...
class ServableData {
  ...
  static_assert(
      ...
      "ServableData<T> requires that T not be machina::serving::Status.");
...
#endif  // MACHINA_SERVING_CORE_SERVABLE_DATA_H_
