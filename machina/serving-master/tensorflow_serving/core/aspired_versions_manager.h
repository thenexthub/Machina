...
#ifndef MACHINA_SERVING_CORE_ASPIRED_VERSIONS_MANAGER_H_
#define MACHINA_SERVING_CORE_ASPIRED_VERSIONS_MANAGER_H_
...
#include "machina_serving/util/observer.h"
...
#endif  // MACHINA_SERVING_CORE_ASPIRED_VERSIONS_MANAGER_H_
