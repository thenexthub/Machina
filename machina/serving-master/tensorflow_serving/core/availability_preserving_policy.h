...
#ifndef MACHINA_SERVING_CORE_AVAILABILITY_PRESERVING_POLICY_H_
#define MACHINA_SERVING_CORE_AVAILABILITY_PRESERVING_POLICY_H_
...
#endif  // MACHINA_SERVING_CORE_AVAILABILITY_PRESERVING_POLICY_H_
