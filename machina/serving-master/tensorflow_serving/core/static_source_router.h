...
#ifndef MACHINA_SERVING_CORE_STATIC_SOURCE_ROUTER_H_
#define MACHINA_SERVING_CORE_STATIC_SOURCE_ROUTER_H_
...
#endif  // MACHINA_SERVING_CORE_STATIC_SOURCE_ROUTER_H_
