...
// machina_serving/core:aspired_versions_manager_benchmark --
// --benchmarks=.
...
void BenchmarkState::RunBenchmark(::testing::benchmark::State& state,
  ...
  // To be compatible with the Google benchmark framework, the machina new
