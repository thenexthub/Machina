...
#ifndef MACHINA_SERVING_CORE_TEST_UTIL_MOCK_LOG_COLLECTOR_H_
#define MACHINA_SERVING_CORE_TEST_UTIL_MOCK_LOG_COLLECTOR_H_
...
#endif  // MACHINA_SERVING_CORE_TEST_UTIL_MOCK_LOG_COLLECTOR_H_
