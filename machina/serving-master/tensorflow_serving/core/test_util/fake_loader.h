...
#ifndef MACHINA_SERVING_CORE_TEST_UTIL_FAKE_LOADER_H_
#define MACHINA_SERVING_CORE_TEST_UTIL_FAKE_LOADER_H_
...
#endif  // MACHINA_SERVING_CORE_TEST_UTIL_FAKE_LOADER_H_
