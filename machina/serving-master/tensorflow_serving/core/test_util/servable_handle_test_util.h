...
#ifndef MACHINA_SERVING_CORE_TEST_UTIL_SERVABLE_HANDLE_TEST_UTIL_H_
#define MACHINA_SERVING_CORE_TEST_UTIL_SERVABLE_HANDLE_TEST_UTIL_H_
...
#endif  // MACHINA_SERVING_CORE_TEST_UTIL_SERVABLE_HANDLE_TEST_UTIL_H_
