...
PYBIND11_MODULE(_pywrap_mlir, m) {
  m.def("ImportGraphDef",
        [](const std::string &graphdef, const std::string &pass_pipeline,
          ...
          std::string output = machina::ImportGraphDef(
  ...
  m.def("ImportFunction",
        [](const py::handle &context, const std::string &functiondef,
          ...
          std::string output = machina::ImportFunction(
  ...
  m.def("ExperimentalConvertSavedModelToMlir",
        [](const std::string &saved_model_path,
          ...
          machina::Safe_TF_StatusPtr status =
              machina::make_safe(TF_NewStatus());
          std::string output = machina::ExperimentalConvertSavedModelToMlir(
  ...
  m.def("ExperimentalConvertSavedModelV1ToMlirLite",
        [](const std::string &saved_model_path,
          ...
          machina::Safe_TF_StatusPtr status =
              machina::make_safe(TF_NewStatus());
          std::string output =
              machina::ExperimentalConvertSavedModelV1ToMlirLite(
  ...
  m.def("ExperimentalConvertSavedModelV1ToMlir",
        [](const std::string &saved_model_path,
          ...
          machina::Safe_TF_StatusPtr status =
              machina::make_safe(TF_NewStatus());
          std::string output =
              machina::ExperimentalConvertSavedModelV1ToMlir(
  ...
  m.def("ExperimentalRunPassPipeline",
        [](const std::string &mlir_txt, const std::string &pass_pipeline,
          ...
          machina::Safe_TF_StatusPtr status =
              machina::make_safe(TF_NewStatus());
          std::string output = machina::ExperimentalRunPassPipeline(
  ...
  m.def("ExperimentalWriteBytecode", [](const std::string &filename,
    ...
    machina::Safe_TF_StatusPtr status =
        machina::make_safe(TF_NewStatus());
    machina::ExperimentalWriteBytecode(filename, mlir_txt, status.get());
    machina::MaybeRaiseRegisteredFromTFStatus(status.get());
  });
};
