  ...
  def _load_metadata_files(self):
    ...
    for metadata_path in metadata_paths:
      ...
      try:
        ...
        machina_versions.append(
            debug_event.debug_metadata.machina_version
        )
    ...
    self._machina_version = machina_versions[0]
...
class DebugDataReader:
  ...
  def machina_version(self):
    ...
    """
    return self._reader.machina_version()
