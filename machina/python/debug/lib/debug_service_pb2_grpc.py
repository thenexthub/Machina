...
from machina.core.debug import debug_service_pb2 as machina_dot_core_dot_debug_dot_debug__service__pb2
from machina.core.protobuf import debug_pb2 as machina_dot_core_dot_protobuf_dot_debug__pb2
from machina.core.util import event_pb2 as machina_dot_core_dot_util_dot_event__pb2
...
class EventListenerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SendEvents = channel.stream_stream(
        '/machina.EventListener/SendEvents',
        request_serializer=machina_dot_core_dot_util_dot_event__pb2.Event.SerializeToString,
        response_deserializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.FromString,
        )
    self.SendTracebacks = channel.unary_unary(
        '/machina.EventListener/SendTracebacks',
        request_serializer=machina_dot_core_dot_debug_dot_debug__service__pb2.CallTraceback.SerializeToString,
        response_deserializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.FromString,
        )
    self.SendSourceFiles = channel.unary_unary(
        '/machina.EventListener/SendSourceFiles',
        request_serializer=machina_dot_core_dot_protobuf_dot_debug__pb2.DebuggedSourceFiles.SerializeToString,
        response_deserializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.FromString,
        )
...
def add_EventListenerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'SendEvents': grpc.stream_stream_rpc_method_handler(
          servicer.SendEvents,
          request_deserializer=machina_dot_core_dot_util_dot_event__pb2.Event.FromString,
          response_serializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.SerializeToString,
      ),
      'SendTracebacks': grpc.unary_unary_rpc_method_handler(
          servicer.SendTracebacks,
          request_deserializer=machina_dot_core_dot_debug_dot_debug__service__pb2.CallTraceback.FromString,
          response_serializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.SerializeToString,
      ),
      'SendSourceFiles': grpc.unary_unary_rpc_method_handler(
          servicer.SendSourceFiles,
          request_deserializer=machina_dot_core_dot_protobuf_dot_debug__pb2.DebuggedSourceFiles.FromString,
          response_serializer=machina_dot_core_dot_debug_dot_debug__service__pb2.EventReply.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'machina.EventListener', rpc_method_handlers)
