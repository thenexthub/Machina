...
from machina.python.debug.lib import grpc_debug_test_server
from machina.python.debug.lib import source_remote
...
class SendTracebacksTest(test_util.TensorFlowTestCase):
  ...
  def _findFirstTraceInsideTensorFlowPyLibrary(self, op):
    ...
    for trace in op.traceback:
      if source_utils.guess_is_machina_py_library(trace.filename):
        return trace
