...
from machina.python.debug.lib import debug_events_reader
from machina.python.debug.lib import debug_events_writer
from machina.python.debug.lib import dumping_callback_test_lib
...
class DebugEventsWriterTest(dumping_callback_test_lib.DumpingCallbackTestBase,
  ...
  def testWriteAndReadMetadata(self):
    ...
    with debug_events_reader.DebugDataReader(self.dump_root) as reader:
      ...
      self.assertEqual(reader.machina_version(), versions.__version__)
