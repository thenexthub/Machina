...
from machina.core.debug import debug_service_pb2
from machina.core.protobuf import debug_pb2
from machina.python.debug.lib import common
from machina.python.debug.lib import debug_service_pb2_grpc
...
def _source_file_paths_outside_machina_py_library(code_defs, id_to_string):
  ...
  non_tf_files = (
      ...
      if not source_utils.guess_is_machina_py_library(f) and gfile.Exists(f))
  return non_tf_files
...
def _send_call_tracebacks(destinations,
  ...
  if send_source:
    ...
    source_file_paths.update(_source_file_paths_outside_machina_py_library(
