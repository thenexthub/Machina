...
from machina.python.debug.cli import evaluator
from machina.python.debug.cli import ui_factory
from machina.python.debug.lib import debug_graphs
...
class DebugAnalyzer(object):
  ...
  def node_info(self, args, screen_info=None):
    ...
    # "A machina graph defined in Python is stripped of unused ops
