...
if [[ -z "${PYTHON_BIN_PATH}" ]]; then
  DEBUG_FIBONACCI_BIN="$TEST_SRCDIR/org_machina/machina/python/debug/examples/v2/debug_fibonacci_v2"
  DEBUG_MNIST_BIN="$TEST_SRCDIR/org_machina/machina/python/debug/examples/v2/debug_mnist_v2"
else
  DEBUG_FIBONACCI_BIN="${PYTHON_BIN_PATH} -m machina.python.debug.examples.v2.debug_fibonacci"
  DEBUG_MNIST_BIN="${PYTHON_BIN_PATH} -m machina.python.debug.examples.v2.debug_mnist"
fi
