...
from machina.python.debug.cli import analyzer_cli
from machina.python.debug.cli import cli_config
from machina.python.debug.cli import cli_shared
from machina.python.debug.cli import command_parser
from machina.python.debug.cli import debugger_cli_common
from machina.python.debug.cli import profile_analyzer_cli
from machina.python.debug.cli import ui_factory
from machina.python.debug.lib import common
from machina.python.debug.lib import debug_data
from machina.python.debug.wrappers import framework
...
class LocalCLIDebugWrapperSession(framework.BaseDebugWrapperSession):
  ...
  def _prep_cli_for_run_start(self):
    ...
    if self._run_call_count == 1:
      ...
      help_intro.extend(debugger_cli_common.get_machina_version_lines())
  ...
  def _run_info_handler(self, args, screen_info=None):
    ...
    if self._run_call_count == 1:
      ...
      output.extend(debugger_cli_common.get_machina_version_lines())
