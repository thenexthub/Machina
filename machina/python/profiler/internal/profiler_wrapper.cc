...
#include "machina/core/profiler/rpc/profiler_server.h"
...
using ::machina::profiler::ToolOptions;
using ::machina::profiler::pywrap::ProfilerSessionWrapper;
