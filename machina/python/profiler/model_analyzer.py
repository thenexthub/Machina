...
from machina.core.profiler import tfprof_options_pb2
from machina.core.profiler import tfprof_output_pb2
from machina.python.eager import context
from machina.python.framework import errors
from machina.python.framework import ops
from machina.python.profiler import option_builder
from machina.python.profiler import tfprof_logger
  ...
  def __init__(self, graph=None, op_log=None):
    ...
    Args:
      graph: tf.Graph. If None and eager execution is not enabled, use default
        graph.
      op_log: optional. machina::tfprof::OpLogProto proto. Used to define
        extra op types.
    """
...
def profile(graph=None,
  ...
  """Profile model.
    ...
    https://github.com/machina/machina/blob/master/machina/core/profiler/g3doc/python_api.md

  Args:
    graph: tf.Graph. If None and eager execution is not enabled, use default
      graph.
    run_meta: optional machina.RunMetadata proto. It is necessary to
      support run time information profiling, such as time and memory.
    op_log: machina.tfprof.OpLogProto proto. User can assign "types" to graph
...
def advise(graph=None, run_meta=None, options=_DEFAULT_ADVISE_OPTIONS):
  """Auto profile and advise.
    ...
    https://github.com/machina/machina/tree/master/machina/core/profiler/README.md
