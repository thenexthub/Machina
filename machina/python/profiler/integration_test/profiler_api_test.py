...
from machina.python.distribute import collective_all_reduce_strategy as collective_strategy
...
from machina.python.profiler.integration_test import mnist_testing_utils
