...
#ifndef MACHINA_PYTHON_EAGER_PYWRAP_TFE_H_
#define MACHINA_PYTHON_EAGER_PYWRAP_TFE_H_
...
// Execute a machina operation assuming that all provided inputs are
...
struct EagerContextThreadLocalData {
  ...
  machina::Safe_PyObjectPtr device_name;
  machina::Safe_PyObjectPtr scope_name;
  machina::Safe_PyObjectPtr device_spec;
  machina::Safe_PyObjectPtr function_call_options;
  machina::Safe_PyObjectPtr executor;
  machina::Safe_PyObjectPtr op_callbacks;
};
...
#endif  // MACHINA_PYTHON_EAGER_PYWRAP_TFE_H_
