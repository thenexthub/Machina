...
#ifndef MACHINA_PYTHON_EAGER_PYWRAP_TENSOR_CONVERSION_H_
#define MACHINA_PYTHON_EAGER_PYWRAP_TENSOR_CONVERSION_H_
...
struct TFE_TensorHandleCache {
  ...
  TFE_TensorHandle* Lookup(PyObject* value, machina::DataType dtype,
                           TFE_Context* ctx,
                           absl::string_view device_name) const;

  void Insert(PyObject* value, machina::DataType dtype, TFE_Context* ctx,
 ...
 private:
  ...
  using Key = std::tuple<PyObjectPtr, machina::DataType, TFE_Context*,
                         absl::string_view>;
...
#endif  // MACHINA_PYTHON_EAGER_PYWRAP_TENSOR_CONVERSION_H_
