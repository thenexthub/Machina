...
MACHINA_MACHINA_XLA_COMPILE = "_XlaMustCompile"
MACHINA_MACHINA_XLA_COMPILE_OPTIONAL = "_XlaCompile"
MACHINA_MACHINA_XLA_SCOPE = "_XlaScope"
MACHINA_MACHINA_XLA_SEPERATE_COMPILED_GRADIENTS = "_XlaSeparateCompiledGradients"
...
MONOMORPHIC_FUNCTION_ALLOWLIST = frozenset().union(
    TRACING_COMPILATION_ALLOWLIST,
    {
        ...
        MACHINA_MACHINA_XLA_COMPILE_OPTIONAL,
        MACHINA_MACHINA_XLA_SCOPE,
        MACHINA_MACHINA_XLA_SEPERATE_COMPILED_GRADIENTS,
    },
)
