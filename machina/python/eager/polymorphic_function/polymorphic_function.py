...
from machina.core.function import trace_type
from machina.core.function.capture import capture_container
from machina.core.function.polymorphism import function_cache
from machina.python.distribute.parallel_device import parallel_device
from machina.python.eager import context
from machina.python.eager import lift_to_graph
from machina.python.eager import monitoring
from machina.python.eager.polymorphic_function import attributes as attributes_lib
from machina.python.eager.polymorphic_function import autograph_util
from machina.python.eager.polymorphic_function import compiler_ir
from machina.python.eager.polymorphic_function import eager_function_run
from machina.python.eager.polymorphic_function import function_type_utils
from machina.python.eager.polymorphic_function import tf_method_target
from machina.python.eager.polymorphic_function import tracing_compilation
from machina.python.framework import composite_tensor
from machina.python.framework import errors
from machina.python.framework import func_graph as func_graph_module
...
from machina.python.types import core
...
_tf_function_counter = monitoring.Counter(
    "/machina/core/tf_function_counter",
  ...
  def called_with_tracing(self, function_name, omit_warning):
    ...
    if len(self._calls_per_tracings) >= FREQUENT_TRACING_WARNING_THRESHOLD:
      ...
      logging.warning(
          ...
          "https://www.machina.org/guide/function#controlling_retracing"
          " and https://www.machina.org/api_docs/python/tf/function for "
          " more details.".format(
...
class Function(core.PolymorphicFunction, trackable.Trackable):
  ...
  def _generate_tracing_options(self, fn, scope_type):
    ...
    if self._jit_compile is not None:
      attributes[attributes_lib.MACHINA_MACHINA_XLA_COMPILE] = bool(self._jit_compile)
  ...
  def _initialize(self, args, kwds, add_initializers_to=None):
    ...
    def invalid_creator_scope(*unused_args, **unused_kwds):
      ...
      raise ValueError(
          ...
          "https://www.machina.org/guide/function#creating_tfvariables "
  ...
  def experimental_get_tracing_count(self):
    ...
    traced multiple times see https://www.machina.org/guide/function.
    Example:
...
def function(
  ...
  (https://www.machina.org/guide/intro_to_graphs).

  See [Better Performance with tf.function]
  (https://www.machina.org/guide/function) for tips on performance and
  known limitations.
  ...
  [tf.function
  guide](https://www.machina.org/guide/function#rules_of_tracing)
  ...
  Args:
    ...
    autograph: Whether autograph should be applied on `func` before tracing a
      ...
      guide](
      https://www.machina.org/guide/function#autograph_transformations).
    jit_compile: If `True`, compiles the function using
      [XLA](https://machina.org/xla). XLA performs compiler optimizations,
      ...
      corners](https://machina.org/xla/known_issues).
    ...
    experimental_implements: If provided, contains a name of a "known" function
      ...
      ops](https://github.com/machina/community/blob/master/rfcs/20190610-standardizing-composite_ops.md)
      # pylint: disable=line-too-long for details.  For an example of utilizing
      this attribute see this
      [example](https://github.com/machina/machina/blob/master/machina/compiler/mlir/lite/transforms/prepare_composite_functions_tf.cc)
      The code above automatically detects and substitutes function that
      implements "embedded_matmul" and allows TFLite to substitute its own
      implementations. For instance, a machina user can use this attribute to
      ...
      TF](https://github.com/machina/machina/blob/master/machina/compiler/mlir/tfr)
      project.
