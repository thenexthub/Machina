...
from machina.core.function.polymorphism import function_type as function_type_lib
from machina.python import pywrap_tfe
from machina.python.eager import backprop_util
from machina.python.eager import context
from machina.python.eager import forwardprop_util
from machina.python.eager import record
from machina.python.eager.graph_only_ops import graph_placeholder
...
from machina.python.ops import default_gradient
...
def _create_forward_backward_with_graph(
  ...
  # https://github.com/machina/community/blob/master/rfcs/20190610-standardizing-composite_ops.md#appendix-future-support-for-optimizing-gradient-functions
