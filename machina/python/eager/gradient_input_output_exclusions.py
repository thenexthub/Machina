...
// Generated by: machina/python/eager/gen_gradient_input_output_exclusions.py
"""
...
auto OpGradientInfoInit(const T &a) {
  auto *m = new machina::gtl::FlatMap<string, machina::gtl::FlatSet<int>>;
  for (const auto &item : a) {
    m->emplace(string(item.op_name),
               machina::gtl::FlatSet<int>(
...
def get_function(name, entries):
  ...
  contents = """
absl::optional<machina::gtl::FlatSet<int>> {name}(
