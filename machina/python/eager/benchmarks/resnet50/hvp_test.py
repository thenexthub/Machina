...
from machina.python.eager.benchmarks.resnet50 import resnet50
from machina.python.eager.benchmarks.resnet50 import resnet50_test_util
...
class HVPTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_hvp_shapes(self, hvp_function):
    ...
    with tf.device(device):
      ...
      # in the final hvp. machina/python/eager:forwardprop_test has a
