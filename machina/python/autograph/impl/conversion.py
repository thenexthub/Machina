...
from machina.python.autograph.pyct import cache
...
def is_unsupported(o):
  ...
  # See machina.framework.load_library.
  if (hasattr(o, '__module__') and
      hasattr(o.__module__, '_IS_MACHINA_PLUGIN')):
...
def is_allowlisted(
  ...
  Examples of allowed entities include all members of the machina
  package.
