...
from machina.python.autograph.utils import ag_logging
from machina.python.autograph.utils import misc
from machina.python.autograph.utils import tensors
from machina.python.autograph.utils import type_registry
...
from machina.python.types import distribute
    ...
    def guarded_extra_test():
      ...
      try:
        ...
        raise NotImplementedError(
            ...
            ' loop?\nSee '
            'https://github.com/machina/machina/blob/master/machina/'
...
class _PythonLoopChecker(object):
  ...
  def _verify_inefficient_unroll(self):
    ...
    ag_logging.warning(
        ...
        'machina/python/autograph/g3doc/reference/common_errors.md'
