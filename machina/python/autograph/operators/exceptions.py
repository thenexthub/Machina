...
def _tf_assert_stmt(expression1, expression2):
  ...
  This implementation deviates from Python semantics as follows:
    ...
    (2) on assertion failure, the graph execution will fail with
        machina.errors.ValueError, rather than AssertionError.

  Args:
    expression1: machina.Tensor, must evaluate to a tf.bool scalar
    expression2: Callable[[], Union[machina.Tensor, List[machina.Tensor]]]
