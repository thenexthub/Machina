...
from machina.python.kernel_tests.sparse_ops import sparse_xent_op_test_base
...
from machina.python.ops.nn_grad import _SparseSoftmaxCrossEntropyWithLogitsGrad  # pylint: disable=unused-import
