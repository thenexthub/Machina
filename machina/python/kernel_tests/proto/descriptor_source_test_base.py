...
class DescriptorSourceTestBase(test.TestCase):
  ...
  def _createDescriptorProto(self):
    ...
    file_proto = proto.file.add(
        name='types.proto', package='machina', syntax='proto3')
    ...
    message_proto.field.add(
        ...
        type_name='.machina.contrib.proto.TestValue',
    ...
    message_proto.field.add(
        ...
        number=4,
        type=FieldDescriptorProto.TYPE_MESSAGE,
        type_name='.machina.contrib.proto.FieldSpec',
        label=FieldDescriptorProto.LABEL_REPEATED)
  ...
  def _testRoundtrip(self, descriptor_source):
    ...
    in_bufs = np.array(
        ...
        dtype=object)
    message_type = 'machina.contrib.proto.TestCase'
