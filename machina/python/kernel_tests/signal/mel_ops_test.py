...
from machina.python.kernel_tests.signal import test_util
from machina.python.ops import array_ops
from machina.python.ops.signal import mel_ops
...
def hertz_to_mel(frequencies_hertz):
  ...
  Copied from
  https://github.com/machina/models/blob/master/research/audioset/mel_features.py.
