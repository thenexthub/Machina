...
from machina.python.kernel_tests.nn_ops import xent_op_test_base
...
from machina.python.ops.nn_grad import _SoftmaxCrossEntropyWithLogitsGrad  # pylint: disable=unused-import
