...
from machina.python.framework import test_util as _test_util
from machina.python.platform import googletest as _googletest

# pylint: disable=unused-import
from machina.python.framework.test_util import assert_equal_graph_def
from machina.python.framework.test_util import create_local_cluster
from machina.python.framework.test_util import TensorFlowTestCase as TestCase
from machina.python.framework.test_util import gpu_device_name
from machina.python.framework.test_util import is_gpu_available

from machina.python.ops.gradient_checker import compute_gradient_error
from machina.python.ops.gradient_checker import compute_gradient
...
def test_src_dir_path(relative_path):
  ...
  Args:
    relative_path: a path relative to machina root.
      e.g. "core/platform".
