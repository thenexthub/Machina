...
from machina.core.protobuf import trackable_object_graph_pb2
from machina.python.checkpoint import async_checkpoint_helper
from machina.python.checkpoint import checkpoint_context
...
from machina.python.checkpoint import graph_view as graph_view_lib
from machina.python.checkpoint import restore as restore_lib
from machina.python.checkpoint import save_util
from machina.python.checkpoint import save_util_v1
from machina.python.checkpoint import util
...
from machina.python.ops import gen_io_ops as io_ops
...
from machina.python.training import saver as v1_saver_lib
from machina.python.training.saving import saveable_object as saveable_object_lib
  ...
  def __del__(self):
    ...
    if unused_nodes_in_checkpoint or unrestored_attributes_in_object:
      ...
      log_fn("Detecting that an object or model or tf.train.Checkpoint is being"
             ...
             "https://www.machina.org/api_docs/python/tf/train/Checkpoint#restore"
...
class CheckpointV1(autotrackable.AutoTrackable):
  ...
  [guide to training
  checkpoints](https://www.machina.org/guide/checkpoint) for
...
_preemption_checkpoint_saved_time_usecs = monitoring.Counter(
    "/machina/api/distribution_strategy/preemption_checkpoint_saved_time_usecs",
