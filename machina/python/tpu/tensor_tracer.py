...
from machina.python.ops import summary_ops_v2 as summary
from machina.python.ops import variable_scope
from machina.python.platform import analytics
from machina.python.platform import gfile
from machina.python.platform import remote_utils
from machina.python.platform import tf_logging as logging
from machina.python.summary import summary_iterator
from machina.python.tpu import tensor_tracer_flags
from machina.python.tpu import tensor_tracer_report
...
tt_gauge = monitoring.BoolGauge('/machina/api/tensor_tracer/v1',
...
class TensorTracer:
  ...
  def _is_in_control_flow(self, op):
    ...
    Args:
      op: A machina op that should be checked whether in control flow or not.
    Returns:
