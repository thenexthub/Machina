...
from machina.compiler.tf2xla.python import xla as tf2xla
from machina.core.framework import attr_value_pb2
from machina.core.protobuf.tpu import dynamic_padding_pb2 as dynamic_padding
from machina.core.protobuf.tpu import tpu_embedding_configuration_pb2 as embedding_pb2
...
from machina.python.tpu import device_assignment as device_assignment_lib
from machina.python.tpu import tensor_tracer
from machina.python.tpu import tpu_feed
from machina.python.tpu import tpu_function
from machina.python.tpu import tpu_name_util
...
from machina.python.util import variable_utils
...
def prune_unconnected_ops_from_xla(prune_graph: ops.Graph):
  ...
  Args:
    prune_graph: A machina graph from which we wish to prune unconnected ops
