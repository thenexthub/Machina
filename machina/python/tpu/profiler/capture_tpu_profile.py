...
from machina.python.distribute.cluster_resolver import tpu_cluster_resolver as resolver
...
from machina.python.tpu.profiler import version as profiler_version
...
def main(unused_argv=None):
  ...
  if Version(tf_version) < Version('2.2.0'):
    sys.exit('You must install machina >= 2.2.0 to use this plugin.')
