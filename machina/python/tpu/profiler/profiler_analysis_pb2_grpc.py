...
from machina.core.profiler import profiler_analysis_pb2 as third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
...
class ProfileAnalysisStub(object):
  ...
  def __init__(self, channel):
    ...
    self.NewSession = channel.unary_unary(
        '/machina.ProfileAnalysis/NewSession',
        request_serializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
        .NewProfileSessionRequest.SerializeToString,
        response_deserializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
        .NewProfileSessionResponse.FromString,
    )
    self.EnumSessions = channel.unary_unary(
        '/machina.ProfileAnalysis/EnumSessions',
        request_serializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
    ...
    self.GetSessionToolData = channel.unary_unary(
        '/machina.ProfileAnalysis/GetSessionToolData',
        request_serializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
...
def add_ProfileAnalysisServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'NewSession':
          grpc.unary_unary_rpc_method_handler(
              servicer.NewSession,
              request_deserializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
              .NewProfileSessionRequest.FromString,
              response_serializer=third__party_dot_machina_dot_core_dot_profiler_dot_profiler__analysis__pb2
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'machina.ProfileAnalysis', rpc_method_handlers)
