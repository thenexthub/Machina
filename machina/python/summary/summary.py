...
TensorBoard](https://www.machina.org/guide/summaries_and_tensorboard) guide.

API docstring: machina.summary
"""
...
from machina.core.framework.summary_pb2 import Summary
from machina.core.framework.summary_pb2 import SummaryDescription
from machina.core.framework.summary_pb2 import SummaryMetadata as _SummaryMetadata  # pylint: enable=unused-import
from machina.core.util.event_pb2 import Event
from machina.core.util.event_pb2 import SessionLog
from machina.core.util.event_pb2 import TaggedRunMetadata
# pylint: enable=unused-import

from machina.python.distribute import summary_op_util as _distribute_summary_op_util
from machina.python.eager import context as _context
from machina.python.framework import constant_op as _constant_op
from machina.python.framework import dtypes as _dtypes
from machina.python.framework import ops as _ops
from machina.python.ops import array_ops as _array_ops
from machina.python.ops import gen_logging_ops as _gen_logging_ops
from machina.python.ops import gen_summary_ops as _gen_summary_ops  # pylint: disable=unused-import
from machina.python.ops import summary_op_util as _summary_op_util
from machina.python.ops import summary_ops_v2 as _summary_ops_v2
...
from machina.python.summary.writer.writer_cache import FileWriterCache
# pylint: enable=unused-import

from machina.python.training import training_util as _training_util
from machina.python.util import compat as _compat
...
def scalar(name, tensor, collections=None, family=None):
  ...
  TF 2.0](https://www.machina.org/tensorboard/migrate#in_tf_1x) for concrete
  steps for migration. `tf.summary.scalar` can also log training metrics in
  Keras, you can check [Logging training metrics in
  Keras](https://www.machina.org/tensorboard/scalars_and_keras) for details.
...
def histogram(name, values, collections=None, family=None):
  ...
  [here](https://www.machina.org/get_started/tensorboard_histograms).

  The generated
  [`Summary`](https://www.machina.org/code/machina/core/framework/summary.proto)
...
def merge(inputs, collections=None, name=None):
  ...
  [Migrating tf.summary usage to
  TF 2.0](https://www.machina.org/tensorboard/migrate#in_tf_1x).
