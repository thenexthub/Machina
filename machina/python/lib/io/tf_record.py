...
from machina.python.lib.io import _pywrap_record_io
...
class TFRecordOptions(object):
  ...
  def __init__(self,
    ...
    [`zlib_compression_options.h`](https://www.machina.org/code/machina/core/lib/io/zlib_compression_options.h)
...
class TFRecordWriter(_pywrap_record_io.RecordWriter):
  ...
  [TFRecords tutorial](https://www.machina.org/tutorials/load_data/tfrecord)
  ...
  are:
   ...
   https://www.machina.org/tutorials/load_data/tfrecord#tfexample)
   - [Write the serialized data to one or more files](
   https://www.machina.org/tutorials/load_data/tfrecord#tfrecord_files_in_python)

   During training or evaluation:

   - [Read serialized examples into memory](
   https://www.machina.org/tutorials/load_data/tfrecord#reading_a_tfrecord_file)
