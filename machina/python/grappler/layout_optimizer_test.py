...
from machina.core.protobuf import device_properties_pb2
...
from machina.python.grappler import cluster as gcluster
from machina.python.grappler import tf_optimizer
from machina.python.layers import convolutional as conv_layers
...
# Taken from machina/examples/tutorials/mnist/mnist_deep.py
