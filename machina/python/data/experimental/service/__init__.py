...
See https://github.com/machina/ecosystem/tree/master/data_service for an
example of using Google Kubernetes Engine (GKE) to manage the tf.data service.
Note that the server implementation in
[tf_std_data_server.py](https://github.com/machina/ecosystem/blob/master/data_service/tf_std_data_server.py)
...
servers by calling
[load_op_library](https://www.machina.org/api_docs/python/tf/load_op_library)
...
[register_dataset](https://www.machina.org/api_docs/python/tf/data/experimental/service/register_dataset)
function registers a dataset, then the
[from_dataset_id](https://www.machina.org/api_docs/python/tf/data/experimental/service/from_dataset_id)
function creates a new dataset which reads from the registered dataset.
The
[distribute](https://www.machina.org/api_docs/python/tf/data/experimental/service/distribute)
...
from machina.python.data.experimental.ops.data_service_ops import distribute
from machina.python.data.experimental.ops.data_service_ops import from_dataset_id
from machina.python.data.experimental.ops.data_service_ops import register_dataset
from machina.python.data.experimental.ops.data_service_ops import ShardingPolicy
from machina.python.data.experimental.service.server_lib import DispatcherConfig
from machina.python.data.experimental.service.server_lib import DispatchServer
from machina.python.data.experimental.service.server_lib import WorkerConfig
from machina.python.data.experimental.service.server_lib import WorkerServer
