...
from machina.core.framework import dataset_metadata_pb2
from machina.core.framework import dataset_options_pb2
from machina.core.framework import graph_pb2
from machina.core.protobuf import struct_pb2
from machina.python import tf2
from machina.python.compat import v2_compat
from machina.python.data.ops import dataset_autograph
...
from machina.python.data.util import traverse
...
from machina.python.framework import auto_control_deps
from machina.python.framework import auto_control_deps_utils as acd_utils
from machina.python.framework import composite_tensor
from machina.python.framework import constant_op
from machina.python.framework import dtypes
from machina.python.framework import function
from machina.python.framework import none_tensor
from machina.python.framework import ops
from machina.python.framework import random_seed as core_random_seed
...
from machina.python.ops import check_ops
from machina.python.ops import cond
from machina.python.ops import control_flow_assert
from machina.python.ops import gen_dataset_ops
from machina.python.ops import gen_io_ops
from machina.python.ops import gen_parsing_ops
...
from machina.python.saved_model import nested_structure_coder
from machina.python.trackable import asset
from machina.python.trackable import base as tracking_base
from machina.python.trackable import resource as resource_lib
from machina.python.types import data as data_types
from machina.python.types import trace
from machina.python.util import deprecation
from machina.python.util import lazy_loader
from machina.python.util import nest as tf_nest
...
prefetch_op = lazy_loader.LazyLoader(
    "prefetch_op", globals(),
    "machina.python.data.ops.prefetch_op")
# Loaded lazily due to a circular dependency (dataset_ops ->
# shuffle_op -> dataset_ops).
shuffle_op = lazy_loader.LazyLoader(
    "shuffle_op", globals(),
    "machina.python.data.ops.shuffle_op")
...
class DatasetV2(
  ...
  **Component**: The leaf in the nested structure of an element.
  ...
  read [this guide](https://www.machina.org/guide/data).
  """
  ...
  def element_spec(self):
    ...
    For more information,
    read [this guide](https://www.machina.org/guide/data#dataset_structure).
  ...
  def from_tensors(tensors, name=None) -> "DatasetV2":
    ...
    in [this
    guide](https://machina.org/guide/data#consuming_numpy_arrays).

    Args:
      tensors: A dataset "element". Supported values are documented
        [here](https://www.machina.org/guide/data#dataset_structure).
    ...
    from machina.python.data.ops import from_tensors_op
  ...
  def from_tensor_slices(tensors, name=None) -> "DatasetV2":
    ...
    contains one or more large NumPy arrays, consider the alternative described
    in [this guide](
    https://machina.org/guide/data#consuming_numpy_arrays).
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import from_tensor_slices_op
  ...
  def from_generator(
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import from_generator_op
  ...
  def range(*args, **kwargs) -> "DatasetV2":
    ...
    # -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import range_op
  ...
  def zip(*args, datasets=None, name=None) -> "DatasetV2":
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import zip_op
  ...
  def concatenate(self, dataset, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import concatenate_op
  ...
  def counter(start=0, step=1, dtype=dtypes.int64, name=None) -> "DatasetV2":
    ...
    # -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import counter_op
  ...
  def rebatch(self, batch_size, drop_remainder=False, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import rebatch_op
  ...
  def repeat(self, count=None, name=None) -> "DatasetV2":
    ...
    from machina.python.data.ops import repeat_op
  ...
  def cache(self, filename="", name=None) -> "DatasetV2":
    ...
    # -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import cache_op
  ...
  def take(self, count, name=None) -> "DatasetV2":
    ...
    # take_op -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import take_op
  ...
  def skip(self, count, name=None) -> "DatasetV2":
    ...
    # skip_op -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import skip_op
  ...
  def shard(self, num_shards, index, name=None) -> "DatasetV2":
    ...
    """
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import shard_op
  ...
  def save(self,
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import save_op
  ...
  def load(
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import load_op
  ...
  def batch(
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access,redefined-outer-name
    from machina.python.data.ops import batch_op
    ...
    * If the dimension is unknown, the component will be padded out to the
    ...
    Raises:
      ...
      TypeError: If a component is of an unsupported type. The list of supported
        ...
        https://www.machina.org/guide/data#dataset_structure.
    """
    # Loaded lazily due to a circular dependency (dataset_ops ->
    # padded_batch_op -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import padded_batch_op
  ...
  def ragged_batch(
    ...
    *  If an input element is a `tf.RaggedTensor` or any other type, then it is
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import ragged_batch_op
  ...
  def sparse_batch(self, batch_size, row_shape, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import sparse_batch_op
...
name=None))
  ...
  def flat_map(self, map_func, name=None) -> "DatasetV2":
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import flat_map_op
  ...
  def ignore_errors(self, log_warning=False, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import ignore_errors_op
  ...
  def interleave(
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import interleave_op
  ...
  def filter(self, predicate, name=None) -> "DatasetV2":
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import filter_op
  ...
  def window(
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import window_op
  ...
  def unbatch(self, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import unbatch_op
  ...
  def group_by_window(
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import group_by_window_op
  ...
  def snapshot(
    ...
    https://github.com/machina/community/blob/master/rfcs/20200107-tf-data-snapshot.md
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import snapshot_op
  ...
  def scan(self, initial_state, scan_func, name=None) -> "DatasetV2":
    ...
    # scan_op -> dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import scan_op
  ...
  def take_while(self, predicate, name=None) -> "DatasetV2":
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import take_while_op
  ...
  def unique(self, name=None) -> "DatasetV2":
    ...
    # dataset_ops).
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import unique_op
  ...
  def sample_from_datasets(
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import sample_from_datasets_op
  ...
  def choose_from_datasets(
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import choose_from_datasets_op
...
class DatasetV1(DatasetV2, data_types.DatasetV1):
  ...
  def from_sparse_tensor_slices(sparse_tensor):
    ...
    # pylint: disable=g-import-not-at-top,protected-access
    from machina.python.data.ops import from_sparse_tensor_slices_op
...
batch_op = lazy_loader.LazyLoader(
    "batch_op", globals(),
    "machina.python.data.ops.batch_op")
...
repeat_op = lazy_loader.LazyLoader(
    "repeat_op", globals(),
    "machina.python.data.ops.repeat_op")
