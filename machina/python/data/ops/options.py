...
from machina.core.framework import model_pb2
from machina.python.data.ops import test_mode
from machina.python.data.util import options as options_lib
...
class AutoShardPolicy(enum.IntEnum):
  ...
  DATA = 2
  HINT = 3
  # LINT.ThenChange(//machina/python/data/experimental/ops/data_service_ops.py:tf_data_service_sharding_policy)
