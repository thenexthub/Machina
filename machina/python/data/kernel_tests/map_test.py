...
from machina.python.data.experimental.ops import global_shuffle_op
from machina.python.data.experimental.ops import random_access
from machina.python.data.kernel_tests import checkpoint_test_base
...
class MapGlobalShuffleTest(test_base.DatasetTestBase, parameterized.TestCase):
  ...
  def testMapV2(  # V2 API preserves cardinality by default.
    ...
    # https://github.com/machina/machina/blob/master/machina/core/kernels/data/prefetch_dataset_op.cc#L197-L199.
    options = options_lib.Options()
    options.experimental_optimization.apply_default_optimizations = False
