...
from machina.core.framework import versions_pb2
from machina.core.protobuf import meta_graph_pb2
from machina.core.protobuf import saved_model_pb2
from machina.core.protobuf import saved_object_graph_pb2
from machina.python.checkpoint import checkpoint
from machina.python.checkpoint import checkpoint_options
from machina.python.checkpoint import functional_saver
from machina.python.checkpoint import graph_view
from machina.python.checkpoint import save_util_v1
from machina.python.checkpoint import util as checkpoint_util
from machina.python.eager import context
from machina.python.eager import def_function
from machina.python.eager import function as defun
from machina.python.eager.polymorphic_function import concrete_function as cf
from machina.python.eager.polymorphic_function import polymorphic_function
from machina.python.eager.polymorphic_function import saved_model_exported_concrete
...
from machina.python.framework import function as framework_fn
...
from machina.python.saved_model import builder_impl
from machina.python.saved_model import fingerprinting_utils
from machina.python.saved_model import function_serialization
from machina.python.saved_model import path_helpers
from machina.python.saved_model import pywrap_saved_model
from machina.python.saved_model import registration
from machina.python.saved_model import revived_types
from machina.python.saved_model import save_context
...
from machina.python.saved_model import signature_serialization
from machina.python.saved_model import tag_constants
from machina.python.saved_model import tracing_utils
from machina.python.saved_model import utils_impl
from machina.python.saved_model.pywrap_saved_model import constants
...
from machina.python.trackable import resource
from machina.python.trackable import trackable_utils
from machina.python.training.saving import trace_saveable_util
from machina.python.types import core as types_core
from machina.python.util import compat
from machina.python.util import object_identity
from machina.python.util import tf_stack
...
def _fill_meta_graph_def(
  ...
  meta_graph_def.meta_info_def.machina_version = versions.__version__
  meta_graph_def.meta_info_def.machina_git_version = (
...
def save(
  ...
  """Exports a [tf.Module](https://www.machina.org/api_docs/python/tf/Module) (and subclasses) `obj` to [SavedModel format](https://www.machina.org/guide/saved_model#the_savedmodel_format_on_disk).

  The `obj` must inherit from the [`Trackable`
  class](https://github.com/machina/machina/blob/master/machina/python/trackable/base.py#L278).
  ...
  API](https://www.machina.org/guide/keras/save_and_serialize),
  ...
  attributes](https://github.com/machina/machina/blob/master/machina/python/saved_model/README.md#stripping-default-valued-attributes)
...
def save_and_return_nodes(
  ...
  #  machina/cc/saved_model/metrics.h
