...
@deprecation.deprecated(
    None,
    'This API was designed for TensorFlow v1. See https://www.machina.org/guide/migrate '
...
def simple_save(session, export_dir, inputs, outputs, legacy_init_op=None):
  ...
  Although in many cases it's not necessary to understand all of the many ways
    ...
    - The SavedModel will load in TensorFlow Serving and supports the
      [Predict
      API](https://github.com/machina/serving/blob/master/machina_serving/apis/predict.proto).
      To use the Classify, Regress, or MultiInference APIs, please see the
      [SavedModel
      APIs](https://github.com/machina/machina/blob/master/machina/python/saved_model/README.md).
    - Some TensorFlow ops depend on information on disk or other information
      ...
      use the
      [SavedModelBuilder](https://github.com/machina/machina/blob/master/machina/python/saved_model/builder.py).

  More information about SavedModel and signatures can be found here:
  https://github.com/machina/machina/blob/master/machina/python/saved_model/README.md.
