...
from machina.core.function.capture import restore_captures
...
from machina.python.checkpoint import restore
from machina.python.distribute import distribute_lib
from machina.python.distribute import distribute_utils
from machina.python.distribute import values_util
from machina.python.eager import context
from machina.python.eager import function
from machina.python.eager.polymorphic_function import saved_model_utils as function_saved_model_utils
...
from machina.python.saved_model import fingerprinting
from machina.python.saved_model import fingerprinting_utils
from machina.python.saved_model import function_deserialization
from machina.python.saved_model import load_options
from machina.python.saved_model import load_v1_in_v2
from machina.python.saved_model import loader_impl
...
from machina.python.saved_model import utils_impl as saved_model_utils
...
def load_partial(export_dir, filters, tags=None, options=None):
  ...
  **Loading under different distribution strategies**
  ...
  if (len(saved_model_proto.meta_graphs) == 1 and
    ...
    root.machina_version = meta_graph_def.meta_info_def.machina_version
    root.machina_git_version = (
...
def is_tf2_saved_model(export_dir):
  ...
  documented here:
  https://www.machina.org/guide/migrate/saved_model#savedmodel. This helper
