...
#include "machina/python/saved_model/pywrap_saved_model_metrics.h"
...
void DefineMetricsModule(py::module main_module) {
  ...
  m.def(
      ...
      py::doc("Increment the '/machina/core/saved_model/write/count' "
              "counter."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("write_version"),
      py::doc("Get value of '/machina/core/saved_model/write/count' "
              "counter."));
  ...
  m.def(
      ...
      py::doc("Increment the '/machina/core/saved_model/write/api' "
  ...
  m.def(
      ...
      py::doc("Get value of '/machina/core/saved_model/write/api' "
  ...
  m.def(
      ...
      py::kw_only(), py::arg("write_version"),
      py::doc("Increment the '/machina/core/saved_model/read/count' "
  ...
  m.def(
      ...
      py::kw_only(), py::arg("write_version"),
      py::doc("Get value of '/machina/core/saved_model/read/count' "
  ...
  m.def(
      ...
      py::doc("Increment the '/machina/core/saved_model/read/api' "
              "counter for API with `api_label`."));
  ...
  m.def(
      ...
      py::doc("Get value of '/machina/core/saved_model/read/api' "
              "counter for `api_label` cell."));
  ...
  m.def(
      ...
      py::doc("Set the '/machina/core/saved_model/read/fingerprint' gauge "
              "with `fingerprint`."));

  m.def(
      "GetReadFingerprint",
      []() { return metrics::SavedModelReadFingerprint().value(); },
      py::doc("Get value of '/machina/core/saved_model/read/fingerprint' "
              "gauge."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("fingerprint"),
      py::doc("Set the '/machina/core/saved_model/write/fingerprint' gauge "
              "with `fingerprint`."));

  m.def(
      "GetWriteFingerprint",
      []() { return metrics::SavedModelWriteFingerprint().value(); },
      py::doc("Get value of '/machina/core/saved_model/write/fingerprint' "
              "gauge."));
  ...
  m.def(
      ...
      py::doc("Set the '/machina/core/saved_model/read/path' gauge "
              "with `saved_model_path`."));

  m.def(
      "GetReadPath", []() { return metrics::SavedModelReadPath().value(); },
      py::doc("Get value of '/machina/core/saved_model/read/path' gauge."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("saved_model_path"),
      py::doc("Set the '/machina/core/saved_model/write/path' gauge "
              "with `saved_model_path`."));

  m.def(
      "GetWritePath", []() { return metrics::SavedModelWritePath().value(); },
      py::doc("Get value of '/machina/core/saved_model/write/path' gauge."));
  ...
  m.def(
      ...
      py::doc(
          "Set the '/machina/core/saved_model/read/path_and_singleprint' "
  ...
  m.def(
      ...
      py::doc(
          ...
          "'/machina/core/saved_model/read/path_and_singleprint' gauge."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("path"), py::arg("singleprint"),
      py::doc("Set the "
              "'/machina/core/saved_model/write/path_and_singleprint' gauge "
  ...
  m.def(
      ...
      py::doc(
          "Get value of "
          "'/machina/core/saved_model/found_fingerprint_on_load' gauge."));
  ...
  m.def(
      ...
      py::doc("Add `microseconds` to the cell `api_label`for "
              "'/machina/core/checkpoint/read/read_durations'."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("api_label"), py::arg("microseconds"),
      py::doc("Add `microseconds` to the cell `api_label` for "
              "'/machina/core/checkpoint/write/write_durations'."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("api_label"), py::arg("microseconds"),
      py::doc("Add `microseconds` to the cell `api_label` for "
              "'/machina/core/checkpoint/write/async_write_durations'."));
  ...
  m.def(
      ...
      py::kw_only(), py::arg("api_label"), py::arg("microseconds"),
      py::doc("Add `microseconds` to the cell `api_label` for "
              "'/machina/core/checkpoint/write/training_time_saved'."));
  ...
  m.def(
      ...
      py::doc("Increment the "
              "'/machina/core/checkpoint/write/checkpoint_size' counter for "
  ...
  m.def(
      ...
      py::doc("Get cell (api_label, filesize) for "
              "'/machina/core/checkpoint/write/checkpoint_size'."));

  m.def(
      "GetShardingCallbackDuration",
      []() { return metrics::ShardingCallbackDuration().value(); },
      py::doc("Get value of "
              "'/machina/core/checkpoint/sharding/callback_duration'."));
  ...
  m.def(
      ...
      py::doc("Get value of "
              "'/machina/core/checkpoint/sharding/"
  ...
  m.def(
      ...
      py::doc("Get value of "
              "'/machina/core/checkpoint/sharding/callback_description'."));
