...
from machina.python.ops import array_ops  # pylint: disable=unused-import
from machina.python.ops import gen_candidate_sampling_ops
from machina.python.ops import math_ops  # pylint: disable=unused-import
...
def uniform_candidate_sampler(true_classes, num_true, num_sampled, unique,
  ...
  Reference](http://www.machina.org/extras/candidate_sampling.pdf)
  ...
  Reference](http://www.machina.org/extras/candidate_sampling.pdf). You
