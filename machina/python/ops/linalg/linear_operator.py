...
from machina.python.ops.linalg import linalg_impl as linalg
from machina.python.ops.linalg import linear_operator_util
from machina.python.ops.linalg import property_hint_util
from machina.python.ops.linalg import slicing
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def _linop_matmul(
    ...
    # instance of linear_operator_zeros.LinearOperatorZeros
      ...
      from machina.python.ops.linalg import linear_operator_composition  # pylint: disable=g-import-not-at-top
  ...
  def _linop_solve(
    ...
    # errors due to this cyclic dependency.
    from machina.python.ops.linalg import linear_operator_composition  # pylint: disable=g-import-not-at-top
    from machina.python.ops.linalg import linear_operator_inversion  # pylint: disable=g-import-not-at-top
  ...
  def _linop_adjoint(self) -> "LinearOperator":
    from machina.python.ops.linalg import linear_operator_adjoint  # pylint: disable=g-import-not-at-top
  ...
  def _linop_cholesky(self) -> "LinearOperator":
    from machina.python.ops.linalg import linear_operator_lower_triangular  # pylint: disable=g-import-not-at-top
