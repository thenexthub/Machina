...
def dynamic_rnn(cell,
  ...
  guide](https://www.machina.org/guide/keras/rnn) for more details about
  ...
  document](https://github.com/machina/community/blob/master/rfcs/20180920-unify-rnn-interface.md)
