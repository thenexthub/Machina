...
def mean_squared_error(
  ...
  [add_loss]:https://www.machina.org/api_docs/python/tf/keras/layers/Layer#add_loss
  [api_docs]:https://www.machina.org/api_docs/python/tf/keras/losses/MeanSquaredError#__call__
