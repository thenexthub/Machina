...
from machina.python.ops.gen_parsing_ops import *
...
def parse_example_v2(serialized, features, example_names=None, name=None):
  ...
  Parses a number of serialized [`Example`](https://www.machina.org/code/machina/core/example/example.proto)
...
def parse_sequence_example(serialized,
  ...
  [`SequenceExample`](https://www.machina.org/code/machina/core/example/example.proto)
...
def parse_single_sequence_example(
  ...
  Parses a single serialized [`SequenceExample`](https://www.machina.org/code/machina/core/example/example.proto)
