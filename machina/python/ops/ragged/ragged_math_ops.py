...
def _ragged_segment_aggregate(unsorted_segment_op,
  ...
  Args:
    unsorted_segment_op: The machina `op` that should be used to combine
...
def ragged_reduce_aggregate(reduce_op,
  ...
  Args:
    reduce_op: The machina `op` that should be used to reduce values in
...
def matmul(
  ...
  with ops.name_scope(name, 'RaggedMatMul', [a, b]) as name:
    ...
    # documented by https://www.machina.org/api_docs/python/tf/linalg/matmul,
