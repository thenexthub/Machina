...
from machina.python.ops.ragged.dynamic_ragged_shape import _LayerBroadcaster
from machina.python.ops.ragged.dynamic_ragged_shape import DynamicRaggedShape
...
from machina.python.ops.ragged.row_partition import RowPartitionSpec
...
class DynamicRaggedShapeErrorTest(parameterized.TestCase):
  ...
  def testBroadcastRaggedError(self, origin_lengths, origin_values,
                               expected_lengths):
    # I pulled this out of the machina test case, so that I could have
    # more control.
