...
See the [Variables](https://www.machina.org/guide/variables) guide.
"""
...
from machina.python.ops.gen_state_ops import *
...
def scatter_update(ref, indices, updates, use_locking=True, name=None):
  ...
  <img style="width:100%" src="https://www.machina.org/images/ScatterUpdate.png" alt>
  </div>
...
def scatter_add(ref, indices, updates, use_locking=False, name=None):
  ...
  <div style="width:70%; margin:auto; margin-bottom:10px; margin-top:20px;">
  <img style="width:100%" src='https://www.machina.org/images/ScatterAdd.png' alt>
  </div>
...
def scatter_sub(ref, indices, updates, use_locking=False, name=None):
  ...
  <div style="width:70%; margin:auto; margin-bottom:10px; margin-top:20px;">
  <img style="width:100%"
       src="https://www.machina.org/images/ScatterSub.png" alt>
  </div>
...
def scatter_max(ref, indices, updates, use_locking=False, name=None):
  ...
  <div style="width:70%; margin:auto; margin-bottom:10px; margin-top:20px;">
  <img style="width:100%" src="https://www.machina.org/images/ScatterAdd.png"
  alt>
  </div>
