...
from machina.python.ops.distributions import distribution
from machina.python.ops.distributions import kullback_leibler
...
class Dirichlet(distribution.Distribution):
  ...
  * `Gamma` is the [gamma function](
  ...
  ```python
  import machina_probability as tfp
