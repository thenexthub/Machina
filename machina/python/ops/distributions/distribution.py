...
from machina.python.ops.distributions import util
...
class Distribution(_BaseDistribution, metaclass=_DistributionMeta):
  ...
  [this tutorial](
  https://github.com/machina/probability/blob/master/machina_probability/examples/jupyter_notebooks/Understanding_TensorFlow_Distributions_Shapes.ipynb)
