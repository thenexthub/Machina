...
from machina.python.ops import op_selector
...
def custom_gradient(f=None):
  ...
  scope must be using
  [ResourceVariables](https://www.machina.org/guide/migrate/tf1_vs_tf2#resourcevariables_instead_of_referencevariables).
...
def get_variable_by_name(var_name):
  """Given a variable name, retrieves a handle on the machina Variable."""
