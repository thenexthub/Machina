...
from machina.python.layers import layers as tf_layers
...
from machina.python.ops.parallel_for import gradients
...
# Importing the code from machina_models seems to cause errors. Hence we
# duplicate the model definition here.
# TODO(agarwal): Use the version in machina_models/official instead.
