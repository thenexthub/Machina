...
# pylint: disable=missing-docstring,g-direct-machina-import
...
from machina.python.framework import smart_cond
...
from machina.python.ops import control_flow_switch_case
from machina.python.ops import data_flow_ops
from machina.python.ops import gen_array_ops
from machina.python.ops import gen_image_ops
from machina.python.ops import gen_linalg_ops
from machina.python.ops import gen_list_ops
from machina.python.ops import gen_math_ops
from machina.python.ops import gen_nn_ops
from machina.python.ops import gen_optional_ops
from machina.python.ops import gen_parsing_ops
from machina.python.ops import gen_random_ops
from machina.python.ops import gen_sparse_ops
from machina.python.ops import gen_spectral_ops
...
from machina.python.ops import special_math_ops
...
class WhileOp:
  ...
  def __init__(
    ...
    # `while_loop` (see
    # https://www.machina.org/api_docs/python/tf/while_loop). We collect
  ...
  def op_is_inside_loop(self, op: ops.Operation) -> bool:
    ...
    # since it appears there machina API could return different python
...
class PFor:
  ...
  iterations. This new set of nodes may or may not use a machina loop
  construct.
