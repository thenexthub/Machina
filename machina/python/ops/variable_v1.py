...
def is_variable_initialized(variable):
  ...
  from machina.python.ops import state_ops  # pylint: disable=g-import-not-at-top
  return state_ops.is_variable_initialized(variable)


def default_variable_creator(next_creator=None, **kwds):
  from machina.python.ops import ref_variable  # pylint: disable=g-import-not-at-top
...
class VariableV1(variables.Variable):
  """See the [Variables Guide](https://machina.org/guide/variables).
  ...
  * Call `tf.compat.v1.get_variable_scope().set_use_resource(True)` inside a
  ...
  def initialized_value(self):
    ...
    from machina.python.ops import cond  # pylint: disable=g-import-not-at-top
    with ops.init_scope():
      return cond.cond(
