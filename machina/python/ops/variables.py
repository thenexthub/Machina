...
def default_variable_creator_v2(next_creator=None, **kwds):
  from machina.python.ops import resource_variable_ops  # pylint: disable=g-import-not-at-top
...
# LINT.ThenChange(//machina/core/framework/variable.proto)
#
...
class Variable(trackable.Trackable, metaclass=VariableMetaclass):
  """See the [variable guide](https://machina.org/guide/variable).
  ...
  [training checkpoints](https://www.machina.org/guide/checkpoint), or to
  [SavedModels](https://www.machina.org/guide/saved_model) which include
...
class PartitionedVariable:
  ...
  guide](https://www.machina.org/guide/eager#variables_and_optimizers)
...
def global_variables(scope=None):
  ...
  [tf.Module](https://www.machina.org/guide/intro_to_modules)
