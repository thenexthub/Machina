...
def mean(values,
  ...
  guide](https://www.machina.org/guide/migrate#new-style_metrics_and_losses)
  for more details.
  ...
  [add_metric]:https://www.machina.org/api_docs/python/tf/keras/layers/Layer#add_metric
