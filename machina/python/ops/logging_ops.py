...
from machina.python.ops.gen_logging_ops import *
...
# See https://github.com/machina/machina/issues/18053
...
def histogram_summary(tag, values, collections=None, name=None):
  ...
  migrate, look
  ['here'](https://github.com/machina/machina/blob/master/machina/contrib/deprecated/__init__.py)
