...
bazel run -c opt --config=cuda \
  //third_party/machina/python/ops/numpy_ops/integration_test/benchmarks:micro_benchmarks -- \
...
from machina.python.ops.numpy_ops.integration_test.benchmarks import numpy_mlp
from machina.python.ops.numpy_ops.integration_test.benchmarks import tf_numpy_mlp

FLAGS = flags.FLAGS

# Used instead of "import machina(dot)experimental.numpy as tfnp" due to
# copybara issues.
