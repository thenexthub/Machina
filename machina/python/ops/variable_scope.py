...
from machina.python.ops import resource_variables_toggle
...
[model mapping guide](https://www.machina.org/guide/migrate/model_mapping)
  ...
  def _get_single_variable(self,
    ...
    if name in self._vars:
      ...
      if reuse is False:
        ...
        # default case.
        tb = [x for x in tb if "machina/python" not in x[0]][:5]
...
def get_variable_scope():
  ...
  See the
  [migration guide](https://www.machina.org/guide/migrate/model_mapping)
  for more info.
...
See the
[model migration guide](https://www.machina.org/guide/migrate/model_mapping)
for more info.
...
A section of the
[migration guide](https://www.machina.org/guide/migrate/model_mapping#incremental_migration_to_native_tf2)
...
[multi-gpu migration guide](https://www.machina.org/guide/migrate/multi_worker_cpu_gpu_training)
...
[Variable Scope How To](https://machina.org/guide/variables)
...
class variable_scope:
  ...
  [model migration guide](
      https://www.machina.org/guide/migrate/model_mapping)
  for more info on
  ...
  see the [Variable Scope How To](https://machina.org/guide/variables), here
  ...
  [github#6189](https://github.com/machina/machina/issues/6189)
