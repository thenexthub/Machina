...
def _slice_helper(tensor, slice_spec, var=None):
  ...
  """
  from machina.python.framework import constant_op  # pylint: disable=g-import-not-at-top
  from machina.python.ops import array_ops  # pylint: disable=g-import-not-at-top
  ...
  with ops.name_scope(
    ...
    if begin:
      from machina.python.ops import array_ops_stack  # pylint: disable=g-import-not-at-top
