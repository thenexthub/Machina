...
from machina.python.framework import cpp_shape_inference_pb2
...
from machina.python.framework import tensor as tensor_module
...
from machina.python.ops import gen_state_ops
...
from machina.python.ops.gen_resource_variable_ops import *
...
class ResourceVariable(BaseResourceVariable, composite_tensor.CompositeTensor):
  ...
  See the [Variables How To](https://machina.org/guide/variables)
  ...
  def __init__(
    ...
    Args:
      ...
      experimental_enable_variable_lifting: Whether to lift the variable out if
        ...
        [here](https://www.machina.org/guide/function#creating_tfvariables).
