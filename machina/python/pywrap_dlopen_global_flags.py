...
Note that this file is only imported by pywrap_machina.py if this is a static
build (meaning there is no explicit framework cc_binary shared object dependency
of _pywrap_machina_internal.so). For regular (non-static) builds, RTLD_GLOBAL
...
# On UNIX-based platforms, pywrap_machina is a SWIG-generated python library
# that dynamically loads _pywrap_machina.so. The default mode for loading
