...
from machina.python.keras import callbacks
...
from machina.python.keras.distribute import distributed_training_utils as dist_utils
...
def _build_network_on_replica(model, mode, inputs=None, targets=None):
  ...
  from machina.python.keras.engine import sequential  # pylint: disable=g-import-not-at-top
