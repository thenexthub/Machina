...
from machina.python.distribute import one_device_strategy
...
from machina.python.keras.mixed_precision import loss_scale as keras_loss_scale_module
from machina.python.keras.optimizer_v2 import optimizer_v2
from machina.python.keras.optimizer_v2 import utils as optimizer_utils
...
from machina.python.trackable import base_delegate
from machina.python.training.experimental import loss_scale as loss_scale_module
from machina.python.training.experimental import mixed_precision
...
class LossScaleOptimizer(base_delegate.DelegatingTrackableMixin,
  ...
  https://www.machina.org/guide/keras/mixed_precision) for more information
