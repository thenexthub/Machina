...
from machina.python.summary import summary as tf_summary
  ...
  * Sampled profiling
  ...
  Args:
      ...
      embeddings_metadata: a dictionary which maps layer name to a file name in
        which metadata for this embedding layer is saved.
          [Here are details](
            https://www.machina.org/how_tos/embedding_viz/#metadata_optional)
      ...
      embeddings_data: data to be embedded at layers specified in
        ...
        about embeddings [in this guide](
          https://www.machina.org/programmers_guide/embedding).
  ...
  def set_model(self, model):
    ...
    if self.embeddings_freq and self.embeddings_data is not None:
      ...
      from machina.python.keras.engine import training_utils_v1  # pylint: disable=g-import-not-at-top
