...
from machina.python.keras import distribute
...
from machina.python.keras.engine.sequential import Sequential
from machina.python.keras.engine.training import Model
