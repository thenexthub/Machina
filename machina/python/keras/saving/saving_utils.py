...
def trace_model_call(model, input_signature=None):
  ...
  def _wrapped_model(*args):
    ...
    if output_names is None:  # Subclassed Model.
      from machina.python.keras.engine import compile_utils  # pylint: disable=g-import-not-at-top
...
def model_metadata(model, include_optimizer=True, require_config=True):
  ...
  from machina.python.keras.optimizer_v2 import optimizer_v2  # pylint: disable=g-import-not-at-top
