...
from machina.python.keras.saving.saved_model import load as keras_load
from machina.python.keras.saving.saved_model import serialized_attributes
...
sequential_lib = LazyLoader(
    ...
    "machina.python.keras.engine.sequential")
