...
from machina.python.keras.protobuf import saved_metadata_pb2
from machina.python.keras.protobuf import versions_pb2
...
from machina.python.keras.saving.saved_model import utils
from machina.python.keras.saving.saved_model.serialized_attributes import CommonEndpoints
from machina.python.keras.utils import generic_utils
from machina.python.keras.utils import metrics_utils
from machina.python.keras.utils.generic_utils import LazyLoader
...
from machina.python.saved_model import load as tf_load
...
def _unable_to_call_layer_due_to_serialization_issue(
  ...
  raise ValueError(
      ...
      'https://www.machina.org/guide/keras/save_and_serialize'
