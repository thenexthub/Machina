...
from machina.python.ops.losses import losses_impl
...
class Loss:
  ...
  * `call()`: Contains the logic for loss calculation using `y_true`, `y_pred`.
  ...
  Please see this custom training [tutorial](
    https://www.machina.org/tutorials/distribute/custom_training) for more
  details on this.
    ...
    Args:
      reduction: Type of `tf.keras.losses.Reduction` to apply to
        ...
        will raise an error. Please see this custom training [tutorial](
          https://www.machina.org/tutorials/distribute/custom_training) for
            more details.
