...
from machina.python.keras import backend as K
...
from machina.python.keras.utils import conv_utils
...
from machina.python.ops import standard_ops
...
from machina.python.util.tf_export import get_symbol_from_name
...
class Masking(Layer):
  ...
  See [the masking and padding guide](
    https://www.machina.org/guide/keras/masking_and_padding)
  for more details.
  """
...
class Lambda(Layer):
  ...
  [this guide](https://www.machina.org/guide/keras/custom_layers_and_models)
