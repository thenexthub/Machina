...
from machina.python.client import session as session_module
from machina.python.distribute import distribute_lib
from machina.python.eager import context
from machina.python.eager.context import get_config
...
from machina.python.framework import dtypes as dtypes_module
...
from machina.python.keras import backend_config
from machina.python.keras.distribute import distribute_coordinator_utils as dc
from machina.python.keras.engine import keras_tensor
from machina.python.keras.utils import control_flow_util
from machina.python.keras.utils import object_identity
from machina.python.keras.utils import tf_contextlib
...
from machina.python.training import moving_averages
from machina.python.util import dispatch
from machina.python.util import nest
from machina.python.util import numpy_compat
...
def placeholder(shape=None,
  ...
  Args:
      ...
      ragged: Boolean, whether the placeholder should have a ragged type.
          ...
          [guide](https://www.machina.org/guide/ragged_tensors).
  ...
  if context.executing_eagerly():
    ...
    from machina.python.keras.engine import input_layer  # pylint: disable=g-import-not-at-top
...
def is_placeholder(x):
  ...
  try:
    ...
    from machina.python.keras.utils import tf_utils  # pylint: disable=g-import-not-at-top
...
def zeros_like(x, dtype=None, name=None):
  ...
  ```python
  from machina.keras import backend as K
...
def in_train_phase(x, alt, training=None):
  ...
  """
  from machina.python.keras.engine import base_layer_utils  # pylint: disable=g-import-not-at-top
  if training is None:
