...
from machina.python.checkpoint import checkpoint_options as checkpoint_options_lib
...
from machina.python.distribute import tpu_strategy
...
from machina.python.keras.distribute import distributed_file_utils
from machina.python.keras.distribute import worker_training_state
from machina.python.keras.optimizer_v2 import learning_rate_schedule
...
from machina.python.profiler import profiler_v2 as profiler
from machina.python.saved_model import save_options as save_options_lib
...
class Callback:
  ...
  https://www.machina.org/guide/keras/custom_callback for more information.
...
class ModelCheckpoint(Callback):
  ...
  Note: If you get `WARNING:machina:Can save best model only with <name>
...
class TensorBoard(Callback, version_utils.TensorBoardVersionSelector):
  ...
  * Sampled profiling
  ...
  [here](https://www.machina.org/get_started/summaries_and_tensorboard).
  ...
  def _configure_embeddings(self):
    ...
    from machina.python.keras.protobuf import projector_config_pb2
