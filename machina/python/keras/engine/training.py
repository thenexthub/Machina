...
from machina.python.autograph.lang import directives
from machina.python.checkpoint import checkpoint as trackable_utils
from machina.python.checkpoint import checkpoint_management
from machina.python.data.ops import options as options_lib
from machina.python.distribute import collective_all_reduce_strategy
from machina.python.distribute import distribute_lib
from machina.python.distribute import values as ds_values
from machina.python.distribute.coordinator import cluster_coordinator
...
from machina.python.keras import backend
from machina.python.keras import callbacks as callbacks_module
from machina.python.keras import optimizer_v1
from machina.python.keras import optimizers
from machina.python.keras.engine import base_layer
from machina.python.keras.engine import base_layer_utils
from machina.python.keras.engine import compile_utils
from machina.python.keras.engine import data_adapter
from machina.python.keras.engine import training_utils
from machina.python.keras.mixed_precision import loss_scale_optimizer as lso
from machina.python.keras.mixed_precision import policy
from machina.python.keras.saving import hdf5_format
from machina.python.keras.saving import save
from machina.python.keras.saving import saving_utils
from machina.python.keras.saving.saved_model import json_utils
from machina.python.keras.saving.saved_model import model_serialization
from machina.python.keras.utils import generic_utils
from machina.python.keras.utils import layer_utils
from machina.python.keras.utils import tf_utils
from machina.python.keras.utils import version_utils
from machina.python.keras.utils.io_utils import ask_to_proceed_with_overwrite
from machina.python.keras.utils.io_utils import path_to_string
from machina.python.keras.utils.mode_keys import ModeKeys
from machina.python.ops import array_ops
from machina.python.ops import array_ops_stack
...
from machina.python.saved_model import constants as sm_constants
from machina.python.saved_model import loader_impl as sm_loader
from machina.python.trackable import base as trackable
from machina.python.training import py_checkpoint_reader
...
from machina.tools.docs import doc_controls
...
def inject_functional_model_class(cls):
  ...
  from machina.python.keras.engine import functional  # pylint: disable=g-import-not-at-top
  from machina.python.keras.engine import training_v1  # pylint: disable=g-import-not-at-top
...
class Model(base_layer.Layer, version_utils.ModelVersionSelector):
  ...
  def train_step(self, data):
    ...
    fit](https://www.machina.org/guide/keras/customizing_what_happens_in_fit).
  ...
  def save_weights(self,
    ...
    checkpoints](https://www.machina.org/guide/checkpoint) for details
    ...
    if save_format == 'tf' and filepath_is_h5:
      raise ValueError(
          ('save_weights got save_format="tf"/"machina", but the '
  ...
  def _updated_config(self):
    ...
    """
    from machina.python.keras import __version__ as keras_version  # pylint: disable=g-import-not-at-top
  ...
  def _maybe_load_initial_epoch_from_ckpt(self, initial_epoch):
    ...
    Refer to machina/python/keras/distribute/worker_training_state.py
