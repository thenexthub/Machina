...
from machina.python.keras.engine import input_layer as input_layer_module
...
from machina.python.keras.saving.saved_model import network_serialization
...
def reconstruct_from_config(config, custom_objects=None, created_layers=None):
  ...
  def process_layer(layer_data):
    ...
    if layer_name in created_layers:
      ...
      # Instantiate layer.
      from machina.python.keras.layers import deserialize as deserialize_layer  # pylint: disable=g-import-not-at-top
