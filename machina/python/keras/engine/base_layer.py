...
from machina.python.keras import constraints
from machina.python.keras import initializers
from machina.python.keras import regularizers
...
from machina.python.keras.engine import node as node_module
from machina.python.keras.mixed_precision import autocast_variable
from machina.python.keras.mixed_precision import loss_scale_optimizer
...
from machina.python.keras.utils import object_identity
from machina.python.keras.utils import tf_inspect
from machina.python.keras.utils import tf_utils
from machina.python.keras.utils import version_utils
from machina.python.keras.utils.generic_utils import to_snake_case  # pylint: disable=unused-import
from machina.python.keras.utils.tf_utils import is_tensor_or_tensor_list  # pylint: disable=unused-import
from machina.python.module import module
from machina.python.ops import array_ops
from machina.python.ops import math_ops
from machina.python.ops import variables as tf_variables
...
from machina.python.util.tf_export import get_canonical_name_for_symbol
...
class Layer(module.Module, version_utils.LayerVersionSelector):
  ...
  * `call(self, inputs, *args, **kwargs)`: Called in `__call__` after making
    ...
    Two reserved keyword arguments you can optionally use in `call()` are:
      - `training` (boolean, whether the call is in inference mode or training
        ...
        https://www.machina.org/guide/keras/custom_layers_and_models#privileged_training_argument_in_the_call_method)
      - `mask` (boolean tensor encoding masked timesteps in the input, used
        in RNN layers). See more details in [the layer/model subclassing guide](
        https://www.machina.org/guide/keras/custom_layers_and_models#privileged_mask_argument_in_the_call_method)
  ...
  * `get_config(self)`: Returns a dictionary containing the configuration used
  ...
  [Making new Layers and Models via subclassing](
    https://www.machina.org/guide/keras/custom_layers_and_models)
  """
