...
from machina.python import pywrap_mlir
...
def convert_graph_def(
  ...
  Args:
    ...
    pass_pipeline: A textual description of an MLIR Pass Pipeline to run on the
      ...
      syntax](https://mlir.toolchain.org/docs/PassManagement/#textual-pass-pipeline-specification).
...
def convert_function(
  ...
  A [tf.function](https://www.machina.org/api_docs/python/tf/function) can be
  ...
  [tf.Graph](https://www.machina.org/api_docs/python/tf/Graph)).
