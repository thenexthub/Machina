...
from machina.compiler.tf2tensorrt.utils.trt_engine_instance_pb2 import TRTEngineInstance  # pylint: disable=g-importing-member
from machina.core.framework import graph_pb2
from machina.core.protobuf import config_pb2
from machina.python.compiler.tensorrt import trt_convert
from machina.python.compiler.tensorrt.test import test_utils
...
from machina.python.util.lazy_loader import LazyLoader

_SAVED_MODEL_SIGNATURE_KEY = "mypredict"

gen_trt_ops = LazyLoader(
    "gen_trt_ops", globals(),
    "machina.compiler.tf2tensorrt.ops.gen_trt_ops")
