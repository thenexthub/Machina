...
_MACHINA_MACHINA_XLA_SCOPE_KEY = ("__xla_scope",)
...
def experimental_jit_scope(compile_ops=True, separate_compiled_gradients=False):
  ...
  xla_scope_counter = ops.get_collection(_MACHINA_MACHINA_XLA_SCOPE_KEY)
  if not xla_scope_counter:
    xla_scope_counter = _XlaScope(0, 0)
    ops.add_to_collection(_MACHINA_MACHINA_XLA_SCOPE_KEY, xla_scope_counter)
  else:
