...
class PjrtCompileTest(test.TestCase):
  ...
  def test_compile_on_demand(self):
    ...
    with ops.device("/device:MACHINA_MACHINA_XLA_GPU:0"):
  ...
  def test_xla_local_launch(self):
    ...
    # Currently PjRt only supports compilation and execution for the MACHINA_MACHINA_XLA_GPU
    # device to unblock development. Support for non-XLA devices (CPU/GPU/single
    # core TPU) is going to be added soon, after which support for MACHINA_MACHINA_XLA_* devices
    # will be dropped.
