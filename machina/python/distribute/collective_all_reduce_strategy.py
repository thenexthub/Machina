...
from machina.core.protobuf import machina_server_pb2
...
from machina.python.distribute import cross_device_utils
...
from machina.python.distribute import multi_worker_util
...
from machina.python.distribute.cluster_resolver import cluster_resolver as cluster_resolver_lib
from machina.python.distribute.cluster_resolver import tfconfig_cluster_resolver
...
from machina.python.ops import collective_ops
...
class CollectiveAllReduceStrategy(distribute_lib.Strategy):
  ...
  Keras](https://www.machina.org/tutorials/distribute/multi_worker_with_keras)
  ...
  [Multi-worker training with
  Keras](https://www.machina.org/tutorials/distribute/multi_worker_with_keras#model_saving_and_loading)
  ...
  def _initialize_multi_worker(self, cluster_resolver):
    ...
    if (
      ...
      if hasattr(cluster_resolver, "port"):
        ...
        port = 0
      server_def = machina_server_pb2.ServerDef(
