...
from machina.python.distribute.failure_handling.failure_handling_util import detect_platform
from machina.python.distribute.failure_handling.failure_handling_util import PlatformDevice
from machina.python.eager import context
from machina.python.eager import monitoring
from machina.python.framework.errors import AbortedError
from machina.python.framework.errors import CancelledError
from machina.python.framework.errors import InternalError
from machina.python.framework.errors import UnavailableError
from machina.python.util.tf_export import tf_export


_preemption_watcher_initialization_counter = monitoring.Counter(
    "/machina/api/distribution_strategy/preemption_watcher_initialized",
    "Counter for usages of PreemptionWatcher",
)
_preemption_handling_counter = monitoring.Counter(
    "/machina/api/distribution_strategy/preemption_watcher_handled",
