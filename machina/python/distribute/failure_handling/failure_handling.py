...
from machina.core.distributed_runtime.preemption import gen_check_preemption_op
from machina.python.checkpoint import checkpoint as checkpoint_lib
...
from machina.python.distribute.failure_handling import failure_handling_util
    ...
    if (self._platform_device ==
      ...
      try:
        ...
        if abort_error.experimental_payloads.get(
            b'type.googleapis.com/machina.distributed_runtime.WorkerPreemption'
        ):
