...
def _init():
  ...
  function_tracing_sampler = monitoring.Sampler(
      '/machina/api/ps_strategy/coordinator/function_tracing',
  ...
  closure_execution_sampler = monitoring.Sampler(
      '/machina/api/ps_strategy/coordinator/closure_execution',
  ...
  remote_value_fetch_sampler = monitoring.Sampler(
      '/machina/api/ps_strategy/coordinator/remote_value_fetch',
      fetch_time_buckets,
      'Sampler to track the time (in seconds) for fetching remote_value.')

  server_def_update_sampler = monitoring.Sampler(
      '/machina/api/ps_strategy/coordinator/server_def_update',
