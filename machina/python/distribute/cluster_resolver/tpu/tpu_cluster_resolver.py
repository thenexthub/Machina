...
from machina.core.protobuf.tpu import topology_pb2
...
from machina.python.tpu import tpu_strategy_util
from machina.python.tpu import tpu_system_metadata as tpu_system_metadata_lib
...
try:
  ...
  from machina.python.tpu.client import client  # pylint: disable=g-import-not-at-top
