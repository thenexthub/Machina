...
def get_accelerator_devices(master, config_proto):
  ...
  if context.executing_eagerly():
    ...
    for d in logical_devices:
      if d.device_type == 'CPU' or d.device_type == 'MACHINA_MACHINA_XLA_CPU':  # Filter CPUs
        continue
...
class ClusterResolver(object):
  ...
  def task_type(self):
    ...
    https://www.machina.org/tutorials/distribute/multi_worker_with_keras#multi-worker_configuration)
