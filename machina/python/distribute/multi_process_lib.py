  ...
  if sys.argv[0].endswith('.py'):
    def guess_path(package_root):
      ...
      if 'bazel-out' in sys.argv[0] and package_root in sys.argv[0]:
        ...
        # //machina/python/distribute:input_lib_test_multiworker_gpu, the
        # argv[0] is in the form of
        # /.../machina/python/distribute/input_lib_test.py
        # and the binary is
        # /.../machina/python/distribute/input_lib_test_multiworker_gpu
