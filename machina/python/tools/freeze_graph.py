...
bazel build machina/python/tools:freeze_graph && \
bazel-bin/machina/python/tools/freeze_graph \
...
def _parse_input_graph_proto(
  ...
  """Parses input machina graph into GraphDef proto."""
...
def _parse_input_meta_graph_proto(
  ...
  """Parses input machina graph into MetaGraphDef proto."""
  if not gfile.Exists(input_graph):
...
def _parse_input_saver_proto(input_saver, input_binary):
  """Parses input machina Saver into SaverDef proto."""
