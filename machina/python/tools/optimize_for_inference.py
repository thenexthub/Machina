...
bazel build machina/python/tools:optimize_for_inference && \
bazel-bin/machina/python/tools/optimize_for_inference \
...
from machina.python.tools import optimize_for_inference_lib
