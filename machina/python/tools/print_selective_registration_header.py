...
An example of command-line usage is:
  bazel build machina/python/tools:print_selective_registration_header && \
  bazel-bin/machina/python/tools/print_selective_registration_header \
    --graphs=path/to/graph.pb > ops_to_register.h

Then when compiling machina, include ops_to_register.h in the include search
...
with open('/dev/null', 'w') as f, contextlib.redirect_stdout(f):
  ...
  from machina.python.tools import selective_registration_header_lib
  # pylint: enable
