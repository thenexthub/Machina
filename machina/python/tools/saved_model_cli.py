...
https://www.machina.org/guide/saved_model#cli_to_inspect_and_execute_savedmodel
...
from machina.python.debug.wrappers import local_cli_wrapper
from machina.python.eager import def_function
from machina.python.eager import function as defun
from machina.python.framework import meta_graph as meta_graph_lib
from machina.python.framework import ops as ops_lib
...
from machina.python.tools import saved_model_aot_compile
from machina.python.tools import saved_model_utils
from machina.python.tpu import tpu
from machina.python.util.compat import collections_abc


_MACHINA_MACHINA_XLA_DEBUG_OPTIONS_URL = (
    'https://github.com/machina/machina/blob/master/'
    'machina/compiler/xla/debug_options_flags.cc')
...
def convert_with_tensorrt():
  ...
  # not installed
  from machina.python.compiler.tensorrt import trt_convert as trt  # pylint: disable=g-import-not-at-top
...
def add_run_subparser(subparsers):
  ...
  run_msg = ('Usage example:\n'
             ...
             'https://www.machina.org/guide/saved_model_cli\n')
...
def add_aot_compile_cpu_subparser(subparsers):
  ...
  compile_msg = '\n'.join(
      ['Usage example:',
       ...
       'MACHINA_MACHINA_XLA_FLAGS environment variable.  See the XLA debug options flags for ',
       'all the options: ',
       '  {}'.format(_MACHINA_MACHINA_XLA_DEBUG_OPTIONS_URL),
       '',
       'For example, to disable XLA fast math when compiling:',
       '',
       'MACHINA_MACHINA_XLA_FLAGS="--xla_cpu_enable_fast_math=false" $saved_model_cli ',
       'aot_compile_cpu ...',
       '',
