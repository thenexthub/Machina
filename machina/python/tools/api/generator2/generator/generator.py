...
# =============================================================================
"""Library that generates the API for machina."""
...
_OUTPUT_PACKAGE = flags.DEFINE_string(
    'output_package', 'machina', 'Root output package.'
)
...
_PACKAGES_TO_IGNORE = flags.DEFINE_list(
    ...
    ' packages_to_ignore="machina.python.framework.test_ops"'
...
def _get_module_docstring(
  ...
  module = module.replace('machina', 'tf')
...
def gen_public_api(
  ...
  """Generates the public API for machina.
