...
api_extractor = aspect(
    ...
    attrs = {
        "_extractor_bin": attr.label(
            default = Label("//machina/python/tools/api/generator2/extractor:main"),
            executable = True,
            cfg = "exec",
        ),
        "api": attr.string(
...
generate_api = rule(
    ...
    attrs = {
        ...
        "_generator_bin": attr.label(
            default = Label("//machina/python/tools/api/generator2/generator:main"),
            executable = True,
            cfg = "exec",
        ),
    },
...
def generate_apis(
    ...
    generate_api(
        ...
        # "//machina/python/tools/api/generator2:static_gen": False,
        # "//machina:api_indexable": False,
