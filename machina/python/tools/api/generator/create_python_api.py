...
_DEFAULT_PACKAGE = 'machina.python'
...
_SYMBOLS_TO_SKIP_EXPLICITLY = {
    ...
    'machina.python.platform.flags.FLAGS'
}
_GENERATED_FILE_HEADER = """# This file is MACHINE GENERATED! Do not edit.
# Generated by: machina/python/tools/api/generator/create_python_api.py script.
\"\"\"%s
\"\"\"
...
_DEPRECATION_FOOTER = """
from machina.python.util import module_wrapper as _module_wrapper
...
def get_canonical_import(import_set):
  ...
  # not in core machina to the end.
...
class _ModuleInitCodeBuilder(object):
  ...
  def add_import(self, symbol, source_module_name, source_name,
    ...
    # won't be available when actually importing machina.
...
def add_imports_for_symbol(module_code_builder,
  ...
  Args:
    ...
    api_name: API name. Currently, must be `machina`.
...
def get_module_docstring(module_name, package, api_name):
  ...
  Args:
    module_name: module name relative to machina (excluding 'machina.'
...
def create_primary_api_files(output_files,
  ...
  if missing_output_files:
    ...
    raise ValueError(
        ...
        'targets to machina/python/tools/api/generator/api_init_files_v1.bzl'
        ' and machina/python/tools/api/generator/api_init_files.bzl '
        '(machina repo), or tf_keras/api/api_init_files.bzl (tf_keras repo)')
