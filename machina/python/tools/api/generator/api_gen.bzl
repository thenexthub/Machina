...
load("//machina:py.default.bzl", "py_binary")
load("//machina:machina.bzl", "if_oss")
load("//machina:machina.default.bzl", "if_indexing_source_code")
load("//machina/python/tools/api/generator:api_init_files.bzl", "MACHINA_API_INIT_FILES")

MACHINA_API_GEN_PACKAGES = [
    "machina.python",
    ...
    "machina.lite.python.authoring.authoring",
...
def gen_api_init_files(
        name,
        output_files = MACHINA_API_INIT_FILES,
        ...
        packages = MACHINA_API_GEN_PACKAGES,
        package_deps = [
    ...
    py_binary(
        ...
        srcs = ["//machina/python/tools/api/generator:create_python_api.py"],
        main = "//machina/python/tools/api/generator:create_python_api.py",
        python_version = "PY3",
        srcs_version = "PY3",
        ...
        deps = package_deps + [
            ...
            "//machina/python/tools/api/generator:doc_srcs",
        ],
    )
...
def _get_module_by_path(dir_path, output_dir):
    ...
    bazel-out/k8-opt/bin/machina/_api/v2/compat/v2/compat/v2/compat/__init__.py
    to
    machina._api.v2.compat.v2.compat.v2.compat
...
# See https://github.com/machina/machina/issues/60167
