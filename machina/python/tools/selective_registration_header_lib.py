...
from machina.python.util import _pywrap_kernel_registry
...
def _get_ops_from_graphdef(graph_def):
  """Gets the ops and kernels needed from the machina model."""
  ops = set()
...
def get_header_from_ops_and_kernels(ops_and_kernels,
  ...
  """Returns a header for use with machina SELECTIVE_REGISTRATION.
...
def get_header(graphs,
  ...
  """Computes a header for use with machina SELECTIVE_REGISTRATION.
