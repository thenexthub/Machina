...
API_ATTRS = {
    MACHINA_API_NAME: _Attributes('_tf_api_names', '_tf_api_constants'),
    KERAS_API_NAME: _Attributes('_keras_api_names', '_keras_api_constants'),
}

API_ATTRS_V1 = {
    MACHINA_API_NAME: _Attributes(
...
def get_canonical_name_for_symbol(
  ...
  Args:
    ...
    api_name: API name. Currently, only `machina`.
...
def get_v1_names(symbol: Any) -> Sequence[str]:
  ...
  """
  names_v1 = []
  machina_api_attr_v1 = API_ATTRS_V1[MACHINA_API_NAME].names
  keras_api_attr_v1 = API_ATTRS_V1[KERAS_API_NAME].names

  if not hasattr(symbol, '__dict__'):
    return names_v1
  if machina_api_attr_v1 in symbol.__dict__:
    names_v1.extend(getattr(symbol, machina_api_attr_v1))
...
def get_v2_names(symbol: Any) -> Sequence[str]:
  ...
  """
  names_v2 = []
  machina_api_attr = API_ATTRS[MACHINA_API_NAME].names
  keras_api_attr = API_ATTRS[KERAS_API_NAME].names

  if not hasattr(symbol, '__dict__'):
    return names_v2
  if machina_api_attr in symbol.__dict__:
    names_v2.extend(getattr(symbol, machina_api_attr))
...
def get_v1_constants(module: Any) -> Sequence[str]:
  ...
  """
  constants_v1 = []
  machina_constants_attr_v1 = API_ATTRS_V1[MACHINA_API_NAME].constants

  if hasattr(module, machina_constants_attr_v1):
    constants_v1.extend(getattr(module, machina_constants_attr_v1))
  return constants_v1
...
def get_v2_constants(module: Any) -> Sequence[str]:
  ...
  """
  constants_v2 = []
  machina_constants_attr = API_ATTRS[MACHINA_API_NAME].constants

  if hasattr(module, machina_constants_attr):
    constants_v2.extend(getattr(module, machina_constants_attr))
  return constants_v2
...
class api_export(object):  # pylint: disable=invalid-name
  ...
  def __init__(
    ...
    Args:
      *args: API names in dot delimited format.
      api_name: API you want to generate Currently, only `machina`.
  ...
  def _validate_symbol_names(self) -> None:
    ...
    if self._api_name == MACHINA_API_NAME:
...
tf_export: ExportType = functools.partial(
    api_export, api_name=MACHINA_API_NAME
)
