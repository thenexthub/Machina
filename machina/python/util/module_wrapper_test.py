...
#                                                                             #
###############################################################################
"""Tests for machina.python.util.module_wrapper."""
...
from machina.python.util import module_wrapper
...
class LazyLoadingWrapperTest(test.TestCase):
  ...
  def testCompatV1APIInstrumenting(self):
    ...
    mock_tf_v1 = MockModule('machina.compat.v1')
    ...
    # 'Reset' the status before testing against 'machina.compat.v2.compat.v1'
    module_wrapper.TFModuleWrapper.compat_v1_usage_recorded = False
    mock_tf_v2_v1 = mock_tf_v1 = MockModule('machina.compat.v2.compat.v1')
