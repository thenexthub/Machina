...
#ifndef MACHINA_PYTHON_UTIL_FUNCTION_PARAMETER_CANONICALIZER_H_
#define MACHINA_PYTHON_UTIL_FUNCTION_PARAMETER_CANONICALIZER_H_
...
#endif  // MACHINA_PYTHON_UTIL_FUNCTION_PARAMETER_CANONICALIZER_H_
