...
PYBIND11_MODULE(_pywrap_utils, m) {
  ...
  m.def("RegisterPyObject", [](const py::handle& name, const py::handle& type) {
    return machina::PyoOrThrow(
        machina::swig::RegisterPyObject(name.ptr(), type.ptr()));
  });
  m.def(
      "IsTensor",
      [](const py::handle& o) {
        bool result = machina::swig::IsTensor(o.ptr());
        if (PyErr_Occurred()) {
  ...
  m.def(
      "IsNested",
      [](const py::handle& o) {
        bool result = machina::swig::IsNested(o.ptr());
        return result;
      },
      R"pbdoc(
  ...
  m.def(
      "IsNestedOrComposite",
      [](const py::handle& o) {
        bool result = machina::swig::IsNestedOrComposite(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsCompositeTensor",
      [](const py::handle& o) {
        bool result = machina::swig::IsCompositeTensor(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsTypeSpec",
      [](const py::handle& o) {
        bool result = machina::swig::IsTypeSpec(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      ...
      [](const py::handle& o, bool strict) {
        return machina::PyoOrThrow(
            machina::swig::IsNamedtuple(o.ptr(), strict));
      },
      R"pbdoc(
  ...
  m.def(
      "IsMapping",
      [](const py::handle& o) {
        bool result = machina::swig::IsMapping(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsMutableMapping",
      [](const py::handle& o) {
        bool result = machina::swig::IsMutableMapping(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsMappingView",
      [](const py::handle& o) {
        bool result = machina::swig::IsMappingView(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsAttrs",
      [](const py::handle& o) {
        bool result = machina::swig::IsAttrs(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      ...
      [](const py::handle& o1, const py::handle& o2) {
        return machina::PyoOrThrow(
            machina::swig::SameNamedtuples(o1.ptr(), o2.ptr()));
      },
      R"pbdoc(
  ...
  m.def(
      ...
      [](const py::handle& o1, const py::handle& o2, bool check_types,
        ...
        bool result = machina::swig::AssertSameStructure(
  ...
  m.def(
      ...
      [](const py::handle& o, bool expand_composites) {
        return machina::PyoOrThrow(
            machina::swig::Flatten(o.ptr(), expand_composites));
      },
      R"pbdoc(
  ...
  m.def(
      "IsNestedForData",
      [](const py::handle& o) {
        bool result = machina::swig::IsNestedForData(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
      ...
      NOTE(mrry): This differs from `machina.python.util.nest.is_nested()`,
  ...
  m.def(
      ...
      [](const py::handle& o) {
        return machina::PyoOrThrow(
            machina::swig::FlattenForData(o.ptr()));
      },
      R"pbdoc(
  ...
  m.def(
      ...
      [](const py::handle& o1, const py::handle& o2, bool check_types) {
        bool result = machina::swig::AssertSameStructureForData(
  ...
  m.def(
      "IsResourceVariable",
      [](const py::handle& o) {
        bool result = machina::swig::IsResourceVariable(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      "IsVariable",
      [](const py::handle& o) {
        bool result = machina::swig::IsVariable(o.ptr());
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
  ...
  m.def(
      ...
      [](const machina::DataType& dt) {
        bool result = machina::IsDataTypeSupportedByOneDNNOnThisCPU(dt);
        if (PyErr_Occurred()) {
          throw py::error_already_set();
        }
        return result;
