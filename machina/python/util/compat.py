...
[migration guide](https://www.machina.org/guide/migrate) for details.
...
def path_to_str(path):
  ...
  Examples:
  ```python
  $ tf.compat.path_to_str('C:\XYZ\machina\./.././machina')
  'C:\XYZ\machina\./.././machina' # Windows OS
  $ tf.compat.path_to_str(Path('C:\XYZ\machina\./.././machina'))
  'C:\XYZ\machina\..\machina' # Windows OS
