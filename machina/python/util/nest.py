...
* Classes (including
  ...
  See examples in
  [`nest_util.py`](https://github.com/machina/machina/blob/04869b4e63bfc03cb13627b3e1b879fdd0f69e34/machina/python/util/nest_util.py#L97)
...
API docstring: machina.nest
"""

from machina.python.util import _pywrap_nest
from machina.python.util import _pywrap_utils
from machina.python.util import nest_util
...
def is_nested(seq):
  ...
  Refer to [tf.nest](https://www.machina.org/api_docs/python/tf/nest)
