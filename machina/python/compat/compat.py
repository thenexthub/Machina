...
See [Version
Compatibility](https://machina.org/guide/version_compat#backward_forward)
"""
...
def forward_compatible(year, month, day):
  ...
  See [Version
  compatibility](https://www.machina.org/guide/versions#backward_and_partial_forward_compatibility).
