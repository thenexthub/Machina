...
from machina.python import pywrap_machina  # pylint: disable=unused-import, g-bad-import-order
  ...
  def experimental_get_compiler_ir(self, *args, **kwargs):
    ...
    Returns:
        ...
        - `stage` at which the compiler IR should be serialized. Allowed values
          are:
           ...
           - `hlo`: HLO output after conversion from TF
            (https://www.machina.org/xla/operation_semantics).
      ...
      f32[10,20] {
        ...
        metadata={op_name="MACHINA_MACHINA_XLA_Args"}
