 ...
 *
 */
#ifndef MACHINA_PYTHON_FRAMEWORK_OFFSET_COUNTER_HELPER_H_
#define MACHINA_PYTHON_FRAMEWORK_OFFSET_COUNTER_HELPER_H_
...
#endif  // MACHINA_PYTHON_FRAMEWORK_OFFSET_COUNTER_HELPER_H_
