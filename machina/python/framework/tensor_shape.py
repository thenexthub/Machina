...
class Dimension(object):
  ...
  (https://www.machina.org/guide/migrate/index#tensorshape) on common code
  ...
  # See https://github.com/machina/machina/pull/9780
  def __long__(self):
    return self._value
...
class TensorShape(trace.TraceType, trace_type.Serializable):
  ...
  *dynamic* representation, please use `tf.shape(t)`
  ...
  `"Foo"`. See [Shape
  functions](https://www.machina.org/guide/create_op#shape_functions_in_c)
