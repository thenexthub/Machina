 ...
 *
 */
#ifndef MACHINA_PYTHON_FRAMEWORK_PY_CONTEXT_MANAGER_H_
#define MACHINA_PYTHON_FRAMEWORK_PY_CONTEXT_MANAGER_H_
...
#endif  // MACHINA_PYTHON_FRAMEWORK_PY_CONTEXT_MANAGER_H_
