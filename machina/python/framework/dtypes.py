...
# We need to import pywrap_machina prior to the bfloat wrapper to avoid
...
from machina.python.framework import _dtypes
...
def as_dtype(type_value):
  ...
  enum](https://www.machina.org/code/machina/core/framework/types.proto),
