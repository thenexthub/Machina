...
from machina.python.eager.polymorphic_function import composite_tensor_utils
    ...
    while inner_graph is not None and isinstance(inner_graph, FuncGraph):
      if inner_graph is self:
        ...
        raise errors.InaccessibleTensorError(
            ...
            "access it.\n"
            "Please see https://www.machina.org/guide/function#all_outputs_of_a_tffunction_must_be_return_values "  # pylint: disable=line-too-long
