...
using ::machina::AttributeType;
using ::machina::AttributeTypeFromName;
using ::machina::AttrValue;
using ::machina::CheckOpDeprecation;
using ::machina::ConvertPyObjectToAttributeType;
using ::machina::DataType;
using ::machina::DataTypeToPyObject;
using ::machina::MaybeRaiseFromStatus;
using ::machina::OpDef;
using ::machina::OpRegistry;
using ::machina::protobuf::RepeatedField;
using ::machina::protobuf::RepeatedPtrField;
using AttrDef = ::machina::OpDef::AttrDef;
using ArgDef = ::machina::OpDef::ArgDef;
