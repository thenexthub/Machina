...
def create_meta_graph_def(meta_info_def=None,
  ...
  Args:
    ...
    strip_default_attrs: Boolean. If `True`, default-valued attributes will be
        ...
        [Stripping Default-Valued Attributes](https://github.com/machina/machina/blob/master/machina/python/saved_model/README.md#stripping-default-valued-attributes).
  ...
  meta_info_def.machina_version = versions.__version__
  meta_info_def.machina_git_version = versions.__git_version__
...
def import_scoped_meta_graph_with_return_elements(
  ...
  * Run inference from a saved graph and checkpoints.
  ...
  with graph.as_default():
    ...
    tf_version = meta_graph_def.meta_info_def.machina_version
    if not tf_version:
