...
_tensor_equality_api_usage_gauge = monitoring.BoolGauge(
    "/machina/api/enable_tensor_equality",
...
class Tensor(internal.NativeObject, core_tf_types.Symbol):
  ...
  * a shape
  ...
  For more on Tensors, see the [guide](https://machina.org/guide/tensor).
  """
  ...
  def _disallow(self, task):
    raise errors.OperatorNotAllowedInGraphError(
        ...
        " to AutoGraph. See"
        " https://github.com/machina/machina/blob/master/machina/python/autograph/g3doc/reference/limitations.md#access-to-source-code"
  ...
  def get_shape(self) -> tensor_shape.TensorShape:
    ...
    *execution* time.
    ...
    Guide](https://www.machina.org/guide/concrete_function) for details).
