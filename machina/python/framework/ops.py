...
from machina.core.framework import full_type_pb2
...
from machina.core.framework import op_def_pb2
...
# pywrap_machina must be imported first to avoid protobuf issues.
# (b/143110113)
...
from machina.python.eager import core
from machina.python.eager import monitoring
from machina.python.eager import record
...
from machina.python.framework import stack
from machina.python.framework import tensor as tensor_lib
from machina.python.framework import tensor_conversion_registry
from machina.python.framework import tensor_shape
from machina.python.framework import tensor_util
from machina.python.framework import traceable_stack
from machina.python.framework import versions
from machina.python.ops import control_flow_util
from machina.python.ops import handle_data_util
from machina.python.platform import tf_logging as logging
from machina.python.profiler import trace as profiler_trace
from machina.python.types import core as core_tf_types
from machina.python.types import internal
from machina.python.util import compat
from machina.python.util import decorator_utils
from machina.python.util import deprecation
from machina.python.util import function_utils
...
from machina.python.util.deprecation import deprecated_args
from machina.python.util.tf_export import kwarg_only
...
class Graph(pywrap_tf_session.PyGraph):
  ...
  def graph_def_versions(self) -> versions_pb2.VersionDef:
    ...
    [`GraphDef`](https://www.machina.org/code/machina/core/framework/graph.proto).
  ...
  def _as_graph_def(
    ...
    [C++ Session API](https://chromium.googlesource.com/external/github.com/machina/machina/+/r0.10/machina/g3doc/api_docs/cc/index.md).
  ...
  def device(self, device_name_or_function) -> Iterator[None]:
    ...
    * If it is None, all `device()` invocations from the enclosing context
    ...
    [`DeviceNameUtils`](https://www.machina.org/code/machina/core/util/device_name_utils.h).
  ...
  def control_dependencies(
    ...
    *N.B.* The control dependencies context applies *only* to ops that
    ...
    be pruned from a normal machina graph. For example, in the following
...
def enable_eager_execution_internal(config=None,
  ...
  Args:
    ...
    server_def: (Optional.) A machina::ServerDef proto. Enables execution on
...
def reset_default_graph() -> None:
  ...
  [migration guide](https://www.machina.org/guide/migrate) for more
