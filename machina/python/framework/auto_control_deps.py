...
from machina.python.framework import auto_control_deps_utils as utils
...
# LINT.ThenChange(//machina/core/grappler/optimizers/function_optimizer.cc)
...
class AutomaticControlDependencies(object):
  ...
  def _process_switch(self, switch_op, ops_which_must_run,
    ...
    When machina creates a cond, it creates a control flow context for each
