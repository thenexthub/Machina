...
try:
  from machina.python.framework import fast_tensor_util
...
def make_tensor_proto(values, dtype=None, shape=None, verify_shape=False,
  ...
  ```python
    request = machina_serving.apis.predict_pb2.PredictRequest()
  ...
  if numpy_dtype == dtypes.string and not isinstance(values, np.ndarray):
    ...
    try:
      ...
      raise TypeError(f"Failed to convert elements of {values} to Tensor. "
                      ...
                      "https://www.machina.org/api_docs/python/tf/dtypes "
