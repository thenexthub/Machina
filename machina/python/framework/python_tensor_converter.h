 ...
 *
 */
#ifndef MACHINA_PYTHON_FRAMEWORK_PYTHON_TENSOR_CONVERTER_H_
#define MACHINA_PYTHON_FRAMEWORK_PYTHON_TENSOR_CONVERTER_H_
...
#endif  // MACHINA_PYTHON_FRAMEWORK_PYTHON_TENSOR_CONVERTER_H_
