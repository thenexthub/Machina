...
from machina.python.client import pywrap_tf_session as py_tf
from machina.python.eager import context
from machina.python.framework import _pywrap_python_op_gen
...
def load_op_library(library_filename):
  ...
  setattr(module, '_IS_MACHINA_PLUGIN', True)
