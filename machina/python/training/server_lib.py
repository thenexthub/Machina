...
from machina.core.protobuf import device_filters_pb2
...
def _make_server_def(server_or_cluster_def, job_name, task_index, protocol,
  ...
  if isinstance(server_or_cluster_def, machina_server_pb2.ServerDef):
...
class Server:
  ...
  def __del__(self):
    ...
    try:
      ...
      # See:
      # https://github.com/machina/machina/blob/0495317a6e9dd4cac577b9d5cf9525e62b571018/machina/core/distributed_runtime/rpc/grpc_server_lib.h#L73
