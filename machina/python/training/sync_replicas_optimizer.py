...
from machina.python.training import session_manager
...
class SyncReplicasOptimizer(optimizer.Optimizer):
  ...
  Strategies](https://github.com/machina/machina/tree/master/machina/contrib/distribute).
  ...
  * `sync_rep_local_step`, one per replica. Compared against the global_step in
  ...
  @deprecation.deprecated(
      ...
      "machina/machina/tree/master/machina/contrib/distribute).",
      warn_once=True)
  def __init__(self,
               opt,
