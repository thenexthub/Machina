...
from machina.python.training import slot_creator
...
class Optimizer(
  ...
  loops](https://www.machina.org/guide/basic_training_loops) or
  [Writing a training loop from scratch]
  (https://www.machina.org/guide/keras/writing_a_training_loop_from_scratch)
  for examples.
