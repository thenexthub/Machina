...
from machina.python.checkpoint import checkpoint as trackable_util
from machina.python.checkpoint import graph_view
from machina.python.distribute import distribute_coordinator_context
...
from machina.python.training import basic_session_run_hooks
from machina.python.training import coordinator
from machina.python.training import queue_runner
from machina.python.training import saver as training_saver
from machina.python.training import session_manager as sm
from machina.python.training import session_run_hook
...
def MonitoredTrainingSession(
  ...
  https://github.com/machina/docs/blob/master/site/en/guide/migrate/logging_stop_hook.ipynb)
