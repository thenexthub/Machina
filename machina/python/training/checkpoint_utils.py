...
they are not recommended for TF2. Please check  `machina/python/checkpoint`
...
def init_from_checkpoint(ckpt_dir_or_file, assignment_map):
  ...
  (https://www.machina.org/guide/checkpoint#loading_mechanics), while
  ...
  see [migration guide]
  (https://www.machina.org/guide/migrate#checkpoint_compatibility) for more
  details.
