...
machina/python/training/trackable and machina/python/training/saving.
"""
import collections
import glob
import os.path
...
class Saver:
  ...
  saving](https://www.machina.org/guide/checkpoint#loading_mechanics).
  ...
  https://www.machina.org/guide/migrate#checkpoint_compatibility)
  ...
  (https://github.com/machina/machina/blob/master/machina/python/training/checkpoint_state.proto)
  ...
  See [Variables](https://machina.org/guide/variables)
