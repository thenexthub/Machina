...
from machina.python.summary import summary as _summary
from machina.python.training import coordinator
from machina.python.training import saver as saver_mod
from machina.python.training import session_manager as session_manager_mod
...
class Supervisor:
  ...
  * Specifying `'grpc://hostname:port'` requests a session that uses
    ...
    master to access remote machina workers. Often, it is
