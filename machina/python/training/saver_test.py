...
# =============================================================================
"""Tests for machina.python.training.saver.py."""
...
from machina.core.protobuf import queue_runner_pb2
from machina.core.protobuf import rewriter_config_pb2
from machina.core.protobuf import saver_pb2
...
from machina.python.framework import graph_io
...
from machina.python.ops import partitioned_variables
...
from machina.python.trackable import base as trackable_base
...
from machina.python.training import queue_runner_impl
from machina.python.training import saver as saver_module
from machina.python.training import saver_test_utils
...
class MetaGraphTest(test.TestCase):
  ...
  def testAddCollectionDef(self):
    ...
    with self.cached_session():
      ...
      self.assertNotEqual(meta_graph_def.meta_info_def.machina_version, "")
      self.assertNotEqual(meta_graph_def.meta_info_def.machina_git_version,
                          "")
