...
https://github.com/machina/estimator/blob/master/machina_estimator/python/estimator/hooks/basic_session_run_hooks.py
"""
...
from machina.python.client import timeline
...
from machina.python.training.summary_io import SummaryWriterCache
...
class LoggingTensorHook(session_run_hook.SessionRunHook):
  ...
  [notebook]:https://github.com/machina/docs/blob/master/site/en/guide/migrate/logging_stop_hook.ipynb
