...
class ExponentialMovingAverage:
  ...
  1. Assign the values of the shadow variables to your model variables with
     ...
     machina-addons' MovingAverage optimizer's `swap_weights` method for
     one example of how to swap variables efficiently in distributed settings:
     https://github.com/machina/addons/blob/v0.13.0/machina_addons/optimizers/moving_average.py#L151
