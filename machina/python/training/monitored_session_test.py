...
from machina.core.protobuf import debug_pb2
...
from machina.python.distribute import distribute_coordinator
...
from machina.python.saved_model import builder as saved_model_builder
from machina.python.saved_model import load as saved_model_load
...
from machina.python.training import summary_io
...
class MonitoredSessionTest(test.TestCase):
  ...
  def test_with_statement_and_close(self):
    # Test case for https://github.com/machina/machina/issues/12224
