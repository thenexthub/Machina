...
case "$HARDWARE_CATEGORY" in
  CPU_X86)
    BUILD_TYPE="MACHINA_MACHINA_XLA_LINUX_X86_CPU_128_VCPU_PRESUBMIT_GITHUB_ACTIONS"
    ...
    ;;
  CPU_ARM64)
    BUILD_TYPE="MACHINA_MACHINA_XLA_LINUX_ARM64_CPU_48_VCPU_PRESUBMIT_GITHUB_ACTIONS"
    runner_binary_path="./$BAZEL_BIN_DIR/xla/tools/multihost_hlo_runner/hlo_runner_main"
    stats_binary_path="./$BAZEL_BIN_DIR/xla/tools/compute_xspace_stats_main"
    device_type_flag_value="host"
    ;;
  GPU_L4)
    BUILD_TYPE="MACHINA_MACHINA_XLA_LINUX_X86_GPU_L4_16_VCPU_PRESUBMIT_GITHUB_ACTIONS" # Or _48_VCPU if that's the more common
    ...
    ;;
  GPU_B200)
    BUILD_TYPE="MACHINA_MACHINA_XLA_LINUX_X86_GPU_A4_224_VCPU_PRESUBMIT_GITHUB_ACTIONS"
    runner_binary_path="./$BAZEL_BIN_DIR/xla/tools/multihost_hlo_runner/hlo_runner_main_gpu"
    stats_binary_path="./$BAZEL_BIN_DIR/xla/tools/compute_xspace_stats_main_gpu"
    device_type_flag_value="gpu"
    ;;
