...
#ifndef MACHINA_TSL_PLATFORM_FINGERPRINT_H_
#define MACHINA_TSL_PLATFORM_FINGERPRINT_H_
...
inline uint64_t Fingerprint64(const absl::string_view s) {
  ...
  // LINT.ThenChange(//machina/core/kernels/fingerprint_op.cc)
#endif
}
...
#endif  // MACHINA_TSL_PLATFORM_FINGERPRINT_H_
