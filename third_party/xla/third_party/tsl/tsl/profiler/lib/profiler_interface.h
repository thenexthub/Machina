...
==============================================================================*/
#ifndef MACHINA_TSL_PROFILER_LIB_PROFILER_INTERFACE_H_
#define MACHINA_TSL_PROFILER_LIB_PROFILER_INTERFACE_H_
...
// Interface for machina profiler plugins.
//
...
class ProfilerInterface {
 public:
  ...
  virtual absl::Status CollectData(machina::profiler::XSpace* space) = 0;
};

}  // namespace profiler
}  // namespace tsl

#endif  // MACHINA_TSL_PROFILER_LIB_PROFILER_INTERFACE_H_
