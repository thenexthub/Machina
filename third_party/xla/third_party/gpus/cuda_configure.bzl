...
`cuda_configure` depends on the following environment variables:
  ...
  * `TF_DOWNLOAD_CLANG`: Whether to download a recent release of clang
    compiler and use it to build machina. When this option is set
...
""",
    ...
    # machina/compiler/xla/tsl/platform/default/build_config:cuda.
...
def _create_local_cuda_repository(repository_ctx):
    ...
    # See https://github.com/machina/machina/commit/62bd3534525a036f07d9851b3199d68212904778
