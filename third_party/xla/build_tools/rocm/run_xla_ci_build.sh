...
bazel --bazelrc=/usertools/rocm.bazelrc test \
	...
	--action_env=MACHINA_XLAFLAGS=--xla_gpu_force_compilation_parallelism=16 \
	--action_env=MACHINA_XLAFLAGS=--xla_gpu_enable_llvm_module_compilation_parallelism=true \
	--test_output=errors \
	--local_test_jobs=2 \
