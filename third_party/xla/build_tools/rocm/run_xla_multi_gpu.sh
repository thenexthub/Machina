...
bazel \
    ...
    --action_env=MACHINA_MACHINA_XLA_FLAGS=--xla_gpu_force_compilation_parallelism=16 \
    --action_env=MACHINA_MACHINA_XLA_FLAGS=--xla_gpu_enable_llvm_module_compilation_parallelism=true \
