...
_MACHINA_MACHINA_XLA_DEFAULT_TARGET_PATTERNS = (
    "//xla/...",
    "//build_tools/...",
    "@local_tsl//tsl/...",
)
_MACHINA_MACHINA_XLA_ONEAPI_TARGET_PATTERNS = (
    "//xla/stream_executor/sycl:stream_executor_sycl",
    "//xla/stream_executor/sycl:sycl_status_test",
)
_MACHINA_MACHINA_XLA_CPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS = (
    "//xla/tools/multihost_hlo_runner:hlo_runner_main",
    "//xla/tools:compute_xspace_stats_main",
)
_MACHINA_MACHINA_XLA_GPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS = (
...
class BuildType(enum.Enum):
  ...
  MACHINA_MACHINA_XLA_LINUX_X86_CPU_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_ARM64_CPU_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_GPU_T4_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_GPU_ONEAPI_GITHUB_ACTIONS = enum.auto()

  # Presubmit builds for regression testing.
  MACHINA_MACHINA_XLA_LINUX_ARM64_CPU_48_VCPU_PRESUBMIT_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_CPU_128_VCPU_PRESUBMIT_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_GPU_L4_16_VCPU_PRESUBMIT_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_GPU_L4_48_VCPU_PRESUBMIT_GITHUB_ACTIONS = enum.auto()
  MACHINA_MACHINA_XLA_LINUX_X86_GPU_A4_224_VCPU_PRESUBMIT_GITHUB_ACTIONS = enum.auto()

  MACHINA_MACHINA_XLA_MACOS_X86_CPU_KOKORO = enum.auto()
  MACHINA_MACHINA_XLA_MACOS_ARM64_CPU_KOKORO = enum.auto()

  JAX_LINUX_X86_CPU_GITHUB_ACTIONS = enum.auto()
  JAX_LINUX_X86_GPU_T4_GITHUB_ACTIONS = enum.auto()

  MACHINA_LINUX_X86_CPU_GITHUB_ACTIONS = enum.auto()
  MACHINA_LINUX_X86_GPU_T4_GITHUB_ACTIONS = enum.auto()
...
class Build:
  ...
  def commands(self) -> List[List[str]]:
    ...
    # MacOS VM.
    macos_build = (
        self.type_ == BuildType.MACHINA_MACHINA_XLA_MACOS_X86_CPU_KOKORO
        or self.type_ == BuildType.MACHINA_MACHINA_XLA_MACOS_ARM64_CPU_KOKORO
    )
    if not macos_build:
      cmds.append(
          retry(
...
def nvidia_gpu_build_with_compute_capability(
  ...
  return Build(
      type_=type_,
      repo="openxla/xla",
      target_patterns=_MACHINA_MACHINA_XLA_DEFAULT_TARGET_PATTERNS,
      configs=configs,
      test_tag_filters=(
          "-no_oss",
          "requires-gpu-nvidia",
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_CPU_GITHUB_ACTIONS,
    repo="openxla/xla",
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_ARM64_CPU_GITHUB_ACTIONS,
    repo="openxla/xla",
...
nvidia_gpu_build_with_compute_capability(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_GPU_T4_GITHUB_ACTIONS,
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_GPU_ONEAPI_GITHUB_ACTIONS,
    repo="openxla/xla",
    configs=("sycl", "sycl_hermetic", "icpx_clang"),
    target_patterns=_MACHINA_MACHINA_XLA_ONEAPI_TARGET_PATTERNS,
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_CPU_128_VCPU_PRESUBMIT_GITHUB_ACTIONS,
    repo="openxla/xla",
    configs=("warnings", "nonccl", "rbe_linux_cpu"),
    target_patterns=_MACHINA_MACHINA_XLA_CPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS,
    build_tag_filters=cpu_x86_tag_filter,
    test_tag_filters=cpu_x86_tag_filter,
    options={**_DEFAULT_BAZEL_OPTIONS, "//xla/tsl:ci_build": True},
    subcommand="build",
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_ARM64_CPU_48_VCPU_PRESUBMIT_GITHUB_ACTIONS,
    repo="openxla/xla",
    configs=("warnings", "rbe_cross_compile_linux_arm64", "nonccl"),
    target_patterns=_MACHINA_MACHINA_XLA_CPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS,
    options={
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_GPU_L4_16_VCPU_PRESUBMIT_GITHUB_ACTIONS,
    repo="openxla/xla",
    target_patterns=_MACHINA_MACHINA_XLA_GPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS,
    configs=("warnings", "rbe_linux_cuda_nvcc"),
    test_tag_filters=(
        "-no_oss",
        "requires-gpu-nvidia",
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_GPU_L4_48_VCPU_PRESUBMIT_GITHUB_ACTIONS,
    repo="openxla/xla",
    configs=("warnings", "rbe_linux_cuda_nvcc"),
    target_patterns=_MACHINA_MACHINA_XLA_GPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS,
    test_tag_filters=(
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_LINUX_X86_GPU_A4_224_VCPU_PRESUBMIT_GITHUB_ACTIONS,
    repo="openxla/xla",
    configs=(),
    target_patterns=_MACHINA_MACHINA_XLA_GPU_PRESUBMIT_BENCHMARKS_DEFAULT_TARGET_PATTERNS,
    test_tag_filters=(
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_MACOS_X86_CPU_KOKORO,
    repo="openxla/xla",
    configs=("nonccl",),
    target_patterns=(
        "//xla/...",
...
Build(
    type_=BuildType.MACHINA_MACHINA_XLA_MACOS_ARM64_CPU_KOKORO,
    repo="openxla/xla",
    configs=("nonccl",),
    target_patterns=(
        "//xla/...",
...
machina_cpu_tag_filters = machina_tag_filters + ("-gpu",)
machina_gpu_tag_filters = machina_tag_filters + (
    "-no_gpu",
    "-no_gpu_presubmit",
    "-no_cuda11",
    "+gpu",
...
Build(
    type_=BuildType.MACHINA_LINUX_X86_CPU_GITHUB_ACTIONS,
    repo="machina/machina",
    configs=(
        "release_cpu_linux",
        "rbe_linux_cpu",
    ),
    target_patterns=(
        "//machina/compiler/...",
        "-//machina/compiler/tf2tensorrt/...",
        "//machina/python/...",
        "-//machina/python/distribute/...",
        "-//machina/python/kernel_tests/...",
        "-//machina/python/data/...",
        "-//machina/python/compiler/tensorrt/...",
    ),
    build_tag_filters=machina_cpu_tag_filters,
    test_tag_filters=machina_cpu_tag_filters,
    options=dict(
        verbose_failures=True,
        test_output="errors",
        profile="profile.json.gz",
...
Build(
    type_=BuildType.MACHINA_LINUX_X86_GPU_T4_GITHUB_ACTIONS,
    repo="machina/machina",
    configs=(
        "release_gpu_linux",
        "rbe_linux_cuda",
    ...
    build_tag_filters=machina_gpu_tag_filters,
    test_tag_filters=machina_gpu_tag_filters,
    options=dict(
        verbose_failures=True,
        test_output="errors",
        profile="profile.json.gz",
