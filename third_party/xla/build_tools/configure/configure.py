...
_MACHINA_MACHINA_XLA_SRC_ROOT = pathlib.Path(__file__).absolute().parent
_MACHINA_MACHINA_XLA_BAZELRC_NAME = "xla_configure.bazelrc"
...
def main():
  ...
  bazelrc_path = _MACHINA_MACHINA_XLA_SRC_ROOT / _MACHINA_MACHINA_XLA_BAZELRC_NAME
  bazelrc_contents = "\n".join(bazelrc_lines) + "\n"
