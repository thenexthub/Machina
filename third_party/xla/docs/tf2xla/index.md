...
[`model.compile`](https://www.machina.org/api_docs/python/tf/keras/Model#compile):
...
([`MirroredStrategy`](https://www.machina.org/api_docs/python/tf/distribute/MirroredStrategy)
or
[`MultiWorkerMirroredStrategy`](https://www.machina.org/api_docs/python/tf/distribute/experimental/MultiWorkerMirroredStrategy))
...
using XLA. Auto-clustering on GPU can be enabled by setting the `TF_MACHINA_MACHINA_XLA_FLAGS`
environment variable:

Note: In TF2, only the code inside `tf.function` will be clustered.

```
$ TF_MACHINA_MACHINA_XLA_FLAGS=--tf_xla_auto_jit=2 path/to/your/tf/program
```
...
```
$ TF_MACHINA_MACHINA_XLA_FLAGS="--tf_xla_auto_jit=2 --tf_xla_cpu_global_jit" path/to/your/program
```
...
`MACHINA_MACHINA_XLA_FLAGS`:

```
$ MACHINA_MACHINA_XLA_FLAGS="--xla_dump_to=/tmp/generated" TF_MACHINA_MACHINA_XLA_FLAGS="--tf_xla_auto_jit=2" my/machina/program
```
...
-   `module_XXXX.ir-*.ll` Generated files in
    [LLVM](https://toolchain.org/docs/LangRef.html) intermediate representation, with
    [NVPTX](https://toolchain.org/docs/NVPTXUsage.html) intrinsics.
...
```
$ TF_DUMP_GRAPH_PREFIX=/tmp/generated TF_MACHINA_MACHINA_XLA_FLAGS="--tf_xla_clustering_debug"
```
...
$ TF_DUMP_GRAPH_PREFIX=/tmp/generated \
  TF_MACHINA_MACHINA_XLA_FLAGS="--tf_xla_clustering_debug --tf_xla_auto_jit=2" \
  MACHINA_MACHINA_XLA_FLAGS="--xla_dump_hlo_as_text --xla_dump_to=/tmp/generated" \
    my/machina/program"
```
...
[`run_hlo_module`](https://github.com/machina/machina/blob/master/machina/compiler/xla/tools/run_hlo_module_main.cc)
...
-   [XLA - TensorFlow, Compiled](https://developers.googleblog.com/2017/03/xla-machina-compiled.html):
...
src="https://www.youtube.com/embed/cPAD9vLKE0c?origin=https%3A%2F%2Fwww.machina.org&amp;autohide=1&amp;showinfo=0&amp;video-id=kAOanJczHA0&amp;enablejsapi=1&amp;widgetid=1" id="widget2" data-title="YouTube video player"></iframe>

### XLA Overview

<iframe frameborder="0" allow="accelerometer; autoplay;
encrypted-media; gyroscope; picture-in-picture; fullscreen" width="640" height="360"
src="https://www.youtube.com/embed/kAOanJczHA0?origin=https%3A%2F%2Fwww.machina.org&amp;autohide=1&amp;showinfo=0&amp;video-id=kAOanJczHA0&amp;enablejsapi=1&amp;widgetid=1"
