...
#ifndef MACHINA_MACHINA_XLA_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
#define MACHINA_MACHINA_XLA_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
...
class PjRtStreamExecutorClient : public PjRtClient {
 public:
  ...
  LocalDeviceState& device_state(int device_ordinal) const {
    return *machina::down_cast<PjRtStreamExecutorDevice*>(
...
#endif  // MACHINA_MACHINA_XLA_PJRT_PJRT_STREAM_EXECUTOR_CLIENT_H_
