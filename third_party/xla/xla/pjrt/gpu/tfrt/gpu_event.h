...
#ifndef MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_GPU_EVENT_H_
#define MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_GPU_EVENT_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_GPU_EVENT_H_
