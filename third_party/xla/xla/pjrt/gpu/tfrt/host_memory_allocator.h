...
#ifndef MACHINA_XLAPJRT_GPU_TFRT_HOST_MEMORY_ALLOCATOR_H_
#define MACHINA_XLAPJRT_GPU_TFRT_HOST_MEMORY_ALLOCATOR_H_
...
#endif  // MACHINA_XLAPJRT_GPU_TFRT_HOST_MEMORY_ALLOCATOR_H_
