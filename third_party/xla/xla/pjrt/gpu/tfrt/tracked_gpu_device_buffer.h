...
#ifndef MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_TRACKED_GPU_DEVICE_BUFFER_H_
#define MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_TRACKED_GPU_DEVICE_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_GPU_TFRT_TRACKED_GPU_DEVICE_BUFFER_H_
