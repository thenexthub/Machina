...
TEST(TfrtGpuClientTest, AcquireDonation) {
  ...
  TfrtGpuClient* tfrt_client =
      machina::down_cast<TfrtGpuClient*>(client.get());
  TfrtGpuDevice* device =
      machina::down_cast<TfrtGpuDevice*>(client->devices()[0]);
...
TEST(TfrtGpuClientTest, ShouldStageHostToDeviceTransfersSetToTrue) {
  ...
  auto* staging_client = machina::down_cast<TfrtGpuClient*>(client.get());
...
TEST(TfrtGpuClientTest, DeviceAttributes) {
  ...
  for (int device_index = 0;
    ...
    TfrtGpuDevice* device = machina::down_cast<TfrtGpuDevice*>(
...
TEST(TfrtGpuClientTest, DmaMapUnmap) {
  ...
  auto client = machina::down_cast<TfrtGpuClient*>(gpu_client.get());
