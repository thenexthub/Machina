...
#ifndef MACHINA_MACHINA_XLA_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
...
class StreamExecutorGpuClient : public xla::PjRtStreamExecutorClient {
 public:
  ...
  void UpdateGlobalProcessInfo(
      absl::Span<machina::CoordinatedTaskStateInfo> infos) override;
 ...
 private:
  ...
  std::vector<machina::CoordinatedTaskStateInfo> task_state_infos_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_GPU_SE_GPU_PJRT_CLIENT_H_
