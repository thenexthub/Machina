...
#include "machina/xla/pjrt/cpu/cpu_client.h"
...
#include "machina/xla/backends/cpu/runtime/buffer_allocations.h"
#include "machina/xla/backends/cpu/runtime/thread_pool_task_runner.h"
#include "machina/xla/backends/cpu/runtime/thunk.h"
#include "machina/xla/backends/cpu/runtime/thunk_executor.h"
#include "machina/xla/backends/cpu/runtime/xfeed_manager.h"
...
#include "machina/xla/pjrt/common_pjrt_client.h"
#include "machina/xla/pjrt/cpu/abstract_cpu_buffer.h"
#include "machina/xla/pjrt/cpu/cpu_async_execution_tracker.h"
#include "machina/xla/pjrt/cpu/cpu_device.h"
#include "machina/xla/pjrt/cpu/cpu_event.h"
#include "machina/xla/pjrt/cpu/raw_buffer.h"
#include "machina/xla/pjrt/cpu/tracked_cpu_device_buffer.h"
#include "machina/xla/pjrt/device_event.h"
#include "machina/xla/pjrt/host_callback.h"
#include "machina/xla/pjrt/host_memory_spaces.h"
#include "machina/xla/pjrt/host_to_device_transfer_manager.h"
#include "machina/xla/pjrt/layout_mode.h"
#include "machina/xla/pjrt/mlir_to_hlo.h"
#include "machina/xla/pjrt/pjrt_client.h"
#include "machina/xla/pjrt/pjrt_client_utils.h"
...
#include "machina/xla/pjrt/plugin/xla_cpu/cpu_execute_options.h"
#include "machina/xla/pjrt/plugin/xla_cpu/cpu_topology.h"
#include "machina/xla/pjrt/plugin/xla_cpu/cpu_topology_description.h"
#include "machina/xla/pjrt/proto/compile_options.pb.h"
#include "machina/xla/pjrt/raw_buffer.h"
...
#include "machina/xla/service/cpu/cpu_executable_run_options.h"
#include "machina/xla/service/custom_call_status.h"
#include "machina/xla/service/custom_call_status_internal.h"
...
#include "machina/xla/service/hlo_module_util.h"
    ...
    auto get_buffer = [&](int i) -> absl::Status {
      ...
      if (must_donate) {
        ...
        if (donation_transaction.ok()) {
          tracked_buffer = machina::down_cast<TrackedCpuDeviceBuffer*>(
