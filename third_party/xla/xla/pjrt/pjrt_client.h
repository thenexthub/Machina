...
#ifndef MACHINA_MACHINA_XLA_PJRT_PJRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PJRT_PJRT_CLIENT_H_
...
class PjRtBuffer {
 public:
  ...
  // how machina and xrt setup the output buffer in the graph.
  //
...
#endif  // MACHINA_MACHINA_XLA_PJRT_PJRT_CLIENT_H_
