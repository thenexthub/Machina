...
#include "machina/xla/pjrt/c/pjrt_c_api_gpu.h"
...
#include "machina/xla/pjrt/c/pjrt_c_api_gpu_internal.h"
#include "machina/xla/pjrt/c/pjrt_c_api_helpers.h"
#include "machina/xla/pjrt/c/pjrt_c_api_test.h"
#include "machina/xla/pjrt/c/pjrt_c_api_test_base.h"
...
TEST(PjrtCApiGpuExtensionTest,
  ...
  auto* gpu_client =
      machina::down_cast<xla::StreamExecutorGpuClient*>(cpp_client);
...
TEST(PjrtCApiGpuExtensionTest, CustomCallTyped) {
  ...
  MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kNoop, noop, xla::ffi::Ffi::Bind());
