...
#ifndef MACHINA_XLAPJRT_C_PJRT_C_API_TEST_H_
#define MACHINA_XLAPJRT_C_PJRT_C_API_TEST_H_
...
// machina/compiler/xla/pjrt/c/pjrt_c_api_test.h in the test file will run
// all the tests in this test factory with the PJRT_Api generated by the input
// to  RegisterPjRtCApiTestFactory. See
// machina/compiler/xla/pjrt/c/pjrt_c_api_cpu_test.cc for an example usage
void RegisterPjRtCApiTestFactory(std::function<const PJRT_Api*()> factory,
                                 absl::string_view platform_name);

}  // namespace pjrt

#endif  // MACHINA_XLAPJRT_C_PJRT_C_API_TEST_H_
