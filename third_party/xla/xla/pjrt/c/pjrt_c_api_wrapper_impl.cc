  ...
  auto translate_state = [](PJRT_ProcessState state) {
    switch (state) {
      case PJRT_ProcessState_kUnspecified:
        return machina::CoordinatedTaskState::TASKSTATE_UNSPECIFIED;
      case PJRT_ProcessState_kUninitialized:
        return machina::CoordinatedTaskState::TASKSTATE_UNINITIALIZED;
      case PJRT_ProcessState_kDisconnected:
        return machina::CoordinatedTaskState::TASKSTATE_DISCONNECTED;
      case PJRT_ProcessState_kConnected:
        return machina::CoordinatedTaskState::TASKSTATE_CONNECTED;
      case PJRT_ProcessState_kError:
        return machina::CoordinatedTaskState::TASKSTATE_ERROR;
    }
    LOG(FATAL) << "Unexpected PJRT_ProcessState " << state;
  };

  std::vector<machina::CoordinatedTaskStateInfo> infos;
