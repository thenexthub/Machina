...
absl::StatusOr<mlir::OwningOpRef<mlir::ModuleOp>> ParseMlirModuleString(
  ...
  mlir::OwningOpRef<mlir::ModuleOp> module =
      mlir::parseSourceString<mlir::ModuleOp>(
          toolchain::StringRef(mlir_module_str.data(), mlir_module_str.size()),
...
std::optional<mlir::StringRef> FindPotentiallyUnstableDialects(
  ...
  module->walk([&](mlir::Operation* op) {
    if (!toolchain::isa<mlir::ModuleOp>(op) &&
        !toolchain::isa<mlir::stablehlo::StablehloDialect, mlir::func::FuncDialect,
