...
#ifndef MACHINA_MACHINA_XLA_PJRT_ABSTRACT_TRACKED_DEVICE_BUFFER_H_
#define MACHINA_MACHINA_XLA_PJRT_ABSTRACT_TRACKED_DEVICE_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_ABSTRACT_TRACKED_DEVICE_BUFFER_H_
