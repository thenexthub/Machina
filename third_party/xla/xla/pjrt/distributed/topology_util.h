...
#ifndef MACHINA_MACHINA_XLA_PJRT_DISTRIBUTED_TOPOLOGY_UTIL_H_
#define MACHINA_MACHINA_XLA_PJRT_DISTRIBUTED_TOPOLOGY_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_PJRT_DISTRIBUTED_TOPOLOGY_UTIL_H_
