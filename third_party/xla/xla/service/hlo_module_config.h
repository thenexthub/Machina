...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_CONFIG_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_CONFIG_H_
...
#include "machina/xla/service/schedule_config.h"
#include "machina/xla/service/sharding_config.h"
...
class HloModuleConfig {
 ...
 private:
  ...
  // LINT.ThenChange(//machina/compiler/xla/xla.proto)
};

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_MODULE_CONFIG_H_
