...
#ifndef MACHINA_XLASERVICE_SPMD_SHARDING_FORMAT_PICKER_H_
#define MACHINA_XLASERVICE_SPMD_SHARDING_FORMAT_PICKER_H_
...
#endif  // MACHINA_XLASERVICE_SPMD_SHARDING_FORMAT_PICKER_H_
