...
struct SdyRoundTripExportPipelineOptions
  ...
  Option<bool> keepMeshesInlined{
      *this, "keep-meshes-inlined",
      toolchain::cl::desc("Whether to keep meshes inlined and not lift them."),
