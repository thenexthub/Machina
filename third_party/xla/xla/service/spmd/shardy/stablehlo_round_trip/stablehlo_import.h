...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_STABLEHLO_ROUND_TRIP_STABLEHLO_IMPORT_H_
#define MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_STABLEHLO_ROUND_TRIP_STABLEHLO_IMPORT_H_
...
mlir::sdy::TensorShardingAttr convertToSdySharding(
    ...
    const toolchain::SmallDenseMap<int64_t, mlir::StringRef>&
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_STABLEHLO_ROUND_TRIP_STABLEHLO_IMPORT_H_
