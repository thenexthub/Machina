...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_UTILS_H_
#define MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_UTILS_H_
...
AttrTy parseStringAttr(toolchain::StringRef escapedValue,
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SPMD_SHARDY_UTILS_H_
