...
#ifndef MACHINA_XLASERVICE_SPMD_SHARDY_ROUND_TRIP_COMMON_IMPORT_FUNC_CALLS_H_
#define MACHINA_XLASERVICE_SPMD_SHARDY_ROUND_TRIP_COMMON_IMPORT_FUNC_CALLS_H_
...
#endif  // MACHINA_XLASERVICE_SPMD_SHARDY_ROUND_TRIP_COMMON_IMPORT_FUNC_CALLS_H_
