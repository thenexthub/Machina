...
#ifndef MACHINA_MACHINA_XLA_SERVICE_COMPILATION_ENVIRONMENTS_H_
#define MACHINA_MACHINA_XLA_SERVICE_COMPILATION_ENVIRONMENTS_H_
...
#if TSL_IS_IN_OSS
  return machina::down_cast<T&>(*it->second);
#else
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_COMPILATION_ENVIRONMENTS_H_
