...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
#define MACHINA_MACHINA_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
