...
#ifndef MACHINA_MACHINA_XLA_SERVICE_DOT_AS_CONVOLUTION_UTIL_H_
#define MACHINA_MACHINA_XLA_SERVICE_DOT_AS_CONVOLUTION_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_DOT_AS_CONVOLUTION_UTIL_H_
