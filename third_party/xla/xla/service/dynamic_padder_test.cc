...
#include "machina/xla/tests/xla_test_backend_predicates.h"
...
#include "machina/xla/tests/llvm_irgen_test_base.h"
...
ENTRY main {
  ...
  TF_ASSERT_OK(
      RunPadder(
          ...
          .status());
  MACHINA_MACHINA_XLA_VLOG_LINES(1, module_->ToString());
