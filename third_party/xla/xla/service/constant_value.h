...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CONSTANT_VALUE_H_
#define MACHINA_MACHINA_XLA_SERVICE_CONSTANT_VALUE_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CONSTANT_VALUE_H_
