...
#ifndef MACHINA_XLASERVICE_WHILE_LOOP_CONCAT_CODE_MOTION_H_
#define MACHINA_XLASERVICE_WHILE_LOOP_CONCAT_CODE_MOTION_H_
...
#endif  // MACHINA_XLASERVICE_WHILE_LOOP_CONCAT_CODE_MOTION_H_
