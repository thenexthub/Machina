...
#ifndef MACHINA_MACHINA_XLA_SERVICE_LLVM_COMPILER_H_
#define MACHINA_MACHINA_XLA_SERVICE_LLVM_COMPILER_H_
...
class LLVMCompiler : public Compiler {
 public:
  ...
  // statistics.
  using ModuleHook = std::function<void(const toolchain::Module&)>;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_LLVM_COMPILER_H_
