...
#ifndef MACHINA_XLASERVICE_BUFFER_VALUE_CONTAINERS_H_
#define MACHINA_XLASERVICE_BUFFER_VALUE_CONTAINERS_H_
...
#endif  // MACHINA_XLASERVICE_BUFFER_VALUE_CONTAINERS_H_
