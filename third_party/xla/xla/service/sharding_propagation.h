...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SHARDING_PROPAGATION_H_
#define MACHINA_MACHINA_XLA_SERVICE_SHARDING_PROPAGATION_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SHARDING_PROPAGATION_H_
