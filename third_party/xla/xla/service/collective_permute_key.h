...
#ifndef MACHINA_XLASERVICE_COLLECTIVE_PERMUTE_KEY_H_
#define MACHINA_XLASERVICE_COLLECTIVE_PERMUTE_KEY_H_
...
#endif  // MACHINA_XLASERVICE_COLLECTIVE_PERMUTE_KEY_H_
