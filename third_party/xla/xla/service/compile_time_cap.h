...
#ifndef MACHINA_MACHINA_XLA_SERVICE_COMPILE_TIME_CAP_H_
#define MACHINA_MACHINA_XLA_SERVICE_COMPILE_TIME_CAP_H_
#include <algorithm>
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_COMPILE_TIME_CAP_H_
