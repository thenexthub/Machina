...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
