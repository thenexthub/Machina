...
#ifndef MACHINA_XLASERVICE_REDUCE_SCATTER_DECOMPOSER_H_
#define MACHINA_XLASERVICE_REDUCE_SCATTER_DECOMPOSER_H_
...
#endif  // MACHINA_XLASERVICE_REDUCE_SCATTER_DECOMPOSER_H_
