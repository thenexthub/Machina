...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_NORM_REWRITER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_NORM_REWRITER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_CUDNN_NORM_REWRITER_H_
