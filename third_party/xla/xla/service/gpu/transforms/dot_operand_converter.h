...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_OPERAND_CONVERTER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_OPERAND_CONVERTER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_OPERAND_CONVERTER_H_
