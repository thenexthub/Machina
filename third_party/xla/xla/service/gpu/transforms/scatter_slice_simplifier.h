...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_SLICE_SIMPLIFIER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_SLICE_SIMPLIFIER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_SLICE_SIMPLIFIER_H_
