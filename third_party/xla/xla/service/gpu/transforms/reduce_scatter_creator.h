...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_REDUCE_SCATTER_CREATOR_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_REDUCE_SCATTER_CREATOR_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_REDUCE_SCATTER_CREATOR_H_
