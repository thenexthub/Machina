...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_SANITIZE_CONSTANT_NAMES_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_SANITIZE_CONSTANT_NAMES_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_SANITIZE_CONSTANT_NAMES_H_
