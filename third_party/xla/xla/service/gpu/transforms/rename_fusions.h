...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_RENAME_FUSIONS_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_RENAME_FUSIONS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_RENAME_FUSIONS_H_
