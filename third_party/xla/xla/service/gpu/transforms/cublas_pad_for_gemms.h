...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_CUBLAS_PAD_FOR_GEMMS_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_CUBLAS_PAD_FOR_GEMMS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_CUBLAS_PAD_FOR_GEMMS_H_
