...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_TOPK_SPECIALIZER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_TOPK_SPECIALIZER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_TOPK_SPECIALIZER_H_
