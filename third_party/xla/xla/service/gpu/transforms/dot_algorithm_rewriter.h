...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_ALGORITHM_REWRITER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_ALGORITHM_REWRITER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_DOT_ALGORITHM_REWRITER_H_
