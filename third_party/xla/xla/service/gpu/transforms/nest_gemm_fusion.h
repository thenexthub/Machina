...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_NEST_GEMM_FUSION_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_NEST_GEMM_FUSION_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_NEST_GEMM_FUSION_H_
