...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
