...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_SORT_REWRITER_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_SORT_REWRITER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_TRANSFORMS_SORT_REWRITER_H_
