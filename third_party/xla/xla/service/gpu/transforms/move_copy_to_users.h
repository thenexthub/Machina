...
#ifndef MACHINA_XLASERVICE_GPU_TRANSFORMS_MOVE_COPY_TO_USERS_H_
#define MACHINA_XLASERVICE_GPU_TRANSFORMS_MOVE_COPY_TO_USERS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_TRANSFORMS_MOVE_COPY_TO_USERS_H_
