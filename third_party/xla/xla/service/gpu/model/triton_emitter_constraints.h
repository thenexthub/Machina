...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TRITON_EMITTER_CONSTRAINTS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TRITON_EMITTER_CONSTRAINTS_H_
...
class TritonEmitterConstraints : public EmitterSpecificConstraints {
 ...
 private:
  ...
  explicit TritonEmitterConstraints(
      toolchain::SmallVector<mlir::AffineMap, 4> tile_size_maps,
      toolchain::SmallVector<RootTileInfo, 2> roots,
  ...
  toolchain::SmallVector<mlir::AffineMap, 4> tile_size_maps_;
  ...
  toolchain::SmallVector<RootTileInfo, 2> roots_;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TRITON_EMITTER_CONSTRAINTS_H_
