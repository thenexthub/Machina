...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_EXPR_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_EXPR_H_
...
inline ::toolchain::hash_code hash_value(SymbolicExpr expr) {
  return ::toolchain::hash_value(expr.GetImpl());
}
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_EXPR_H_
