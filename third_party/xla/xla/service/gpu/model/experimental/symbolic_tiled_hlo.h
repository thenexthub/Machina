...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_TILED_HLO_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_TILED_HLO_H_
...
class SymbolicTiledHloInstruction {
 public:
  ...
  toolchain::ArrayRef<const SymbolicTiledHloInstruction*> operands() const {
    return operands_;
  }
 ...
 private:
  ...
  toolchain::SmallVector<const SymbolicTiledHloInstruction*, 2> operands_;
};
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_SYMBOLIC_TILED_HLO_H_
