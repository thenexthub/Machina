...
#include "machina/xla/service/gpu/model/experimental/symbolic_expr.h"
...
int64_t SymbolicExpr::Evaluate(
  ...
  switch (GetType()) {
    ...
    case SymbolicExprType::kMul:
      return lhs_value * rhs_value;
    case SymbolicExprType::kFloorDiv:
      return toolchain::divideFloorSigned(lhs_value, rhs_value);
    case SymbolicExprType::kCeilDiv:
      return toolchain::divideCeilSigned(lhs_value, rhs_value);
    case SymbolicExprType::kMod: {
