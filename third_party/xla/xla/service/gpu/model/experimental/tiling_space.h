...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_TILING_SPACE_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_TILING_SPACE_H_
...
class TilingSpace {
 public:
  ...
  toolchain::ArrayRef<SymbolicTile> tiled_roots() const { return tiled_roots_; }
 ...
 private:
  ...
  toolchain::SmallVector<SymbolicTile, 2> tiled_roots_;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_EXPERIMENTAL_TILING_SPACE_H_
