...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_COALESCING_ANALYSIS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_COALESCING_ANALYSIS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_COALESCING_ANALYSIS_H_
