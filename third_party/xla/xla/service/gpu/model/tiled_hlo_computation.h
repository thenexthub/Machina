...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TILED_HLO_COMPUTATION_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TILED_HLO_COMPUTATION_H_
...
class TiledHloComputation {
 public:
  ...
  toolchain::ArrayRef<int64_t> num_output_tiles_per_dim() const {
 ...
 private:
  ...
  toolchain::SmallVector<int64_t> num_output_tiles_per_dim_;
};

}  // namespace gpu
}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_TILED_HLO_COMPUTATION_H_
