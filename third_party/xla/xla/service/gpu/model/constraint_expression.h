...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_CONSTRAINT_EXPRESSION_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_CONSTRAINT_EXPRESSION_H_
...
class ConstraintExpression {
 ...
 private:
  ...
  friend H AbslHashValue(H h, const Constraint& constraint) {
    toolchain::hash_code expr_hash = mlir::hash_value(constraint.expr);
  ...
  toolchain::SmallVector<ConjointConstraints, 2> disjoint_conjoint_constraints_;
};
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_MODEL_CONSTRAINT_EXPRESSION_H_
