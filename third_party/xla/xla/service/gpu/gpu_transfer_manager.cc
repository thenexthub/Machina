...
#include "machina/xla/service/gpu/gpu_transfer_manager.h"
...
#include "machina/xla/service/gpu/infeed_manager.h"
...
static std::unique_ptr<xla::TransferManager> CreateNVPTXTransferManager() {
  return std::make_unique<xla::gpu::GpuTransferManager>(
      ...
      /*pointer_size=*/toolchain::DataLayout(xla::gpu::nvptx::DataLayout())
...
static std::unique_ptr<xla::TransferManager> CreateAMDGPUTransferManager() {
  return std::make_unique<xla::gpu::GpuTransferManager>(
      ...
      /*pointer_size=*/toolchain::DataLayout(xla::gpu::amdgpu::DataLayout())
          .getPointerSize(0 /* default address space */));
}
...
static std::unique_ptr<xla::TransferManager> CreateSYCLTransferManager() {
  return std::make_unique<xla::gpu::GpuTransferManager>(
      ...
      /*pointer_size=*/toolchain::DataLayout(xla::gpu::spir::DataLayout())
          .getPointerSize(0 /* default address space */));
}
