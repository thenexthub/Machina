...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
...
#include "machina/xla/service/gpu/ir_emission_utils.pb.h"
...
struct TransposeSpec {
  ...
  toolchain::SmallVector<int64_t, 3> permutation;
  toolchain::SmallVector<int64_t, 3> inv_permutation;

  toolchain::SmallVector<int64_t, 3> canonical_output_shape;
  toolchain::SmallVector<int64_t, 3> canonical_permutation;
  toolchain::SmallVector<int64_t, 3> canonical_inv_permutation;
  toolchain::SmallVector<int64_t, 3> canonical_input_shape;
};
...
// Returns the toolchain type for the indices used in the kernel that contains the
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
