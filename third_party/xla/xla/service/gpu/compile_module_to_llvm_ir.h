...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_COMPILE_MODULE_TO_LLVM_IR_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_COMPILE_MODULE_TO_LLVM_IR_H_
...
struct CompileModuleResults {
  ...
  std::unique_ptr<toolchain::Module> llvm_module_constants;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_COMPILE_MODULE_TO_LLVM_IR_H_
