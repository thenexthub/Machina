...
#ifndef MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_LOAD_IR_MODULE_H_
#define MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_LOAD_IR_MODULE_H_
...
#endif  // MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_LOAD_IR_MODULE_H_
