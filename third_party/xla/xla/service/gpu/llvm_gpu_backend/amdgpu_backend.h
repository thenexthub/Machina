...
#ifndef MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_AMDGPU_BACKEND_H_
#define MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_AMDGPU_BACKEND_H_
...
#endif  // MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_AMDGPU_BACKEND_H_
