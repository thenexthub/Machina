...
#ifndef MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
#define MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
