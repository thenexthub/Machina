...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
...
class IrEmitterUnnested : public IrEmitter {
 public:
  ...
  using ValueVector3 = std::array<toolchain::Value*, 3>;
  using ValueVector2 = std::array<toolchain::Value*, 2>;

  using ConstantGenerator = std::function<toolchain::Value*(int64_t)>;
 ...
 private:
  ...
  toolchain::Value* CreateLoad(toolchain::Value* address, toolchain::Type* data_type,
                          int alignment_bytes);
  ...
  //   alignment_bytes: the number of bytes required to align. The number of
  //     bytes of the data_type must be divisible by alignment_bytes.
  void CreateStore(toolchain::Value* data, toolchain::Value* address,
                   int alignment_bytes);
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
