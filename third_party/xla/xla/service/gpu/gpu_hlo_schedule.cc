...
#include "machina/xla/service/gpu/model/analytical_latency_estimator.h"
#include "machina/xla/service/gpu/model/gpu_hlo_cost_analysis.h"
#include "machina/xla/service/gpu/model/sol_latency_estimator.h"
#include "machina/xla/service/gpu/transforms/collectives/async_collective_annotator.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_ops_utils.h"
#include "machina/xla/service/gpu/transforms/pgle_accuracy_checker.h"
#include "machina/xla/service/gpu/transforms/scheduling_instruction_annotator.h"
#include "machina/xla/service/hlo_module_config.h"
#include "machina/xla/service/latency_hiding_scheduler.h"
#include "machina/xla/service/legalize_scheduling_annotations.h"
#include "machina/xla/service/p2p_schedule_preparation.h"
#include "machina/xla/service/profile_guided_latency_estimator.h"
...
using machina::profiler::ProfiledInstructionsProto;
...
ProfiledInstructionsProto FilterWithFingerprint(
  ...
  machina::profiler::ProfiledInstructionsProto merged_result;
...
std::unique_ptr<LatencyEstimator> GetLatencyEstimator(
  ...
  std::optional<machina::profiler::ProfiledInstructionsProto> profile =
