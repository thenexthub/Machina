...
#include "machina/xla/service/gpu/gpu_compiler.h"
...
#include "toolchain/Transforms/Utils/SplitModule.h"
#include "mlir/IR/Diagnostics.h"
#include "mlir/IR/DialectRegistry.h"
#include "mlir/Support/LLVM.h"
#include "machina/xla/backends/gpu/codegen/triton/support.h"
#include "machina/xla/backends/gpu/runtime/sequential_thunk.h"
#include "machina/xla/hlo/analysis/alias_info.h"
#include "machina/xla/hlo/analysis/hlo_dataflow_analysis.h"
...
#include "machina/xla/hlo/ir/hlo_module_group.h"
#include "machina/xla/hlo/ir/hlo_opcode.h"
#include "machina/xla/hlo/ir/hlo_schedule.h"
#include "machina/xla/hlo/pass/hlo_pass_fix.h"
#include "machina/xla/hlo/pass/hlo_pass_pipeline.h"
#include "machina/xla/hlo/transforms/collectives/all_gather_broadcast_reorder.h"
#include "machina/xla/hlo/transforms/collectives/all_gather_remove_degenerate_dims.h"
#include "machina/xla/hlo/transforms/collectives/all_reduce_contiguous.h"
#include "machina/xla/hlo/transforms/collectives/collective_permute_combiner.h"
#include "machina/xla/hlo/transforms/collectives/collective_quantizer.h"
#include "machina/xla/hlo/transforms/collectives/collectives_schedule_linearizer.h"
#include "machina/xla/hlo/transforms/convert_memory_placement_to_internal_annotations.h"
#include "machina/xla/hlo/transforms/expanders/bitcast_dtypes_expander.h"
#include "machina/xla/hlo/transforms/expanders/comparison_expander.h"
#include "machina/xla/hlo/transforms/expanders/convolution_4d_expander.h"
#include "machina/xla/hlo/transforms/expanders/convolution_pred_expander.h"
#include "machina/xla/hlo/transforms/expanders/dot_decomposer.h"
#include "machina/xla/hlo/transforms/expanders/dynamic_index_splitter.h"
#include "machina/xla/hlo/transforms/expanders/eigh_expander.h"
#include "machina/xla/hlo/transforms/expanders/logistic_expander.h"
#include "machina/xla/hlo/transforms/expanders/optimization_barrier_expander.h"
#include "machina/xla/hlo/transforms/expanders/qr_expander.h"
#include "machina/xla/hlo/transforms/expanders/ragged_dot_rewriter.h"
#include "machina/xla/hlo/transforms/expanders/real_imag_expander.h"
#include "machina/xla/hlo/transforms/expanders/reduce_decomposer.h"
#include "machina/xla/hlo/transforms/expanders/reshape_decomposer.h"
#include "machina/xla/hlo/transforms/expanders/rng_bit_generator_expander.h"
#include "machina/xla/hlo/transforms/expanders/rng_expander.h"
#include "machina/xla/hlo/transforms/expanders/stable_sort_expander.h"
#include "machina/xla/hlo/transforms/expanders/stochastic_convert_decomposer.h"
#include "machina/xla/hlo/transforms/host_offload_legalize.h"
#include "machina/xla/hlo/transforms/host_offloader.h"
#include "machina/xla/hlo/transforms/operand_upcaster.h"
#include "machina/xla/hlo/transforms/simplifiers/algebraic_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/all_gather_pad_ds_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/all_gather_permuted_ds_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/all_reduce_folder.h"
#include "machina/xla/hlo/transforms/simplifiers/broadcast_canonicalizer.h"
#include "machina/xla/hlo/transforms/simplifiers/conditional_canonicalizer.h"
#include "machina/xla/hlo/transforms/simplifiers/convert_mover.h"
#include "machina/xla/hlo/transforms/simplifiers/dot_merger.h"
#include "machina/xla/hlo/transforms/simplifiers/dynamic_dimension_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/flatten_call_graph.h"
#include "machina/xla/hlo/transforms/simplifiers/float_normalization.h"
#include "machina/xla/hlo/transforms/simplifiers/gather_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_computation_deduplicator.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_constant_folding.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_dce.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_rematerialization.h"
#include "machina/xla/hlo/transforms/simplifiers/host_memory_transfer_asyncifier.h"
#include "machina/xla/hlo/transforms/simplifiers/optimize_input_output_buffer_alias.h"
#include "machina/xla/hlo/transforms/simplifiers/reduce_window_rewriter.h"
#include "machina/xla/hlo/transforms/simplifiers/reshape_mover.h"
#include "machina/xla/hlo/transforms/simplifiers/result_caster.h"
#include "machina/xla/hlo/transforms/simplifiers/simplify_fp_conversions.h"
#include "machina/xla/hlo/transforms/simplifiers/slice_sinker.h"
#include "machina/xla/hlo/transforms/simplifiers/sort_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/sub_byte_normalization.h"
#include "machina/xla/hlo/transforms/simplifiers/tuple_simplifier.h"
#include "machina/xla/hlo/transforms/simplifiers/zero_sized_hlo_elimination.h"
#include "machina/xla/hlo/transforms/while_loop_trip_count_annotator.h"
#include "machina/xla/hlo/utils/hlo_traversal.h"
#include "machina/xla/maybe_owning.h"
#include "machina/xla/service/all_reduce_promotion.h"
#include "machina/xla/service/all_reduce_reassociate.h"
#include "machina/xla/service/all_reduce_simplifier.h"
#include "machina/xla/service/batched_gather_scatter_normalizer.h"
#include "machina/xla/service/batchnorm_expander.h"
#include "machina/xla/service/buffer_assignment.h"
#include "machina/xla/service/call_inliner.h"
#include "machina/xla/service/collective_ops_utils.h"
#include "machina/xla/service/collective_permute_decomposer.h"
#include "machina/xla/service/collective_pipeliner.h"
#include "machina/xla/service/collective_pipeliner_utils.h"
#include "machina/xla/service/collective_utils.h"
#include "machina/xla/service/compiler.h"
#include "machina/xla/service/conditional_simplifier.h"
#include "machina/xla/service/copy_insertion.h"
#include "machina/xla/service/cpu_gpu_shape_verifier.h"
#include "machina/xla/service/dump.h"
#include "machina/xla/service/dynamic_dimension_inference.h"
#include "machina/xla/service/dynamic_padder.h"
#include "machina/xla/service/executable.h"
#include "machina/xla/service/export_hlo.h"
#include "machina/xla/service/float_support.h"
#include "machina/xla/service/gather_expander.h"
#include "machina/xla/service/gpu/alias_info.h"
#include "machina/xla/service/gpu/autotuning/autotuner_util.h"
#include "machina/xla/service/gpu/autotuning/custom_kernel_fusion_autotuner.h"
#include "machina/xla/service/gpu/compile_module_to_llvm_ir.h"
#include "machina/xla/service/gpu/conv_layout_normalization.h"
#include "machina/xla/service/gpu/cublas_cudnn.h"
#include "machina/xla/service/gpu/execution_stream_assignment.h"
#include "machina/xla/service/gpu/flag_utils.h"
#include "machina/xla/service/gpu/fusion_dispatch_pipeline.h"
#include "machina/xla/service/gpu/fusion_pipeline.h"
#include "machina/xla/service/gpu/gpu_executable.h"
#include "machina/xla/service/gpu/gpu_float_support.h"
#include "machina/xla/service/gpu/gpu_hlo_schedule.h"
#include "machina/xla/service/gpu/gpu_latency_hiding_scheduler.h"
#include "machina/xla/service/gpu/gpu_spmd_pipeline.h"
#include "machina/xla/service/gpu/hlo_fusion_stats.h"
#include "machina/xla/service/gpu/ir_emission_utils.h"
#include "machina/xla/service/gpu/ir_emitter_context.h"
#include "machina/xla/service/gpu/ir_emitter_unnested.h"
#include "machina/xla/service/gpu/kernel_reuse_cache.h"
#include "machina/xla/service/gpu/matmul_utils.h"
#include "machina/xla/service/gpu/metrics.h"
#include "machina/xla/service/gpu/model/collective_ptable_stats_collection.h"
#include "machina/xla/service/gpu/model/gpu_cost_model_stats_collection.h"
#include "machina/xla/service/gpu/model/gpu_hlo_cost_analysis.h"
#include "machina/xla/service/gpu/model/matmul_ptable_stats_collection.h"
#include "machina/xla/service/gpu/model/sol_gpu_cost_model_stats_collection.h"
#include "machina/xla/service/gpu/pre_scheduling_copy_insertion_pipeline.h"
#include "machina/xla/service/gpu/reduction_utils.h"
#include "machina/xla/service/gpu/runtime_intrinsics.h"
#include "machina/xla/service/gpu/stream_executor_util.h"
#include "machina/xla/service/gpu/transforms/add_tracking_suffix_to_instruction_names.h"
#include "machina/xla/service/gpu/transforms/algebraic_simplifier.h"
#include "machina/xla/service/gpu/transforms/algorithm_checker.h"
#include "machina/xla/service/gpu/transforms/async_wrapper.h"
#include "machina/xla/service/gpu/transforms/collectives/all_gather_combiner.h"
#include "machina/xla/service/gpu/transforms/collectives/all_gather_dynamic_slice_simplifier.h"
#include "machina/xla/service/gpu/transforms/collectives/all_gather_optimizer.h"
#include "machina/xla/service/gpu/transforms/collectives/all_reduce_blueconnect.h"
#include "machina/xla/service/gpu/transforms/collectives/all_reduce_combiner.h"
#include "machina/xla/service/gpu/transforms/collectives/all_reduce_decomposer.h"
#include "machina/xla/service/gpu/transforms/collectives/all_reduce_splitter.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_backend_assigner.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_combiner_annotator.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_ops_utils.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_permute_cycle_decomposer.h"
#include "machina/xla/service/gpu/transforms/collectives/collective_pipelining_analyzer.h"
#include "machina/xla/service/gpu/transforms/collectives/convert_async_collectives_to_sync.h"
#include "machina/xla/service/gpu/transforms/collectives/gpu_collective_combiner_utils.h"
#include "machina/xla/service/gpu/transforms/collectives/reduce_scatter_combiner.h"
#include "machina/xla/service/gpu/transforms/command_buffer_conversion_pass.h"
#include "machina/xla/service/gpu/transforms/command_buffer_scheduling.h"
#include "machina/xla/service/gpu/transforms/conv_rewriter.h"
#include "machina/xla/service/gpu/transforms/cudnn_custom_call_converter.h"
#include "machina/xla/service/gpu/transforms/custom_kernel_fusion_rewriter.h"
#include "machina/xla/service/gpu/transforms/dot_algorithm_rewriter.h"
#include "machina/xla/service/gpu/transforms/dot_dimension_sorter.h"
#include "machina/xla/service/gpu/transforms/dot_normalizer.h"
#include "machina/xla/service/gpu/transforms/dot_operand_converter.h"
#include "machina/xla/service/gpu/transforms/dot_strength_reduction.h"
#include "machina/xla/service/gpu/transforms/double_buffer_loop_unrolling.h"
#include "machina/xla/service/gpu/transforms/dynamic_slice_fusion_rewriter.h"
#include "machina/xla/service/gpu/transforms/explicit_collectives_group_async_wrapper.h"
#include "machina/xla/service/gpu/transforms/explicit_stream_annotation_async_wrapper.h"
#include "machina/xla/service/gpu/transforms/fusion_wrapper.h"
#include "machina/xla/service/gpu/transforms/gemm_broadcast_folding_rewriter.h"
#include "machina/xla/service/gpu/transforms/gemm_fusion.h"
#include "machina/xla/service/gpu/transforms/gemm_fusion_swap_operands.h"
#include "machina/xla/service/gpu/transforms/gemm_rewriter.h"
#include "machina/xla/service/gpu/transforms/gemv_rewriter.h"
#include "machina/xla/service/gpu/transforms/layout_assignment.h"
#include "machina/xla/service/gpu/transforms/move_copy_to_users.h"
#include "machina/xla/service/gpu/transforms/nest_gemm_fusion.h"
#include "machina/xla/service/gpu/transforms/ragged_all_to_all_canonicalizer.h"
#include "machina/xla/service/gpu/transforms/ragged_all_to_all_decomposer.h"
#include "machina/xla/service/gpu/transforms/reduce_scatter_creator.h"
#include "machina/xla/service/gpu/transforms/reduction_degenerate_dim_remover.h"
#include "machina/xla/service/gpu/transforms/reduction_dimension_grouper.h"
#include "machina/xla/service/gpu/transforms/reduction_layout_normalizer.h"
#include "machina/xla/service/gpu/transforms/reduction_splitter.h"
#include "machina/xla/service/gpu/transforms/rename_fusions.h"
#include "machina/xla/service/gpu/transforms/sanitize_constant_names.h"
#include "machina/xla/service/gpu/transforms/scalar_constant_sinker.h"
#include "machina/xla/service/gpu/transforms/scatter_expander.h"
#include "machina/xla/service/gpu/transforms/scatter_slice_simplifier.h"
#include "machina/xla/service/gpu/transforms/softmax_rewriter_triton.h"
#include "machina/xla/service/gpu/transforms/sort_rewriter.h"
#include "machina/xla/service/gpu/transforms/splitk_rewriter.h"
#include "machina/xla/service/gpu/transforms/stream_attribute_annotator.h"
#include "machina/xla/service/gpu/transforms/stream_attribute_async_wrapper.h"
#include "machina/xla/service/gpu/transforms/thunk_pass_pipeline.h"
#include "machina/xla/service/gpu/transforms/topk_specializer.h"
#include "machina/xla/service/gpu/transforms/topk_splitter.h"
#include "machina/xla/service/gpu/transforms/transpose_dimension_grouper.h"
#include "machina/xla/service/gpu/transforms/tree_reduction_rewriter.h"
#include "machina/xla/service/gpu/transforms/triton_fusion_numerics_verifier.h"
#include "machina/xla/service/gpu/transforms/windowed_einsum_handler.h"
#include "machina/xla/service/hlo.pb.h"
#include "machina/xla/service/hlo_cost_analysis.h"
#include "machina/xla/service/hlo_cse.h"
#include "machina/xla/service/hlo_module_config.h"
#include "machina/xla/service/hlo_value.h"
#include "machina/xla/service/hlo_verifier.h"
#include "machina/xla/service/layout_assignment.h"
#include "machina/xla/service/layout_normalization.h"
#include "machina/xla/service/llvm_ir/llvm_command_line_options.h"
#include "machina/xla/service/llvm_ir/llvm_util.h"
#include "machina/xla/service/reduce_scatter_reassociate.h"
#include "machina/xla/service/scatter_determinism_expander.h"
#include "machina/xla/service/scatter_expander.h"
#include "machina/xla/service/scatter_simplifier.h"
#include "machina/xla/service/select_and_scatter_expander.h"
#include "machina/xla/service/sharding_remover.h"
#include "machina/xla/service/slow_operation_alarm.h"
#include "machina/xla/service/spmd/schedule_aware_collective_ops_cse.h"
#include "machina/xla/service/spmd/shardy/shardy_xla_pass.h"
#include "machina/xla/service/topk_rewriter.h"
#include "machina/xla/service/transpose_folding.h"
#include "machina/xla/service/while_loop_all_reduce_code_motion.h"
#include "machina/xla/service/while_loop_constant_sinking.h"
#include "machina/xla/service/while_loop_simplifier.h"
#include "machina/xla/shape.h"
#include "machina/xla/shape_util.h"
#include "machina/xla/status_macros.h"
#include "machina/xla/stream_executor/cuda/cuda_compute_capability.h"
#include "machina/xla/stream_executor/device_description.h"
#include "machina/xla/stream_executor/device_description.pb.h"
...
#include "machina/xla/hlo/experimental/auto_sharding/auto_sharding.h"
#include "machina/xla/hlo/experimental/auto_sharding/auto_sharding_option.h"
#include "machina/xla/hlo/experimental/auto_sharding/auto_sharding_stablehlo_pass.h"
...
GpuThunkAotCompilationResult::LoadExecutable(
  ...
  auto llvm_module = std::make_unique<toolchain::Module>("", llvm_context);
  llvm_module->setTargetTriple(toolchain::Triple(gpu_compiler->target_triple()));
...
GpuCompiler::GpuCompiler(se::Platform::Id platform_id,
    ...
    : platform_id_(platform_id),
      ...
      pointer_size_(toolchain::DataLayout(data_layout)
...
void LogDebugOptions(HloModule* hlo_module) {
  ...
  // `debug_option_flags.cc`, and it is overridden by MACHINA_MACHINA_XLA_FLAGS to false, we
  // will not see it in the DebugString(). So, we print all the fields.
  if (VLOG_IS_ON(1)) {
    MACHINA_MACHINA_XLA_VLOG_LINES(
        1,
...
absl::StatusOr<std::unique_ptr<HloModule>> GpuCompiler::RunHloPasses(
  ...
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_IF(
...
static void NullDiagnosticHandler(const toolchain::DiagnosticInfo* diag_info,
                                  void* context) {
  std::string error_string;
  toolchain::raw_string_ostream string_printer(error_string);
  toolchain::DiagnosticPrinterRawOStream diagnostic_printer(string_printer);
...
std::unique_ptr<toolchain::Module> CopyToContext(const toolchain::Module& module,
                                            toolchain::LLVMContext& context) {
  // We are setting toolchain::SmallString's InternalLen to 0, because we want to
  // allocate its buffer on the heap. We use toolchain::SmallString instead of
  // std::string, because toolchain::raw_svector_ostream is a bit faster than
  // toolchain::raw_string_ostream.
  toolchain::SmallString<0> bitcode;
  toolchain::raw_svector_ostream bitcode_ostream(bitcode);
  toolchain::WriteBitcodeToFile(module, bitcode_ostream);

  toolchain::Expected<std::unique_ptr<toolchain::Module>> new_module =
      toolchain::parseBitcodeFile(
          toolchain::MemoryBufferRef(toolchain::StringRef(bitcode.data(), bitcode.size()),
                                "split_module"),
          context);
  CHECK(new_module) << "Failed to parse bitcode "
                    << toolchain::toString(new_module.takeError());
...
GpuCompiler::CompileSingleModule(
    ...
    const HloModule* debug_module, toolchain::Module* llvm_module, bool relocatable,
  ...
  tsl::profiler::TraceMe traceme("CompileSingleModule");
  {
    ...
    std::string err;
    toolchain::raw_string_ostream err_stream(err);

    // verifyModule() returns true if the module is broken.
    TF_RET_CHECK(!toolchain::verifyModule(*llvm_module, &err_stream))
...
namespace {
int CountFunctions(const toolchain::Module& module) {
  int num_functions = 0;
  for (const toolchain::Function& func : module.functions()) {
    if (!func.isDeclaration() &&
        func.getLinkage() == toolchain::GlobalValue::LinkageTypes::ExternalLinkage) {
      ++num_functions;
    }
  }
...
std::string SingleFunctionName(const toolchain::Module& module) {
  std::string name;
  for (const toolchain::Function& func : module.functions()) {
    if (!func.isDeclaration() &&
        func.getLinkage() == toolchain::GlobalValue::LinkageTypes::ExternalLinkage) {
...
absl::StatusOr<GpuCompiler::BackendCompileResult> GpuCompiler::CompileAndLink(
  ...
  toolchain::Module* llvm_module = &*compile_module_results.llvm_module;

  bool force_module_split =
      module_config.debug_options().xla_llvm_force_inline_before_split();
  if (force_module_split) {
    for (toolchain::Function& func : llvm_module->functions()) {
      if (func.getNumUses() > 0 && !func.isDeclaration()) {
        ...
        for (auto* call_to_inline : calls_to_inline) {
          ...
          if (!toolchain::InlineFunction(*call_to_inline, inline_function_info)
                   .isSuccess()) {
  ...
  // to ensure constant-folding works properly after calling toolchain::SplitModule.
  toolchain::DenseMap<toolchain::StringRef, toolchain::Constant*> const_initializer_map;
  toolchain::Module& module_with_constants =
      (compile_module_results.llvm_module_constants == nullptr)
          ? *llvm_module
          : *compile_module_results.llvm_module_constants;
  for (toolchain::GlobalVariable& gv : module_with_constants.globals()) {
    if (gv.hasName() && gv.isConstant() && gv.hasInitializer() &&
        gv.hasExternalLinkage()) {
      toolchain::Constant* initializer = gv.getInitializer();
      unsigned int num_elements = 0;
      if (auto* caz =
              toolchain::dyn_cast<toolchain::ConstantAggregateZero>(initializer)) {
        num_elements = caz->getElementCount().getFixedValue();
      } else if (auto* cds = toolchain::dyn_cast<toolchain::ConstantDataSequential>(
                     initializer)) {
      ...
      thread_pool.get_mutable()->Schedule(
          [&compile_results, i, &llvm_modules, &counter, this, &module_config,
           &device_description, &debug_module, &options] {
            ...
            toolchain::LLVMContext new_context;
            std::unique_ptr<toolchain::Module> new_module =
  ...
  if (!maybe_backend_result.ok()) {
    LOG(ERROR) << "The CUDA linking API did not work. Please use MACHINA_MACHINA_XLA_FLAGS="
...
GpuCompiler::CompileToBackendResult(
    HloModule* module, toolchain::LLVMContext* llvm_context,
...

  {
    ...
    // Compile the module to thnks and toolchain IR.
    TF_ASSIGN_OR_RETURN(
...
absl::StatusOr<std::unique_ptr<AotCompilationResult>> GpuCompiler::Export(
  ...
  auto* gpu_executable = machina::down_cast<GpuExecutable*>(executable);
