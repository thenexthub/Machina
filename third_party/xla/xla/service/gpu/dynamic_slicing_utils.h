...
#ifndef MACHINA_XLASERVICE_GPU_DYNAMIC_SLICING_UTILS_H_
#define MACHINA_XLASERVICE_GPU_DYNAMIC_SLICING_UTILS_H_
...
#endif  // MACHINA_XLASERVICE_GPU_DYNAMIC_SLICING_UTILS_H_
