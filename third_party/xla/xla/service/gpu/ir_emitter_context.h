...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_CONTEXT_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_CONTEXT_H_
...
class IrEmitterContext {
 public:
  IrEmitterContext(const HloModule* hlo_module,
                   ...
                   mlir::MLIRContext* mlir_context, toolchain::Module* llvm_module,
                   toolchain::Module* llvm_module_constants, bool emit_kernels)
  ...
  toolchain::Module* llvm_module() { return llvm_module_; }
  // A separate module can optionally be used to emit constants.
  toolchain::Module* llvm_module_constants() {
  ...
  void emit_constant(int64_t num_elements, int64_t bytes_per_element,
                     ...
                     DenseDataIntermediate content, toolchain::IRBuilderBase* b);
 ...
 private:
  ...
  toolchain::Module* llvm_module_constants_;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_IR_EMITTER_CONTEXT_H_
