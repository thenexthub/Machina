...
#include "machina/xla/service/gpu/nvptx_compiler.h"
...
#include "machina/xla/backends/gpu/autotuner/factory.h"
...
#include "machina/xla/pjrt/distributed/key_value_store_interface.h"
...
#include "machina/xla/service/gpu/autotuning/autotuner_pass.h"
#include "machina/xla/service/gpu/autotuning/autotuner_util.h"
#include "machina/xla/service/gpu/autotuning/conv_algorithm_picker.h"
#include "machina/xla/service/gpu/autotuning/gemm_algorithm_picker.h"
#include "machina/xla/service/gpu/autotuning/gemm_fusion_autotuner.h"
#include "machina/xla/service/gpu/cublas_padding_requirements.h"
#include "machina/xla/service/gpu/gpu_compiler.h"
#include "machina/xla/service/gpu/ir_emission_utils.h"
#include "machina/xla/service/gpu/llvm_gpu_backend/nvptx_backend.h"
#include "machina/xla/service/gpu/llvm_gpu_backend/nvptx_utils.h"
#include "machina/xla/service/gpu/metrics.h"
#include "machina/xla/service/gpu/nvptx_alias_info.h"
#include "machina/xla/service/gpu/ptx_compile_options_from_debug_options.h"
#include "machina/xla/service/gpu/target_constants.h"
#include "machina/xla/service/gpu/transforms/algebraic_simplifier.h"
#include "machina/xla/service/gpu/transforms/block_scaling_rewriter.h"
#include "machina/xla/service/gpu/transforms/conv_padding_legalization.h"
#include "machina/xla/service/gpu/transforms/conv_rewriter.h"
#include "machina/xla/service/gpu/transforms/cublas_pad_for_gemms.h"
#include "machina/xla/service/gpu/transforms/cudnn_custom_call_compiler.h"
#include "machina/xla/service/gpu/transforms/cudnn_fused_conv_rewriter.h"
#include "machina/xla/service/gpu/transforms/cudnn_fusion_compiler.h"
#include "machina/xla/service/gpu/transforms/cudnn_norm_rewriter.h"
#include "machina/xla/service/gpu/transforms/cudnn_pad_for_convolutions.h"
#include "machina/xla/service/gpu/transforms/cudnn_simplify_padding.h"
#include "machina/xla/service/gpu/transforms/cudnn_vectorize_convolutions.h"
#include "machina/xla/service/gpu/transforms/gpusolver_rewriter.h"
#include "machina/xla/service/gpu/transforms/triangular_solve_rewriter.h"
...
#include "machina/xla/stream_executor/cuda/assemble_compilation_provider.h"
#include "machina/xla/stream_executor/cuda/compilation_options.h"
#include "machina/xla/stream_executor/cuda/compilation_provider.h"
#include "machina/xla/stream_executor/cuda/compilation_provider_options.h"
#include "machina/xla/stream_executor/cuda/cuda_compute_capability.h"
#include "machina/xla/stream_executor/cuda/cuda_diagnostics.h"
#include "machina/xla/stream_executor/cuda/cuda_platform_id.h"
#include "machina/xla/stream_executor/cuda/cuda_solver_context.h"
...
// successful, return the toolchain::Module, otherwise return nullptr.
std::unique_ptr<toolchain::Module> MaybeLoadLLVMFromFile(const HloModule* module,
  ...
  if (matched_filename != std::end(xla_gpu_llvm_ir_file)) {
    ...
    std::unique_ptr<toolchain::Module> loaded_module =
        toolchain::parseIRFile(*matched_filename, err, context);

    if (!loaded_module) {
      err.print("ERR", toolchain::errs());
...
NVPTXCompiler::CompileTargetBinary(
  ...
  toolchain::Module* selected_module = nullptr;
  if (loaded_module) {
