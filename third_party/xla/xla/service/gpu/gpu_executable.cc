...
#include "machina/xla/service/gpu/resource_requests.h"
...
#include "machina/xla/service/rendezvous.h"
...
#include "machina/xla/service/xla_debug_info_manager.h"
...
#include "machina/xla/stream_executor/scoped_module_handle.h"
#include "machina/xla/stream_executor/stream.h"
#include "machina/xla/stream_executor/stream_executor.h"
#include "machina/xla/stream_executor/sycl/sycl_platform_id.h"
  ...
  for (auto& p : result.MutableResult()->buffers()) {
    ...
    if (output_info.alias_config) {
      ...
      if (maybe_owning_memory && maybe_owning_memory->HasOwnership()) {
        std::optional<machina::se::OwningDeviceMemory> owning =
