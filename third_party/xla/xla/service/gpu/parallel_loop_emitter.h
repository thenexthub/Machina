...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_PARALLEL_LOOP_EMITTER_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_PARALLEL_LOOP_EMITTER_H_
...
class ParallelLoopEmitter {
 ...
 private:
  struct LinearBaseAndThreadIdx {
    toolchain::Value* linear_base;
    toolchain::Value* thread_idx;
  };

  LinearBaseAndThreadIdx EmitLinearBaseAndThreadIdx(toolchain::Type* index_type,
                                                    toolchain::Value* base_index);
  absl::Status EmitSerialLoop(absl::string_view loop_name,
                              toolchain::Type* index_type,
                              toolchain::Value* base_indvar = nullptr);
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_PARALLEL_LOOP_EMITTER_H_
