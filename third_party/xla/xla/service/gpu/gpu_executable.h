...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
...
#include "machina/xla/service/gpu/gpu_executable.pb.h"
...
class GpuExecutable : public Executable {
 ...
 private:
  ...
  // this GpuExecutable. We save a string instead of an toolchain::Module* because
  // leaving toolchain::Module* in a singleton can cause the heap checker to emit
  // false positives.
  //
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
