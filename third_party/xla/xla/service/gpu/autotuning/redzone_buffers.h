...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_AUTOTUNING_REDZONE_BUFFERS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_AUTOTUNING_REDZONE_BUFFERS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_AUTOTUNING_REDZONE_BUFFERS_H_
