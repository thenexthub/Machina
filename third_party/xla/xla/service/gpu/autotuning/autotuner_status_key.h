...
#ifndef MACHINA_XLASERVICE_GPU_AUTOTUNING_AUTOTUNER_STATUS_KEY_H_
#define MACHINA_XLASERVICE_GPU_AUTOTUNING_AUTOTUNER_STATUS_KEY_H_
...
#endif  // MACHINA_XLASERVICE_GPU_AUTOTUNING_AUTOTUNER_STATUS_KEY_H_
