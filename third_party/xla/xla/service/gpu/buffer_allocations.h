...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_BUFFER_ALLOCATIONS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_BUFFER_ALLOCATIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_BUFFER_ALLOCATIONS_H_
