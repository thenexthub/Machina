...
#ifndef MACHINA_XLASERVICE_GPU_TESTS_GPU_CODEGEN_TEST_H_
#define MACHINA_XLASERVICE_GPU_TESTS_GPU_CODEGEN_TEST_H_
...
class GpuCodegenTest : public LlvmIrGenTestBase {
 ...
 protected:
  ...
  // FileCheck pattern.  (See http://toolchain.org/docs/CommandGuide/FileCheck.html).
...
#endif  // MACHINA_XLASERVICE_GPU_TESTS_GPU_CODEGEN_TEST_H_
