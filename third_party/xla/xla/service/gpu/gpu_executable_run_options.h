...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_RUN_OPTIONS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_RUN_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_EXECUTABLE_RUN_OPTIONS_H_
