...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_COMPILER_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_COMPILER_H_
...
class GpuCompiler : public LLVMCompiler {
 ...
 private:
  ...
  absl::StatusOr<BackendCompileResult> CompileSingleModule(
      const HloModuleConfig& module_config,
      const stream_executor::DeviceDescription& device_description,
      const HloModule* debug_module, toolchain::Module* llvm_module,
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_GPU_COMPILER_H_
