...
#ifndef MACHINA_XLASERVICE_GPU_FUSION_DISPATCH_PIPELINE_H_
#define MACHINA_XLASERVICE_GPU_FUSION_DISPATCH_PIPELINE_H_
...
#endif  // MACHINA_XLASERVICE_GPU_FUSION_DISPATCH_PIPELINE_H_
