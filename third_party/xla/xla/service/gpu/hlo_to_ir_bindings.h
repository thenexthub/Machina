...
#ifndef MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
#define MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
...
class HloToIrBindings {
 public:
  HloToIrBindings(toolchain::IRBuilderBase* b, toolchain::Module* llvm_module,
                  bool is_nested)
  ...
  void BindHloToIrValue(const HloInstruction& hlo, toolchain::Value* ir_value,
  ...
  toolchain::Value* GetBasePointer(const HloInstruction& hlo,
 ...
 private:
  ...
  // Stores the underlying toolchain::IrArray for each HloInstruction.
  ...
  // in the ShapeTree.
  absl::flat_hash_map<const HloInstruction*, ShapeTree<toolchain::Value*>>
      base_ptrs_;
};
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
