...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_UNSTACKER_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_UNSTACKER_H_
...
// dynamic-slice: `machina/compiler/xla/service/while_loop_unroller.h`)
//
//   +-while----------------------------------------------------+
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_UNSTACKER_H_
