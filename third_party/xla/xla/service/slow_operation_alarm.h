...
#ifndef MACHINA_MACHINA_XLA_SERVICE_SLOW_OPERATION_ALARM_H_
#define MACHINA_MACHINA_XLA_SERVICE_SLOW_OPERATION_ALARM_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_SLOW_OPERATION_ALARM_H_
