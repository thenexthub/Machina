...
#ifndef MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_MAP_H_
#define MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_MAP_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_HLO_DOMAIN_MAP_H_
