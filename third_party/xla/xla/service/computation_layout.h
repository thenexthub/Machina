...
#ifndef MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_LAYOUT_H_
#define MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_LAYOUT_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_LAYOUT_H_
