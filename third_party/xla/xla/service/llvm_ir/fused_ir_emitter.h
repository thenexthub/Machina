...
#ifndef MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_FUSED_IR_EMITTER_H_
#define MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_FUSED_IR_EMITTER_H_
...
class FusedIrEmitter {
 ...
 private:
  ...
  using ValueCacheKey =
      std::pair<const HloInstruction*, std::vector<toolchain::Value*>>;
  absl::flat_hash_map<ValueCacheKey, toolchain::Value*> value_cache_;
};

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_SERVICE_LLVM_IR_FUSED_IR_EMITTER_H_
