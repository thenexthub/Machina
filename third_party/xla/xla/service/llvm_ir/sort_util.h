...
#ifndef MACHINA_XLASERVICE_LLVM_IR_SORT_UTIL_H_
#define MACHINA_XLASERVICE_LLVM_IR_SORT_UTIL_H_
...
using EmitCallToNestedComputationCallback =
    std::function<absl::Status(absl::Span<toolchain::Value* const>, toolchain::Value*)>;
// Emits toolchain IR to do pairwise comparisons/swaps in the 'dimension_to_sort'
...
#endif  // MACHINA_XLASERVICE_LLVM_IR_SORT_UTIL_H_
