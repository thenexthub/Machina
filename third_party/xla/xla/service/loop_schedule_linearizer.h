...
#ifndef MACHINA_XLASERVICE_LOOP_SCHEDULE_LINEARIZER_H_
#define MACHINA_XLASERVICE_LOOP_SCHEDULE_LINEARIZER_H_
...
#endif  // MACHINA_XLASERVICE_LOOP_SCHEDULE_LINEARIZER_H_
