...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
#define MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
...
#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_CONCAT(a, b) a##b

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM_HELPER(symbol, address,   \
                                                        platform, counter) \
  static ::xla::RegisterCustomCallTarget MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_CONCAT(  \
      custom_call_target_register, counter)(                               \
      symbol, reinterpret_cast<void*>(address), platform)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET(function, platform) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(#function, function, platform)

#define MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(symbol, address, platform)  \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM_HELPER(symbol, address, platform, \
                                                  __COUNTER__)

// Convenience overloads for registering custom-call targets on the CPU.
#define MACHINA_MACHINA_XLA_CPU_REGISTER_CUSTOM_CALL_TARGET(function) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(#function, function, "Host")

#define MACHINA_MACHINA_XLA_CPU_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(symbol, address) \
  MACHINA_MACHINA_XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM(symbol, address, "Host")

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
