...
#ifndef MACHINA_MACHINA_XLA_SERVICE_COST_MODELLING_OP_COST_H_
#define MACHINA_MACHINA_XLA_SERVICE_COST_MODELLING_OP_COST_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_COST_MODELLING_OP_COST_H_
