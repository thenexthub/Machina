...
#ifndef MACHINA_MACHINA_XLA_SERVICE_PATTERN_MATCHER_H_
#define MACHINA_MACHINA_XLA_SERVICE_PATTERN_MATCHER_H_
...
#include "machina/xla/hlo/ir/ptrvec.h"
...
#define MACHINA_MACHINA_XLA_NULLOP_PATTERN(NAME)                                     \
...
MACHINA_MACHINA_XLA_NULLOP_PATTERN(Constant)
MACHINA_MACHINA_XLA_NULLOP_PATTERN(Parameter)
MACHINA_MACHINA_XLA_NULLOP_PATTERN(Iota)
MACHINA_MACHINA_XLA_NULLOP_PATTERN(Rng)
MACHINA_MACHINA_XLA_NULLOP_PATTERN(PartitionId)
MACHINA_MACHINA_XLA_NULLOP_PATTERN(ReplicaId)
#undef MACHINA_MACHINA_XLA_NULLOP_PATTERN

// Helpers for unary instructions.
#define MACHINA_MACHINA_XLA_UNOP_PATTERN(NAME)                                       \
  inline auto NAME() { return Op().WithOpcode(HloOpcode::k##NAME); } \
                                                                     \
  template <typename HloInstructionType>                             \
  inline auto NAME(HloInstructionType** matched_inst) {              \
...
MACHINA_MACHINA_XLA_UNOP_PATTERN(Abs)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Bitcast)
MACHINA_MACHINA_XLA_UNOP_PATTERN(BitcastConvert)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Broadcast)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Cbrt)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Ceil)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Convert)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Copy)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Cos)
MACHINA_MACHINA_XLA_UNOP_PATTERN(AllReduceStart)
MACHINA_MACHINA_XLA_UNOP_PATTERN(AllReduceDone)
MACHINA_MACHINA_XLA_UNOP_PATTERN(AllToAll)
MACHINA_MACHINA_XLA_UNOP_PATTERN(RaggedAllToAll)
MACHINA_MACHINA_XLA_UNOP_PATTERN(AsyncDone)
MACHINA_MACHINA_XLA_UNOP_PATTERN(CollectiveBroadcast)
MACHINA_MACHINA_XLA_UNOP_PATTERN(CollectivePermute)
MACHINA_MACHINA_XLA_UNOP_PATTERN(CollectivePermuteStart)
MACHINA_MACHINA_XLA_UNOP_PATTERN(CollectivePermuteDone)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Domain)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Erf)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Exp)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Expm1)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Fft)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Floor)
MACHINA_MACHINA_XLA_UNOP_PATTERN(GetTupleElement)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Imag)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Infeed)
MACHINA_MACHINA_XLA_UNOP_PATTERN(IsFinite)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Log)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Logistic)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Not)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Negate)
MACHINA_MACHINA_XLA_UNOP_PATTERN(OptimizationBarrier)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Real)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Recv)
MACHINA_MACHINA_XLA_UNOP_PATTERN(RecvDone)
MACHINA_MACHINA_XLA_UNOP_PATTERN(ReducePrecision)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Reshape)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Reverse)
MACHINA_MACHINA_XLA_UNOP_PATTERN(RoundNearestAfz)
MACHINA_MACHINA_XLA_UNOP_PATTERN(RoundNearestEven)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Rsqrt)
MACHINA_MACHINA_XLA_UNOP_PATTERN(SendDone)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Sign)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Sin)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Slice)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Sqrt)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Tan)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Tanh)
MACHINA_MACHINA_XLA_UNOP_PATTERN(Transpose)
MACHINA_MACHINA_XLA_UNOP_PATTERN(While)
#undef MACHINA_MACHINA_XLA_UNOP_PATTERN

// Helpers for binary instructions.
#define MACHINA_MACHINA_XLA_BINOP_PATTERN(NAME)                                               \
  inline auto NAME() { return Op().WithOpcode(HloOpcode::k##NAME); }          \
                                                                              \
...
#define MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(NAME)                                \
  MACHINA_MACHINA_XLA_BINOP_PATTERN(NAME)                                                  \
                                                                           \
  template <typename HloInstructionType, typename Lhs, typename Rhs>       \
...
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Add)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Atan2)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Divide)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Complex)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Compare)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Convolution)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Dot)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Gather)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Maximum)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Minimum)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Multiply)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Outfeed)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Pad)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Power)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Remainder)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Send)
MACHINA_MACHINA_XLA_BINOP_PATTERN(Subtract)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(And)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Or)
MACHINA_MACHINA_XLA_BINOP_PATTERN(ShiftLeft)
MACHINA_MACHINA_XLA_BINOP_PATTERN(ShiftRightArithmetic)
MACHINA_MACHINA_XLA_BINOP_PATTERN(ShiftRightLogical)
MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN(Xor)
#undef MACHINA_MACHINA_XLA_COMMUTATIVE_BINOP_PATTERN
#undef MACHINA_MACHINA_XLA_BINOP_PATTERN

// Helpers for ternary instructions.
#define MACHINA_MACHINA_XLA_TERNOP_PATTERN(NAME)                                       \
  inline auto NAME() { return Op().WithOpcode(HloOpcode::k##NAME); }   \
                                                                       \
...
MACHINA_MACHINA_XLA_TERNOP_PATTERN(Clamp);
MACHINA_MACHINA_XLA_TERNOP_PATTERN(RaggedDot);
MACHINA_MACHINA_XLA_TERNOP_PATTERN(Select);
MACHINA_MACHINA_XLA_TERNOP_PATTERN(SelectAndScatter);
#undef MACHINA_MACHINA_XLA_TERNOP_PATTERN
...
#define MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(NAME)                                         \
  inline auto NAME() { return Op().WithOpcode(HloOpcode::k##NAME); }          \
                                                                              \
...
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(AfterAll);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(AllGather)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(AllReduce)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(AsyncStart)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Concatenate);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Conditional);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(DynamicSlice)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(DynamicUpdateSlice)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Fusion);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Map)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Reduce);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(ReduceScatter)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(ReduceWindow)
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Scatter);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Sort);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Tuple);
MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN(Call);

// CustomCall doesn't use the MACHINA_MACHINA_XLA_VARIADIC_OP_PATTERN macro so that you can
...
#define MACHINA_MACHINA_XLA_COMPARE_PATTERN(NAME)                                             \
  inline auto NAME() {                                                        \
    return Op()                                                               \
...
#define MACHINA_MACHINA_XLA_COMMUTATIVE_COMPARE_PATTERN(NAME)                              \
  MACHINA_MACHINA_XLA_COMPARE_PATTERN(NAME)                                                \
                                                                           \
  template <typename HloInstructionType, typename Lhs, typename Rhs>       \
  inline auto NAME##AnyOrder(HloInstructionType** matched_inst, Lhs&& lhs, \
                             Rhs&& rhs) {                                  \
...
MACHINA_MACHINA_XLA_COMMUTATIVE_COMPARE_PATTERN(Eq);
MACHINA_MACHINA_XLA_COMMUTATIVE_COMPARE_PATTERN(Ne);
MACHINA_MACHINA_XLA_COMPARE_PATTERN(Ge);
MACHINA_MACHINA_XLA_COMPARE_PATTERN(Gt);
MACHINA_MACHINA_XLA_COMPARE_PATTERN(Le);
MACHINA_MACHINA_XLA_COMPARE_PATTERN(Lt);
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_PATTERN_MATCHER_H_
