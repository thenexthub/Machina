...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_PARALLEL_LOOP_EMITTER_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_PARALLEL_LOOP_EMITTER_H_
...
class ParallelLoopEmitter : public llvm_ir::LoopEmitter {
 public:
  ...
  std::vector<llvm_ir::IrArray::Index> EmitIndexAndSetExitBasicBlock(
      ...
      toolchain::Value* base_index) override;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_PARALLEL_LOOP_EMITTER_H_
