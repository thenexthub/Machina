...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_EXECUTABLE_H_
...
class CpuExecutable : public Executable {
 ...
 private:
  ...
  // CpuExecutable. We save a string instead of an toolchain::Module* because leaving
  // toolchain::Module* in a singleton can cause the heap checker to emit false
  // positives.
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_CPU_EXECUTABLE_H_
