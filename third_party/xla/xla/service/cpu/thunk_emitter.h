...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_THUNK_EMITTER_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_THUNK_EMITTER_H_
...
class ThunkEmitter {
 public:
  ...
  struct EmittedKernel {
    ...
    toolchain::orc::ThreadSafeModule module;
  };
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_THUNK_EMITTER_H_
