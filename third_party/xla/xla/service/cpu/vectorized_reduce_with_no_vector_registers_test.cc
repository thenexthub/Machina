...
#include "machina/xla/service/cpu/test_target_triple_helper.h"
...
absl::StatusOr<unsigned int> GetTargetVectorRegisterByteSize(
  ...
  toolchain::Function* function = toolchain::Function::Create(
      toolchain::FunctionType::get(toolchain::Type::getVoidTy(context), {}),
      toolchain::GlobalValue::ExternalLinkage, "test", &module);

  std::unique_ptr<toolchain::TargetMachine> target_machine =
      absl::WrapUnique(target->createTargetMachine(
          /*TT=*/triple, /*CPU=*/"", /*Features=*/"", toolchain::TargetOptions{},
          /*RM=*/std::nullopt));
