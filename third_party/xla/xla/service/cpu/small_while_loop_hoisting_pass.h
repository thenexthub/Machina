...
#ifndef MACHINA_XLASERVICE_CPU_SMALL_WHILE_LOOP_HOISTING_PASS_H_
#define MACHINA_XLASERVICE_CPU_SMALL_WHILE_LOOP_HOISTING_PASS_H_
...
#endif  // MACHINA_XLASERVICE_CPU_SMALL_WHILE_LOOP_HOISTING_PASS_H_
