...
#include "machina/xla/backends/cpu/codegen/computation_kernel_emitter.h"
#include "machina/xla/backends/cpu/codegen/dot/dot_kernel_emitter.h"
#include "machina/xla/backends/cpu/codegen/elemental/concatenate_kernel_emitter.h"
#include "machina/xla/backends/cpu/codegen/elemental/elemental_kernel_emitter.h"
#include "machina/xla/backends/cpu/codegen/emitters/cpu_scatter_emitter.h"
#include "machina/xla/backends/cpu/codegen/fusion_compiler.h"
#include "machina/xla/backends/cpu/codegen/fusion_emitter.h"
#include "machina/xla/backends/cpu/codegen/ir_compiler.h"
#include "machina/xla/backends/cpu/codegen/target_machine_features.h"
#include "machina/xla/backends/cpu/runtime/all_gather_thunk.h"
#include "machina/xla/backends/cpu/runtime/all_reduce_thunk.h"
#include "machina/xla/backends/cpu/runtime/all_to_all_thunk.h"
#include "machina/xla/backends/cpu/runtime/call_thunk.h"
#include "machina/xla/backends/cpu/runtime/collective_permute_thunk.h"
#include "machina/xla/backends/cpu/runtime/collective_thunk.h"
#include "machina/xla/backends/cpu/runtime/conditional_thunk.h"
#include "machina/xla/backends/cpu/runtime/convolution_thunk.h"
#include "machina/xla/backends/cpu/runtime/copy_thunk.h"
#include "machina/xla/backends/cpu/runtime/custom_call_thunk.h"
#include "machina/xla/backends/cpu/runtime/dot_thunk.h"
#include "machina/xla/backends/cpu/runtime/fft_thunk.h"
#include "machina/xla/backends/cpu/runtime/infeed_thunk.h"
#include "machina/xla/backends/cpu/runtime/kernel_thunk.h"
#include "machina/xla/backends/cpu/runtime/logical_id_thunk.h"
#include "machina/xla/backends/cpu/runtime/outfeed_thunk.h"
#include "machina/xla/backends/cpu/runtime/reduce_scatter_thunk.h"
#include "machina/xla/backends/cpu/runtime/rng_state_thunk.h"
#include "machina/xla/backends/cpu/runtime/sort_thunk.h"
#include "machina/xla/backends/cpu/runtime/thunk.h"
#include "machina/xla/backends/cpu/runtime/topk_thunk.h"
#include "machina/xla/backends/cpu/runtime/while_thunk.h"
#include "machina/xla/backends/cpu/runtime/xnnpack/xnn_dot_thunk.h"
#include "machina/xla/backends/cpu/runtime/xnnpack/xnn_fusion_thunk.h"
#include "machina/xla/backends/cpu/xnn_emitter.h"
...
#include "machina/xla/runtime/resource_use.h"
...
#if MACHINA_MACHINA_XLA_ONEDNN_USE_GRAPH_API
#include "machina/xla/backends/cpu/onednn_emitter.h"
#include "machina/xla/backends/cpu/onednn_support.h"
#include "machina/xla/backends/cpu/runtime/onednn/onednn_fusion_thunk.h"
#endif  // MACHINA_MACHINA_XLA_ONEDNN_USE_GRAPH_API
...
absl::Status HandleReduceAndReduceWindowElementalKernelCompilationOptions(
    const HloInstruction* instruction, toolchain::Module& llvm_module,
    const TargetMachineFeatures& target_machine_features) {
  bool disable_loop_unrolling = true;
  ...
  if (DumpingEnabledForHloModule(hlo_module)) {
    auto callback_factory = [&hlo_module](std::string stage_name) {
      return [&hlo_module, stage_name](mlir::ModuleOp module) {
        std::optional<toolchain::StringRef> name = module.getName();
        if (!name.has_value()) {
          return;
        }
