...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_DOT_OP_EMITTER_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_DOT_OP_EMITTER_H_
...
struct DotOpWorkGroupId {
  toolchain::Value* x = nullptr;
  toolchain::Value* y = nullptr;
};
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_DOT_OP_EMITTER_H_
