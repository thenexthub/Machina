...
#ifndef MACHINA_XLASERVICE_CPU_IR_EMISSION_UTILS_H_
#define MACHINA_XLASERVICE_CPU_IR_EMISSION_UTILS_H_
...
using DynamicLoopBounds = std::vector<std::pair<toolchain::Value*, toolchain::Value*>>;

}  // namespace cpu
}  // namespace xla

#endif  // MACHINA_XLASERVICE_CPU_IR_EMISSION_UTILS_H_
