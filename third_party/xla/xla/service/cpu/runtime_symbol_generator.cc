...
#include "machina/xla/service/cpu/runtime_conv2d.h"
#include "machina/xla/service/cpu/runtime_conv2d_acl.h"
#include "machina/xla/service/cpu/runtime_conv3d.h"
#include "machina/xla/service/cpu/runtime_custom_call_status.h"
#include "machina/xla/service/cpu/runtime_fp16.h"
#include "machina/xla/service/cpu/runtime_key_value_sort.h"
#include "machina/xla/service/cpu/runtime_matmul.h"
#include "machina/xla/service/cpu/runtime_matmul_acl.h"
#include "machina/xla/service/cpu/runtime_pow.h"
#include "machina/xla/service/cpu/runtime_single_threaded_conv2d.h"
#include "machina/xla/service/cpu/runtime_single_threaded_conv3d.h"
#include "machina/xla/service/cpu/runtime_single_threaded_matmul.h"
#include "machina/xla/service/cpu/runtime_topk.h"
#include "machina/xla/service/cpu/windows_compatibility.h"
#include "machina/xla/service/custom_call_target_registry.h"
#include "tsl/platform/logging.h"

#if defined(INTEL_MKL)
#include "machina/xla/service/cpu/onednn_convolution.h"
#include "machina/xla/service/cpu/onednn_layer_norm.h"
#include "machina/xla/service/cpu/onednn_matmul.h"
#include "machina/xla/service/cpu/onednn_softmax.h"
#endif

namespace xla::cpu {

RuntimeSymbolGenerator::RuntimeSymbolGenerator(toolchain::DataLayout data_layout)
    : data_layout_(std::move(data_layout)) {}

toolchain::Error RuntimeSymbolGenerator::tryToGenerate(
    toolchain::orc::LookupState&, toolchain::orc::LookupKind kind,
    toolchain::orc::JITDylib& jit_dylib, toolchain::orc::JITDylibLookupFlags,
    const toolchain::orc::SymbolLookupSet& names) {
  toolchain::orc::SymbolMap symbols;
  ...
  cantFail(jit_dylib.define(toolchain::orc::absoluteSymbols(std::move(symbols))));
  return toolchain::Error::success();
}

std::optional<toolchain::orc::ExecutorSymbolDef>
RuntimeSymbolGenerator::ResolveRuntimeSymbol(toolchain::StringRef name) {
  ...
  return toolchain::orc::ExecutorSymbolDef{
      toolchain::orc::ExecutorAddr(reinterpret_cast<uint64_t>(fn_addr)),
      toolchain::JITSymbolFlags::Weak};
}
