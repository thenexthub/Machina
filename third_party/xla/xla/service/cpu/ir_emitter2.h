...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_IR_EMITTER2_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_IR_EMITTER2_H_
...
class IrEmitter2 {
 ...
 public:
  IrEmitter2(const HloModule& hlo_module, toolchain::Module* module,
 ...
 private:
  ...
  // load metadata.
  void AttachInvariantLoadMetadataForLoad(toolchain::LoadInst* instr) const;

  CpuElementalIrEmitter ElementalIrEmmiterFactory(toolchain::IRBuilderBase* b) const;
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_IR_EMITTER2_H_
