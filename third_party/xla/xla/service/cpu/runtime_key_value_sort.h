...
#ifndef MACHINA_XLASERVICE_CPU_RUNTIME_KEY_VALUE_SORT_H_
#define MACHINA_XLASERVICE_CPU_RUNTIME_KEY_VALUE_SORT_H_
...
#endif  // MACHINA_XLASERVICE_CPU_RUNTIME_KEY_VALUE_SORT_H_
