...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_MATMUL_H_
