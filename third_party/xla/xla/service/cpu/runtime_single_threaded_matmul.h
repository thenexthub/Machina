...
#ifndef MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_SINGLE_THREADED_MATMUL_H_
#define MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_SINGLE_THREADED_MATMUL_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_CPU_RUNTIME_SINGLE_THREADED_MATMUL_H_
