...
#ifndef MACHINA_XLASERVICE_CPU_TEST_TARGET_TRIPLE_HELPER_H_
#define MACHINA_XLASERVICE_CPU_TEST_TARGET_TRIPLE_HELPER_H_
...
#endif  // MACHINA_XLASERVICE_CPU_TEST_TARGET_TRIPLE_HELPER_H_
