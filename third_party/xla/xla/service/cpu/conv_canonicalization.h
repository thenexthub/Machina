...
#ifndef MACHINA_XLASERVICE_CPU_CONV_CANONICALIZATION_H_
#define MACHINA_XLASERVICE_CPU_CONV_CANONICALIZATION_H_
...
#endif  // MACHINA_XLASERVICE_CPU_CONV_CANONICALIZATION_H_
