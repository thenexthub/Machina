...
#ifndef MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_PLACER_H_
#define MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_PLACER_H_
...
#endif  // MACHINA_MACHINA_XLA_SERVICE_COMPUTATION_PLACER_H_
