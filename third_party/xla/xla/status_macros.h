...
#ifndef MACHINA_MACHINA_XLA_STATUS_MACROS_H_
#define MACHINA_MACHINA_XLA_STATUS_MACROS_H_
...
#include "machina/xla/tsl/platform/errors.h"  // IWYU pragma: keep, used in macro.
...
// after the macro.
#define MACHINA_MACHINA_XLA_RET_CHECK_FAIL()                                         \
  return xla::status_macros::MakeErrorStream(__FILE__, __LINE__,     \
                                             ::tsl::error::INTERNAL) \
      .with_log_stack_trace()

#endif  // MACHINA_MACHINA_XLA_STATUS_MACROS_H_
