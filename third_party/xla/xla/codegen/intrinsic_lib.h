...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_LIB_H_
#define MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_LIB_H_
...
class IntrinsicFunction {
 public:
  ...
  virtual toolchain::Function* CreateDefinition(toolchain::Module& module,
  ...
  // "_ZGV_LLVM_N8" used in toolchain::VecDesc.
...
class IntrinsicFunctionLib {
 public:
  ...
  std::vector<toolchain::VecDesc> Vectorizations();
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_LIB_H_
