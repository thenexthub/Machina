...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_CONCATENATE_KERNEL_EMITTER_H_
#define MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_CONCATENATE_KERNEL_EMITTER_H_
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_CONCATENATE_KERNEL_EMITTER_H_
