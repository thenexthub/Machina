...
// CHECK-SAME:   %[[ARG0:.*]]: !toolchain.ptr {toolchain.noalias},
// CHECK-SAME:   %[[ARG1:.*]]: !toolchain.ptr {toolchain.noalias, xla.invariant},
// CHECK-SAME:   %[[ARG2:.*]]: index) -> f32 {
// CHECK:        %[[GEP0:.*]] = toolchain.getelementptr inbounds %[[ARG0]]
// CHECK:        toolchain.load %[[GEP0]] : !toolchain.ptr
// CHECK:        %[[GEP1:.*]] = toolchain.getelementptr inbounds %[[ARG1]]
// CHECK:        toolchain.load %[[GEP1]] invariant : !toolchain.ptr
// CHECK:        %[[GEP2:.*]] = toolchain.getelementptr inbounds %[[ARG0]]

// CHECK:      func.func @tensorcall
// CHECK-SAME:   %[[ARG0:[a-z0-9]+]]: !toolchain.ptr {toolchain.noalias},
// CHECK-SAME:   %[[ARG1:[a-z0-9]+]]: !toolchain.ptr {toolchain.noalias, xla.invariant},
// CHECK-SAME:   %[[ARG2:[a-z0-9]+]]: !toolchain.ptr {toolchain.noalias},
...
// CHECK-SAME:    %[[ARG0:[a-z0-9]+]]: !toolchain.ptr,
// CHECK-SAME:    %[[ARG1:[a-z0-9]+]]: !toolchain.ptr,
...
// CHECK-SAME:    %[[ARG0:[a-z0-9]+]]: !toolchain.ptr {toolchain.noalias},
// CHECK-SAME:    %[[ARG1:[a-z0-9]+]]: !toolchain.ptr {toolchain.noalias},
// CHECK-SAME:    %[[IDX:[a-z0-9]+]]: index) -> f32 attributes {xla.entry} {
// CHECK:         %[[GEP0:.*]] = toolchain.getelementptr inbounds %[[ARG0]]
// CHECK:         %[[V0:.*]] = toolchain.load %[[GEP0]]
// CHECK:         %[[GEP1:.*]] = toolchain.getelementptr inbounds %[[ARG0]]
// CHECK:         %[[V1:.*]] = toolchain.load %[[GEP1]]
