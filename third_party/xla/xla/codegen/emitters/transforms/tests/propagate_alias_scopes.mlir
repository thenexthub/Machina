...
// CHECK: tensor.extract {{.*}}toolchain.noalias = [#[[ALIAS_SCOPE:[a-z0-9_]+]]
...
// CHECK: tensor.extract {{.*}}toolchain.noalias = [#[[ALIAS_SCOPE_1:[a-z0-9_]+]],
// CHECK-SAME: #[[ALIAS_SCOPE_2:[a-z0-9_]+]]
// CHECK-DAG : tensor.insert {{.*}}alias_scopes = [#[[ALIAS_SCOPE_1]]],
// CHECK-DAG-SAME: toolchain.noalias = [#[[ALIAS_SCOPE_2]]]
// CHECK-DAG : tensor.insert {{.*}}alias_scopes = [#[[ALIAS_SCOPE_2]]],
// CHECK-DAG-SAME: toolchain.noalias = [#[[ALIAS_SCOPE_1]]]
