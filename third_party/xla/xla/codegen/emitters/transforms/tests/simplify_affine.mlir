...
func.func @op_and_for_ranges(%arg0: !toolchain.ptr, %arg1: !toolchain.ptr, %arg2: !toolchain.ptr) {
  ...
  scf.for %arg3 = %c0 to %c4 step %c1 {
    ...
    %4 = toolchain.getelementptr %arg0[%3] : (!toolchain.ptr, i64) -> !toolchain.ptr, f32
    %5 = toolchain.load %4 invariant : !toolchain.ptr -> f32
    %8 = toolchain.getelementptr %arg1[%3] : (!toolchain.ptr, i64) -> !toolchain.ptr, f32
    %9 = toolchain.load %8 invariant : !toolchain.ptr -> f32
    %10 = arith.cmpf oge, %5, %9 : f32
    %11 = toolchain.getelementptr %arg2[%3] : (!toolchain.ptr, i64) -> !toolchain.ptr, i1
    toolchain.store %10, %11 : i1, !toolchain.ptr
  }
  return
}
