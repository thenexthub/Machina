...
#ifndef MACHINA_XLACODEGEN_EMITTERS_COMPUTATION_FINGERPRINT_H_
#define MACHINA_XLACODEGEN_EMITTERS_COMPUTATION_FINGERPRINT_H_
...
#endif  // MACHINA_XLACODEGEN_EMITTERS_COMPUTATION_FINGERPRINT_H_
