...
#include "machina/xla/codegen/emitters/ir/xla_attrs.cc.inc"
#include "machina/xla/codegen/emitters/ir/xla_enums.cc.inc"
...
struct XlaInlinerInterface : public mlir::DialectInlinerInterface {
  ...
  bool isLegalToInline(mlir::Operation* call, mlir::Operation* callable,
    ...
    toolchain::SmallDenseSet<toolchain::StringRef> callee_calls;
...
struct XlaOpAsmDialectInterface : public mlir::OpAsmDialectInterface {
  ...
  AliasResult getAlias(mlir::Attribute attr,
    ...
    if (toolchain::isa<IndexingMapAttr>(attr)) {
      os << "indexing_map";
