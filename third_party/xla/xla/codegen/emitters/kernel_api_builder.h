...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_KERNEL_API_BUILDER_H_
#define MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_KERNEL_API_BUILDER_H_
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_KERNEL_API_BUILDER_H_
