...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_ELEMENTAL_HLO_TO_MLIR_H_
#define MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_ELEMENTAL_HLO_TO_MLIR_H_
...
using OperandProvider =
    std::function<absl::StatusOr<toolchain::SmallVector<mlir::Value, 1>>(
...
toolchain::SmallVector<mlir::Value, 2> ProvideParameterRange(
    const PartitionedComputation& computation, const HloInstruction* instr,
...
toolchain::SmallVector<mlir::Value, 3> ApplyIndexing(IndexingMap map,
...
mlir::ValueRange EmitLoopNest(
    ...
    mlir::function_ref<toolchain::SmallVector<mlir::Value>(
...
absl::StatusOr<mlir::ValueRange> EmitLoopNestWithStatus(
    mlir::ImplicitLocOpBuilder& b, mlir::ValueRange dim_values,
    mlir::ValueRange iter_args_inits, const IndexingMap& indexing_map,
    mlir::function_ref<absl::StatusOr<toolchain::SmallVector<mlir::Value>>(
        mlir::ValueRange iter_args, mlir::ValueRange dim_values,
        mlir::ValueRange symbol_values)>
        create_body);
...
void GetLoopBoundsFromIndexingMap(mlir::ImplicitLocOpBuilder& b,
                                  ...
                                  toolchain::SmallVectorImpl<mlir::Value>* lbs,
                                  toolchain::SmallVectorImpl<mlir::Value>* ubs,
                                  toolchain::SmallVectorImpl<mlir::Value>* steps);
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_EMITTERS_ELEMENTAL_HLO_TO_MLIR_H_
