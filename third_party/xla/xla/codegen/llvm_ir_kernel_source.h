...
#ifndef MACHINA_XLACODEGEN_LLVM_IR_KERNEL_SOURCE_H_
#define MACHINA_XLACODEGEN_LLVM_IR_KERNEL_SOURCE_H_
...
class LlvmIrKernelSource final : public KernelSource {
 public:
  LlvmIrKernelSource(toolchain::orc::ThreadSafeContext context,
 ...
 private:
  toolchain::orc::ThreadSafeModule module_;
};

}  // namespace xla

#endif  // MACHINA_XLACODEGEN_LLVM_IR_KERNEL_SOURCE_H_
