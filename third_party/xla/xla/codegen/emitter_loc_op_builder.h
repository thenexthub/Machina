...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
#define MACHINA_MACHINA_XLA_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
...
#endif  // MACHINA_MACHINA_XLA_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
