...
TEST(SimpleJitRunnerTest, RunJitTest) {
  ...
  toolchain::FunctionType* func_type =
      toolchain::FunctionType::get(toolchain::Type::getDoubleTy(*context),
                              {toolchain::Type::getDoubleTy(*context)}, false);
  toolchain::Function* func = toolchain::Function::Create(
      func_type, toolchain::Function::ExternalLinkage, "test_func", *module);
  toolchain::BasicBlock* entry_block =
      toolchain::BasicBlock::Create(*context, "entry", func);
  builder.SetInsertPoint(entry_block);
  toolchain::Value* arg = func->getArg(0);
  toolchain::Value* result = builder.CreateFMul(
      arg, toolchain::ConstantFP::get(toolchain::Type::getDoubleTy(*context), 2.0));
...
TEST(SimpleJitRunnerTest, RunJitVectorized) {
  ...
  toolchain::Type* f64_type = toolchain::Type::getDoubleTy(*context);
  toolchain::Type* vec_type = toolchain::VectorType::get(
      f64_type, toolchain::ElementCount::getFixed(vector_size));
  toolchain::Type* int_vec_type =
      toolchain::VectorType::get(toolchain::Type::getInt64Ty(*context),
                            toolchain::ElementCount::getFixed(vector_size));

  toolchain::FunctionType* func_type =
      toolchain::FunctionType::get(vec_type, {vec_type, int_vec_type}, false);
  toolchain::Function* func = toolchain::Function::Create(
      func_type, toolchain::Function::ExternalLinkage, "test_vec_func", *module);
  toolchain::BasicBlock* entry_block =
      toolchain::BasicBlock::Create(*context, "entry", func);
  builder.SetInsertPoint(entry_block);
  toolchain::Value* arg1 = func->getArg(0);
  toolchain::Value* arg2 = func->getArg(1);
...
TEST(SimpleJitRunnerTest, RunJitVectorizedF32) {
  ...
  toolchain::IRBuilder<> builder(*context);
  constexpr int vector_size = 4;
  toolchain::Type* vec_type =
      toolchain::VectorType::get(toolchain::Type::getFloatTy(*context),
                            toolchain::ElementCount::getFixed(vector_size));
  toolchain::Type* int_vec_type =
      toolchain::VectorType::get(toolchain::Type::getInt64Ty(*context),
                            toolchain::ElementCount::getFixed(vector_size));
...
TEST(SimpleJitRunnerTest, RunJitVectorizedF32Loop) {
  ...
  toolchain::FunctionType* PrintfFuncType = toolchain::FunctionType::get(
      builder.getInt32Ty(), builder.getInt8Ty()->getPointerTo(), true);
  toolchain::Function* PrintfFunc = toolchain::Function::Create(
      PrintfFuncType, toolchain::Function::ExternalLinkage, "printf", *module);
  toolchain::Value* format_str = builder.CreateGlobalStringPtr("Iterating\n");
