...
#ifndef MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_RSQRT_H_
#define MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_RSQRT_H_
...
class Rsqrt : public Intrinsic<Rsqrt> {
 public:
  ...
  static absl::StatusOr<toolchain::Function*> CreateDefinition(
      toolchain::Module* module, absl::string_view features, Type type);
};

}  // namespace xla::codegen::intrinsics

#endif  // MACHINA_MACHINA_XLA_CODEGEN_INTRINSIC_RSQRT_H_
