...
#ifndef MACHINA_MACHINA_XLA_FFI_FFI_H_
#define MACHINA_MACHINA_XLA_FFI_FFI_H_

#ifdef MACHINA_MACHINA_XLA_FFI_API_FFI_H_
...
#include "machina/xla/types.h"  // IWYU pragma: keep
...
struct FfiApi {};               // binds `const MACHINA_MACHINA_XLA_FFI_Api*`
struct FfiExecutionContext {};  // binds `MACHINA_MACHINA_XLA_FFI_ExecutionContext*`
...
class AnyBuffer {
 public:
  ...
  explicit AnyBuffer(const MACHINA_MACHINA_XLA_FFI_Buffer* absl_nonnull buf) : buf_(buf) {
    DCHECK(buf_ != nullptr) << "MACHINA_MACHINA_XLA_FFI_Buffer must be non-null";
  }
...
class Buffer {
 public:
  ...
  explicit Buffer(const MACHINA_MACHINA_XLA_FFI_Buffer* absl_nonnull buf) : buf_(buf) {
    DCHECK(buf_ != nullptr) << "MACHINA_MACHINA_XLA_FFI_Buffer must be non-null";
  }
...
struct ArgDecoding<AnyBuffer> {
  ...
  static std::optional<AnyBuffer> Decode(MACHINA_MACHINA_XLA_FFI_ArgType type, void* arg,
    ...
    if (ABSL_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER)) {
...
struct RetDecoding<AnyBuffer> {
  ...
  static std::optional<Result<AnyBuffer>> Decode(MACHINA_MACHINA_XLA_FFI_RetType type,
                                                 void* arg,
                                                 DiagnosticEngine& diagnostic) {
    if (ABSL_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_RetType_BUFFER)) {
...
struct RetDecoding<Buffer<dtype, rank>> {
  ...
  static std::optional<Result<Buffer<dtype, rank>>> Decode(
      MACHINA_MACHINA_XLA_FFI_RetType type, void* arg, DiagnosticEngine& diagnostic) {
    if (ABSL_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_RetType_BUFFER)) {
      return diagnostic.Emit("Wrong result type: expected ")
             << MACHINA_MACHINA_XLA_FFI_RetType_BUFFER << " but got " << type;
    }
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(T, TYPE)                   \
  template <>                                                            \
  struct AttrDecoding<absl::Span<const T>> {                             \
    using Type = absl::Span<const T>;                                    \
    static std::optional<Type> Decode(MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr, \
                                      DiagnosticEngine& diagnostic) {    \
      if (ABSL_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_ARRAY)) {          \
...
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(int8_t, MACHINA_MACHINA_XLA_FFI_DataType_S8);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(int16_t, MACHINA_MACHINA_XLA_FFI_DataType_S16);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(int32_t, MACHINA_MACHINA_XLA_FFI_DataType_S32);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(int64_t, MACHINA_MACHINA_XLA_FFI_DataType_S64);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(float, MACHINA_MACHINA_XLA_FFI_DataType_F32);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING(double, MACHINA_MACHINA_XLA_FFI_DataType_F64);

#undef MACHINA_MACHINA_XLA_FFI_REGISTER_ARRRAY_ATTR_DECODING

template <>
struct AttrDecoding<absl::string_view> {
  using Type = absl::string_view;
  static std::optional<absl::string_view> Decode(MACHINA_MACHINA_XLA_FFI_AttrType type,
                                                 void* attr,
                                                 DiagnosticEngine& diagnostic) {
...
struct AttrDecoding<Pointer<T>> {
  ...
  static std::optional<Type> Decode(MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr,
    ...
    if (ABSL_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR ||
...
struct AttrDecoding<Dictionary> {
  ...
  static std::optional<Dictionary> Decode(MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr,
                                          DiagnosticEngine& diagnostic) {
...
struct CtxDecoding<Stream> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                    ...
                                    DiagnosticEngine& diagnostic) {
    void* ptr = api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_Stream_Get(ctx);
...
struct CtxDecoding<DeviceOrdinal> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                    DiagnosticEngine&) {
    return api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceOrdinal_Get(ctx);
  }
};
...
struct CtxDecoding<Allocator> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    void* device_allocator =
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceMemoryAllocator_Get(ctx);
...
struct CtxDecoding<ScratchAllocator> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    int32_t device_ordinal =
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceOrdinal_Get(ctx);
    void* device_allocator =
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceMemoryAllocator_Get(ctx);
...
struct CtxDecoding<CalledComputation> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                    DiagnosticEngine&) {
    void* ptr = api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_CalledComputation_Get(ctx);
    return reinterpret_cast<Type>(ptr);
  }
};
...
struct CtxDecoding<IntraOpThreadPool> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    void* intra_op_thread_pool =
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_IntraOpThreadPool_Get(ctx);
...
struct CtxDecoding<RunId> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                    DiagnosticEngine& diagnostic) {
    return RunId{api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_RunId_Get(ctx)};
  }
};
...
struct CtxDecoding<UserData<T>> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    auto* execution_context = reinterpret_cast<const ExecutionContext*>(
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionContext_Get(ctx));
...
struct CtxDecoding<State<T>> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    auto* execution_state = reinterpret_cast<const ExecutionState*>(
        api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionState_Get(ctx));
...
struct ResultEncoding<stage, absl::Status> {
  static MACHINA_MACHINA_XLA_FFI_Error* Encode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    return api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_Error_Forward(&status);
  }
};
...
struct ResultEncoding<stage, tsl::AsyncValueRef<tsl::Chain>> {
  static MACHINA_MACHINA_XLA_FFI_Future* Encode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                tsl::AsyncValueRef<tsl::Chain> async_value) {
    return api->internal_api->MACHINA_MACHINA_XLA_FFI_INTERNAL_Future_Forward(
        async_value.release());
  }
};
