...
#ifndef MACHINA_MACHINA_XLA_FFI_API_API_H_
#define MACHINA_MACHINA_XLA_FFI_API_API_H_
...
#ifdef __has_builtin
#define MACHINA_MACHINA_XLA_FFI_HAS_BUILTIN(x) __has_builtin(x)
#else
#define MACHINA_MACHINA_XLA_FFI_HAS_BUILTIN(x) 0
#endif

#if __has_attribute(always_inline)
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE __attribute__((always_inline))
#elif defined(_MSC_VER)
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE __forceinline
#else
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
#endif

#if __has_attribute(noinline)
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_NEVER_INLINE __attribute__((noinline))
#elif defined(_MSC_VER)
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_NEVER_INLINE __declspec(noinline)
#else
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_NEVER_INLINE
#endif

#if MACHINA_MACHINA_XLA_FFI_HAS_BUILTIN(__builtin_expect)
#define MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(x) (__builtin_expect(false || (x), false))
#define MACHINA_MACHINA_XLA_FFI_PREDICT_TRUE(x) (__builtin_expect(false || (x), true))
#else
#define MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(x) (x)
#define MACHINA_MACHINA_XLA_FFI_PREDICT_TRUE(x) (x)
#endif
...
inline std::ostream& operator<<(std::ostream& os,
                                const MACHINA_MACHINA_XLA_FFI_DataType dtype) {
  switch (dtype) {
    case MACHINA_MACHINA_XLA_FFI_DataType_INVALID:
      return os << "INVALID";
    case MACHINA_MACHINA_XLA_FFI_DataType_PRED:
      return os << "PRED";
    case MACHINA_MACHINA_XLA_FFI_DataType_S1:
      return os << "S1";
    case MACHINA_MACHINA_XLA_FFI_DataType_S2:
      return os << "S2";
    case MACHINA_MACHINA_XLA_FFI_DataType_S4:
      return os << "S4";
    case MACHINA_MACHINA_XLA_FFI_DataType_S8:
      return os << "S8";
    case MACHINA_MACHINA_XLA_FFI_DataType_S16:
      return os << "S16";
    case MACHINA_MACHINA_XLA_FFI_DataType_S32:
      return os << "S32";
    case MACHINA_MACHINA_XLA_FFI_DataType_S64:
      return os << "S64";
    case MACHINA_MACHINA_XLA_FFI_DataType_U1:
      return os << "U1";
    case MACHINA_MACHINA_XLA_FFI_DataType_U2:
      return os << "U2";
    case MACHINA_MACHINA_XLA_FFI_DataType_U4:
      return os << "U4";
    case MACHINA_MACHINA_XLA_FFI_DataType_U8:
      return os << "U8";
    case MACHINA_MACHINA_XLA_FFI_DataType_U16:
      return os << "U16";
    case MACHINA_MACHINA_XLA_FFI_DataType_U32:
      return os << "U32";
    case MACHINA_MACHINA_XLA_FFI_DataType_U64:
      return os << "U64";
    case MACHINA_MACHINA_XLA_FFI_DataType_F16:
      return os << "F16";
    case MACHINA_MACHINA_XLA_FFI_DataType_F32:
      return os << "F32";
    case MACHINA_MACHINA_XLA_FFI_DataType_F64:
      return os << "F64";
    case MACHINA_MACHINA_XLA_FFI_DataType_BF16:
      return os << "BF16";
    case MACHINA_MACHINA_XLA_FFI_DataType_C64:
      return os << "C64";
    case MACHINA_MACHINA_XLA_FFI_DataType_C128:
      return os << "C128";
    case MACHINA_MACHINA_XLA_FFI_DataType_TOKEN:
      return os << "TOKEN";
    case MACHINA_MACHINA_XLA_FFI_DataType_F4E2M1FN:
      return os << "F4E2M1FN";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E5M2:
      return os << "F8E5M2";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E3M4:
      return os << "F8E3M4";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3:
      return os << "F8E4M3";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3FN:
      return os << "F8E4M3FN";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3B11FNUZ:
      return os << "F8E4M3B11FNUZ";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E5M2FNUZ:
      return os << "F8E5M2FNUZ";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3FNUZ:
      return os << "F8E4M3FNUZ";
    case MACHINA_MACHINA_XLA_FFI_DataType_F8E8M0FNU:
      return os << "F8E8M0FNU";
  }
}

inline std::ostream& operator<<(std::ostream& os, const MACHINA_MACHINA_XLA_FFI_AttrType type) {
  switch (type) {
    case MACHINA_MACHINA_XLA_FFI_AttrType_ARRAY:
      return os << "array";
    case MACHINA_MACHINA_XLA_FFI_AttrType_DICTIONARY:
      return os << "dictionary";
    case MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR:
      return os << "scalar";
    case MACHINA_MACHINA_XLA_FFI_AttrType_STRING:
      return os << "string";
  }
}

inline std::ostream& operator<<(std::ostream& os,
                                const MACHINA_MACHINA_XLA_FFI_ExecutionStage stage) {
  switch (stage) {
    case MACHINA_MACHINA_XLA_FFI_ExecutionStage_INSTANTIATE:
      return os << "instantiate";
    case MACHINA_MACHINA_XLA_FFI_ExecutionStage_PREPARE:
      return os << "prepare";
    case MACHINA_MACHINA_XLA_FFI_ExecutionStage_INITIALIZE:
      return os << "initialize";
    case MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE:
      return os << "execute";
  }
}
...
enum class ExecutionStage : uint8_t {
  kInstantiate = MACHINA_MACHINA_XLA_FFI_ExecutionStage_INSTANTIATE,
  kPrepare = MACHINA_MACHINA_XLA_FFI_ExecutionStage_PREPARE,
  kInitialize = MACHINA_MACHINA_XLA_FFI_ExecutionStage_INITIALIZE,
  kExecute = MACHINA_MACHINA_XLA_FFI_ExecutionStage_EXECUTE,
};

enum class Traits : uint32_t {
  kCmdBufferCompatible = MACHINA_MACHINA_XLA_FFI_HANDLER_TRAITS_COMMAND_BUFFER_COMPATIBLE,
};
...
class Ffi {
 public:
  ...
  virtual ~Ffi() = default;
  virtual MACHINA_MACHINA_XLA_FFI_Error* Call(MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) const = 0;

  // Registers FFI handler bundle with an XLA runtime under the given name on a
  // given platform.
  static MACHINA_MACHINA_XLA_FFI_Error* RegisterStaticHandler(
      const MACHINA_MACHINA_XLA_FFI_Api* api, std::string_view name, std::string_view platform,
      MACHINA_MACHINA_XLA_FFI_Handler_Bundle bundle, MACHINA_MACHINA_XLA_FFI_Handler_Traits traits = 0);

  // Registers FFI execute handler with an XLA runtime under the given name on a
  // given platform.
  static MACHINA_MACHINA_XLA_FFI_Error* RegisterStaticHandler(
      const MACHINA_MACHINA_XLA_FFI_Api* api, std::string_view name, std::string_view platform,
      MACHINA_MACHINA_XLA_FFI_Handler* execute, MACHINA_MACHINA_XLA_FFI_Handler_Traits traits = 0) {
    return RegisterStaticHandler(
        api, name, platform,
        MACHINA_MACHINA_XLA_FFI_Handler_Bundle{nullptr, nullptr, nullptr, execute}, traits);
  }
  ...
  // `type_id`.
  static MACHINA_MACHINA_XLA_FFI_Error* RegisterTypeId(const MACHINA_MACHINA_XLA_FFI_Api* api,
  ...
  struct Wrapper<fn> {
    MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE Ret operator()(Args... args) const {
 ...
 protected:
  ...
  static MACHINA_MACHINA_XLA_FFI_Error* Sucess();

  static MACHINA_MACHINA_XLA_FFI_Error* MakeError(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                  MACHINA_MACHINA_XLA_FFI_Error_Code errc, std::string message);

  static MACHINA_MACHINA_XLA_FFI_Error* InvalidArgument(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                        std::string message);

  static MACHINA_MACHINA_XLA_FFI_Error* CheckStructSize(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                        std::string_view struct_name,
                                        size_t expected, size_t actual);

  static MACHINA_MACHINA_XLA_FFI_Error* StructSizeIsGreaterOrEqual(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                                   std::string_view struct_name,
                                                   size_t expected,
                                                   size_t actual);
};

inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::RegisterStaticHandler(
    const MACHINA_MACHINA_XLA_FFI_Api* api, std::string_view name, std::string_view platform,
    MACHINA_MACHINA_XLA_FFI_Handler_Bundle bundle, MACHINA_MACHINA_XLA_FFI_Handler_Traits traits) {
  MACHINA_MACHINA_XLA_FFI_Handler_Register_Args args;
  args.struct_size = MACHINA_MACHINA_XLA_FFI_Handler_Register_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.name = MACHINA_MACHINA_XLA_FFI_ByteSpan{name.data(), name.size()};
  args.platform = MACHINA_MACHINA_XLA_FFI_ByteSpan{platform.data(), platform.size()};
  args.bundle = bundle;
  args.traits = traits;
  return api->MACHINA_MACHINA_XLA_FFI_Handler_Register(&args);
}

inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::RegisterTypeId(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                          std::string_view name,
                                          MACHINA_MACHINA_XLA_FFI_TypeId* type_id) {
  MACHINA_MACHINA_XLA_FFI_TypeId_Register_Args args;
  args.struct_size = MACHINA_MACHINA_XLA_FFI_TypeId_Register_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.name = MACHINA_MACHINA_XLA_FFI_ByteSpan{name.data(), name.size()};
  args.type_id = type_id;
  return api->MACHINA_MACHINA_XLA_FFI_TypeId_Register(&args);
}
...
inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::Sucess() { return nullptr; }

inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::MakeError(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                     MACHINA_MACHINA_XLA_FFI_Error_Code errc,
                                     std::string message) {
  MACHINA_MACHINA_XLA_FFI_Error_Create_Args args;
  args.struct_size = MACHINA_MACHINA_XLA_FFI_Error_Create_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.errc = errc;
  args.message = message.c_str();
  return api->MACHINA_MACHINA_XLA_FFI_Error_Create(&args);
}

inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::InvalidArgument(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                           std::string message) {
  return MakeError(api, MACHINA_MACHINA_XLA_FFI_Error_Code_INVALID_ARGUMENT,
                   std::move(message));
}

inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::CheckStructSize(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                           std::string_view struct_name,
                                           size_t expected, size_t actual) {
  if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(expected != actual)) {
...
inline MACHINA_MACHINA_XLA_FFI_Error* Ffi::StructSizeIsGreaterOrEqual(
    const MACHINA_MACHINA_XLA_FFI_Api* api, std::string_view struct_name, size_t expected,
    size_t actual) {
  if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(actual < expected)) {
    return InvalidArgument(
...
template <typename T>
constexpr MACHINA_MACHINA_XLA_FFI_DataType NativeTypeToCApiDataType() {
  if constexpr (std::is_same_v<T, char>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_U8;
  } else if constexpr (std::is_same_v<T, bool>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_PRED;
  } else if constexpr (std::is_same_v<T, int8_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_S8;
  } else if constexpr (std::is_same_v<T, int16_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_S16;
  } else if constexpr (std::is_same_v<T, int32_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_S32;
  } else if constexpr (std::is_same_v<T, int64_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_S64;
  } else if constexpr (std::is_same_v<T, uint8_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_U8;
  } else if constexpr (std::is_same_v<T, uint16_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_U16;
  } else if constexpr (std::is_same_v<T, uint32_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_U32;
  } else if constexpr (std::is_same_v<T, uint64_t>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_U64;
  } else if constexpr (std::is_same_v<T, float>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_F32;
  } else if constexpr (std::is_same_v<T, double>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_F64;
  } else if constexpr (std::is_same_v<T, std::complex<float>>) {
    return MACHINA_MACHINA_XLA_FFI_DataType_C64;
  } else {
    static_assert(std::is_same_v<T, std::complex<double>>,
                  "unsupported FFI data type");
    return MACHINA_MACHINA_XLA_FFI_DataType_C128;
  }
}
...
//     static std::optional<MyType> Decode(MACHINA_MACHINA_XLA_FFI_ArgType type, void* arg);
//   };
//
...
//     static std::optional<MyType> Decode(MACHINA_MACHINA_XLA_FFI_RetType type, void* ret);
//   };
//
// If argument can't be decoded it should return the empty optional.
template <typename T>
...
//    static std::optional<MyType> Decode(MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr,
//                                        DiagnosticEngine&);
//   }
//
template <typename T>
...
//    static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
...
//     MACHINA_MACHINA_XLA_FFI_Error* Encode(const MACHINA_MACHINA_XLA_FFI_Api* api,
//                           MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
//                           absl::Status status) {...}
//   };
//
...
//
// Asynchronous FFI handlers can return encoded result as an `MACHINA_MACHINA_XLA_FFI_Future*`
// or as an `std::variant` of `MACHINA_MACHINA_XLA_FFI_Error*` and `MACHINA_MACHINA_XLA_FFI_Future*`, where an
...
//     std::variant<MACHINA_MACHINA_XLA_FFI_Error*, MACHINA_MACHINA_XLA_FFI_Future*> Encode(
//       const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
...
struct DecodingContext {
  MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame;
...
template <typename T>
struct Decode {
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
...
struct Decode<OptionalArgTag<T>> {
  ...
  static std::optional<std::optional<T>> call(DecodingOffsets& offsets,
                                              DecodingContext& ctx,
                                              DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(offsets.args >= ctx.call_frame->args.size)) {
...
struct Decode<OptionalRetTag<T>> {
  ...
  static std::optional<std::optional<Result<T>>> call(
      ...
      DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(offsets.rets >= ctx.call_frame->rets.size)) {
...
struct Decode<AttrTag<T>> {
  ...
  static std::optional<R> call(DecodingOffsets& offsets, DecodingContext& ctx,
    ...
    MACHINA_MACHINA_XLA_FFI_AttrType attr_type = ctx.call_frame->attrs.types[idx];
    MACHINA_MACHINA_XLA_FFI_ByteSpan* attr_name = ctx.call_frame->attrs.names[idx];
    ...
    auto eq = [](MACHINA_MACHINA_XLA_FFI_ByteSpan* a, std::string_view b) {
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(a->len != b.size())) {
        return false;
      }
      for (size_t i = 0; i < a->len; ++i) {
        if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(a->ptr[i] != b.data()[i])) {
          return false;
        }
      }
      return true;
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(!eq(attr_name, ctx.attrs_names[i]))) {
...
class RemainingArgsBase {
 public:
  RemainingArgsBase(const MACHINA_MACHINA_XLA_FFI_Args* args, size_t offset)
 ...
 protected:
  const MACHINA_MACHINA_XLA_FFI_Args* args() const { return args_; }
  size_t offset() const { return offset_; }

 private:
  const MACHINA_MACHINA_XLA_FFI_Args* args_;
  size_t offset_;
};
...
class RemainingRetsBase {
 public:
  RemainingRetsBase(const MACHINA_MACHINA_XLA_FFI_Rets* rets, size_t offset)
 ...
 protected:
  const MACHINA_MACHINA_XLA_FFI_Rets* rets() const { return rets_; }
  size_t offset() const { return offset_; }

 private:
  const MACHINA_MACHINA_XLA_FFI_Rets* rets_;  // not owned
  size_t offset_;
};
...
class DictionaryBase {
 public:
  explicit DictionaryBase(const MACHINA_MACHINA_XLA_FFI_Attrs* attrs) : attrs_(attrs) {}
 ...
 protected:
  ...
  std::optional<T> get(std::string_view name,
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(!idx.has_value())) {
      return diagnostic.Emit("Unexpected attribute: ") << name;
    }

    MACHINA_MACHINA_XLA_FFI_AttrType attr_type = attrs_->types[*idx];
 ...
 private:
  std::optional<size_t> Find(std::string_view name) const {
    MACHINA_MACHINA_XLA_FFI_ByteSpan** begin = attrs_->names;
    MACHINA_MACHINA_XLA_FFI_ByteSpan** end = begin + attrs_->size;

    auto eq = [](MACHINA_MACHINA_XLA_FFI_ByteSpan* a, std::string_view b) {
      return std::string_view{a->ptr, a->len} == b;
    };

    auto lt = [](MACHINA_MACHINA_XLA_FFI_ByteSpan* a, std::string_view b) {
      return std::string_view{a->ptr, a->len} < b;
    };
  ...
  const MACHINA_MACHINA_XLA_FFI_Attrs* attrs_;
};
...
struct internal::Decode<internal::AttrsTag<T>> {
  static std::optional<T> call(DecodingOffsets& offsets, DecodingContext& ctx,
                               DiagnosticEngine& diagnostic) {
    return AttrDecoding<T>::Decode(MACHINA_MACHINA_XLA_FFI_AttrType_DICTIONARY,
...
class Handler : public Ffi {
 ...
 public:
  ...
  MACHINA_MACHINA_XLA_FFI_Error* Call(MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) const override {
    // Sanity checking call frame struct size.
    if (MACHINA_MACHINA_XLA_FFI_Error* err = CheckStructSize(
            call_frame->api, "MACHINA_MACHINA_XLA_FFI_CallFrame", MACHINA_MACHINA_XLA_FFI_CallFrame_STRUCT_SIZE,
            call_frame->struct_size);
        MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(err)) {
      return err;
    }

    // If passed a call frame with the metadata extension, just return the
    // metadata.
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(call_frame->extension_start != nullptr &&
                              call_frame->extension_start->type ==
                                  MACHINA_MACHINA_XLA_FFI_Extension_Metadata)) {
      return PopulateMetadata(call_frame->api,
                              reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Metadata_Extension*>(
                                  call_frame->extension_start));
    }

    // Check that handler is called during correct execution stage.
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(call_frame->stage !=
                              static_cast<MACHINA_MACHINA_XLA_FFI_ExecutionStage>(stage))) {
    ...
    if constexpr (internal::HasRemainingArgsTag<Ts...>::value) {
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(call_frame->args.size < kNumArgs)) {
        return InvalidArgument(
            call_frame->api,
    ...
    if constexpr (internal::HasRemainingRetsTag<Ts...>::value) {
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(call_frame->rets.size < kNumRets)) {
        return InvalidArgument(
            call_frame->api,
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(kNumDictAttrs == 0 &&
 ...
 private:
  MACHINA_MACHINA_XLA_FFI_Error* PopulateMetadata(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                  MACHINA_MACHINA_XLA_FFI_Metadata_Extension* extension) const {
    if (MACHINA_MACHINA_XLA_FFI_Error* err =
            StructSizeIsGreaterOrEqual(api, "MACHINA_MACHINA_XLA_FFI_Metadata_Extension",
                                       MACHINA_MACHINA_XLA_FFI_Metadata_Extension_STRUCT_SIZE,
                                       extension->extension_base.struct_size)) {
      return err;
    }

    if (MACHINA_MACHINA_XLA_FFI_Error* err = StructSizeIsGreaterOrEqual(
            api, "MACHINA_MACHINA_XLA_FFI_Metadata", MACHINA_MACHINA_XLA_FFI_Metadata_STRUCT_SIZE,
            extension->metadata->struct_size)) {
      return err;
    }

    extension->metadata->api_version = MACHINA_MACHINA_XLA_FFI_Api_Version{
    ...
    MACHINA_MACHINA_XLA_FFI_Handler_Traits traits = 0;
    for (const auto& trait : traits_) {
      traits |= static_cast<MACHINA_MACHINA_XLA_FFI_Handler_Traits>(trait);
    }
  ...
  template <size_t... Is>
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE MACHINA_MACHINA_XLA_FFI_Error* Call(
      MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame, std::index_sequence<Is...>) const {
    ...
    if constexpr (sizeof...(Ts) > 0) {
      ...
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(!all_decoded)) {
    ...
    //   (1) Synchronous handlers that return result encoded as MACHINA_MACHINA_XLA_FFI_Error*
    //   (2) Asynchronous handlers that return result encoded as MACHINA_MACHINA_XLA_FFI_Future*
    //   (3) Handlers that can return either (1) or (2)
    static constexpr bool kIsEncodedError =
        std::is_same_v<decltype(encoded), MACHINA_MACHINA_XLA_FFI_Error*>;
    static constexpr bool kIsEncodedFuture =
        std::is_same_v<decltype(encoded), MACHINA_MACHINA_XLA_FFI_Future*>;
    static constexpr bool kIsEncodedErrorOrFuture =
        std::is_same_v<decltype(encoded),
                       std::variant<MACHINA_MACHINA_XLA_FFI_Error*, MACHINA_MACHINA_XLA_FFI_Future*>>;
  ...
  MACHINA_MACHINA_XLA_FFI_Error* FailedDecodeError(const MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame,
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(T, TYPE)                     \
  template <>                                                              \
  struct AttrDecoding<T> {                                                 \
    using Type = T;                                                        \
    MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<T> Decode(        \
        MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr, DiagnosticEngine& diagnostic) { \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR)) {        \
        return diagnostic.Emit("Wrong attribute type: expected ")          \
               << MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR << " but got " << type;          \
      }                                                                    \
                                                                           \
      auto* scalar = reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Scalar*>(attr);              \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(scalar->dtype != TYPE)) {                  \
...
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(bool, MACHINA_MACHINA_XLA_FFI_DataType_PRED);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(int8_t, MACHINA_MACHINA_XLA_FFI_DataType_S8);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(int16_t, MACHINA_MACHINA_XLA_FFI_DataType_S16);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(int32_t, MACHINA_MACHINA_XLA_FFI_DataType_S32);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(int64_t, MACHINA_MACHINA_XLA_FFI_DataType_S64);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(uint8_t, MACHINA_MACHINA_XLA_FFI_DataType_U8);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(uint16_t, MACHINA_MACHINA_XLA_FFI_DataType_U16);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(uint32_t, MACHINA_MACHINA_XLA_FFI_DataType_U32);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(uint64_t, MACHINA_MACHINA_XLA_FFI_DataType_U64);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(float, MACHINA_MACHINA_XLA_FFI_DataType_F32);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(double, MACHINA_MACHINA_XLA_FFI_DataType_F64);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(std::complex<float>,
                                      MACHINA_MACHINA_XLA_FFI_DataType_C64);
MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING(std::complex<double>,
                                      MACHINA_MACHINA_XLA_FFI_DataType_C128);

#undef MACHINA_MACHINA_XLA_FFI_REGISTER_SCALAR_ATTR_DECODING
...
struct DecodeDictionaryAttr {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
  static std::optional<T> Decode(const MACHINA_MACHINA_XLA_FFI_Attrs* attrs,
  ...
  template <size_t... Is>
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<T> Decode(
      const MACHINA_MACHINA_XLA_FFI_Attrs* attrs, std::array<std::string_view, kSize> names,
      std::index_sequence<Is...>, DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(kSize != attrs->size)) {
    ...
    // pre-compute mapping from `names` to index in the `MACHINA_MACHINA_XLA_FFI_Attrs`
...
//
//   MACHINA_MACHINA_XLA_FFI_REGISTER_STRUCT_ATTR_DECODING(
//     PairOfI64,
...
//
#define MACHINA_MACHINA_XLA_FFI_REGISTER_STRUCT_ATTR_DECODING(T, ...)                         \
  namespace xla::ffi {                                                        \
  template <>                                                                 \
  ...
  struct AttrDecoding<T> {                                                    \
    ...
    MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<T> Decode(           \
        MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr, DiagnosticEngine& diagnostic) {    \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_DICTIONARY)) {       \
        diagnostic.Emit("Wrong attribute type: expected ")                    \
            << MACHINA_MACHINA_XLA_FFI_AttrType_DICTIONARY << " but got " << type;            \
        return std::nullopt;                                                  \
      }                                                                       \
                                                                              \
      auto decoder = ::xla::ffi::internal::DictionaryDecoder<T>(__VA_ARGS__); \
      return decltype(decoder)::Decode(                                       \
          reinterpret_cast<const MACHINA_MACHINA_XLA_FFI_Attrs*>(attr),                       \
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(T)                           \
  namespace xla::ffi {                                                   \
  template <>                                                            \
  struct AttrDecoding<T> {                                               \
    using Type = T;                                                      \
    ...
    static_assert(std::is_enum<Type>::value, "Expected enum class");     \
                                                                         \
    MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(   \
        MACHINA_MACHINA_XLA_FFI_AttrType attr_type, void* attr,                          \
        DiagnosticEngine& diagnostic) {                                  \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(attr_type != MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR)) { \
        return diagnostic.Emit("Wrong attribute type: expected ")        \
               << MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR << " but got " << attr_type;   \
      }                                                                  \
                                                                         \
      auto* scalar = reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Scalar*>(attr);            \
      constexpr auto expected_dtype =                                    \
          ::xla::ffi::internal::NativeTypeToCApiDataType<U>();           \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(scalar->dtype != expected_dtype)) {      \
        return diagnostic.Emit("Wrong scalar data type: expected ")      \
...
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_UNUSED __attribute__((unused))
#else  // Non-GCC equivalents
#define MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_UNUSED
#endif

// Use captureless lambda to function pointer conversion to create a static
// MACHINA_MACHINA_XLA_FFI_Handler function pointer variable.

// Use explicit binding specification to create a handler.
#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_EXPLICIT(fn, impl, binding)                    \
  static constexpr MACHINA_MACHINA_XLA_FFI_Handler* fn = +[](MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) { \
    static auto* handler = binding.To(impl).release();                        \
    return handler->Call(call_frame);                                         \
  }

#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_EXPLICIT_WITH_TRAITS(fn, impl, binding, traits) \
  static constexpr MACHINA_MACHINA_XLA_FFI_Handler* fn = +[](MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) {  \
...
#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_AUTO(fn, impl)                                 \
  static constexpr MACHINA_MACHINA_XLA_FFI_Handler* fn = +[](MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) { \
    static auto* handler = ::xla::ffi::Ffi::BindTo(impl).release();           \
    return handler->Call(call_frame);                                         \
  }

#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_X(x, fn, impl, binding, traits, FUNC, ...) FUNC
...
#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(fn, impl, ...)                             \
  MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_X(                                               \
      , fn, impl, ##__VA_ARGS__,                                          \
      MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_EXPLICIT_WITH_TRAITS(fn, impl, __VA_ARGS__), \
      MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_EXPLICIT(fn, impl, __VA_ARGS__),             \
      MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_AUTO(fn, impl))
...
// FFI handlers.
#define MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(API, NAME, PLATFORM, FUNC, ...)    \
  MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER_(API, NAME, PLATFORM, FUNC, __COUNTER__, \
                            ##__VA_ARGS__)
#define MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER_(API, NAME, PLATFORM, FUNC, N, ...) \
  MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER__(API, NAME, PLATFORM, FUNC, N, ##__VA_ARGS__)
#define MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER__(API, NAME, PLATFORM, FUNC, N, ...)       \
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_UNUSED static const MACHINA_MACHINA_XLA_FFI_Error*                      \
...
#define MACHINA_MACHINA_XLA_FFI_DECLARE_HANDLER_SYMBOL(fn) \
  extern "C" MACHINA_MACHINA_XLA_FFI_Error* fn(MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame)

// Defines C function that implements FFI handler.
#define MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER_SYMBOL(fn, impl, ...)                           \
  extern "C" MACHINA_MACHINA_XLA_FFI_Error* fn(MACHINA_MACHINA_XLA_FFI_CallFrame* call_frame) {                \
    MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(handler, impl, ##__VA_ARGS__);                      \
    return (*handler)(call_frame);                                             \
  }                                                                            \
                                                                               \
  static_assert(                                                               \
      std::is_invocable_r_v<MACHINA_MACHINA_XLA_FFI_Error*, decltype(fn), MACHINA_MACHINA_XLA_FFI_CallFrame*>, \
      "FFI handler must return MACHINA_MACHINA_XLA_FFI_Error* and accept MACHINA_MACHINA_XLA_FFI_CallFrame*")

}  // namespace xla::ffi

#endif  // MACHINA_MACHINA_XLA_FFI_API_API_H_
