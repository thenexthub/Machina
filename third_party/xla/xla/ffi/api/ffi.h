...
#ifndef MACHINA_MACHINA_XLA_FFI_API_FFI_H_
#define MACHINA_MACHINA_XLA_FFI_API_FFI_H_

#include <string_view>
#ifdef MACHINA_MACHINA_XLA_FFI_FFI_H_
#error Two different XLA FFI implementations cannot be included together. \
       See README.md for more details.
#endif  // MACHINA_MACHINA_XLA_FFI_FFI_H_
...
using TypeId = MACHINA_MACHINA_XLA_FFI_TypeId;  // NOLINT

enum class DataType : uint8_t {
  INVALID = MACHINA_MACHINA_XLA_FFI_DataType_INVALID,
  PRED = MACHINA_MACHINA_XLA_FFI_DataType_PRED,
  S1 = MACHINA_MACHINA_XLA_FFI_DataType_S1,
  S2 = MACHINA_MACHINA_XLA_FFI_DataType_S2,
  S4 = MACHINA_MACHINA_XLA_FFI_DataType_S4,
  S8 = MACHINA_MACHINA_XLA_FFI_DataType_S8,
  S16 = MACHINA_MACHINA_XLA_FFI_DataType_S16,
  S32 = MACHINA_MACHINA_XLA_FFI_DataType_S32,
  S64 = MACHINA_MACHINA_XLA_FFI_DataType_S64,
  U1 = MACHINA_MACHINA_XLA_FFI_DataType_U1,
  U2 = MACHINA_MACHINA_XLA_FFI_DataType_U2,
  U4 = MACHINA_MACHINA_XLA_FFI_DataType_U4,
  U8 = MACHINA_MACHINA_XLA_FFI_DataType_U8,
  U16 = MACHINA_MACHINA_XLA_FFI_DataType_U16,
  U32 = MACHINA_MACHINA_XLA_FFI_DataType_U32,
  U64 = MACHINA_MACHINA_XLA_FFI_DataType_U64,
  F16 = MACHINA_MACHINA_XLA_FFI_DataType_F16,
  F32 = MACHINA_MACHINA_XLA_FFI_DataType_F32,
  F64 = MACHINA_MACHINA_XLA_FFI_DataType_F64,
  BF16 = MACHINA_MACHINA_XLA_FFI_DataType_BF16,
  C64 = MACHINA_MACHINA_XLA_FFI_DataType_C64,
  C128 = MACHINA_MACHINA_XLA_FFI_DataType_C128,
  TOKEN = MACHINA_MACHINA_XLA_FFI_DataType_TOKEN,
  F8E5M2 = MACHINA_MACHINA_XLA_FFI_DataType_F8E5M2,
  F8E4M3 = MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3,
  F8E4M3FN = MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3FN,
  F8E4M3B11FNUZ = MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3B11FNUZ,
  F8E5M2FNUZ = MACHINA_MACHINA_XLA_FFI_DataType_F8E5M2FNUZ,
  F8E4M3FNUZ = MACHINA_MACHINA_XLA_FFI_DataType_F8E4M3FNUZ,
  F8E3M4 = MACHINA_MACHINA_XLA_FFI_DataType_F8E3M4,
  F4E2M1FN = MACHINA_MACHINA_XLA_FFI_DataType_F4E2M1FN,
  F8E8M0FNU = MACHINA_MACHINA_XLA_FFI_DataType_F8E8M0FNU,
};
...
inline std::ostream& operator<<(std::ostream& os, const DataType dtype) {
  return os << static_cast<MACHINA_MACHINA_XLA_FFI_DataType>(dtype);
}
...
enum class ErrorCode : uint8_t {
  kOk = MACHINA_MACHINA_XLA_FFI_Error_Code_OK,
  kCancelled = MACHINA_MACHINA_XLA_FFI_Error_Code_CANCELLED,
  kUnknown = MACHINA_MACHINA_XLA_FFI_Error_Code_UNKNOWN,
  kInvalidArgument = MACHINA_MACHINA_XLA_FFI_Error_Code_INVALID_ARGUMENT,
  kDeadlineExceeded = MACHINA_MACHINA_XLA_FFI_Error_Code_DEADLINE_EXCEEDED,
  kNotFound = MACHINA_MACHINA_XLA_FFI_Error_Code_NOT_FOUND,
  kAlreadyExists = MACHINA_MACHINA_XLA_FFI_Error_Code_ALREADY_EXISTS,
  kPermissionDenied = MACHINA_MACHINA_XLA_FFI_Error_Code_PERMISSION_DENIED,
  kResourceExhausted = MACHINA_MACHINA_XLA_FFI_Error_Code_RESOURCE_EXHAUSTED,
  kFailedPrecondition = MACHINA_MACHINA_XLA_FFI_Error_Code_FAILED_PRECONDITION,
  kAborted = MACHINA_MACHINA_XLA_FFI_Error_Code_ABORTED,
  kOutOfRange = MACHINA_MACHINA_XLA_FFI_Error_Code_OUT_OF_RANGE,
  kUnimplemented = MACHINA_MACHINA_XLA_FFI_Error_Code_UNIMPLEMENTED,
  kInternal = MACHINA_MACHINA_XLA_FFI_Error_Code_INTERNAL,
  kUnavailable = MACHINA_MACHINA_XLA_FFI_Error_Code_UNAVAILABLE,
  kDataLoss = MACHINA_MACHINA_XLA_FFI_Error_Code_DATA_LOSS,
  kUnauthenticated = MACHINA_MACHINA_XLA_FFI_Error_Code_UNAUTHENTICATED,
};
...
class Error {
 public:
  ...
  Error(MACHINA_MACHINA_XLA_FFI_Error_Code errc, std::string message)
...
class CountDownPromise {
 public:
  ...
  bool CountDown(size_t count, const Error& error = Error::Success()) {
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(!error.success())) {
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(is_complete)) {
      bool is_error = state_->is_error.load(std::memory_order_acquire);
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(is_error)) {
        auto take_error = [&] {
          const std::lock_guard<std::mutex> lock(state_->mutex);
          return state_->error;
        };
...
class AnyBuffer {
 public:
  ...
  explicit AnyBuffer(const MACHINA_MACHINA_XLA_FFI_Buffer* buf) : buf_(buf) {
    assert(buf != nullptr && "MACHINA_MACHINA_XLA_FFI_Buffer must be non-null");
  }
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE size_t size_bytes() const {
    return ByteWidth(element_type()) * element_count();
  }

  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE size_t element_count() const {
 ...
 private:
  const MACHINA_MACHINA_XLA_FFI_Buffer* buf_;
};
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(data_type_value, actual_type) \
  template <>                                                           \
  struct DataTypeToNative<data_type_value> {                            \
    using type = actual_type;                                           \
  };

MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::PRED, bool);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::U8, uint8_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::U16, uint16_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::U32, uint32_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::U64, uint64_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::S8, int8_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::S16, int16_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::S32, int32_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::S64, int64_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::F16, uint16_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::F32, float);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::F64, double);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::BF16, uint16_t);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::C64, std::complex<float>);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::C128, std::complex<double>);
MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING(DataType::TOKEN, void);

#undef MACHINA_MACHINA_XLA_FFI_REGISTER_DATATYPE_MAPPING
...
class Buffer {
 public:
  ...
  explicit Buffer(const MACHINA_MACHINA_XLA_FFI_Buffer* buf) : buf_(buf) {
    assert(buf_ != nullptr && "MACHINA_MACHINA_XLA_FFI_Buffer must be non-null");
  }
...
MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE std::optional<Buffer<dtype, rank>> DecodeBuffer(
    MACHINA_MACHINA_XLA_FFI_Buffer* buf, DiagnosticEngine& diagnostic) {
  if (auto buf_dtype = static_cast<DataType>(buf->dtype);
      MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(buf_dtype != dtype)) {
    return diagnostic.Emit("Wrong buffer dtype: expected ")
           << dtype << " but got " << buf_dtype;
  }

  if constexpr (rank != internal::kDynamicRank) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(buf->rank != rank)) {
...
inline std::ostream& operator<<(std::ostream& os, const MACHINA_MACHINA_XLA_FFI_ArgType type) {
  switch (type) {
    case MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER:
      return os << "buffer";
  }
}
...
struct ArgDecoding<AnyBuffer> {
  ...
  static std::optional<AnyBuffer> Decode(MACHINA_MACHINA_XLA_FFI_ArgType type, void* arg,
                                         DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER)) {
      return diagnostic.Emit("Wrong argument type: expected ")
             << MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER << " but got " << type;
    }
    return AnyBuffer(reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(arg));
  }
};
...
struct ArgDecoding<Buffer<dtype, rank>> {
  ...
  static std::optional<Buffer<dtype, rank>> Decode(
      MACHINA_MACHINA_XLA_FFI_ArgType type, void* arg, DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER)) {
      return diagnostic.Emit("Wrong argument type: expected ")
             << MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER << " but got " << type;
    }
    ...
    return internal::DecodeBuffer<dtype, rank>(
        reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(arg), diagnostic);
  }
};
...
class RemainingArgs : public internal::RemainingArgsBase {
 public:
  ...
  ErrorOr<T> get(size_t index) const {
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(idx >= args()->size)) {
      return Unexpected(
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(!value.has_value())) {
...
inline std::ostream& operator<<(std::ostream& os, const MACHINA_MACHINA_XLA_FFI_RetType type) {
  switch (type) {
    case MACHINA_MACHINA_XLA_FFI_RetType_BUFFER:
      return os << "buffer";
  }
}
...
struct RetDecoding<AnyBuffer> {
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
  static std::optional<Result<AnyBuffer>> Decode(MACHINA_MACHINA_XLA_FFI_RetType type,
                                                 void* ret,
                                                 DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_RetType_BUFFER)) {
      return diagnostic.Emit("Wrong result type: expected ")
             << MACHINA_MACHINA_XLA_FFI_RetType_BUFFER << " but got " << type;
    }
    return AnyBuffer(reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(ret));
  }
};
...
struct RetDecoding<Buffer<dtype, rank>> {
  ...
  static std::optional<Result<Buffer<dtype, rank>>> Decode(
      MACHINA_MACHINA_XLA_FFI_RetType type, void* ret, DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_RetType_BUFFER)) {
      return diagnostic.Emit("Wrong result type: expected ")
             << MACHINA_MACHINA_XLA_FFI_RetType_BUFFER << " but got " << type;
    }
    ...
    return internal::DecodeBuffer<dtype, rank>(
        reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Buffer*>(ret), diagnostic);
  }
};
...
class RemainingRets : public internal::RemainingRetsBase {
 public:
  ...
  ErrorOr<Result<T>> get(size_t index) const {
    size_t idx = offset() + index;
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(idx >= rets()->size)) {
      return Unexpected(
          Error(ErrorCode::kInvalidArgument, "Index out of range"));
    }
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(T, TYPE)                       \
  template <>                                                               \
  struct AttrDecoding<Span<const T>> {                                      \
    ...
    MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(      \
      ...
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_ARRAY)) {          \
        return diagnostic.Emit("Wrong attribute type: expected ")           \
               << MACHINA_MACHINA_XLA_FFI_AttrType_ARRAY << " but got " << type;            \
      }                                                                     \
                                                                            \
      auto* array = reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Array*>(attr);                 \
      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(array->dtype != TYPE)) {                    \
...
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(int8_t, MACHINA_MACHINA_XLA_FFI_DataType_S8);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(int16_t, MACHINA_MACHINA_XLA_FFI_DataType_S16);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(int32_t, MACHINA_MACHINA_XLA_FFI_DataType_S32);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(int64_t, MACHINA_MACHINA_XLA_FFI_DataType_S64);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(uint8_t, MACHINA_MACHINA_XLA_FFI_DataType_U8);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(uint16_t, MACHINA_MACHINA_XLA_FFI_DataType_U16);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(uint32_t, MACHINA_MACHINA_XLA_FFI_DataType_U32);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(uint64_t, MACHINA_MACHINA_XLA_FFI_DataType_U64);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(float, MACHINA_MACHINA_XLA_FFI_DataType_F32);
MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING(double, MACHINA_MACHINA_XLA_FFI_DataType_F64);

#undef MACHINA_MACHINA_XLA_FFI_REGISTER_ARRAY_ATTR_DECODING

template <>
struct AttrDecoding<std::string_view> {
  using Type = std::string_view;

  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<std::string_view> Decode(
      MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr, DiagnosticEngine& diagnostic) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_STRING)) {
      return diagnostic.Emit("Wrong attribute type: expected ")
             << MACHINA_MACHINA_XLA_FFI_AttrType_STRING << " but got " << type;
    }

    auto* span = reinterpret_cast<MACHINA_MACHINA_XLA_FFI_ByteSpan*>(attr);
...
struct AttrDecoding<Pointer<T>> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(type != MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR ||
                              scalar->dtype != MACHINA_MACHINA_XLA_FFI_DataType_S64)) {
...
struct internal::Decode<internal::AttrsTag<Dictionary>> {
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Dictionary> call(
...
struct AttrDecoding<Dictionary> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Dictionary> Decode(
      MACHINA_MACHINA_XLA_FFI_AttrType type, void* attr, DiagnosticEngine& diagnostic) {
    ...
    return Dictionary(reinterpret_cast<MACHINA_MACHINA_XLA_FFI_Attrs*>(attr));
  }
};
...
inline MACHINA_MACHINA_XLA_FFI_Error* CreateError(const MACHINA_MACHINA_XLA_FFI_Api* api, const Error& error) {
  ...
  args.errc = static_cast<MACHINA_MACHINA_XLA_FFI_Error_Code>(*error.errc());
  args.message = error.message().c_str();
  return api->MACHINA_MACHINA_XLA_FFI_Error_Create(&args);
}

inline void DestroyError(const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_Error* error) {
  MACHINA_MACHINA_XLA_FFI_Error_Destroy_Args args;
  args.struct_size = MACHINA_MACHINA_XLA_FFI_Error_Destroy_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.error = error;
  api->MACHINA_MACHINA_XLA_FFI_Error_Destroy(&args);
}

inline const char* GetErrorMessage(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                   MACHINA_MACHINA_XLA_FFI_Error* error) {
  MACHINA_MACHINA_XLA_FFI_Error_GetMessage_Args args;
  args.struct_size = MACHINA_MACHINA_XLA_FFI_Error_GetMessage_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.error = error;
  api->MACHINA_MACHINA_XLA_FFI_Error_GetMessage(&args);
  return args.message;
}
...
struct ResultEncoding<stage, Error> {
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
  static MACHINA_MACHINA_XLA_FFI_Error* Encode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                               MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx, Error error) {
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_TRUE(error.success())) {
      return nullptr;
    }
...
struct ResultEncoding<ExecutionStage::kInstantiate,
  ...
  static MACHINA_MACHINA_XLA_FFI_Error* Encode(const MACHINA_MACHINA_XLA_FFI_Api* api,
    ...
    if (MACHINA_MACHINA_XLA_FFI_PREDICT_TRUE(state.has_value())) {
      MACHINA_MACHINA_XLA_FFI_State_Set_Args args;
      args.struct_size = MACHINA_MACHINA_XLA_FFI_State_Set_Args_STRUCT_SIZE;
      args.extension_start = nullptr;
      args.ctx = ctx;
      args.type_id = &T::id;
      args.state = state.value().release();
      args.deleter = +[](void* state) { delete reinterpret_cast<T*>(state); };
      return api->MACHINA_MACHINA_XLA_FFI_State_Set(&args);
    }
...
struct ResultEncoding<stage, Future> {
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE
  static std::variant<MACHINA_MACHINA_XLA_FFI_Error*, MACHINA_MACHINA_XLA_FFI_Future*> Encode(
      const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx, Future future) {
    // Create MACHINA_MACHINA_XLA_FFI_Future object that will signal completion to the runtime.
    MACHINA_MACHINA_XLA_FFI_Future_Create_Args args;
    args.struct_size = MACHINA_MACHINA_XLA_FFI_Future_Create_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.future = nullptr;

    if (auto* err = api->MACHINA_MACHINA_XLA_FFI_Future_Create(&args)) {
      return err;
    }

    assert(args.future != nullptr && "MACHINA_MACHINA_XLA_FFI_Future_Create failed");
    ...
    future.OnReady([api, f = args.future](const std::optional<Error>& error) {
      ...
      auto abort_on_error = [api](MACHINA_MACHINA_XLA_FFI_Error* err) {
        if (MACHINA_MACHINA_XLA_FFI_PREDICT_TRUE(err == nullptr)) {
          return;
        }

        std::cerr << "Failed to signal MACHINA_MACHINA_XLA_FFI_Future completion: "
                  << internal::GetErrorMessage(api, err) << std::endl;
        internal::DestroyError(api, err);
        std::abort();
      };

      if (MACHINA_MACHINA_XLA_FFI_PREDICT_FALSE(error.has_value())) {
        MACHINA_MACHINA_XLA_FFI_Future_SetError_Args args;
        args.struct_size = MACHINA_MACHINA_XLA_FFI_Future_SetError_Args_STRUCT_SIZE;
        args.extension_start = nullptr;
        args.future = f;
        args.error = internal::CreateError(api, *error);

        abort_on_error(api->MACHINA_MACHINA_XLA_FFI_Future_SetError(&args));

      } else {
        MACHINA_MACHINA_XLA_FFI_Future_SetAvailable_Args args;
        args.struct_size = MACHINA_MACHINA_XLA_FFI_Future_SetAvailable_Args_STRUCT_SIZE;
        args.extension_start = nullptr;
        args.future = f;

        abort_on_error(api->MACHINA_MACHINA_XLA_FFI_Future_SetAvailable(&args));
      }
    });
...
struct CtxDecoding<PlatformStream<T>> {
  ...
  static std::optional<Type> Decode(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                    DiagnosticEngine& diagnostic) {
    MACHINA_MACHINA_XLA_FFI_Stream_Get_Args args;
    args.struct_size = MACHINA_MACHINA_XLA_FFI_Stream_Get_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx;
    args.stream = nullptr;

    if (MACHINA_MACHINA_XLA_FFI_Error* error = api->MACHINA_MACHINA_XLA_FFI_Stream_Get(&args)) {
...
class ScratchAllocator {
 ...
 private:
  ...
  ScratchAllocator(const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                   DiagnosticEngine& diagnostic);
  ...
  const MACHINA_MACHINA_XLA_FFI_Api* api_;
  MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx_;
...
inline std::optional<void*> ScratchAllocator::Allocate(size_t size,
  ...
  args.struct_size = MACHINA_MACHINA_XLA_FFI_DeviceMemory_Allocate_Args_STRUCT_SIZE;
  args.extension_start = nullptr;
  args.ctx = ctx_;
  args.size = size;
  args.alignment = alignment;
  args.data = nullptr;
  if (MACHINA_MACHINA_XLA_FFI_Error* error = api_->MACHINA_MACHINA_XLA_FFI_DeviceMemory_Allocate(&args)) {
...
inline ScratchAllocator::ScratchAllocator(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                          MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                          DiagnosticEngine& diagnostic)
...
inline ScratchAllocator::~ScratchAllocator() {
  for (Allocation& alloc : allocations_) {
    ...
    args.struct_size = MACHINA_MACHINA_XLA_FFI_DeviceMemory_Free_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx_;
    args.size = alloc.size;
    args.data = alloc.data;
    if (MACHINA_MACHINA_XLA_FFI_Error* error = api_->MACHINA_MACHINA_XLA_FFI_DeviceMemory_Free(&args)) {
...
class ThreadPool {
 public:
  template <typename F>
  void Schedule(F&& f) {
    MACHINA_MACHINA_XLA_FFI_Task* task = +[](void* data) {
    ...
    args.struct_size = MACHINA_MACHINA_XLA_FFI_ThreadPool_Schedule_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx_;
    args.task = task;
    args.data = data;

    if (MACHINA_MACHINA_XLA_FFI_Error* error = api_->MACHINA_MACHINA_XLA_FFI_ThreadPool_Schedule(&args)) {
  ...
  int64_t num_threads() const {
    ...
    args.struct_size = MACHINA_MACHINA_XLA_FFI_ThreadPool_NumThreads_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx_;
    args.num_threads = &num_threads;

    // Silently ignore errors if we can't get the number of threads.
    if (MACHINA_MACHINA_XLA_FFI_Error* error = api_->MACHINA_MACHINA_XLA_FFI_ThreadPool_NumThreads(&args)) {
      internal::DestroyError(api_, error);
    }
 ...
 private:
  ...
  ThreadPool(const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
             DiagnosticEngine& diagnostic);
...
inline ThreadPool::ThreadPool(const MACHINA_MACHINA_XLA_FFI_Api* api,
                              MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                              DiagnosticEngine& diagnostic)
    : api_(api), ctx_(ctx), diagnostic_(diagnostic) {}
...
struct CtxDecoding<FfiApi> {
  using Type = const MACHINA_MACHINA_XLA_FFI_Api*;
...
struct CtxDecoding<FfiExecutionContext> {
  using Type = MACHINA_MACHINA_XLA_FFI_ExecutionContext*;
...
#define MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE(API, NAME, TYPE_ID) \
  MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE_(API, NAME, TYPE_ID, __COUNTER__)
#define MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE_(API, NAME, TYPE_ID, N) \
  MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE__(API, NAME, TYPE_ID, N)
#define MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE__(API, NAME, TYPE_ID, N) \
...
struct CtxDecoding<UserData<T>> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(
    ...
    args.struct_size = MACHINA_MACHINA_XLA_FFI_ExecutionContext_Get_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx;
    args.type_id = &T::id;
    args.data = nullptr;
    ...
    if (MACHINA_MACHINA_XLA_FFI_Error* err = api->MACHINA_MACHINA_XLA_FFI_ExecutionContext_Get(&args); err) {
...
struct CtxDecoding<State<T>> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(
      const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
      DiagnosticEngine& diagnostic) {
    MACHINA_MACHINA_XLA_FFI_State_Get_Args args;
    args.struct_size = MACHINA_MACHINA_XLA_FFI_State_Get_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx;
    args.type_id = &T::id;
    args.state = nullptr;
    ...
    if (MACHINA_MACHINA_XLA_FFI_Error* err = api->MACHINA_MACHINA_XLA_FFI_State_Get(&args); err) {
...
struct CtxDecoding<RunId> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(
      const MACHINA_MACHINA_XLA_FFI_Api* api, MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
      DiagnosticEngine& diagnostic) {
    MACHINA_MACHINA_XLA_FFI_RunId_Get_Args args;
    args.struct_size = MACHINA_MACHINA_XLA_FFI_ExecutionContext_Get_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx;
    args.run_id = 0;

    if (MACHINA_MACHINA_XLA_FFI_Error* err = api->MACHINA_MACHINA_XLA_FFI_RunId_Get(&args); err) {
...
struct CtxDecoding<DeviceOrdinal> {
  ...
  MACHINA_MACHINA_XLA_FFI_ATTRIBUTE_ALWAYS_INLINE static std::optional<Type> Decode(
    ...
    args.struct_size = MACHINA_MACHINA_XLA_FFI_DeviceOrdinal_Get_Args_STRUCT_SIZE;
    args.extension_start = nullptr;
    args.ctx = ctx;
    args.device_ordinal = 0;

    if (MACHINA_MACHINA_XLA_FFI_Error* err = api->MACHINA_MACHINA_XLA_FFI_DeviceOrdinal_Get(&args); err) {
...
#endif  // MACHINA_MACHINA_XLA_FFI_API_FFI_H_
