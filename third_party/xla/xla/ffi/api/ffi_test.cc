...
#include "machina/xla/ffi/api/ffi.h"
...
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Int32BasedEnum);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Int64BasedEnum);

MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Enum0);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Enum1);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Enum2);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Enum3);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(::xla::ffi::Enum4);
...
TypeId MyDataWithAutoTypeId::id = MACHINA_MACHINA_XLA_FFI_UNKNOWN_TYPE_ID;
MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE(GetXlaFfiApi(), "my_data_auto",
...
MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE(GetXlaFfiApi(), "my_data_explicit",
...
MACHINA_MACHINA_XLA_FFI_REGISTER_TYPE(GetXlaFfiApi(), "state", &MyState::id);
