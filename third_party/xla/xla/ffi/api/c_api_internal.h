...
#ifndef MACHINA_MACHINA_XLA_FFI_API_C_API_INTERNAL_H_
#define MACHINA_MACHINA_XLA_FFI_API_C_API_INTERNAL_H_
...
// caller.
typedef MACHINA_MACHINA_XLA_FFI_Error* MACHINA_MACHINA_XLA_FFI_INTERNAL_Error_Forward(void* status);
...
typedef MACHINA_MACHINA_XLA_FFI_Future* MACHINA_MACHINA_XLA_FFI_INTERNAL_Future_Forward(void* async_value);
...
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_Stream_Get(MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);

// Returns the device ordinal of the device associated with the execution
// context.
typedef int32_t MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceOrdinal_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);

// Returns the run id associated with the execution context.
typedef int64_t MACHINA_MACHINA_XLA_FFI_INTERNAL_RunId_Get(MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);
...
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceMemoryAllocator_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);

// Returns a pointer to `xla::HloComputation` if FFI handler has a called
// computation attached to it.
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_CalledComputation_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);
...
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionContext_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);
...
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionState_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);
...
typedef void* MACHINA_MACHINA_XLA_FFI_INTERNAL_IntraOpThreadPool_Get(
    MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx);
...
#define _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(fn_type) fn_type* fn_type

struct MACHINA_MACHINA_XLA_FFI_InternalApi {
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_Error_Forward);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_Future_Forward);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_Stream_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceOrdinal_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_RunId_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(
      MACHINA_MACHINA_XLA_FFI_INTERNAL_DeviceMemoryAllocator_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_CalledComputation_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionContext_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_ExecutionState_Get);
  _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD(MACHINA_MACHINA_XLA_FFI_INTERNAL_IntraOpThreadPool_Get);
};

#undef _MACHINA_MACHINA_XLA_FFI_INTERNAL_API_STRUCT_FIELD

#ifdef __cplusplus
}
#endif

#endif  // MACHINA_MACHINA_XLA_FFI_API_C_API_INTERNAL_H_
