...
// pointing into that storage in the same struct (MACHINA_MACHINA_XLA_FFI_ByteSpan). Extra care
...
struct CallFrame::Buffer {
  absl::InlinedVector<int64_t, 4> dims;  // MACHINA_MACHINA_XLA_FFI_Buffer::dims

  MACHINA_MACHINA_XLA_FFI_Buffer buffer = {MACHINA_MACHINA_XLA_FFI_Buffer_STRUCT_SIZE, nullptr};
};
...
struct CallFrame::Array {
  CallFrameBuilder::Array value;  // MACHINA_MACHINA_XLA_FFI_Array::data

  MACHINA_MACHINA_XLA_FFI_Array array = {};
};

struct CallFrame::Scalar {
  CallFrameBuilder::Scalar value;  // MACHINA_MACHINA_XLA_FFI_Scalar::value

  MACHINA_MACHINA_XLA_FFI_Scalar scalar = {};
};

struct CallFrame::String {
  std::string value;  // MACHINA_MACHINA_XLA_FFI_ByteSpan::ptr

  MACHINA_MACHINA_XLA_FFI_ByteSpan span = {};
};
...
struct CallFrame::Arguments {
  ...
  std::vector<MACHINA_MACHINA_XLA_FFI_ArgType> types;  // MACHINA_MACHINA_XLA_FFI_Args::types
  std::vector<void*> args;             // MACHINA_MACHINA_XLA_FFI_Args::args

  MACHINA_MACHINA_XLA_FFI_Args ffi_args = {MACHINA_MACHINA_XLA_FFI_Args_STRUCT_SIZE, nullptr};
};

struct CallFrame::Results {
  std::vector<Buffer> results;

  std::vector<MACHINA_MACHINA_XLA_FFI_RetType> types;  // MACHINA_MACHINA_XLA_FFI_Rets::types
  std::vector<void*> rets;             // MACHINA_MACHINA_XLA_FFI_Rets::rets

  MACHINA_MACHINA_XLA_FFI_Rets ffi_rets = {MACHINA_MACHINA_XLA_FFI_Rets_STRUCT_SIZE, nullptr};
};

struct CallFrame::Attributes {
  std::vector<NamedAttribute> attributes;

  std::vector<MACHINA_MACHINA_XLA_FFI_ByteSpan*> names;  // MACHINA_MACHINA_XLA_FFI_Attributes::names
  std::vector<MACHINA_MACHINA_XLA_FFI_AttrType> types;   // MACHINA_MACHINA_XLA_FFI_Attributes::types
  std::vector<void*> attrs;              // MACHINA_MACHINA_XLA_FFI_Attributes::attrs

  MACHINA_MACHINA_XLA_FFI_Attrs ffi_attrs = {MACHINA_MACHINA_XLA_FFI_Attrs_STRUCT_SIZE, nullptr};
};
...
MACHINA_MACHINA_XLA_FFI_CallFrame CallFrame::Build(const MACHINA_MACHINA_XLA_FFI_Api* api,
                                   MACHINA_MACHINA_XLA_FFI_ExecutionContext* ctx,
                                   MACHINA_MACHINA_XLA_FFI_ExecutionStage stage) {
  MACHINA_MACHINA_XLA_FFI_CallFrame call_frame = {MACHINA_MACHINA_XLA_FFI_CallFrame_STRUCT_SIZE, nullptr};
  call_frame.api = api;
  call_frame.ctx = ctx;
...
static MACHINA_MACHINA_XLA_FFI_DataType ToDataType(PrimitiveType primitive_type) {
  switch (primitive_type) {
    ...
    case PrimitiveType::OPAQUE_TYPE:
      return static_cast<MACHINA_MACHINA_XLA_FFI_DataType>(primitive_type);
    default:
      DCHECK(false) << "Unsupported primitive type "
                    << PrimitiveType_Name(primitive_type);
      return MACHINA_MACHINA_XLA_FFI_DataType_INVALID;
  }
}
...
std::unique_ptr<CallFrame::Arguments> CallFrame::CreateArgs(
  ...
  args->types.resize(num_args, MACHINA_MACHINA_XLA_FFI_ArgType_BUFFER);
...
std::unique_ptr<CallFrame::Arguments> CallFrame::FixUpArgs(
  ...
  // building MACHINA_MACHINA_XLA_FFI_Args.
...
std::unique_ptr<CallFrame::Results> CallFrame::CreateRets(
  ...
  rets->types.resize(num_rets, MACHINA_MACHINA_XLA_FFI_RetType_BUFFER);
...
struct CallFrame::AttributeType {
  MACHINA_MACHINA_XLA_FFI_AttrType operator()(CallFrame::Array&) {
    return MACHINA_MACHINA_XLA_FFI_AttrType_ARRAY;
  }

  MACHINA_MACHINA_XLA_FFI_AttrType operator()(CallFrame::Scalar&) {
    return MACHINA_MACHINA_XLA_FFI_AttrType_SCALAR;
  }

  MACHINA_MACHINA_XLA_FFI_AttrType operator()(CallFrame::String&) {
    return MACHINA_MACHINA_XLA_FFI_AttrType_STRING;
  }

  MACHINA_MACHINA_XLA_FFI_AttrType operator()(CallFrame::Dictionary&) {
    return MACHINA_MACHINA_XLA_FFI_AttrType_DICTIONARY;
  }
};
...
std::unique_ptr<CallFrame::Attributes> CallFrame::FixUpAttrs(
  ...
  // Initialize vectors required for building MACHINA_MACHINA_XLA_FFI_Attributes.
  for (NamedAttribute& attr : attrs->attributes) {
