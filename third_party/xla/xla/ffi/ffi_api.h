...
#ifndef MACHINA_MACHINA_XLA_FFI_FFI_API_H_
#define MACHINA_MACHINA_XLA_FFI_FFI_API_H_
...
absl::Status Call(
    MACHINA_MACHINA_XLA_FFI_Handler* handler, CallFrame& call_frame,
    const CallOptions& options = {},
...
const MACHINA_MACHINA_XLA_FFI_Api* GetXlaFfiApi();

}  // namespace xla::ffi

#endif  // MACHINA_MACHINA_XLA_FFI_FFI_API_H_
