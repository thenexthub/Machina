...
MlirAttribute mlirMhloScatterDimensionNumbersGet(
  ...
  return wrap(mlir::mhlo::ScatterDimensionNumbersAttr::get(
      unwrap(ctx), toolchain::ArrayRef(updateWindowDims, nUpdateWindowDims),
      toolchain::ArrayRef(insertedWindowDims, nInsertedWindowDims),
      toolchain::ArrayRef(inputBatchingDims, nInputBatchingDims),
      toolchain::ArrayRef(scatterIndicesBatchingDims, nScatterIndicesBatchingDims),
      toolchain::ArrayRef(scatteredDimsToOperandDims, nScatteredDimsToOperandDims),
      indexVectorDim));
}
...
MlirAttribute mlirMhloGatherDimensionNumbersGet(
  ...
  return wrap(mlir::mhlo::GatherDimensionNumbersAttr::get(
      unwrap(ctx), toolchain::ArrayRef(offsetDims, nOffsetDims),
      toolchain::ArrayRef(collapsedSliceDims, nCollapsedSliceDims),
      toolchain::ArrayRef(operandBatchingDims, nOperandBatchingDims),
      toolchain::ArrayRef(startIndicesBatchingDims, nStartIndicesBatchingDims),
      toolchain::ArrayRef(startIndexMap, nStartIndexMap), indexVectorDim));
}
...
MlirAttribute mlirMhloDotDimensionNumbersGet(
  ...
  return wrap(mlir::mhlo::DotDimensionNumbersAttr::get(
      unwrap(ctx),
      toolchain::ArrayRef(lhsBatchingDimensions, nLhsBatchingDimensions),
      toolchain::ArrayRef(rhsBatchingDimensions, nRhsBatchingDimensions),
      toolchain::ArrayRef(lhsContractingDimensions, nLhsContractingDimensions),
      toolchain::ArrayRef(rhsContractingDimensions, nRhsContractingDimensions)));
}
...
MlirAttribute mlirMhloConvDimensionNumbersGet(
  ...
  return wrap(mlir::mhlo::ConvDimensionNumbersAttr::get(
      ...
      toolchain::ArrayRef(inputSpatialDimensions, nInputSpatialDimensions),
      kernelInputFeatureDimension, kernelOutputFeatureDimension,
      toolchain::ArrayRef(kernelSpatialDimensions, nKernelSpatialDimensions),
      outputBatchDimension, outputFeatureDimension,
      toolchain::ArrayRef(outputSpatialDimensions, nOutputSpatialDimensions)));
}
...
MLIR_CAPI_EXPORTED MlirAttribute mlirMhloOutputOperandAliasGet(
  ...
  return wrap(mlir::mhlo::OutputOperandAliasAttr::get(
      unwrap(ctx), toolchain::ArrayRef(outputTupleIndices, nOutputTupleIndices),
      operandIndex, toolchain::ArrayRef(operandTupleIndices, nOperandTupleIndices)));
}
...
MlirAttribute mlirMhloTypeExtensionsGet(MlirContext ctx, intptr_t nBounds,
  ...
  return wrap(mlir::mhlo::TypeExtensionsAttr::get(
      unwrap(ctx), toolchain::ArrayRef(bounds, nBounds)));
}
