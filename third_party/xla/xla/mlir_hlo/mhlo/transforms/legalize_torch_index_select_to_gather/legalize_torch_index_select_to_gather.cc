...
struct TorchIndexSelectIsGather : public OpRewritePattern<TorchIndexSelectOp> {
  ...
  LogicalResult matchAndRewrite(TorchIndexSelectOp op,
    ...
    toolchain::SmallVector<int64_t> offsetDims;
    toolchain::SmallVector<int64_t> collapsedSliceDims;
    toolchain::SmallVector<int64_t> startIndexMap;
    toolchain::SmallVector<int64_t> sliceSizes(operandTy.getShape());
