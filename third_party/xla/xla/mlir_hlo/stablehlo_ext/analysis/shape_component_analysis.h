...
class ShapeComponentAnalysis {
 public:
  ...
  class ShapeOrValueInfo {
    toolchain::PointerIntPair<Value, 1, bool> p;
   ...
   public:
    ...
    struct DenseMapInfo {
      using PairInfo = toolchain::DenseMapInfo<decltype(p)>;
  ...
  struct SymbolicExpr {
    ...
    void dump(toolchain::raw_ostream &os = toolchain::outs()) const;
  };
...
struct DenseMapInfo<mlir::stablehlo_ext::ShapeComponentAnalysis::Symbol> {
  ...
  getEmptyKey() {
    return {mlir::stablehlo_ext::ShapeComponentAnalysis::ShapeOrValueInfo::
            ...
            toolchain::DenseMapInfo<size_t>::getEmptyKey()};
  }
  static inline mlir::stablehlo_ext::ShapeComponentAnalysis::Symbol
  getTombstoneKey() {
    return {mlir::stablehlo_ext::ShapeComponentAnalysis::ShapeOrValueInfo::
                DenseMapInfo::getTombstoneKey(),
            toolchain::DenseMapInfo<size_t>::getTombstoneKey()};
  }
  static unsigned getHashValue(
    ...
    return toolchain::hash_combine(
        ...
        toolchain::DenseMapInfo<size_t>::getHashValue(symbol.index));
  }
