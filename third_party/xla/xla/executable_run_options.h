...
#ifndef MACHINA_MACHINA_XLA_EXECUTABLE_RUN_OPTIONS_H_
#define MACHINA_MACHINA_XLA_EXECUTABLE_RUN_OPTIONS_H_
...
#endif  // MACHINA_MACHINA_XLA_EXECUTABLE_RUN_OPTIONS_H_
