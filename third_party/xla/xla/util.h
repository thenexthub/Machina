...
#ifndef MACHINA_MACHINA_XLA_UTIL_H_
#define MACHINA_MACHINA_XLA_UTIL_H_
...
#include "machina/xla/tsl/platform/errors.h"  // IWYU pragma: keep
#include "machina/xla/tsl/platform/logging.h"
#include "machina/xla/tsl/util/safe_reinterpret_cast.h"
...
//
//   MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER("fooing bar");  // nop if !VLOG_IS_ON(1).
//
// but you can control this via:
//
//   MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_LEVEL("fooing bar", 2);  // nop if !VLOG_IS_ON(2)
//
#define MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER(label) \
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER(label, 1, __COUNTER__, /*condition=*/true)
#define MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_LEVEL(label, level) \
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER(label, level, __COUNTER__, /*condition=*/true)
// The timer trace is only printed if the condition is true.
#define MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_IF(label, condition) \
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER(label, 1, __COUNTER__, (condition))
...
#define MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER(label, level, counter, condition) \
  MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER2(label, level, counter, (condition))

// Helper for macros above.  Don't use directly.
#define MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_HELPER2(label, level, counter, condition)     \
  static ::xla::TimerStats MACHINA_MACHINA_XLA_TimerStats##counter;                            \
  ::xla::ScopedLoggingTimer MACHINA_MACHINA_XLA_ScopedLoggingTimerInstance##counter(           \
      label, /*enabled=*/VLOG_IS_ON(level) && (condition), __FILE__, __LINE__, \
      &MACHINA_MACHINA_XLA_TimerStats##counter);
...
// RAII timer for MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER and MACHINA_MACHINA_XLA_SCOPED_LOGGING_TIMER_LEVEL
...
// };
//
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_PREFIX(error_type) \
  template <typename... Args>                                     \
  struct error_type {                                             \
    absl::Status status;
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_SUFFIX(error_type)        \
  /* NOLINTNEXTLINE(google-explicit-constructor) */                      \
  operator absl::Status() const { return status; }                       \
  }                                                                      \
  ;                                                                      \
...
#if defined(PLATFORM_GOOGLE)
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(error_type)               \
  MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_PREFIX(error_type)              \
  /* NOLINTNEXTLINE(google-explicit-constructor) */                      \
  error_type(const absl::FormatSpec<Args...>& format, Args&&... args,    \
      ...
      : status(WithLogBacktrace(                                         \
            absl::error_type##Error(absl::StrFormat(format, args...))    \
                .WithSourceLocation(loc))) {}                            \
  MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_SUFFIX(error_type)
#else
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(error_type)          \
  template <typename... Args>                                       \
...
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(Cancelled);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(FailedPrecondition);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(Internal);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(InvalidArgument);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(NotFound);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(ResourceExhausted);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(Unavailable);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(Unimplemented);
MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE(Unknown);

#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE
#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_PREFIX
#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRFORMAT_AND_BACKTRACE_SUFFIX
...
// };
//
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_PREFIX(error_type) \
  template <typename... Args>                                  \
  struct error_type##StrCat {                                  \
    absl::Status status;                                       \
    /* NOLINTNEXTLINE(google-explicit-constructor) */
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_SUFFIX(error_type)           \
  /* NOLINTNEXTLINE(google-explicit-constructor) */                      \
  operator absl::Status() const { return status; }                       \
  }                                                                      \
  ;                                                                      \
...
#if defined(PLATFORM_GOOGLE)
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(error_type)                       \
  MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_PREFIX(error_type)                      \
  error_type##StrCat(Args&&... concat, absl::SourceLocation loc =             \
      ...
      : status(                                                               \
            WithLogBacktrace(absl::error_type##Error(                         \
                                 ...
                                 .WithSourceLocation(loc))) {}                \
  MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_SUFFIX(error_type)
#else
#define MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(error_type)       \
  MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_PREFIX(error_type)      \
...
MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(ResourceExhausted);
MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(InvalidArgument);
MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(Unimplemented);
MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE(Internal);

#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE
#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_PREFIX
#undef MACHINA_MACHINA_XLA_ERROR_WITH_STRCAT_AND_BACKTRACE_SUFFIX
...
std::unique_ptr<Derived> unique_ptr_down_cast(std::unique_ptr<Base> ptr) {
  return absl::WrapUnique(machina::down_cast<Derived*>(ptr.release()));
}
...
#define MACHINA_MACHINA_XLA_LOG_LINES(SEV, STRING) \
...
#define MACHINA_MACHINA_XLA_VLOG_LINES(LEVEL, STRING)                   \
  do {                                                  \
    if (VLOG_IS_ON(LEVEL)) MACHINA_MACHINA_XLA_LOG_LINES(INFO, STRING); \
  } while (false)
...
#endif  // MACHINA_MACHINA_XLA_UTIL_H_
