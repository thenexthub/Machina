...
#ifndef MACHINA_MACHINA_XLA_RUNTIME_EXECUTION_GRAPH_H_
#define MACHINA_MACHINA_XLA_RUNTIME_EXECUTION_GRAPH_H_
...
#endif  // MACHINA_MACHINA_XLA_RUNTIME_EXECUTION_GRAPH_H_
