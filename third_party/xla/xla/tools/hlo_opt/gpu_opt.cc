...
#include "machina/xla/service/gpu/executable.pb.h"
...
#include "machina/xla/tools/hlo_opt/compiled_opt_lib.h"
...
class GpuOptProvider : public CompiledOptProvider {
 public:
  ...
  absl::StatusOr<std::optional<std::string>> GenerateStage(
    ...
    if (s == "toolchain-before-optimizations") {
    ...
    } else if (s == "toolchain" || s == "toolchain-after-optimizations") {
  ...
  std::set<std::string> SupportedStages() override {
    ...
    supported.insert({"ptx", "toolchain", "buffer-assignment",
                      "toolchain-before-optimizations", "toolchain-after-optimizations"});
    return supported;
  }
