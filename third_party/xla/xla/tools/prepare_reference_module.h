...
#ifndef MACHINA_XLATOOLS_PREPARE_REFERENCE_MODULE_H_
#define MACHINA_XLATOOLS_PREPARE_REFERENCE_MODULE_H_
...
#endif  // MACHINA_XLATOOLS_PREPARE_REFERENCE_MODULE_H_
