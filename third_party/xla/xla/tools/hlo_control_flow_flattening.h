...
#ifndef MACHINA_MACHINA_XLA_TOOLS_HLO_CONTROL_FLOW_FLATTENING_H_
#define MACHINA_MACHINA_XLA_TOOLS_HLO_CONTROL_FLOW_FLATTENING_H_
...
#endif  // MACHINA_MACHINA_XLA_TOOLS_HLO_CONTROL_FLOW_FLATTENING_H_
