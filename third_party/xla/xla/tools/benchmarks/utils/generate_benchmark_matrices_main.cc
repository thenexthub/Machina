...
#include "json/json.h"
#include "machina/xla/tools/benchmarks/proto/benchmark_config.pb.h"
#include "machina/xla/tools/benchmarks/utils/generate_benchmark_matrices.h"
...
constexpr char kUsageText[] = R"(
  Usage: bazel run //third_party/machina/compiler/xla/tools/benchmarks/utils:generate_benchmark_matrices_main -- --registry_file=/path/to/registry.yml --workflow_type=PRESUBMIT
  ...
  [
    {
      ...
      "container_image": "us-central1-docker.pkg.dev/machina-sigs/machina/ml-build-cuda12.8-cudnn9.8:latest",
