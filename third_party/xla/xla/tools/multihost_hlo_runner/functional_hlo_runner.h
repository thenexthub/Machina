...
#ifndef MACHINA_MACHINA_XLA_TOOLS_MULTIHOST_HLO_RUNNER_FUNCTIONAL_HLO_RUNNER_H_
#define MACHINA_MACHINA_XLA_TOOLS_MULTIHOST_HLO_RUNNER_FUNCTIONAL_HLO_RUNNER_H_
...
#include "machina/xla/tools/multihost_hlo_runner/hlo_input_output_format.h"
...
class XSpaceProfilerInterface : public ProfilerInterface {
 public:
  virtual const machina::profiler::XSpace* GetXSpace() = 0;
};
...
class HLORunnerProfiler : public XSpaceProfilerInterface {
 public:
  ...
  const machina::profiler::XSpace* GetXSpace() override;
 ...
 private:
  ...
  std::unique_ptr<machina::profiler::XSpace> xspace_;
};
...
#endif  // MACHINA_MACHINA_XLA_TOOLS_MULTIHOST_HLO_RUNNER_FUNCTIONAL_HLO_RUNNER_H_
