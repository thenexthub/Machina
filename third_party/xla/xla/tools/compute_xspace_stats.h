...
#ifndef MACHINA_XLATOOLS_COMPUTE_XSPACE_STATS_H_
#define MACHINA_XLATOOLS_COMPUTE_XSPACE_STATS_H_
...
bool IsMemcpy(const machina::profiler::XEvent& event,
...
absl::StatusOr<LineStats> ProcessLineEvents(
    const machina::profiler::XLine& line, int64_t memcpy_details_id);

absl::StatusOr<LineStats> ProcessLineEvents(
    const machina::profiler::XLine& line);
...
#endif  // MACHINA_XLATOOLS_COMPUTE_XSPACE_STATS_H_
