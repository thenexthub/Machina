...
#ifndef MACHINA_MACHINA_XLA_TOOLS_HLO_MODULE_LOADER_H_
#define MACHINA_MACHINA_XLA_TOOLS_HLO_MODULE_LOADER_H_
...
#endif  // MACHINA_MACHINA_XLA_TOOLS_HLO_MODULE_LOADER_H_
