...
#ifndef MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_DIALECTS_UTIL_H_
#define MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_DIALECTS_UTIL_H_
...
struct OffsetsSizesStrides {
  toolchain::SmallVector<int64_t> offsets;
  toolchain::SmallVector<int64_t> sizes;
  toolchain::SmallVector<int64_t> strides;
};
...
toolchain::SmallVector<InterpreterValue> NoOpTerminator(
...
toolchain::SmallVector<int64_t> EvalAffineMap(AffineMap map, ArrayRef<int64_t> dims,
                                         ArrayRef<int64_t> symbols);
toolchain::SmallVector<int64_t> EvalAffineMap(AffineMap map,
                                         ArrayRef<int64_t> operands);

}  // namespace interpreter
}  // namespace mlir

#endif  // MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_DIALECTS_UTIL_H_
