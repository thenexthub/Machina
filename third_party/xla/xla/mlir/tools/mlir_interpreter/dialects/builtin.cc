...
toolchain::SmallVector<InterpreterValue> UnrealizedConversionCast(
  ...
  if (auto r = toolchain::dyn_cast<ShapedType>(result_ty)) {
    if (auto o = toolchain::dyn_cast<ShapedType>(operand_ty)) {
  ...
  toolchain::errs() << "Unimplemented cast: " << *op << "\n";
