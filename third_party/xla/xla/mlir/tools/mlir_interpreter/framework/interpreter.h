...
#ifndef MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_FRAMEWORK_INTERPRETER_H_
#define MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_FRAMEWORK_INTERPRETER_H_
...
struct InterpreterOptions {
  ...
  std::function<void(toolchain::StringRef)> error_handler =
      [](toolchain::StringRef failure) {
        toolchain::errs() << "Interpreter failure: " << failure << "\n";
      };
...
class InterpreterState {
 public:
  ...
  void AddFailure(toolchain::StringRef failure);
  bool HasFailure() const { return failed_; }
  void CheckSuccess(LogicalResult result, toolchain::StringRef failure) {
    if (!result.succeeded()) {
      AddFailure(failure);
    }
  }
...
#endif  // MACHINA_MACHINA_XLA_MLIR_TOOLS_MLIR_INTERPRETER_FRAMEWORK_INTERPRETER_H_
