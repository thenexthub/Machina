...
TEST(InterpreterValueTest, FillUnitTensor) {
  ...
  v.Fill([](toolchain::ArrayRef<int64_t>) { return InterpreterValue{int64_t{43}}; });
  ASSERT_EQ(t.at({}), 43);
}
...
TEST(InterpreterValueTest, Fill1DTensor) {
  ...
  InterpreterValue v{t};
  v.Fill([](toolchain::ArrayRef<int64_t> indices) {
...
TEST(InterpreterValueTest, FillTensorOfVector) {
  ...
  InterpreterValue v{t};
  v.Fill([](toolchain::ArrayRef<int64_t> indices) -> InterpreterValue {
