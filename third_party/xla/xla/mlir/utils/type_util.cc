...
xla::PrimitiveType ConvertMlirTypeToPrimitiveType(mlir::Type type) {
  ...
  } else if (toolchain::isa<mlir::Float8E3M4Type>(type)) {
    return xla::PrimitiveType::F8E3M4;
  } else if (toolchain::isa<mlir::Float8E8M0FNUType>(type)) {
