...
#ifndef MACHINA_MACHINA_XLA_CORE_COLLECTIVES_CLIQUE_KEY_H_
#define MACHINA_MACHINA_XLA_CORE_COLLECTIVES_CLIQUE_KEY_H_
...
#endif  // MACHINA_MACHINA_XLA_CORE_COLLECTIVES_CLIQUE_KEY_H_
