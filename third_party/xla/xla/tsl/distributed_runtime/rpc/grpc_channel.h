...
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_CHANNEL_H_
