...
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_COORDINATION_GRPC_COORDINATION_SERVICE_IMPL_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_COORDINATION_GRPC_COORDINATION_SERVICE_IMPL_H_
...
#include "machina/xla/tsl/protobuf/coordination_service.grpc.pb.h"
...
class GrpcCoordinationServiceImpl : public AsyncServiceInterface {
 public:
  ...
  using CoordCall = Call<GrpcCoordinationServiceImpl,
                         machina::grpc::CoordinationService::AsyncService,
...
#define HANDLER(method)                                                       \
  void method##Handler(CoordCall<machina::method##Request,                 \
                                 machina::method##Response>* call) {       \
    ...
    Call<GrpcCoordinationServiceImpl,                                         \
         machina::grpc::CoordinationService::AsyncService,                 \
         machina::method##Request, machina::method##Response>::         \
...
#undef HANDLER
  ...
  machina::grpc::CoordinationService::AsyncService service_;
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_COORDINATION_GRPC_COORDINATION_SERVICE_IMPL_H_
