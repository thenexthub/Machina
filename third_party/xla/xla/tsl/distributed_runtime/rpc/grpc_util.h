...
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_UTIL_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_UTIL_H_
...
// Proto: machina::distributed_runtime::GrpcPayloadsLost
...
constexpr char kGrpcPayloadsLost[] =
    "type.googleapis.com/machina.distributed_runtime.GrpcPayloadsLost";
...
inline std::string SerializePayloads(const absl::Status& s) {
  machina::distributed_runtime::GrpcPayloadContainer container;
  s.ForEachPayload(
...
inline void InsertSerializedPayloads(absl::Status& s, std::string payloads) {
  ...
  if (container.ParseFromString(payloads)) {
    ...
    s.SetPayload(kGrpcPayloadsLost,
                 absl::Cord(machina::distributed_runtime::GrpcPayloadsLost()
                                .SerializeAsString()));
  }
}
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_RPC_GRPC_UTIL_H_
