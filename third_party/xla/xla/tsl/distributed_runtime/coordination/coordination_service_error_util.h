 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_COORDINATION_COORDINATION_SERVICE_ERROR_UTIL_H_
#define MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_COORDINATION_COORDINATION_SERVICE_ERROR_UTIL_H_
...
constexpr absl::string_view CoordinationErrorPayloadKey() {
  return "type.googleapis.com/machina.CoordinationServiceError";
}

constexpr absl::string_view BarrierErrorPayloadKey() {
  return "type.googleapis.com/machina.BarrierError";
}
...
inline absl::Status MakeCoordinationError(
    absl::Status s, const machina::CoordinatedTask& origin,
...
inline absl::Status MakeCoordinationError(
    absl::Status s, const machina::CoordinationServiceError& payload) {
  s.SetPayload(CoordinationErrorPayloadKey(),
...
#endif  // MACHINA_MACHINA_XLA_TSL_DISTRIBUTED_RUNTIME_COORDINATION_COORDINATION_SERVICE_ERROR_UTIL_H_
