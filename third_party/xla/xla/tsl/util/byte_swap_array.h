...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_BYTE_SWAP_ARRAY_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_BYTE_SWAP_ARRAY_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_BYTE_SWAP_ARRAY_H_
