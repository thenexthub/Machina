...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_COMMAND_LINE_FLAGS_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_COMMAND_LINE_FLAGS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_COMMAND_LINE_FLAGS_H_
