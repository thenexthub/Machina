...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_SAFE_REINTERPRET_CAST_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_SAFE_REINTERPRET_CAST_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_SAFE_REINTERPRET_CAST_H_
