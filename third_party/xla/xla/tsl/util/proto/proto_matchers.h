...
#ifndef MACHINA_MACHINA_XLA_TSL_UTIL_PROTO_PROTO_MATCHERS_H_
#define MACHINA_MACHINA_XLA_TSL_UTIL_PROTO_PROTO_MATCHERS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_UTIL_PROTO_PROTO_MATCHERS_H_
