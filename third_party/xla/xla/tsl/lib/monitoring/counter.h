...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COUNTER_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COUNTER_H_
...
class Counter {
 public:
  ...
  //
  // Example;
  // auto* counter_with_label = Counter<1>::New("/machina/counter",
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COUNTER_H_
