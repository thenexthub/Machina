...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_PERCENTILE_SAMPLER_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_PERCENTILE_SAMPLER_H_
...
class PercentileSampler {
 public:
  ...
  // PercentileSampler<1>::New({"/machina/sampler",
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_PERCENTILE_SAMPLER_H_
