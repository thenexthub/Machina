 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_INL_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_INL_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_INL_H_
