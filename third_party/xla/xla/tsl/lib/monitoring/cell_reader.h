 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_H_
...
#include "machina/xla/tsl/lib/monitoring/cell_reader-inl.h"
#include "machina/xla/tsl/lib/monitoring/collected_metrics.h"
#include "machina/xla/tsl/lib/monitoring/metric_def.h"
...
//
// ```
// using machina::monitoring::testing::Histogram;
// using machina::monitoring::testing::Percentiles;
//
// CellReader<int64_t> counter_reader("/machina/monitoring/test/counter");
// CellReader<Histogram> sampler_reader("/machina/monitoring/test/sampler");
// CellReader<std::string> gauge_reader("/machina/monitoring/test/gauge");
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_CELL_READER_H_
