...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_SAMPLER_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_SAMPLER_H_
...
#include "machina/xla/tsl/protobuf/histogram.pb.h"

namespace tsl {
namespace monitoring {
using machina::HistogramProto;
...
#include "machina/xla/tsl/lib/histogram/histogram.h"
...
class Sampler {
 public:
  ...
  //
  // Example;
  // auto* sampler_with_label = Sampler<1>::New({"/machina/sampler",
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_SAMPLER_H_
