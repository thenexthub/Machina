...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_METRIC_DEF_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_METRIC_DEF_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_METRIC_DEF_H_
