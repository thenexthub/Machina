...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COLLECTED_METRICS_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COLLECTED_METRICS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_COLLECTED_METRICS_H_
