...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_GAUGE_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_GAUGE_H_
...
class Gauge {
 public:
  ...
  //   "/machina/string_gauge_with_label",
  //   "String gauge with one label.", "MyLabelName");
  //
  // auto* integer_gauge = Gauge<int64, 0>::New("/machina/integer_gauge",
  //   "Integer gauge")
  //
  // auto* bool_gauge = Gauge<bool, 0>::New("/machina/bool_gauge",
  //   "Bool gauge")
  template <typename... MetricDefArgs>
  static Gauge* New(MetricDefArgs&&... metric_def_args);
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_MONITORING_GAUGE_H_
