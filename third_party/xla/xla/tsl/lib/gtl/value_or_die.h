...
#ifndef MACHINA_MACHINA_XLA_TSL_LIB_GTL_VALUE_OR_DIE_H_
#define MACHINA_MACHINA_XLA_TSL_LIB_GTL_VALUE_OR_DIE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_LIB_GTL_VALUE_OR_DIE_H_
