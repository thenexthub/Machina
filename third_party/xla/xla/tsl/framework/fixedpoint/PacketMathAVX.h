...
#ifndef MACHINA_MACHINA_XLA_TSL_FRAMEWORK_FIXEDPOINT_PACKETMATHAVX_H_
#define MACHINA_MACHINA_XLA_TSL_FRAMEWORK_FIXEDPOINT_PACKETMATHAVX_H_
#ifdef _MSC_VER
...
#endif  // MACHINA_MACHINA_XLA_TSL_FRAMEWORK_FIXEDPOINT_PACKETMATHAVX_H_
