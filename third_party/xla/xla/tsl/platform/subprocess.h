...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_SUBPROCESS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_SUBPROCESS_H_
...
#include "machina/xla/tsl/platform/google/subprocess.h"
#elif defined(PLATFORM_POSIX) || defined(PLATFORM_POSIX_ANDROID) ||    \
    defined(PLATFORM_GOOGLE_ANDROID) || defined(PLATFORM_POSIX_IOS) || \
    defined(PLATFORM_GOOGLE_IOS)
#include "machina/xla/tsl/platform/default/subprocess.h"  // IWYU pragma: export
#elif defined(PLATFORM_WINDOWS)
#include "machina/xla/tsl/platform/windows/subprocess.h"  // IWYU pragma: export
#else
#error Define the appropriate PLATFORM_<foo> macro for this platform
#endif

#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_SUBPROCESS_H_
