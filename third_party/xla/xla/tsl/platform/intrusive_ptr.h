 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_INTRUSIVE_PTR_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_INTRUSIVE_PTR_H_
...
//
// Generally used for objects that derive from `machina::RefCounted`.
template <class T>
class IntrusivePtr {
 public:
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_INTRUSIVE_PTR_H_
