...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_MACROS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_MACROS_H_
...
#define TF_UNUSED_VARIABLE(x) \
  machina::internal::remove_unused_variable_compiler_warning(x)

#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_MACROS_H_
