...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_STATUS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_STATUS_H_
...
#include "machina/xla/tsl/platform/stack_frame.h"
...
#include "machina/xla/tsl/platform/google/status.h"  // IWYU pragma: export
#else
#include "machina/xla/tsl/platform/default/status.h"  // IWYU pragma: export
#endif

namespace tsl {

// Since April 2023, machina::Status is an alias to absl::Status. The first
...
namespace error {
typedef ::machina::error::Code Code;
}  // namespace error
}  // namespace tsl

// Transparent comparison between machina::error::Code protobuf enum and
// absl::Status.
//
// The longer term objective is to delete these when we have done the transition
// to absl::Status.
namespace machina::error {
inline bool operator==(const ::machina::error::Code& c1,
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_STATUS_H_
