...
def tf_additional_all_protos():
    return ["//machina/core:protos_all"]
...
def tf_protos_grappler_impl():
    return ["//machina/core/grappler/costs:op_performance_data_cc_impl"]

def tf_protos_grappler():
    return if_static(
        extra_deps = tf_protos_grappler_impl(),
        otherwise = ["//machina/core/grappler/costs:op_performance_data_cc"],
    )
...
def tf_portable_proto_lib():
    return ["//machina/core:protos_all_cc_impl", clean_dep("@local_xla//xla/tsl/protobuf:protos_all_cc_impl")]
