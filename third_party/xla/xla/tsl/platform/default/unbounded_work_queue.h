 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_UNBOUNDED_WORK_QUEUE_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_UNBOUNDED_WORK_QUEUE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_UNBOUNDED_WORK_QUEUE_H_
