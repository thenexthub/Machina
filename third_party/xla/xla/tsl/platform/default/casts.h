...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_CASTS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_CASTS_H_
...
namespace tsl {
using ::machina::down_cast;
}

#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_DEFAULT_CASTS_H_
