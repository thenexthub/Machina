...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_CURL_HTTP_REQUEST_H_
