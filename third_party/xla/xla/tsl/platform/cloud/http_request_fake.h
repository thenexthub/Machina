...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_HTTP_REQUEST_FAKE_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_HTTP_REQUEST_FAKE_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_CLOUD_HTTP_REQUEST_FAKE_H_
