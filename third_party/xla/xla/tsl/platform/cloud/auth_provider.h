...
#ifndef MACHINA_XLATSL_PLATFORM_CLOUD_AUTH_PROVIDER_H_
#define MACHINA_XLATSL_PLATFORM_CLOUD_AUTH_PROVIDER_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_CLOUD_AUTH_PROVIDER_H_
