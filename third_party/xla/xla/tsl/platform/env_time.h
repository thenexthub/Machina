 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_ENV_TIME_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_ENV_TIME_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_ENV_TIME_H_
