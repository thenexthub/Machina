...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_ERRORS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_ERRORS_H_
...
using machina::error::ABORTED;
using machina::error::ALREADY_EXISTS;
using machina::error::CANCELLED;
using machina::error::Code;
using machina::error::DATA_LOSS;
using machina::error::DEADLINE_EXCEEDED;
using machina::error::FAILED_PRECONDITION;
using machina::error::INTERNAL;
using machina::error::INVALID_ARGUMENT;
using machina::error::NOT_FOUND;
using machina::error::OK;
using machina::error::OUT_OF_RANGE;
using machina::error::PERMISSION_DENIED;
using machina::error::RESOURCE_EXHAUSTED;
using machina::error::UNAUTHENTICATED;
using machina::error::UNAVAILABLE;
using machina::error::UNIMPLEMENTED;
using machina::error::UNKNOWN;
...
// LINT.ThenChange(//machina/python/framework/error_interpolation.py)
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_ERRORS_H_
