...
#ifndef MACHINA_XLATSL_PLATFORM_PROFILE_UTILS_I_CPU_UTILS_HELPER_H_
#define MACHINA_XLATSL_PLATFORM_PROFILE_UTILS_I_CPU_UTILS_HELPER_H_
...
#endif  // MACHINA_XLATSL_PLATFORM_PROFILE_UTILS_I_CPU_UTILS_HELPER_H_
