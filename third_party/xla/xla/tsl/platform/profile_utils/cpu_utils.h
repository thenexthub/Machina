...
#ifndef MACHINA_MACHINA_XLA_TSL_PLATFORM_PROFILE_UTILS_CPU_UTILS_H_
#define MACHINA_MACHINA_XLA_TSL_PLATFORM_PROFILE_UTILS_CPU_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PLATFORM_PROFILE_UTILS_CPU_UTILS_H_
