...
#include "machina/xla/tsl/profiler/rpc/profiler_service_impl.h"
...
#include "machina/xla/tsl/profiler/rpc/client/save_profile.h"
#include "machina/xla/tsl/profiler/utils/file_system_utils.h"
...
using machina::MonitorRequest;
using machina::MonitorResponse;
using machina::ProfileRequest;
using machina::ProfileResponse;
using machina::TerminateRequest;
using machina::TerminateResponse;
...
class ProfilerServiceImpl : public machina::grpc::ProfilerService::Service {
 public:
...
std::unique_ptr<machina::grpc::ProfilerService::Service>
