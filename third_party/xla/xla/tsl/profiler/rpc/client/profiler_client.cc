...
absl::Status ProfileGrpc(const std::string& service_address,
  ...
  std::unique_ptr<machina::grpc::ProfilerService::Stub> stub =
      CreateStub<machina::grpc::ProfilerService>(service_address);
  TF_RETURN_IF_ERROR(
...
absl::Status NewSessionGrpc(const std::string& service_address,
  ...
  ::grpc::ClientContext context;
  std::unique_ptr<machina::grpc::ProfileAnalysis::Stub> stub =
      CreateStub<machina::grpc::ProfileAnalysis>(service_address);
  TF_RETURN_IF_ERROR(
...
RemoteProfilerSession::RemoteProfilerSession(
    ...
    : response_(absl::make_unique<ProfileResponse>()),
      ...
      stub_(CreateStub<machina::grpc::ProfilerService>(service_address_)),
      deadline_(deadline),
