...
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_RPC_CLIENT_PROFILER_CLIENT_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_RPC_CLIENT_PROFILER_CLIENT_H_
...
// Note that machina/tools/def_file_filter/symbols_pybind.txt is incompatible
...
class RemoteProfilerSession {
 public:
  ...
  static std::unique_ptr<RemoteProfilerSession> Create(
      ...
      const machina::ProfileRequest& profile_request);
  ...
  // an error status.
  std::unique_ptr<machina::ProfileResponse> WaitForCompletion(
 ...
 private:
  ...
  std::unique_ptr<machina::ProfileResponse> response_;
  // Client address and connection attributes.
  std::string service_address_;
  std::unique_ptr<machina::grpc::ProfilerService::Stub> stub_;
  absl::Time deadline_;
  ::grpc::ClientContext grpc_context_;
  std::unique_ptr<
      ::grpc::ClientAsyncResponseReader<machina::ProfileResponse>>
      rpc_;
  ...
  machina::ProfileRequest profile_request_;
};

}  // namespace profiler
}  // namespace tsl

#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_RPC_CLIENT_PROFILER_CLIENT_H_
