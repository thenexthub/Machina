...
#include "machina/xla/tsl/profiler/convert/trace_events_to_json.h"
...
#include "machina/xla/tsl/profiler/rpc/client/remote_profiler_session_manager.h"
...
using machina::NewProfileSessionRequest;
using machina::NewProfileSessionResponse;
using machina::ProfileRequest;
using machina::ProfileResponse;
using machina::RemoteProfilerSessionManagerOptions;
using machina::profiler::XSpace;
...
ProfileRequest PopulateProfileRequest(
  ...
  request.add_tools("machina_stats");
