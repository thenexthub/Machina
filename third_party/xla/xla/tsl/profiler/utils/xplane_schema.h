...
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_SCHEMA_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_SCHEMA_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_SCHEMA_H_
