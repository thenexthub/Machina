...
#ifndef MACHINA_XLATSL_PROFILER_UTILS_TRACE_FILTER_UTILS_H_
#define MACHINA_XLATSL_PROFILER_UTILS_TRACE_FILTER_UTILS_H_
...
#endif  // MACHINA_XLATSL_PROFILER_UTILS_TRACE_FILTER_UTILS_H_
