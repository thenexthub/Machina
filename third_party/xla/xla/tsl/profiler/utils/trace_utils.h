...
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_TRACE_UTILS_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_TRACE_UTILS_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_TRACE_UTILS_H_
