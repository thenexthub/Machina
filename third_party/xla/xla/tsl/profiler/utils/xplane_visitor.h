 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_VISITOR_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_VISITOR_H_
...
#include "machina/xla/tsl/profiler/utils/timespan.h"
#include "tsl/profiler/protobuf/xplane.pb.h"

namespace tsl {
namespace profiler {

using machina::profiler::XEvent;          // NOLINT
using machina::profiler::XEventMetadata;  // NOLINT
using machina::profiler::XLine;           // NOLINT
using machina::profiler::XPlane;          // NOLINT
using machina::profiler::XSpace;          // NOLINT
using machina::profiler::XStat;           // NOLINT
using machina::profiler::XStatMetadata;   // NOLINT
...
#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_XPLANE_VISITOR_H_
