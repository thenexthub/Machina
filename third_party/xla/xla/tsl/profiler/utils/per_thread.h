 ...
 *
 */
#ifndef MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_PER_THREAD_H_
#define MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_PER_THREAD_H_
...
#endif  // MACHINA_MACHINA_XLA_TSL_PROFILER_UTILS_PER_THREAD_H_
