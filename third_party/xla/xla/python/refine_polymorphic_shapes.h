...
#ifndef MACHINA_XLAPYTHON_REFINE_POLYMORPHIC_SHAPES_H_
#define MACHINA_XLAPYTHON_REFINE_POLYMORPHIC_SHAPES_H_
...
#endif  // MACHINA_XLAPYTHON_REFINE_POLYMORPHIC_SHAPES_H_
