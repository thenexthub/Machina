...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_HOST_CALLBACK_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_HOST_CALLBACK_H_
...
// added.
class HostCallback : public toolchain::RTTIExtends<HostCallback, toolchain::RTTIRoot> {
 public:
...
class LoadedHostCallback
    : public tsl::ReferenceCounted<LoadedHostCallback>,
      public toolchain::RTTIExtends<LoadedHostCallback, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_HOST_CALLBACK_H_
