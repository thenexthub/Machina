...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_H_
...
class Device : public toolchain::RTTIExtends<Device, toolchain::RTTIRoot> {
 public:
  Device() = default;
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_H_
