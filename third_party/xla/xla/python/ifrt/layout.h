...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_LAYOUT_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_LAYOUT_H_
...
#include "machina/xla/python/ifrt/layout.pb.h"
...
class Layout : public toolchain::RTTIExtends<Layout, Serializable> {
 public:
...
class CompactLayout final : public toolchain::RTTIExtends<CompactLayout, Layout> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_LAYOUT_H_
