...
#include "machina/xla/python/ifrt/plugin_program.h"
...
class PluginProgramSerDes
    : public toolchain::RTTIExtends<PluginProgramSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    return absl::StrCat(kSerializationPrefix,
                        toolchain::cast<PluginProgram>(serializable).data);
  }
...
class PluginCompileOptionsSerDes
    : public toolchain::RTTIExtends<PluginCompileOptionsSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
