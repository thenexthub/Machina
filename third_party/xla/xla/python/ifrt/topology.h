...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_TOPOLOGY_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_TOPOLOGY_H_
...
class Topology : public toolchain::RTTIExtends<Topology, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_TOPOLOGY_H_
