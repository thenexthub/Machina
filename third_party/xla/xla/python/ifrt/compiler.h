...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_COMPILER_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_COMPILER_H_
...
struct CompileOptions : toolchain::RTTIExtends<CompileOptions, Serializable> {
...
// deserialization.
class Compiler : public toolchain::RTTIExtends<Compiler, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_COMPILER_H_
