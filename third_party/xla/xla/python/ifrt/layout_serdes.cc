...
#include "machina/xla/python/ifrt/layout_serdes.pb.h"
...
class CompactLayoutSerDes
    : public toolchain::RTTIExtends<CompactLayoutSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const auto* compact_layout = toolchain::cast<CompactLayout>(&serializable);
