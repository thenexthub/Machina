...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_CLIENT_H_
...
class Client : public toolchain::RTTIExtends<Client, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_CLIENT_H_
