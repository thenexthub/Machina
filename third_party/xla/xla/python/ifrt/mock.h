...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_MOCK_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_MOCK_H_
...
#include "machina/xla/python/ifrt/executable_serdes.h"
...
class MockArray : public toolchain::RTTIExtends<MockArray, Array> {
 public:
  MockArray() = default;
...
class MockClient : public toolchain::RTTIExtends<MockClient, Client> {
 public:
  MockClient() = default;
...
class MockCompiler : public toolchain::RTTIExtends<MockCompiler, Compiler> {
 public:
...
class MockExecutable : public toolchain::RTTIExtends<MockExecutable, Executable> {
 public:
...
class MockLoadedExecutable
    : public toolchain::RTTIExtends<MockLoadedExecutable, LoadedExecutable> {
 public:
...
class MockHostCallback final
    : public toolchain::RTTIExtends<MockHostCallback, HostCallback> {
 public:
...
class MockLoadedHostCallback final
    : public toolchain::RTTIExtends<MockLoadedHostCallback, LoadedHostCallback> {
 public:
  MOCK_METHOD(Client*, client, (), (const, final));
  MOCK_METHOD(absl::StatusOr<std::string>, Serialize, (), (const, final));
...
class MockSharding : public toolchain::RTTIExtends<MockSharding, Sharding> {
 public:
  MockSharding()
      : toolchain::RTTIExtends<MockSharding, Sharding>(
            BasicDeviceList::Create({}), MemoryKind(),
            /*is_fully_replicated=*/false) {}

  MockSharding(DeviceListRef devices, MemoryKind memory_kind,
               bool is_fully_replicated)
      : toolchain::RTTIExtends<MockSharding, Sharding>(devices, memory_kind,
                                                  is_fully_replicated) {}
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_MOCK_H_
