...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_H_
...
class Array : public toolchain::RTTIExtends<Array, Value> {
 public:
  Array() = default;
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_ARRAY_H_
