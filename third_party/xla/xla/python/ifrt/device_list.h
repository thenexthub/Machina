...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_LIST_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_LIST_H_
...
#include "machina/xla/python/ifrt/device.pb.h"
#include "machina/xla/python/ifrt/ref_wrapper.h"
...
class DeviceList : public tsl::ReferenceCounted<DeviceList>,
                   public toolchain::RTTIExtends<DeviceList, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_DEVICE_LIST_H_
