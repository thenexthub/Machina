...
#include "machina/xla/python/ifrt/device_test_util.h"
...
#include "machina/xla/python/ifrt/serdes_test_util.h"
...
TEST_P(CustomCallProgramSerDesTest, RoundTrip) {
  ...
  const auto* deserialized_sharding0 = toolchain::dyn_cast<ConcreteEvenSharding>(
  ...
  const auto* deserialized_sharding1 = toolchain::dyn_cast<ConcreteEvenSharding>(
