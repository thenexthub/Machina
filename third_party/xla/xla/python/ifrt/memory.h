...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_MEMORY_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_MEMORY_H_
...
class Memory : public toolchain::RTTIExtends<Memory, toolchain::RTTIRoot> {
 public:
  Memory() = default;
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_MEMORY_H_
