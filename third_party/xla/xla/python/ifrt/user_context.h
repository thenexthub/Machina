...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_USER_CONTEXT_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_USER_CONTEXT_H_
...
class UserContext : public tsl::ReferenceCounted<UserContext>,
                    public toolchain::RTTIExtends<UserContext, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_USER_CONTEXT_H_
