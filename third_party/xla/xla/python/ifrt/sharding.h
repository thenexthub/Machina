...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_SHARDING_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_SHARDING_H_
...
#include "machina/xla/python/ifrt/sharding.pb.h"
...
class Sharding : public toolchain::RTTIExtends<Sharding, Serializable> {
 public:
...
class SingleDeviceSharding final
    : public toolchain::RTTIExtends<SingleDeviceSharding, Sharding> {
 public:
...
class OpaqueSharding : public toolchain::RTTIExtends<OpaqueSharding, Sharding> {
 public:
...
class ConcreteSharding : public toolchain::RTTIExtends<ConcreteSharding, Sharding> {
 public:
...
class ConcreteEvenSharding
    : public toolchain::RTTIExtends<ConcreteEvenSharding, Sharding> {
 public:
...
class ShardingParamSharding
    : public toolchain::RTTIExtends<ShardingParamSharding, Sharding> {
 public:
  // REQUIRES: !devices.empty()
...
struct DeserializeShardingOptions
    : toolchain::RTTIExtends<DeserializeShardingOptions, DeserializeOptions> {
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_SHARDING_H_
