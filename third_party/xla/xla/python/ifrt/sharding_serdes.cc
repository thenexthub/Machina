...
#include "machina/xla/python/ifrt/sharding_serdes.pb.h"
...
class SingleDeviceShardingSerDes
    : public toolchain::RTTIExtends<SingleDeviceShardingSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const SingleDeviceSharding& sharding =
        toolchain::cast<SingleDeviceSharding>(serializable);
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    const auto* deserialize_sharding_options =
        toolchain::cast<DeserializeShardingOptions>(options.get());
...
class OpaqueShardingSerDes
    : public toolchain::RTTIExtends<OpaqueShardingSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const OpaqueSharding& sharding = toolchain::cast<OpaqueSharding>(serializable);
...
class ConcreteShardingSerDes
    : public toolchain::RTTIExtends<ConcreteShardingSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const ConcreteSharding& sharding =
        toolchain::cast<ConcreteSharding>(serializable);
...
class ConcreteEvenShardingSerDes
    : public toolchain::RTTIExtends<ConcreteEvenShardingSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const ConcreteEvenSharding& sharding =
        toolchain::cast<ConcreteEvenSharding>(serializable);
...
class ShardingParamShardingSerDes
    : public toolchain::RTTIExtends<ShardingParamShardingSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const ShardingParamSharding& sharding =
        toolchain::cast<ShardingParamSharding>(serializable);
