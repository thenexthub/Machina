...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_HLO_HLO_PROGRAM_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_HLO_HLO_PROGRAM_H_
...
class HloProgram : public toolchain::RTTIExtends<HloProgram, Program> {
 public:
  HloProgram() = default;
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_HLO_HLO_PROGRAM_H_
