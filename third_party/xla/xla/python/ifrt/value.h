...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_VALUE_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_VALUE_H_
...
class Value : public tsl::ReferenceCounted<Value>,
              public toolchain::RTTIExtends<Value, toolchain::RTTIRoot> {
 public:
  Value() = default;
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_VALUE_H_
