...
struct TestNumber : toolchain::RTTIExtends<TestNumber, Serializable> {
...
struct TestNumberSerializeOptions
    : toolchain::RTTIExtends<TestNumberSerializeOptions, SerializeOptions> {
...
struct TestNumberDeserializeOptions
    : toolchain::RTTIExtends<TestNumberDeserializeOptions, DeserializeOptions> {
  absl::Status injected_failure;
...
class TestNumberSerDes : public toolchain::RTTIExtends<TestNumberSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    if (options != nullptr) {
      auto* serialize_options =
          toolchain::cast<TestNumberSerializeOptions>(options.get());
      TF_RETURN_IF_ERROR(serialize_options->injected_failure);
    }
    const TestNumber& obj = toolchain::cast<TestNumber>(serializable);
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    if (options != nullptr) {
      auto* deserialize_options =
          toolchain::cast<TestNumberDeserializeOptions>(options.get());
