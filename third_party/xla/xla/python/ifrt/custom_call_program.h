...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_CUSTOM_CALL_PROGRAM_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_CUSTOM_CALL_PROGRAM_H_
...
struct CustomCallProgram
    : public toolchain::RTTIExtends<CustomCallProgram, Program> {
...
struct CustomCallCompileOptions
    : toolchain::RTTIExtends<CustomCallCompileOptions, CompileOptions> {
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_CUSTOM_CALL_PROGRAM_H_
