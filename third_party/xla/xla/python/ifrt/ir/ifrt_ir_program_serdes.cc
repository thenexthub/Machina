...
#include "machina/xla/python/ifrt/ir/ifrt_ir_compile_options.pb.h"
#include "machina/xla/python/ifrt/ir/ifrt_ir_program.h"
#include "machina/xla/python/ifrt/ir/ifrt_ir_program.pb.h"
...
#include "machina/xla/python/ifrt/serdes_week_4_old_version_accessor.h"
#include "machina/xla/python/ifrt/support/module_parsing.h"
...
class IfrtIRProgramSerDes
    : public toolchain::RTTIExtends<IfrtIRProgramSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const auto& program = toolchain::cast<IfrtIRProgram>(serializable);
    ...
    toolchain::raw_string_ostream ifrt_ir_program_stream(
    ...
    const auto* serialize_options =
        toolchain::dyn_cast_or_null<SerializeIfrtIRProgramOptions>(options.get());
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    const auto* deserialize_options =
        toolchain::dyn_cast_or_null<DeserializeIfrtIRProgramOptions>(options.get());
...
class IfrtIRCompileOptionsSerDes
    : public toolchain::RTTIExtends<IfrtIRCompileOptionsSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const auto& compile_options =
        toolchain::cast<IfrtIRCompileOptions>(serializable);
