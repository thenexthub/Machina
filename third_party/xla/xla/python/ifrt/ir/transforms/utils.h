...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_UTILS_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_UTILS_H_
...
struct IfrtCallOpInfo : toolchain::DenseMapInfo<xla::ifrt::CallOp> {
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_UTILS_H_
