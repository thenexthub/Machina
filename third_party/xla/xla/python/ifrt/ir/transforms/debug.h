...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_DEBUG_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_DEBUG_H_
...
// A simple wrapper that allows using `WritableFile` as `toolchain::raw_ostream`.
class AppendOnlyFileRawStream : public toolchain::raw_ostream {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_DEBUG_H_
