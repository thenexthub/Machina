...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_PASSES_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_PASSES_H_
...
#include "machina/xla/python/ifrt/ir/transforms/passes.h.inc"  // IWYU pragma: export
...
struct IfrtToOutlinedAtomProgramsPipelineOptions
  ...
  Option<bool> propagate_shardings{
      *this, "propagate_shardings",
      toolchain::cl::desc("Whether to propagate shardings from executables for "
...
struct OutlinedAtomProgramsToCompiledPipelineOptions
  ...
  ListOption<std::string> platform_names{
      *this, "platform_names",
      toolchain::cl::desc("A list to represent a mapping from logical device IDs to "
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_TRANSFORMS_PASSES_H_
