...
#ifndef MACHINA_XLAPYTHON_IFRT_IR_BASIC_ATOM_PROGRAM_COMPILER_H_
#define MACHINA_XLAPYTHON_IFRT_IR_BASIC_ATOM_PROGRAM_COMPILER_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_IR_BASIC_ATOM_PROGRAM_COMPILER_H_
