...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_VERSION_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_VERSION_H_
...
class Version {
 public:
  ...
  // invalid.
  static mlir::FailureOr<Version> fromString(toolchain::StringRef version_ref);
 ...
 private:
  toolchain::SmallVector<int64_t, 3> major_minor_patch_;
};
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_VERSION_H_
