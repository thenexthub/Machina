...
#include "machina/xla/python/ifrt/serdes.pb.h"

namespace xla {
namespace ifrt {

// NOLINTNEXTLINE
toolchain::cl::opt<bool> strip_debug_info_option(
    "strip_debuginfo", toolchain::cl::desc("Strip debug info from all operations"),
    toolchain::cl::init(false));

// NOLINTNEXTLINE
toolchain::cl::opt<std::string> ifrt_version_option(
    "ifrt_version", toolchain::cl::desc("Target version for IFRT IR serialization"),
    toolchain::cl::init("current"));

// NOLINTNEXTLINE
toolchain::cl::opt<std::string> atom_program_version_option(
    "atom_program_version",
    toolchain::cl::desc("Target version for atom program serialization"),
    toolchain::cl::init("current"));

mlir::TranslateFromMLIRRegistration serializeRegistration(
    "serialize", "Serialize IFRT IR program into a VIFRT artifact",
    [](mlir::ModuleOp module, toolchain::raw_ostream &os) -> mlir::LogicalResult {
...
mlir::TranslateToMLIRRegistration deserializeRegistration(
    ...
    [](toolchain::StringRef input,
      ...
      if (deserialized_program_or.ok()) {
        ...
        toolchain::dbgs() << "failed to deserialize: "
