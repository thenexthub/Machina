...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_IR_PROGRAM_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_IR_PROGRAM_H_
...
struct IfrtIRProgram : toolchain::RTTIExtends<IfrtIRProgram, Program> {
...
struct SerializeIfrtIRProgramOptions
    : toolchain::RTTIExtends<SerializeIfrtIRProgramOptions, SerializeOptions> {
...
struct DeserializeIfrtIRProgramOptions
    : toolchain::RTTIExtends<DeserializeIfrtIRProgramOptions, DeserializeOptions> {
...
struct IfrtIRCompileOptions
    : toolchain::RTTIExtends<IfrtIRCompileOptions, CompileOptions> {
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_IR_PROGRAM_H_
