...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_INTERFACES_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_INTERFACES_H_
  ...
  class Impl : public TraitBase<ConcreteType, Impl> {
   public:
    ...
    static LogicalResult verifyTrait(Operation* op) {
      ...
      ConcreteType concrete = toolchain::cast<ConcreteType>(op);
...
#include "machina/xla/python/ifrt/ir/ifrt_attr_interfaces.h.inc"

#define GET_OP_INTERFACE_CLASSES
#include "machina/xla/python/ifrt/ir/ifrt_op_interfaces.h.inc"

// IWYU pragma: end_exports

#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_IFRT_INTERFACES_H_
