...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_PROGRAM_INTERPRETER_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_PROGRAM_INTERPRETER_H_
...
class ProgramInterpreter {
 ...
 private:
  ...
  toolchain::DenseSet<mlir::Value> deletable_program_arguments_;
};

}  // namespace ifrt
}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_IR_PROGRAM_INTERPRETER_H_
