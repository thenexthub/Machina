...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_H_
...
struct SerializeOptions : toolchain::RTTIExtends<SerializeOptions, toolchain::RTTIRoot> {
...
struct DeserializeOptions
    : toolchain::RTTIExtends<DeserializeOptions, toolchain::RTTIRoot> {
  static char ID;  // NOLINT
};

// Base class for serializable IFRT types.
class Serializable : public toolchain::RTTIExtends<Serializable, toolchain::RTTIRoot> {
 public:
  static char ID;  // NOLINT
...
class SerDes : public toolchain::RTTIExtends<SerDes, toolchain::RTTIRoot> {
 public:
...
absl::StatusOr<std::unique_ptr<InterfaceType>> Deserialize(
  ...
  if (!toolchain::isa<InterfaceType>(result.get())) {
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_SERDES_H_
