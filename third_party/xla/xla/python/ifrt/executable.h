...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_EXECUTABLE_H_
...
#include "machina/xla/python/ifrt/execute_options.pb.h"
...
class Executable : public toolchain::RTTIExtends<Executable, toolchain::RTTIRoot> {
 public:
...
class LoadedExecutable
    : public toolchain::RTTIExtends<LoadedExecutable, toolchain::RTTIRoot> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_EXECUTABLE_H_
