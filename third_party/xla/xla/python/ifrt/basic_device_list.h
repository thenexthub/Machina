...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
...
class BasicDeviceList : public toolchain::RTTIExtends<BasicDeviceList, DeviceList> {
 public:
  ...
  bool operator==(const DeviceList& other) const override {
    ...
    const auto* other_basic_device_list =
        toolchain::dyn_cast<BasicDeviceList>(&other);
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
