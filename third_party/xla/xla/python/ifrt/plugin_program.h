...
#ifndef MACHINA_XLAPYTHON_IFRT_PLUGIN_PROGRAM_H_
#define MACHINA_XLAPYTHON_IFRT_PLUGIN_PROGRAM_H_
...
struct PluginProgram
    : public toolchain::RTTIExtends<PluginProgram, xla::ifrt::Program> {
  std::string data;
  static char ID;  // NOLINT
};

struct PluginCompileOptions
    : toolchain::RTTIExtends<PluginCompileOptions, CompileOptions> {
...
#endif  // MACHINA_XLAPYTHON_IFRT_PLUGIN_PROGRAM_H_
