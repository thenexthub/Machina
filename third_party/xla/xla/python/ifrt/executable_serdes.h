...
#ifndef MACHINA_XLAPYTHON_IFRT_EXECUTABLE_SERDES_H_
#define MACHINA_XLAPYTHON_IFRT_EXECUTABLE_SERDES_H_
...
struct DeserializeExecutableOptions
    : toolchain::RTTIExtends<DeserializeExecutableOptions, DeserializeOptions> {
...
#endif  // MACHINA_XLAPYTHON_IFRT_EXECUTABLE_SERDES_H_
