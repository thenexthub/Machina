...
#include "machina/xla/python/ifrt/array_spec.pb.h"
#include "machina/xla/python/ifrt/custom_call_program.h"
#include "machina/xla/python/ifrt/custom_call_program.pb.h"
...
class CustomCallProgramSerDes
    : public toolchain::RTTIExtends<CustomCallProgramSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const CustomCallProgram& program =
        toolchain::cast<CustomCallProgram>(serializable);
...
class CustomCallCompileOptionsSerDes
    : public toolchain::RTTIExtends<CustomCallCompileOptionsSerDes, SerDes> {
 public:
  absl::string_view type_name() const override {
