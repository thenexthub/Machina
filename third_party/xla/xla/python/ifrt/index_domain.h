...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_INDEX_DOMAIN_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_INDEX_DOMAIN_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_INDEX_DOMAIN_H_
