...
#ifndef MACHINA_XLAPYTHON_IFRT_TUPLE_H_
#define MACHINA_XLAPYTHON_IFRT_TUPLE_H_
...
class Tuple : public toolchain::RTTIExtends<Tuple, Value> {
 public:
  Tuple() = default;
...
#endif  // MACHINA_XLAPYTHON_IFRT_TUPLE_H_
