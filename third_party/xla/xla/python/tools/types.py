...
# ==============================================================================
"""machina.compiler.xla.python.tools.types.

This module provides Python bindings for various functions in
'machina/compiler/xla/python/types.h'.  It is primarily intended
...
# we cannot abide by [g-direct-machina-import].
# pylint: disable=g-direct-machina-import,unused-import
from local_xla.xla import xla_data_pb2
# pylint: enable=g-direct-machina-import,unused-import
