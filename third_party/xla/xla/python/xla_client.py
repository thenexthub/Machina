...
MACHINA_MACHINA_XLA_ELEMENT_TYPE_TO_DTYPE = {
...
DTYPE_TO_MACHINA_MACHINA_XLA_ELEMENT_TYPE = {
    str(dt): et for et, dt in MACHINA_MACHINA_XLA_ELEMENT_TYPE_TO_DTYPE.items()
}


def dtype_to_etype(dtype):
  """Convenience function for reading DTYPE_TO_MACHINA_MACHINA_XLA_ELEMENT_TYPE."""
  return DTYPE_TO_MACHINA_MACHINA_XLA_ELEMENT_TYPE[str(np.dtype(dtype))]
