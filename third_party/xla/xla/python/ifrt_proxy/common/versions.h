...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_VERSIONS_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_VERSIONS_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_COMMON_VERSIONS_H_
