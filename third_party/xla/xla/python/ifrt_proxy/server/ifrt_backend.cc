...
#include "machina/xla/python/ifrt/serdes_any_version_accessor.h"
...
#include "machina/xla/python/ifrt_proxy/common/prof_util.h"
#include "machina/xla/python/ifrt_proxy/common/proto_util.h"
#include "machina/xla/python/ifrt_proxy/common/types.h"
  ...
  auto f = [this, request = std::shared_ptr<IfrtRequest>(
        ...
        host_callback_queues;
    {
      ...
      if (!loaded_host_callbacks.empty()) {
        if (auto xla_options =
                toolchain::dyn_cast<xla::ifrt::XlaCompileOptions>(options.get())) {
