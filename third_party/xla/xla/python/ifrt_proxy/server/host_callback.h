...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_SERVER_HOST_CALLBACK_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_SERVER_HOST_CALLBACK_H_
...
class RemoteLoadedHostCallback
    : public toolchain::RTTIExtends<RemoteLoadedHostCallback,
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_SERVER_HOST_CALLBACK_H_
