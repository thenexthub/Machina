...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_CLIENT_SESSION_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_CLIENT_SESSION_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_CLIENT_SESSION_H_
