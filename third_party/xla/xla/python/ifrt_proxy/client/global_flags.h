...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_GLOBAL_FLAGS_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_GLOBAL_FLAGS_H_
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_GLOBAL_FLAGS_H_
