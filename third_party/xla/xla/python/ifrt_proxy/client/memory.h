...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MEMORY_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MEMORY_H_
...
class Memory : public toolchain::RTTIExtends<Memory, xla::ifrt::Memory> {
 public:
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_MEMORY_H_
