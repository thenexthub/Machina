...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_DEVICE_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_DEVICE_H_
...
class Device final : public toolchain::RTTIExtends<Device, xla::ifrt::Device> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_DEVICE_H_
