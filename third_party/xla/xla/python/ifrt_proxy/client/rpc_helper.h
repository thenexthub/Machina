...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_RPC_HELPER_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_RPC_HELPER_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_RPC_HELPER_H_
