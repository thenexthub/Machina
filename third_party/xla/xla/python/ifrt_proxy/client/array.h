...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_ARRAY_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_ARRAY_H_
...
class Array final : public toolchain::RTTIExtends<Array, xla::ifrt::Array> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_ARRAY_H_
