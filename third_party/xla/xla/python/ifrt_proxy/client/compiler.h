...
#ifndef MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_COMPILER_H_
#define MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_COMPILER_H_
...
class Compiler final : public toolchain::RTTIExtends<Compiler, xla::ifrt::Compiler> {
 public:
...
#endif  // MACHINA_XLAPYTHON_IFRT_PROXY_CLIENT_COMPILER_H_
