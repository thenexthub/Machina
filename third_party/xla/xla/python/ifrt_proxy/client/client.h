...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_CLIENT_H_
...
class Client final : public toolchain::RTTIExtends<Client, xla::ifrt::Client> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_CLIENT_H_
