...
#ifndef MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_EXECUTABLE_H_
...
class LoadedExecutable final
    : public toolchain::RTTIExtends<LoadedExecutable, xla::ifrt::LoadedExecutable> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_IFRT_PROXY_CLIENT_EXECUTABLE_H_
