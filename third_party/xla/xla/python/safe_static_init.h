...
#ifndef MACHINA_MACHINA_XLA_PYTHON_SAFE_STATIC_INIT_H_
#define MACHINA_MACHINA_XLA_PYTHON_SAFE_STATIC_INIT_H_
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_SAFE_STATIC_INIT_H_
