...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_LAYOUT_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_LAYOUT_H_
...
class PjRtLayout final
    : public toolchain::RTTIExtends<xla::ifrt::PjRtLayout, Layout> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_LAYOUT_H_
