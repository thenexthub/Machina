...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_HOST_CALLBACK_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_HOST_CALLBACK_H_
...
class PjRtHostSendAndRecvLoadedHostCallback
    : public toolchain::RTTIExtends<PjRtHostSendAndRecvLoadedHostCallback,
                               LoadedHostCallback> {
 public:
...
class PjRtFfiLoadedHostCallback
    : public toolchain::RTTIExtends<PjRtFfiLoadedHostCallback, LoadedHostCallback> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_HOST_CALLBACK_H_
