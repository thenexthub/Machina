...
#ifndef MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_ATTRIBUTE_MAP_UTIL_H_
#define MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_ATTRIBUTE_MAP_UTIL_H_
...
#endif  // MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_ATTRIBUTE_MAP_UTIL_H_
