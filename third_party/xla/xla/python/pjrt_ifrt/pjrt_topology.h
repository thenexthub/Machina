...
#ifndef MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_TOPOLOGY_H_
#define MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_TOPOLOGY_H_
...
class PjRtTopology final : public toolchain::RTTIExtends<PjRtTopology, Topology> {
 public:
...
#endif  // MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_TOPOLOGY_H_
