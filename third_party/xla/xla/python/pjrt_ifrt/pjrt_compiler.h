...
#ifndef MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_COMPILER_H_
#define MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_COMPILER_H_
...
class PjRtCompiler final : public toolchain::RTTIExtends<PjRtCompiler, Compiler> {
 public:
...
#endif  // MACHINA_XLAPYTHON_PJRT_IFRT_PJRT_COMPILER_H_
