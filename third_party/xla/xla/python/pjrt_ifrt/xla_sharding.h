...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_SHARDING_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_SHARDING_H_
...
class XlaCompatibleSharding
    : public toolchain::RTTIExtends<XlaCompatibleSharding, Sharding> {
 public:
  using toolchain::RTTIExtends<XlaCompatibleSharding, Sharding>::RTTIExtends;
...
class HloSharding final
    : public toolchain::RTTIExtends<HloSharding, XlaCompatibleSharding> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_SHARDING_H_
