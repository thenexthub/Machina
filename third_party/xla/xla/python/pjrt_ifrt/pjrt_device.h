...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_DEVICE_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_DEVICE_H_
...
class PjRtCompatibleDevice : public toolchain::RTTIExtends<PjRtDevice, Device> {
 public:
...
class PjRtDevice final
    : public toolchain::RTTIExtends<PjRtDevice, PjRtCompatibleDevice> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_DEVICE_H_
