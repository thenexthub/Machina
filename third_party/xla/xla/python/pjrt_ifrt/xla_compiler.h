...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_COMPILER_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_COMPILER_H_
...
struct XlaCompileOptions
    : toolchain::RTTIExtends<XlaCompileOptions, CompileOptions> {
...
struct XlaDeserializeExecutableOptions
    : toolchain::RTTIExtends<XlaDeserializeExecutableOptions,
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_MACHINA_MACHINA_XLA_COMPILER_H_
