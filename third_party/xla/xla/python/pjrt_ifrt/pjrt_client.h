...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_CLIENT_H_
...
#include "machina/xla/python/pjrt_ifrt/pjrt_compiler.h"
#include "machina/xla/python/pjrt_ifrt/transfer_server_interface.h"
...
class PjRtCompatibleClient
    : public toolchain::RTTIExtends<PjRtCompatibleClient, Client> {
 public:
...
class PjRtClient final
    : public toolchain::RTTIExtends<PjRtClient, PjRtCompatibleClient> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_CLIENT_H_
