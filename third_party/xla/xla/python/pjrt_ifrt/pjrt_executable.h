...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_EXECUTABLE_H_
...
class PjRtCompatibleExecutable
    : public toolchain::RTTIExtends<PjRtCompatibleExecutable, Executable> {
 public:
...
class PjRtCompatibleLoadedExecutable
    : public toolchain::RTTIExtends<PjRtCompatibleLoadedExecutable,
                               LoadedExecutable> {
 public:
...
class PjRtExecutable final
    : public toolchain::RTTIExtends<PjRtExecutable, PjRtCompatibleExecutable> {
 public:
...
class PjRtLoadedExecutable final
    : public toolchain::RTTIExtends<PjRtLoadedExecutable,
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_EXECUTABLE_H_
