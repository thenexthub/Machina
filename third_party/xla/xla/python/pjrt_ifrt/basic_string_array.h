...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_BASIC_STRING_ARRAY_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_BASIC_STRING_ARRAY_H_
...
class BasicStringArray final
    : public toolchain::RTTIExtends<BasicStringArray, Array> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_BASIC_STRING_ARRAY_H_
