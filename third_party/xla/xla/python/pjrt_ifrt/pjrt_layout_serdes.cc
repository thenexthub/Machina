...
#include "machina/xla/python/pjrt_ifrt/pjrt_layout.h"
#include "machina/xla/python/pjrt_ifrt/pjrt_layout_serdes.pb.h"
...
class PjRtLayoutSerDes : public toolchain::RTTIExtends<PjRtLayoutSerDes, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const auto* pjrt_layout = toolchain::cast<PjRtLayout>(&serializable);
