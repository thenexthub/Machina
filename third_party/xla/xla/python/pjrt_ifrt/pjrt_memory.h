...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_MEMORY_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_MEMORY_H_
...
class PjRtCompatibleMemory
    : public toolchain::RTTIExtends<PjRtCompatibleMemory, Memory> {
 public:
...
class PjRtMemory final
    : public toolchain::RTTIExtends<PjRtMemory, PjRtCompatibleMemory> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_MEMORY_H_
