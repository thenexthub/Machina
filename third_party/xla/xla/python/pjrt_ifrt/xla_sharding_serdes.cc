...
#include "machina/xla/python/pjrt_ifrt/xla_sharding.pb.h"
...
class HloShardingSerDes : public toolchain::RTTIExtends<HloSharding, SerDes> {
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    const HloSharding& sharding = toolchain::cast<HloSharding>(serializable);
