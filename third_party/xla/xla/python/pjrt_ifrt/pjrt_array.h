...
#ifndef MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_ARRAY_H_
#define MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_ARRAY_H_
...
class PjRtCompatibleArray
    : public toolchain::RTTIExtends<PjRtCompatibleArray, Array> {
 public:
...
class PjRtArray final
    : public toolchain::RTTIExtends<PjRtArray, PjRtCompatibleArray> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PJRT_IFRT_PJRT_ARRAY_H_
