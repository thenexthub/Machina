...
void ForEachThread(PyThreadState* curr_thread, ForEachThreadFunc&& callback) {
  ...
  // In OSS, the python runtime and machina profiler are built separately.
...
void PythonHookContext::CollectData(machina::profiler::XPlane* raw_plane) {
...
void PythonHookContext::Finalize(machina::profiler::XSpace* space) {
