...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_PYTHON_PROFILER_INTERNAL_PYTHON_HOOKS_H_
#define MACHINA_MACHINA_XLA_PYTHON_PROFILER_INTERNAL_PYTHON_HOOKS_H_
...
class PythonHookContext {
 public:
  void Finalize(machina::profiler::XSpace* space);
 ...
 private:
  ...
  void CollectData(machina::profiler::XPlane* raw_plane);
  ...
  std::optional<machina::profiler::XPlane> end_to_end_xplane_;
};
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_PROFILER_INTERNAL_PYTHON_HOOKS_H_
