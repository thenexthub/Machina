...
#include "machina/xla/python/transfer/test_pattern.h"
...
xla::ifrt::PjRtDevice* GetOtherDevice(xla::ifrt::ArrayRef arr) {
  auto* ifrt_client =
      toolchain::dyn_cast_or_null<xla::ifrt::PjRtClient>(arr->client());
  return toolchain::dyn_cast<xla::ifrt::PjRtDevice>(ifrt_client->devices()[1]);
}

xla::ifrt::PjRtClient* GetIfrtClient(xla::ifrt::ArrayRef arr) {
  return toolchain::dyn_cast_or_null<xla::ifrt::PjRtClient>(arr->client());
}

xla::Shape ShapeFromIfrt(xla::ifrt::ArrayRef arr) {
  auto* pjrt_arr =
      toolchain::dyn_cast_or_null<xla::ifrt::PjRtCompatibleArray>(arr.get());
...
void CopyIntoDest(tsl::RCReference<ChunkDestination> dest,
  ...
  std::shared_ptr<xla::PjRtClient> pjrt_client =
      machina::down_cast<xla::ifrt::PjRtClient*>(arr->client())
