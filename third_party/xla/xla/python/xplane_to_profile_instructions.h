...
#ifndef MACHINA_XLAPYTHON_XPLANE_TO_PROFILE_INSTRUCTIONS_H_
#define MACHINA_XLAPYTHON_XPLANE_TO_PROFILE_INSTRUCTIONS_H_
...
#endif  // MACHINA_XLAPYTHON_XPLANE_TO_PROFILE_INSTRUCTIONS_H_
