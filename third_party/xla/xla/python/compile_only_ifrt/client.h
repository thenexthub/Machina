...
#ifndef MACHINA_MACHINA_XLA_PYTHON_COMPILE_ONLY_IFRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_PYTHON_COMPILE_ONLY_IFRT_CLIENT_H_
...
class CompileOnlyMemory
    : public toolchain::RTTIExtends<CompileOnlyMemory, ifrt::Memory> {
 public:
...
class CompileOnlyDevice
    : public toolchain::RTTIExtends<CompileOnlyDevice, ifrt::Device> {
 public:
...
class CompileOnlyIfrtCompiler final
    : public toolchain::RTTIExtends<CompileOnlyIfrtCompiler, ifrt::Compiler> {
 public:
...
class CompileOnlyIfRtClient final
    : public toolchain::RTTIExtends<CompileOnlyIfRtClient, ifrt::Client> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_PYTHON_COMPILE_ONLY_IFRT_CLIENT_H_
