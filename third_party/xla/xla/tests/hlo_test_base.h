...
#ifndef MACHINA_MACHINA_XLA_TESTS_HLO_TEST_BASE_H_
#define MACHINA_MACHINA_XLA_TESTS_HLO_TEST_BASE_H_
...
#define MACHINA_MACHINA_XLA_TEST_NOT_MIGRATED_TO_HLO_RUNNER_PJRT
#ifdef MACHINA_MACHINA_XLA_TEST_MIGRATED_TO_HLO_RUNNER_PJRT
static_assert(false,
              "HloTestBase cannot be used in the same target as a test that "
              "has been explicitly migrated to use HloRunnerPjRt.");
#endif  // MACHINA_MACHINA_XLA_TEST_MIGRATED_TO_HLO_RUNNER_PJRT
...
#include "machina/xla/tests/hlo_runner_agnostic_reference_mixin.h"
#include "machina/xla/tests/hlo_runner_agnostic_test_base.h"
...
#endif  // MACHINA_MACHINA_XLA_TESTS_HLO_TEST_BASE_H_
