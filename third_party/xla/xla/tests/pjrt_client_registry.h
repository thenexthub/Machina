...
#ifndef MACHINA_MACHINA_XLA_TESTS_PJRT_CLIENT_REGISTRY_H_
#define MACHINA_MACHINA_XLA_TESTS_PJRT_CLIENT_REGISTRY_H_
...
#endif  // MACHINA_MACHINA_XLA_TESTS_PJRT_CLIENT_REGISTRY_H_
