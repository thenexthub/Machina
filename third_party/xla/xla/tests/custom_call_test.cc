...
#include "machina/xla/tests/client_library_test_runner_mixin.h"
#include "machina/xla/tests/hlo_pjrt_interpreter_reference_mixin.h"
#include "machina/xla/tests/hlo_pjrt_test_base.h"
...
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(BinaryOp);
MACHINA_MACHINA_XLA_FFI_REGISTER_ENUM_ATTR_DECODING(InitMethod);
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kR0F32Add2, R0F32Add2,
                       ffi::Ffi::Bind()
                           .Ret<ffi::Buffer<PrimitiveType::F32>>()
                           .Arg<ffi::Buffer<PrimitiveType::F32>>());

MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kR0F32Add2InPlace, R0F32Add2InPlace,
                       ffi::Ffi::Bind()
                           .Ret<ffi::Buffer<PrimitiveType::F32>>()
                           .Arg<ffi::Buffer<PrimitiveType::F32>>());

MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kR2F32ReduceSum, R2F32ReduceSum,
                       ffi::Ffi::Bind()
                           .Ret<ffi::Buffer<PrimitiveType::F32>>()
                           .Arg<ffi::Buffer<PrimitiveType::F32>>());

MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kAdd1ToValues, Add1ToValues,
                       ffi::Ffi::Bind()
                           .Ret<ffi::Buffer<PrimitiveType::F32>>()
                           .Arg<ffi::Buffer<PrimitiveType::F32>>());

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "R0F32Add2", PLATFORM,
                         kR0F32Add2);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "R0F32Add2InPlace", PLATFORM,
                         kR0F32Add2InPlace);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "R2F32ReduceSum", PLATFORM,
                         kR2F32ReduceSum);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "Add1ToValues", PLATFORM,
                         kAdd1ToValues);
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kAlwaysSucceed, AlwaysSucceed,
                       ffi::Ffi::Bind().Ret<AnyBuffer>()  // unused out buffer
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$always_succeed",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kAlwaysFail, AlwaysFail,
                       ffi::Ffi::Bind()
                           .Ret<AnyBuffer>()        // unused out buffer
                           .Attr<int32_t>("value")  // value
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$always_fail",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(
    kTokens, Tokens,
    ffi::Ffi::Bind().Arg<ffi::Token>().Ret<AnyBuffer>().Ret<ffi::Token>());

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$tokens", PLATFORM,
                         kTokens);
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiR0F32Add2, FfiR0F32Add2,
                       ffi::Ffi::Bind()
                           .Arg<R0F32Buffer>()  // in
                           .Ret<R0F32Buffer>()  // out
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiR0F32Add2",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiR0FAdd2BufferBase, FfiR0FAdd2BufferBase,
                       ffi::Ffi::Bind()
                           .Arg<AnyBuffer>()  // in
                           .Ret<AnyBuffer>()  // out
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(),
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiR0F32AddN, FfiR0F32AddN,
                       ffi::Ffi::Bind()
                           .Arg<R0F32Buffer>()  // in
                           .Ret<R0F32Buffer>()  // out
                           .Attr<float>("n"));

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiR0F32AddN",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiR0F32AddNPointer, FfiR0F32AddNPointer,
                       ffi::Ffi::Bind()
                           .Arg<R0F32Buffer>()  // in
                           .Ret<R0F32Buffer>()  // out
                           .Attr<ffi::Pointer<float>>("n"));

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiR0F32AddNPointer",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiF32ReduceSum, FfiF32ReduceSum,
                       ffi::Ffi::Bind()
                           .Arg<F32Buffer>()    // in
                           .Ret<R0F32Buffer>()  // out
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiF32ReduceSum",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiF32Accumulate, FfiF32Accumulate,
                       ffi::Ffi::Bind()
                           .Arg<F32Buffer>(/*in*/)
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiF32Accumulate",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiF32Add1ToValues, FfiF32Add1ToValues,
                       ffi::Ffi::Bind()
                           .Arg<F32Buffer>()  // in
                           .Ret<F32Buffer>()  // out
);

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiF32Add1ToValues",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiF32TupleSwap, FfiF32TupleSwap,
                       ffi::Ffi::Bind()
                           .Arg<R0F32Buffer>()  // in0
                           .Arg<R0F32Buffer>()  // in1
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiF32TupleSwap",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kFfiTupleRotate, FfiTupleRotate,
                       ffi::Ffi::Bind()
                           .Arg<R0F32Buffer>()  // in0
                           .Arg<R0F32Buffer>()  // in1
                           .Arg<R0F32Buffer>()  // in2
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$FfiTupleRotate",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kVerifyR2Dimensions, VerifyR2Dimensions,
                       ffi::Ffi::Bind()
                           .Arg<ffi::AnyBuffer>()  // in
                           .Attr<int32_t>("rows")
                           .Attr<int32_t>("cols"));

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$VerifyR2Dimensions",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kSwapTupleAnyBuffersToS16U32,
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kSwapTupleU32S16ToS16U32, SwapTupleU32S16ToS16U32,
                       (ffi::Ffi::Bind()
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kHandleTupleDifferentRanks, HandleTupleDifferentRanks,
                       ffi::Ffi::Bind()
                           .Arg<ffi::BufferR0<U32>>()
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kIntraOpThreadPool, CustomCallWithIntraOpThreadPool,
                       ffi::Ffi::Bind()
                           .Ret<AnyBuffer>()  // unused out buffer
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kConcat3Vectors, Concat3Vectors,
                       ffi::Ffi::Bind()
                           .Arg<ffi::BufferR2<F32>>()
                           .Arg<ffi::BufferR2<F32>>()
                           .Arg<ffi::BufferR2<F32>>()
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$Concat3Vectors",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kInstantiateState, InstantiateState,
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_test$$ffi_execution_state",
                         PLATFORM,
                         {
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kIncrementStateWithAttribute,
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kExecutionContextExecute,
                       ExecutionContext<ffi::ExecutionStage::kExecute>,
                       ffi::Ffi::Bind<ffi::ExecutionStage::kExecute>()
                           .Ret<ffi::AnyBuffer>()
                           .Ctx<ffi::UserData<SomeExtraContext>>());

MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "xla.cpu.ffi_execution_context",
                         PLATFORM,
                         {
                             /*instantiate=*/nullptr,
                             /*prepare=*/nullptr,
