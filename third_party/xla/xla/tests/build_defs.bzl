...
def xla_test(
    ...
    The build rule defines the preprocessor macro MACHINA_MACHINA_XLA_TEST_BACKEND_${BACKEND}
    ...
    for backend in backends:
        ...
        xla_cc_test(
            ...
            env = env | {
                "MACHINA_MACHINA_XLA_TEST_DEVICE": device,
                "MACHINA_MACHINA_XLA_TEST_DEVICE_TYPE": device_type_for_env,
                "MACHINA_MACHINA_XLA_TEST_MODIFIERS": ",".join(modifiers),
            },
