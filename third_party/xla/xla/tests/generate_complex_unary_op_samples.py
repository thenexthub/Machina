...
Usage:
  Running
    python /path/to/generate_complex_unary_op_samples.py [xla | machina]
  will create
...
def main():
  ...
  assert target in {'xla', 'machina'}, target
  header_file_define = dict(
      xla='MACHINA_MACHINA_XLA_TESTS_COMPLEX_UNARY_OP_SAMPLES_H_',
      machina='MACHINA_COMPILER_MACHINA_MACHINA_XLA_TESTS_COMPLEX_UNARY_OP_SAMPLES_H_',
  )[target]
  default_size = 7
