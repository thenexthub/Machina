...
#ifndef MACHINA_MACHINA_XLA_TESTS_HLO_RUNNER_AGNOSTIC_REFERENCE_MIXIN_H_
#define MACHINA_MACHINA_XLA_TESTS_HLO_RUNNER_AGNOSTIC_REFERENCE_MIXIN_H_
...
#endif  // MACHINA_MACHINA_XLA_TESTS_HLO_RUNNER_AGNOSTIC_REFERENCE_MIXIN_H_
