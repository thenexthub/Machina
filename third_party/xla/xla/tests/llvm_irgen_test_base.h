...
#ifndef MACHINA_MACHINA_XLA_TESTS_LLVM_IRGEN_TEST_BASE_H_
#define MACHINA_MACHINA_XLA_TESTS_LLVM_IRGEN_TEST_BASE_H_

#include <string>

#include "machina/xla/service/llvm_compiler.h"
#include "machina/xla/tests/codegen_test_base.h"
...
class LlvmIrGenTestBase : public CodegenTestBase {
 protected:
  ...
  // (http://toolchain.org/docs/CommandGuide/FileCheck.html).
  //
 ...
 private:
  ...
  std::string ir_;
  absl::Status IrHook(const toolchain::Module& module);
};

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_TESTS_LLVM_IRGEN_TEST_BASE_H_
