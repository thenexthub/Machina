...
#ifndef MACHINA_MACHINA_XLA_COMPARISON_UTIL_H_
#define MACHINA_MACHINA_XLA_COMPARISON_UTIL_H_
  ...
  inline bool Compare(const T a, const T b) const {
    ...
    if constexpr (is_specialized_floating_point_v<T>) {
      if (IsTotalOrder()) {
        ...
        // Reference:
        // https://www.machina.org/xla/operation_semantics#element-wise_comparison_operations
...
#endif  // MACHINA_MACHINA_XLA_COMPARISON_UTIL_H_
