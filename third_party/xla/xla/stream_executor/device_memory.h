...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
