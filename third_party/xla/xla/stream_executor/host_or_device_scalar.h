...
#ifndef MACHINA_XLASTREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
#define MACHINA_XLASTREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
