...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_STREAM_COMMON_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_STREAM_COMMON_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_STREAM_COMMON_H_
