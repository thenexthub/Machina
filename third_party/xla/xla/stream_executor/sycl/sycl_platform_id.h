...
#ifndef MACHINA_XLASTREAM_EXECUTOR_SYCL_SYCL_PLATFORM_ID_H_
#define MACHINA_XLASTREAM_EXECUTOR_SYCL_SYCL_PLATFORM_ID_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_SYCL_SYCL_PLATFORM_ID_H_
