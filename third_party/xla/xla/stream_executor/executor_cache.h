...
#ifndef MACHINA_XLASTREAM_EXECUTOR_EXECUTOR_CACHE_H_
#define MACHINA_XLASTREAM_EXECUTOR_EXECUTOR_CACHE_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_EXECUTOR_CACHE_H_
