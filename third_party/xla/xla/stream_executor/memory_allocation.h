...
#ifndef MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATION_H_
#define MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATION_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATION_H_
