...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCSOLVER_WRAPPER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCSOLVER_WRAPPER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCSOLVER_WRAPPER_H_
