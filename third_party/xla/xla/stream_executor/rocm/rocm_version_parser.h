...
#ifndef MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_VERSION_PARSER_H_
#define MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_VERSION_PARSER_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_VERSION_PARSER_H_
