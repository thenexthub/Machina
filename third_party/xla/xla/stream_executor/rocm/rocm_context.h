...
#ifndef MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_CONTEXT_H_
#define MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_CONTEXT_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_ROCM_ROCM_CONTEXT_H_
