...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCM_SOLVER_CONTEXT_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCM_SOLVER_CONTEXT_H_
...
#define MACHINA_USE_HIPSOLVER (TF_ROCM_VERSION >= 40500)
#define MACHINA_USE_ROCSOLVER (TF_ROCM_VERSION < 40500)

#include "rocm/rocm_config.h"
// Macros to ease the transition from rocsolver to hipsolver.
#if MACHINA_USE_HIPSOLVER
#include "machina/xla/stream_executor/rocm/hipsolver_wrapper.h"
using gpusolverHandle_t = hipsolverHandle_t;
#else  // MACHINA_USE_ROCSOLVER
#include "machina/xla/stream_executor/rocm/rocblas_wrapper.h"
#include "machina/xla/stream_executor/rocm/rocsolver_wrapper.h"
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_ROCM_ROCM_SOLVER_CONTEXT_H_
