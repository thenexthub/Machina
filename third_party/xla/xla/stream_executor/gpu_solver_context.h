...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_SOLVER_CONTEXT_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_SOLVER_CONTEXT_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_SOLVER_CONTEXT_H_
