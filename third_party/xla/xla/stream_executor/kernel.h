...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_KERNEL_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_KERNEL_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_KERNEL_H_
