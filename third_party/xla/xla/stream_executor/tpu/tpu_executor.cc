...
#include "machina/xla/stream_executor/tpu/tpu_event.h"
#include "machina/xla/stream_executor/tpu/tpu_executor_api.h"
#include "machina/xla/stream_executor/tpu/tpu_stream.h"
...
machina::tpu::TpuCoreLocationExternal TpuExecutor::GetCoreLocationExternal()
    const {
  return machina::tpu::TpuCoreLocationExternal(
...
absl::StatusOr<std::unique_ptr<Stream>> TpuExecutor::CreateStream(
  ...
  auto stream = std::make_unique<machina::tpu::TpuStream>(
