...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_H_
...
#include "machina/xla/stream_executor/allocator_stats.h"
...
#include "machina/xla/stream_executor/tpu/tpu_executor_interface.h"
...
class TpuExecutor : public machina::tpu::TpuExecutorInterface {
 public:
  using StatusCallback = std::function<void(const absl::Status&)>;

  TpuExecutor(::machina::tpu::TpuPlatformInterface* platform,
  ...
  machina::tpu::TpuCoreLocationExternal GetCoreLocationExternal()
      const override;
  ...
  const ::machina::tpu::TpuPlatformInterface& platform() const override {
    return *platform_;
  }

  ::machina::tpu::TpuPlatformInterface& platform() override {
    return *platform_;
  }
  ...
  absl::StatusOr<std::unique_ptr<
      machina::tpu::TpuExecutorInterface::TemporaryDeviceMemory>>
 ...
 private:
  machina::tpu::TpuPlatform& tpu_platform() {
    return *(machina::down_cast<machina::tpu::TpuPlatform*>(platform_));
  }

  machina::tpu::TpuPlatform::StreamMap& stream_map() {
  ...
  machina::tpu::TpuPlatformInterface* platform_;
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_EXECUTOR_H_
