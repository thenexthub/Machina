...
#include "machina/xla/stream_executor/tpu/tpu_executable.h"
...
class TpuCompiler : public Compiler {
 public:
  ...
  stream_executor::Platform::Id PlatformId() const override {
    return machina::tpu::GetTpuPlatformId();
  }
  ...
  absl::StatusOr<std::unique_ptr<HloModule>> RunHloPasses(
    ...
    MACHINA_MACHINA_XLA_HloModule hlo_module;
    ...
    MACHINA_MACHINA_XLA_HloModule result;
    StatusHelper status;
  ...
  absl::StatusOr<std::vector<std::unique_ptr<Executable>>> Compile(
      ...
      const CompileOptions& options) override {
    MACHINA_MACHINA_XLA_HloModuleGroup se_module_group;
    se_module_group.proto =
        stream_executor::tpu::SerializeProto(module_group->ToProto());
    se_module_group.module_config =
        new MACHINA_MACHINA_XLA_HloModuleConfig[module_group->size()];
  ...
  Shape DefaultDeviceShapeRepresentation(const Shape& shape) const override {
    MACHINA_MACHINA_XLA_Shape host_shape, device_shape;
