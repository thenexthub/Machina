...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_STREAM_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_STREAM_H_
...
class TpuStream : public machina::tpu::TpuStreamInterface {
 public:
  ...
  bool IsSameSharedMemoryLocation(
      machina::tpu::TpuStreamInterface* other) override {
 ...
 private:
  ...
  machina::tpu::TpuPlatform* tpu_platform_;
};

}  // namespace tpu
}  // namespace machina

#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_STREAM_H_
