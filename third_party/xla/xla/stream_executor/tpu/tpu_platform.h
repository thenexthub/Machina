...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_PLATFORM_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_PLATFORM_H_
...
#include "machina/xla/stream_executor/tpu/tpu_executor_c_api.h"  // IWYU pragma: keep
...
class TpuPlatform : public ::machina::tpu::TpuPlatformInterface {
 public:
  ...
  const machina::tpu::TpuHostLocationExternal GetTpuHostLocation()
      const override;
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_TPU_PLATFORM_H_
