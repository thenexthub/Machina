...
#ifndef MACHINA_XLASTREAM_EXECUTOR_TPU_STATUS_HELPER_H_
#define MACHINA_XLASTREAM_EXECUTOR_TPU_STATUS_HELPER_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_TPU_STATUS_HELPER_H_
