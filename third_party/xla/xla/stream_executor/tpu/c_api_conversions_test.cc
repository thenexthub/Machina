...
TEST(XlaTile, ToCInlined) {
  ...
  MACHINA_MACHINA_XLA_Tile c_tile;
  ToC(cpp_tile, &c_tile);
...
TEST(XlaTile, FromCInlined) {
  ...
  MACHINA_MACHINA_XLA_Tile c_tile{tile_dimensions};
...
void XlaLayout_ToC(const xla::Layout& cpp_layout) {
  MACHINA_MACHINA_XLA_Layout c_layout;
  ...
  MACHINA_MACHINA_XLA_Tile* tile_base =
...
TEST(XlaHloModuleConfig, ToAndFromC) {
  ...
  MACHINA_MACHINA_XLA_HloModuleConfig c_config = ToC(in_config);
...
TEST(XlaHloModule, ToAndFromC) {
  ...
  MACHINA_MACHINA_XLA_HloModule c_module = ToC(in_module);
