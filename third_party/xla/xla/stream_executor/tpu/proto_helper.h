...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_PROTO_HELPER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_PROTO_HELPER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_PROTO_HELPER_H_
