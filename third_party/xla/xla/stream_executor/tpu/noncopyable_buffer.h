...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_NONCOPYABLE_BUFFER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_NONCOPYABLE_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_TPU_NONCOPYABLE_BUFFER_H_
