...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_MAKE_BATCH_POINTERS_KERNEL_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_MAKE_BATCH_POINTERS_KERNEL_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_MAKE_BATCH_POINTERS_KERNEL_H_
