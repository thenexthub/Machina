...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_ACTIVATE_CONTEXT_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_ACTIVATE_CONTEXT_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_SCOPED_ACTIVATE_CONTEXT_H_
