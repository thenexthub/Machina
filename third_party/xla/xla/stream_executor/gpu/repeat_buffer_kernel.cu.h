...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_REPEAT_BUFFER_KERNEL_CU_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_REPEAT_BUFFER_KERNEL_CU_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_REPEAT_BUFFER_KERNEL_CU_H_
