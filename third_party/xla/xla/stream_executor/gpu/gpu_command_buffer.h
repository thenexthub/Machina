...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_COMMAND_BUFFER_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_COMMAND_BUFFER_H_
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_COMMAND_BUFFER_H_
