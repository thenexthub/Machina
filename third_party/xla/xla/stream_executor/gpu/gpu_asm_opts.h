...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_ASM_OPTS_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_ASM_OPTS_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_GPU_ASM_OPTS_H_
