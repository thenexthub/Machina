...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_BLAS_LT_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_BLAS_LT_H_
...
#include "machina/xla/stream_executor/gpu/gpu_blas_lt.pb.h"
#include "machina/xla/stream_executor/host_or_device_scalar.h"
...
struct BlasLt {
  ...
  struct MatmulPlan {
    ...
    // see machina/core/kernels/matmul_util.cc
    ...
    // This version is used by TF: see machina/core/kernels/matmul_util.cc
    absl::Status ExecuteOnStream(
        Stream* stream, DeviceMemoryBase a, DeviceMemoryBase b,
        DeviceMemoryBase c, DeviceMemoryBase d,
        DeviceMemoryBase bias,  // may be null
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_GPU_GPU_BLAS_LT_H_
