...
#ifndef MACHINA_XLASTREAM_EXECUTOR_GPU_TOPK_KERNEL_H_
#define MACHINA_XLASTREAM_EXECUTOR_GPU_TOPK_KERNEL_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_GPU_TOPK_KERNEL_H_
