...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_FFT_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_FFT_H_
...
#define MACHINA_STREAM_EXECUTOR_GPU_FFT_SUPPORT_OVERRIDES                   \
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_FFT_H_
