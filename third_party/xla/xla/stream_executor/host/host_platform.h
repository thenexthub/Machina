...
#ifndef MACHINA_XLASTREAM_EXECUTOR_HOST_HOST_PLATFORM_H_
#define MACHINA_XLASTREAM_EXECUTOR_HOST_HOST_PLATFORM_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_HOST_HOST_PLATFORM_H_
