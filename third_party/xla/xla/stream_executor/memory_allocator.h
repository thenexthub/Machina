...
#ifndef MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATOR_H_
#define MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATOR_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_MEMORY_ALLOCATOR_H_
