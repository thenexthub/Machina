...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DNN_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DNN_H_
...
// int64_t is not the same type as machina::protobuf_int64 in open-source.
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_DNN_H_
