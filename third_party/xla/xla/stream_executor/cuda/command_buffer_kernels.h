...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
