...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_DRIVER_COMPILATION_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_DRIVER_COMPILATION_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_DRIVER_COMPILATION_H_
