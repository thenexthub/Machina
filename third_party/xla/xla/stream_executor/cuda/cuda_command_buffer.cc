...
#include "machina/xla/stream_executor/bit_pattern.h"
#include "machina/xla/stream_executor/command_buffer.h"
#include "machina/xla/stream_executor/cuda/command_buffer_kernels.h"
...
#include "machina/xla/stream_executor/gpu/gpu_command_buffer.h"
#include "machina/xla/stream_executor/gpu/scoped_update_mode.h"
...
#include "machina/xla/stream_executor/typed_kernel_factory.h"  // IWYU pragma: keep
...
absl::StatusOr<GraphNodeHandle> CudaCommandBuffer::CreateChildNode(
  ...
  CUgraph child_graph =
      machina::down_cast<const CudaCommandBuffer&>(nested).graph_;
