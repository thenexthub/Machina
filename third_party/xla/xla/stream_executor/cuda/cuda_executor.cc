...
#include "machina/xla/stream_executor/cuda/cuda_executor.h"
...
#include "machina/xla/stream_executor/cuda/cuda_command_buffer.h"
#include "machina/xla/stream_executor/cuda/cuda_context.h"
#include "machina/xla/stream_executor/cuda/cuda_event.h"
#include "machina/xla/stream_executor/cuda/cuda_kernel.h"
#include "machina/xla/stream_executor/cuda/cuda_platform_id.h"
#include "machina/xla/stream_executor/cuda/cuda_status.h"
#include "machina/xla/stream_executor/cuda/cuda_stream.h"
#include "machina/xla/stream_executor/cuda/cuda_timer.h"
#include "machina/xla/stream_executor/cuda/cuda_version_parser.h"
#include "machina/xla/stream_executor/cuda/tma_util.h"
...
absl::Status EnablePeerAccess(Context* from, Context* to) {
  ...
  CUresult result = cuCtxEnablePeerAccess(
      machina::down_cast<CudaContext*>(to)->context(), 0 /* = flags */);
