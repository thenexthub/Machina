...
#ifndef MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_BLAS_H_
#define MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_BLAS_H_
...
class CUDABlas : public blas::BlasSupport {
 public:
  ...
  MACHINA_STREAM_EXECUTOR_GPU_BLAS_SUPPORT_OVERRIDES
...
#endif  // MACHINA_MACHINA_XLA_STREAM_EXECUTOR_CUDA_CUDA_BLAS_H_
