...
#ifndef MACHINA_XLASTREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
#define MACHINA_XLASTREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
...
#endif  // MACHINA_XLASTREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
