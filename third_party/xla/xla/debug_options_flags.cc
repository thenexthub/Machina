...
#include "machina/xla/debug_options_parsers.h"
#include "machina/xla/parse_flags_from_env.h"
...
#ifdef MACHINA_MACHINA_XLA_CPU_USE_ACL
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "Whether to reset MACHINA_MACHINA_XLA_FLAGS next time to parse."));
  flag_list->push_back(tsl::Flag(
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "Decide whether to force inline before toolchain module split to get a more "
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "dumped "
      "MLIR will be in the toolchain-parsable format and can be processed by "
      "mlir-opt tools. "
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "Sets how often we verify the generated toolchain modules. Higher "
...
static void AllocateFlags(DebugOptions* defaults) {
  ...
  ParseFlagsFromEnvAndDieIfUnknown("MACHINA_MACHINA_XLA_FLAGS", *flag_objects);
}

void ParseDebugOptionFlagsFromEnv(bool reset_envvar) {
  absl::call_once(flags_init, &AllocateFlags, nullptr);
  ParseFlagsFromEnvAndDieIfUnknown("MACHINA_MACHINA_XLA_FLAGS", *flag_objects, reset_envvar);
}
