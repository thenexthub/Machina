...
#ifndef MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_DOT_DECOMPOSER_H_
#define MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_DOT_DECOMPOSER_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_EXPANDERS_DOT_DECOMPOSER_H_
