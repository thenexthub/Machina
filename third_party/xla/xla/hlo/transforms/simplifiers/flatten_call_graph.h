...
#ifndef MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
#define MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
