...
#ifndef MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_CONVERT_MOVER_H_
#define MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_CONVERT_MOVER_H_
...
#endif  // MACHINA_XLAHLO_TRANSFORMS_SIMPLIFIERS_CONVERT_MOVER_H_
