...
#ifndef MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_ATTRIBUTE_EXPORTER_H_
#define MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_ATTRIBUTE_EXPORTER_H_
...
absl::StatusOr<TriangularSolveOptions::Transpose> ConvertTranspose(
    toolchain::StringRef transpose_string);
...
std::optional<xla::OriginalValueProto> ConvertOriginalValue(
    toolchain::StringRef original_value, const xla::Shape& shape);

std::optional<xla::HloInputOutputAliasProto> ConvertInputOutputAlias(
    toolchain::ArrayRef<mlir::Attribute> aliasing);
...
#endif  // MACHINA_MACHINA_XLA_HLO_TRANSLATE_MHLO_TO_HLO_ATTRIBUTE_EXPORTER_H_
