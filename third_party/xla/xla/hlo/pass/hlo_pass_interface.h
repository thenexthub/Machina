...
#ifndef MACHINA_MACHINA_XLA_HLO_PASS_HLO_PASS_INTERFACE_H_
#define MACHINA_MACHINA_XLA_HLO_PASS_HLO_PASS_INTERFACE_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_PASS_HLO_PASS_INTERFACE_H_
