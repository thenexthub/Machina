...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_PRNG_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_PRNG_H_
...
//   seed operand of a machina random operation as a key to the random bit
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_PRNG_H_
