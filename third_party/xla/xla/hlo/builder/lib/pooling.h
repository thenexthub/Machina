...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_POOLING_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_POOLING_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_POOLING_H_
