...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_MATH_IMPL_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_MATH_IMPL_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_MATH_IMPL_H_
