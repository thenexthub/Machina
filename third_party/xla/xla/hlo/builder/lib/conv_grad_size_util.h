...
#ifndef MACHINA_XLAHLO_BUILDER_LIB_CONV_GRAD_SIZE_UTIL_H_
#define MACHINA_XLAHLO_BUILDER_LIB_CONV_GRAD_SIZE_UTIL_H_
...
#endif  // MACHINA_XLAHLO_BUILDER_LIB_CONV_GRAD_SIZE_UTIL_H_
