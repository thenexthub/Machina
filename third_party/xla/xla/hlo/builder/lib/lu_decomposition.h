...
#ifndef MACHINA_XLAHLO_BUILDER_LIB_LU_DECOMPOSITION_H_
#define MACHINA_XLAHLO_BUILDER_LIB_LU_DECOMPOSITION_H_
...
#endif  // MACHINA_XLAHLO_BUILDER_LIB_LU_DECOMPOSITION_H_
