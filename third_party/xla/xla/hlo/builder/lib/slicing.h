...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_SLICING_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_SLICING_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_SLICING_H_
