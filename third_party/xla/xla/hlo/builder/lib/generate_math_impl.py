...
Usage:
  Running
    python /path/to/generate_math_impl.py [xla | machina]
  will create
...
def main():
  ...
  header_file_define = dict(
      xla="MACHINA_MACHINA_XLA_CLIENT_MATH_IMPL_H_",
      machina="MACHINA_COMPILER_MACHINA_MACHINA_XLA_CLIENT_MATH_IMPL_H_",
  )[target]
