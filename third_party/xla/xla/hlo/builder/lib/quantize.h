...
#ifndef MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_QUANTIZE_H_
#define MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_QUANTIZE_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_BUILDER_LIB_QUANTIZE_H_
