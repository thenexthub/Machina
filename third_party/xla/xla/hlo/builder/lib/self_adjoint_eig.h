...
#ifndef MACHINA_XLAHLO_BUILDER_LIB_SELF_ADJOINT_EIG_H_
#define MACHINA_XLAHLO_BUILDER_LIB_SELF_ADJOINT_EIG_H_
...
#endif  // MACHINA_XLAHLO_BUILDER_LIB_SELF_ADJOINT_EIG_H_
