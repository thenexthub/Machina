...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_COLLECTIVE_OP_GROUP_MODE_H_
#define MACHINA_MACHINA_XLA_HLO_IR_COLLECTIVE_OP_GROUP_MODE_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_COLLECTIVE_OP_GROUP_MODE_H_
