...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
#define MACHINA_MACHINA_XLA_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
