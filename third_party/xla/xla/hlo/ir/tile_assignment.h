...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_TILE_ASSIGNMENT_H_
#define MACHINA_MACHINA_XLA_HLO_IR_TILE_ASSIGNMENT_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_TILE_ASSIGNMENT_H_
