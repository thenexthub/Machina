...
#ifndef MACHINA_MACHINA_XLA_HLO_IR_HLO_CLONE_CONTEXT_H_
#define MACHINA_MACHINA_XLA_HLO_IR_HLO_CLONE_CONTEXT_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_IR_HLO_CLONE_CONTEXT_H_
