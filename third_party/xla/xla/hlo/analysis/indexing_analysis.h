...
#ifndef MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
#define MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
...
toolchain::SmallVector<mlir::AffineExpr, 4> DelinearizeInBoundsIndex(
    mlir::AffineExpr linear, absl::Span<const int64_t> sizes);

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
