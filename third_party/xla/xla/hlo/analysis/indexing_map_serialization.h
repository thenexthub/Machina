...
#ifndef MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
#define MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
...
toolchain::SmallVector<std::string> GetDimVarNames(const IndexingMap& map);
// Range variables names.
toolchain::SmallVector<std::string> GetRangeVarNames(const IndexingMap& map);
// Runtime variable names.
toolchain::SmallVector<std::string> GetRTVarNames(const IndexingMap& map);
// Symbol variable names: concatenation of range and runtime variables.
toolchain::SmallVector<std::string> GetSymbolVarNames(const IndexingMap& map);

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
