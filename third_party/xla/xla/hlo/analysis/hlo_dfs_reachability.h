...
#ifndef MACHINA_MACHINA_XLA_HLO_ANALYSIS_HLO_DFS_REACHABILITY_H_
#define MACHINA_MACHINA_XLA_HLO_ANALYSIS_HLO_DFS_REACHABILITY_H_
...
class HloDfsReachability {
 ...
 private:
  ...
  toolchain::DenseMap<const HloInstruction*, size_t> instruction_to_idx_;
};

}  // namespace xla

#endif  // MACHINA_MACHINA_XLA_HLO_ANALYSIS_HLO_DFS_REACHABILITY_H_
