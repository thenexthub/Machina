...
#ifndef MACHINA_XLAHLO_EXPERIMENTAL_AUTO_SHARDING_STABLEHLO_UTILS_H_
#define MACHINA_XLAHLO_EXPERIMENTAL_AUTO_SHARDING_STABLEHLO_UTILS_H_
...
#endif  // MACHINA_XLAHLO_EXPERIMENTAL_AUTO_SHARDING_STABLEHLO_UTILS_H_
