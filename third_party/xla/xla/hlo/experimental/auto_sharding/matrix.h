...
#ifndef MACHINA_MACHINA_XLA_HLO_EXPERIMENTAL_AUTO_SHARDING_MATRIX_H_
#define MACHINA_MACHINA_XLA_HLO_EXPERIMENTAL_AUTO_SHARDING_MATRIX_H_
...
// machina/compiler/xla/array2d.h;l=39)
template <typename T>
class Matrix {
 public:
...
#endif  // MACHINA_MACHINA_XLA_HLO_EXPERIMENTAL_AUTO_SHARDING_MATRIX_H_
