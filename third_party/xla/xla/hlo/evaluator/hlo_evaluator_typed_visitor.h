...
#ifndef MACHINA_MACHINA_XLA_HLO_EVALUATOR_HLO_EVALUATOR_TYPED_VISITOR_H_
#define MACHINA_MACHINA_XLA_HLO_EVALUATOR_HLO_EVALUATOR_TYPED_VISITOR_H_
    ...
    if constexpr (std::is_floating_point_v<ElementwiseT>) {
      switch (distribution) {
        case RNG_UNIFORM: {
          ...
          // [1] https://bugs.toolchain.org/show_bug.cgi?id=18767
...
#endif  // MACHINA_MACHINA_XLA_HLO_EVALUATOR_HLO_EVALUATOR_TYPED_VISITOR_H_
