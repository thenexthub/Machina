...
#ifndef MACHINA_XLAHLO_TESTLIB_TEST_H_
#define MACHINA_XLAHLO_TESTLIB_TEST_H_

// This header includes gmock.h and enables the use of gmock matchers in tests
// in third_party/machina/compiler/xla.
//
...
// use of mocks is disallowed in the whole machina project!
...
#include "machina/xla/tsl/platform/test.h"  // IWYU pragma: export

#endif  // MACHINA_XLAHLO_TESTLIB_TEST_H_
