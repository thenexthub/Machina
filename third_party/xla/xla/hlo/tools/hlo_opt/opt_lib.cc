...
#include "machina/xla/hlo/tools/hlo_opt/opt_lib.h"
...
#include "machina/xla/hlo/tools/tests/hlo_opt_test_only_passes.h"
#include "machina/xla/hlo/transforms/add_original_value.h"
#include "machina/xla/hlo/transforms/bfloat16_propagation.h"
#include "machina/xla/hlo/transforms/collectives/all_gather_broadcast_reorder.h"
#include "machina/xla/hlo/transforms/collectives/all_gather_combiner.h"
#include "machina/xla/hlo/transforms/collectives/all_gather_cse.h"
#include "machina/xla/hlo/transforms/collectives/all_reduce_combiner.h"
#include "machina/xla/hlo/transforms/collectives/all_reduce_contiguous.h"
#include "machina/xla/hlo/transforms/collectives/async_collective_creator.h"
#include "machina/xla/hlo/transforms/collectives/collective_quantizer.h"
#include "machina/xla/hlo/transforms/collectives/collective_transformation_reorderer.h"
#include "machina/xla/hlo/transforms/collectives/collectives_schedule_linearizer.h"
#include "machina/xla/hlo/transforms/collectives/convert_async_collectives_to_sync.h"
#include "machina/xla/hlo/transforms/collectives/infeed_token_propagation.h"
#include "machina/xla/hlo/transforms/collectives/while_loop_all_reduce_code_motion_setup.h"
#include "machina/xla/hlo/transforms/convert_memory_placement_to_internal_annotations.h"
#include "machina/xla/hlo/transforms/defuser.h"
#include "machina/xla/hlo/transforms/despecializer.h"
...
#include "machina/xla/hlo/transforms/host_offloading_prepare.h"
#include "machina/xla/hlo/transforms/literal_canonicalizer.h"
#include "machina/xla/hlo/transforms/memory_space_propagation.h"
...
#include "machina/xla/hlo/transforms/simplifiers/ar_crs_combiner.h"
#include "machina/xla/hlo/transforms/simplifiers/batch_dot_simplification.h"
#include "machina/xla/hlo/transforms/simplifiers/bfloat16_conversion_folding.h"
...
#include "machina/xla/hlo/transforms/simplifiers/convert_operand_folder.h"
#include "machina/xla/hlo/transforms/simplifiers/convolution_group_converter.h"
#include "machina/xla/hlo/transforms/simplifiers/dot_dimension_merger.h"
...
#include "machina/xla/hlo/transforms/simplifiers/fusion_constant_sinking.h"
...
#include "machina/xla/hlo/transforms/simplifiers/hlo_constant_splitter.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_dce.h"
#include "machina/xla/hlo/transforms/simplifiers/hlo_element_type_converter.h"
...
#include "machina/xla/hlo/transforms/simplifiers/instruction_hoister.h"
...
#include "machina/xla/hlo/transforms/simplifiers/root_instruction_sinker.h"
...
#include "machina/xla/service/buffer_value.h"
...
#include "machina/xla/stream_executor/platform/initialize.h"
