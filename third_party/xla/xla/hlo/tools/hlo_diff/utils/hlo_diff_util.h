...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_HLO_DIFF_UTIL_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_HLO_DIFF_UTIL_H_
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_HLO_DIFF_UTIL_H_
