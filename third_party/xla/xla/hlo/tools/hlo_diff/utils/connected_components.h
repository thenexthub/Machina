...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
