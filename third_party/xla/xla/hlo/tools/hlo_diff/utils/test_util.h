...
#ifndef MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_UTILS_TEST_UTIL_H_
#define MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_UTILS_TEST_UTIL_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_UTILS_TEST_UTIL_H_
