...
#ifndef MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
#define MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
...
#endif  // MACHINA_MACHINA_XLA_HLO_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
