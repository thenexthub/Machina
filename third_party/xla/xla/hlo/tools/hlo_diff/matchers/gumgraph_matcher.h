...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_MATCHERS_GUMGRAPH_MATCHER_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_MATCHERS_GUMGRAPH_MATCHER_H_
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_MATCHERS_GUMGRAPH_MATCHER_H_
