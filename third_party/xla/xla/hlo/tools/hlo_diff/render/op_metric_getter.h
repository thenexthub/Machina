...
#ifndef MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_OP_METRIC_GETTER_H_
#define MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_OP_METRIC_GETTER_H_
...
#endif  // MACHINA_XLAHLO_TOOLS_HLO_DIFF_RENDER_OP_METRIC_GETTER_H_
