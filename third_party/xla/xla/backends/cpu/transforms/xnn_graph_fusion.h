...
#ifndef MACHINA_XLABACKENDS_CPU_TRANSFORMS_XNN_GRAPH_FUSION_H_
#define MACHINA_XLABACKENDS_CPU_TRANSFORMS_XNN_GRAPH_FUSION_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_TRANSFORMS_XNN_GRAPH_FUSION_H_
