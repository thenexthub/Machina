...
#ifndef MACHINA_XLABACKENDS_CPU_NANORT_NANORT_CLIENT_H_
#define MACHINA_XLABACKENDS_CPU_NANORT_NANORT_CLIENT_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_NANORT_NANORT_CLIENT_H_
