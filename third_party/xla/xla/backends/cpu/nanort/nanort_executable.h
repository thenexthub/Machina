...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_NANORT_EXECUTABLE_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_NANORT_EXECUTABLE_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_NANORT_EXECUTABLE_H_
