...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_IFRT_CLIENT_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_IFRT_CLIENT_H_
...
class NanoIfrtClient : public toolchain::RTTIExtends<NanoIfrtClient, ifrt::Client> {
 public:
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_NANORT_IFRT_CLIENT_H_
