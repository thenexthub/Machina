...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_FusionF32)
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_FusionF32_2)
    ->MeasureProcessCPUTime()
    ->Arg(40)
    ->Arg(80)
    ->Arg(160)
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_BcastFusionF32)
    ->MeasureProcessCPUTime()
    ->Arg(128)
    ->Arg(256)
    ->Arg(512)
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_DynamicUpdateSliceFusionF32)
    ->MeasureProcessCPUTime()
    ->Arg(128)
    ->Arg(256)
    ->Arg(512)
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_ChainOfAddF32)
    ->MeasureProcessCPUTime()
    ->Arg(64)
    ->Arg(128)
    ->Arg(256)
