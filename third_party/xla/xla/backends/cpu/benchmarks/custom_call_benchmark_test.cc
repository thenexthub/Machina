...
#include "machina/xla/backends/cpu/benchmarks/hlo_benchmark_runner.h"
#include "machina/xla/backends/cpu/benchmarks/multi_benchmark_config.h"
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_bm$$minimal", "Host",
                         kMinimal);
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kManyIntAttributes, ManyIntAttributes,
                       ffi::Ffi::Bind()
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_bm$$many_int_attributes",
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kManyFloatBuffers, ManyFloatBuffers,
                       ffi::Ffi::Bind()
...
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "__xla_bm$$many_float_buffers",
...
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_CustomCall_Minimal)->MeasureProcessCPUTime();
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_CustomCall_16IntAttributes)->MeasureProcessCPUTime();
MACHINA_MACHINA_XLA_CPU_BENCHMARK(BM_CustomCall_16FloatBuffers)->MeasureProcessCPUTime();
