...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_XNN_FUSION_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_XNN_FUSION_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_XNN_FUSION_H_
