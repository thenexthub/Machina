...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_FUSION_COMPILER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_FUSION_COMPILER_H_
...
class FusionCompiler {
 public:
  ...
  absl::StatusOr<std::unique_ptr<toolchain::Module>> Compile(
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_FUSION_COMPILER_H_
