...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_POLYNOMIAL_APPROXIMATIONS_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_POLYNOMIAL_APPROXIMATIONS_H_
...
// intrinsics (i.e. `toolchain.tanh.f32`) and custom XLA:CPU vectorized math
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_POLYNOMIAL_APPROXIMATIONS_H_
