...
#ifndef MACHINA_XLABACKENDS_CPU_CODEGEN_AOT_COMPILED_FUNCTION_LIBRARY_H_
#define MACHINA_XLABACKENDS_CPU_CODEGEN_AOT_COMPILED_FUNCTION_LIBRARY_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_CODEGEN_AOT_COMPILED_FUNCTION_LIBRARY_H_
