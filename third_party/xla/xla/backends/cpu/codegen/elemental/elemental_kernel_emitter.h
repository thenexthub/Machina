...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_ELEMENTAL_ELEMENTAL_KERNEL_EMITTER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_ELEMENTAL_ELEMENTAL_KERNEL_EMITTER_H_
...
class ElementalKernelEmitter final : public LlvmKernelEmitter {
 ...
 private:
  ...
  ThreadLocalCallbackFactory(toolchain::IRBuilderBase& builder,
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_ELEMENTAL_ELEMENTAL_KERNEL_EMITTER_H_
