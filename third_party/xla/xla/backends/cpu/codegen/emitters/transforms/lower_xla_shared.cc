...
#include "machina/xla/backends/cpu/codegen/emitters/transforms/passes.h.inc"
...
struct LowerForall : mlir::OpRewritePattern<mlir::scf::ForallOp> {
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    auto loop_annotation = rewriter.getAttr<mlir::LLVM::LoopAnnotationAttr>(
        ...
        /*startLoc=*/nullptr,
        /*endLoc=*/nullptr,
        /*parallelAccesses=*/toolchain::ArrayRef<mlir::LLVM::AccessGroupAttr>());
