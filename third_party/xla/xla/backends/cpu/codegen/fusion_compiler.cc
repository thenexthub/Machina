...
#include "machina/xla/backends/cpu/codegen/emitters/ir/xla_cpu_dialect.h"
#include "machina/xla/backends/cpu/codegen/emitters/transforms/passes.h"
#include "machina/xla/backends/cpu/codegen/kernel_api_ir_builder.h"
#include "machina/xla/codegen/emitters/ir/xla_attrs.h.inc"
...
#include "machina/xla/codegen/trace_pass_instrumentation.h"
...
absl::StatusOr<std::unique_ptr<toolchain::Module>> FusionCompiler::Compile(
    toolchain::LLVMContext& llvm_context, mlir::ModuleOp mlir_module) {
  ...
  std::unique_ptr<toolchain::Module> llvm_module = mlir::translateModuleToLLVMIR(
  ...
  if (mlir::Attribute options =
    ...
    toolchain::MDString* options_mdstring =
        toolchain::MDString::get(llvm_context, options_csv);
...
absl::StatusOr<LlvmIrKernelSource> FusionCompiler::Compile(
  ...
  TF_ASSIGN_OR_RETURN(std::unique_ptr<toolchain::Module> llvm_module,
