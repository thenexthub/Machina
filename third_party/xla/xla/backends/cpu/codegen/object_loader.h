...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
...
class ObjectLoader {
 public:
  ...
  absl::StatusOr<toolchain::orc::SymbolMap> LookupSymbols(
      absl::Span<const Symbol> symbols);

  absl::StatusOr<std::unique_ptr<FunctionLibrary>> CreateFunctionLibrary(
      absl::Span<const Symbol> symbols, toolchain::orc::SymbolMap& symbol_map) &&;
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
