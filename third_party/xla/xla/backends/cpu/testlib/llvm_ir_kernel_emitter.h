...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_TESTLIB_LLVM_IR_KERNEL_EMITTER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_TESTLIB_LLVM_IR_KERNEL_EMITTER_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_TESTLIB_LLVM_IR_KERNEL_EMITTER_H_
