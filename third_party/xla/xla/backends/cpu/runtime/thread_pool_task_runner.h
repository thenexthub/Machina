...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_THREAD_POOL_TASK_RUNNER_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_THREAD_POOL_TASK_RUNNER_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_THREAD_POOL_TASK_RUNNER_H_
