...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
