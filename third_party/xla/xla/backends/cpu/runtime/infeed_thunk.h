...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_INFEED_THUNK_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_INFEED_THUNK_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_INFEED_THUNK_H_
