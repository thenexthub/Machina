...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_H_
 ...
 public:
  ...
  class ExecuteSession {
   public:
    ...
    // configurable with MACHINA_MACHINA_XLA_FLAGS. Also, we should find representative
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_THUNK_H_
