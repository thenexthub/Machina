...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_CONVOLUTION_THUNK_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_CONVOLUTION_THUNK_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_CONVOLUTION_THUNK_H_
