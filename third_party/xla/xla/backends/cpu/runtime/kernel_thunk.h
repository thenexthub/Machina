...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
#define MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
...
class KernelThunk : public KernelThunkBase {
 ...
 private:
  ...
  using KernelArgs = std::conditional_t<
      ...
      absl::InlinedVector<MACHINA_MACHINA_XLA_CPU_KernelArg, 8>,
      std::array<MACHINA_MACHINA_XLA_CPU_KernelArg, Size(num_arguments + num_results)>>;
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
