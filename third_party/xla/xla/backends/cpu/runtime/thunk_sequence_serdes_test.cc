...
#include "machina/xla/backends/cpu/runtime/convolution_thunk_test_util.h"
...
#include "machina/xla/backends/cpu/runtime/serdes_base.h"
...
#include "machina/xla/backends/cpu/runtime/thunk_executor.h"
#include "machina/xla/backends/cpu/runtime/thunk_proto_serdes.h"
#include "machina/xla/backends/cpu/runtime/thunk_testlib.h"
#include "machina/xla/backends/cpu/runtime/topk_thunk.h"
#include "machina/xla/backends/cpu/runtime/while_thunk.h"
#include "machina/xla/backends/cpu/runtime/xnnpack/xnn_convolution_thunk.h"
...
MACHINA_MACHINA_XLA_FFI_DEFINE_HANDLER(kNoOp, NoOp, ffi::Ffi::Bind());
MACHINA_MACHINA_XLA_FFI_REGISTER_HANDLER(ffi::GetXlaFfiApi(), "no_op", "Host", kNoOp);
