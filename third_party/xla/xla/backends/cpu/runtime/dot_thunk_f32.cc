...
#include "machina/xla/backends/cpu/runtime/dot_thunk.h"  // NOLINT IWYU pragma: keep

#if defined(MACHINA_USE_CUSTOM_CONTRACTION_KERNEL)
#include "machina/xla/tsl/framework/contraction/eigen_contraction_kernel.h"  // IWYU pragma: keep
#endif
