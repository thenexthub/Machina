...
#ifndef MACHINA_XLABACKENDS_CPU_RUNTIME_THUNK_PROTO_SERDES_H_
#define MACHINA_XLABACKENDS_CPU_RUNTIME_THUNK_PROTO_SERDES_H_
...
#endif  // MACHINA_XLABACKENDS_CPU_RUNTIME_THUNK_PROTO_SERDES_H_
