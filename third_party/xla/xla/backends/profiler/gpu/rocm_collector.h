...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_ROCM_COLLECTOR_H_
#define MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_ROCM_COLLECTOR_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_ROCM_COLLECTOR_H_
