...
#ifndef MACHINA_XLABACKENDS_PROFILER_GPU_NVTX_UTILS_H_
#define MACHINA_XLABACKENDS_PROFILER_GPU_NVTX_UTILS_H_
 ...
 * code.
 * We have no intention to use NVTX in machina right now, we use this class
...
#endif  // MACHINA_XLABACKENDS_PROFILER_GPU_NVTX_UTILS_H_
