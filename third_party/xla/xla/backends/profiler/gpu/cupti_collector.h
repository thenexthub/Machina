...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_COLLECTOR_H_
#define MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_COLLECTOR_H_
...
class CuptiTraceCollector {
 public:
  ...
  virtual bool Export(machina::profiler::XSpace* space,
                      uint64_t end_gpu_ns) {
    return true;
  }
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_PROFILER_GPU_CUPTI_COLLECTOR_H_
