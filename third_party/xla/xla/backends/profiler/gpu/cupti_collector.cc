...
#include "machina/xla/tsl/profiler/utils/parse_annotation.h"
...
using machina::profiler::XEventMetadata;
using machina::profiler::XLine;
using machina::profiler::XPlane;
using machina::profiler::XSpace;
using machina::profiler::XStatMetadata;
...
class CuptiTraceCollectorImpl : public CuptiTraceCollector {
 public:
  ...
  void ExportScopeRangeIdTree(XSpace* space) {
    ...
    machina::profiler::XStatMetadata metadata;
