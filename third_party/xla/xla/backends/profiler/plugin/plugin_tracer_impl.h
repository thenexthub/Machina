...
#ifndef MACHINA_XLABACKENDS_PROFILER_PLUGIN_PLUGIN_TRACER_IMPL_H_
#define MACHINA_XLABACKENDS_PROFILER_PLUGIN_PLUGIN_TRACER_IMPL_H_
...
struct PLUGIN_Profiler {
  std::optional<machina::profiler::XSpace> space;
...
#endif  // MACHINA_XLABACKENDS_PROFILER_PLUGIN_PLUGIN_TRACER_IMPL_H_
