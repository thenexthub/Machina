...
#ifndef MACHINA_XLABACKENDS_PROFILER_CPU_METADATA_UTILS_H_
#define MACHINA_XLABACKENDS_PROFILER_CPU_METADATA_UTILS_H_
...
#endif  // MACHINA_XLABACKENDS_PROFILER_CPU_METADATA_UTILS_H_
