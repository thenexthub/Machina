...
==============================================================================*/
#include "machina/xla/backends/profiler/cpu/host_tracer.h"
...
#include "machina/xla/tsl/profiler/backends/cpu/host_tracer_utils.h"
#include "machina/xla/tsl/profiler/backends/cpu/threadpool_listener.h"
#include "machina/xla/tsl/profiler/backends/cpu/traceme_recorder.h"
#include "machina/xla/tsl/profiler/utils/time_utils.h"
...
class HostTracer : public tsl::profiler::ProfilerInterface {
 public:
  ...
  absl::Status Start() override;  // MACHINA_STATUS_OK

  absl::Status Stop() override;  // MACHINA_STATUS_OK

  absl::Status CollectData(  // MACHINA_STATUS_OK
      machina::profiler::XSpace* space) override;
...
absl::Status HostTracer::Start() {  // MACHINA_STATUS_OK
  if (recording_) {
...
absl::Status HostTracer::Stop() {  // MACHINA_STATUS_OK
  if (!recording_) {
...
absl::Status HostTracer::CollectData(  // MACHINA_STATUS_OK
