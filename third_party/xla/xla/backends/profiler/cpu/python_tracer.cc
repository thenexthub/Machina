...
==============================================================================*/
#include "machina/xla/backends/profiler/cpu/python_tracer.h"
...
absl::Status PythonTracer::Start() {  // MACHINA_STATUS_OK
  if (recording_) {
...
absl::Status PythonTracer::Stop() {  // MACHINA_STATUS_OK
  if (!recording_) {
...
absl::Status PythonTracer::CollectData(  // MACHINA_STATUS_OK
