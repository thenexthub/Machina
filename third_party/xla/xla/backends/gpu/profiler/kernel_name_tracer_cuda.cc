...
#include "machina/xla/backends/gpu/profiler/kernel_name_tracer_factory.h"
#include "machina/xla/backends/profiler/gpu/cupti_collector.h"
#include "machina/xla/backends/profiler/gpu/cupti_tracer.h"
#include "machina/xla/stream_executor/cuda/cuda_platform.h"
...
std::vector<std::string> KernelNameTracerCuda::stop() {
  ...
  auto space = std::make_unique<machina::profiler::XSpace>();
