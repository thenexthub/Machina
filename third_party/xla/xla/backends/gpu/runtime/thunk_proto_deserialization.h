...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_THUNK_PROTO_DESERIALIZATION_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_THUNK_PROTO_DESERIALIZATION_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_THUNK_PROTO_DESERIALIZATION_H_
