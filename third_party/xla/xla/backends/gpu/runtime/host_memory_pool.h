...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_HOST_MEMORY_POOL_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_HOST_MEMORY_POOL_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_HOST_MEMORY_POOL_H_
