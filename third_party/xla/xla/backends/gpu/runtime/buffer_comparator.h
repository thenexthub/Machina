...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_BUFFER_COMPARATOR_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_BUFFER_COMPARATOR_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_BUFFER_COMPARATOR_H_
