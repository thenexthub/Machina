...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_GEMM_THUNK_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_GEMM_THUNK_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_RUNTIME_GEMM_THUNK_H_
