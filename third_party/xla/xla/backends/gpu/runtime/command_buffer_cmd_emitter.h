...
#ifndef MACHINA_XLABACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
#define MACHINA_XLABACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
