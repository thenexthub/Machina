...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_SCATTER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_SCATTER_H_
...
struct ScatterDescription {
  ...
  Shape update_shape;
  toolchain::SmallVector<int64_t, 2> slice_shape;
  toolchain::SmallVector<int64_t, 2> output_shape;
};
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_SCATTER_H_
