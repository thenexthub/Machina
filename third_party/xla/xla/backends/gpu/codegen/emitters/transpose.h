...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
...
class TransposeFusion : public TransposeFusionBase {
 ...
 private:
  ...
  toolchain::SmallVector<mlir::AffineExpr, 4> GetThreadOffsets(
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_TRANSPOSE_H_
