...
// CHECK: toolchain.nvvm.f16x2.to.e4m3x2.rn
// CHECK: toolchain.nvvm.f16x2.to.e5m2x2.rn
...
// CHECK: toolchain.nvvm.ff.to.e4m3x2.rn
// CHECK: toolchain.nvvm.ff.to.e5m2x2.rn
...
// CHECK: toolchain.nvvm.e4m3x2.to.f16x2.rn
// CHECK: toolchain.nvvm.e5m2x2.to.f16x2.rn
...
// CHECK: %[[PAIR:.*]] = toolchain.call_intrinsic "toolchain.nvvm.f16x2.to.e5m2x2.rn"
// CHECK: %[[RES:.*]] = toolchain.trunc %[[PAIR]] : i16 to i8
...
// CHECK: %[[PAIR:.*]] = toolchain.call_intrinsic "toolchain.nvvm.ff.to.e4m3x2.rn"
// CHECK: %[[RES:.*]] = toolchain.trunc %[[PAIR]] : i16 to i8
