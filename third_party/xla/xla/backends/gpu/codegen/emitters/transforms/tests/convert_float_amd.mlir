...
// CHECK: toolchain.amdgcn.cvt.pk.fp8.f32
// CHECK: toolchain.amdgcn.cvt.pk.bf8.f32
...
// CHECK: toolchain.amdgcn.cvt.f32.fp8
// CHECK: toolchain.amdgcn.cvt.f32.bf8
...
// CHECK: toolchain.amdgcn.cvt.f32.fp8
// CHECK: toolchain.amdgcn.cvt.f32.bf8
// CHECK: toolchain.bitcast %{{.+}} : f32 to i32
// CHECK: toolchain.bitcast %{{.+}} : i16 to bf16
...
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.fp8.f32
// CHECK-COUNT-4: arith.extf %{{.+}} : f16 to f32
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.bf8.f32
...
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.f32.fp8
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pkrtz
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.f32.bf8
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pkrtz
...
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.f32.fp8
// CHECK-COUNT-8: toolchain.bitcast
// CHECK-COUNT-2: toolchain.amdgcn.cvt.pk.f32.bf8
// CHECK-COUNT-8: toolchain.bitcast
// CHECK-NOT: arith.truncf %{{.+}} : f32 to bf16
