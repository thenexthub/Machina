...
==============================================================================*/
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
...
class EmitterBase : public KernelFusionInterface {
 public:
  ...
  absl::StatusOr<std::unique_ptr<toolchain::Module>> CreateLLVMModule(
 ...
 protected:
  ...
  absl::flat_hash_map<const HloInstruction*, mlir::ValueRange> EmitEpilogue(
      ...
      const absl::flat_hash_map<const HloInstruction*,
                                toolchain::SmallVector<mlir::Value>>& injected,
  ...
  toolchain::SmallVector<mlir::Value> EmitThreadAndBlockIds(
      mlir::ImplicitLocOpBuilder& builder) const;
...
// Adds passes that transform MACHINA_MACHINA_XLA_GPU and SCF loops, e.g. peel, pipeline,
// vectorize.
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
