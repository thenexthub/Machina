...
==============================================================================*/
#include "machina/xla/backends/gpu/codegen/custom.h"
...
#include "machina/xla/hlo/analysis/while_loop_analysis.h"
#include "machina/xla/hlo/evaluator/hlo_evaluator.h"
  ...
  if (slice_adaptor.has_value()) {
    ...
    if (auto* static_slice = DynCast<HloSliceInstruction>(slice_instr)) {
      ...
      for (auto [start, stride] :
           toolchain::zip(static_slice->slice_starts(),
