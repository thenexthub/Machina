...
#ifndef MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_DOT_ALGORITHMS_H_
#define MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_DOT_ALGORITHMS_H_
...
#endif  // MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_DOT_ALGORITHMS_H_
