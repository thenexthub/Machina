...
#ifndef MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_TRANSFORMS_PASSES_H_
#define MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_TRANSFORMS_PASSES_H_
...
bool ContainsOp(mlir::Operation* op,
                toolchain::function_ref<bool(mlir::Operation*)> fn);
...
#endif  // MACHINA_XLABACKENDS_GPU_CODEGEN_TRITON_TRANSFORMS_PASSES_H_
