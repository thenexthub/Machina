...
#include "machina/xla/backends/gpu/codegen/triton/test_utils.h"
...
#include "machina/xla/service/gpu/gpu_device_info_for_tests.h"
...
ENTRY entry {
  ...
  toolchain::LLVMContext llvm_ctx;
  toolchain::Module llvm_module("module", llvm_ctx);
...
// See machina/compiler/xla/backends/gpu/codegen/triton/tma_utils.cc.
TEST_P(TmaParameterizedTritonEmitterTest,
