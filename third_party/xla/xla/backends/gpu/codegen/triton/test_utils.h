...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_TEST_UTILS_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_TEST_UTILS_H_
...
class TritonSupportTestBase : public HloTestBase {
 protected:
  ...
  toolchain::LLVMContext llvm_ctx_;
  toolchain::Module llvm_module_{"module", llvm_ctx_};
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_TEST_UTILS_H_
