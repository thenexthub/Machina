...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_EMITTER_HELPERS_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_EMITTER_HELPERS_H_
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_EMITTER_HELPERS_H_
