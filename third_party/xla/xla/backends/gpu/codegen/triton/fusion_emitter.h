...
#ifndef MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_FUSION_EMITTER_H_
#define MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_FUSION_EMITTER_H_
...
struct TritonWrapperResult {
  ...
  std::vector<toolchain::Metadata*> nvvm_annotations;
};
...
toolchain::SmallVector<mlir::Value, 3> ComputeDelinearizedTileIndex(
...
inline std::string DumpTritonIR(mlir::ModuleOp triton_module,
  ...
  toolchain::raw_string_ostream os(triton_ir);
...
#endif  // MACHINA_MACHINA_XLA_BACKENDS_GPU_CODEGEN_TRITON_FUSION_EMITTER_H_
