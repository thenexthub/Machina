...
#include "machina/xla/mlir_hlo/mhlo/transforms/transformation_helpers.h"
...
#include "machina/xla/service/gpu/triton_tiling_propagation.h"
...
bool IsFp8Type(Type t) {
  return toolchain::isa<mlir::Float8E5M2Type, mlir::Float8E4M3FNType,
...
absl::Status EmitForLoopBody(EmitterLocOpBuilder& b,
                             ...
                             const MatMulDims& dims,
                             const toolchain::SmallVector<IterableInput>& inputs,
...
absl::Status EmitMatMul(EmitterLocOpBuilder& b,
  ...
  toolchain::SmallVector<IterableInput> inputs;
