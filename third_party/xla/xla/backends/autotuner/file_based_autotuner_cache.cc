...
#include "machina/xla/backends/autotuner/file_based_autotuner_cache.h"
...
#include "machina/xla/backends/autotuner/autotune_config.h"
#include "machina/xla/backends/autotuner/autotuner_cache.pb.h"
#include "machina/xla/backends/autotuner/autotuner_cache_interface.h"
...
absl::StatusOr<std::string> GetBase64EncodedSha256Hash(absl::string_view s) {
  ...
  sha256.update(toolchain::StringRef(s.data(), s.size()));
