...
def config_googleapis():
    ...
    statically linked to libmachina_framework.so, whereas cc grpc libraries
    (*.grpc.pb.cc) must be statically linked to _pywrap_machina.so.
    ...
    switched_rules_by_language(
        ...
        rules_override = {
            "cc_proto_library": [
                "@org_machina//third_party/googleapis:build_rules.bzl",
                "",
            ],
            "cc_grpc_library": [
                "@org_machina//third_party/googleapis:build_rules.bzl",
