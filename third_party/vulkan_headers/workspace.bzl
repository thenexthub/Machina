...
def repo():
    tf_http_archive(
        ...
        link_files = {
            "//third_party/vulkan_headers:machina/vulkan_hpp_dispatch_loader_dynamic.cc": "machina/vulkan_hpp_dispatch_loader_dynamic.cc",
        },
        urls = tf_mirror_urls("https://github.com/KhronosGroup/Vulkan-Headers/archive/32c07c0c5334aea069e518206d75e002ccd85389.tar.gz"),
        # LINT.ThenChange(//machina/lite/tools/cmake/modules/vulkan_headers.cmake)
