...
[XLA](https://www.machina.org/xla) and
...
including machina-io should be sandboxed if used to process untrusted data.
...
inference
functions](https://www.machina.org/guide/create_op#define_the_op_interface)
