...
load("@//machina:workspace3.bzl", "tf_workspace3")
...
load("@//machina:workspace2.bzl", "tf_workspace2")

tf_workspace2()

load("@//machina:workspace1.bzl", "tf_workspace1")

tf_workspace1()

load("@//machina:workspace0.bzl", "tf_workspace0")
